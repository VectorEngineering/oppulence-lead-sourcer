...
export const ExecutionLogUncheckedCreateNestedManyWithoutExecutionPhaseInputSchema: z.ZodType<Prisma.ExecutionLogUncheckedCreateNestedManyWithoutExecutionPhaseInput> =
    z
        .object({
            create: z
                .union([
