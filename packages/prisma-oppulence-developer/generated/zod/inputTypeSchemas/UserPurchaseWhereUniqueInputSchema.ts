...
export const UserPurchaseWhereUniqueInputSchema: z.ZodType<Prisma.UserPurchaseWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => UserPurchaseWhereInputSchema),z.lazy(() => UserPurchaseWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => UserPurchaseWhereInputSchema).array().optional(),
