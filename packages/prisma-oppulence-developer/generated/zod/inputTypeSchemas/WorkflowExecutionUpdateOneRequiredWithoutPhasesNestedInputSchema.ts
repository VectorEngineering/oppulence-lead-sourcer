...
export const WorkflowExecutionUpdateOneRequiredWithoutPhasesNestedInputSchema: z.ZodType<Prisma.WorkflowExecutionUpdateOneRequiredWithoutPhasesNestedInput> = z.object({
  create: z.union([ z.lazy(() => WorkflowExecutionCreateWithoutPhasesInputSchema),z.lazy(() => WorkflowExecutionUncheckedCreateWithoutPhasesInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => WorkflowExecutionUpdateToOneWithWhereWithoutPhasesInputSchema),z.lazy(() => WorkflowExecutionUpdateWithoutPhasesInputSchema),z.lazy(() => WorkflowExecutionUncheckedUpdateWithoutPhasesInputSchema) ]).optional(),
}).strict();
