...
export const ExecutionPhaseUpsertWithWhereUniqueWithoutExecutionInputSchema: z.ZodType<Prisma.ExecutionPhaseUpsertWithWhereUniqueWithoutExecutionInput> = z.object({
  where: z.lazy(() => ExecutionPhaseWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ExecutionPhaseUpdateWithoutExecutionInputSchema),z.lazy(() => ExecutionPhaseUncheckedUpdateWithoutExecutionInputSchema) ]),
  create: z.union([ z.lazy(() => ExecutionPhaseCreateWithoutExecutionInputSchema),z.lazy(() => ExecutionPhaseUncheckedCreateWithoutExecutionInputSchema) ]),
}).strict();
