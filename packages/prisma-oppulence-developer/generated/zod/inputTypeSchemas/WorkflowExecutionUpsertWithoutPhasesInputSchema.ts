...
export const WorkflowExecutionUpsertWithoutPhasesInputSchema: z.ZodType<Prisma.WorkflowExecutionUpsertWithoutPhasesInput> = z.object({
  update: z.union([ z.lazy(() => WorkflowExecutionUpdateWithoutPhasesInputSchema),z.lazy(() => WorkflowExecutionUncheckedUpdateWithoutPhasesInputSchema) ]),
  create: z.union([ z.lazy(() => WorkflowExecutionCreateWithoutPhasesInputSchema),z.lazy(() => WorkflowExecutionUncheckedCreateWithoutPhasesInputSchema) ]),
