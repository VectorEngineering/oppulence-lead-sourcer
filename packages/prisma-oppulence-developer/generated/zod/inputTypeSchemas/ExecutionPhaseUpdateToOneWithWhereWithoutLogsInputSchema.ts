...
export const ExecutionPhaseUpdateToOneWithWhereWithoutLogsInputSchema: z.ZodType<Prisma.ExecutionPhaseUpdateToOneWithWhereWithoutLogsInput> = z.object({
  where: z.lazy(() => ExecutionPhaseWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ExecutionPhaseUpdateWithoutLogsInputSchema),z.lazy(() => ExecutionPhaseUncheckedUpdateWithoutLogsInputSchema) ]),
}).strict();
