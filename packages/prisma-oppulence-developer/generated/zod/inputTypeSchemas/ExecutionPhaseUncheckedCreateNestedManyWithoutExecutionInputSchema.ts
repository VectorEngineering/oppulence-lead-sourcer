...
export const ExecutionPhaseUncheckedCreateNestedManyWithoutExecutionInputSchema: z.ZodType<Prisma.ExecutionPhaseUncheckedCreateNestedManyWithoutExecutionInput> =
    z
        .object({
            create: z
                .union([
