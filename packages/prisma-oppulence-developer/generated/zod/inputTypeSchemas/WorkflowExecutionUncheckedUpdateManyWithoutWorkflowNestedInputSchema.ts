...
export const WorkflowExecutionUncheckedUpdateManyWithoutWorkflowNestedInputSchema: z.ZodType<Prisma.WorkflowExecutionUncheckedUpdateManyWithoutWorkflowNestedInput> =
    z
        .object({
            create: z
                .union([
