...
export const WorkflowExecutionUpdateToOneWithWhereWithoutPhasesInputSchema: z.ZodType<Prisma.WorkflowExecutionUpdateToOneWithWhereWithoutPhasesInput> = z.object({
  where: z.lazy(() => WorkflowExecutionWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => WorkflowExecutionUpdateWithoutPhasesInputSchema),z.lazy(() => WorkflowExecutionUncheckedUpdateWithoutPhasesInputSchema) ]),
}).strict();
