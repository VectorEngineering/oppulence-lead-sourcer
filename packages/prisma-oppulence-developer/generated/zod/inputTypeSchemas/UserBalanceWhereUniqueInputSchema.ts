...
export const UserBalanceWhereUniqueInputSchema: z.ZodType<Prisma.UserBalanceWhereUniqueInput> = z.object({
  userId: z.string()
})
.and(z.object({
  userId: z.string().optional(),
  AND: z.union([ z.lazy(() => UserBalanceWhereInputSchema),z.lazy(() => UserBalanceWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => UserBalanceWhereInputSchema).array().optional(),
