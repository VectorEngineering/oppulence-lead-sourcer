...
import { WorkflowExecutionUncheckedUpdateManyWithoutWorkflowNestedInputSchema } from './WorkflowExecutionUncheckedUpdateManyWithoutWorkflowNestedInputSchema';
...
export const WorkflowUncheckedUpdateInputSchema: z.ZodType<Prisma.WorkflowUncheckedUpdateInput> = z.object({
  ...
  executionPlan: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  creditsCost: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cron: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  status: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  lastRunAt: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  lastRunId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  executions: z.lazy(() => WorkflowExecutionUncheckedUpdateManyWithoutWorkflowNestedInputSchema).optional()
}).strict();

export default WorkflowUncheckedUpdateInputSchema;
