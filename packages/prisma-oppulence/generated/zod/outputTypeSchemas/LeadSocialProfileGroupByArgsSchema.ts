...
export const LeadSocialProfileGroupByArgsSchema: z.ZodType<Prisma.LeadSocialProfileGroupByArgs> = z
    .object({
        where: LeadSocialProfileWhereInputSchema.optional(),
        orderBy: z
            .union([LeadSocialProfileOrderByWithAggregationInputSchema.array(), LeadSocialProfileOrderByWithAggregationInputSchema])
            .optional(),
