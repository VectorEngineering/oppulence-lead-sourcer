...
export const LeadProductFitUpdateArgsSchema: z.ZodType<Prisma.LeadProductFitUpdateArgs> = z.object({
  select: LeadProductFitSelectSchema.optional(),
  include: LeadProductFitIncludeSchema.optional(),
  data: z.union([ LeadProductFitUpdateInputSchema,LeadProductFitUncheckedUpdateInputSchema ]),
  where: LeadProductFitWhereUniqueInputSchema,
}).strict() ;

export default LeadProductFitUpdateArgsSchema;
