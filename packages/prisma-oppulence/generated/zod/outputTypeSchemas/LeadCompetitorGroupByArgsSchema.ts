...
export const LeadCompetitorGroupByArgsSchema: z.ZodType<Prisma.LeadCompetitorGroupByArgs> = z
    .object({
        where: LeadCompetitorWhereInputSchema.optional(),
        orderBy: z
            .union([LeadCompetitorOrderByWithAggregationInputSchema.array(), LeadCompetitorOrderByWithAggregationInputSchema])
            .optional(),
