...
export const RestrictedTokenGroupByArgsSchema: z.ZodType<Prisma.RestrictedTokenGroupByArgs> = z.object({
  where: RestrictedTokenWhereInputSchema.optional(),
  orderBy: z.union([ RestrictedTokenOrderByWithAggregationInputSchema.array(),RestrictedTokenOrderByWithAggregationInputSchema ]).optional(),
