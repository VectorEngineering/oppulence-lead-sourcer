...
export const LeadFeedbackCreateArgsSchema: z.ZodType<Prisma.LeadFeedbackCreateArgs> = z.object({
  select: LeadFeedbackSelectSchema.optional(),
  include: LeadFeedbackIncludeSchema.optional(),
  data: z.union([ LeadFeedbackCreateInputSchema,LeadFeedbackUncheckedCreateInputSchema ]),
}).strict() ;

export default LeadFeedbackCreateArgsSchema;
