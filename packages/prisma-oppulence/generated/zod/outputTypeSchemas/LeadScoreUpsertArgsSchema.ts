...
import { LeadScoreCreateInputSchema } from '../inputTypeSchemas/LeadScoreCreateInputSchema'
import { LeadScoreUncheckedCreateInputSchema } from '../inputTypeSchemas/LeadScoreUncheckedCreateInputSchema'
import { LeadScoreUpdateInputSchema } from '../inputTypeSchemas/LeadScoreUpdateInputSchema'
import { LeadScoreUncheckedUpdateInputSchema } from '../inputTypeSchemas/LeadScoreUncheckedUpdateInputSchema'
...
export const LeadScoreUpsertArgsSchema: z.ZodType<Prisma.LeadScoreUpsertArgs> = z.object({
  select: LeadScoreSelectSchema.optional(),
  include: LeadScoreIncludeSchema.optional(),
  where: LeadScoreWhereUniqueInputSchema,
  create: z.union([ LeadScoreCreateInputSchema,LeadScoreUncheckedCreateInputSchema ]),
  update: z.union([ LeadScoreUpdateInputSchema,LeadScoreUncheckedUpdateInputSchema ]),
}).strict() ;

export default LeadScoreUpsertArgsSchema;
