...
export const DealActivityUpdateArgsSchema: z.ZodType<Prisma.DealActivityUpdateArgs> = z.object({
  select: DealActivitySelectSchema.optional(),
  include: DealActivityIncludeSchema.optional(),
  data: z.union([ DealActivityUpdateInputSchema,DealActivityUncheckedUpdateInputSchema ]),
  where: DealActivityWhereUniqueInputSchema,
}).strict() ;

export default DealActivityUpdateArgsSchema;
