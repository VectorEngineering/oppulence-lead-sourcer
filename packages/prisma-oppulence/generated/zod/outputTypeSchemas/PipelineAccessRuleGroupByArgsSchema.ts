...
export const PipelineAccessRuleGroupByArgsSchema: z.ZodType<Prisma.PipelineAccessRuleGroupByArgs> = z.object({
  where: PipelineAccessRuleWhereInputSchema.optional(),
  orderBy: z.union([ PipelineAccessRuleOrderByWithAggregationInputSchema.array(),PipelineAccessRuleOrderByWithAggregationInputSchema ]).optional(),
