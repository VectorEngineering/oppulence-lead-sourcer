...
export const LeadScoreUpdateArgsSchema: z.ZodType<Prisma.LeadScoreUpdateArgs> = z.object({
  select: LeadScoreSelectSchema.optional(),
  include: LeadScoreIncludeSchema.optional(),
  data: z.union([ LeadScoreUpdateInputSchema,LeadScoreUncheckedUpdateInputSchema ]),
  where: LeadScoreWhereUniqueInputSchema,
}).strict() ;

export default LeadScoreUpdateArgsSchema;
