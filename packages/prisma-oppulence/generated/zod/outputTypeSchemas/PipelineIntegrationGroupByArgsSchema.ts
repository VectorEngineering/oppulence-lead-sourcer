...
export const PipelineIntegrationGroupByArgsSchema: z.ZodType<Prisma.PipelineIntegrationGroupByArgs> = z
    .object({
        where: PipelineIntegrationWhereInputSchema.optional(),
        orderBy: z
            .union([PipelineIntegrationOrderByWithAggregationInputSchema.array(), PipelineIntegrationOrderByWithAggregationInputSchema])
            .optional(),
