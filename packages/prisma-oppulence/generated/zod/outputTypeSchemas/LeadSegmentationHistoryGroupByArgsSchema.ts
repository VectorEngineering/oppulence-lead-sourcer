...
export const LeadSegmentationHistoryGroupByArgsSchema: z.ZodType<Prisma.LeadSegmentationHistoryGroupByArgs> = z.object({
  where: LeadSegmentationHistoryWhereInputSchema.optional(),
  orderBy: z.union([ LeadSegmentationHistoryOrderByWithAggregationInputSchema.array(),LeadSegmentationHistoryOrderByWithAggregationInputSchema ]).optional(),
