...
export const ProjectInviteGroupByArgsSchema: z.ZodType<Prisma.ProjectInviteGroupByArgs> = z
    .object({
        where: ProjectInviteWhereInputSchema.optional(),
        orderBy: z
            .union([ProjectInviteOrderByWithAggregationInputSchema.array(), ProjectInviteOrderByWithAggregationInputSchema])
            .optional(),
