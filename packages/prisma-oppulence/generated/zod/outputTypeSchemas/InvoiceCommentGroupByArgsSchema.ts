...
export const InvoiceCommentGroupByArgsSchema: z.ZodType<Prisma.InvoiceCommentGroupByArgs> = z.object({
  where: InvoiceCommentWhereInputSchema.optional(),
  orderBy: z.union([ InvoiceCommentOrderByWithAggregationInputSchema.array(),InvoiceCommentOrderByWithAggregationInputSchema ]).optional(),
