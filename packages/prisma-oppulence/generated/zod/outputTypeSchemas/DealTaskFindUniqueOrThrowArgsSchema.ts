...
export const DealTaskFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.DealTaskFindUniqueOrThrowArgs> = z.object({
  select: DealTaskSelectSchema.optional(),
  include: DealTaskIncludeSchema.optional(),
  where: DealTaskWhereUniqueInputSchema,
}).strict() ;

export default DealTaskFindUniqueOrThrowArgsSchema;
