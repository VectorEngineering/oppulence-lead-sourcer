...
export const LeadCategoryUpdateArgsSchema: z.ZodType<Prisma.LeadCategoryUpdateArgs> = z.object({
  select: LeadCategorySelectSchema.optional(),
  include: LeadCategoryIncludeSchema.optional(),
  data: z.union([ LeadCategoryUpdateInputSchema,LeadCategoryUncheckedUpdateInputSchema ]),
  where: LeadCategoryWhereUniqueInputSchema,
}).strict() ;

export default LeadCategoryUpdateArgsSchema;
