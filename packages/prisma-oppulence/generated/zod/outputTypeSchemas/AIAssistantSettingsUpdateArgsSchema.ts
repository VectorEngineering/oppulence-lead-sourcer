...
export const AIAssistantSettingsUpdateArgsSchema: z.ZodType<Prisma.AIAssistantSettingsUpdateArgs> = z.object({
  select: AIAssistantSettingsSelectSchema.optional(),
  include: AIAssistantSettingsIncludeSchema.optional(),
  data: z.union([ AIAssistantSettingsUpdateInputSchema,AIAssistantSettingsUncheckedUpdateInputSchema ]),
  where: AIAssistantSettingsWhereUniqueInputSchema,
}).strict() ;

export default AIAssistantSettingsUpdateArgsSchema;
