...
export const AccessRuleConditionCreateArgsSchema: z.ZodType<Prisma.AccessRuleConditionCreateArgs> = z.object({
  select: AccessRuleConditionSelectSchema.optional(),
  include: AccessRuleConditionIncludeSchema.optional(),
  data: z.union([ AccessRuleConditionCreateInputSchema,AccessRuleConditionUncheckedCreateInputSchema ]),
}).strict() ;

export default AccessRuleConditionCreateArgsSchema;
