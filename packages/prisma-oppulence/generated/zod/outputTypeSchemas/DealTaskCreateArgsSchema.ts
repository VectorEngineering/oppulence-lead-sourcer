...
export const DealTaskCreateArgsSchema: z.ZodType<Prisma.DealTaskCreateArgs> = z.object({
  select: DealTaskSelectSchema.optional(),
  include: DealTaskIncludeSchema.optional(),
  data: z.union([ DealTaskCreateInputSchema,DealTaskUncheckedCreateInputSchema ]),
}).strict() ;

export default DealTaskCreateArgsSchema;
