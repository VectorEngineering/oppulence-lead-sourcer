...
export const LeadNurturingCreateArgsSchema: z.ZodType<Prisma.LeadNurturingCreateArgs> = z.object({
  select: LeadNurturingSelectSchema.optional(),
  include: LeadNurturingIncludeSchema.optional(),
  data: z.union([ LeadNurturingCreateInputSchema,LeadNurturingUncheckedCreateInputSchema ]),
}).strict() ;

export default LeadNurturingCreateArgsSchema;
