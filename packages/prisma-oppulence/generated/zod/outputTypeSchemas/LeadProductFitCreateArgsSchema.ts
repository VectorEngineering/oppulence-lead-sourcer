...
export const LeadProductFitCreateArgsSchema: z.ZodType<Prisma.LeadProductFitCreateArgs> = z.object({
  select: LeadProductFitSelectSchema.optional(),
  include: LeadProductFitIncludeSchema.optional(),
  data: z.union([ LeadProductFitCreateInputSchema,LeadProductFitUncheckedCreateInputSchema ]),
}).strict() ;

export default LeadProductFitCreateArgsSchema;
