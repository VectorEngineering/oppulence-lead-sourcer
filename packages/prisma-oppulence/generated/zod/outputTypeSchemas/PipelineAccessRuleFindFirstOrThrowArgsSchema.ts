...
export const PipelineAccessRuleFindFirstOrThrowArgsSchema: z.ZodType<Prisma.PipelineAccessRuleFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ PipelineAccessRuleOrderByWithRelationInputSchema.array(),PipelineAccessRuleOrderByWithRelationInputSchema ]).optional(),
...
export default PipelineAccessRuleFindFirstOrThrowArgsSchema;
