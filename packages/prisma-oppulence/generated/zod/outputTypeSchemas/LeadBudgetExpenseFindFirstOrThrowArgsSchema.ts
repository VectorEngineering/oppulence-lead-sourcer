...
export const LeadBudgetExpenseFindFirstOrThrowArgsSchema: z.ZodType<Prisma.LeadBudgetExpenseFindFirstOrThrowArgs> = z
    .object({
        ...
        orderBy: z
            .union([LeadBudgetExpenseOrderByWithRelationInputSchema.array(), LeadBudgetExpenseOrderByWithRelationInputSchema])
            .optional(),
...
export default LeadBudgetExpenseFindFirstOrThrowArgsSchema
