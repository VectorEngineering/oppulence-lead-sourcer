...
export const LeadComplianceAuditFindFirstOrThrowArgsSchema: z.ZodType<Prisma.LeadComplianceAuditFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ LeadComplianceAuditOrderByWithRelationInputSchema.array(),LeadComplianceAuditOrderByWithRelationInputSchema ]).optional(),
...
export default LeadComplianceAuditFindFirstOrThrowArgsSchema;
