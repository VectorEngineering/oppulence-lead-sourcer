...
export const LeadTouchpointGroupByArgsSchema: z.ZodType<Prisma.LeadTouchpointGroupByArgs> = z
    .object({
        where: LeadTouchpointWhereInputSchema.optional(),
        orderBy: z
            .union([LeadTouchpointOrderByWithAggregationInputSchema.array(), LeadTouchpointOrderByWithAggregationInputSchema])
            .optional(),
