...
export const LeadRiskFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.LeadRiskFindUniqueOrThrowArgs> = z.object({
  select: LeadRiskSelectSchema.optional(),
  include: LeadRiskIncludeSchema.optional(),
  where: LeadRiskWhereUniqueInputSchema,
}).strict() ;

export default LeadRiskFindUniqueOrThrowArgsSchema;
