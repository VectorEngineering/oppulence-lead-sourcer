...
export const LeadScoreHistoryGroupByArgsSchema: z.ZodType<Prisma.LeadScoreHistoryGroupByArgs> = z.object({
  where: LeadScoreHistoryWhereInputSchema.optional(),
  orderBy: z.union([ LeadScoreHistoryOrderByWithAggregationInputSchema.array(),LeadScoreHistoryOrderByWithAggregationInputSchema ]).optional(),
