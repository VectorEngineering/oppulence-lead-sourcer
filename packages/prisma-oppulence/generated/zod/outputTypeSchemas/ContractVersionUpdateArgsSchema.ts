...
export const ContractVersionUpdateArgsSchema: z.ZodType<Prisma.ContractVersionUpdateArgs> = z.object({
  select: ContractVersionSelectSchema.optional(),
  include: ContractVersionIncludeSchema.optional(),
  data: z.union([ ContractVersionUpdateInputSchema,ContractVersionUncheckedUpdateInputSchema ]),
  where: ContractVersionWhereUniqueInputSchema,
}).strict() ;

export default ContractVersionUpdateArgsSchema;
