...
export const LeadSegmentationHistoryCreateArgsSchema: z.ZodType<Prisma.LeadSegmentationHistoryCreateArgs> = z.object({
  select: LeadSegmentationHistorySelectSchema.optional(),
  include: LeadSegmentationHistoryIncludeSchema.optional(),
  data: z.union([ LeadSegmentationHistoryCreateInputSchema,LeadSegmentationHistoryUncheckedCreateInputSchema ]),
}).strict() ;

export default LeadSegmentationHistoryCreateArgsSchema;
