...
export const AccessRuleConditionGroupByArgsSchema: z.ZodType<Prisma.AccessRuleConditionGroupByArgs> = z.object({
  where: AccessRuleConditionWhereInputSchema.optional(),
  orderBy: z.union([ AccessRuleConditionOrderByWithAggregationInputSchema.array(),AccessRuleConditionOrderByWithAggregationInputSchema ]).optional(),
