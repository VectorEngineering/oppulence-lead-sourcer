...
export const StageDurationGroupByArgsSchema: z.ZodType<Prisma.StageDurationGroupByArgs> = z.object({
  where: StageDurationWhereInputSchema.optional(),
  orderBy: z.union([ StageDurationOrderByWithAggregationInputSchema.array(),StageDurationOrderByWithAggregationInputSchema ]).optional(),
