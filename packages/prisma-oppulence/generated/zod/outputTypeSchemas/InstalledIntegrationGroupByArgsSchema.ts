...
export const InstalledIntegrationGroupByArgsSchema: z.ZodType<Prisma.InstalledIntegrationGroupByArgs> = z.object({
  where: InstalledIntegrationWhereInputSchema.optional(),
  orderBy: z.union([ InstalledIntegrationOrderByWithAggregationInputSchema.array(),InstalledIntegrationOrderByWithAggregationInputSchema ]).optional(),
