...
export const LeadBudgetFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.LeadBudgetFindUniqueOrThrowArgs> = z.object({
  select: LeadBudgetSelectSchema.optional(),
  include: LeadBudgetIncludeSchema.optional(),
  where: LeadBudgetWhereUniqueInputSchema,
}).strict() ;

export default LeadBudgetFindUniqueOrThrowArgsSchema;
