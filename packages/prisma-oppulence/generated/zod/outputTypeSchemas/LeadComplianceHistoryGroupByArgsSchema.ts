...
export const LeadComplianceHistoryGroupByArgsSchema: z.ZodType<Prisma.LeadComplianceHistoryGroupByArgs> = z.object({
  where: LeadComplianceHistoryWhereInputSchema.optional(),
  orderBy: z.union([ LeadComplianceHistoryOrderByWithAggregationInputSchema.array(),LeadComplianceHistoryOrderByWithAggregationInputSchema ]).optional(),
