...
export const LeadCommunicationFindFirstOrThrowArgsSchema: z.ZodType<Prisma.LeadCommunicationFindFirstOrThrowArgs> = z
    .object({
        ...
        orderBy: z
            .union([LeadCommunicationOrderByWithRelationInputSchema.array(), LeadCommunicationOrderByWithRelationInputSchema])
            .optional(),
...
export default LeadCommunicationFindFirstOrThrowArgsSchema
