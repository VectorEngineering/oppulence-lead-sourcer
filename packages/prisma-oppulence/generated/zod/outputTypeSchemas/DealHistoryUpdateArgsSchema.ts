...
export const DealHistoryUpdateArgsSchema: z.ZodType<Prisma.DealHistoryUpdateArgs> = z.object({
  select: DealHistorySelectSchema.optional(),
  include: DealHistoryIncludeSchema.optional(),
  data: z.union([ DealHistoryUpdateInputSchema,DealHistoryUncheckedUpdateInputSchema ]),
  where: DealHistoryWhereUniqueInputSchema,
}).strict() ;

export default DealHistoryUpdateArgsSchema;
