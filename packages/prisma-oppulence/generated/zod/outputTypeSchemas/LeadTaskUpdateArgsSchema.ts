...
export const LeadTaskUpdateArgsSchema: z.ZodType<Prisma.LeadTaskUpdateArgs> = z.object({
  select: LeadTaskSelectSchema.optional(),
  include: LeadTaskIncludeSchema.optional(),
  data: z.union([ LeadTaskUpdateInputSchema,LeadTaskUncheckedUpdateInputSchema ]),
  where: LeadTaskWhereUniqueInputSchema,
}).strict() ;

export default LeadTaskUpdateArgsSchema;
