...
export const EmailVerificationTokenFindManyArgsSchema: z.ZodType<Prisma.EmailVerificationTokenFindManyArgs> = z
    .object({
...
export default EmailVerificationTokenFindManyArgsSchema
