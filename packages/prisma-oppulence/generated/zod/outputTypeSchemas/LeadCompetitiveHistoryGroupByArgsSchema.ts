...
export const LeadCompetitiveHistoryGroupByArgsSchema: z.ZodType<Prisma.LeadCompetitiveHistoryGroupByArgs> = z
    .object({
        where: LeadCompetitiveHistoryWhereInputSchema.optional(),
        orderBy: z
            .union([
                LeadCompetitiveHistoryOrderByWithAggregationInputSchema.array(),
                LeadCompetitiveHistoryOrderByWithAggregationInputSchema
            ])
            .optional(),
