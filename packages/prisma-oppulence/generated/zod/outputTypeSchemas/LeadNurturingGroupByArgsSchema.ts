...
export const LeadNurturingGroupByArgsSchema: z.ZodType<Prisma.LeadNurturingGroupByArgs> = z
    .object({
        where: LeadNurturingWhereInputSchema.optional(),
        orderBy: z
            .union([LeadNurturingOrderByWithAggregationInputSchema.array(), LeadNurturingOrderByWithAggregationInputSchema])
            .optional(),
