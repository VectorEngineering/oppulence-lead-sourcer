...
export const LeadCompanyDetailsUpdateArgsSchema: z.ZodType<Prisma.LeadCompanyDetailsUpdateArgs> = z.object({
  select: LeadCompanyDetailsSelectSchema.optional(),
  include: LeadCompanyDetailsIncludeSchema.optional(),
  data: z.union([ LeadCompanyDetailsUpdateInputSchema,LeadCompanyDetailsUncheckedUpdateInputSchema ]),
  where: LeadCompanyDetailsWhereUniqueInputSchema,
}).strict() ;

export default LeadCompanyDetailsUpdateArgsSchema;
