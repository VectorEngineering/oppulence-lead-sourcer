...
export const LeadCompanyDetailsGroupByArgsSchema: z.ZodType<Prisma.LeadCompanyDetailsGroupByArgs> = z
    .object({
        where: LeadCompanyDetailsWhereInputSchema.optional(),
        orderBy: z
            .union([LeadCompanyDetailsOrderByWithAggregationInputSchema.array(), LeadCompanyDetailsOrderByWithAggregationInputSchema])
            .optional(),
