...
export const LeadSegmentationCreateArgsSchema: z.ZodType<Prisma.LeadSegmentationCreateArgs> = z.object({
  select: LeadSegmentationSelectSchema.optional(),
  include: LeadSegmentationIncludeSchema.optional(),
  data: z.union([ LeadSegmentationCreateInputSchema,LeadSegmentationUncheckedCreateInputSchema ]),
}).strict() ;

export default LeadSegmentationCreateArgsSchema;
