...
export const LeadPersonalDetailsGroupByArgsSchema: z.ZodType<Prisma.LeadPersonalDetailsGroupByArgs> = z
    .object({
        where: LeadPersonalDetailsWhereInputSchema.optional(),
        orderBy: z
            .union([LeadPersonalDetailsOrderByWithAggregationInputSchema.array(), LeadPersonalDetailsOrderByWithAggregationInputSchema])
            .optional(),
