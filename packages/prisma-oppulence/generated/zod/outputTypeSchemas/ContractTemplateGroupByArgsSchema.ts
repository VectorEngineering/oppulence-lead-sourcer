...
export const ContractTemplateGroupByArgsSchema: z.ZodType<Prisma.ContractTemplateGroupByArgs> = z
    .object({
        where: ContractTemplateWhereInputSchema.optional(),
        orderBy: z
            .union([ContractTemplateOrderByWithAggregationInputSchema.array(), ContractTemplateOrderByWithAggregationInputSchema])
            .optional(),
