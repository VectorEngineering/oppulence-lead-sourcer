...
export const OAuthAppUpdateArgsSchema: z.ZodType<Prisma.OAuthAppUpdateArgs> = z.object({
  select: OAuthAppSelectSchema.optional(),
  include: OAuthAppIncludeSchema.optional(),
  data: z.union([ OAuthAppUpdateInputSchema,OAuthAppUncheckedUpdateInputSchema ]),
  where: OAuthAppWhereUniqueInputSchema,
}).strict() ;

export default OAuthAppUpdateArgsSchema;
