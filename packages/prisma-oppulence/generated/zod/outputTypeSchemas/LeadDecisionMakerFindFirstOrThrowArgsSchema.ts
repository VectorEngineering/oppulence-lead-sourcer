...
export const LeadDecisionMakerFindFirstOrThrowArgsSchema: z.ZodType<Prisma.LeadDecisionMakerFindFirstOrThrowArgs> = z
    .object({
        ...
        orderBy: z
            .union([LeadDecisionMakerOrderByWithRelationInputSchema.array(), LeadDecisionMakerOrderByWithRelationInputSchema])
            .optional(),
...
export default LeadDecisionMakerFindFirstOrThrowArgsSchema
