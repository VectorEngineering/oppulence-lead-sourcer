...
export const CampaignVariantGroupByArgsSchema: z.ZodType<Prisma.CampaignVariantGroupByArgs> = z.object({
  where: CampaignVariantWhereInputSchema.optional(),
  orderBy: z.union([ CampaignVariantOrderByWithAggregationInputSchema.array(),CampaignVariantOrderByWithAggregationInputSchema ]).optional(),
