...
export const PipelineStageUpdateArgsSchema: z.ZodType<Prisma.PipelineStageUpdateArgs> = z.object({
  select: PipelineStageSelectSchema.optional(),
  include: PipelineStageIncludeSchema.optional(),
  data: z.union([ PipelineStageUpdateInputSchema,PipelineStageUncheckedUpdateInputSchema ]),
  where: PipelineStageWhereUniqueInputSchema,
}).strict() ;

export default PipelineStageUpdateArgsSchema;
