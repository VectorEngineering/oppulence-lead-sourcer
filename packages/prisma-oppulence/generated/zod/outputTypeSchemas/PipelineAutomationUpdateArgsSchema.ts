...
export const PipelineAutomationUpdateArgsSchema: z.ZodType<Prisma.PipelineAutomationUpdateArgs> = z.object({
  select: PipelineAutomationSelectSchema.optional(),
  include: PipelineAutomationIncludeSchema.optional(),
  data: z.union([ PipelineAutomationUpdateInputSchema,PipelineAutomationUncheckedUpdateInputSchema ]),
  where: PipelineAutomationWhereUniqueInputSchema,
}).strict() ;

export default PipelineAutomationUpdateArgsSchema;
