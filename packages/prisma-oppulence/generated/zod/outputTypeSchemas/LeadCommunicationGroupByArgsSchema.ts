...
export const LeadCommunicationGroupByArgsSchema: z.ZodType<Prisma.LeadCommunicationGroupByArgs> = z.object({
  where: LeadCommunicationWhereInputSchema.optional(),
  orderBy: z.union([ LeadCommunicationOrderByWithAggregationInputSchema.array(),LeadCommunicationOrderByWithAggregationInputSchema ]).optional(),
