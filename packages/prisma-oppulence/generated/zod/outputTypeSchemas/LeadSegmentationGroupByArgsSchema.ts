...
export const LeadSegmentationGroupByArgsSchema: z.ZodType<Prisma.LeadSegmentationGroupByArgs> = z
    .object({
        where: LeadSegmentationWhereInputSchema.optional(),
        orderBy: z
            .union([LeadSegmentationOrderByWithAggregationInputSchema.array(), LeadSegmentationOrderByWithAggregationInputSchema])
            .optional(),
