...
export const LeadCompanyDetailsCreateArgsSchema: z.ZodType<Prisma.LeadCompanyDetailsCreateArgs> = z.object({
  select: LeadCompanyDetailsSelectSchema.optional(),
  include: LeadCompanyDetailsIncludeSchema.optional(),
  data: z.union([ LeadCompanyDetailsCreateInputSchema,LeadCompanyDetailsUncheckedCreateInputSchema ]),
}).strict() ;

export default LeadCompanyDetailsCreateArgsSchema;
