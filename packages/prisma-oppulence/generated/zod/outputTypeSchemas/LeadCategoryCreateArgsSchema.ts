...
export const LeadCategoryCreateArgsSchema: z.ZodType<Prisma.LeadCategoryCreateArgs> = z.object({
  select: LeadCategorySelectSchema.optional(),
  include: LeadCategoryIncludeSchema.optional(),
  data: z.union([ LeadCategoryCreateInputSchema,LeadCategoryUncheckedCreateInputSchema ]),
}).strict() ;

export default LeadCategoryCreateArgsSchema;
