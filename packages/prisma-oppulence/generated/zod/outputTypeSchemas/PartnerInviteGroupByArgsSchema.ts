...
export const PartnerInviteGroupByArgsSchema: z.ZodType<Prisma.PartnerInviteGroupByArgs> = z.object({
  where: PartnerInviteWhereInputSchema.optional(),
  orderBy: z.union([ PartnerInviteOrderByWithAggregationInputSchema.array(),PartnerInviteOrderByWithAggregationInputSchema ]).optional(),
