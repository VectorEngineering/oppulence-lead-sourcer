...
export const LeadProductFitGroupByArgsSchema: z.ZodType<Prisma.LeadProductFitGroupByArgs> = z.object({
  where: LeadProductFitWhereInputSchema.optional(),
  orderBy: z.union([ LeadProductFitOrderByWithAggregationInputSchema.array(),LeadProductFitOrderByWithAggregationInputSchema ]).optional(),
