...
export const DealCompetitorGroupByArgsSchema: z.ZodType<Prisma.DealCompetitorGroupByArgs> = z
    .object({
        where: DealCompetitorWhereInputSchema.optional(),
        orderBy: z
            .union([DealCompetitorOrderByWithAggregationInputSchema.array(), DealCompetitorOrderByWithAggregationInputSchema])
            .optional(),
