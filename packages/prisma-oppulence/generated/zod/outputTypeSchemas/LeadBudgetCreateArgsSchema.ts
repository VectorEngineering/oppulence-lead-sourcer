...
export const LeadBudgetCreateArgsSchema: z.ZodType<Prisma.LeadBudgetCreateArgs> = z.object({
  select: LeadBudgetSelectSchema.optional(),
  include: LeadBudgetIncludeSchema.optional(),
  data: z.union([ LeadBudgetCreateInputSchema,LeadBudgetUncheckedCreateInputSchema ]),
}).strict() ;

export default LeadBudgetCreateArgsSchema;
