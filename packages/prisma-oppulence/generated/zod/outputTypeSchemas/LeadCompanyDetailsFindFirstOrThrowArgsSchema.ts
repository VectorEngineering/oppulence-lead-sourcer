...
export const LeadCompanyDetailsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.LeadCompanyDetailsFindFirstOrThrowArgs> = z
    .object({
        ...
        orderBy: z
            .union([LeadCompanyDetailsOrderByWithRelationInputSchema.array(), LeadCompanyDetailsOrderByWithRelationInputSchema])
            .optional(),
...
export default LeadCompanyDetailsFindFirstOrThrowArgsSchema
