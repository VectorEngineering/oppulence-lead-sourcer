...
export const LeadContactPreferenceGroupByArgsSchema: z.ZodType<Prisma.LeadContactPreferenceGroupByArgs> = z
    .object({
        where: LeadContactPreferenceWhereInputSchema.optional(),
        orderBy: z
            .union([LeadContactPreferenceOrderByWithAggregationInputSchema.array(), LeadContactPreferenceOrderByWithAggregationInputSchema])
            .optional(),
