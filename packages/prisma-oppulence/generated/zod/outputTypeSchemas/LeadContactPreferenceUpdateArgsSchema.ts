...
export const LeadContactPreferenceUpdateArgsSchema: z.ZodType<Prisma.LeadContactPreferenceUpdateArgs> = z.object({
  select: LeadContactPreferenceSelectSchema.optional(),
  include: LeadContactPreferenceIncludeSchema.optional(),
  data: z.union([ LeadContactPreferenceUpdateInputSchema,LeadContactPreferenceUncheckedUpdateInputSchema ]),
  where: LeadContactPreferenceWhereUniqueInputSchema,
}).strict() ;

export default LeadContactPreferenceUpdateArgsSchema;
