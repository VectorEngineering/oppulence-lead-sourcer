...
export const DealProductFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.DealProductFindUniqueOrThrowArgs> = z.object({
  select: DealProductSelectSchema.optional(),
  include: DealProductIncludeSchema.optional(),
  where: DealProductWhereUniqueInputSchema,
}).strict() ;

export default DealProductFindUniqueOrThrowArgsSchema;
