...
import { LeadProductFitArgsSchema } from './LeadProductFitArgsSchema'
...
export const LeadProductFitAssessmentUpdateArgsSchema: z.ZodType<Prisma.LeadProductFitAssessmentUpdateArgs> = z
    .object({
        select: LeadProductFitAssessmentSelectSchema.optional(),
        include: LeadProductFitAssessmentIncludeSchema.optional(),
        data: z.union([LeadProductFitAssessmentUpdateInputSchema, LeadProductFitAssessmentUncheckedUpdateInputSchema]),
        where: LeadProductFitAssessmentWhereUniqueInputSchema
    })
    .strict()

export default LeadProductFitAssessmentUpdateArgsSchema
