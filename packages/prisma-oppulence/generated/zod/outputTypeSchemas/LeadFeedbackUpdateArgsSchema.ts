...
export const LeadFeedbackUpdateArgsSchema: z.ZodType<Prisma.LeadFeedbackUpdateArgs> = z.object({
  select: LeadFeedbackSelectSchema.optional(),
  include: LeadFeedbackIncludeSchema.optional(),
  data: z.union([ LeadFeedbackUpdateInputSchema,LeadFeedbackUncheckedUpdateInputSchema ]),
  where: LeadFeedbackWhereUniqueInputSchema,
}).strict() ;

export default LeadFeedbackUpdateArgsSchema;
