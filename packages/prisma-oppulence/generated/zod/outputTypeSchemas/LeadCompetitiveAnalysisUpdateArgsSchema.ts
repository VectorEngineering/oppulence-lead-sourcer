...
export const LeadCompetitiveAnalysisUpdateArgsSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisUpdateArgs> = z.object({
  select: LeadCompetitiveAnalysisSelectSchema.optional(),
  include: LeadCompetitiveAnalysisIncludeSchema.optional(),
  data: z.union([ LeadCompetitiveAnalysisUpdateInputSchema,LeadCompetitiveAnalysisUncheckedUpdateInputSchema ]),
  where: LeadCompetitiveAnalysisWhereUniqueInputSchema,
}).strict() ;

export default LeadCompetitiveAnalysisUpdateArgsSchema;
