...
export const InboxShareCreateArgsSchema: z.ZodType<Prisma.InboxShareCreateArgs> = z.object({
  select: InboxShareSelectSchema.optional(),
  include: InboxShareIncludeSchema.optional(),
  data: z.union([ InboxShareCreateInputSchema,InboxShareUncheckedCreateInputSchema ]),
}).strict() ;

export default InboxShareCreateArgsSchema;
