...
export const DealProductUpdateArgsSchema: z.ZodType<Prisma.DealProductUpdateArgs> = z.object({
  select: DealProductSelectSchema.optional(),
  include: DealProductIncludeSchema.optional(),
  data: z.union([ DealProductUpdateInputSchema,DealProductUncheckedUpdateInputSchema ]),
  where: DealProductWhereUniqueInputSchema,
}).strict() ;

export default DealProductUpdateArgsSchema;
