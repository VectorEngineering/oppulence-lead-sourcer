...
export const LeadCompetitorSelectSchema: z.ZodType<Prisma.LeadCompetitorSelect> = z.object({
...
export const LeadCompetitorUpsertArgsSchema: z.ZodType<Prisma.LeadCompetitorUpsertArgs> = z.object({
  ...
  create: z.union([ LeadCompetitorCreateInputSchema,LeadCompetitorUncheckedCreateInputSchema ]),
  update: z.union([ LeadCompetitorUpdateInputSchema,LeadCompetitorUncheckedUpdateInputSchema ]),
}).strict() ;

export default LeadCompetitorUpsertArgsSchema;
