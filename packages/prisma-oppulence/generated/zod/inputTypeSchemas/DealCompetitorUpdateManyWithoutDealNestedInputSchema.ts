...
export const DealCompetitorUpdateManyWithoutDealNestedInputSchema: z.ZodType<Prisma.DealCompetitorUpdateManyWithoutDealNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => DealCompetitorUpsertWithWhereUniqueWithoutDealInputSchema),z.lazy(() => DealCompetitorUpsertWithWhereUniqueWithoutDealInputSchema).array() ]).optional(),
  createMany: z.lazy(() => DealCompetitorCreateManyDealInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => DealCompetitorWhereUniqueInputSchema),z.lazy(() => DealCompetitorWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => DealCompetitorWhereUniqueInputSchema),z.lazy(() => DealCompetitorWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => DealCompetitorWhereUniqueInputSchema),z.lazy(() => DealCompetitorWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => DealCompetitorWhereUniqueInputSchema),z.lazy(() => DealCompetitorWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => DealCompetitorUpdateWithWhereUniqueWithoutDealInputSchema),z.lazy(() => DealCompetitorUpdateWithWhereUniqueWithoutDealInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => DealCompetitorUpdateManyWithWhereWithoutDealInputSchema),z.lazy(() => DealCompetitorUpdateManyWithWhereWithoutDealInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => DealCompetitorScalarWhereInputSchema),z.lazy(() => DealCompetitorScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default DealCompetitorUpdateManyWithoutDealNestedInputSchema;
