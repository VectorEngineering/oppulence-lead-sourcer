...
export const UserUpdateOneWithoutDealNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDealNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => UserCreateWithoutDealInputSchema), z.lazy(() => UserUncheckedCreateWithoutDealInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => UserUpdateToOneWithWhereWithoutDealInputSchema),
                z.lazy(() => UserUpdateWithoutDealInputSchema),
                z.lazy(() => UserUncheckedUpdateWithoutDealInputSchema)
            ])
            .optional()
    })
    .strict()
