...
export const PipelineStageUpdateToOneWithWhereWithoutStageDurationInputSchema: z.ZodType<Prisma.PipelineStageUpdateToOneWithWhereWithoutStageDurationInput> = z.object({
  where: z.lazy(() => PipelineStageWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => PipelineStageUpdateWithoutStageDurationInputSchema),z.lazy(() => PipelineStageUncheckedUpdateWithoutStageDurationInputSchema) ]),
}).strict();
