...
export const PartnerUserUpdateWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.PartnerUserUpdateWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => PartnerUserWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => PartnerUserUpdateWithoutUserInputSchema),z.lazy(() => PartnerUserUncheckedUpdateWithoutUserInputSchema) ]),
}).strict();
