...
export const LeadFeedbackWhereInputSchema: z.ZodType<Prisma.LeadFeedbackWhereInput> = z
    .object({
        AND: z.union([z.lazy(() => LeadFeedbackWhereInputSchema), z.lazy(() => LeadFeedbackWhereInputSchema).array()]).optional(),
        OR: z
            .lazy(() => LeadFeedbackWhereInputSchema)
            .array()
            .optional(),
...
export default LeadFeedbackWhereInputSchema
