...
export const NestedEnumDealCompetitorStatusNullableWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumDealCompetitorStatusNullableWithAggregatesFilter> =
    z
        .object({
            equals: z
            ...
            not: z
                .union([
                    ...
                    z.lazy(() => NestedEnumDealCompetitorStatusNullableWithAggregatesFilterSchema)
                ])
                .optional()
                .nullable(),
...
export default NestedEnumDealCompetitorStatusNullableWithAggregatesFilterSchema
