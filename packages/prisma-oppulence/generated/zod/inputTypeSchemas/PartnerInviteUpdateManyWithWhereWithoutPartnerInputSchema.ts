...
export const PartnerInviteUpdateManyWithWhereWithoutPartnerInputSchema: z.ZodType<Prisma.PartnerInviteUpdateManyWithWhereWithoutPartnerInput> =
    z
        .object({
            where: z.lazy(() => PartnerInviteScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => PartnerInviteUpdateManyMutationInputSchema),
                z.lazy(() => PartnerInviteUncheckedUpdateManyWithoutPartnerInputSchema)
            ])
        })
        .strict()
