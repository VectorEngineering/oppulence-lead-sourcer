...
export const WebhookUpdateOneRequiredWithoutLogsNestedInputSchema: z.ZodType<Prisma.WebhookUpdateOneRequiredWithoutLogsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => WebhookUpdateToOneWithWhereWithoutLogsInputSchema),z.lazy(() => WebhookUpdateWithoutLogsInputSchema),z.lazy(() => WebhookUncheckedUpdateWithoutLogsInputSchema) ]).optional(),
}).strict();
