...
export const LeadCompetitiveHistoryScalarWhereInputSchema: z.ZodType<Prisma.LeadCompetitiveHistoryScalarWhereInput> = z
    .object({
        AND: z
            .union([
            ...
            .optional(),
        OR: z
            .lazy(() => LeadCompetitiveHistoryScalarWhereInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
