...
export const LeadScoreHistoryUpsertWithWhereUniqueWithoutLeadScoreInputSchema: z.ZodType<Prisma.LeadScoreHistoryUpsertWithWhereUniqueWithoutLeadScoreInput> = z.object({
  where: z.lazy(() => LeadScoreHistoryWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LeadScoreHistoryUpdateWithoutLeadScoreInputSchema),z.lazy(() => LeadScoreHistoryUncheckedUpdateWithoutLeadScoreInputSchema) ]),
  create: z.union([ z.lazy(() => LeadScoreHistoryCreateWithoutLeadScoreInputSchema),z.lazy(() => LeadScoreHistoryUncheckedCreateWithoutLeadScoreInputSchema) ]),
}).strict();
