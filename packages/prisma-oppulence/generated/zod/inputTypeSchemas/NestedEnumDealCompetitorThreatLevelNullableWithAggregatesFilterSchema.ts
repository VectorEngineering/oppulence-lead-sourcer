...
export const NestedEnumDealCompetitorThreatLevelNullableWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumDealCompetitorThreatLevelNullableWithAggregatesFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => DealCompetitorThreatLevelSchema),z.lazy(() => NestedEnumDealCompetitorThreatLevelNullableWithAggregatesFilterSchema) ]).optional().nullable(),
