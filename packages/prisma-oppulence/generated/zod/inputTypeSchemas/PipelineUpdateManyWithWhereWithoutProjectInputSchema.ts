...
export const PipelineUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.PipelineUpdateManyWithWhereWithoutProjectInput> = z
    .object({
        where: z.lazy(() => PipelineScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => PipelineUpdateManyMutationInputSchema),
            z.lazy(() => PipelineUncheckedUpdateManyWithoutProjectInputSchema)
        ])
    })
    .strict()
