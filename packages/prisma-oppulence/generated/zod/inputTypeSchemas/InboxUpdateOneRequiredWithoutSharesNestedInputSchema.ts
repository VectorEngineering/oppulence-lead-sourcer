...
export const InboxUpdateOneRequiredWithoutSharesNestedInputSchema: z.ZodType<Prisma.InboxUpdateOneRequiredWithoutSharesNestedInput> = z.object({
  create: z.union([ z.lazy(() => InboxCreateWithoutSharesInputSchema),z.lazy(() => InboxUncheckedCreateWithoutSharesInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => InboxUpdateToOneWithWhereWithoutSharesInputSchema),z.lazy(() => InboxUpdateWithoutSharesInputSchema),z.lazy(() => InboxUncheckedUpdateWithoutSharesInputSchema) ]).optional(),
}).strict();
