...
export const InboxLabelUpsertWithWhereUniqueWithoutInboxInputSchema: z.ZodType<Prisma.InboxLabelUpsertWithWhereUniqueWithoutInboxInput> = z.object({
  where: z.lazy(() => InboxLabelWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => InboxLabelUpdateWithoutInboxInputSchema),z.lazy(() => InboxLabelUncheckedUpdateWithoutInboxInputSchema) ]),
