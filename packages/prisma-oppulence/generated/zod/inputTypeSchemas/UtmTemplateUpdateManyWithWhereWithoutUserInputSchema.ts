...
export const UtmTemplateUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.UtmTemplateUpdateManyWithWhereWithoutUserInput> = z.object({
  where: z.lazy(() => UtmTemplateScalarWhereInputSchema),
  data: z.union([ z.lazy(() => UtmTemplateUpdateManyMutationInputSchema),z.lazy(() => UtmTemplateUncheckedUpdateManyWithoutUserInputSchema) ]),
}).strict();
