...
export const DealUpsertWithWhereUniqueWithoutAssignedToInputSchema: z.ZodType<Prisma.DealUpsertWithWhereUniqueWithoutAssignedToInput> = z.object({
  where: z.lazy(() => DealWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => DealUpdateWithoutAssignedToInputSchema),z.lazy(() => DealUncheckedUpdateWithoutAssignedToInputSchema) ]),
