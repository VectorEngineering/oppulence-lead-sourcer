...
export const PipelineStageUpdateWithWhereUniqueWithoutPipelineInputSchema: z.ZodType<Prisma.PipelineStageUpdateWithWhereUniqueWithoutPipelineInput> = z.object({
  where: z.lazy(() => PipelineStageWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => PipelineStageUpdateWithoutPipelineInputSchema),z.lazy(() => PipelineStageUncheckedUpdateWithoutPipelineInputSchema) ]),
}).strict();
