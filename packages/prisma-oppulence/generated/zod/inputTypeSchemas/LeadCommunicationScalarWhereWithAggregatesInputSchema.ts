...
export const LeadCommunicationScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadCommunicationScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => LeadCommunicationScalarWhereWithAggregatesInputSchema),z.lazy(() => LeadCommunicationScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadCommunicationScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LeadCommunicationScalarWhereWithAggregatesInputSchema),z.lazy(() => LeadCommunicationScalarWhereWithAggregatesInputSchema).array() ]).optional(),
