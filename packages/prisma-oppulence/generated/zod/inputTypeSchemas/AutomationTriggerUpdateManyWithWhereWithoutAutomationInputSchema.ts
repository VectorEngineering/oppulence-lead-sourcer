...
export const AutomationTriggerUpdateManyWithWhereWithoutAutomationInputSchema: z.ZodType<Prisma.AutomationTriggerUpdateManyWithWhereWithoutAutomationInput> =
    z
        .object({
            where: z.lazy(() => AutomationTriggerScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => AutomationTriggerUpdateManyMutationInputSchema),
                z.lazy(() => AutomationTriggerUncheckedUpdateManyWithoutAutomationInputSchema)
            ])
        })
        .strict()
