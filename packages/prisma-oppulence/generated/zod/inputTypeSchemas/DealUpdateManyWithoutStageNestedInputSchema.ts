...
export const DealUpdateManyWithoutStageNestedInputSchema: z.ZodType<Prisma.DealUpdateManyWithoutStageNestedInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => DealCreateWithoutStageInputSchema),
                z.lazy(() => DealCreateWithoutStageInputSchema).array(),
                z.lazy(() => DealUncheckedCreateWithoutStageInputSchema),
                z.lazy(() => DealUncheckedCreateWithoutStageInputSchema).array()
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => DealCreateOrConnectWithoutStageInputSchema),
                z.lazy(() => DealCreateOrConnectWithoutStageInputSchema).array()
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => DealUpsertWithWhereUniqueWithoutStageInputSchema),
                z.lazy(() => DealUpsertWithWhereUniqueWithoutStageInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => DealUpdateWithWhereUniqueWithoutStageInputSchema),
                z.lazy(() => DealUpdateWithWhereUniqueWithoutStageInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => DealUpdateManyWithWhereWithoutStageInputSchema),
                z.lazy(() => DealUpdateManyWithWhereWithoutStageInputSchema).array()
            ])
            .optional(),
...
export default DealUpdateManyWithoutStageNestedInputSchema
