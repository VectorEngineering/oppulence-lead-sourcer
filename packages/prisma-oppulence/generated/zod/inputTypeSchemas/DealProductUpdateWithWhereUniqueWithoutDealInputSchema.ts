...
export const DealProductUpdateWithWhereUniqueWithoutDealInputSchema: z.ZodType<Prisma.DealProductUpdateWithWhereUniqueWithoutDealInput> = z.object({
  where: z.lazy(() => DealProductWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => DealProductUpdateWithoutDealInputSchema),z.lazy(() => DealProductUncheckedUpdateWithoutDealInputSchema) ]),
}).strict();
