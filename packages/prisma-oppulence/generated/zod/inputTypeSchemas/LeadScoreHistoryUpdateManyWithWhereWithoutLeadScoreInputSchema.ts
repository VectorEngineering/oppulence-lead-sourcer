...
export const LeadScoreHistoryUpdateManyWithWhereWithoutLeadScoreInputSchema: z.ZodType<Prisma.LeadScoreHistoryUpdateManyWithWhereWithoutLeadScoreInput> =
    z
        .object({
            where: z.lazy(() => LeadScoreHistoryScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LeadScoreHistoryUpdateManyMutationInputSchema),
                z.lazy(() => LeadScoreHistoryUncheckedUpdateManyWithoutLeadScoreInputSchema)
            ])
        })
        .strict()
