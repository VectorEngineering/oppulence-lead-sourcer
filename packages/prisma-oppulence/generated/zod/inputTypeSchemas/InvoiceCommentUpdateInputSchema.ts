...
import { InvoiceUpdateOneRequiredWithoutCommentsNestedInputSchema } from './InvoiceUpdateOneRequiredWithoutCommentsNestedInputSchema';
import { InvoiceCommentUpdateOneWithoutRepliesNestedInputSchema } from './InvoiceCommentUpdateOneWithoutRepliesNestedInputSchema';
import { InvoiceCommentUpdateManyWithoutParentNestedInputSchema } from './InvoiceCommentUpdateManyWithoutParentNestedInputSchema';

export const InvoiceCommentUpdateInputSchema: z.ZodType<Prisma.InvoiceCommentUpdateInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  content: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  type: z.union([ z.lazy(() => InvoiceCommentTypeSchema),z.lazy(() => EnumInvoiceCommentTypeFieldUpdateOperationsInputSchema) ]).optional(),
  visibility: z.union([ z.lazy(() => InvoiceCommentVisibilitySchema),z.lazy(() => EnumInvoiceCommentVisibilityFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  threadPath: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  lastReplyAt: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  resolvedAt: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  resolvedBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  invoice: z.lazy(() => InvoiceUpdateOneRequiredWithoutCommentsNestedInputSchema).optional(),
  parent: z.lazy(() => InvoiceCommentUpdateOneWithoutRepliesNestedInputSchema).optional(),
  replies: z.lazy(() => InvoiceCommentUpdateManyWithoutParentNestedInputSchema).optional()
}).strict();

export default InvoiceCommentUpdateInputSchema;
