...
export const CampaignVariantUpdateWithWhereUniqueWithoutCampaignInputSchema: z.ZodType<Prisma.CampaignVariantUpdateWithWhereUniqueWithoutCampaignInput> = z.object({
  where: z.lazy(() => CampaignVariantWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => CampaignVariantUpdateWithoutCampaignInputSchema),z.lazy(() => CampaignVariantUncheckedUpdateWithoutCampaignInputSchema) ]),
}).strict();
