...
export const InstalledIntegrationUncheckedUpdateManyWithoutIntegrationNestedInputSchema: z.ZodType<Prisma.InstalledIntegrationUncheckedUpdateManyWithoutIntegrationNestedInput> =
    z
        .object({
            create: z
                .union([
