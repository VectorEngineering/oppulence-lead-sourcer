...
export const ContractEventUpdateWithWhereUniqueWithoutContractInputSchema: z.ZodType<Prisma.ContractEventUpdateWithWhereUniqueWithoutContractInput> =
    z
        .object({
            where: z.lazy(() => ContractEventWhereUniqueInputSchema),
            data: z.union([
                z.lazy(() => ContractEventUpdateWithoutContractInputSchema),
                z.lazy(() => ContractEventUncheckedUpdateWithoutContractInputSchema)
            ])
        })
        .strict()
