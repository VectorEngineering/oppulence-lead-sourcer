...
export const LeadContactPreferenceUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadContactPreferenceUncheckedUpdateManyWithoutLeadNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => LeadContactPreferenceCreateWithoutLeadInputSchema),
                    z.lazy(() => LeadContactPreferenceCreateWithoutLeadInputSchema).array(),
                    z.lazy(() => LeadContactPreferenceUncheckedCreateWithoutLeadInputSchema),
                    z.lazy(() => LeadContactPreferenceUncheckedCreateWithoutLeadInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => LeadContactPreferenceCreateOrConnectWithoutLeadInputSchema),
                    z.lazy(() => LeadContactPreferenceCreateOrConnectWithoutLeadInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => LeadContactPreferenceUpsertWithWhereUniqueWithoutLeadInputSchema),
                    z.lazy(() => LeadContactPreferenceUpsertWithWhereUniqueWithoutLeadInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => LeadContactPreferenceCreateManyLeadInputEnvelopeSchema).optional(),
            set: z
                .union([
                    z.lazy(() => LeadContactPreferenceWhereUniqueInputSchema),
                    z.lazy(() => LeadContactPreferenceWhereUniqueInputSchema).array()
                ])
                .optional(),
            disconnect: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadContactPreferenceUpdateWithWhereUniqueWithoutLeadInputSchema),
                    z.lazy(() => LeadContactPreferenceUpdateWithWhereUniqueWithoutLeadInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => LeadContactPreferenceUpdateManyWithWhereWithoutLeadInputSchema),
                    z.lazy(() => LeadContactPreferenceUpdateManyWithWhereWithoutLeadInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
...
export default LeadContactPreferenceUncheckedUpdateManyWithoutLeadNestedInputSchema
