...
export const YearInReviewUncheckedUpdateManyWithoutWorkspaceNestedInputSchema: z.ZodType<Prisma.YearInReviewUncheckedUpdateManyWithoutWorkspaceNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => YearInReviewUpsertWithWhereUniqueWithoutWorkspaceInputSchema),
                    z.lazy(() => YearInReviewUpsertWithWhereUniqueWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => YearInReviewUpdateWithWhereUniqueWithoutWorkspaceInputSchema),
                    z.lazy(() => YearInReviewUpdateWithWhereUniqueWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => YearInReviewUpdateManyWithWhereWithoutWorkspaceInputSchema),
                    z.lazy(() => YearInReviewUpdateManyWithWhereWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([z.lazy(() => YearInReviewScalarWhereInputSchema), z.lazy(() => YearInReviewScalarWhereInputSchema).array()])
                .optional()
        })
        .strict()

export default YearInReviewUncheckedUpdateManyWithoutWorkspaceNestedInputSchema
