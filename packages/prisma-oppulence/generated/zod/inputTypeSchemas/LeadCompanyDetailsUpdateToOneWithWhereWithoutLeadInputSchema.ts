...
export const LeadCompanyDetailsUpdateToOneWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadCompanyDetailsUpdateToOneWithWhereWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadCompanyDetailsWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => LeadCompanyDetailsUpdateWithoutLeadInputSchema),z.lazy(() => LeadCompanyDetailsUncheckedUpdateWithoutLeadInputSchema) ]),
}).strict();
