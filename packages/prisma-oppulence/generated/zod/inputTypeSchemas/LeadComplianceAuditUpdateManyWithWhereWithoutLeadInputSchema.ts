...
export const LeadComplianceAuditUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadComplianceAuditUpdateManyWithWhereWithoutLeadInput> =
    z
        .object({
            where: z.lazy(() => LeadComplianceAuditScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LeadComplianceAuditUpdateManyMutationInputSchema),
                z.lazy(() => LeadComplianceAuditUncheckedUpdateManyWithoutLeadInputSchema)
            ])
        })
        .strict()
