...
export const LeadLabelUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadLabelUpdateManyWithWhereWithoutLeadInput> = z
    .object({
        where: z.lazy(() => LeadLabelScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => LeadLabelUpdateManyMutationInputSchema),
            z.lazy(() => LeadLabelUncheckedUpdateManyWithoutLeadInputSchema)
        ])
    })
    .strict()
