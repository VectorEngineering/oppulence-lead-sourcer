...
export const ProjectUpdateOneRequiredWithoutInvitesNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutInvitesNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutInvitesInputSchema),
                    z.lazy(() => ProjectUpdateWithoutInvitesInputSchema),
                    z.lazy(() => ProjectUncheckedUpdateWithoutInvitesInputSchema)
                ])
                .optional()
        })
        .strict()
