...
export const LeadTouchpointUpdateManyWithWhereWithoutCampaignInputSchema: z.ZodType<Prisma.LeadTouchpointUpdateManyWithWhereWithoutCampaignInput> = z.object({
  where: z.lazy(() => LeadTouchpointScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LeadTouchpointUpdateManyMutationInputSchema),z.lazy(() => LeadTouchpointUncheckedUpdateManyWithoutCampaignInputSchema) ]),
}).strict();
