...
export const LeadUpsertWithWhereUniqueWithoutCategoriesInputSchema: z.ZodType<Prisma.LeadUpsertWithWhereUniqueWithoutCategoriesInput> = z.object({
  where: z.lazy(() => LeadWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LeadUpdateWithoutCategoriesInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutCategoriesInputSchema) ]),
  create: z.union([ z.lazy(() => LeadCreateWithoutCategoriesInputSchema),z.lazy(() => LeadUncheckedCreateWithoutCategoriesInputSchema) ]),
}).strict();
