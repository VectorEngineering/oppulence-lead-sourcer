...
export const LeadUpdateOneRequiredWithoutLeadSegmentationNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutLeadSegmentationNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCreateWithoutLeadSegmentationInputSchema),z.lazy(() => LeadUncheckedCreateWithoutLeadSegmentationInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateToOneWithWhereWithoutLeadSegmentationInputSchema),z.lazy(() => LeadUpdateWithoutLeadSegmentationInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutLeadSegmentationInputSchema) ]).optional(),
}).strict();
