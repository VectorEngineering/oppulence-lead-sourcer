...
export const InvoiceUncheckedUpdateManyWithoutCustomerNestedInputSchema: z.ZodType<Prisma.InvoiceUncheckedUpdateManyWithoutCustomerNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => InvoiceCreateWithoutCustomerInputSchema),
                    z.lazy(() => InvoiceCreateWithoutCustomerInputSchema).array(),
                    z.lazy(() => InvoiceUncheckedCreateWithoutCustomerInputSchema),
                    z.lazy(() => InvoiceUncheckedCreateWithoutCustomerInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => InvoiceCreateOrConnectWithoutCustomerInputSchema),
                    z.lazy(() => InvoiceCreateOrConnectWithoutCustomerInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => InvoiceUpsertWithWhereUniqueWithoutCustomerInputSchema),
                    z.lazy(() => InvoiceUpsertWithWhereUniqueWithoutCustomerInputSchema).array()
                ])
                .optional(),
            ...
            disconnect: z
                .union([z.lazy(() => InvoiceWhereUniqueInputSchema), z.lazy(() => InvoiceWhereUniqueInputSchema).array()])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => InvoiceUpdateWithWhereUniqueWithoutCustomerInputSchema),
                    z.lazy(() => InvoiceUpdateWithWhereUniqueWithoutCustomerInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => InvoiceUpdateManyWithWhereWithoutCustomerInputSchema),
                    z.lazy(() => InvoiceUpdateManyWithWhereWithoutCustomerInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([z.lazy(() => InvoiceScalarWhereInputSchema), z.lazy(() => InvoiceScalarWhereInputSchema).array()])
                .optional()
        })
        .strict()
