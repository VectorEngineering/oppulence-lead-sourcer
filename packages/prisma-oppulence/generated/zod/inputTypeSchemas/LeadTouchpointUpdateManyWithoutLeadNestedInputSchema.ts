...
export const LeadTouchpointUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadTouchpointUpdateManyWithoutLeadNestedInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => LeadTouchpointCreateWithoutLeadInputSchema),
                z.lazy(() => LeadTouchpointCreateWithoutLeadInputSchema).array(),
                z.lazy(() => LeadTouchpointUncheckedCreateWithoutLeadInputSchema),
                z.lazy(() => LeadTouchpointUncheckedCreateWithoutLeadInputSchema).array()
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => LeadTouchpointCreateOrConnectWithoutLeadInputSchema),
                z.lazy(() => LeadTouchpointCreateOrConnectWithoutLeadInputSchema).array()
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => LeadTouchpointUpsertWithWhereUniqueWithoutLeadInputSchema),
                z.lazy(() => LeadTouchpointUpsertWithWhereUniqueWithoutLeadInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LeadTouchpointUpdateWithWhereUniqueWithoutLeadInputSchema),
                z.lazy(() => LeadTouchpointUpdateWithWhereUniqueWithoutLeadInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => LeadTouchpointUpdateManyWithWhereWithoutLeadInputSchema),
                z.lazy(() => LeadTouchpointUpdateManyWithWhereWithoutLeadInputSchema).array()
            ])
            .optional(),
        deleteMany: z
...
export default LeadTouchpointUpdateManyWithoutLeadNestedInputSchema
