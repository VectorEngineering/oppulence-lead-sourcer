...
export const LinkWebhookUpdateManyWithWhereWithoutWebhookInputSchema: z.ZodType<Prisma.LinkWebhookUpdateManyWithWhereWithoutWebhookInput> =
    z
        .object({
            where: z.lazy(() => LinkWebhookScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LinkWebhookUpdateManyMutationInputSchema),
                z.lazy(() => LinkWebhookUncheckedUpdateManyWithoutWebhookInputSchema)
            ])
        })
        .strict()
