...
export const LeadScoreUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadScoreUpdateManyWithoutLeadNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => LeadScoreUpsertWithWhereUniqueWithoutLeadInputSchema),
                z.lazy(() => LeadScoreUpsertWithWhereUniqueWithoutLeadInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LeadScoreUpdateWithWhereUniqueWithoutLeadInputSchema),
                z.lazy(() => LeadScoreUpdateWithWhereUniqueWithoutLeadInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => LeadScoreUpdateManyWithWhereWithoutLeadInputSchema),
                z.lazy(() => LeadScoreUpdateManyWithWhereWithoutLeadInputSchema).array()
            ])
            .optional(),
        deleteMany: z
            .union([z.lazy(() => LeadScoreScalarWhereInputSchema), z.lazy(() => LeadScoreScalarWhereInputSchema).array()])
            .optional()
    })
    .strict()

export default LeadScoreUpdateManyWithoutLeadNestedInputSchema
