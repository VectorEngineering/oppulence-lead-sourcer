...
import { LeadCreateNestedOneWithoutLeadScoreInputSchema } from './LeadCreateNestedOneWithoutLeadScoreInputSchema';
import { LeadScoreHistoryCreateNestedManyWithoutLeadScoreInputSchema } from './LeadScoreHistoryCreateNestedManyWithoutLeadScoreInputSchema';

export const LeadScoreCreateInputSchema: z.ZodType<Prisma.LeadScoreCreateInput> = z.object({
  ...
  lead: z.lazy(() => LeadCreateNestedOneWithoutLeadScoreInputSchema),
  scoreHistory: z.lazy(() => LeadScoreHistoryCreateNestedManyWithoutLeadScoreInputSchema).optional()
}).strict();

export default LeadScoreCreateInputSchema;
