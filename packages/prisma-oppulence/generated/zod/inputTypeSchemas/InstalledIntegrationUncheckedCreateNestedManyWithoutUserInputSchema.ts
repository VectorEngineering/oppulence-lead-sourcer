...
export const InstalledIntegrationUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.InstalledIntegrationUncheckedCreateNestedManyWithoutUserInput> =
    z
        .object({
            create: z
                .union([
