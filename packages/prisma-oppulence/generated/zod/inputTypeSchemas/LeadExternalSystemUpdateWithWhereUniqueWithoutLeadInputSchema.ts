...
export const LeadExternalSystemUpdateWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadExternalSystemUpdateWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadExternalSystemWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadExternalSystemUpdateWithoutLeadInputSchema),z.lazy(() => LeadExternalSystemUncheckedUpdateWithoutLeadInputSchema) ]),
}).strict();
