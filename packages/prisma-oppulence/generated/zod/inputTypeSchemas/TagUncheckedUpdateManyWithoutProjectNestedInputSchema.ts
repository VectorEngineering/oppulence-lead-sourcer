...
export const TagUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.TagUncheckedUpdateManyWithoutProjectNestedInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => TagCreateWithoutProjectInputSchema),
                z.lazy(() => TagCreateWithoutProjectInputSchema).array(),
                z.lazy(() => TagUncheckedCreateWithoutProjectInputSchema),
                z.lazy(() => TagUncheckedCreateWithoutProjectInputSchema).array()
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => TagCreateOrConnectWithoutProjectInputSchema),
                z.lazy(() => TagCreateOrConnectWithoutProjectInputSchema).array()
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => TagUpsertWithWhereUniqueWithoutProjectInputSchema),
                z.lazy(() => TagUpsertWithWhereUniqueWithoutProjectInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => TagUpdateWithWhereUniqueWithoutProjectInputSchema),
                z.lazy(() => TagUpdateWithWhereUniqueWithoutProjectInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => TagUpdateManyWithWhereWithoutProjectInputSchema),
                z.lazy(() => TagUpdateManyWithWhereWithoutProjectInputSchema).array()
            ])
            .optional(),
...
export default TagUncheckedUpdateManyWithoutProjectNestedInputSchema
