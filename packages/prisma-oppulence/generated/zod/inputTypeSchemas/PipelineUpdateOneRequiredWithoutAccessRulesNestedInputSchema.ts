...
export const PipelineUpdateOneRequiredWithoutAccessRulesNestedInputSchema: z.ZodType<Prisma.PipelineUpdateOneRequiredWithoutAccessRulesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => PipelineUpdateToOneWithWhereWithoutAccessRulesInputSchema),z.lazy(() => PipelineUpdateWithoutAccessRulesInputSchema),z.lazy(() => PipelineUncheckedUpdateWithoutAccessRulesInputSchema) ]).optional(),
}).strict();
