...
export const LeadUncheckedUpdateManyWithoutAssignedToNestedInputSchema: z.ZodType<Prisma.LeadUncheckedUpdateManyWithoutAssignedToNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCreateWithoutAssignedToInputSchema),z.lazy(() => LeadCreateWithoutAssignedToInputSchema).array(),z.lazy(() => LeadUncheckedCreateWithoutAssignedToInputSchema),z.lazy(() => LeadUncheckedCreateWithoutAssignedToInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LeadCreateOrConnectWithoutAssignedToInputSchema),z.lazy(() => LeadCreateOrConnectWithoutAssignedToInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LeadUpsertWithWhereUniqueWithoutAssignedToInputSchema),z.lazy(() => LeadUpsertWithWhereUniqueWithoutAssignedToInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateWithWhereUniqueWithoutAssignedToInputSchema),z.lazy(() => LeadUpdateWithWhereUniqueWithoutAssignedToInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadUpdateManyWithWhereWithoutAssignedToInputSchema),z.lazy(() => LeadUpdateManyWithWhereWithoutAssignedToInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadScalarWhereInputSchema),z.lazy(() => LeadScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadUncheckedUpdateManyWithoutAssignedToNestedInputSchema;
