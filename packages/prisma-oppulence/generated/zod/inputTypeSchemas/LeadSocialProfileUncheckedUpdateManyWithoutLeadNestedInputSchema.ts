...
export const LeadSocialProfileUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadSocialProfileUncheckedUpdateManyWithoutLeadNestedInput> =
    z
        .object({
            create: z
                .union([
