...
export const PipelineAccessRuleUpsertWithoutConditionsInputSchema: z.ZodType<Prisma.PipelineAccessRuleUpsertWithoutConditionsInput> = z.object({
  update: z.union([ z.lazy(() => PipelineAccessRuleUpdateWithoutConditionsInputSchema),z.lazy(() => PipelineAccessRuleUncheckedUpdateWithoutConditionsInputSchema) ]),
  create: z.union([ z.lazy(() => PipelineAccessRuleCreateWithoutConditionsInputSchema),z.lazy(() => PipelineAccessRuleUncheckedCreateWithoutConditionsInputSchema) ]),
