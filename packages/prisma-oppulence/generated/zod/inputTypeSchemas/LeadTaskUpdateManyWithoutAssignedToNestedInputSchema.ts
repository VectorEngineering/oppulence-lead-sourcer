...
export const LeadTaskUpdateManyWithoutAssignedToNestedInputSchema: z.ZodType<Prisma.LeadTaskUpdateManyWithoutAssignedToNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadTaskCreateWithoutAssignedToInputSchema),z.lazy(() => LeadTaskCreateWithoutAssignedToInputSchema).array(),z.lazy(() => LeadTaskUncheckedCreateWithoutAssignedToInputSchema),z.lazy(() => LeadTaskUncheckedCreateWithoutAssignedToInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LeadTaskCreateOrConnectWithoutAssignedToInputSchema),z.lazy(() => LeadTaskCreateOrConnectWithoutAssignedToInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LeadTaskUpsertWithWhereUniqueWithoutAssignedToInputSchema),z.lazy(() => LeadTaskUpsertWithWhereUniqueWithoutAssignedToInputSchema).array() ]).optional(),
  ...
  disconnect: z.union([ z.lazy(() => LeadTaskWhereUniqueInputSchema),z.lazy(() => LeadTaskWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadTaskUpdateWithWhereUniqueWithoutAssignedToInputSchema),z.lazy(() => LeadTaskUpdateWithWhereUniqueWithoutAssignedToInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadTaskUpdateManyWithWhereWithoutAssignedToInputSchema),z.lazy(() => LeadTaskUpdateManyWithWhereWithoutAssignedToInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadTaskScalarWhereInputSchema),z.lazy(() => LeadTaskScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadTaskUpdateManyWithoutAssignedToNestedInputSchema;
