...
export const InvoiceTemplateCreateManyInputSchema: z.ZodType<Prisma.InvoiceTemplateCreateManyInput> = z.object({
...
export default InvoiceTemplateCreateManyInputSchema;
