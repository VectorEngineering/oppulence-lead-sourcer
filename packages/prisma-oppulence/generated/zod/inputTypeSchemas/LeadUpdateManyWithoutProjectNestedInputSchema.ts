...
export const LeadUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.LeadUpdateManyWithoutProjectNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCreateWithoutProjectInputSchema),z.lazy(() => LeadCreateWithoutProjectInputSchema).array(),z.lazy(() => LeadUncheckedCreateWithoutProjectInputSchema),z.lazy(() => LeadUncheckedCreateWithoutProjectInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LeadCreateOrConnectWithoutProjectInputSchema),z.lazy(() => LeadCreateOrConnectWithoutProjectInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LeadUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => LeadUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => LeadUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => LeadUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadScalarWhereInputSchema),z.lazy(() => LeadScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadUpdateManyWithoutProjectNestedInputSchema;
