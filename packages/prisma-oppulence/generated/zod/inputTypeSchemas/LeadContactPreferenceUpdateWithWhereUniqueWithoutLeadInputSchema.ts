...
export const LeadContactPreferenceUpdateWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadContactPreferenceUpdateWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadContactPreferenceWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadContactPreferenceUpdateWithoutLeadInputSchema),z.lazy(() => LeadContactPreferenceUncheckedUpdateWithoutLeadInputSchema) ]),
}).strict();
