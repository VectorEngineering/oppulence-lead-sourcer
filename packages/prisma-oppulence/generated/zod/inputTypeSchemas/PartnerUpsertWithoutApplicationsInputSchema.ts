...
export const PartnerUpsertWithoutApplicationsInputSchema: z.ZodType<Prisma.PartnerUpsertWithoutApplicationsInput> = z.object({
  update: z.union([ z.lazy(() => PartnerUpdateWithoutApplicationsInputSchema),z.lazy(() => PartnerUncheckedUpdateWithoutApplicationsInputSchema) ]),
  create: z.union([ z.lazy(() => PartnerCreateWithoutApplicationsInputSchema),z.lazy(() => PartnerUncheckedCreateWithoutApplicationsInputSchema) ]),
