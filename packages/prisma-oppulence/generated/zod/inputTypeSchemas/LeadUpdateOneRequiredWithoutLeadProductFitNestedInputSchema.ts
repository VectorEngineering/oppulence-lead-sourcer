...
export const LeadUpdateOneRequiredWithoutLeadProductFitNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutLeadProductFitNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadUpdateToOneWithWhereWithoutLeadProductFitInputSchema),
                    z.lazy(() => LeadUpdateWithoutLeadProductFitInputSchema),
                    z.lazy(() => LeadUncheckedUpdateWithoutLeadProductFitInputSchema)
                ])
                .optional()
        })
        .strict()
