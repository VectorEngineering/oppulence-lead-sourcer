...
export const ProjectUpdateOneRequiredWithoutTransactionCategoryNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutTransactionCategoryNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutTransactionCategoryInputSchema),
