...
export const LeadNurturingWhereUniqueInputSchema: z.ZodType<Prisma.LeadNurturingWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    leadId: z.string()
  }),
...
.and(z.object({
  ...
  OR: z.lazy(() => LeadNurturingWhereInputSchema).array().optional(),
  ...
  currentStep: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
...
export default LeadNurturingWhereUniqueInputSchema;
