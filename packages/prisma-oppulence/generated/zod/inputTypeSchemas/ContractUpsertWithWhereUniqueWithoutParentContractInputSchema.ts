...
export const ContractUpsertWithWhereUniqueWithoutParentContractInputSchema: z.ZodType<Prisma.ContractUpsertWithWhereUniqueWithoutParentContractInput> =
    z
        .object({
            where: z.lazy(() => ContractWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => ContractUpdateWithoutParentContractInputSchema),
                z.lazy(() => ContractUncheckedUpdateWithoutParentContractInputSchema)
            ]),
            create: z.union([
