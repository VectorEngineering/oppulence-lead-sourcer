...
export const LeadCategoryUpdateManyWithWhereWithoutLeadsInputSchema: z.ZodType<Prisma.LeadCategoryUpdateManyWithWhereWithoutLeadsInput> = z
    .object({
        where: z.lazy(() => LeadCategoryScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => LeadCategoryUpdateManyMutationInputSchema),
            z.lazy(() => LeadCategoryUncheckedUpdateManyWithoutLeadsInputSchema)
        ])
    })
    .strict()
