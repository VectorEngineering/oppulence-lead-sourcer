...
export const LeadUpdateOneRequiredWithoutRisksNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutRisksNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => LeadCreateWithoutRisksInputSchema), z.lazy(() => LeadUncheckedCreateWithoutRisksInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LeadUpdateToOneWithWhereWithoutRisksInputSchema),
                z.lazy(() => LeadUpdateWithoutRisksInputSchema),
                z.lazy(() => LeadUncheckedUpdateWithoutRisksInputSchema)
            ])
            .optional()
    })
    .strict()
