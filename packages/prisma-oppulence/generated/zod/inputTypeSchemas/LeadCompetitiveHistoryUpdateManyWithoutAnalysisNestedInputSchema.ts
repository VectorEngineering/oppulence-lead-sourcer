...
export const LeadCompetitiveHistoryUpdateManyWithoutAnalysisNestedInputSchema: z.ZodType<Prisma.LeadCompetitiveHistoryUpdateManyWithoutAnalysisNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => LeadCompetitiveHistoryCreateWithoutAnalysisInputSchema),
                    z.lazy(() => LeadCompetitiveHistoryCreateWithoutAnalysisInputSchema).array(),
                    z.lazy(() => LeadCompetitiveHistoryUncheckedCreateWithoutAnalysisInputSchema),
                    z.lazy(() => LeadCompetitiveHistoryUncheckedCreateWithoutAnalysisInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => LeadCompetitiveHistoryCreateOrConnectWithoutAnalysisInputSchema),
                    z.lazy(() => LeadCompetitiveHistoryCreateOrConnectWithoutAnalysisInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => LeadCompetitiveHistoryUpsertWithWhereUniqueWithoutAnalysisInputSchema),
                    z.lazy(() => LeadCompetitiveHistoryUpsertWithWhereUniqueWithoutAnalysisInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => LeadCompetitiveHistoryCreateManyAnalysisInputEnvelopeSchema).optional(),
            set: z
                .union([
                    z.lazy(() => LeadCompetitiveHistoryWhereUniqueInputSchema),
                    z.lazy(() => LeadCompetitiveHistoryWhereUniqueInputSchema).array()
                ])
                .optional(),
            disconnect: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadCompetitiveHistoryUpdateWithWhereUniqueWithoutAnalysisInputSchema),
                    z.lazy(() => LeadCompetitiveHistoryUpdateWithWhereUniqueWithoutAnalysisInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => LeadCompetitiveHistoryUpdateManyWithWhereWithoutAnalysisInputSchema),
                    z.lazy(() => LeadCompetitiveHistoryUpdateManyWithWhereWithoutAnalysisInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
                    z.lazy(() => LeadCompetitiveHistoryScalarWhereInputSchema),
                    z.lazy(() => LeadCompetitiveHistoryScalarWhereInputSchema).array()
                ])
                .optional()
        })
        .strict()

export default LeadCompetitiveHistoryUpdateManyWithoutAnalysisNestedInputSchema
