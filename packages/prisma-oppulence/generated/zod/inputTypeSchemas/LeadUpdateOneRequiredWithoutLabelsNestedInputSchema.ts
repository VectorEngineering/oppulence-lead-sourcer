...
export const LeadUpdateOneRequiredWithoutLabelsNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutLabelsNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => LeadCreateWithoutLabelsInputSchema), z.lazy(() => LeadUncheckedCreateWithoutLabelsInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LeadUpdateToOneWithWhereWithoutLabelsInputSchema),
                z.lazy(() => LeadUpdateWithoutLabelsInputSchema),
                z.lazy(() => LeadUncheckedUpdateWithoutLabelsInputSchema)
            ])
            .optional()
    })
    .strict()
