...
export const OAuthCodeUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.OAuthCodeUpdateManyWithWhereWithoutProjectInput> = z.object({
  where: z.lazy(() => OAuthCodeScalarWhereInputSchema),
  data: z.union([ z.lazy(() => OAuthCodeUpdateManyMutationInputSchema),z.lazy(() => OAuthCodeUncheckedUpdateManyWithoutProjectInputSchema) ]),
}).strict();
