...
export const DocumentAnnotationUncheckedUpdateManyWithoutDocumentNestedInputSchema: z.ZodType<Prisma.DocumentAnnotationUncheckedUpdateManyWithoutDocumentNestedInput> =
    z
        .object({
            create: z
                .union([
