...
export const LeadDecisionMakerUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadDecisionMakerUncheckedUpdateManyWithoutLeadNestedInput> =
    z
        .object({
            create: z
                .union([
