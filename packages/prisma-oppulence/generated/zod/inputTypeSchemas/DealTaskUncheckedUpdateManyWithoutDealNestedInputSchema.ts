...
export const DealTaskUncheckedUpdateManyWithoutDealNestedInputSchema: z.ZodType<Prisma.DealTaskUncheckedUpdateManyWithoutDealNestedInput> = z.object({
  create: z.union([ z.lazy(() => DealTaskCreateWithoutDealInputSchema),z.lazy(() => DealTaskCreateWithoutDealInputSchema).array(),z.lazy(() => DealTaskUncheckedCreateWithoutDealInputSchema),z.lazy(() => DealTaskUncheckedCreateWithoutDealInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => DealTaskCreateOrConnectWithoutDealInputSchema),z.lazy(() => DealTaskCreateOrConnectWithoutDealInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => DealTaskUpsertWithWhereUniqueWithoutDealInputSchema),z.lazy(() => DealTaskUpsertWithWhereUniqueWithoutDealInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => DealTaskUpdateWithWhereUniqueWithoutDealInputSchema),z.lazy(() => DealTaskUpdateWithWhereUniqueWithoutDealInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => DealTaskUpdateManyWithWhereWithoutDealInputSchema),z.lazy(() => DealTaskUpdateManyWithWhereWithoutDealInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => DealTaskScalarWhereInputSchema),z.lazy(() => DealTaskScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default DealTaskUncheckedUpdateManyWithoutDealNestedInputSchema;
