...
export const PipelineAccessRuleUpdateOneRequiredWithoutConditionsNestedInputSchema: z.ZodType<Prisma.PipelineAccessRuleUpdateOneRequiredWithoutConditionsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => PipelineAccessRuleUpdateToOneWithWhereWithoutConditionsInputSchema),
