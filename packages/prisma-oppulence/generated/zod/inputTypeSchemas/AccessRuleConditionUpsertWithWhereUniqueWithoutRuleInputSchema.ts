...
export const AccessRuleConditionUpsertWithWhereUniqueWithoutRuleInputSchema: z.ZodType<Prisma.AccessRuleConditionUpsertWithWhereUniqueWithoutRuleInput> = z.object({
  where: z.lazy(() => AccessRuleConditionWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => AccessRuleConditionUpdateWithoutRuleInputSchema),z.lazy(() => AccessRuleConditionUncheckedUpdateWithoutRuleInputSchema) ]),
  create: z.union([ z.lazy(() => AccessRuleConditionCreateWithoutRuleInputSchema),z.lazy(() => AccessRuleConditionUncheckedCreateWithoutRuleInputSchema) ]),
}).strict();
