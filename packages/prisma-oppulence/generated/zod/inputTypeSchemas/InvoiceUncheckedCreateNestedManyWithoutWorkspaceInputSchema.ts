...
export const InvoiceUncheckedCreateNestedManyWithoutWorkspaceInputSchema: z.ZodType<Prisma.InvoiceUncheckedCreateNestedManyWithoutWorkspaceInput> =
    z
        .object({
            create: z
                .union([
...
export default InvoiceUncheckedCreateNestedManyWithoutWorkspaceInputSchema
