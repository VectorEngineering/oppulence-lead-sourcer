...
import { z } from 'zod';
import { ContractVersionContractIdVersionNumberCompoundUniqueInputSchema } from './ContractVersionContractIdVersionNumberCompoundUniqueInputSchema';
...
export const ContractVersionWhereUniqueInputSchema: z.ZodType<Prisma.ContractVersionWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    contractId_versionNumber: z.lazy(() => ContractVersionContractIdVersionNumberCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.string().cuid(),
  }),
...
.and(z.object({
  ...
  contractId_versionNumber: z.lazy(() => ContractVersionContractIdVersionNumberCompoundUniqueInputSchema).optional(),
  AND: z.union([ z.lazy(() => ContractVersionWhereInputSchema),z.lazy(() => ContractVersionWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ContractVersionWhereInputSchema).array().optional(),
...
export default ContractVersionWhereUniqueInputSchema;
