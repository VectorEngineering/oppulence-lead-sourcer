...
export const LeadTaskUpdateWithWhereUniqueWithoutAssignedToInputSchema: z.ZodType<Prisma.LeadTaskUpdateWithWhereUniqueWithoutAssignedToInput> = z.object({
  where: z.lazy(() => LeadTaskWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadTaskUpdateWithoutAssignedToInputSchema),z.lazy(() => LeadTaskUncheckedUpdateWithoutAssignedToInputSchema) ]),
}).strict();
