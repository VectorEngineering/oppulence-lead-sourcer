...
export const LeadUncheckedUpdateManyWithoutTagsNestedInputSchema: z.ZodType<Prisma.LeadUncheckedUpdateManyWithoutTagsNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCreateWithoutTagsInputSchema),z.lazy(() => LeadCreateWithoutTagsInputSchema).array(),z.lazy(() => LeadUncheckedCreateWithoutTagsInputSchema),z.lazy(() => LeadUncheckedCreateWithoutTagsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LeadCreateOrConnectWithoutTagsInputSchema),z.lazy(() => LeadCreateOrConnectWithoutTagsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LeadUpsertWithWhereUniqueWithoutTagsInputSchema),z.lazy(() => LeadUpsertWithWhereUniqueWithoutTagsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateWithWhereUniqueWithoutTagsInputSchema),z.lazy(() => LeadUpdateWithWhereUniqueWithoutTagsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadUpdateManyWithWhereWithoutTagsInputSchema),z.lazy(() => LeadUpdateManyWithWhereWithoutTagsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadScalarWhereInputSchema),z.lazy(() => LeadScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadUncheckedUpdateManyWithoutTagsNestedInputSchema;
