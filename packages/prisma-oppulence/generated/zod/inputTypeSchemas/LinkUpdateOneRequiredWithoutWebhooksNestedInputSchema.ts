...
export const LinkUpdateOneRequiredWithoutWebhooksNestedInputSchema: z.ZodType<Prisma.LinkUpdateOneRequiredWithoutWebhooksNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LinkUpdateToOneWithWhereWithoutWebhooksInputSchema),z.lazy(() => LinkUpdateWithoutWebhooksInputSchema),z.lazy(() => LinkUncheckedUpdateWithoutWebhooksInputSchema) ]).optional(),
}).strict();
