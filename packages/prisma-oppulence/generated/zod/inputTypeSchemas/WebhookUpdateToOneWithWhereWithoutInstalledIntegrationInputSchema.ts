...
export const WebhookUpdateToOneWithWhereWithoutInstalledIntegrationInputSchema: z.ZodType<Prisma.WebhookUpdateToOneWithWhereWithoutInstalledIntegrationInput> = z.object({
  where: z.lazy(() => WebhookWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => WebhookUpdateWithoutInstalledIntegrationInputSchema),z.lazy(() => WebhookUncheckedUpdateWithoutInstalledIntegrationInputSchema) ]),
}).strict();
