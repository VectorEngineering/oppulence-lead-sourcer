...
import { LeadComplianceHistoryUncheckedUpdateManyWithoutComplianceAuditNestedInputSchema } from './LeadComplianceHistoryUncheckedUpdateManyWithoutComplianceAuditNestedInputSchema';

export const LeadComplianceAuditUncheckedUpdateWithoutLeadInputSchema: z.ZodType<Prisma.LeadComplianceAuditUncheckedUpdateWithoutLeadInput> = z.object({
  ...
  status: z.union([ z.lazy(() => ComplianceStatusSchema),z.lazy(() => EnumComplianceStatusFieldUpdateOperationsInputSchema) ]).optional(),
  findings: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  auditHistory: z.lazy(() => LeadComplianceHistoryUncheckedUpdateManyWithoutComplianceAuditNestedInputSchema).optional()
}).strict();

export default LeadComplianceAuditUncheckedUpdateWithoutLeadInputSchema;
