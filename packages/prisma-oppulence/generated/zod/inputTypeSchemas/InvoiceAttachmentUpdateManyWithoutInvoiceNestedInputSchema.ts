...
export const InvoiceAttachmentUpdateManyWithoutInvoiceNestedInputSchema: z.ZodType<Prisma.InvoiceAttachmentUpdateManyWithoutInvoiceNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => InvoiceAttachmentUpsertWithWhereUniqueWithoutInvoiceInputSchema),z.lazy(() => InvoiceAttachmentUpsertWithWhereUniqueWithoutInvoiceInputSchema).array() ]).optional(),
  createMany: z.lazy(() => InvoiceAttachmentCreateManyInvoiceInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => InvoiceAttachmentWhereUniqueInputSchema),z.lazy(() => InvoiceAttachmentWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => InvoiceAttachmentWhereUniqueInputSchema),z.lazy(() => InvoiceAttachmentWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => InvoiceAttachmentWhereUniqueInputSchema),z.lazy(() => InvoiceAttachmentWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => InvoiceAttachmentUpdateWithWhereUniqueWithoutInvoiceInputSchema),z.lazy(() => InvoiceAttachmentUpdateWithWhereUniqueWithoutInvoiceInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => InvoiceAttachmentUpdateManyWithWhereWithoutInvoiceInputSchema),z.lazy(() => InvoiceAttachmentUpdateManyWithWhereWithoutInvoiceInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => InvoiceAttachmentScalarWhereInputSchema),z.lazy(() => InvoiceAttachmentScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default InvoiceAttachmentUpdateManyWithoutInvoiceNestedInputSchema;
