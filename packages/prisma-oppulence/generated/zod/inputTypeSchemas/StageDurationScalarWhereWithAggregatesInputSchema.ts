...
export const StageDurationScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.StageDurationScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => StageDurationScalarWhereWithAggregatesInputSchema),
                z.lazy(() => StageDurationScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => StageDurationScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
