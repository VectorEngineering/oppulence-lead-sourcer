...
export const UserUpdateOneRequiredWithoutAppsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutAppsNestedInput> = z
    .object({
        create: z
        ...
        update: z
            .union([
                z.lazy(() => UserUpdateToOneWithWhereWithoutAppsInputSchema),
                z.lazy(() => UserUpdateWithoutAppsInputSchema),
                z.lazy(() => UserUncheckedUpdateWithoutAppsInputSchema)
            ])
            .optional()
    })
    .strict()
