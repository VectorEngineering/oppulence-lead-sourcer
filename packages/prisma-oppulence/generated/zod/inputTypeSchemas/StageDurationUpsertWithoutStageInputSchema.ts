...
export const StageDurationUpsertWithoutStageInputSchema: z.ZodType<Prisma.StageDurationUpsertWithoutStageInput> = z.object({
  update: z.union([ z.lazy(() => StageDurationUpdateWithoutStageInputSchema),z.lazy(() => StageDurationUncheckedUpdateWithoutStageInputSchema) ]),
  create: z.union([ z.lazy(() => StageDurationCreateWithoutStageInputSchema),z.lazy(() => StageDurationUncheckedCreateWithoutStageInputSchema) ]),
