...
export const LeadComplianceHistoryUpsertWithWhereUniqueWithoutComplianceAuditInputSchema: z.ZodType<Prisma.LeadComplianceHistoryUpsertWithWhereUniqueWithoutComplianceAuditInput> =
    z
        .object({
            where: z.lazy(() => LeadComplianceHistoryWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => LeadComplianceHistoryUpdateWithoutComplianceAuditInputSchema),
                z.lazy(() => LeadComplianceHistoryUncheckedUpdateWithoutComplianceAuditInputSchema)
            ]),
            create: z.union([
