...
export const LeadUpdateOneRequiredWithoutLeadCompetitiveAnalysisNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutLeadCompetitiveAnalysisNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LeadUpdateToOneWithWhereWithoutLeadCompetitiveAnalysisInputSchema),z.lazy(() => LeadUpdateWithoutLeadCompetitiveAnalysisInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutLeadCompetitiveAnalysisInputSchema) ]).optional(),
}).strict();
