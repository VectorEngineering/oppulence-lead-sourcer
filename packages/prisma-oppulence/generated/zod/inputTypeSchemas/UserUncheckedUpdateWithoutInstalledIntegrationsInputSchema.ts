...
import { LeadUncheckedUpdateManyWithoutAssignedToNestedInputSchema } from './LeadUncheckedUpdateManyWithoutAssignedToNestedInputSchema';
import { LeadTaskUncheckedUpdateManyWithoutAssignedToNestedInputSchema } from './LeadTaskUncheckedUpdateManyWithoutAssignedToNestedInputSchema';
import { DealUncheckedUpdateManyWithoutAssignedToNestedInputSchema } from './DealUncheckedUpdateManyWithoutAssignedToNestedInputSchema';
import { DealTaskUncheckedUpdateManyWithoutAssignedToNestedInputSchema } from './DealTaskUncheckedUpdateManyWithoutAssignedToNestedInputSchema';

export const UserUncheckedUpdateWithoutInstalledIntegrationsInputSchema: z.ZodType<Prisma.UserUncheckedUpdateWithoutInstalledIntegrationsInput> = z.object({
  ...
  defaultWorkspace: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  defaultPartnerId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  timeFormat: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  timezone: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  weekStartsOnMonday: z.union([ z.boolean(),z.lazy(() => NullableBoolFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  Lead: z.lazy(() => LeadUncheckedUpdateManyWithoutAssignedToNestedInputSchema).optional(),
  LeadTask: z.lazy(() => LeadTaskUncheckedUpdateManyWithoutAssignedToNestedInputSchema).optional(),
  Deal: z.lazy(() => DealUncheckedUpdateManyWithoutAssignedToNestedInputSchema).optional(),
  DealTask: z.lazy(() => DealTaskUncheckedUpdateManyWithoutAssignedToNestedInputSchema).optional()
}).strict();

export default UserUncheckedUpdateWithoutInstalledIntegrationsInputSchema;
