...
export const LeadUpdateOneRequiredWithoutContactPreferencesNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutContactPreferencesNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadUpdateToOneWithWhereWithoutContactPreferencesInputSchema),
