...
export const LeadCompetitiveHistoryUncheckedUpdateManyWithoutAnalysisNestedInputSchema: z.ZodType<Prisma.LeadCompetitiveHistoryUncheckedUpdateManyWithoutAnalysisNestedInput> =
    z
        .object({
            create: z
                .union([
