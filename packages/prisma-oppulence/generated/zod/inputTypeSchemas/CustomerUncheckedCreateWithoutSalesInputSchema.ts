...
export const CustomerUncheckedCreateWithoutSalesInputSchema: z.ZodType<Prisma.CustomerUncheckedCreateWithoutSalesInput> = z
    .object({
...
export default CustomerUncheckedCreateWithoutSalesInputSchema
