...
export const ReportSortingUpsertWithWhereUniqueWithoutReportInputSchema: z.ZodType<Prisma.ReportSortingUpsertWithWhereUniqueWithoutReportInput> =
    z
        .object({
            where: z.lazy(() => ReportSortingWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => ReportSortingUpdateWithoutReportInputSchema),
                z.lazy(() => ReportSortingUncheckedUpdateWithoutReportInputSchema)
            ]),
            create: z.union([
