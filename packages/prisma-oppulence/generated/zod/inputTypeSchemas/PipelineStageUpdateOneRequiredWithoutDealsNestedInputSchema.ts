...
export const PipelineStageUpdateOneRequiredWithoutDealsNestedInputSchema: z.ZodType<Prisma.PipelineStageUpdateOneRequiredWithoutDealsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => PipelineStageUpdateToOneWithWhereWithoutDealsInputSchema),
