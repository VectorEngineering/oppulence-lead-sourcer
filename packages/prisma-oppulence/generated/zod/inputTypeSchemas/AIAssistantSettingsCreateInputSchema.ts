...
import { z } from 'zod';
import { UserCreateNestedOneWithoutAiAssistantSettingsInputSchema } from './UserCreateNestedOneWithoutAiAssistantSettingsInputSchema';

export const AIAssistantSettingsCreateInputSchema: z.ZodType<Prisma.AIAssistantSettingsCreateInput> = z.object({
  ...
  user: z.lazy(() => UserCreateNestedOneWithoutAiAssistantSettingsInputSchema)
}).strict();

export default AIAssistantSettingsCreateInputSchema;
