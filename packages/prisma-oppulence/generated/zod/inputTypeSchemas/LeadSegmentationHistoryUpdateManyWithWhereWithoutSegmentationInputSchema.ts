...
export const LeadSegmentationHistoryUpdateManyWithWhereWithoutSegmentationInputSchema: z.ZodType<Prisma.LeadSegmentationHistoryUpdateManyWithWhereWithoutSegmentationInput> =
    z
        .object({
            where: z.lazy(() => LeadSegmentationHistoryScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LeadSegmentationHistoryUpdateManyMutationInputSchema),
                z.lazy(() => LeadSegmentationHistoryUncheckedUpdateManyWithoutSegmentationInputSchema)
            ])
        })
        .strict()
