...
export const PipelineIntegrationUncheckedCreateNestedManyWithoutPipelineInputSchema: z.ZodType<Prisma.PipelineIntegrationUncheckedCreateNestedManyWithoutPipelineInput> =
    z
        .object({
            create: z
                .union([
