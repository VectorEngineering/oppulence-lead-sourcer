...
export const ProjectUsersUpdateOneRequiredWithoutNotificationPreferenceNestedInputSchema: z.ZodType<Prisma.ProjectUsersUpdateOneRequiredWithoutNotificationPreferenceNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUsersUpdateToOneWithWhereWithoutNotificationPreferenceInputSchema),
