...
export const AutomationConditionCreateNestedManyWithoutAutomationInputSchema: z.ZodType<Prisma.AutomationConditionCreateNestedManyWithoutAutomationInput> =
    z
        .object({
            create: z
                .union([
