...
export const LeadScoreHistoryUpdateManyWithoutLeadScoreNestedInputSchema: z.ZodType<Prisma.LeadScoreHistoryUpdateManyWithoutLeadScoreNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LeadScoreHistoryUpsertWithWhereUniqueWithoutLeadScoreInputSchema),z.lazy(() => LeadScoreHistoryUpsertWithWhereUniqueWithoutLeadScoreInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LeadScoreHistoryCreateManyLeadScoreInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => LeadScoreHistoryWhereUniqueInputSchema),z.lazy(() => LeadScoreHistoryWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => LeadScoreHistoryWhereUniqueInputSchema),z.lazy(() => LeadScoreHistoryWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => LeadScoreHistoryWhereUniqueInputSchema),z.lazy(() => LeadScoreHistoryWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadScoreHistoryUpdateWithWhereUniqueWithoutLeadScoreInputSchema),z.lazy(() => LeadScoreHistoryUpdateWithWhereUniqueWithoutLeadScoreInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadScoreHistoryUpdateManyWithWhereWithoutLeadScoreInputSchema),z.lazy(() => LeadScoreHistoryUpdateManyWithWhereWithoutLeadScoreInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadScoreHistoryScalarWhereInputSchema),z.lazy(() => LeadScoreHistoryScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadScoreHistoryUpdateManyWithoutLeadScoreNestedInputSchema;
