...
export const LeadHistoryScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadHistoryScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => LeadHistoryScalarWhereWithAggregatesInputSchema),z.lazy(() => LeadHistoryScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadHistoryScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LeadHistoryScalarWhereWithAggregatesInputSchema),z.lazy(() => LeadHistoryScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  changeType: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
