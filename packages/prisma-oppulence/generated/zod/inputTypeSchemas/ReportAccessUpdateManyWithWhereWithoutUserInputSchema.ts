...
export const ReportAccessUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.ReportAccessUpdateManyWithWhereWithoutUserInput> = z.object({
  where: z.lazy(() => ReportAccessScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ReportAccessUpdateManyMutationInputSchema),z.lazy(() => ReportAccessUncheckedUpdateManyWithoutUserInputSchema) ]),
}).strict();
