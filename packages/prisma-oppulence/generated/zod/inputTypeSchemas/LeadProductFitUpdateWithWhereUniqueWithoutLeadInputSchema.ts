...
export const LeadProductFitUpdateWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadProductFitUpdateWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadProductFitWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadProductFitUpdateWithoutLeadInputSchema),z.lazy(() => LeadProductFitUncheckedUpdateWithoutLeadInputSchema) ]),
}).strict();
