...
export const LeadCompetitiveHistoryScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadCompetitiveHistoryScalarWhereWithAggregatesInput> =
    z
        .object({
            AND: z
                .union([
                    z.lazy(() => LeadCompetitiveHistoryScalarWhereWithAggregatesInputSchema),
                    z.lazy(() => LeadCompetitiveHistoryScalarWhereWithAggregatesInputSchema).array()
                ])
                .optional(),
            OR: z
                .lazy(() => LeadCompetitiveHistoryScalarWhereWithAggregatesInputSchema)
                .array()
                .optional(),
            NOT: z
                .union([
