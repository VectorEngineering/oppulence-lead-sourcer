...
export const UserUpdateOneWithoutDealTaskNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDealTaskNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutDealTaskInputSchema),z.lazy(() => UserUpdateWithoutDealTaskInputSchema),z.lazy(() => UserUncheckedUpdateWithoutDealTaskInputSchema) ]).optional(),
}).strict();
