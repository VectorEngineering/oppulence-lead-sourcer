...
export const DocumentCommentWhereUniqueInputSchema: z.ZodType<Prisma.DocumentCommentWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => DocumentCommentWhereInputSchema), z.lazy(() => DocumentCommentWhereInputSchema).array()])
                    .optional(),
                OR: z
                    .lazy(() => DocumentCommentWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([z.lazy(() => DocumentCommentWhereInputSchema), z.lazy(() => DocumentCommentWhereInputSchema).array()])
