...
export const NotificationPreferenceWhereInputSchema: z.ZodType<Prisma.NotificationPreferenceWhereInput> = z
    .object({
        AND: z
            .union([z.lazy(() => NotificationPreferenceWhereInputSchema), z.lazy(() => NotificationPreferenceWhereInputSchema).array()])
            .optional(),
        OR: z
        ...
        projectUserId: z.union([z.lazy(() => StringFilterSchema), z.string()]).optional(),
...
export default NotificationPreferenceWhereInputSchema
