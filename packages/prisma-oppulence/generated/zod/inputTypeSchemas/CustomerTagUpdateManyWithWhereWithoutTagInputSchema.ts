...
export const CustomerTagUpdateManyWithWhereWithoutTagInputSchema: z.ZodType<Prisma.CustomerTagUpdateManyWithWhereWithoutTagInput> = z.object({
  where: z.lazy(() => CustomerTagScalarWhereInputSchema),
  data: z.union([ z.lazy(() => CustomerTagUpdateManyMutationInputSchema),z.lazy(() => CustomerTagUncheckedUpdateManyWithoutTagInputSchema) ]),
}).strict();
