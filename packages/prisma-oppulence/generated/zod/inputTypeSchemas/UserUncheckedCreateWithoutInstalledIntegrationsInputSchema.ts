...
import { LeadUncheckedCreateNestedManyWithoutAssignedToInputSchema } from './LeadUncheckedCreateNestedManyWithoutAssignedToInputSchema';
import { LeadTaskUncheckedCreateNestedManyWithoutAssignedToInputSchema } from './LeadTaskUncheckedCreateNestedManyWithoutAssignedToInputSchema';
import { DealUncheckedCreateNestedManyWithoutAssignedToInputSchema } from './DealUncheckedCreateNestedManyWithoutAssignedToInputSchema';
import { DealTaskUncheckedCreateNestedManyWithoutAssignedToInputSchema } from './DealTaskUncheckedCreateNestedManyWithoutAssignedToInputSchema';

export const UserUncheckedCreateWithoutInstalledIntegrationsInputSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutInstalledIntegrationsInput> = z.object({
  ...
  Lead: z.lazy(() => LeadUncheckedCreateNestedManyWithoutAssignedToInputSchema).optional(),
  LeadTask: z.lazy(() => LeadTaskUncheckedCreateNestedManyWithoutAssignedToInputSchema).optional(),
  Deal: z.lazy(() => DealUncheckedCreateNestedManyWithoutAssignedToInputSchema).optional(),
  DealTask: z.lazy(() => DealTaskUncheckedCreateNestedManyWithoutAssignedToInputSchema).optional()
}).strict();

export default UserUncheckedCreateWithoutInstalledIntegrationsInputSchema;
