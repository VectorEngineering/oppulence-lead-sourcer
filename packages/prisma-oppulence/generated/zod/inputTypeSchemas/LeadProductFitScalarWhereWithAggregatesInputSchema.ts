...
export const LeadProductFitScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadProductFitScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadProductFitScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadProductFitScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadProductFitScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
