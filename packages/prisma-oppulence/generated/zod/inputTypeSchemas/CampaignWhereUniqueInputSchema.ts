...
export const CampaignWhereUniqueInputSchema: z.ZodType<Prisma.CampaignWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                conversions: z.union([z.lazy(() => IntFilterSchema), z.number().int()]).optional(),
...
export default CampaignWhereUniqueInputSchema
