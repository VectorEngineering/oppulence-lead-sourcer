...
export const LeadUpdateOneRequiredWithoutLeadBudgetNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutLeadBudgetNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadUpdateToOneWithWhereWithoutLeadBudgetInputSchema),
