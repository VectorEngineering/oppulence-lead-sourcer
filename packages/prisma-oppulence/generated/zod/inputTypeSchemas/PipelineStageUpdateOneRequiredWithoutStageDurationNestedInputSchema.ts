...
export const PipelineStageUpdateOneRequiredWithoutStageDurationNestedInputSchema: z.ZodType<Prisma.PipelineStageUpdateOneRequiredWithoutStageDurationNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => PipelineStageUpdateToOneWithWhereWithoutStageDurationInputSchema),
