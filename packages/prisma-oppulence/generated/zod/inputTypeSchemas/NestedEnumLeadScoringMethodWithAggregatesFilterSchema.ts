...
export const NestedEnumLeadScoringMethodWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumLeadScoringMethodWithAggregatesFilter> = z
    .object({
        ...
        notIn: z
            ...
            .optional(),
        not: z
            .union([z.lazy(() => LeadScoringMethodSchema), z.lazy(() => NestedEnumLeadScoringMethodWithAggregatesFilterSchema)])
            .optional(),
