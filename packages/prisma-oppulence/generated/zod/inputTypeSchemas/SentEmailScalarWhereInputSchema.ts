...
export const SentEmailScalarWhereInputSchema: z.ZodType<Prisma.SentEmailScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => SentEmailScalarWhereInputSchema),z.lazy(() => SentEmailScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => SentEmailScalarWhereInputSchema).array().optional(),
