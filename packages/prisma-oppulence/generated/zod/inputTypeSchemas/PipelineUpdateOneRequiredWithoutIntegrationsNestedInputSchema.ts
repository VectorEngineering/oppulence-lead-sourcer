...
export const PipelineUpdateOneRequiredWithoutIntegrationsNestedInputSchema: z.ZodType<Prisma.PipelineUpdateOneRequiredWithoutIntegrationsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => PipelineUpdateToOneWithWhereWithoutIntegrationsInputSchema),
