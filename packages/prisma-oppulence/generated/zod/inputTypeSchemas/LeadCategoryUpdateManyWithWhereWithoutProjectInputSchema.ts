...
export const LeadCategoryUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.LeadCategoryUpdateManyWithWhereWithoutProjectInput> =
    z
        .object({
            where: z.lazy(() => LeadCategoryScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LeadCategoryUpdateManyMutationInputSchema),
                z.lazy(() => LeadCategoryUncheckedUpdateManyWithoutProjectInputSchema)
            ])
        })
        .strict()
