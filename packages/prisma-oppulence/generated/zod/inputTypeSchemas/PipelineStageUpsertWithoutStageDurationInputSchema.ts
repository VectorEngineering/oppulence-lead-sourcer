...
export const PipelineStageUpsertWithoutStageDurationInputSchema: z.ZodType<Prisma.PipelineStageUpsertWithoutStageDurationInput> = z.object({
  update: z.union([ z.lazy(() => PipelineStageUpdateWithoutStageDurationInputSchema),z.lazy(() => PipelineStageUncheckedUpdateWithoutStageDurationInputSchema) ]),
