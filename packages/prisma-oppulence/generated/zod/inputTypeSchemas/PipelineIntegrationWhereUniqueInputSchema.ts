...
export const PipelineIntegrationWhereUniqueInputSchema: z.ZodType<Prisma.PipelineIntegrationWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => PipelineIntegrationWhereInputSchema), z.lazy(() => PipelineIntegrationWhereInputSchema).array()])
                    .optional(),
                OR: z
                    .lazy(() => PipelineIntegrationWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([z.lazy(() => PipelineIntegrationWhereInputSchema), z.lazy(() => PipelineIntegrationWhereInputSchema).array()])
...
export default PipelineIntegrationWhereUniqueInputSchema
