...
export const PipelineAutomationUncheckedUpdateManyWithoutPipelineNestedInputSchema: z.ZodType<Prisma.PipelineAutomationUncheckedUpdateManyWithoutPipelineNestedInput> =
    z
        .object({
            create: z
                .union([
