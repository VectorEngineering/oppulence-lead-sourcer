...
export const LeadTouchpointUncheckedUpdateManyWithoutCampaignNestedInputSchema: z.ZodType<Prisma.LeadTouchpointUncheckedUpdateManyWithoutCampaignNestedInput> =
    z
        .object({
            create: z
                .union([
