...
export const DocumentCommentUpdateManyWithoutDocumentNestedInputSchema: z.ZodType<Prisma.DocumentCommentUpdateManyWithoutDocumentNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => DocumentCommentUpsertWithWhereUniqueWithoutDocumentInputSchema),
                    z.lazy(() => DocumentCommentUpsertWithWhereUniqueWithoutDocumentInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => DocumentCommentUpdateWithWhereUniqueWithoutDocumentInputSchema),
                    z.lazy(() => DocumentCommentUpdateWithWhereUniqueWithoutDocumentInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => DocumentCommentUpdateManyWithWhereWithoutDocumentInputSchema),
                    z.lazy(() => DocumentCommentUpdateManyWithWhereWithoutDocumentInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default DocumentCommentUpdateManyWithoutDocumentNestedInputSchema
