...
export const LeadUpsertWithoutCompanyDetailsInputSchema: z.ZodType<Prisma.LeadUpsertWithoutCompanyDetailsInput> = z.object({
  update: z.union([ z.lazy(() => LeadUpdateWithoutCompanyDetailsInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutCompanyDetailsInputSchema) ]),
