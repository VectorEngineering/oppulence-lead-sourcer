...
export const LeadProductFitAssessmentUpdateManyWithoutProductFitNestedInputSchema: z.ZodType<Prisma.LeadProductFitAssessmentUpdateManyWithoutProductFitNestedInput> =
    z
        .object({
            create: z
                .union([
