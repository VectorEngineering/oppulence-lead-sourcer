...
export const DealHistoryScalarWhereInputSchema: z.ZodType<Prisma.DealHistoryScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => DealHistoryScalarWhereInputSchema),z.lazy(() => DealHistoryScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => DealHistoryScalarWhereInputSchema).array().optional(),
