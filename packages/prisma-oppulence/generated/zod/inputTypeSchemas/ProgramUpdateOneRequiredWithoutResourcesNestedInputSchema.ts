...
export const ProgramUpdateOneRequiredWithoutResourcesNestedInputSchema: z.ZodType<Prisma.ProgramUpdateOneRequiredWithoutResourcesNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProgramUpdateToOneWithWhereWithoutResourcesInputSchema),
