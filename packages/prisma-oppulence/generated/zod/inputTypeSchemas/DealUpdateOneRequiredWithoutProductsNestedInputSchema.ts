...
export const DealUpdateOneRequiredWithoutProductsNestedInputSchema: z.ZodType<Prisma.DealUpdateOneRequiredWithoutProductsNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => DealCreateWithoutProductsInputSchema), z.lazy(() => DealUncheckedCreateWithoutProductsInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => DealUpdateToOneWithWhereWithoutProductsInputSchema),
                z.lazy(() => DealUpdateWithoutProductsInputSchema),
                z.lazy(() => DealUncheckedUpdateWithoutProductsInputSchema)
            ])
            .optional()
    })
    .strict()
