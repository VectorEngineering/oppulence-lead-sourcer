...
export const PipelineIntegrationUpdateWithWhereUniqueWithoutPipelineInputSchema: z.ZodType<Prisma.PipelineIntegrationUpdateWithWhereUniqueWithoutPipelineInput> = z.object({
  where: z.lazy(() => PipelineIntegrationWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => PipelineIntegrationUpdateWithoutPipelineInputSchema),z.lazy(() => PipelineIntegrationUncheckedUpdateWithoutPipelineInputSchema) ]),
}).strict();
