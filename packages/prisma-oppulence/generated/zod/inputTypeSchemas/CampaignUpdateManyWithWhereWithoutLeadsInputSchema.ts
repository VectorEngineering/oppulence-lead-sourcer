...
export const CampaignUpdateManyWithWhereWithoutLeadsInputSchema: z.ZodType<Prisma.CampaignUpdateManyWithWhereWithoutLeadsInput> = z.object({
  where: z.lazy(() => CampaignScalarWhereInputSchema),
  data: z.union([ z.lazy(() => CampaignUpdateManyMutationInputSchema),z.lazy(() => CampaignUncheckedUpdateManyWithoutLeadsInputSchema) ]),
}).strict();
