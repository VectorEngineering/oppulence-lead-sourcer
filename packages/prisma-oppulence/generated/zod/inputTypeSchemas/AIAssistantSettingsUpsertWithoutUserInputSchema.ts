...
export const AIAssistantSettingsUpsertWithoutUserInputSchema: z.ZodType<Prisma.AIAssistantSettingsUpsertWithoutUserInput> = z.object({
  update: z.union([ z.lazy(() => AIAssistantSettingsUpdateWithoutUserInputSchema),z.lazy(() => AIAssistantSettingsUncheckedUpdateWithoutUserInputSchema) ]),
  create: z.union([ z.lazy(() => AIAssistantSettingsCreateWithoutUserInputSchema),z.lazy(() => AIAssistantSettingsUncheckedCreateWithoutUserInputSchema) ]),
