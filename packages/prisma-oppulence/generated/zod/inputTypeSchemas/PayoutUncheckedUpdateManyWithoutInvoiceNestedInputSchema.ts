...
export const PayoutUncheckedUpdateManyWithoutInvoiceNestedInputSchema: z.ZodType<Prisma.PayoutUncheckedUpdateManyWithoutInvoiceNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => PayoutUpsertWithWhereUniqueWithoutInvoiceInputSchema),
                    z.lazy(() => PayoutUpsertWithWhereUniqueWithoutInvoiceInputSchema).array()
                ])
                .optional(),
            ...
            disconnect: z
                .union([z.lazy(() => PayoutWhereUniqueInputSchema), z.lazy(() => PayoutWhereUniqueInputSchema).array()])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => PayoutUpdateWithWhereUniqueWithoutInvoiceInputSchema),
                    z.lazy(() => PayoutUpdateWithWhereUniqueWithoutInvoiceInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => PayoutUpdateManyWithWhereWithoutInvoiceInputSchema),
                    z.lazy(() => PayoutUpdateManyWithWhereWithoutInvoiceInputSchema).array()
                ])
                .optional(),
...
export default PayoutUncheckedUpdateManyWithoutInvoiceNestedInputSchema
