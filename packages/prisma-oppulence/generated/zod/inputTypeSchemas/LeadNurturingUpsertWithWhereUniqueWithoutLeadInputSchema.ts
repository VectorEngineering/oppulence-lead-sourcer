...
export const LeadNurturingUpsertWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadNurturingUpsertWithWhereUniqueWithoutLeadInput> =
    z
        .object({
            where: z.lazy(() => LeadNurturingWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => LeadNurturingUpdateWithoutLeadInputSchema),
                z.lazy(() => LeadNurturingUncheckedUpdateWithoutLeadInputSchema)
            ]),
            create: z.union([
