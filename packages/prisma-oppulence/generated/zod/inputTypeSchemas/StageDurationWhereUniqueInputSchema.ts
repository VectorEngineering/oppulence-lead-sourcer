...
export const StageDurationWhereUniqueInputSchema: z.ZodType<Prisma.StageDurationWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    stageId: z.string(),
...
.and(z.object({
  ...
  warningDays: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  criticalDays: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
