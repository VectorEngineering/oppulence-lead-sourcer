...
export const LeadProductFitUpdateToOneWithWhereWithoutAssessmentsInputSchema: z.ZodType<Prisma.LeadProductFitUpdateToOneWithWhereWithoutAssessmentsInput> = z.object({
  where: z.lazy(() => LeadProductFitWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => LeadProductFitUpdateWithoutAssessmentsInputSchema),z.lazy(() => LeadProductFitUncheckedUpdateWithoutAssessmentsInputSchema) ]),
}).strict();
