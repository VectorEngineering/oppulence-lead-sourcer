...
export const LeadComplianceAuditScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadComplianceAuditScalarWhereWithAggregatesInput> =
    z
        .object({
            AND: z
                .union([
                    z.lazy(() => LeadComplianceAuditScalarWhereWithAggregatesInputSchema),
                    z.lazy(() => LeadComplianceAuditScalarWhereWithAggregatesInputSchema).array()
                ])
                .optional(),
            OR: z
                .lazy(() => LeadComplianceAuditScalarWhereWithAggregatesInputSchema)
                .array()
                .optional(),
            NOT: z
                .union([
            ...
            status: z
                .union([z.lazy(() => EnumComplianceStatusWithAggregatesFilterSchema), z.lazy(() => ComplianceStatusSchema)])
                .optional(),
            findings: z
