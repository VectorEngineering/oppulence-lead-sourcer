...
export const LeadBudgetExpenseUncheckedCreateNestedManyWithoutBudgetInputSchema: z.ZodType<Prisma.LeadBudgetExpenseUncheckedCreateNestedManyWithoutBudgetInput> =
    z
        .object({
            create: z
                .union([
