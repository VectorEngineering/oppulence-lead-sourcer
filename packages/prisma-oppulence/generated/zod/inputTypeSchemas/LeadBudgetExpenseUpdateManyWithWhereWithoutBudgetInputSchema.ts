...
export const LeadBudgetExpenseUpdateManyWithWhereWithoutBudgetInputSchema: z.ZodType<Prisma.LeadBudgetExpenseUpdateManyWithWhereWithoutBudgetInput> =
    z
        .object({
            where: z.lazy(() => LeadBudgetExpenseScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LeadBudgetExpenseUpdateManyMutationInputSchema),
                z.lazy(() => LeadBudgetExpenseUncheckedUpdateManyWithoutBudgetInputSchema)
            ])
        })
        .strict()
