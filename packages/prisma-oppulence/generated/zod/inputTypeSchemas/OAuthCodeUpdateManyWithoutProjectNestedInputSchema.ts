...
export const OAuthCodeUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.OAuthCodeUpdateManyWithoutProjectNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => OAuthCodeUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => OAuthCodeUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => OAuthCodeUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => OAuthCodeUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => OAuthCodeUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => OAuthCodeUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => OAuthCodeScalarWhereInputSchema),z.lazy(() => OAuthCodeScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default OAuthCodeUpdateManyWithoutProjectNestedInputSchema;
