...
export const PipelineAccessRuleScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.PipelineAccessRuleScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => PipelineAccessRuleScalarWhereWithAggregatesInputSchema),
                z.lazy(() => PipelineAccessRuleScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => PipelineAccessRuleScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
