...
export const LeadSocialProfileUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadSocialProfileUpdateManyWithWhereWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadSocialProfileScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LeadSocialProfileUpdateManyMutationInputSchema),z.lazy(() => LeadSocialProfileUncheckedUpdateManyWithoutLeadInputSchema) ]),
}).strict();
