...
export const ContractVersionScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ContractVersionScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => ContractVersionScalarWhereWithAggregatesInputSchema),z.lazy(() => ContractVersionScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => ContractVersionScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => ContractVersionScalarWhereWithAggregatesInputSchema),z.lazy(() => ContractVersionScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  reviewStatus: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  ...
  signatureStatus: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  ...
  lastViewedBy: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  lastViewedAt: z.union([ z.lazy(() => DateTimeNullableWithAggregatesFilterSchema),z.coerce.date() ]).optional().nullable(),
