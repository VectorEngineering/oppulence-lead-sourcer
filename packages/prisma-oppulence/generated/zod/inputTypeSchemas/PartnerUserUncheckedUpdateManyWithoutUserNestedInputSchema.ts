...
export const PartnerUserUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.PartnerUserUncheckedUpdateManyWithoutUserNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => PartnerUserUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => PartnerUserUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => PartnerUserUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => PartnerUserUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => PartnerUserUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => PartnerUserUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => PartnerUserScalarWhereInputSchema),z.lazy(() => PartnerUserScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default PartnerUserUncheckedUpdateManyWithoutUserNestedInputSchema;
