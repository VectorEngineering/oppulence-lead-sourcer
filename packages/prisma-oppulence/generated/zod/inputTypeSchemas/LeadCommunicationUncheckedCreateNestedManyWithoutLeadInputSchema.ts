...
export const LeadCommunicationUncheckedCreateNestedManyWithoutLeadInputSchema: z.ZodType<Prisma.LeadCommunicationUncheckedCreateNestedManyWithoutLeadInput> =
    z
        .object({
            create: z
                .union([
