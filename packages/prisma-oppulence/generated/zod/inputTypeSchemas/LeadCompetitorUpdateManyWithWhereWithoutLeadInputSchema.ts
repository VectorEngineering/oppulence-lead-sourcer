...
export const LeadCompetitorUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadCompetitorUpdateManyWithWhereWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadCompetitorScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LeadCompetitorUpdateManyMutationInputSchema),z.lazy(() => LeadCompetitorUncheckedUpdateManyWithoutLeadInputSchema) ]),
}).strict();
