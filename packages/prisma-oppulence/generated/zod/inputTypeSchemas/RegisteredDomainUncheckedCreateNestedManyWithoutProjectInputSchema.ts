...
export const RegisteredDomainUncheckedCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.RegisteredDomainUncheckedCreateNestedManyWithoutProjectInput> =
    z
        .object({
            create: z
                .union([
