...
export const ProgramEnrollmentUpsertWithWhereUniqueWithoutProgramInputSchema: z.ZodType<Prisma.ProgramEnrollmentUpsertWithWhereUniqueWithoutProgramInput> = z.object({
  where: z.lazy(() => ProgramEnrollmentWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ProgramEnrollmentUpdateWithoutProgramInputSchema),z.lazy(() => ProgramEnrollmentUncheckedUpdateWithoutProgramInputSchema) ]),
  create: z.union([ z.lazy(() => ProgramEnrollmentCreateWithoutProgramInputSchema),z.lazy(() => ProgramEnrollmentUncheckedCreateWithoutProgramInputSchema) ]),
}).strict();
