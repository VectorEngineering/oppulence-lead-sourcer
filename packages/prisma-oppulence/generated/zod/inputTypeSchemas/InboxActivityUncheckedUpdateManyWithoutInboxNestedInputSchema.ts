...
export const InboxActivityUncheckedUpdateManyWithoutInboxNestedInputSchema: z.ZodType<Prisma.InboxActivityUncheckedUpdateManyWithoutInboxNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => InboxActivityUpsertWithWhereUniqueWithoutInboxInputSchema),z.lazy(() => InboxActivityUpsertWithWhereUniqueWithoutInboxInputSchema).array() ]).optional(),
  createMany: z.lazy(() => InboxActivityCreateManyInboxInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => InboxActivityWhereUniqueInputSchema),z.lazy(() => InboxActivityWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => InboxActivityWhereUniqueInputSchema),z.lazy(() => InboxActivityWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => InboxActivityWhereUniqueInputSchema),z.lazy(() => InboxActivityWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => InboxActivityWhereUniqueInputSchema),z.lazy(() => InboxActivityWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => InboxActivityUpdateWithWhereUniqueWithoutInboxInputSchema),z.lazy(() => InboxActivityUpdateWithWhereUniqueWithoutInboxInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => InboxActivityUpdateManyWithWhereWithoutInboxInputSchema),z.lazy(() => InboxActivityUpdateManyWithWhereWithoutInboxInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => InboxActivityScalarWhereInputSchema),z.lazy(() => InboxActivityScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default InboxActivityUncheckedUpdateManyWithoutInboxNestedInputSchema;
