...
export const DealHistoryUpdateWithWhereUniqueWithoutDealInputSchema: z.ZodType<Prisma.DealHistoryUpdateWithWhereUniqueWithoutDealInput> = z.object({
  where: z.lazy(() => DealHistoryWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => DealHistoryUpdateWithoutDealInputSchema),z.lazy(() => DealHistoryUncheckedUpdateWithoutDealInputSchema) ]),
}).strict();
