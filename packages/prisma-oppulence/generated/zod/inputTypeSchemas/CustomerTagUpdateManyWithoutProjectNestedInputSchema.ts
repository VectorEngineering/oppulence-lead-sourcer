...
export const CustomerTagUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.CustomerTagUpdateManyWithoutProjectNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => CustomerTagUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => CustomerTagUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => CustomerTagUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => CustomerTagUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => CustomerTagUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => CustomerTagUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => CustomerTagScalarWhereInputSchema),z.lazy(() => CustomerTagScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default CustomerTagUpdateManyWithoutProjectNestedInputSchema;
