...
export const PayoutUncheckedUpdateManyWithoutProgramNestedInputSchema: z.ZodType<Prisma.PayoutUncheckedUpdateManyWithoutProgramNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => PayoutUpsertWithWhereUniqueWithoutProgramInputSchema),z.lazy(() => PayoutUpsertWithWhereUniqueWithoutProgramInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => PayoutUpdateWithWhereUniqueWithoutProgramInputSchema),z.lazy(() => PayoutUpdateWithWhereUniqueWithoutProgramInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => PayoutUpdateManyWithWhereWithoutProgramInputSchema),z.lazy(() => PayoutUpdateManyWithWhereWithoutProgramInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => PayoutScalarWhereInputSchema),z.lazy(() => PayoutScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default PayoutUncheckedUpdateManyWithoutProgramNestedInputSchema;
