...
export const LeadConsentUpdateWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadConsentUpdateWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadConsentWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadConsentUpdateWithoutLeadInputSchema),z.lazy(() => LeadConsentUncheckedUpdateWithoutLeadInputSchema) ]),
}).strict();
