...
export const DealUpdateOneRequiredWithoutActivitiesNestedInputSchema: z.ZodType<Prisma.DealUpdateOneRequiredWithoutActivitiesNestedInput> = z.object({
  create: z.union([ z.lazy(() => DealCreateWithoutActivitiesInputSchema),z.lazy(() => DealUncheckedCreateWithoutActivitiesInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => DealUpdateToOneWithWhereWithoutActivitiesInputSchema),z.lazy(() => DealUpdateWithoutActivitiesInputSchema),z.lazy(() => DealUncheckedUpdateWithoutActivitiesInputSchema) ]).optional(),
}).strict();
