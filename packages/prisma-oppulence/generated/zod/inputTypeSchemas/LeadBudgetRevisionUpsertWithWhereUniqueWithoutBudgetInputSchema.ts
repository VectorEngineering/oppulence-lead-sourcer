...
export const LeadBudgetRevisionUpsertWithWhereUniqueWithoutBudgetInputSchema: z.ZodType<Prisma.LeadBudgetRevisionUpsertWithWhereUniqueWithoutBudgetInput> = z.object({
  where: z.lazy(() => LeadBudgetRevisionWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LeadBudgetRevisionUpdateWithoutBudgetInputSchema),z.lazy(() => LeadBudgetRevisionUncheckedUpdateWithoutBudgetInputSchema) ]),
  create: z.union([ z.lazy(() => LeadBudgetRevisionCreateWithoutBudgetInputSchema),z.lazy(() => LeadBudgetRevisionUncheckedCreateWithoutBudgetInputSchema) ]),
}).strict();
