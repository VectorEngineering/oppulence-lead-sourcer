...
export const PipelineAutomationUpsertWithoutConditionsInputSchema: z.ZodType<Prisma.PipelineAutomationUpsertWithoutConditionsInput> = z.object({
  update: z.union([ z.lazy(() => PipelineAutomationUpdateWithoutConditionsInputSchema),z.lazy(() => PipelineAutomationUncheckedUpdateWithoutConditionsInputSchema) ]),
  create: z.union([ z.lazy(() => PipelineAutomationCreateWithoutConditionsInputSchema),z.lazy(() => PipelineAutomationUncheckedCreateWithoutConditionsInputSchema) ]),
