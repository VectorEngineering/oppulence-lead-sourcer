...
export const LeadUpsertWithoutLeadTasksInputSchema: z.ZodType<Prisma.LeadUpsertWithoutLeadTasksInput> = z
    .object({
        update: z.union([
        ...
        create: z.union([
            z.lazy(() => LeadCreateWithoutLeadTasksInputSchema),
            z.lazy(() => LeadUncheckedCreateWithoutLeadTasksInputSchema)
        ]),
