...
export const LeadComplianceAuditUpdateOneRequiredWithoutAuditHistoryNestedInputSchema: z.ZodType<Prisma.LeadComplianceAuditUpdateOneRequiredWithoutAuditHistoryNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LeadComplianceAuditUpdateToOneWithWhereWithoutAuditHistoryInputSchema),z.lazy(() => LeadComplianceAuditUpdateWithoutAuditHistoryInputSchema),z.lazy(() => LeadComplianceAuditUncheckedUpdateWithoutAuditHistoryInputSchema) ]).optional(),
}).strict();
