...
export const LeadTouchpointScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadTouchpointScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadTouchpointScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadTouchpointScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadTouchpointScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
