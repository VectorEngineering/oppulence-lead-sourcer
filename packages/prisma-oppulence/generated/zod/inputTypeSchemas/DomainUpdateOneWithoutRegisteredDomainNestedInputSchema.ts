...
export const DomainUpdateOneWithoutRegisteredDomainNestedInputSchema: z.ZodType<Prisma.DomainUpdateOneWithoutRegisteredDomainNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => DomainUpdateToOneWithWhereWithoutRegisteredDomainInputSchema),z.lazy(() => DomainUpdateWithoutRegisteredDomainInputSchema),z.lazy(() => DomainUncheckedUpdateWithoutRegisteredDomainInputSchema) ]).optional(),
}).strict();
