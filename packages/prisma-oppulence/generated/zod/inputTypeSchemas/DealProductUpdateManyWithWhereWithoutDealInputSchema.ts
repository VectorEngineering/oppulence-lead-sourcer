...
export const DealProductUpdateManyWithWhereWithoutDealInputSchema: z.ZodType<Prisma.DealProductUpdateManyWithWhereWithoutDealInput> = z
    .object({
        where: z.lazy(() => DealProductScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => DealProductUpdateManyMutationInputSchema),
            z.lazy(() => DealProductUncheckedUpdateManyWithoutDealInputSchema)
        ])
    })
    .strict()
