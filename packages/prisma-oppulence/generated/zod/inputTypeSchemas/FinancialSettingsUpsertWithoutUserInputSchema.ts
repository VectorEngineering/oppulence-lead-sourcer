...
export const FinancialSettingsUpsertWithoutUserInputSchema: z.ZodType<Prisma.FinancialSettingsUpsertWithoutUserInput> = z.object({
  update: z.union([ z.lazy(() => FinancialSettingsUpdateWithoutUserInputSchema),z.lazy(() => FinancialSettingsUncheckedUpdateWithoutUserInputSchema) ]),
  create: z.union([ z.lazy(() => FinancialSettingsCreateWithoutUserInputSchema),z.lazy(() => FinancialSettingsUncheckedCreateWithoutUserInputSchema) ]),
