...
export const PipelineAccessRuleScalarWhereInputSchema: z.ZodType<Prisma.PipelineAccessRuleScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => PipelineAccessRuleScalarWhereInputSchema),z.lazy(() => PipelineAccessRuleScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => PipelineAccessRuleScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => PipelineAccessRuleScalarWhereInputSchema),z.lazy(() => PipelineAccessRuleScalarWhereInputSchema).array() ]).optional(),
