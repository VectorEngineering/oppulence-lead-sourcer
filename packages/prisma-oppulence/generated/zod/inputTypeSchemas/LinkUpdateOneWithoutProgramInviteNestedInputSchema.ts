...
export const LinkUpdateOneWithoutProgramInviteNestedInputSchema: z.ZodType<Prisma.LinkUpdateOneWithoutProgramInviteNestedInput> = z
    .object({
        create: z
            .union([
        ...
        update: z
            .union([
                z.lazy(() => LinkUpdateToOneWithWhereWithoutProgramInviteInputSchema),
