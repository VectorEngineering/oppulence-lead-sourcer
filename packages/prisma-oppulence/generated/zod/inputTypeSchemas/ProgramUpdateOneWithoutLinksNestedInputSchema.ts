...
export const ProgramUpdateOneWithoutLinksNestedInputSchema: z.ZodType<Prisma.ProgramUpdateOneWithoutLinksNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => ProgramCreateWithoutLinksInputSchema), z.lazy(() => ProgramUncheckedCreateWithoutLinksInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => ProgramUpdateToOneWithWhereWithoutLinksInputSchema),
                z.lazy(() => ProgramUpdateWithoutLinksInputSchema),
                z.lazy(() => ProgramUncheckedUpdateWithoutLinksInputSchema)
            ])
            .optional()
    })
    .strict()
