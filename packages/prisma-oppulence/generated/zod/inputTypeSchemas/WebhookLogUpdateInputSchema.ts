...
import { WebhookUpdateOneRequiredWithoutLogsNestedInputSchema } from './WebhookUpdateOneRequiredWithoutLogsNestedInputSchema';

export const WebhookLogUpdateInputSchema: z.ZodType<Prisma.WebhookLogUpdateInput> = z.object({
  ...
  webhook: z.lazy(() => WebhookUpdateOneRequiredWithoutLogsNestedInputSchema).optional()
}).strict();

export default WebhookLogUpdateInputSchema;
