...
export const ContractEventUpdateManyWithoutContractNestedInputSchema: z.ZodType<Prisma.ContractEventUpdateManyWithoutContractNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ContractEventUpsertWithWhereUniqueWithoutContractInputSchema),z.lazy(() => ContractEventUpsertWithWhereUniqueWithoutContractInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ContractEventCreateManyContractInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ContractEventWhereUniqueInputSchema),z.lazy(() => ContractEventWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ContractEventWhereUniqueInputSchema),z.lazy(() => ContractEventWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ContractEventWhereUniqueInputSchema),z.lazy(() => ContractEventWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => ContractEventWhereUniqueInputSchema),z.lazy(() => ContractEventWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ContractEventUpdateWithWhereUniqueWithoutContractInputSchema),z.lazy(() => ContractEventUpdateWithWhereUniqueWithoutContractInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ContractEventUpdateManyWithWhereWithoutContractInputSchema),z.lazy(() => ContractEventUpdateManyWithWhereWithoutContractInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ContractEventScalarWhereInputSchema),z.lazy(() => ContractEventScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ContractEventUpdateManyWithoutContractNestedInputSchema;
