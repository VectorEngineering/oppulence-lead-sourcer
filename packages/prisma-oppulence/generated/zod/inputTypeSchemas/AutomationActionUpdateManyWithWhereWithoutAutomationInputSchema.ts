...
export const AutomationActionUpdateManyWithWhereWithoutAutomationInputSchema: z.ZodType<Prisma.AutomationActionUpdateManyWithWhereWithoutAutomationInput> =
    z
        .object({
            where: z.lazy(() => AutomationActionScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => AutomationActionUpdateManyMutationInputSchema),
                z.lazy(() => AutomationActionUncheckedUpdateManyWithoutAutomationInputSchema)
            ])
        })
        .strict()
