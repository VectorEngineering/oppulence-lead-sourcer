...
export const RegisteredDomainUncheckedUpdateOneWithoutDomainNestedInputSchema: z.ZodType<Prisma.RegisteredDomainUncheckedUpdateOneWithoutDomainNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => RegisteredDomainUpdateToOneWithWhereWithoutDomainInputSchema),
...
export default RegisteredDomainUncheckedUpdateOneWithoutDomainNestedInputSchema
