...
export const AIAssistantSettingsUncheckedUpdateOneWithoutUserNestedInputSchema: z.ZodType<Prisma.AIAssistantSettingsUncheckedUpdateOneWithoutUserNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => AIAssistantSettingsUpdateToOneWithWhereWithoutUserInputSchema),
...
export default AIAssistantSettingsUncheckedUpdateOneWithoutUserNestedInputSchema
