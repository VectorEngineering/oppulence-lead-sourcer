...
import { StageDurationUncheckedCreateNestedManyWithoutPipelineInputSchema } from './StageDurationUncheckedCreateNestedManyWithoutPipelineInputSchema';
...
export const PipelineUncheckedCreateWithoutIntegrationsInputSchema: z.ZodType<Prisma.PipelineUncheckedCreateWithoutIntegrationsInput> = z.object({
  ...
  stageDurations: z.lazy(() => StageDurationUncheckedCreateNestedManyWithoutPipelineInputSchema).optional(),
  accessRules: z.lazy(() => PipelineAccessRuleUncheckedCreateNestedManyWithoutPipelineInputSchema).optional()
}).strict();

export default PipelineUncheckedCreateWithoutIntegrationsInputSchema;
