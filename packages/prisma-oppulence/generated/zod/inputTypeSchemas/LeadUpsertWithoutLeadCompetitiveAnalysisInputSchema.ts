...
export const LeadUpsertWithoutLeadCompetitiveAnalysisInputSchema: z.ZodType<Prisma.LeadUpsertWithoutLeadCompetitiveAnalysisInput> = z.object({
  update: z.union([ z.lazy(() => LeadUpdateWithoutLeadCompetitiveAnalysisInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutLeadCompetitiveAnalysisInputSchema) ]),
  create: z.union([ z.lazy(() => LeadCreateWithoutLeadCompetitiveAnalysisInputSchema),z.lazy(() => LeadUncheckedCreateWithoutLeadCompetitiveAnalysisInputSchema) ]),
