...
export const ProjectUsersUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.ProjectUsersUncheckedUpdateManyWithoutUserNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ProjectUsersUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => ProjectUsersUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProjectUsersUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => ProjectUsersUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProjectUsersUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => ProjectUsersUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ProjectUsersScalarWhereInputSchema),z.lazy(() => ProjectUsersScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ProjectUsersUncheckedUpdateManyWithoutUserNestedInputSchema;
