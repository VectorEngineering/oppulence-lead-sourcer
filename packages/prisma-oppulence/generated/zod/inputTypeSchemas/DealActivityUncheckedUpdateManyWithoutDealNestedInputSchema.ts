...
export const DealActivityUncheckedUpdateManyWithoutDealNestedInputSchema: z.ZodType<Prisma.DealActivityUncheckedUpdateManyWithoutDealNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => DealActivityUpsertWithWhereUniqueWithoutDealInputSchema),z.lazy(() => DealActivityUpsertWithWhereUniqueWithoutDealInputSchema).array() ]).optional(),
  createMany: z.lazy(() => DealActivityCreateManyDealInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => DealActivityWhereUniqueInputSchema),z.lazy(() => DealActivityWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => DealActivityWhereUniqueInputSchema),z.lazy(() => DealActivityWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => DealActivityWhereUniqueInputSchema),z.lazy(() => DealActivityWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => DealActivityWhereUniqueInputSchema),z.lazy(() => DealActivityWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => DealActivityUpdateWithWhereUniqueWithoutDealInputSchema),z.lazy(() => DealActivityUpdateWithWhereUniqueWithoutDealInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => DealActivityUpdateManyWithWhereWithoutDealInputSchema),z.lazy(() => DealActivityUpdateManyWithWhereWithoutDealInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => DealActivityScalarWhereInputSchema),z.lazy(() => DealActivityScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default DealActivityUncheckedUpdateManyWithoutDealNestedInputSchema;
