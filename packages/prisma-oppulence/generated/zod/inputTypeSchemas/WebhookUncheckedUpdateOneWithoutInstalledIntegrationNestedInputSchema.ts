...
export const WebhookUncheckedUpdateOneWithoutInstalledIntegrationNestedInputSchema: z.ZodType<Prisma.WebhookUncheckedUpdateOneWithoutInstalledIntegrationNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => WebhookUpdateToOneWithWhereWithoutInstalledIntegrationInputSchema),
