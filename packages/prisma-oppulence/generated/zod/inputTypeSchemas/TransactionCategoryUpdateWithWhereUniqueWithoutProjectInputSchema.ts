...
export const TransactionCategoryUpdateWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.TransactionCategoryUpdateWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => TransactionCategoryWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => TransactionCategoryUpdateWithoutProjectInputSchema),z.lazy(() => TransactionCategoryUncheckedUpdateWithoutProjectInputSchema) ]),
}).strict();
