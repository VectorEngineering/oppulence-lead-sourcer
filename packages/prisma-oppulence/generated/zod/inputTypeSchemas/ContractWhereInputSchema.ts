...
export const ContractWhereInputSchema: z.ZodType<Prisma.ContractWhereInput> = z
    .object({
        AND: z.union([z.lazy(() => ContractWhereInputSchema), z.lazy(() => ContractWhereInputSchema).array()]).optional(),
        OR: z
            .lazy(() => ContractWhereInputSchema)
            .array()
            .optional(),
        ...
        parentContract: z
            .union([z.lazy(() => ContractNullableRelationFilterSchema), z.lazy(() => ContractWhereInputSchema)])
            .optional()
            .nullable(),
...
export default ContractWhereInputSchema
