...
export const CampaignUpdateManyWithWhereWithoutTouchpointsInputSchema: z.ZodType<Prisma.CampaignUpdateManyWithWhereWithoutTouchpointsInput> =
    z
        .object({
            where: z.lazy(() => CampaignScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => CampaignUpdateManyMutationInputSchema),
                z.lazy(() => CampaignUncheckedUpdateManyWithoutTouchpointsInputSchema)
            ])
        })
        .strict()
