...
export const UserUpdateOneWithoutLeadNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutLeadNestedInput> = z
    .object({
        create: z
        ...
        update: z
            .union([
                z.lazy(() => UserUpdateToOneWithWhereWithoutLeadInputSchema),
                z.lazy(() => UserUpdateWithoutLeadInputSchema),
                z.lazy(() => UserUncheckedUpdateWithoutLeadInputSchema)
            ])
            .optional()
    })
    .strict()
