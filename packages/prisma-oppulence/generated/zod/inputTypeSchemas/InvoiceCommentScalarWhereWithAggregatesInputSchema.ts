...
export const InvoiceCommentScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.InvoiceCommentScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => InvoiceCommentScalarWhereWithAggregatesInputSchema),z.lazy(() => InvoiceCommentScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => InvoiceCommentScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => InvoiceCommentScalarWhereWithAggregatesInputSchema),z.lazy(() => InvoiceCommentScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  visibility: z.union([ z.lazy(() => EnumInvoiceCommentVisibilityWithAggregatesFilterSchema),z.lazy(() => InvoiceCommentVisibilitySchema) ]).optional(),
  ...
  threadPath: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  ...
  lastReplyAt: z.union([ z.lazy(() => DateTimeNullableWithAggregatesFilterSchema),z.coerce.date() ]).optional().nullable(),
  resolvedAt: z.union([ z.lazy(() => DateTimeNullableWithAggregatesFilterSchema),z.coerce.date() ]).optional().nullable(),
  resolvedBy: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
