...
export const StageRequiredFieldUpdateManyWithoutStageNestedInputSchema: z.ZodType<Prisma.StageRequiredFieldUpdateManyWithoutStageNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => StageRequiredFieldUpsertWithWhereUniqueWithoutStageInputSchema),z.lazy(() => StageRequiredFieldUpsertWithWhereUniqueWithoutStageInputSchema).array() ]).optional(),
  createMany: z.lazy(() => StageRequiredFieldCreateManyStageInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => StageRequiredFieldWhereUniqueInputSchema),z.lazy(() => StageRequiredFieldWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => StageRequiredFieldWhereUniqueInputSchema),z.lazy(() => StageRequiredFieldWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => StageRequiredFieldWhereUniqueInputSchema),z.lazy(() => StageRequiredFieldWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => StageRequiredFieldUpdateWithWhereUniqueWithoutStageInputSchema),z.lazy(() => StageRequiredFieldUpdateWithWhereUniqueWithoutStageInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => StageRequiredFieldUpdateManyWithWhereWithoutStageInputSchema),z.lazy(() => StageRequiredFieldUpdateManyWithWhereWithoutStageInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => StageRequiredFieldScalarWhereInputSchema),z.lazy(() => StageRequiredFieldScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default StageRequiredFieldUpdateManyWithoutStageNestedInputSchema;
