...
export const LeadUpdateToOneWithWhereWithoutDecisionMakersInputSchema: z.ZodType<Prisma.LeadUpdateToOneWithWhereWithoutDecisionMakersInput> = z.object({
  where: z.lazy(() => LeadWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => LeadUpdateWithoutDecisionMakersInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutDecisionMakersInputSchema) ]),
}).strict();
