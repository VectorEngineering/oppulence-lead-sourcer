...
export const DealHistoryUpdateManyWithWhereWithoutDealInputSchema: z.ZodType<Prisma.DealHistoryUpdateManyWithWhereWithoutDealInput> = z
    .object({
        where: z.lazy(() => DealHistoryScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => DealHistoryUpdateManyMutationInputSchema),
            z.lazy(() => DealHistoryUncheckedUpdateManyWithoutDealInputSchema)
        ])
    })
    .strict()
