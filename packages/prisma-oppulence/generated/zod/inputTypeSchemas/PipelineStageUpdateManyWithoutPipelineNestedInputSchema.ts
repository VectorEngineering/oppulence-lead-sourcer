...
export const PipelineStageUpdateManyWithoutPipelineNestedInputSchema: z.ZodType<Prisma.PipelineStageUpdateManyWithoutPipelineNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => PipelineStageCreateWithoutPipelineInputSchema),
                    z.lazy(() => PipelineStageCreateWithoutPipelineInputSchema).array(),
                    z.lazy(() => PipelineStageUncheckedCreateWithoutPipelineInputSchema),
                    z.lazy(() => PipelineStageUncheckedCreateWithoutPipelineInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => PipelineStageCreateOrConnectWithoutPipelineInputSchema),
                    z.lazy(() => PipelineStageCreateOrConnectWithoutPipelineInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => PipelineStageUpsertWithWhereUniqueWithoutPipelineInputSchema),
                    z.lazy(() => PipelineStageUpsertWithWhereUniqueWithoutPipelineInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => PipelineStageCreateManyPipelineInputEnvelopeSchema).optional(),
            set: z
                .union([z.lazy(() => PipelineStageWhereUniqueInputSchema), z.lazy(() => PipelineStageWhereUniqueInputSchema).array()])
                .optional(),
            disconnect: z
                .union([z.lazy(() => PipelineStageWhereUniqueInputSchema), z.lazy(() => PipelineStageWhereUniqueInputSchema).array()])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => PipelineStageUpdateWithWhereUniqueWithoutPipelineInputSchema),
                    z.lazy(() => PipelineStageUpdateWithWhereUniqueWithoutPipelineInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => PipelineStageUpdateManyWithWhereWithoutPipelineInputSchema),
                    z.lazy(() => PipelineStageUpdateManyWithWhereWithoutPipelineInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default PipelineStageUpdateManyWithoutPipelineNestedInputSchema
