...
export const DealActivityUpsertWithWhereUniqueWithoutDealInputSchema: z.ZodType<Prisma.DealActivityUpsertWithWhereUniqueWithoutDealInput> = z.object({
  where: z.lazy(() => DealActivityWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => DealActivityUpdateWithoutDealInputSchema),z.lazy(() => DealActivityUncheckedUpdateWithoutDealInputSchema) ]),
  create: z.union([ z.lazy(() => DealActivityCreateWithoutDealInputSchema),z.lazy(() => DealActivityUncheckedCreateWithoutDealInputSchema) ]),
}).strict();
