...
export const ProgramEnrollmentUpdateManyWithWhereWithoutProgramInputSchema: z.ZodType<Prisma.ProgramEnrollmentUpdateManyWithWhereWithoutProgramInput> = z.object({
  where: z.lazy(() => ProgramEnrollmentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ProgramEnrollmentUpdateManyMutationInputSchema),z.lazy(() => ProgramEnrollmentUncheckedUpdateManyWithoutProgramInputSchema) ]),
}).strict();
