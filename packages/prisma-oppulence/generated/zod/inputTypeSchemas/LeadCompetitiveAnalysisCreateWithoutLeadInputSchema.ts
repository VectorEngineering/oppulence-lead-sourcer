...
import { LeadCompetitiveHistoryCreateNestedManyWithoutAnalysisInputSchema } from './LeadCompetitiveHistoryCreateNestedManyWithoutAnalysisInputSchema';

export const LeadCompetitiveAnalysisCreateWithoutLeadInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisCreateWithoutLeadInput> = z.object({
  ...
  analysisHistory: z.lazy(() => LeadCompetitiveHistoryCreateNestedManyWithoutAnalysisInputSchema).optional()
}).strict();

export default LeadCompetitiveAnalysisCreateWithoutLeadInputSchema;
