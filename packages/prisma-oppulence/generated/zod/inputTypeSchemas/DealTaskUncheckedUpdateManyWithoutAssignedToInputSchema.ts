...
export const DealTaskUncheckedUpdateManyWithoutAssignedToInputSchema: z.ZodType<Prisma.DealTaskUncheckedUpdateManyWithoutAssignedToInput> =
    z
        .object({
            ...
            priority: z
                ...
                .nullable(),
            status: z
                .union([z.lazy(() => DealTaskStatusSchema), z.lazy(() => EnumDealTaskStatusFieldUpdateOperationsInputSchema)])
                .optional(),
            completedAt: z
                .union([z.coerce.date(), z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema)])
                .optional()
