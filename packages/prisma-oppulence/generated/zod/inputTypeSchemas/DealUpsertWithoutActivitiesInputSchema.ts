...
export const DealUpsertWithoutActivitiesInputSchema: z.ZodType<Prisma.DealUpsertWithoutActivitiesInput> = z.object({
  update: z.union([ z.lazy(() => DealUpdateWithoutActivitiesInputSchema),z.lazy(() => DealUncheckedUpdateWithoutActivitiesInputSchema) ]),
  create: z.union([ z.lazy(() => DealCreateWithoutActivitiesInputSchema),z.lazy(() => DealUncheckedCreateWithoutActivitiesInputSchema) ]),
