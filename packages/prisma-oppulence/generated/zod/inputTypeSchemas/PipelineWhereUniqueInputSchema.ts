...
export const PipelineWhereUniqueInputSchema: z.ZodType<Prisma.PipelineWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    slug: z.string()
  }),
...
.and(z.object({
  ...
  typicalSalesCycle: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  ...
  dealCountTarget: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  ...
  dataRetention: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
...
export default PipelineWhereUniqueInputSchema;
