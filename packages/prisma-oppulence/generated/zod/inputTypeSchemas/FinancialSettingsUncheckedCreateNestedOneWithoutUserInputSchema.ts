...
export const FinancialSettingsUncheckedCreateNestedOneWithoutUserInputSchema: z.ZodType<Prisma.FinancialSettingsUncheckedCreateNestedOneWithoutUserInput> =
    z
        .object({
            create: z
                .union([
