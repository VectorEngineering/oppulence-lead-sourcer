...
export const LeadCompetitiveAnalysisUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisUpdateManyWithWhereWithoutLeadInput> =
    z
        .object({
            where: z.lazy(() => LeadCompetitiveAnalysisScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LeadCompetitiveAnalysisUpdateManyMutationInputSchema),
                z.lazy(() => LeadCompetitiveAnalysisUncheckedUpdateManyWithoutLeadInputSchema)
            ])
        })
        .strict()
