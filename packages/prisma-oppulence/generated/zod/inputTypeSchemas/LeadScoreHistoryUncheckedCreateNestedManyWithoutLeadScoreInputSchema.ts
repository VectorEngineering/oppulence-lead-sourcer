...
export const LeadScoreHistoryUncheckedCreateNestedManyWithoutLeadScoreInputSchema: z.ZodType<Prisma.LeadScoreHistoryUncheckedCreateNestedManyWithoutLeadScoreInput> =
    z
        .object({
            create: z
                .union([
