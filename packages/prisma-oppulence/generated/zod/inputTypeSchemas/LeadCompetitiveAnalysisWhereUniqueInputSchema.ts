...
export const LeadCompetitiveAnalysisWhereUniqueInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
            leadId: z.string()
            ...
            .object({
                ...
                AND: z
                    .union([
                        ...
                        z.lazy(() => LeadCompetitiveAnalysisWhereInputSchema).array()
                    ])
                    .optional(),
                OR: z
                    .lazy(() => LeadCompetitiveAnalysisWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([
