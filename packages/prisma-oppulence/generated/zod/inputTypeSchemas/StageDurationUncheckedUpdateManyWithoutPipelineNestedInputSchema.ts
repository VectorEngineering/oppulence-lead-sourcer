...
export const StageDurationUncheckedUpdateManyWithoutPipelineNestedInputSchema: z.ZodType<Prisma.StageDurationUncheckedUpdateManyWithoutPipelineNestedInput> =
    z
        .object({
            create: z
                .union([
