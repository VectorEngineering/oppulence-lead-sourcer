...
export const ProjectCreateNestedOneWithoutPipelineInputSchema: z.ZodType<Prisma.ProjectCreateNestedOneWithoutPipelineInput> = z
    .object({
        create: z
            .union([z.lazy(() => ProjectCreateWithoutPipelineInputSchema), z.lazy(() => ProjectUncheckedCreateWithoutPipelineInputSchema)])
            .optional(),
