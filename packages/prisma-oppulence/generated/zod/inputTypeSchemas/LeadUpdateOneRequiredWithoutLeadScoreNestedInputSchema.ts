...
export const LeadUpdateOneRequiredWithoutLeadScoreNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutLeadScoreNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LeadUpdateToOneWithWhereWithoutLeadScoreInputSchema),z.lazy(() => LeadUpdateWithoutLeadScoreInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutLeadScoreInputSchema) ]).optional(),
}).strict();
