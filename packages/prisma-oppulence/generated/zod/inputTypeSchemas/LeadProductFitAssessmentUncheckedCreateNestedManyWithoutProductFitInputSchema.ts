...
export const LeadProductFitAssessmentUncheckedCreateNestedManyWithoutProductFitInputSchema: z.ZodType<Prisma.LeadProductFitAssessmentUncheckedCreateNestedManyWithoutProductFitInput> =
    z
        .object({
            create: z
                .union([
