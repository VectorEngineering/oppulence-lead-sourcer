...
export const LeadCompetitiveAnalysisUpdateWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisUpdateWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadCompetitiveAnalysisWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadCompetitiveAnalysisUpdateWithoutLeadInputSchema),z.lazy(() => LeadCompetitiveAnalysisUncheckedUpdateWithoutLeadInputSchema) ]),
}).strict();
