...
export const DealProductCreateNestedManyWithoutDealInputSchema: z.ZodType<Prisma.DealProductCreateNestedManyWithoutDealInput> = z
    .object({
        create: z
            .union([
...
export default DealProductCreateNestedManyWithoutDealInputSchema
