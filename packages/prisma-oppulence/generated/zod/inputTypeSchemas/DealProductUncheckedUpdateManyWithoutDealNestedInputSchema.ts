...
export const DealProductUncheckedUpdateManyWithoutDealNestedInputSchema: z.ZodType<Prisma.DealProductUncheckedUpdateManyWithoutDealNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => DealProductCreateWithoutDealInputSchema),
                    z.lazy(() => DealProductCreateWithoutDealInputSchema).array(),
                    z.lazy(() => DealProductUncheckedCreateWithoutDealInputSchema),
                    z.lazy(() => DealProductUncheckedCreateWithoutDealInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => DealProductCreateOrConnectWithoutDealInputSchema),
                    z.lazy(() => DealProductCreateOrConnectWithoutDealInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => DealProductUpsertWithWhereUniqueWithoutDealInputSchema),
                    z.lazy(() => DealProductUpsertWithWhereUniqueWithoutDealInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => DealProductCreateManyDealInputEnvelopeSchema).optional(),
            set: z
                .union([z.lazy(() => DealProductWhereUniqueInputSchema), z.lazy(() => DealProductWhereUniqueInputSchema).array()])
                .optional(),
            disconnect: z
                .union([z.lazy(() => DealProductWhereUniqueInputSchema), z.lazy(() => DealProductWhereUniqueInputSchema).array()])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => DealProductUpdateWithWhereUniqueWithoutDealInputSchema),
                    z.lazy(() => DealProductUpdateWithWhereUniqueWithoutDealInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => DealProductUpdateManyWithWhereWithoutDealInputSchema),
                    z.lazy(() => DealProductUpdateManyWithWhereWithoutDealInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([z.lazy(() => DealProductScalarWhereInputSchema), z.lazy(() => DealProductScalarWhereInputSchema).array()])
                .optional()
        })
        .strict()

export default DealProductUncheckedUpdateManyWithoutDealNestedInputSchema
