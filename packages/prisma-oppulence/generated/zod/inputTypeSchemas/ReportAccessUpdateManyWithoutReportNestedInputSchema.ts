...
export const ReportAccessUpdateManyWithoutReportNestedInputSchema: z.ZodType<Prisma.ReportAccessUpdateManyWithoutReportNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ReportAccessUpsertWithWhereUniqueWithoutReportInputSchema),z.lazy(() => ReportAccessUpsertWithWhereUniqueWithoutReportInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ReportAccessUpdateWithWhereUniqueWithoutReportInputSchema),z.lazy(() => ReportAccessUpdateWithWhereUniqueWithoutReportInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ReportAccessUpdateManyWithWhereWithoutReportInputSchema),z.lazy(() => ReportAccessUpdateManyWithWhereWithoutReportInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ReportAccessScalarWhereInputSchema),z.lazy(() => ReportAccessScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ReportAccessUpdateManyWithoutReportNestedInputSchema;
