...
export const LeadComplianceAuditCreateNestedOneWithoutAuditHistoryInputSchema: z.ZodType<Prisma.LeadComplianceAuditCreateNestedOneWithoutAuditHistoryInput> =
    z
        .object({
            create: z
                .union([
