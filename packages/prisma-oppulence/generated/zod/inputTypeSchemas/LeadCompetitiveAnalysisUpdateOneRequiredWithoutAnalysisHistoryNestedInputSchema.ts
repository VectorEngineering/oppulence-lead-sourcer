...
export const LeadCompetitiveAnalysisUpdateOneRequiredWithoutAnalysisHistoryNestedInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisUpdateOneRequiredWithoutAnalysisHistoryNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LeadCompetitiveAnalysisUpdateToOneWithWhereWithoutAnalysisHistoryInputSchema),z.lazy(() => LeadCompetitiveAnalysisUpdateWithoutAnalysisHistoryInputSchema),z.lazy(() => LeadCompetitiveAnalysisUncheckedUpdateWithoutAnalysisHistoryInputSchema) ]).optional(),
}).strict();
