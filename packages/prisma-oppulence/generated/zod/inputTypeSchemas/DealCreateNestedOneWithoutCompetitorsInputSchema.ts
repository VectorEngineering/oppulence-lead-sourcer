...
export const DealCreateNestedOneWithoutCompetitorsInputSchema: z.ZodType<Prisma.DealCreateNestedOneWithoutCompetitorsInput> = z
    .object({
        create: z
            .union([z.lazy(() => DealCreateWithoutCompetitorsInputSchema), z.lazy(() => DealUncheckedCreateWithoutCompetitorsInputSchema)])
            .optional(),
