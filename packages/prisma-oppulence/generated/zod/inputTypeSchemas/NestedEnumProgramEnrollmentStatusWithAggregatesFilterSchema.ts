...
export const NestedEnumProgramEnrollmentStatusWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumProgramEnrollmentStatusWithAggregatesFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => ProgramEnrollmentStatusSchema),z.lazy(() => NestedEnumProgramEnrollmentStatusWithAggregatesFilterSchema) ]).optional(),
