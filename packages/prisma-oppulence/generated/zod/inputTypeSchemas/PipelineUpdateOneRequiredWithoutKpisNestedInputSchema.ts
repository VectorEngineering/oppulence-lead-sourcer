...
export const PipelineUpdateOneRequiredWithoutKpisNestedInputSchema: z.ZodType<Prisma.PipelineUpdateOneRequiredWithoutKpisNestedInput> = z
    .object({
        create: z
        ...
        update: z
            .union([
                z.lazy(() => PipelineUpdateToOneWithWhereWithoutKpisInputSchema),
                z.lazy(() => PipelineUpdateWithoutKpisInputSchema),
                z.lazy(() => PipelineUncheckedUpdateWithoutKpisInputSchema)
            ])
            .optional()
    })
    .strict()
