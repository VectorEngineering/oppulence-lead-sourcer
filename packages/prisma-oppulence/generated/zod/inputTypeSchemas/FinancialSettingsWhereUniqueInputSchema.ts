...
export const FinancialSettingsWhereUniqueInputSchema: z.ZodType<Prisma.FinancialSettingsWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    userId: z.string()
  }),
...
.and(z.object({
  ...
  OR: z.lazy(() => FinancialSettingsWhereInputSchema).array().optional(),
  ...
  supportedCurrencies: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  stripeCardPaymentsCapability: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  stripeTransfersCapability: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  activePaymentProviders: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  providerConfigs: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  autoCategorizeTxn: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  minTxnAmount: z.union([ z.lazy(() => DecimalNullableFilterSchema),z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional().nullable(),
  maxTxnAmount: z.union([ z.lazy(() => DecimalNullableFilterSchema),z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional().nullable(),
  notifyLargeTransactions: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  largeTransactionThreshold: z.union([ z.lazy(() => DecimalNullableFilterSchema),z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional().nullable(),
  ...
  lowBalanceThreshold: z.union([ z.lazy(() => DecimalNullableFilterSchema),z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional().nullable(),
  autoReconciliation: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  reconciliationWindow: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  ...
  lastSuccessfulSync: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
...
export default FinancialSettingsWhereUniqueInputSchema;
