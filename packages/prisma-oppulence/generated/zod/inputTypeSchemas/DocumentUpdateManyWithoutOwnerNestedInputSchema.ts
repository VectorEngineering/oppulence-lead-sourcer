...
export const DocumentUpdateManyWithoutOwnerNestedInputSchema: z.ZodType<Prisma.DocumentUpdateManyWithoutOwnerNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => DocumentUpsertWithWhereUniqueWithoutOwnerInputSchema),
                z.lazy(() => DocumentUpsertWithWhereUniqueWithoutOwnerInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => DocumentUpdateWithWhereUniqueWithoutOwnerInputSchema),
                z.lazy(() => DocumentUpdateWithWhereUniqueWithoutOwnerInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => DocumentUpdateManyWithWhereWithoutOwnerInputSchema),
                z.lazy(() => DocumentUpdateManyWithWhereWithoutOwnerInputSchema).array()
            ])
            .optional(),
...
export default DocumentUpdateManyWithoutOwnerNestedInputSchema
