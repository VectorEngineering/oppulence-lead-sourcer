...
export const LeadCategoryUpdateWithWhereUniqueWithoutLeadsInputSchema: z.ZodType<Prisma.LeadCategoryUpdateWithWhereUniqueWithoutLeadsInput> = z.object({
  where: z.lazy(() => LeadCategoryWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadCategoryUpdateWithoutLeadsInputSchema),z.lazy(() => LeadCategoryUncheckedUpdateWithoutLeadsInputSchema) ]),
}).strict();
