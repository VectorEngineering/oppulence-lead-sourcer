...
export const LeadExternalSystemScalarWhereInputSchema: z.ZodType<Prisma.LeadExternalSystemScalarWhereInput> = z
    .object({
        AND: z
            .union([z.lazy(() => LeadExternalSystemScalarWhereInputSchema), z.lazy(() => LeadExternalSystemScalarWhereInputSchema).array()])
            .optional(),
        OR: z
            .lazy(() => LeadExternalSystemScalarWhereInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([z.lazy(() => LeadExternalSystemScalarWhereInputSchema), z.lazy(() => LeadExternalSystemScalarWhereInputSchema).array()])
