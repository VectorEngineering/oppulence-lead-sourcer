...
export const LeadSegmentationUpdateOneRequiredWithoutSegmentationHistoryNestedInputSchema: z.ZodType<Prisma.LeadSegmentationUpdateOneRequiredWithoutSegmentationHistoryNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LeadSegmentationUpdateToOneWithWhereWithoutSegmentationHistoryInputSchema),z.lazy(() => LeadSegmentationUpdateWithoutSegmentationHistoryInputSchema),z.lazy(() => LeadSegmentationUncheckedUpdateWithoutSegmentationHistoryInputSchema) ]).optional(),
}).strict();
