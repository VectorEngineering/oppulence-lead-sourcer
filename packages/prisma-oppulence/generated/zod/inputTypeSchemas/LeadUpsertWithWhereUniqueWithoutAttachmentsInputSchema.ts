...
export const LeadUpsertWithWhereUniqueWithoutAttachmentsInputSchema: z.ZodType<Prisma.LeadUpsertWithWhereUniqueWithoutAttachmentsInput> = z
    .object({
        where: z.lazy(() => LeadWhereUniqueInputSchema),
        update: z.union([
            z.lazy(() => LeadUpdateWithoutAttachmentsInputSchema),
            z.lazy(() => LeadUncheckedUpdateWithoutAttachmentsInputSchema)
        ]),
        create: z.union([
