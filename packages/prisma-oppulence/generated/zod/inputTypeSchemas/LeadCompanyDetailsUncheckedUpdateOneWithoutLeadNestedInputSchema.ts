...
export const LeadCompanyDetailsUncheckedUpdateOneWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadCompanyDetailsUncheckedUpdateOneWithoutLeadNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LeadCompanyDetailsUpdateToOneWithWhereWithoutLeadInputSchema),z.lazy(() => LeadCompanyDetailsUpdateWithoutLeadInputSchema),z.lazy(() => LeadCompanyDetailsUncheckedUpdateWithoutLeadInputSchema) ]).optional(),
}).strict();

export default LeadCompanyDetailsUncheckedUpdateOneWithoutLeadNestedInputSchema;
