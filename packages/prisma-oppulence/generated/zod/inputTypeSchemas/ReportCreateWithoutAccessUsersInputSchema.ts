...
import { ReportScheduleCreateNestedManyWithoutReportInputSchema } from './ReportScheduleCreateNestedManyWithoutReportInputSchema';
...
export const ReportCreateWithoutAccessUsersInputSchema: z.ZodType<Prisma.ReportCreateWithoutAccessUsersInput> = z.object({
  ...
  schedules: z.lazy(() => ReportScheduleCreateNestedManyWithoutReportInputSchema).optional(),
  recipients: z.lazy(() => ReportRecipientCreateNestedManyWithoutReportInputSchema).optional()
}).strict();

export default ReportCreateWithoutAccessUsersInputSchema;
