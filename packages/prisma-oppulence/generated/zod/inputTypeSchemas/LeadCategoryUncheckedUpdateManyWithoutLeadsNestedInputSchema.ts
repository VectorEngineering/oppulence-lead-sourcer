...
export const LeadCategoryUncheckedUpdateManyWithoutLeadsNestedInputSchema: z.ZodType<Prisma.LeadCategoryUncheckedUpdateManyWithoutLeadsNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCategoryCreateWithoutLeadsInputSchema),z.lazy(() => LeadCategoryCreateWithoutLeadsInputSchema).array(),z.lazy(() => LeadCategoryUncheckedCreateWithoutLeadsInputSchema),z.lazy(() => LeadCategoryUncheckedCreateWithoutLeadsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LeadCategoryCreateOrConnectWithoutLeadsInputSchema),z.lazy(() => LeadCategoryCreateOrConnectWithoutLeadsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LeadCategoryUpsertWithWhereUniqueWithoutLeadsInputSchema),z.lazy(() => LeadCategoryUpsertWithWhereUniqueWithoutLeadsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadCategoryUpdateWithWhereUniqueWithoutLeadsInputSchema),z.lazy(() => LeadCategoryUpdateWithWhereUniqueWithoutLeadsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadCategoryUpdateManyWithWhereWithoutLeadsInputSchema),z.lazy(() => LeadCategoryUpdateManyWithWhereWithoutLeadsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadCategoryScalarWhereInputSchema),z.lazy(() => LeadCategoryScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadCategoryUncheckedUpdateManyWithoutLeadsNestedInputSchema;
