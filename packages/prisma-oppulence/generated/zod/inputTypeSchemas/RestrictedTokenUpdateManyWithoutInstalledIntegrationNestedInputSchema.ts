...
export const RestrictedTokenUpdateManyWithoutInstalledIntegrationNestedInputSchema: z.ZodType<Prisma.RestrictedTokenUpdateManyWithoutInstalledIntegrationNestedInput> =
    z
        .object({
            create: z
                .union([
