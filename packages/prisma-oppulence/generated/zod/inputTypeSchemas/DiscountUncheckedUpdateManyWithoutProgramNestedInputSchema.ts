...
export const DiscountUncheckedUpdateManyWithoutProgramNestedInputSchema: z.ZodType<Prisma.DiscountUncheckedUpdateManyWithoutProgramNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => DiscountCreateWithoutProgramInputSchema),
                    z.lazy(() => DiscountCreateWithoutProgramInputSchema).array(),
                    z.lazy(() => DiscountUncheckedCreateWithoutProgramInputSchema),
                    z.lazy(() => DiscountUncheckedCreateWithoutProgramInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => DiscountCreateOrConnectWithoutProgramInputSchema),
                    z.lazy(() => DiscountCreateOrConnectWithoutProgramInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => DiscountUpsertWithWhereUniqueWithoutProgramInputSchema),
                    z.lazy(() => DiscountUpsertWithWhereUniqueWithoutProgramInputSchema).array()
                ])
                .optional(),
            ...
            disconnect: z
                .union([z.lazy(() => DiscountWhereUniqueInputSchema), z.lazy(() => DiscountWhereUniqueInputSchema).array()])
                .optional(),
            delete: z
                .union([z.lazy(() => DiscountWhereUniqueInputSchema), z.lazy(() => DiscountWhereUniqueInputSchema).array()])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => DiscountUpdateWithWhereUniqueWithoutProgramInputSchema),
                    z.lazy(() => DiscountUpdateWithWhereUniqueWithoutProgramInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => DiscountUpdateManyWithWhereWithoutProgramInputSchema),
                    z.lazy(() => DiscountUpdateManyWithWhereWithoutProgramInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([z.lazy(() => DiscountScalarWhereInputSchema), z.lazy(() => DiscountScalarWhereInputSchema).array()])
                .optional()
        })
        .strict()
