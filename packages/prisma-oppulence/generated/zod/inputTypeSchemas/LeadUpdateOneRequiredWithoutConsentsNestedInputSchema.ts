...
export const LeadUpdateOneRequiredWithoutConsentsNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutConsentsNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCreateWithoutConsentsInputSchema),z.lazy(() => LeadUncheckedCreateWithoutConsentsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateToOneWithWhereWithoutConsentsInputSchema),z.lazy(() => LeadUpdateWithoutConsentsInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutConsentsInputSchema) ]).optional(),
}).strict();
