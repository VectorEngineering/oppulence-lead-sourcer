...
export const AutomationConditionUpdateManyWithWhereWithoutAutomationInputSchema: z.ZodType<Prisma.AutomationConditionUpdateManyWithWhereWithoutAutomationInput> =
    z
        .object({
            where: z.lazy(() => AutomationConditionScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => AutomationConditionUpdateManyMutationInputSchema),
                z.lazy(() => AutomationConditionUncheckedUpdateManyWithoutAutomationInputSchema)
            ])
        })
        .strict()
