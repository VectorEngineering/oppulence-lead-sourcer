...
export const LeadSegmentationHistoryUpdateManyWithoutSegmentationNestedInputSchema: z.ZodType<Prisma.LeadSegmentationHistoryUpdateManyWithoutSegmentationNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => LeadSegmentationHistoryCreateWithoutSegmentationInputSchema),
                    z.lazy(() => LeadSegmentationHistoryCreateWithoutSegmentationInputSchema).array(),
                    z.lazy(() => LeadSegmentationHistoryUncheckedCreateWithoutSegmentationInputSchema),
                    z.lazy(() => LeadSegmentationHistoryUncheckedCreateWithoutSegmentationInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => LeadSegmentationHistoryCreateOrConnectWithoutSegmentationInputSchema),
                    z.lazy(() => LeadSegmentationHistoryCreateOrConnectWithoutSegmentationInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => LeadSegmentationHistoryUpsertWithWhereUniqueWithoutSegmentationInputSchema),
                    z.lazy(() => LeadSegmentationHistoryUpsertWithWhereUniqueWithoutSegmentationInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => LeadSegmentationHistoryCreateManySegmentationInputEnvelopeSchema).optional(),
            set: z
                .union([
                    z.lazy(() => LeadSegmentationHistoryWhereUniqueInputSchema),
                    z.lazy(() => LeadSegmentationHistoryWhereUniqueInputSchema).array()
                ])
                .optional(),
            disconnect: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadSegmentationHistoryUpdateWithWhereUniqueWithoutSegmentationInputSchema),
                    z.lazy(() => LeadSegmentationHistoryUpdateWithWhereUniqueWithoutSegmentationInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => LeadSegmentationHistoryUpdateManyWithWhereWithoutSegmentationInputSchema),
                    z.lazy(() => LeadSegmentationHistoryUpdateManyWithWhereWithoutSegmentationInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
...
export default LeadSegmentationHistoryUpdateManyWithoutSegmentationNestedInputSchema
