...
export const DealCompetitorUpdateWithWhereUniqueWithoutDealInputSchema: z.ZodType<Prisma.DealCompetitorUpdateWithWhereUniqueWithoutDealInput> = z.object({
  where: z.lazy(() => DealCompetitorWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => DealCompetitorUpdateWithoutDealInputSchema),z.lazy(() => DealCompetitorUncheckedUpdateWithoutDealInputSchema) ]),
}).strict();
