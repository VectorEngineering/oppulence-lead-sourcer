...
export const OAuthAppUpdateToOneWithWhereWithoutIntegrationInputSchema: z.ZodType<Prisma.OAuthAppUpdateToOneWithWhereWithoutIntegrationInput> = z.object({
  where: z.lazy(() => OAuthAppWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => OAuthAppUpdateWithoutIntegrationInputSchema),z.lazy(() => OAuthAppUncheckedUpdateWithoutIntegrationInputSchema) ]),
}).strict();
