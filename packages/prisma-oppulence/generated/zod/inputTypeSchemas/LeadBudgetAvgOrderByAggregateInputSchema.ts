...
export const LeadBudgetAvgOrderByAggregateInputSchema: z.ZodType<Prisma.LeadBudgetAvgOrderByAggregateInput> = z.object({
...
export default LeadBudgetAvgOrderByAggregateInputSchema;
