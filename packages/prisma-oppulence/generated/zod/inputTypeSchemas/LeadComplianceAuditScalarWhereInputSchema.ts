...
export const LeadComplianceAuditScalarWhereInputSchema: z.ZodType<Prisma.LeadComplianceAuditScalarWhereInput> = z
    .object({
        AND: z
            .union([
            ...
            .optional(),
        OR: z
            .lazy(() => LeadComplianceAuditScalarWhereInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
