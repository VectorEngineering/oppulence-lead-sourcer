...
export const ReportAccessUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.ReportAccessUpsertWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => ReportAccessWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ReportAccessUpdateWithoutUserInputSchema),z.lazy(() => ReportAccessUncheckedUpdateWithoutUserInputSchema) ]),
  create: z.union([ z.lazy(() => ReportAccessCreateWithoutUserInputSchema),z.lazy(() => ReportAccessUncheckedCreateWithoutUserInputSchema) ]),
}).strict();
