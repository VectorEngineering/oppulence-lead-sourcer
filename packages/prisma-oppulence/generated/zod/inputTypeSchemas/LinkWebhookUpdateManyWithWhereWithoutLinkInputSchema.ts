...
export const LinkWebhookUpdateManyWithWhereWithoutLinkInputSchema: z.ZodType<Prisma.LinkWebhookUpdateManyWithWhereWithoutLinkInput> = z
    .object({
        where: z.lazy(() => LinkWebhookScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => LinkWebhookUpdateManyMutationInputSchema),
            z.lazy(() => LinkWebhookUncheckedUpdateManyWithoutLinkInputSchema)
        ])
    })
    .strict()
