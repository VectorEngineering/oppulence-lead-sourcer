...
export const ProgramEnrollmentUncheckedUpdateManyWithoutDiscountNestedInputSchema: z.ZodType<Prisma.ProgramEnrollmentUncheckedUpdateManyWithoutDiscountNestedInput> =
    z
        .object({
            create: z
                .union([
