...
export const NestedEnumDealPriorityWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumDealPriorityWithAggregatesFilter> = z.object({
  equals: z.lazy(() => DealPrioritySchema).optional(),
  in: z.lazy(() => DealPrioritySchema).array().optional(),
  notIn: z.lazy(() => DealPrioritySchema).array().optional(),
