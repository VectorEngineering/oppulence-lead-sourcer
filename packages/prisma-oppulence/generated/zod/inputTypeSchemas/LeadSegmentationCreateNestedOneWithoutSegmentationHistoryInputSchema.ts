...
export const LeadSegmentationCreateNestedOneWithoutSegmentationHistoryInputSchema: z.ZodType<Prisma.LeadSegmentationCreateNestedOneWithoutSegmentationHistoryInput> =
    z
        .object({
            create: z
                .union([
