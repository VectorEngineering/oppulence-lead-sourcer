...
export const PipelineStageScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.PipelineStageScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => PipelineStageScalarWhereWithAggregatesInputSchema),z.lazy(() => PipelineStageScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => PipelineStageScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => PipelineStageScalarWhereWithAggregatesInputSchema),z.lazy(() => PipelineStageScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  autoMoveAfterDays: z.union([ z.lazy(() => IntNullableWithAggregatesFilterSchema),z.number() ]).optional().nullable(),
  nextStageId: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
