...
export const ProjectUpdateOneRequiredWithoutRegisteredDomainsNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutRegisteredDomainsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutRegisteredDomainsInputSchema),z.lazy(() => ProjectUpdateWithoutRegisteredDomainsInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutRegisteredDomainsInputSchema) ]).optional(),
}).strict();
