...
export const InboxShareCountOrderByAggregateInputSchema: z.ZodType<Prisma.InboxShareCountOrderByAggregateInput> = z.object({
  ...
  accessSchedule: z.lazy(() => SortOrderSchema).optional(),
...
export default InboxShareCountOrderByAggregateInputSchema;
