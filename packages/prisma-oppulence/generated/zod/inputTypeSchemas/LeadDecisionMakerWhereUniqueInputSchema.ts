...
export const LeadDecisionMakerWhereUniqueInputSchema: z.ZodType<Prisma.LeadDecisionMakerWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => LeadDecisionMakerWhereInputSchema), z.lazy(() => LeadDecisionMakerWhereInputSchema).array()])
                    .optional(),
                OR: z
                    .lazy(() => LeadDecisionMakerWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([z.lazy(() => LeadDecisionMakerWhereInputSchema), z.lazy(() => LeadDecisionMakerWhereInputSchema).array()])
