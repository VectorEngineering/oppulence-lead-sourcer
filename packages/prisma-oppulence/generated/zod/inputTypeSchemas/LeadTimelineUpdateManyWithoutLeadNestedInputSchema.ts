...
export const LeadTimelineUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadTimelineUpdateManyWithoutLeadNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LeadTimelineUpsertWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadTimelineUpsertWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LeadTimelineCreateManyLeadInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => LeadTimelineWhereUniqueInputSchema),z.lazy(() => LeadTimelineWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => LeadTimelineWhereUniqueInputSchema),z.lazy(() => LeadTimelineWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => LeadTimelineWhereUniqueInputSchema),z.lazy(() => LeadTimelineWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => LeadTimelineWhereUniqueInputSchema),z.lazy(() => LeadTimelineWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => LeadTimelineUpdateWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadTimelineUpdateWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadTimelineUpdateManyWithWhereWithoutLeadInputSchema),z.lazy(() => LeadTimelineUpdateManyWithWhereWithoutLeadInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadTimelineScalarWhereInputSchema),z.lazy(() => LeadTimelineScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadTimelineUpdateManyWithoutLeadNestedInputSchema;
