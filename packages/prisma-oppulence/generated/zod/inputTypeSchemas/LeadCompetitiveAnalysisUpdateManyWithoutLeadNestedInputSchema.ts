...
export const LeadCompetitiveAnalysisUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisUpdateManyWithoutLeadNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => LeadCompetitiveAnalysisUpsertWithWhereUniqueWithoutLeadInputSchema),
                    z.lazy(() => LeadCompetitiveAnalysisUpsertWithWhereUniqueWithoutLeadInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => LeadCompetitiveAnalysisUpdateWithWhereUniqueWithoutLeadInputSchema),
                    z.lazy(() => LeadCompetitiveAnalysisUpdateWithWhereUniqueWithoutLeadInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => LeadCompetitiveAnalysisUpdateManyWithWhereWithoutLeadInputSchema),
                    z.lazy(() => LeadCompetitiveAnalysisUpdateManyWithWhereWithoutLeadInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
                    z.lazy(() => LeadCompetitiveAnalysisScalarWhereInputSchema),
                    z.lazy(() => LeadCompetitiveAnalysisScalarWhereInputSchema).array()
                ])
                .optional()
        })
        .strict()

export default LeadCompetitiveAnalysisUpdateManyWithoutLeadNestedInputSchema
