...
import { z } from 'zod';
import { LeadCreateNestedOneWithoutPersonalDetailsInputSchema } from './LeadCreateNestedOneWithoutPersonalDetailsInputSchema';

export const LeadPersonalDetailsCreateInputSchema: z.ZodType<Prisma.LeadPersonalDetailsCreateInput> = z.object({
  ...
  lead: z.lazy(() => LeadCreateNestedOneWithoutPersonalDetailsInputSchema)
}).strict();

export default LeadPersonalDetailsCreateInputSchema;
