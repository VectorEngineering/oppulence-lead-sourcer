...
export const LeadUpsertWithWhereUniqueWithoutAssignedToInputSchema: z.ZodType<Prisma.LeadUpsertWithWhereUniqueWithoutAssignedToInput> = z
    .object({
        where: z.lazy(() => LeadWhereUniqueInputSchema),
        update: z.union([
            z.lazy(() => LeadUpdateWithoutAssignedToInputSchema),
            z.lazy(() => LeadUncheckedUpdateWithoutAssignedToInputSchema)
        ]),
        create: z.union([
