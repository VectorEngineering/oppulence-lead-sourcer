...
export const ProjectUpdateOneRequiredWithoutCustomerTagNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutCustomerTagNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => ProjectCreateWithoutCustomerTagInputSchema),
                    z.lazy(() => ProjectUncheckedCreateWithoutCustomerTagInputSchema)
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutCustomerTagInputSchema),
                    z.lazy(() => ProjectUpdateWithoutCustomerTagInputSchema),
                    z.lazy(() => ProjectUncheckedUpdateWithoutCustomerTagInputSchema)
                ])
                .optional()
        })
        .strict()
