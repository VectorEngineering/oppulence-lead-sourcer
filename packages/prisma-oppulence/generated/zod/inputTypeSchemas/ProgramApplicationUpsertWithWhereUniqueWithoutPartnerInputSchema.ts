...
export const ProgramApplicationUpsertWithWhereUniqueWithoutPartnerInputSchema: z.ZodType<Prisma.ProgramApplicationUpsertWithWhereUniqueWithoutPartnerInput> = z.object({
  where: z.lazy(() => ProgramApplicationWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ProgramApplicationUpdateWithoutPartnerInputSchema),z.lazy(() => ProgramApplicationUncheckedUpdateWithoutPartnerInputSchema) ]),
  create: z.union([ z.lazy(() => ProgramApplicationCreateWithoutPartnerInputSchema),z.lazy(() => ProgramApplicationUncheckedCreateWithoutPartnerInputSchema) ]),
}).strict();
