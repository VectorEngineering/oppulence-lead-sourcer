...
export const LeadComplianceHistoryScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadComplianceHistoryScalarWhereWithAggregatesInput> =
    z
        .object({
            AND: z
                .union([
                    z.lazy(() => LeadComplianceHistoryScalarWhereWithAggregatesInputSchema),
                    z.lazy(() => LeadComplianceHistoryScalarWhereWithAggregatesInputSchema).array()
                ])
                .optional(),
            OR: z
                .lazy(() => LeadComplianceHistoryScalarWhereWithAggregatesInputSchema)
                .array()
                .optional(),
            NOT: z
                .union([
