...
export const DocumentUpdateManyWithoutDealNestedInputSchema: z.ZodType<Prisma.DocumentUpdateManyWithoutDealNestedInput> = z.object({
  create: z.union([ z.lazy(() => DocumentCreateWithoutDealInputSchema),z.lazy(() => DocumentCreateWithoutDealInputSchema).array(),z.lazy(() => DocumentUncheckedCreateWithoutDealInputSchema),z.lazy(() => DocumentUncheckedCreateWithoutDealInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => DocumentCreateOrConnectWithoutDealInputSchema),z.lazy(() => DocumentCreateOrConnectWithoutDealInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => DocumentUpsertWithWhereUniqueWithoutDealInputSchema),z.lazy(() => DocumentUpsertWithWhereUniqueWithoutDealInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => DocumentUpdateWithWhereUniqueWithoutDealInputSchema),z.lazy(() => DocumentUpdateWithWhereUniqueWithoutDealInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => DocumentUpdateManyWithWhereWithoutDealInputSchema),z.lazy(() => DocumentUpdateManyWithWhereWithoutDealInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => DocumentScalarWhereInputSchema),z.lazy(() => DocumentScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default DocumentUpdateManyWithoutDealNestedInputSchema;
