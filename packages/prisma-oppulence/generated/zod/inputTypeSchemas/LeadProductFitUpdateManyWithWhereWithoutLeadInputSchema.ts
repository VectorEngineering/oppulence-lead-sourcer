...
export const LeadProductFitUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadProductFitUpdateManyWithWhereWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadProductFitScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LeadProductFitUpdateManyMutationInputSchema),z.lazy(() => LeadProductFitUncheckedUpdateManyWithoutLeadInputSchema) ]),
}).strict();
