...
export const LeadUpsertWithoutDecisionMakersInputSchema: z.ZodType<Prisma.LeadUpsertWithoutDecisionMakersInput> = z.object({
  update: z.union([ z.lazy(() => LeadUpdateWithoutDecisionMakersInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutDecisionMakersInputSchema) ]),
