...
export const PipelineAutomationUpdateManyWithWhereWithoutPipelineInputSchema: z.ZodType<Prisma.PipelineAutomationUpdateManyWithWhereWithoutPipelineInput> = z.object({
  where: z.lazy(() => PipelineAutomationScalarWhereInputSchema),
  data: z.union([ z.lazy(() => PipelineAutomationUpdateManyMutationInputSchema),z.lazy(() => PipelineAutomationUncheckedUpdateManyWithoutPipelineInputSchema) ]),
}).strict();
