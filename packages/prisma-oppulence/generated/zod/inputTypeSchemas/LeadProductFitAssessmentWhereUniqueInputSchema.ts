...
export const LeadProductFitAssessmentWhereUniqueInputSchema: z.ZodType<Prisma.LeadProductFitAssessmentWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([
                        z.lazy(() => LeadProductFitAssessmentWhereInputSchema),
                        z.lazy(() => LeadProductFitAssessmentWhereInputSchema).array()
                    ])
                    .optional(),
                OR: z
                    .lazy(() => LeadProductFitAssessmentWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([
                ...
                productFit: z
                    .union([z.lazy(() => LeadProductFitRelationFilterSchema), z.lazy(() => LeadProductFitWhereInputSchema)])
                    .optional()
            })
            .strict()
    )
