...
export const YearInReviewUpdateManyWithWhereWithoutWorkspaceInputSchema: z.ZodType<Prisma.YearInReviewUpdateManyWithWhereWithoutWorkspaceInput> = z.object({
  where: z.lazy(() => YearInReviewScalarWhereInputSchema),
  data: z.union([ z.lazy(() => YearInReviewUpdateManyMutationInputSchema),z.lazy(() => YearInReviewUncheckedUpdateManyWithoutWorkspaceInputSchema) ]),
}).strict();
