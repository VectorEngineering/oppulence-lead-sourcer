...
export const PipelineAccessRuleUpdateManyWithWhereWithoutPipelineInputSchema: z.ZodType<Prisma.PipelineAccessRuleUpdateManyWithWhereWithoutPipelineInput> =
    z
        .object({
            where: z.lazy(() => PipelineAccessRuleScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => PipelineAccessRuleUpdateManyMutationInputSchema),
                z.lazy(() => PipelineAccessRuleUncheckedUpdateManyWithoutPipelineInputSchema)
            ])
        })
        .strict()
