...
export const ProgramInviteUncheckedCreateNestedManyWithoutProgramInputSchema: z.ZodType<Prisma.ProgramInviteUncheckedCreateNestedManyWithoutProgramInput> =
    z
        .object({
            create: z
                .union([
