...
export const ContractUpdateOneRequiredWithoutContractApprovalsNestedInputSchema: z.ZodType<Prisma.ContractUpdateOneRequiredWithoutContractApprovalsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ContractUpdateToOneWithWhereWithoutContractApprovalsInputSchema),
