...
export const LeadProductFitAssessmentWhereInputSchema: z.ZodType<Prisma.LeadProductFitAssessmentWhereInput> = z
    .object({
        AND: z
            .union([z.lazy(() => LeadProductFitAssessmentWhereInputSchema), z.lazy(() => LeadProductFitAssessmentWhereInputSchema).array()])
            .optional(),
        OR: z
