...
export const AutomationTriggerUpdateWithWhereUniqueWithoutAutomationInputSchema: z.ZodType<Prisma.AutomationTriggerUpdateWithWhereUniqueWithoutAutomationInput> = z.object({
  where: z.lazy(() => AutomationTriggerWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => AutomationTriggerUpdateWithoutAutomationInputSchema),z.lazy(() => AutomationTriggerUncheckedUpdateWithoutAutomationInputSchema) ]),
}).strict();
