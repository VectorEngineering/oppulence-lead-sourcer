...
export const DealActivityUpdateManyWithWhereWithoutDealInputSchema: z.ZodType<Prisma.DealActivityUpdateManyWithWhereWithoutDealInput> = z
    .object({
        where: z.lazy(() => DealActivityScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => DealActivityUpdateManyMutationInputSchema),
            z.lazy(() => DealActivityUncheckedUpdateManyWithoutDealInputSchema)
        ])
    })
    .strict()
