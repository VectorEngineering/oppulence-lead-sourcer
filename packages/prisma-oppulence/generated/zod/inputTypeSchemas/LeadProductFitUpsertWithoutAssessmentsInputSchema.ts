...
export const LeadProductFitUpsertWithoutAssessmentsInputSchema: z.ZodType<Prisma.LeadProductFitUpsertWithoutAssessmentsInput> = z.object({
  update: z.union([ z.lazy(() => LeadProductFitUpdateWithoutAssessmentsInputSchema),z.lazy(() => LeadProductFitUncheckedUpdateWithoutAssessmentsInputSchema) ]),
  create: z.union([ z.lazy(() => LeadProductFitCreateWithoutAssessmentsInputSchema),z.lazy(() => LeadProductFitUncheckedCreateWithoutAssessmentsInputSchema) ]),
