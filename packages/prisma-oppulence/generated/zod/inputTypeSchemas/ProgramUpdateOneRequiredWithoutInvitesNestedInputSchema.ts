...
export const ProgramUpdateOneRequiredWithoutInvitesNestedInputSchema: z.ZodType<Prisma.ProgramUpdateOneRequiredWithoutInvitesNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => ProgramCreateWithoutInvitesInputSchema),
                    z.lazy(() => ProgramUncheckedCreateWithoutInvitesInputSchema)
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => ProgramUpdateToOneWithWhereWithoutInvitesInputSchema),
                    z.lazy(() => ProgramUpdateWithoutInvitesInputSchema),
                    z.lazy(() => ProgramUncheckedUpdateWithoutInvitesInputSchema)
                ])
                .optional()
        })
        .strict()
