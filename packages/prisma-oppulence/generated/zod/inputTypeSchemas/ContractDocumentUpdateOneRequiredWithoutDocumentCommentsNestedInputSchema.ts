...
export const ContractDocumentUpdateOneRequiredWithoutDocumentCommentsNestedInputSchema: z.ZodType<Prisma.ContractDocumentUpdateOneRequiredWithoutDocumentCommentsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ContractDocumentUpdateToOneWithWhereWithoutDocumentCommentsInputSchema),
