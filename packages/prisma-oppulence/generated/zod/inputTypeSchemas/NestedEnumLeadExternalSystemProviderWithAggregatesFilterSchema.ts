...
export const NestedEnumLeadExternalSystemProviderWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumLeadExternalSystemProviderWithAggregatesFilter> = z.object({
  equals: z.lazy(() => LeadExternalSystemProviderSchema).optional(),
  in: z.lazy(() => LeadExternalSystemProviderSchema).array().optional(),
  notIn: z.lazy(() => LeadExternalSystemProviderSchema).array().optional(),
  not: z.union([ z.lazy(() => LeadExternalSystemProviderSchema),z.lazy(() => NestedEnumLeadExternalSystemProviderWithAggregatesFilterSchema) ]).optional(),
