...
export const LeadExternalSystemUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadExternalSystemUncheckedUpdateManyWithoutLeadNestedInput> =
    z
        .object({
            create: z
                .union([
