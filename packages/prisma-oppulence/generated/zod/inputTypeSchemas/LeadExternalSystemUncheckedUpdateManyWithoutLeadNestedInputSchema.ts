...
export const LeadExternalSystemUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadExternalSystemUncheckedUpdateManyWithoutLeadNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LeadExternalSystemUpsertWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadExternalSystemUpsertWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LeadExternalSystemCreateManyLeadInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => LeadExternalSystemWhereUniqueInputSchema),z.lazy(() => LeadExternalSystemWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => LeadExternalSystemWhereUniqueInputSchema),z.lazy(() => LeadExternalSystemWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => LeadExternalSystemWhereUniqueInputSchema),z.lazy(() => LeadExternalSystemWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadExternalSystemUpdateWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadExternalSystemUpdateWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadExternalSystemUpdateManyWithWhereWithoutLeadInputSchema),z.lazy(() => LeadExternalSystemUpdateManyWithWhereWithoutLeadInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadExternalSystemScalarWhereInputSchema),z.lazy(() => LeadExternalSystemScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadExternalSystemUncheckedUpdateManyWithoutLeadNestedInputSchema;
