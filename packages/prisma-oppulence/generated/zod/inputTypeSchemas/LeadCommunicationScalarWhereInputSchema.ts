...
export const LeadCommunicationScalarWhereInputSchema: z.ZodType<Prisma.LeadCommunicationScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => LeadCommunicationScalarWhereInputSchema),z.lazy(() => LeadCommunicationScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadCommunicationScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LeadCommunicationScalarWhereInputSchema),z.lazy(() => LeadCommunicationScalarWhereInputSchema).array() ]).optional(),
