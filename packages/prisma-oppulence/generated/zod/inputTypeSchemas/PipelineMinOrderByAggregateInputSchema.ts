...
export const PipelineMinOrderByAggregateInputSchema: z.ZodType<Prisma.PipelineMinOrderByAggregateInput> = z
    .object({
...
export default PipelineMinOrderByAggregateInputSchema
