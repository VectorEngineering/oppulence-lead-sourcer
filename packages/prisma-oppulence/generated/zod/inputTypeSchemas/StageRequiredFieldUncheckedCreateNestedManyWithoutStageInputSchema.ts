...
export const StageRequiredFieldUncheckedCreateNestedManyWithoutStageInputSchema: z.ZodType<Prisma.StageRequiredFieldUncheckedCreateNestedManyWithoutStageInput> =
    z
        .object({
            create: z
                .union([
