...
export const AutomationActionUpsertWithWhereUniqueWithoutAutomationInputSchema: z.ZodType<Prisma.AutomationActionUpsertWithWhereUniqueWithoutAutomationInput> =
    z
        .object({
            where: z.lazy(() => AutomationActionWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => AutomationActionUpdateWithoutAutomationInputSchema),
                z.lazy(() => AutomationActionUncheckedUpdateWithoutAutomationInputSchema)
            ]),
            create: z.union([
