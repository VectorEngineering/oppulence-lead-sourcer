...
export const PipelineKpiScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.PipelineKpiScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => PipelineKpiScalarWhereWithAggregatesInputSchema),z.lazy(() => PipelineKpiScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => PipelineKpiScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => PipelineKpiScalarWhereWithAggregatesInputSchema),z.lazy(() => PipelineKpiScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  current: z.union([ z.lazy(() => FloatNullableWithAggregatesFilterSchema),z.number() ]).optional().nullable(),
  ...
  frequency: z.union([ z.lazy(() => EnumPipelineKpiFrequencyWithAggregatesFilterSchema),z.lazy(() => PipelineKpiFrequencySchema) ]).optional(),
  calculation: z.union([ z.lazy(() => EnumPipelineKpiCalculationWithAggregatesFilterSchema),z.lazy(() => PipelineKpiCalculationSchema) ]).optional(),
