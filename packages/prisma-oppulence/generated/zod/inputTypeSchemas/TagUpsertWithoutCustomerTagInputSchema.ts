...
export const TagUpsertWithoutCustomerTagInputSchema: z.ZodType<Prisma.TagUpsertWithoutCustomerTagInput> = z.object({
  update: z.union([ z.lazy(() => TagUpdateWithoutCustomerTagInputSchema),z.lazy(() => TagUncheckedUpdateWithoutCustomerTagInputSchema) ]),
  create: z.union([ z.lazy(() => TagCreateWithoutCustomerTagInputSchema),z.lazy(() => TagUncheckedCreateWithoutCustomerTagInputSchema) ]),
