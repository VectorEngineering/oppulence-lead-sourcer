...
export const ProgramEnrollmentUncheckedCreateNestedManyWithoutProgramInputSchema: z.ZodType<Prisma.ProgramEnrollmentUncheckedCreateNestedManyWithoutProgramInput> =
    z
        .object({
            create: z
                .union([
