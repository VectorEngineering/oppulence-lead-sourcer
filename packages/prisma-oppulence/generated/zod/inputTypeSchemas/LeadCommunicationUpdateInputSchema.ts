...
import { LeadUpdateOneRequiredWithoutCommunicationsNestedInputSchema } from './LeadUpdateOneRequiredWithoutCommunicationsNestedInputSchema';

export const LeadCommunicationUpdateInputSchema: z.ZodType<Prisma.LeadCommunicationUpdateInput> = z.object({
  ...
  lead: z.lazy(() => LeadUpdateOneRequiredWithoutCommunicationsNestedInputSchema).optional()
}).strict();

export default LeadCommunicationUpdateInputSchema;
