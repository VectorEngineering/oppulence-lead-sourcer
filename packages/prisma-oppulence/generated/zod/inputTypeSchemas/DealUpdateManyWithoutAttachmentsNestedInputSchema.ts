...
export const DealUpdateManyWithoutAttachmentsNestedInputSchema: z.ZodType<Prisma.DealUpdateManyWithoutAttachmentsNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => DealUpsertWithWhereUniqueWithoutAttachmentsInputSchema),
                z.lazy(() => DealUpsertWithWhereUniqueWithoutAttachmentsInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => DealUpdateWithWhereUniqueWithoutAttachmentsInputSchema),
                z.lazy(() => DealUpdateWithWhereUniqueWithoutAttachmentsInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => DealUpdateManyWithWhereWithoutAttachmentsInputSchema),
                z.lazy(() => DealUpdateManyWithWhereWithoutAttachmentsInputSchema).array()
            ])
            .optional(),
...
export default DealUpdateManyWithoutAttachmentsNestedInputSchema
