...
export const ProgramApplicationUncheckedUpdateManyWithoutPartnerNestedInputSchema: z.ZodType<Prisma.ProgramApplicationUncheckedUpdateManyWithoutPartnerNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProgramApplicationCreateWithoutPartnerInputSchema),z.lazy(() => ProgramApplicationCreateWithoutPartnerInputSchema).array(),z.lazy(() => ProgramApplicationUncheckedCreateWithoutPartnerInputSchema),z.lazy(() => ProgramApplicationUncheckedCreateWithoutPartnerInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProgramApplicationCreateOrConnectWithoutPartnerInputSchema),z.lazy(() => ProgramApplicationCreateOrConnectWithoutPartnerInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ProgramApplicationUpsertWithWhereUniqueWithoutPartnerInputSchema),z.lazy(() => ProgramApplicationUpsertWithWhereUniqueWithoutPartnerInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProgramApplicationUpdateWithWhereUniqueWithoutPartnerInputSchema),z.lazy(() => ProgramApplicationUpdateWithWhereUniqueWithoutPartnerInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProgramApplicationUpdateManyWithWhereWithoutPartnerInputSchema),z.lazy(() => ProgramApplicationUpdateManyWithWhereWithoutPartnerInputSchema).array() ]).optional(),
...
export default ProgramApplicationUncheckedUpdateManyWithoutPartnerNestedInputSchema;
