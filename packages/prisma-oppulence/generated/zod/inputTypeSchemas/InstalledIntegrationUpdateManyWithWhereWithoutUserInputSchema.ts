...
export const InstalledIntegrationUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.InstalledIntegrationUpdateManyWithWhereWithoutUserInput> =
    z
        .object({
            where: z.lazy(() => InstalledIntegrationScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => InstalledIntegrationUpdateManyMutationInputSchema),
                z.lazy(() => InstalledIntegrationUncheckedUpdateManyWithoutUserInputSchema)
            ])
        })
        .strict()
