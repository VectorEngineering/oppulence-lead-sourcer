...
export const RestrictedTokenUncheckedUpdateManyWithoutInstalledIntegrationNestedInputSchema: z.ZodType<Prisma.RestrictedTokenUncheckedUpdateManyWithoutInstalledIntegrationNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => RestrictedTokenUpsertWithWhereUniqueWithoutInstalledIntegrationInputSchema),
                    z.lazy(() => RestrictedTokenUpsertWithWhereUniqueWithoutInstalledIntegrationInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => RestrictedTokenUpdateWithWhereUniqueWithoutInstalledIntegrationInputSchema),
                    z.lazy(() => RestrictedTokenUpdateWithWhereUniqueWithoutInstalledIntegrationInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => RestrictedTokenUpdateManyWithWhereWithoutInstalledIntegrationInputSchema),
                    z.lazy(() => RestrictedTokenUpdateManyWithWhereWithoutInstalledIntegrationInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default RestrictedTokenUncheckedUpdateManyWithoutInstalledIntegrationNestedInputSchema
