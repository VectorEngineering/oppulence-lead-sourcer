...
export const LeadDecisionMakerUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadDecisionMakerUpdateManyWithWhereWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadDecisionMakerScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LeadDecisionMakerUpdateManyMutationInputSchema),z.lazy(() => LeadDecisionMakerUncheckedUpdateManyWithoutLeadInputSchema) ]),
}).strict();
