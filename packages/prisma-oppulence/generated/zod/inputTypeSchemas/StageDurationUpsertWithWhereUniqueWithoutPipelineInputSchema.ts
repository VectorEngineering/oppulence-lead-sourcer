...
export const StageDurationUpsertWithWhereUniqueWithoutPipelineInputSchema: z.ZodType<Prisma.StageDurationUpsertWithWhereUniqueWithoutPipelineInput> = z.object({
  where: z.lazy(() => StageDurationWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => StageDurationUpdateWithoutPipelineInputSchema),z.lazy(() => StageDurationUncheckedUpdateWithoutPipelineInputSchema) ]),
  create: z.union([ z.lazy(() => StageDurationCreateWithoutPipelineInputSchema),z.lazy(() => StageDurationUncheckedCreateWithoutPipelineInputSchema) ]),
}).strict();
