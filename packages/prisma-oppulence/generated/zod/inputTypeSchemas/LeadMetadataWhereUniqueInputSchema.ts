...
export const LeadMetadataWhereUniqueInputSchema: z.ZodType<Prisma.LeadMetadataWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
...
.and(z.object({
  ...
  OR: z.lazy(() => LeadMetadataWhereInputSchema).array().optional(),
