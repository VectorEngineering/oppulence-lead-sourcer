...
export const PipelineIntegrationScalarWhereInputSchema: z.ZodType<Prisma.PipelineIntegrationScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => PipelineIntegrationScalarWhereInputSchema),z.lazy(() => PipelineIntegrationScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => PipelineIntegrationScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => PipelineIntegrationScalarWhereInputSchema),z.lazy(() => PipelineIntegrationScalarWhereInputSchema).array() ]).optional(),
