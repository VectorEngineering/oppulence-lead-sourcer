...
export const ProjectUsersUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.ProjectUsersUncheckedUpdateManyWithoutProjectNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => ProjectUsersUpsertWithWhereUniqueWithoutProjectInputSchema),
                    z.lazy(() => ProjectUsersUpsertWithWhereUniqueWithoutProjectInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUsersUpdateWithWhereUniqueWithoutProjectInputSchema),
                    z.lazy(() => ProjectUsersUpdateWithWhereUniqueWithoutProjectInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => ProjectUsersUpdateManyWithWhereWithoutProjectInputSchema),
                    z.lazy(() => ProjectUsersUpdateManyWithWhereWithoutProjectInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default ProjectUsersUncheckedUpdateManyWithoutProjectNestedInputSchema
