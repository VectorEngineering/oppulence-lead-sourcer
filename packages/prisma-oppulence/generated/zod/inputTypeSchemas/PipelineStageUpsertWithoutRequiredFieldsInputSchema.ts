...
export const PipelineStageUpsertWithoutRequiredFieldsInputSchema: z.ZodType<Prisma.PipelineStageUpsertWithoutRequiredFieldsInput> = z.object({
  update: z.union([ z.lazy(() => PipelineStageUpdateWithoutRequiredFieldsInputSchema),z.lazy(() => PipelineStageUncheckedUpdateWithoutRequiredFieldsInputSchema) ]),
