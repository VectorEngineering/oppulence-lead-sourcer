...
export const DealTaskUpdateManyWithWhereWithoutDealInputSchema: z.ZodType<Prisma.DealTaskUpdateManyWithWhereWithoutDealInput> = z
    .object({
        where: z.lazy(() => DealTaskScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => DealTaskUpdateManyMutationInputSchema),
            z.lazy(() => DealTaskUncheckedUpdateManyWithoutDealInputSchema)
        ])
    })
    .strict()
