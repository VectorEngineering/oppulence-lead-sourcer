...
export const LeadScoreUpsertWithoutScoreHistoryInputSchema: z.ZodType<Prisma.LeadScoreUpsertWithoutScoreHistoryInput> = z.object({
  update: z.union([ z.lazy(() => LeadScoreUpdateWithoutScoreHistoryInputSchema),z.lazy(() => LeadScoreUncheckedUpdateWithoutScoreHistoryInputSchema) ]),
