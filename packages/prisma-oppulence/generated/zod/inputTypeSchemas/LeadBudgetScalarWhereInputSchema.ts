...
export const LeadBudgetScalarWhereInputSchema: z.ZodType<Prisma.LeadBudgetScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => LeadBudgetScalarWhereInputSchema),z.lazy(() => LeadBudgetScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadBudgetScalarWhereInputSchema).array().optional(),
