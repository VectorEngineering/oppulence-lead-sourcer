...
export const LeadSegmentationHistoryWhereUniqueInputSchema: z.ZodType<Prisma.LeadSegmentationHistoryWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([
                        z.lazy(() => LeadSegmentationHistoryWhereInputSchema),
                        z.lazy(() => LeadSegmentationHistoryWhereInputSchema).array()
                    ])
                    .optional(),
                OR: z
