...
export const LeadComplianceHistoryUpdateManyWithWhereWithoutComplianceAuditInputSchema: z.ZodType<Prisma.LeadComplianceHistoryUpdateManyWithWhereWithoutComplianceAuditInput> =
    z
        .object({
            where: z.lazy(() => LeadComplianceHistoryScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LeadComplianceHistoryUpdateManyMutationInputSchema),
                z.lazy(() => LeadComplianceHistoryUncheckedUpdateManyWithoutComplianceAuditInputSchema)
            ])
        })
        .strict()
