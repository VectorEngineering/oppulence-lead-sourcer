...
import { LeadUpdateOneRequiredWithoutCompetitorsNestedInputSchema } from './LeadUpdateOneRequiredWithoutCompetitorsNestedInputSchema';

export const LeadCompetitorUpdateInputSchema: z.ZodType<Prisma.LeadCompetitorUpdateInput> = z.object({
  ...
  lead: z.lazy(() => LeadUpdateOneRequiredWithoutCompetitorsNestedInputSchema).optional()
}).strict();

export default LeadCompetitorUpdateInputSchema;
