...
import { LeadUpdateOneRequiredWithoutLeadFeedbackNestedInputSchema } from './LeadUpdateOneRequiredWithoutLeadFeedbackNestedInputSchema';

export const LeadFeedbackUpdateInputSchema: z.ZodType<Prisma.LeadFeedbackUpdateInput> = z.object({
  ...
  followUpAssignee: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  followUpStatus: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  followUpNotes: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  status: z.union([ z.lazy(() => FeedbackStatusSchema),z.lazy(() => EnumFeedbackStatusFieldUpdateOperationsInputSchema) ]).optional(),
  resolution: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  lead: z.lazy(() => LeadUpdateOneRequiredWithoutLeadFeedbackNestedInputSchema).optional()
}).strict();

export default LeadFeedbackUpdateInputSchema;
