...
export const DealUncheckedCreateNestedManyWithoutStageInputSchema: z.ZodType<Prisma.DealUncheckedCreateNestedManyWithoutStageInput> = z
    .object({
        create: z
            .union([
...
export default DealUncheckedCreateNestedManyWithoutStageInputSchema
