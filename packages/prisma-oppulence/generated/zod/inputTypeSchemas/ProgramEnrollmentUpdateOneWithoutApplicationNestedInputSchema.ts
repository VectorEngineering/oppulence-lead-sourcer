...
export const ProgramEnrollmentUpdateOneWithoutApplicationNestedInputSchema: z.ZodType<Prisma.ProgramEnrollmentUpdateOneWithoutApplicationNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProgramEnrollmentUpdateToOneWithWhereWithoutApplicationInputSchema),
...
export default ProgramEnrollmentUpdateOneWithoutApplicationNestedInputSchema
