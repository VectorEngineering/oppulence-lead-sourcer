...
export const ProjectUsersWhereUniqueInputSchema: z.ZodType<Prisma.ProjectUsersWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
        ...
        z
            .object({
                ...
                notificationPreference: z
                    .union([
                        z.lazy(() => NotificationPreferenceNullableRelationFilterSchema),
