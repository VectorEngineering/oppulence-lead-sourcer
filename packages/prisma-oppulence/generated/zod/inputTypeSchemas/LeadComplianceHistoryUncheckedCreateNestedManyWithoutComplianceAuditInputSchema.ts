...
export const LeadComplianceHistoryUncheckedCreateNestedManyWithoutComplianceAuditInputSchema: z.ZodType<Prisma.LeadComplianceHistoryUncheckedCreateNestedManyWithoutComplianceAuditInput> =
    z
        .object({
            create: z
                .union([
