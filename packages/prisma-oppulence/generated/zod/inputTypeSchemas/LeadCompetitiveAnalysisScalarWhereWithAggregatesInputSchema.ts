...
export const LeadCompetitiveAnalysisScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => LeadCompetitiveAnalysisScalarWhereWithAggregatesInputSchema),z.lazy(() => LeadCompetitiveAnalysisScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadCompetitiveAnalysisScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LeadCompetitiveAnalysisScalarWhereWithAggregatesInputSchema),z.lazy(() => LeadCompetitiveAnalysisScalarWhereWithAggregatesInputSchema).array() ]).optional(),
