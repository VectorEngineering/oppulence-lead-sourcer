...
export const PipelineAccessRuleUpsertWithWhereUniqueWithoutPipelineInputSchema: z.ZodType<Prisma.PipelineAccessRuleUpsertWithWhereUniqueWithoutPipelineInput> =
    z
        .object({
            where: z.lazy(() => PipelineAccessRuleWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => PipelineAccessRuleUpdateWithoutPipelineInputSchema),
                z.lazy(() => PipelineAccessRuleUncheckedUpdateWithoutPipelineInputSchema)
            ]),
            create: z.union([
