...
export const LeadRequirementWhereUniqueInputSchema: z.ZodType<Prisma.LeadRequirementWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => LeadRequirementWhereInputSchema), z.lazy(() => LeadRequirementWhereInputSchema).array()])
                    .optional(),
                OR: z
