...
export const ProjectUpdateOneRequiredWithoutLeadNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutLeadNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProjectCreateWithoutLeadInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutLeadInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutLeadInputSchema),z.lazy(() => ProjectUpdateWithoutLeadInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutLeadInputSchema) ]).optional(),
}).strict();
