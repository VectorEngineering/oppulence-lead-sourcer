...
export const PipelineIntegrationUpdateManyWithWhereWithoutPipelineInputSchema: z.ZodType<Prisma.PipelineIntegrationUpdateManyWithWhereWithoutPipelineInput> = z.object({
  where: z.lazy(() => PipelineIntegrationScalarWhereInputSchema),
  data: z.union([ z.lazy(() => PipelineIntegrationUpdateManyMutationInputSchema),z.lazy(() => PipelineIntegrationUncheckedUpdateManyWithoutPipelineInputSchema) ]),
}).strict();
