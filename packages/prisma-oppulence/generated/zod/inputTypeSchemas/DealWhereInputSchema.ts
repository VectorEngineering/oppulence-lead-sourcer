...
export const DealWhereInputSchema: z.ZodType<Prisma.DealWhereInput> = z.object({
  ...
  leadId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  expectedRevenue: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  dealCategory: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  dealFocus: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  synergyPotential: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  synergyDescription: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  complianceCheck: z.union([ z.lazy(() => BoolNullableFilterSchema),z.boolean() ]).optional().nullable(),
  complianceNotes: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  estimatedProfitMargin: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  discountReason: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  closingStrategy: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  marketingChannel: z.union([ z.lazy(() => EnumMarketingChannelNullableFilterSchema),z.lazy(() => MarketingChannelSchema) ]).optional().nullable(),
  leadRating: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  lead: z.union([ z.lazy(() => LeadNullableRelationFilterSchema),z.lazy(() => LeadWhereInputSchema) ]).optional().nullable(),
...
export default DealWhereInputSchema;
