...
export const LeadUpdateOneRequiredWithoutSocialProfilesNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutSocialProfilesNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => LeadCreateWithoutSocialProfilesInputSchema),
                    z.lazy(() => LeadUncheckedCreateWithoutSocialProfilesInputSchema)
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => LeadUpdateToOneWithWhereWithoutSocialProfilesInputSchema),
