...
export const LeadNurturingScalarWhereInputSchema: z.ZodType<Prisma.LeadNurturingScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => LeadNurturingScalarWhereInputSchema),z.lazy(() => LeadNurturingScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadNurturingScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LeadNurturingScalarWhereInputSchema),z.lazy(() => LeadNurturingScalarWhereInputSchema).array() ]).optional(),
  ...
  lastEngagement: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
