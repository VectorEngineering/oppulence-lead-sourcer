...
export const PipelineStageWhereUniqueInputSchema: z.ZodType<Prisma.PipelineStageWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
    ...
    .and(
        z
            .object({
                ...
                OR: z
                    .lazy(() => PipelineStageWhereInputSchema)
                    .array()
                    .optional(),
                ...
                stageDuration: z
                    .union([z.lazy(() => StageDurationNullableRelationFilterSchema), z.lazy(() => StageDurationWhereInputSchema)])
                    .optional()
                    .nullable()
            })
            .strict()
