...
export const ProjectUpdateOneWithoutLinksNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneWithoutLinksNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProjectCreateWithoutLinksInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutLinksInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutLinksInputSchema),z.lazy(() => ProjectUpdateWithoutLinksInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutLinksInputSchema) ]).optional(),
}).strict();
