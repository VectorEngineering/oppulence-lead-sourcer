...
export const CustomerUpdateOneRequiredWithoutSalesNestedInputSchema: z.ZodType<Prisma.CustomerUpdateOneRequiredWithoutSalesNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => CustomerCreateWithoutSalesInputSchema), z.lazy(() => CustomerUncheckedCreateWithoutSalesInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => CustomerUpdateToOneWithWhereWithoutSalesInputSchema),
                z.lazy(() => CustomerUpdateWithoutSalesInputSchema),
                z.lazy(() => CustomerUncheckedUpdateWithoutSalesInputSchema)
            ])
            .optional()
    })
    .strict()
