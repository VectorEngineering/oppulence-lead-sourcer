...
export const PipelineUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.PipelineUpdateManyWithoutProjectNestedInput> = z.object({
  create: z.union([ z.lazy(() => PipelineCreateWithoutProjectInputSchema),z.lazy(() => PipelineCreateWithoutProjectInputSchema).array(),z.lazy(() => PipelineUncheckedCreateWithoutProjectInputSchema),z.lazy(() => PipelineUncheckedCreateWithoutProjectInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => PipelineCreateOrConnectWithoutProjectInputSchema),z.lazy(() => PipelineCreateOrConnectWithoutProjectInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => PipelineUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => PipelineUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => PipelineUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => PipelineUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => PipelineUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => PipelineUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => PipelineScalarWhereInputSchema),z.lazy(() => PipelineScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default PipelineUpdateManyWithoutProjectNestedInputSchema;
