...
export const LeadNurturingUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadNurturingUpdateManyWithWhereWithoutLeadInput> = z
    .object({
        where: z.lazy(() => LeadNurturingScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => LeadNurturingUpdateManyMutationInputSchema),
            z.lazy(() => LeadNurturingUncheckedUpdateManyWithoutLeadInputSchema)
        ])
    })
    .strict()
