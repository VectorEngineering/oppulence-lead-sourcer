...
import { LeadUpdateOneRequiredWithoutLeadScoreNestedInputSchema } from './LeadUpdateOneRequiredWithoutLeadScoreNestedInputSchema';
import { LeadScoreHistoryUpdateManyWithoutLeadScoreNestedInputSchema } from './LeadScoreHistoryUpdateManyWithoutLeadScoreNestedInputSchema';

export const LeadScoreUpdateInputSchema: z.ZodType<Prisma.LeadScoreUpdateInput> = z.object({
  ...
  scoringMethod: z.union([ z.lazy(() => LeadScoringMethodSchema),z.lazy(() => EnumLeadScoringMethodFieldUpdateOperationsInputSchema) ]).optional(),
  lastCalculated: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  nextRecalculation: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  lead: z.lazy(() => LeadUpdateOneRequiredWithoutLeadScoreNestedInputSchema).optional(),
  scoreHistory: z.lazy(() => LeadScoreHistoryUpdateManyWithoutLeadScoreNestedInputSchema).optional()
}).strict();

export default LeadScoreUpdateInputSchema;
