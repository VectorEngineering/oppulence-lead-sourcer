...
export const LeadBudgetUpsertWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadBudgetUpsertWithWhereUniqueWithoutLeadInput> = z
    .object({
        where: z.lazy(() => LeadBudgetWhereUniqueInputSchema),
        update: z.union([
            z.lazy(() => LeadBudgetUpdateWithoutLeadInputSchema),
            z.lazy(() => LeadBudgetUncheckedUpdateWithoutLeadInputSchema)
        ]),
        create: z.union([
