...
export const OAuthCodeUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.OAuthCodeUpdateManyWithoutUserNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => OAuthCodeUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => OAuthCodeUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => OAuthCodeUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => OAuthCodeUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => OAuthCodeUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => OAuthCodeUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => OAuthCodeScalarWhereInputSchema),z.lazy(() => OAuthCodeScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default OAuthCodeUpdateManyWithoutUserNestedInputSchema;
