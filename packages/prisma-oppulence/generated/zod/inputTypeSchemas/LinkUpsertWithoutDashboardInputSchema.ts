...
export const LinkUpsertWithoutDashboardInputSchema: z.ZodType<Prisma.LinkUpsertWithoutDashboardInput> = z
    .object({
        update: z.union([
        ...
        create: z.union([
            z.lazy(() => LinkCreateWithoutDashboardInputSchema),
            z.lazy(() => LinkUncheckedCreateWithoutDashboardInputSchema)
        ]),
