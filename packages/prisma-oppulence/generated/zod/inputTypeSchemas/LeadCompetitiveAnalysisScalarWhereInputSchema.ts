...
export const LeadCompetitiveAnalysisScalarWhereInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisScalarWhereInput> = z
    .object({
        AND: z
            .union([
            ...
            .optional(),
        OR: z
            .lazy(() => LeadCompetitiveAnalysisScalarWhereInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
