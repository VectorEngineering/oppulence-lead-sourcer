...
export const LeadCompetitiveAnalysisScalarWhereInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => LeadCompetitiveAnalysisScalarWhereInputSchema),z.lazy(() => LeadCompetitiveAnalysisScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadCompetitiveAnalysisScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LeadCompetitiveAnalysisScalarWhereInputSchema),z.lazy(() => LeadCompetitiveAnalysisScalarWhereInputSchema).array() ]).optional(),
...
export default LeadCompetitiveAnalysisScalarWhereInputSchema;
