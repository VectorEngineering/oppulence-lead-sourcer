...
export const DocumentUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.DocumentUpdateManyWithWhereWithoutLeadInput> = z.object({
  where: z.lazy(() => DocumentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => DocumentUpdateManyMutationInputSchema),z.lazy(() => DocumentUncheckedUpdateManyWithoutLeadInputSchema) ]),
}).strict();
