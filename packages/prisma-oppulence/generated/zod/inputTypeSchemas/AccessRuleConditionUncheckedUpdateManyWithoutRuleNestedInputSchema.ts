...
export const AccessRuleConditionUncheckedUpdateManyWithoutRuleNestedInputSchema: z.ZodType<Prisma.AccessRuleConditionUncheckedUpdateManyWithoutRuleNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => AccessRuleConditionUpsertWithWhereUniqueWithoutRuleInputSchema),z.lazy(() => AccessRuleConditionUpsertWithWhereUniqueWithoutRuleInputSchema).array() ]).optional(),
  createMany: z.lazy(() => AccessRuleConditionCreateManyRuleInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => AccessRuleConditionWhereUniqueInputSchema),z.lazy(() => AccessRuleConditionWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => AccessRuleConditionWhereUniqueInputSchema),z.lazy(() => AccessRuleConditionWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => AccessRuleConditionWhereUniqueInputSchema),z.lazy(() => AccessRuleConditionWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => AccessRuleConditionUpdateWithWhereUniqueWithoutRuleInputSchema),z.lazy(() => AccessRuleConditionUpdateWithWhereUniqueWithoutRuleInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => AccessRuleConditionUpdateManyWithWhereWithoutRuleInputSchema),z.lazy(() => AccessRuleConditionUpdateManyWithWhereWithoutRuleInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => AccessRuleConditionScalarWhereInputSchema),z.lazy(() => AccessRuleConditionScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default AccessRuleConditionUncheckedUpdateManyWithoutRuleNestedInputSchema;
