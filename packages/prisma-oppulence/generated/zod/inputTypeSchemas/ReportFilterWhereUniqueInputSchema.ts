...
export const ReportFilterWhereUniqueInputSchema: z.ZodType<Prisma.ReportFilterWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                OR: z
                    .lazy(() => ReportFilterWhereInputSchema)
                    .array()
                    .optional(),
...
export default ReportFilterWhereUniqueInputSchema
