...
export const PipelineUpdateToOneWithWhereWithoutStageDurationsInputSchema: z.ZodType<Prisma.PipelineUpdateToOneWithWhereWithoutStageDurationsInput> = z.object({
  where: z.lazy(() => PipelineWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => PipelineUpdateWithoutStageDurationsInputSchema),z.lazy(() => PipelineUncheckedUpdateWithoutStageDurationsInputSchema) ]),
}).strict();
