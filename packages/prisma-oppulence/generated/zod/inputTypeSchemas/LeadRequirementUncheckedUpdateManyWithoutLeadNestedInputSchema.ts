...
export const LeadRequirementUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadRequirementUncheckedUpdateManyWithoutLeadNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => LeadRequirementCreateWithoutLeadInputSchema),
                    z.lazy(() => LeadRequirementCreateWithoutLeadInputSchema).array(),
                    z.lazy(() => LeadRequirementUncheckedCreateWithoutLeadInputSchema),
                    z.lazy(() => LeadRequirementUncheckedCreateWithoutLeadInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => LeadRequirementCreateOrConnectWithoutLeadInputSchema),
                    z.lazy(() => LeadRequirementCreateOrConnectWithoutLeadInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => LeadRequirementUpsertWithWhereUniqueWithoutLeadInputSchema),
                    z.lazy(() => LeadRequirementUpsertWithWhereUniqueWithoutLeadInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => LeadRequirementCreateManyLeadInputEnvelopeSchema).optional(),
            set: z
                .union([z.lazy(() => LeadRequirementWhereUniqueInputSchema), z.lazy(() => LeadRequirementWhereUniqueInputSchema).array()])
                .optional(),
            disconnect: z
                .union([z.lazy(() => LeadRequirementWhereUniqueInputSchema), z.lazy(() => LeadRequirementWhereUniqueInputSchema).array()])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => LeadRequirementUpdateWithWhereUniqueWithoutLeadInputSchema),
                    z.lazy(() => LeadRequirementUpdateWithWhereUniqueWithoutLeadInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => LeadRequirementUpdateManyWithWhereWithoutLeadInputSchema),
                    z.lazy(() => LeadRequirementUpdateManyWithWhereWithoutLeadInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default LeadRequirementUncheckedUpdateManyWithoutLeadNestedInputSchema
