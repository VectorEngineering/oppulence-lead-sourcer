...
export const PartnerUpsertWithoutInvitesInputSchema: z.ZodType<Prisma.PartnerUpsertWithoutInvitesInput> = z.object({
  update: z.union([ z.lazy(() => PartnerUpdateWithoutInvitesInputSchema),z.lazy(() => PartnerUncheckedUpdateWithoutInvitesInputSchema) ]),
  create: z.union([ z.lazy(() => PartnerCreateWithoutInvitesInputSchema),z.lazy(() => PartnerUncheckedCreateWithoutInvitesInputSchema) ]),
