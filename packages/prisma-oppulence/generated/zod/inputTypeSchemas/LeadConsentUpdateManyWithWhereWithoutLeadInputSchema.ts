...
export const LeadConsentUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadConsentUpdateManyWithWhereWithoutLeadInput> = z
    .object({
        where: z.lazy(() => LeadConsentScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => LeadConsentUpdateManyMutationInputSchema),
            z.lazy(() => LeadConsentUncheckedUpdateManyWithoutLeadInputSchema)
        ])
    })
    .strict()
