...
export const LeadCategoryUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.LeadCategoryUpdateManyWithoutProjectNestedInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => LeadCategoryCreateWithoutProjectInputSchema),
                z.lazy(() => LeadCategoryCreateWithoutProjectInputSchema).array(),
                z.lazy(() => LeadCategoryUncheckedCreateWithoutProjectInputSchema),
                z.lazy(() => LeadCategoryUncheckedCreateWithoutProjectInputSchema).array()
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => LeadCategoryCreateOrConnectWithoutProjectInputSchema),
                z.lazy(() => LeadCategoryCreateOrConnectWithoutProjectInputSchema).array()
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => LeadCategoryUpsertWithWhereUniqueWithoutProjectInputSchema),
                z.lazy(() => LeadCategoryUpsertWithWhereUniqueWithoutProjectInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LeadCategoryUpdateWithWhereUniqueWithoutProjectInputSchema),
                z.lazy(() => LeadCategoryUpdateWithWhereUniqueWithoutProjectInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => LeadCategoryUpdateManyWithWhereWithoutProjectInputSchema),
                z.lazy(() => LeadCategoryUpdateManyWithWhereWithoutProjectInputSchema).array()
            ])
            .optional(),
        deleteMany: z
...
export default LeadCategoryUpdateManyWithoutProjectNestedInputSchema
