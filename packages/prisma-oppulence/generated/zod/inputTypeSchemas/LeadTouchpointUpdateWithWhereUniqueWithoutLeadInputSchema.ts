...
export const LeadTouchpointUpdateWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadTouchpointUpdateWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadTouchpointWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadTouchpointUpdateWithoutLeadInputSchema),z.lazy(() => LeadTouchpointUncheckedUpdateWithoutLeadInputSchema) ]),
}).strict();
