...
export const DiscountUpsertWithWhereUniqueWithoutProgramInputSchema: z.ZodType<Prisma.DiscountUpsertWithWhereUniqueWithoutProgramInput> = z.object({
  where: z.lazy(() => DiscountWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => DiscountUpdateWithoutProgramInputSchema),z.lazy(() => DiscountUncheckedUpdateWithoutProgramInputSchema) ]),
