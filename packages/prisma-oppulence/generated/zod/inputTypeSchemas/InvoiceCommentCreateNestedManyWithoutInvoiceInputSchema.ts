...
export const InvoiceCommentCreateNestedManyWithoutInvoiceInputSchema: z.ZodType<Prisma.InvoiceCommentCreateNestedManyWithoutInvoiceInput> =
    z
        .object({
            create: z
                .union([
...
export default InvoiceCommentCreateNestedManyWithoutInvoiceInputSchema
