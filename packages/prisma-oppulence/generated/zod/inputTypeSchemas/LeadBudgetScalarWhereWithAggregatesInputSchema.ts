...
export const LeadBudgetScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadBudgetScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadBudgetScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadBudgetScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadBudgetScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
        ...
        approvalStatus: z
            .union([z.lazy(() => EnumApprovalStatusWithAggregatesFilterSchema), z.lazy(() => ApprovalStatusSchema)])
            .optional(),
        approvedBy: z
