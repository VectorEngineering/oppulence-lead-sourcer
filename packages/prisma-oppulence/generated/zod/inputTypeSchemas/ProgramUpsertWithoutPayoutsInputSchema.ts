...
export const ProgramUpsertWithoutPayoutsInputSchema: z.ZodType<Prisma.ProgramUpsertWithoutPayoutsInput> = z.object({
  update: z.union([ z.lazy(() => ProgramUpdateWithoutPayoutsInputSchema),z.lazy(() => ProgramUncheckedUpdateWithoutPayoutsInputSchema) ]),
  create: z.union([ z.lazy(() => ProgramCreateWithoutPayoutsInputSchema),z.lazy(() => ProgramUncheckedCreateWithoutPayoutsInputSchema) ]),
