...
export const LinkUpdateOneWithoutCustomersNestedInputSchema: z.ZodType<Prisma.LinkUpdateOneWithoutCustomersNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => LinkCreateWithoutCustomersInputSchema), z.lazy(() => LinkUncheckedCreateWithoutCustomersInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LinkUpdateToOneWithWhereWithoutCustomersInputSchema),
