...
export const ReportUpdateToOneWithWhereWithoutSchedulesInputSchema: z.ZodType<Prisma.ReportUpdateToOneWithWhereWithoutSchedulesInput> = z.object({
  where: z.lazy(() => ReportWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ReportUpdateWithoutSchedulesInputSchema),z.lazy(() => ReportUncheckedUpdateWithoutSchedulesInputSchema) ]),
}).strict();
