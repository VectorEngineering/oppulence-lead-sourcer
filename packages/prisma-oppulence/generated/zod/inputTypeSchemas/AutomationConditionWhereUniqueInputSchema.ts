...
export const AutomationConditionWhereUniqueInputSchema: z.ZodType<Prisma.AutomationConditionWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => AutomationConditionWhereInputSchema),z.lazy(() => AutomationConditionWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => AutomationConditionWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => AutomationConditionWhereInputSchema),z.lazy(() => AutomationConditionWhereInputSchema).array() ]).optional(),
