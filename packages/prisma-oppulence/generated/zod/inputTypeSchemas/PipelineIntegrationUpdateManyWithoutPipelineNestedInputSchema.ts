...
export const PipelineIntegrationUpdateManyWithoutPipelineNestedInputSchema: z.ZodType<Prisma.PipelineIntegrationUpdateManyWithoutPipelineNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => PipelineIntegrationCreateWithoutPipelineInputSchema),
                    z.lazy(() => PipelineIntegrationCreateWithoutPipelineInputSchema).array(),
                    z.lazy(() => PipelineIntegrationUncheckedCreateWithoutPipelineInputSchema),
                    z.lazy(() => PipelineIntegrationUncheckedCreateWithoutPipelineInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => PipelineIntegrationCreateOrConnectWithoutPipelineInputSchema),
                    z.lazy(() => PipelineIntegrationCreateOrConnectWithoutPipelineInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => PipelineIntegrationUpsertWithWhereUniqueWithoutPipelineInputSchema),
                    z.lazy(() => PipelineIntegrationUpsertWithWhereUniqueWithoutPipelineInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => PipelineIntegrationCreateManyPipelineInputEnvelopeSchema).optional(),
            set: z
                .union([
                    z.lazy(() => PipelineIntegrationWhereUniqueInputSchema),
                    z.lazy(() => PipelineIntegrationWhereUniqueInputSchema).array()
                ])
                .optional(),
            disconnect: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => PipelineIntegrationUpdateWithWhereUniqueWithoutPipelineInputSchema),
                    z.lazy(() => PipelineIntegrationUpdateWithWhereUniqueWithoutPipelineInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => PipelineIntegrationUpdateManyWithWhereWithoutPipelineInputSchema),
                    z.lazy(() => PipelineIntegrationUpdateManyWithWhereWithoutPipelineInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
...
export default PipelineIntegrationUpdateManyWithoutPipelineNestedInputSchema
