...
export const LeadUpdateToOneWithWhereWithoutRequirementsInputSchema: z.ZodType<Prisma.LeadUpdateToOneWithWhereWithoutRequirementsInput> = z.object({
  where: z.lazy(() => LeadWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => LeadUpdateWithoutRequirementsInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutRequirementsInputSchema) ]),
}).strict();
