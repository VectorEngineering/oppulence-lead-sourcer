...
export const TagUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.TagUpdateManyWithoutLeadNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => TagUpsertWithWhereUniqueWithoutLeadInputSchema),
                z.lazy(() => TagUpsertWithWhereUniqueWithoutLeadInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => TagUpdateWithWhereUniqueWithoutLeadInputSchema),
                z.lazy(() => TagUpdateWithWhereUniqueWithoutLeadInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => TagUpdateManyWithWhereWithoutLeadInputSchema),
                z.lazy(() => TagUpdateManyWithWhereWithoutLeadInputSchema).array()
            ])
            .optional(),
...
export default TagUpdateManyWithoutLeadNestedInputSchema
