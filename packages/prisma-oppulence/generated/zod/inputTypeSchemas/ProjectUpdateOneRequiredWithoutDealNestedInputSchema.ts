...
export const ProjectUpdateOneRequiredWithoutDealNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutDealNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => ProjectCreateWithoutDealInputSchema), z.lazy(() => ProjectUncheckedCreateWithoutDealInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => ProjectUpdateToOneWithWhereWithoutDealInputSchema),
                z.lazy(() => ProjectUpdateWithoutDealInputSchema),
                z.lazy(() => ProjectUncheckedUpdateWithoutDealInputSchema)
            ])
            .optional()
    })
    .strict()
