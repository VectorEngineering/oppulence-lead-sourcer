...
export const LeadConsentWhereInputSchema: z.ZodType<Prisma.LeadConsentWhereInput> = z.object({
  AND: z.union([ z.lazy(() => LeadConsentWhereInputSchema),z.lazy(() => LeadConsentWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadConsentWhereInputSchema).array().optional(),
...
export default LeadConsentWhereInputSchema;
