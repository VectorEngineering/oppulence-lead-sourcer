...
export const LeadHistoryUpsertWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadHistoryUpsertWithWhereUniqueWithoutLeadInput> = z
    .object({
        where: z.lazy(() => LeadHistoryWhereUniqueInputSchema),
        update: z.union([
            z.lazy(() => LeadHistoryUpdateWithoutLeadInputSchema),
            z.lazy(() => LeadHistoryUncheckedUpdateWithoutLeadInputSchema)
        ]),
        create: z.union([
