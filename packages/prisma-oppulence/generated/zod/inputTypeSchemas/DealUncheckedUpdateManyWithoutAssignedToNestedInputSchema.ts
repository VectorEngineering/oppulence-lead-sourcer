...
export const DealUncheckedUpdateManyWithoutAssignedToNestedInputSchema: z.ZodType<Prisma.DealUncheckedUpdateManyWithoutAssignedToNestedInput> = z.object({
  create: z.union([ z.lazy(() => DealCreateWithoutAssignedToInputSchema),z.lazy(() => DealCreateWithoutAssignedToInputSchema).array(),z.lazy(() => DealUncheckedCreateWithoutAssignedToInputSchema),z.lazy(() => DealUncheckedCreateWithoutAssignedToInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => DealCreateOrConnectWithoutAssignedToInputSchema),z.lazy(() => DealCreateOrConnectWithoutAssignedToInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => DealUpsertWithWhereUniqueWithoutAssignedToInputSchema),z.lazy(() => DealUpsertWithWhereUniqueWithoutAssignedToInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => DealUpdateWithWhereUniqueWithoutAssignedToInputSchema),z.lazy(() => DealUpdateWithWhereUniqueWithoutAssignedToInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => DealUpdateManyWithWhereWithoutAssignedToInputSchema),z.lazy(() => DealUpdateManyWithWhereWithoutAssignedToInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => DealScalarWhereInputSchema),z.lazy(() => DealScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default DealUncheckedUpdateManyWithoutAssignedToNestedInputSchema;
