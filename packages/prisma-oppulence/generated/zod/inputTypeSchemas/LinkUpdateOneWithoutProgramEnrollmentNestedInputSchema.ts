...
export const LinkUpdateOneWithoutProgramEnrollmentNestedInputSchema: z.ZodType<Prisma.LinkUpdateOneWithoutProgramEnrollmentNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LinkUpdateToOneWithWhereWithoutProgramEnrollmentInputSchema),z.lazy(() => LinkUpdateWithoutProgramEnrollmentInputSchema),z.lazy(() => LinkUncheckedUpdateWithoutProgramEnrollmentInputSchema) ]).optional(),
}).strict();
