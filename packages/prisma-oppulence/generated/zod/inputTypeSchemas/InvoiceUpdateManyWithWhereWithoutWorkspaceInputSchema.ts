...
export const InvoiceUpdateManyWithWhereWithoutWorkspaceInputSchema: z.ZodType<Prisma.InvoiceUpdateManyWithWhereWithoutWorkspaceInput> = z
    .object({
        where: z.lazy(() => InvoiceScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => InvoiceUpdateManyMutationInputSchema),
            z.lazy(() => InvoiceUncheckedUpdateManyWithoutWorkspaceInputSchema)
        ])
    })
    .strict()
