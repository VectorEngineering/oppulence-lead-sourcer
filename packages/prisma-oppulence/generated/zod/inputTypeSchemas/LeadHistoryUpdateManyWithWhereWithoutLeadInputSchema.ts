...
export const LeadHistoryUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadHistoryUpdateManyWithWhereWithoutLeadInput> = z
    .object({
        where: z.lazy(() => LeadHistoryScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => LeadHistoryUpdateManyMutationInputSchema),
            z.lazy(() => LeadHistoryUncheckedUpdateManyWithoutLeadInputSchema)
        ])
    })
    .strict()
