...
export const ReportRecipientWhereUniqueInputSchema: z.ZodType<Prisma.ReportRecipientWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => ReportRecipientWhereInputSchema), z.lazy(() => ReportRecipientWhereInputSchema).array()])
                    .optional(),
                OR: z
