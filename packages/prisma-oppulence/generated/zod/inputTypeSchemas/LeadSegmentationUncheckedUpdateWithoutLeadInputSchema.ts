...
import { LeadSegmentationHistoryUncheckedUpdateManyWithoutSegmentationNestedInputSchema } from './LeadSegmentationHistoryUncheckedUpdateManyWithoutSegmentationNestedInputSchema';

export const LeadSegmentationUncheckedUpdateWithoutLeadInputSchema: z.ZodType<Prisma.LeadSegmentationUncheckedUpdateWithoutLeadInput> = z.object({
  ...
  customerLifetimeValue: z.union([ z.number(),z.lazy(() => NullableFloatFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  segmentationHistory: z.lazy(() => LeadSegmentationHistoryUncheckedUpdateManyWithoutSegmentationNestedInputSchema).optional()
}).strict();

export default LeadSegmentationUncheckedUpdateWithoutLeadInputSchema;
