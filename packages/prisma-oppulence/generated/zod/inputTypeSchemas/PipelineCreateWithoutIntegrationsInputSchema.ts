...
import { StageDurationCreateNestedManyWithoutPipelineInputSchema } from './StageDurationCreateNestedManyWithoutPipelineInputSchema';
...
export const PipelineCreateWithoutIntegrationsInputSchema: z.ZodType<Prisma.PipelineCreateWithoutIntegrationsInput> = z.object({
  ...
  stageDurations: z.lazy(() => StageDurationCreateNestedManyWithoutPipelineInputSchema).optional(),
  accessRules: z.lazy(() => PipelineAccessRuleCreateNestedManyWithoutPipelineInputSchema).optional()
}).strict();

export default PipelineCreateWithoutIntegrationsInputSchema;
