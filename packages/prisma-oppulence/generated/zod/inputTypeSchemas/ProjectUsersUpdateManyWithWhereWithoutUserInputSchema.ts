...
export const ProjectUsersUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.ProjectUsersUpdateManyWithWhereWithoutUserInput> = z
    .object({
        where: z.lazy(() => ProjectUsersScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => ProjectUsersUpdateManyMutationInputSchema),
            z.lazy(() => ProjectUsersUncheckedUpdateManyWithoutUserInputSchema)
        ])
    })
    .strict()
