...
export const InvoiceTemplateScalarWhereInputSchema: z.ZodType<Prisma.InvoiceTemplateScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => InvoiceTemplateScalarWhereInputSchema),z.lazy(() => InvoiceTemplateScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => InvoiceTemplateScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => InvoiceTemplateScalarWhereInputSchema),z.lazy(() => InvoiceTemplateScalarWhereInputSchema).array() ]).optional(),
...
export default InvoiceTemplateScalarWhereInputSchema;
