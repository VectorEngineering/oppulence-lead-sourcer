...
export const PipelineAutomationUpsertWithoutActionsInputSchema: z.ZodType<Prisma.PipelineAutomationUpsertWithoutActionsInput> = z.object({
  update: z.union([ z.lazy(() => PipelineAutomationUpdateWithoutActionsInputSchema),z.lazy(() => PipelineAutomationUncheckedUpdateWithoutActionsInputSchema) ]),
  create: z.union([ z.lazy(() => PipelineAutomationCreateWithoutActionsInputSchema),z.lazy(() => PipelineAutomationUncheckedCreateWithoutActionsInputSchema) ]),
