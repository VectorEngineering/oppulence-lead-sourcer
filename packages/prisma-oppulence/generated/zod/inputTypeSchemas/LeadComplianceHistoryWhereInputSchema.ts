...
export const LeadComplianceHistoryWhereInputSchema: z.ZodType<Prisma.LeadComplianceHistoryWhereInput> = z
    .object({
        AND: z
            .union([z.lazy(() => LeadComplianceHistoryWhereInputSchema), z.lazy(() => LeadComplianceHistoryWhereInputSchema).array()])
            .optional(),
        OR: z
