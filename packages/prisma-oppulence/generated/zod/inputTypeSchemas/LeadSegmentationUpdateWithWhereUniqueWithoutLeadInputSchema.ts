...
export const LeadSegmentationUpdateWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadSegmentationUpdateWithWhereUniqueWithoutLeadInput> =
    z
        .object({
            where: z.lazy(() => LeadSegmentationWhereUniqueInputSchema),
            data: z.union([
                z.lazy(() => LeadSegmentationUpdateWithoutLeadInputSchema),
                z.lazy(() => LeadSegmentationUncheckedUpdateWithoutLeadInputSchema)
            ])
        })
        .strict()
