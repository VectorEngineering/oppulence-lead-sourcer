...
export const SaleUpdateManyWithoutCustomerNestedInputSchema: z.ZodType<Prisma.SaleUpdateManyWithoutCustomerNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => SaleUpsertWithWhereUniqueWithoutCustomerInputSchema),z.lazy(() => SaleUpsertWithWhereUniqueWithoutCustomerInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => SaleUpdateWithWhereUniqueWithoutCustomerInputSchema),z.lazy(() => SaleUpdateWithWhereUniqueWithoutCustomerInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => SaleUpdateManyWithWhereWithoutCustomerInputSchema),z.lazy(() => SaleUpdateManyWithWhereWithoutCustomerInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => SaleScalarWhereInputSchema),z.lazy(() => SaleScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default SaleUpdateManyWithoutCustomerNestedInputSchema;
