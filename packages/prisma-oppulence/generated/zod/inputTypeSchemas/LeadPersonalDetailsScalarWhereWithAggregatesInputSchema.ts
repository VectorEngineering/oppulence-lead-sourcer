...
export const LeadPersonalDetailsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadPersonalDetailsScalarWhereWithAggregatesInput> =
    z
        .object({
            AND: z
                .union([
                    z.lazy(() => LeadPersonalDetailsScalarWhereWithAggregatesInputSchema),
                    z.lazy(() => LeadPersonalDetailsScalarWhereWithAggregatesInputSchema).array()
                ])
                .optional(),
            OR: z
                .lazy(() => LeadPersonalDetailsScalarWhereWithAggregatesInputSchema)
                .array()
                .optional(),
            NOT: z
                .union([
