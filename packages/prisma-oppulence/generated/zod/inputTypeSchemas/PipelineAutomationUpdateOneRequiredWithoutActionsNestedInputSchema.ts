...
export const PipelineAutomationUpdateOneRequiredWithoutActionsNestedInputSchema: z.ZodType<Prisma.PipelineAutomationUpdateOneRequiredWithoutActionsNestedInput> = z.object({
  create: z.union([ z.lazy(() => PipelineAutomationCreateWithoutActionsInputSchema),z.lazy(() => PipelineAutomationUncheckedCreateWithoutActionsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => PipelineAutomationUpdateToOneWithWhereWithoutActionsInputSchema),z.lazy(() => PipelineAutomationUpdateWithoutActionsInputSchema),z.lazy(() => PipelineAutomationUncheckedUpdateWithoutActionsInputSchema) ]).optional(),
}).strict();
