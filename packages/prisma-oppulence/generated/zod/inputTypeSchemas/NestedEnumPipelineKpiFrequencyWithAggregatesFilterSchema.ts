...
export const NestedEnumPipelineKpiFrequencyWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumPipelineKpiFrequencyWithAggregatesFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => PipelineKpiFrequencySchema),z.lazy(() => NestedEnumPipelineKpiFrequencyWithAggregatesFilterSchema) ]).optional(),
