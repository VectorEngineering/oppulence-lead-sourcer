...
export const LeadSegmentationHistoryUpdateWithWhereUniqueWithoutSegmentationInputSchema: z.ZodType<Prisma.LeadSegmentationHistoryUpdateWithWhereUniqueWithoutSegmentationInput> = z.object({
  where: z.lazy(() => LeadSegmentationHistoryWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadSegmentationHistoryUpdateWithoutSegmentationInputSchema),z.lazy(() => LeadSegmentationHistoryUncheckedUpdateWithoutSegmentationInputSchema) ]),
}).strict();
