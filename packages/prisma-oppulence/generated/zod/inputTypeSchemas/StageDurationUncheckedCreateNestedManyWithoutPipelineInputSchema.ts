...
export const StageDurationUncheckedCreateNestedManyWithoutPipelineInputSchema: z.ZodType<Prisma.StageDurationUncheckedCreateNestedManyWithoutPipelineInput> =
    z
        .object({
            create: z
                .union([
