...
export const LinkUpdateManyWithWhereWithoutProjectDomainInputSchema: z.ZodType<Prisma.LinkUpdateManyWithWhereWithoutProjectDomainInput> = z.object({
  where: z.lazy(() => LinkScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LinkUpdateManyMutationInputSchema),z.lazy(() => LinkUncheckedUpdateManyWithoutProjectDomainInputSchema) ]),
}).strict();
