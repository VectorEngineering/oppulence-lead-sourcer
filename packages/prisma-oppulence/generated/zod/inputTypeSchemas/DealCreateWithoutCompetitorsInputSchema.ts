...
import { DealActivityCreateNestedManyWithoutDealInputSchema } from './DealActivityCreateNestedManyWithoutDealInputSchema';
...
export const DealCreateWithoutCompetitorsInputSchema: z.ZodType<Prisma.DealCreateWithoutCompetitorsInput> = z.object({
  ...
  activities: z.lazy(() => DealActivityCreateNestedManyWithoutDealInputSchema).optional(),
...
export default DealCreateWithoutCompetitorsInputSchema;
