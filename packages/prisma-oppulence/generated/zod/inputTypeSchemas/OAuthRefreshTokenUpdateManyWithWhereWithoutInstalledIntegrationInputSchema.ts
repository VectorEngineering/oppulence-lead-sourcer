...
export const OAuthRefreshTokenUpdateManyWithWhereWithoutInstalledIntegrationInputSchema: z.ZodType<Prisma.OAuthRefreshTokenUpdateManyWithWhereWithoutInstalledIntegrationInput> =
    z
        .object({
            where: z.lazy(() => OAuthRefreshTokenScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => OAuthRefreshTokenUpdateManyMutationInputSchema),
                z.lazy(() => OAuthRefreshTokenUncheckedUpdateManyWithoutInstalledIntegrationInputSchema)
            ])
        })
        .strict()
