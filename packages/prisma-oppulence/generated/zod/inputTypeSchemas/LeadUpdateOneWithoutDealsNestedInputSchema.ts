...
export const LeadUpdateOneWithoutDealsNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneWithoutDealsNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCreateWithoutDealsInputSchema),z.lazy(() => LeadUncheckedCreateWithoutDealsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateToOneWithWhereWithoutDealsInputSchema),z.lazy(() => LeadUpdateWithoutDealsInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutDealsInputSchema) ]).optional(),
}).strict();
