...
export const LeadBudgetUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadBudgetUpdateManyWithWhereWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadBudgetScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LeadBudgetUpdateManyMutationInputSchema),z.lazy(() => LeadBudgetUncheckedUpdateManyWithoutLeadInputSchema) ]),
}).strict();
