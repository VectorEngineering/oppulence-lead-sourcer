...
export const CampaignVariantUncheckedUpdateManyWithoutCampaignNestedInputSchema: z.ZodType<Prisma.CampaignVariantUncheckedUpdateManyWithoutCampaignNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => CampaignVariantUpsertWithWhereUniqueWithoutCampaignInputSchema),
                    z.lazy(() => CampaignVariantUpsertWithWhereUniqueWithoutCampaignInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => CampaignVariantUpdateWithWhereUniqueWithoutCampaignInputSchema),
                    z.lazy(() => CampaignVariantUpdateWithWhereUniqueWithoutCampaignInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => CampaignVariantUpdateManyWithWhereWithoutCampaignInputSchema),
                    z.lazy(() => CampaignVariantUpdateManyWithWhereWithoutCampaignInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([z.lazy(() => CampaignVariantScalarWhereInputSchema), z.lazy(() => CampaignVariantScalarWhereInputSchema).array()])
                .optional()
        })
        .strict()

export default CampaignVariantUncheckedUpdateManyWithoutCampaignNestedInputSchema
