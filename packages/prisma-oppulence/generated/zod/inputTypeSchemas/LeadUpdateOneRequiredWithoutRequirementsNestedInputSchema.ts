...
export const LeadUpdateOneRequiredWithoutRequirementsNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutRequirementsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadUpdateToOneWithWhereWithoutRequirementsInputSchema),
