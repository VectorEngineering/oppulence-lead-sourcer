...
export const LeadSegmentationHistoryScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadSegmentationHistoryScalarWhereWithAggregatesInput> =
    z
        .object({
            AND: z
                .union([
                    z.lazy(() => LeadSegmentationHistoryScalarWhereWithAggregatesInputSchema),
                    z.lazy(() => LeadSegmentationHistoryScalarWhereWithAggregatesInputSchema).array()
                ])
                .optional(),
            OR: z
                .lazy(() => LeadSegmentationHistoryScalarWhereWithAggregatesInputSchema)
                .array()
                .optional(),
            NOT: z
                .union([
