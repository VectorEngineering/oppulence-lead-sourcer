...
export const InboxShareUpdateManyWithWhereWithoutInboxInputSchema: z.ZodType<Prisma.InboxShareUpdateManyWithWhereWithoutInboxInput> = z
    .object({
        where: z.lazy(() => InboxShareScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => InboxShareUpdateManyMutationInputSchema),
            z.lazy(() => InboxShareUncheckedUpdateManyWithoutInboxInputSchema)
        ])
    })
    .strict()
