...
export const PipelineUpdateOneRequiredWithoutStagesNestedInputSchema: z.ZodType<Prisma.PipelineUpdateOneRequiredWithoutStagesNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => PipelineUpdateToOneWithWhereWithoutStagesInputSchema),
                    z.lazy(() => PipelineUpdateWithoutStagesInputSchema),
                    z.lazy(() => PipelineUncheckedUpdateWithoutStagesInputSchema)
                ])
                .optional()
        })
        .strict()
