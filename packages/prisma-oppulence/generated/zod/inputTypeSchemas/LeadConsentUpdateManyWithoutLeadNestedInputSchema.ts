...
export const LeadConsentUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadConsentUpdateManyWithoutLeadNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => LeadConsentUpsertWithWhereUniqueWithoutLeadInputSchema),
                z.lazy(() => LeadConsentUpsertWithWhereUniqueWithoutLeadInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LeadConsentUpdateWithWhereUniqueWithoutLeadInputSchema),
                z.lazy(() => LeadConsentUpdateWithWhereUniqueWithoutLeadInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => LeadConsentUpdateManyWithWhereWithoutLeadInputSchema),
                z.lazy(() => LeadConsentUpdateManyWithWhereWithoutLeadInputSchema).array()
            ])
            .optional(),
        deleteMany: z
            .union([z.lazy(() => LeadConsentScalarWhereInputSchema), z.lazy(() => LeadConsentScalarWhereInputSchema).array()])
            .optional()
    })
    .strict()

export default LeadConsentUpdateManyWithoutLeadNestedInputSchema
