...
export const LeadCategoryUpdateWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.LeadCategoryUpdateWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => LeadCategoryWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadCategoryUpdateWithoutProjectInputSchema),z.lazy(() => LeadCategoryUncheckedUpdateWithoutProjectInputSchema) ]),
}).strict();
