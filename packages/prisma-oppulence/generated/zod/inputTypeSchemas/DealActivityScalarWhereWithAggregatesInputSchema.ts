...
export const DealActivityScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.DealActivityScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => DealActivityScalarWhereWithAggregatesInputSchema),z.lazy(() => DealActivityScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => DealActivityScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => DealActivityScalarWhereWithAggregatesInputSchema),z.lazy(() => DealActivityScalarWhereWithAggregatesInputSchema).array() ]).optional(),
