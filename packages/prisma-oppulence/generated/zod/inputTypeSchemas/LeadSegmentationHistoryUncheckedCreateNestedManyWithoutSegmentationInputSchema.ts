...
export const LeadSegmentationHistoryUncheckedCreateNestedManyWithoutSegmentationInputSchema: z.ZodType<Prisma.LeadSegmentationHistoryUncheckedCreateNestedManyWithoutSegmentationInput> =
    z
        .object({
            create: z
                .union([
