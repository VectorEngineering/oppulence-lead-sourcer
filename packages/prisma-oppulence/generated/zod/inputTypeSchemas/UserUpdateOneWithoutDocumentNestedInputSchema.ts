...
export const UserUpdateOneWithoutDocumentNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDocumentNestedInput> = z
    .object({
        create: z
        ...
        update: z
            .union([
                z.lazy(() => UserUpdateToOneWithWhereWithoutDocumentInputSchema),
                z.lazy(() => UserUpdateWithoutDocumentInputSchema),
                z.lazy(() => UserUncheckedUpdateWithoutDocumentInputSchema)
            ])
            .optional()
    })
    .strict()
