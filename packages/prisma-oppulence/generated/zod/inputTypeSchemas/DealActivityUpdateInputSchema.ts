...
import { DealUpdateOneRequiredWithoutActivitiesNestedInputSchema } from './DealUpdateOneRequiredWithoutActivitiesNestedInputSchema';

export const DealActivityUpdateInputSchema: z.ZodType<Prisma.DealActivityUpdateInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  type: z.union([ z.lazy(() => DealActivityTypeSchema),z.lazy(() => EnumDealActivityTypeFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  deal: z.lazy(() => DealUpdateOneRequiredWithoutActivitiesNestedInputSchema).optional()
}).strict();

export default DealActivityUpdateInputSchema;
