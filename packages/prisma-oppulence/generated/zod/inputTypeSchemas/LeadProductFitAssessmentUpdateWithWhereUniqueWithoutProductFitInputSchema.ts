...
export const LeadProductFitAssessmentUpdateWithWhereUniqueWithoutProductFitInputSchema: z.ZodType<Prisma.LeadProductFitAssessmentUpdateWithWhereUniqueWithoutProductFitInput> =
    z
        .object({
            where: z.lazy(() => LeadProductFitAssessmentWhereUniqueInputSchema),
            data: z.union([
                z.lazy(() => LeadProductFitAssessmentUpdateWithoutProductFitInputSchema),
                z.lazy(() => LeadProductFitAssessmentUncheckedUpdateWithoutProductFitInputSchema)
            ])
        })
        .strict()
