...
.and(z.object({
  ...
  interval: z.union([ z.lazy(() => EnumCommissionIntervalNullableFilterSchema),z.lazy(() => CommissionIntervalSchema) ]).optional().nullable(),
  couponId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  couponTestId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
...
export default DiscountWhereUniqueInputSchema;
