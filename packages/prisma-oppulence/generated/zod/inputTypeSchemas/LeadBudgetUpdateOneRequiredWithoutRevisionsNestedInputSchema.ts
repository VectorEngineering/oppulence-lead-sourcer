...
export const LeadBudgetUpdateOneRequiredWithoutRevisionsNestedInputSchema: z.ZodType<Prisma.LeadBudgetUpdateOneRequiredWithoutRevisionsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadBudgetUpdateToOneWithWhereWithoutRevisionsInputSchema),
