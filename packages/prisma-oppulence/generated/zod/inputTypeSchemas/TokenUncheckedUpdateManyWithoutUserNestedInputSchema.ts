...
export const TokenUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.TokenUncheckedUpdateManyWithoutUserNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                ...
                z.lazy(() => TokenUpsertWithWhereUniqueWithoutUserInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                ...
                z.lazy(() => TokenUpdateWithWhereUniqueWithoutUserInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
...
export default TokenUncheckedUpdateManyWithoutUserNestedInputSchema
