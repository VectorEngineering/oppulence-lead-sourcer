...
export const LeadScoreScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadScoreScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadScoreScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadScoreScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadScoreScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
        ...
        scoringMethod: z
            .union([z.lazy(() => EnumLeadScoringMethodWithAggregatesFilterSchema), z.lazy(() => LeadScoringMethodSchema)])
            .optional(),
