...
export const NestedEnumDealCompetitorThreatLevelNullableFilterSchema: z.ZodType<Prisma.NestedEnumDealCompetitorThreatLevelNullableFilter> =
    z
        .object({
            equals: z
            ...
            not: z
                .union([
                    ...
                    z.lazy(() => NestedEnumDealCompetitorThreatLevelNullableFilterSchema)
                ])
                .optional()
                .nullable()
        })
