...
export const DealUpdateOneRequiredWithoutCompetitorsNestedInputSchema: z.ZodType<Prisma.DealUpdateOneRequiredWithoutCompetitorsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => DealUpdateToOneWithWhereWithoutCompetitorsInputSchema),
