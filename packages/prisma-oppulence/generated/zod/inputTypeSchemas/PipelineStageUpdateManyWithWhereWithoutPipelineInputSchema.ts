...
export const PipelineStageUpdateManyWithWhereWithoutPipelineInputSchema: z.ZodType<Prisma.PipelineStageUpdateManyWithWhereWithoutPipelineInput> =
    z
        .object({
            where: z.lazy(() => PipelineStageScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => PipelineStageUpdateManyMutationInputSchema),
                z.lazy(() => PipelineStageUncheckedUpdateManyWithoutPipelineInputSchema)
            ])
        })
        .strict()
