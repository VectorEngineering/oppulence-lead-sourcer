...
export const ProjectUpdateOneRequiredWithoutTransactionAttachmentNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutTransactionAttachmentNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutTransactionAttachmentInputSchema),
