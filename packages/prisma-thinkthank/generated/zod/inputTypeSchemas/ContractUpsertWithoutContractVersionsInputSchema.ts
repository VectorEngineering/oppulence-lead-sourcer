...
export const ContractUpsertWithoutContractVersionsInputSchema: z.ZodType<Prisma.ContractUpsertWithoutContractVersionsInput> = z.object({
  update: z.union([ z.lazy(() => ContractUpdateWithoutContractVersionsInputSchema),z.lazy(() => ContractUncheckedUpdateWithoutContractVersionsInputSchema) ]),
  create: z.union([ z.lazy(() => ContractCreateWithoutContractVersionsInputSchema),z.lazy(() => ContractUncheckedCreateWithoutContractVersionsInputSchema) ]),
