...
export const TransactionCommentCreateNestedManyWithoutTransactionInputSchema: z.ZodType<Prisma.TransactionCommentCreateNestedManyWithoutTransactionInput> =
    z
        .object({
            create: z
                .union([
