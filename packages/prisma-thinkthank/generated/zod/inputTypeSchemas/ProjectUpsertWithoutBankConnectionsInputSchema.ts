...
export const ProjectUpsertWithoutBankConnectionsInputSchema: z.ZodType<Prisma.ProjectUpsertWithoutBankConnectionsInput> = z.object({
  update: z.union([ z.lazy(() => ProjectUpdateWithoutBankConnectionsInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutBankConnectionsInputSchema) ]),
