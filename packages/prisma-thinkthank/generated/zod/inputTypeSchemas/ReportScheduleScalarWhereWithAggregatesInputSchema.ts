...
export const ReportScheduleScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ReportScheduleScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => ReportScheduleScalarWhereWithAggregatesInputSchema),
                z.lazy(() => ReportScheduleScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => ReportScheduleScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
