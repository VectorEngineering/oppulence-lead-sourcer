...
export const InboxActivityWhereUniqueInputSchema: z.ZodType<Prisma.InboxActivityWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                OR: z
                    .lazy(() => InboxActivityWhereInputSchema)
                    .array()
                    .optional(),
...
export default InboxActivityWhereUniqueInputSchema
