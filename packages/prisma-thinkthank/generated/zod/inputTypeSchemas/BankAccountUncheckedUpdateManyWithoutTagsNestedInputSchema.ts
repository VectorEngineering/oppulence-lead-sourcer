...
export const BankAccountUncheckedUpdateManyWithoutTagsNestedInputSchema: z.ZodType<Prisma.BankAccountUncheckedUpdateManyWithoutTagsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => BankAccountUpsertWithWhereUniqueWithoutTagsInputSchema),
                    z.lazy(() => BankAccountUpsertWithWhereUniqueWithoutTagsInputSchema).array()
                ])
                .optional(),
            set: z
            ...
            update: z
                .union([
                    z.lazy(() => BankAccountUpdateWithWhereUniqueWithoutTagsInputSchema),
                    z.lazy(() => BankAccountUpdateWithWhereUniqueWithoutTagsInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => BankAccountUpdateManyWithWhereWithoutTagsInputSchema),
                    z.lazy(() => BankAccountUpdateManyWithWhereWithoutTagsInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default BankAccountUncheckedUpdateManyWithoutTagsNestedInputSchema
