...
export const TransactionAttachmentUncheckedCreateNestedManyWithoutTransactionInputSchema: z.ZodType<Prisma.TransactionAttachmentUncheckedCreateNestedManyWithoutTransactionInput> =
    z
        .object({
            create: z
                .union([
