...
export const BankConnectionSettingsUpdateOneWithoutBankConnectionNestedInputSchema: z.ZodType<Prisma.BankConnectionSettingsUpdateOneWithoutBankConnectionNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => BankConnectionSettingsUpdateToOneWithWhereWithoutBankConnectionInputSchema),
...
export default BankConnectionSettingsUpdateOneWithoutBankConnectionNestedInputSchema
