...
export const BankConnectionSettingsUncheckedCreateNestedManyWithoutCreatorInputSchema: z.ZodType<Prisma.BankConnectionSettingsUncheckedCreateNestedManyWithoutCreatorInput> =
    z
        .object({
            create: z
                .union([
