...
export const WebhookUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.WebhookUncheckedUpdateManyWithoutProjectNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => WebhookUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => WebhookUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => WebhookUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => WebhookUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => WebhookUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => WebhookUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => WebhookScalarWhereInputSchema),z.lazy(() => WebhookScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default WebhookUncheckedUpdateManyWithoutProjectNestedInputSchema;
