...
export const RestrictedTokenUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.RestrictedTokenUpdateManyWithoutProjectNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => RestrictedTokenCreateWithoutProjectInputSchema),
                    z.lazy(() => RestrictedTokenCreateWithoutProjectInputSchema).array(),
                    z.lazy(() => RestrictedTokenUncheckedCreateWithoutProjectInputSchema),
                    z.lazy(() => RestrictedTokenUncheckedCreateWithoutProjectInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => RestrictedTokenCreateOrConnectWithoutProjectInputSchema),
                    z.lazy(() => RestrictedTokenCreateOrConnectWithoutProjectInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => RestrictedTokenUpsertWithWhereUniqueWithoutProjectInputSchema),
                    z.lazy(() => RestrictedTokenUpsertWithWhereUniqueWithoutProjectInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => RestrictedTokenUpdateWithWhereUniqueWithoutProjectInputSchema),
                    z.lazy(() => RestrictedTokenUpdateWithWhereUniqueWithoutProjectInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => RestrictedTokenUpdateManyWithWhereWithoutProjectInputSchema),
                    z.lazy(() => RestrictedTokenUpdateManyWithWhereWithoutProjectInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default RestrictedTokenUpdateManyWithoutProjectNestedInputSchema
