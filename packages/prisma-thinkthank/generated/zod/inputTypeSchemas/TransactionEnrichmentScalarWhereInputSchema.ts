...
export const TransactionEnrichmentScalarWhereInputSchema: z.ZodType<Prisma.TransactionEnrichmentScalarWhereInput> = z
    .object({
        AND: z
            .union([
            ...
            .optional(),
        OR: z
            .lazy(() => TransactionEnrichmentScalarWhereInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
