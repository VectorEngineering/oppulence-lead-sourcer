...
export const ProgramUpdateManyWithWhereWithoutWorkspaceInputSchema: z.ZodType<Prisma.ProgramUpdateManyWithWhereWithoutWorkspaceInput> = z
    .object({
        where: z.lazy(() => ProgramScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => ProgramUpdateManyMutationInputSchema),
            z.lazy(() => ProgramUncheckedUpdateManyWithoutWorkspaceInputSchema)
        ])
    })
    .strict()
