...
export const TransactionUpsertWithoutHistoryInputSchema: z.ZodType<Prisma.TransactionUpsertWithoutHistoryInput> = z.object({
  update: z.union([ z.lazy(() => TransactionUpdateWithoutHistoryInputSchema),z.lazy(() => TransactionUncheckedUpdateWithoutHistoryInputSchema) ]),
