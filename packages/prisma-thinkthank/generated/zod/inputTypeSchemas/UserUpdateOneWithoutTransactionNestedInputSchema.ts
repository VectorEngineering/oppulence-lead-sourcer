...
export const UserUpdateOneWithoutTransactionNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutTransactionNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => UserCreateWithoutTransactionInputSchema), z.lazy(() => UserUncheckedCreateWithoutTransactionInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => UserUpdateToOneWithWhereWithoutTransactionInputSchema),
