...
export const ProjectUpsertWithoutTransactionCategoryInputSchema: z.ZodType<Prisma.ProjectUpsertWithoutTransactionCategoryInput> = z.object({
  update: z.union([ z.lazy(() => ProjectUpdateWithoutTransactionCategoryInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutTransactionCategoryInputSchema) ]),
  create: z.union([ z.lazy(() => ProjectCreateWithoutTransactionCategoryInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutTransactionCategoryInputSchema) ]),
