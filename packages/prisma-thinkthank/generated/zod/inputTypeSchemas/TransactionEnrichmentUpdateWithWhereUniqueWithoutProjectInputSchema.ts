...
export const TransactionEnrichmentUpdateWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.TransactionEnrichmentUpdateWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => TransactionEnrichmentWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => TransactionEnrichmentUpdateWithoutProjectInputSchema),z.lazy(() => TransactionEnrichmentUncheckedUpdateWithoutProjectInputSchema) ]),
}).strict();
