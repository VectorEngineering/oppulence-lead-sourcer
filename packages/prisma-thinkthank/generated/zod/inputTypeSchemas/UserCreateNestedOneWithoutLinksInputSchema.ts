...
export const UserCreateNestedOneWithoutLinksInputSchema: z.ZodType<Prisma.UserCreateNestedOneWithoutLinksInput> = z
    .object({
        create: z
            .union([z.lazy(() => UserCreateWithoutLinksInputSchema), z.lazy(() => UserUncheckedCreateWithoutLinksInputSchema)])
            .optional(),
