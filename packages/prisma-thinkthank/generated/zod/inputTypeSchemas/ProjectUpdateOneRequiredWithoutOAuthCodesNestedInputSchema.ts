...
export const ProjectUpdateOneRequiredWithoutOAuthCodesNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutOAuthCodesNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutOAuthCodesInputSchema),
