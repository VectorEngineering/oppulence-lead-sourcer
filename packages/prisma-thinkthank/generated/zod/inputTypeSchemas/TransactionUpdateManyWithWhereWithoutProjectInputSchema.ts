...
export const TransactionUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.TransactionUpdateManyWithWhereWithoutProjectInput> = z.object({
  where: z.lazy(() => TransactionScalarWhereInputSchema),
  data: z.union([ z.lazy(() => TransactionUpdateManyMutationInputSchema),z.lazy(() => TransactionUncheckedUpdateManyWithoutProjectInputSchema) ]),
}).strict();
