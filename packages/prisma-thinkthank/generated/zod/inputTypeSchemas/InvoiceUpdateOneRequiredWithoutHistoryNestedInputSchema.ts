...
export const InvoiceUpdateOneRequiredWithoutHistoryNestedInputSchema: z.ZodType<Prisma.InvoiceUpdateOneRequiredWithoutHistoryNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => InvoiceUpdateToOneWithWhereWithoutHistoryInputSchema),z.lazy(() => InvoiceUpdateWithoutHistoryInputSchema),z.lazy(() => InvoiceUncheckedUpdateWithoutHistoryInputSchema) ]).optional(),
}).strict();
