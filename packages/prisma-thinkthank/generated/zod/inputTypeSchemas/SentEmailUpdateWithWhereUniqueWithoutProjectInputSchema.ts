...
export const SentEmailUpdateWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.SentEmailUpdateWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => SentEmailWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => SentEmailUpdateWithoutProjectInputSchema),z.lazy(() => SentEmailUncheckedUpdateWithoutProjectInputSchema) ]),
}).strict();
