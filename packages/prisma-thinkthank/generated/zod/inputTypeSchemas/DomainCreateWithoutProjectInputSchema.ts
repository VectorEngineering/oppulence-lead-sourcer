...
export const DomainCreateWithoutProjectInputSchema: z.ZodType<Prisma.DomainCreateWithoutProjectInput> = z.object({
...
export default DomainCreateWithoutProjectInputSchema;
