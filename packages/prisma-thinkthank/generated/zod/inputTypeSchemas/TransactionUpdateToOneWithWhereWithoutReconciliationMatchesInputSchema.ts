...
export const TransactionUpdateToOneWithWhereWithoutReconciliationMatchesInputSchema: z.ZodType<Prisma.TransactionUpdateToOneWithWhereWithoutReconciliationMatchesInput> = z.object({
  where: z.lazy(() => TransactionWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => TransactionUpdateWithoutReconciliationMatchesInputSchema),z.lazy(() => TransactionUncheckedUpdateWithoutReconciliationMatchesInputSchema) ]),
}).strict();
