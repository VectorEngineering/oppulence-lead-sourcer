...
export const ContractUpdateOneRequiredWithoutContractEventsNestedInputSchema: z.ZodType<Prisma.ContractUpdateOneRequiredWithoutContractEventsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ContractCreateWithoutContractEventsInputSchema),z.lazy(() => ContractUncheckedCreateWithoutContractEventsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ContractUpdateToOneWithWhereWithoutContractEventsInputSchema),z.lazy(() => ContractUpdateWithoutContractEventsInputSchema),z.lazy(() => ContractUncheckedUpdateWithoutContractEventsInputSchema) ]).optional(),
}).strict();
