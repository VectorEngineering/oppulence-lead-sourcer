...
export const WebhookLogScalarWhereInputSchema: z.ZodType<Prisma.WebhookLogScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => WebhookLogScalarWhereInputSchema),z.lazy(() => WebhookLogScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => WebhookLogScalarWhereInputSchema).array().optional(),
