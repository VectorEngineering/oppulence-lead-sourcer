...
export const ReportUpdateOneRequiredWithoutAccessUsersNestedInputSchema: z.ZodType<Prisma.ReportUpdateOneRequiredWithoutAccessUsersNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ReportUpdateToOneWithWhereWithoutAccessUsersInputSchema),
