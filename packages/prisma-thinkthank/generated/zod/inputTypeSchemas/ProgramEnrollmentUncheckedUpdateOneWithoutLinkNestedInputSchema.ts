...
export const ProgramEnrollmentUncheckedUpdateOneWithoutLinkNestedInputSchema: z.ZodType<Prisma.ProgramEnrollmentUncheckedUpdateOneWithoutLinkNestedInput> =
    z
        .object({
            create: z
                .union([
