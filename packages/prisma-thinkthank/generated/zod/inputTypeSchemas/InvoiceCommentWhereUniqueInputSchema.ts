...
export const InvoiceCommentWhereUniqueInputSchema: z.ZodType<Prisma.InvoiceCommentWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => InvoiceCommentWhereInputSchema), z.lazy(() => InvoiceCommentWhereInputSchema).array()])
                    .optional(),
                OR: z
                ...
                visibility: z
                    .union([z.lazy(() => EnumInvoiceCommentVisibilityFilterSchema), z.lazy(() => InvoiceCommentVisibilitySchema)])
                    .optional(),
                title: z
                ...
                parent: z
                    .union([z.lazy(() => InvoiceCommentNullableRelationFilterSchema), z.lazy(() => InvoiceCommentWhereInputSchema)])
                    .optional()
                    .nullable(),
