...
export const TagUpsertWithWhereUniqueWithoutTransactionInputSchema: z.ZodType<Prisma.TagUpsertWithWhereUniqueWithoutTransactionInput> = z
    .object({
        where: z.lazy(() => TagWhereUniqueInputSchema),
        update: z.union([
            z.lazy(() => TagUpdateWithoutTransactionInputSchema),
            z.lazy(() => TagUncheckedUpdateWithoutTransactionInputSchema)
        ]),
        create: z.union([
