...
export const TransactionEnrichmentUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.TransactionEnrichmentUpdateManyWithWhereWithoutProjectInput> =
    z
        .object({
            where: z.lazy(() => TransactionEnrichmentScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => TransactionEnrichmentUpdateManyMutationInputSchema),
                z.lazy(() => TransactionEnrichmentUncheckedUpdateManyWithoutProjectInputSchema)
            ])
        })
        .strict()
