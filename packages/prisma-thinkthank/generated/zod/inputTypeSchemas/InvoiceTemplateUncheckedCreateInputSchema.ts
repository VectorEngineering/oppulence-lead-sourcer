...
import { InvoiceUncheckedCreateNestedManyWithoutTemplateInputSchema } from './InvoiceUncheckedCreateNestedManyWithoutTemplateInputSchema';

export const InvoiceTemplateUncheckedCreateInputSchema: z.ZodType<Prisma.InvoiceTemplateUncheckedCreateInput> = z.object({
  ...
  Invoice: z.lazy(() => InvoiceUncheckedCreateNestedManyWithoutTemplateInputSchema).optional()
}).strict();

export default InvoiceTemplateUncheckedCreateInputSchema;
