...
import { ProjectUpdateOneRequiredWithoutIntegrationsNestedInputSchema } from './ProjectUpdateOneRequiredWithoutIntegrationsNestedInputSchema';
import { OAuthAppUpdateOneWithoutIntegrationNestedInputSchema } from './OAuthAppUpdateOneWithoutIntegrationNestedInputSchema';

export const IntegrationUpdateWithoutInstallationsInputSchema: z.ZodType<Prisma.IntegrationUpdateWithoutInstallationsInput> = z.object({
  ...
  project: z.lazy(() => ProjectUpdateOneRequiredWithoutIntegrationsNestedInputSchema).optional(),
  oAuthApp: z.lazy(() => OAuthAppUpdateOneWithoutIntegrationNestedInputSchema).optional()
}).strict();

export default IntegrationUpdateWithoutInstallationsInputSchema;
