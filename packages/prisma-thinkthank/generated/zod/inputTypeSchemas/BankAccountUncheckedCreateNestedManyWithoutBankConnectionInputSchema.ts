...
export const BankAccountUncheckedCreateNestedManyWithoutBankConnectionInputSchema: z.ZodType<Prisma.BankAccountUncheckedCreateNestedManyWithoutBankConnectionInput> =
    z
        .object({
            create: z
                .union([
