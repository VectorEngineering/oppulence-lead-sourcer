...
export const InvoiceCommentUpdateManyWithWhereWithoutInvoiceInputSchema: z.ZodType<Prisma.InvoiceCommentUpdateManyWithWhereWithoutInvoiceInput> = z.object({
  where: z.lazy(() => InvoiceCommentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => InvoiceCommentUpdateManyMutationInputSchema),z.lazy(() => InvoiceCommentUncheckedUpdateManyWithoutInvoiceInputSchema) ]),
}).strict();
