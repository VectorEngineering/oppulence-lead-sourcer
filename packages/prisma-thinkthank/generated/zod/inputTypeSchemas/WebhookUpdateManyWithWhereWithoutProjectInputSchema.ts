...
export const WebhookUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.WebhookUpdateManyWithWhereWithoutProjectInput> = z.object({
  where: z.lazy(() => WebhookScalarWhereInputSchema),
  data: z.union([ z.lazy(() => WebhookUpdateManyMutationInputSchema),z.lazy(() => WebhookUncheckedUpdateManyWithoutProjectInputSchema) ]),
}).strict();
