...
export const InvoiceUpsertWithoutHistoryInputSchema: z.ZodType<Prisma.InvoiceUpsertWithoutHistoryInput> = z.object({
  update: z.union([ z.lazy(() => InvoiceUpdateWithoutHistoryInputSchema),z.lazy(() => InvoiceUncheckedUpdateWithoutHistoryInputSchema) ]),
