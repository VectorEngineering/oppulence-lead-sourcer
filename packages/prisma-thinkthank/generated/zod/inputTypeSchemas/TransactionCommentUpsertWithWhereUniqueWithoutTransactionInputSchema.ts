...
export const TransactionCommentUpsertWithWhereUniqueWithoutTransactionInputSchema: z.ZodType<Prisma.TransactionCommentUpsertWithWhereUniqueWithoutTransactionInput> =
    z
        .object({
            where: z.lazy(() => TransactionCommentWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => TransactionCommentUpdateWithoutTransactionInputSchema),
                z.lazy(() => TransactionCommentUncheckedUpdateWithoutTransactionInputSchema)
            ]),
            create: z.union([
