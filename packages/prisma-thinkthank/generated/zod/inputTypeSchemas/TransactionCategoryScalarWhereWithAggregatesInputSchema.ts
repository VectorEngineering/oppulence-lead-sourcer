...
export const TransactionCategoryScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.TransactionCategoryScalarWhereWithAggregatesInput> =
    z
        .object({
            AND: z
                .union([
                    z.lazy(() => TransactionCategoryScalarWhereWithAggregatesInputSchema),
                    z.lazy(() => TransactionCategoryScalarWhereWithAggregatesInputSchema).array()
                ])
                .optional(),
            OR: z
                .lazy(() => TransactionCategoryScalarWhereWithAggregatesInputSchema)
                .array()
                .optional(),
            NOT: z
                .union([
