...
export const NotificationPreferenceUncheckedUpdateOneWithoutProjectUserNestedInputSchema: z.ZodType<Prisma.NotificationPreferenceUncheckedUpdateOneWithoutProjectUserNestedInput> =
    z
        .object({
            create: z
                .union([
