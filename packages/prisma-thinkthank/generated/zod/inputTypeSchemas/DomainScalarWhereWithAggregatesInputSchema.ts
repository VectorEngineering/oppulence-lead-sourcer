...
export const DomainScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.DomainScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => DomainScalarWhereWithAggregatesInputSchema),
                z.lazy(() => DomainScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => DomainScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
