...
export const ProgramCreateWithoutInvoicesInputSchema: z.ZodType<Prisma.ProgramCreateWithoutInvoicesInput> = z.object({
...
export default ProgramCreateWithoutInvoicesInputSchema;
