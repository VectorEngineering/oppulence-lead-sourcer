...
export const ReportSortingUpdateManyWithoutReportNestedInputSchema: z.ZodType<Prisma.ReportSortingUpdateManyWithoutReportNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ReportSortingUpsertWithWhereUniqueWithoutReportInputSchema),z.lazy(() => ReportSortingUpsertWithWhereUniqueWithoutReportInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ReportSortingCreateManyReportInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ReportSortingWhereUniqueInputSchema),z.lazy(() => ReportSortingWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ReportSortingWhereUniqueInputSchema),z.lazy(() => ReportSortingWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ReportSortingWhereUniqueInputSchema),z.lazy(() => ReportSortingWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => ReportSortingWhereUniqueInputSchema),z.lazy(() => ReportSortingWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ReportSortingUpdateWithWhereUniqueWithoutReportInputSchema),z.lazy(() => ReportSortingUpdateWithWhereUniqueWithoutReportInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ReportSortingUpdateManyWithWhereWithoutReportInputSchema),z.lazy(() => ReportSortingUpdateManyWithWhereWithoutReportInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ReportSortingScalarWhereInputSchema),z.lazy(() => ReportSortingScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ReportSortingUpdateManyWithoutReportNestedInputSchema;
