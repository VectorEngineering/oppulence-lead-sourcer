...
export const ProgramUpdateManyWithoutPrimaryDomainNestedInputSchema: z.ZodType<Prisma.ProgramUpdateManyWithoutPrimaryDomainNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProgramCreateWithoutPrimaryDomainInputSchema),z.lazy(() => ProgramCreateWithoutPrimaryDomainInputSchema).array(),z.lazy(() => ProgramUncheckedCreateWithoutPrimaryDomainInputSchema),z.lazy(() => ProgramUncheckedCreateWithoutPrimaryDomainInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProgramCreateOrConnectWithoutPrimaryDomainInputSchema),z.lazy(() => ProgramCreateOrConnectWithoutPrimaryDomainInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ProgramUpsertWithWhereUniqueWithoutPrimaryDomainInputSchema),z.lazy(() => ProgramUpsertWithWhereUniqueWithoutPrimaryDomainInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProgramUpdateWithWhereUniqueWithoutPrimaryDomainInputSchema),z.lazy(() => ProgramUpdateWithWhereUniqueWithoutPrimaryDomainInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProgramUpdateManyWithWhereWithoutPrimaryDomainInputSchema),z.lazy(() => ProgramUpdateManyWithWhereWithoutPrimaryDomainInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ProgramScalarWhereInputSchema),z.lazy(() => ProgramScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ProgramUpdateManyWithoutPrimaryDomainNestedInputSchema;
