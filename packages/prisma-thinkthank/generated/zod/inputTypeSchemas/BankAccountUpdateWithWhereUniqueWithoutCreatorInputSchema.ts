...
export const BankAccountUpdateWithWhereUniqueWithoutCreatorInputSchema: z.ZodType<Prisma.BankAccountUpdateWithWhereUniqueWithoutCreatorInput> = z.object({
  where: z.lazy(() => BankAccountWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => BankAccountUpdateWithoutCreatorInputSchema),z.lazy(() => BankAccountUncheckedUpdateWithoutCreatorInputSchema) ]),
}).strict();
