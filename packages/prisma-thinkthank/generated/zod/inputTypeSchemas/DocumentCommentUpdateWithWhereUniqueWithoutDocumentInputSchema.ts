...
export const DocumentCommentUpdateWithWhereUniqueWithoutDocumentInputSchema: z.ZodType<Prisma.DocumentCommentUpdateWithWhereUniqueWithoutDocumentInput> = z.object({
  where: z.lazy(() => DocumentCommentWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => DocumentCommentUpdateWithoutDocumentInputSchema),z.lazy(() => DocumentCommentUncheckedUpdateWithoutDocumentInputSchema) ]),
}).strict();
