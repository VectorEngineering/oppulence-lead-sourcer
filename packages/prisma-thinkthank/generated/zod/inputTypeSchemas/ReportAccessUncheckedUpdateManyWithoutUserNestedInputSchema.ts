...
export const ReportAccessUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.ReportAccessUncheckedUpdateManyWithoutUserNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ReportAccessUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => ReportAccessUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ReportAccessCreateManyUserInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ReportAccessWhereUniqueInputSchema),z.lazy(() => ReportAccessWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ReportAccessWhereUniqueInputSchema),z.lazy(() => ReportAccessWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ReportAccessWhereUniqueInputSchema),z.lazy(() => ReportAccessWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => ReportAccessWhereUniqueInputSchema),z.lazy(() => ReportAccessWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ReportAccessUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => ReportAccessUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ReportAccessUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => ReportAccessUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ReportAccessScalarWhereInputSchema),z.lazy(() => ReportAccessScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ReportAccessUncheckedUpdateManyWithoutUserNestedInputSchema;
