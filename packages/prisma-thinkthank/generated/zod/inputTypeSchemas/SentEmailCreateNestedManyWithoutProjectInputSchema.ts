...
export const SentEmailCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.SentEmailCreateNestedManyWithoutProjectInput> = z
    .object({
        create: z
            .union([
...
export default SentEmailCreateNestedManyWithoutProjectInputSchema
