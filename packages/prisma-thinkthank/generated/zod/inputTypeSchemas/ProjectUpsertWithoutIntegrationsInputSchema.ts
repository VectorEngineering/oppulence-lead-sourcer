...
export const ProjectUpsertWithoutIntegrationsInputSchema: z.ZodType<Prisma.ProjectUpsertWithoutIntegrationsInput> = z.object({
  update: z.union([ z.lazy(() => ProjectUpdateWithoutIntegrationsInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutIntegrationsInputSchema) ]),
  create: z.union([ z.lazy(() => ProjectCreateWithoutIntegrationsInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutIntegrationsInputSchema) ]),
