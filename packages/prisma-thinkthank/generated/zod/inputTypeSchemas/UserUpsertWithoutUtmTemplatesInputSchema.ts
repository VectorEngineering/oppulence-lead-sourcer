...
export const UserUpsertWithoutUtmTemplatesInputSchema: z.ZodType<Prisma.UserUpsertWithoutUtmTemplatesInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutUtmTemplatesInputSchema),z.lazy(() => UserUncheckedUpdateWithoutUtmTemplatesInputSchema) ]),
