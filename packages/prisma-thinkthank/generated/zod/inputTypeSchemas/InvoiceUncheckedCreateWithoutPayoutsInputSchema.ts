...
export const InvoiceUncheckedCreateWithoutPayoutsInputSchema: z.ZodType<Prisma.InvoiceUncheckedCreateWithoutPayoutsInput> = z
    .object({
...
export default InvoiceUncheckedCreateWithoutPayoutsInputSchema
