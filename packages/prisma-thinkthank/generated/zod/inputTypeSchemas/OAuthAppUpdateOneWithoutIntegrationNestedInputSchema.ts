...
export const OAuthAppUpdateOneWithoutIntegrationNestedInputSchema: z.ZodType<Prisma.OAuthAppUpdateOneWithoutIntegrationNestedInput> = z.object({
  create: z.union([ z.lazy(() => OAuthAppCreateWithoutIntegrationInputSchema),z.lazy(() => OAuthAppUncheckedCreateWithoutIntegrationInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => OAuthAppUpdateToOneWithWhereWithoutIntegrationInputSchema),z.lazy(() => OAuthAppUpdateWithoutIntegrationInputSchema),z.lazy(() => OAuthAppUncheckedUpdateWithoutIntegrationInputSchema) ]).optional(),
}).strict();

export default OAuthAppUpdateOneWithoutIntegrationNestedInputSchema;
