...
export const BankConnectionSettingsUpdateManyWithoutCreatorNestedInputSchema: z.ZodType<Prisma.BankConnectionSettingsUpdateManyWithoutCreatorNestedInput> =
    z
        .object({
            create: z
                .union([
