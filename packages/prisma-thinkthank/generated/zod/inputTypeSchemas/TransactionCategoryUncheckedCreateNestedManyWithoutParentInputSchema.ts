...
export const TransactionCategoryUncheckedCreateNestedManyWithoutParentInputSchema: z.ZodType<Prisma.TransactionCategoryUncheckedCreateNestedManyWithoutParentInput> =
    z
        .object({
            create: z
                .union([
