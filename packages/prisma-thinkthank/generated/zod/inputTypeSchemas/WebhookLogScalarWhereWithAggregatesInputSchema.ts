...
export const WebhookLogScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.WebhookLogScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => WebhookLogScalarWhereWithAggregatesInputSchema),z.lazy(() => WebhookLogScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => WebhookLogScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => WebhookLogScalarWhereWithAggregatesInputSchema),z.lazy(() => WebhookLogScalarWhereWithAggregatesInputSchema).array() ]).optional(),
