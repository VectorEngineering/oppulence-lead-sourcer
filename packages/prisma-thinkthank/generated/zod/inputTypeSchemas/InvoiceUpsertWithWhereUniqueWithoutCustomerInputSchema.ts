...
export const InvoiceUpsertWithWhereUniqueWithoutCustomerInputSchema: z.ZodType<Prisma.InvoiceUpsertWithWhereUniqueWithoutCustomerInput> = z
    .object({
        where: z.lazy(() => InvoiceWhereUniqueInputSchema),
        update: z.union([
            z.lazy(() => InvoiceUpdateWithoutCustomerInputSchema),
            z.lazy(() => InvoiceUncheckedUpdateWithoutCustomerInputSchema)
        ]),
        create: z.union([
