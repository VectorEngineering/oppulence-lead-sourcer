...
export const RegisteredDomainWhereUniqueInputSchema: z.ZodType<Prisma.RegisteredDomainWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
            domainId: z.string()
    ...
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => RegisteredDomainWhereInputSchema), z.lazy(() => RegisteredDomainWhereInputSchema).array()])
                    .optional(),
                OR: z
