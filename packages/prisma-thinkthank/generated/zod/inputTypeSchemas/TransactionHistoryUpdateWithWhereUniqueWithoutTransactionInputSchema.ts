...
export const TransactionHistoryUpdateWithWhereUniqueWithoutTransactionInputSchema: z.ZodType<Prisma.TransactionHistoryUpdateWithWhereUniqueWithoutTransactionInput> =
    z
        .object({
            where: z.lazy(() => TransactionHistoryWhereUniqueInputSchema),
            data: z.union([
                z.lazy(() => TransactionHistoryUpdateWithoutTransactionInputSchema),
                z.lazy(() => TransactionHistoryUncheckedUpdateWithoutTransactionInputSchema)
            ])
        })
        .strict()
