...
export const PayoutUpdateOneWithoutSalesNestedInputSchema: z.ZodType<Prisma.PayoutUpdateOneWithoutSalesNestedInput> = z.object({
  create: z.union([ z.lazy(() => PayoutCreateWithoutSalesInputSchema),z.lazy(() => PayoutUncheckedCreateWithoutSalesInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => PayoutUpdateToOneWithWhereWithoutSalesInputSchema),z.lazy(() => PayoutUpdateWithoutSalesInputSchema),z.lazy(() => PayoutUncheckedUpdateWithoutSalesInputSchema) ]).optional(),
}).strict();
