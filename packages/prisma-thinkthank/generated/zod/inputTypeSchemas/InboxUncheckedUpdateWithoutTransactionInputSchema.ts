...
import { InboxUncheckedUpdateManyWithoutParentNestedInputSchema } from './InboxUncheckedUpdateManyWithoutParentNestedInputSchema';
import { InboxActivityUncheckedUpdateManyWithoutInboxNestedInputSchema } from './InboxActivityUncheckedUpdateManyWithoutInboxNestedInputSchema';
import { InboxShareUncheckedUpdateManyWithoutInboxNestedInputSchema } from './InboxShareUncheckedUpdateManyWithoutInboxNestedInputSchema';
import { InboxLabelUncheckedUpdateManyWithoutInboxNestedInputSchema } from './InboxLabelUncheckedUpdateManyWithoutInboxNestedInputSchema';

export const InboxUncheckedUpdateWithoutTransactionInputSchema: z.ZodType<Prisma.InboxUncheckedUpdateWithoutTransactionInput> = z.object({
  ...
  folderId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  children: z.lazy(() => InboxUncheckedUpdateManyWithoutParentNestedInputSchema).optional(),
  activities: z.lazy(() => InboxActivityUncheckedUpdateManyWithoutInboxNestedInputSchema).optional(),
  shares: z.lazy(() => InboxShareUncheckedUpdateManyWithoutInboxNestedInputSchema).optional(),
  labels: z.lazy(() => InboxLabelUncheckedUpdateManyWithoutInboxNestedInputSchema).optional()
}).strict();

export default InboxUncheckedUpdateWithoutTransactionInputSchema;
