...
export const ProjectUpdateOneWithoutDashboardsNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneWithoutDashboardsNestedInput> = z
    .object({
        create: z
            .union([
        ...
        update: z
            .union([
                z.lazy(() => ProjectUpdateToOneWithWhereWithoutDashboardsInputSchema),
