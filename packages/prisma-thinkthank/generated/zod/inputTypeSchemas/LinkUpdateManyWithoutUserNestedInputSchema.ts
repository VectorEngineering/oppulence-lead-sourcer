...
export const LinkUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.LinkUpdateManyWithoutUserNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LinkUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => LinkUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LinkUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => LinkUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LinkUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => LinkUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LinkScalarWhereInputSchema),z.lazy(() => LinkScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LinkUpdateManyWithoutUserNestedInputSchema;
