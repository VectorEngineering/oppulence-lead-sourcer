...
export const InvoiceCommentUpsertWithWhereUniqueWithoutInvoiceInputSchema: z.ZodType<Prisma.InvoiceCommentUpsertWithWhereUniqueWithoutInvoiceInput> = z.object({
  where: z.lazy(() => InvoiceCommentWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => InvoiceCommentUpdateWithoutInvoiceInputSchema),z.lazy(() => InvoiceCommentUncheckedUpdateWithoutInvoiceInputSchema) ]),
  create: z.union([ z.lazy(() => InvoiceCommentCreateWithoutInvoiceInputSchema),z.lazy(() => InvoiceCommentUncheckedCreateWithoutInvoiceInputSchema) ]),
}).strict();
