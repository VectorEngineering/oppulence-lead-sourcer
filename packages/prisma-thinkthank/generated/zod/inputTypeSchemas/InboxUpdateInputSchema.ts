...
import { ProjectUpdateOneWithoutInboxNestedInputSchema } from './ProjectUpdateOneWithoutInboxNestedInputSchema';
import { TransactionAttachmentUpdateOneWithoutInboxNestedInputSchema } from './TransactionAttachmentUpdateOneWithoutInboxNestedInputSchema';
import { TransactionUpdateOneWithoutInboxNestedInputSchema } from './TransactionUpdateOneWithoutInboxNestedInputSchema';
import { InboxUpdateOneWithoutChildrenNestedInputSchema } from './InboxUpdateOneWithoutChildrenNestedInputSchema';
import { InboxUpdateManyWithoutParentNestedInputSchema } from './InboxUpdateManyWithoutParentNestedInputSchema';
import { InboxActivityUpdateManyWithoutInboxNestedInputSchema } from './InboxActivityUpdateManyWithoutInboxNestedInputSchema';
import { InboxShareUpdateManyWithoutInboxNestedInputSchema } from './InboxShareUpdateManyWithoutInboxNestedInputSchema';
import { InboxLabelUpdateManyWithoutInboxNestedInputSchema } from './InboxLabelUpdateManyWithoutInboxNestedInputSchema';

export const InboxUpdateInputSchema: z.ZodType<Prisma.InboxUpdateInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  name: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  originalName: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  type: z.union([ z.lazy(() => InboxTypeSchema),z.lazy(() => NullableEnumInboxTypeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  status: z.union([ z.lazy(() => InboxStatusSchema),z.lazy(() => NullableEnumInboxStatusFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  fileExtension: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  size: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  contentType: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  checksum: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  compression: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  storageLocation: z.union([ z.lazy(() => StorageLocationSchema),z.lazy(() => EnumStorageLocationFieldUpdateOperationsInputSchema) ]).optional(),
  virusScanStatus: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  virusScanDate: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  lastSecurityAudit: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  encryptionMethod: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  encryptionKeyId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  digitalSignature: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  certificateId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  sortOrder: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  displayOrder: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  accessLevel: z.union([ z.lazy(() => InboxAccessLevelSchema),z.lazy(() => EnumInboxAccessLevelFieldUpdateOperationsInputSchema) ]).optional(),
  classification: z.union([ z.lazy(() => InboxClassificationSchema),z.lazy(() => EnumInboxClassificationFieldUpdateOperationsInputSchema) ]).optional(),
  password: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  encryptionKey: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  maxAccessCount: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  retentionPolicy: z.union([ z.lazy(() => RetentionPolicySchema),z.lazy(() => EnumRetentionPolicyFieldUpdateOperationsInputSchema) ]).optional(),
  retentionDate: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  legalHold: z.union([ z.boolean(),z.lazy(() => BoolFieldUpdateOperationsInputSchema) ]).optional(),
  dispositionDate: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  archiveDate: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  purgeDate: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  taxAmount: z.union([ z.number(),z.lazy(() => NullableFloatFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  totalAmount: z.union([ z.number(),z.lazy(() => NullableFloatFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  effectiveDate: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  lastValidated: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  lastBackupDate: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  processingStatus: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  workflow: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  ocrLanguage: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ocrConfidence: z.union([ z.number(),z.lazy(() => NullableFloatFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ocrEngine: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  versionNotes: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  branchName: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  mergeHistory: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  forwardedTo: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  forwardedBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  forwardedAt: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  lockHolder: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  lockExpiresAt: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  lastModifiedBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  lastModifiedById: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  dataPrivacyLevel: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  backupStatus: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  lastBackupId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  recoveryPoint: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  backupLocation: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  project: z.lazy(() => ProjectUpdateOneWithoutInboxNestedInputSchema).optional(),
  attachment: z.lazy(() => TransactionAttachmentUpdateOneWithoutInboxNestedInputSchema).optional(),
  transaction: z.lazy(() => TransactionUpdateOneWithoutInboxNestedInputSchema).optional(),
  parent: z.lazy(() => InboxUpdateOneWithoutChildrenNestedInputSchema).optional(),
  children: z.lazy(() => InboxUpdateManyWithoutParentNestedInputSchema).optional(),
  activities: z.lazy(() => InboxActivityUpdateManyWithoutInboxNestedInputSchema).optional(),
  shares: z.lazy(() => InboxShareUpdateManyWithoutInboxNestedInputSchema).optional(),
  labels: z.lazy(() => InboxLabelUpdateManyWithoutInboxNestedInputSchema).optional()
}).strict();

export default InboxUpdateInputSchema;
