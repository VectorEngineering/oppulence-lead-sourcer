...
export const ContractUpsertWithoutContractEventsInputSchema: z.ZodType<Prisma.ContractUpsertWithoutContractEventsInput> = z.object({
  update: z.union([ z.lazy(() => ContractUpdateWithoutContractEventsInputSchema),z.lazy(() => ContractUncheckedUpdateWithoutContractEventsInputSchema) ]),
