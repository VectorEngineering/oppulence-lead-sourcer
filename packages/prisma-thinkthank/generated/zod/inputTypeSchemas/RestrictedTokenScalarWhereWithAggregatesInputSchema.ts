...
export const RestrictedTokenScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.RestrictedTokenScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => RestrictedTokenScalarWhereWithAggregatesInputSchema),
                z.lazy(() => RestrictedTokenScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => RestrictedTokenScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
