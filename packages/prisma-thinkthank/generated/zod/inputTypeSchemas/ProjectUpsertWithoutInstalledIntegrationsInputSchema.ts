...
export const ProjectUpsertWithoutInstalledIntegrationsInputSchema: z.ZodType<Prisma.ProjectUpsertWithoutInstalledIntegrationsInput> = z.object({
  update: z.union([ z.lazy(() => ProjectUpdateWithoutInstalledIntegrationsInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutInstalledIntegrationsInputSchema) ]),
