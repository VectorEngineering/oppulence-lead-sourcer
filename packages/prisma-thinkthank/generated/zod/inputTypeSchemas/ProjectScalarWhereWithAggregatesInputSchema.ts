...
export const ProjectScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ProjectScalarWhereWithAggregatesInput> = z.object({
  ...
  paymentFailedAt: z.union([ z.lazy(() => DateTimeNullableWithAggregatesFilterSchema),z.coerce.date() ]).optional().nullable(),
  stripeConnectId: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  payoutMethodId: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  shopifyStoreId: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  invoicePrefix: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  adminRole: z.union([ z.lazy(() => EnumAdminRoleNullableWithAggregatesFilterSchema),z.lazy(() => AdminRoleSchema) ]).optional().nullable(),
  organizationSize: z.union([ z.lazy(() => EnumOrganizationSizeNullableWithAggregatesFilterSchema),z.lazy(() => OrganizationSizeSchema) ]).optional().nullable(),
  ...
  referralLinkId: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
