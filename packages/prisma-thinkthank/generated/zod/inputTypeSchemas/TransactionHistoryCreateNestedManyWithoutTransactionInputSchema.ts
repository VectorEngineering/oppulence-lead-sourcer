...
export const TransactionHistoryCreateNestedManyWithoutTransactionInputSchema: z.ZodType<Prisma.TransactionHistoryCreateNestedManyWithoutTransactionInput> =
    z
        .object({
            create: z
                .union([
