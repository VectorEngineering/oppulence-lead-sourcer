...
export const InstalledIntegrationUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.InstalledIntegrationUpdateManyWithoutProjectNestedInput> = z.object({
  create: z.union([ z.lazy(() => InstalledIntegrationCreateWithoutProjectInputSchema),z.lazy(() => InstalledIntegrationCreateWithoutProjectInputSchema).array(),z.lazy(() => InstalledIntegrationUncheckedCreateWithoutProjectInputSchema),z.lazy(() => InstalledIntegrationUncheckedCreateWithoutProjectInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => InstalledIntegrationCreateOrConnectWithoutProjectInputSchema),z.lazy(() => InstalledIntegrationCreateOrConnectWithoutProjectInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => InstalledIntegrationUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => InstalledIntegrationUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => InstalledIntegrationUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => InstalledIntegrationUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => InstalledIntegrationUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => InstalledIntegrationUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
...
export default InstalledIntegrationUpdateManyWithoutProjectNestedInputSchema;
