...
export const TransactionReconciliationMatchWhereUniqueInputSchema: z.ZodType<Prisma.TransactionReconciliationMatchWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([
                        z.lazy(() => TransactionReconciliationMatchWhereInputSchema),
                        z.lazy(() => TransactionReconciliationMatchWhereInputSchema).array()
                    ])
                    .optional(),
                OR: z
                    .lazy(() => TransactionReconciliationMatchWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([
...
export default TransactionReconciliationMatchWhereUniqueInputSchema
