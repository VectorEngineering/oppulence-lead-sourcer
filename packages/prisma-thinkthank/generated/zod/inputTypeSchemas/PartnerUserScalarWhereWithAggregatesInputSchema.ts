...
export const PartnerUserScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.PartnerUserScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => PartnerUserScalarWhereWithAggregatesInputSchema),
                z.lazy(() => PartnerUserScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => PartnerUserScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
