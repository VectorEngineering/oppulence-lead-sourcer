...
export const LinkTagUpdateManyWithoutLinkNestedInputSchema: z.ZodType<Prisma.LinkTagUpdateManyWithoutLinkNestedInput> = z.object({
  create: z.union([ z.lazy(() => LinkTagCreateWithoutLinkInputSchema),z.lazy(() => LinkTagCreateWithoutLinkInputSchema).array(),z.lazy(() => LinkTagUncheckedCreateWithoutLinkInputSchema),z.lazy(() => LinkTagUncheckedCreateWithoutLinkInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LinkTagCreateOrConnectWithoutLinkInputSchema),z.lazy(() => LinkTagCreateOrConnectWithoutLinkInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LinkTagUpsertWithWhereUniqueWithoutLinkInputSchema),z.lazy(() => LinkTagUpsertWithWhereUniqueWithoutLinkInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LinkTagUpdateWithWhereUniqueWithoutLinkInputSchema),z.lazy(() => LinkTagUpdateWithWhereUniqueWithoutLinkInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LinkTagUpdateManyWithWhereWithoutLinkInputSchema),z.lazy(() => LinkTagUpdateManyWithWhereWithoutLinkInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LinkTagScalarWhereInputSchema),z.lazy(() => LinkTagScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LinkTagUpdateManyWithoutLinkNestedInputSchema;
