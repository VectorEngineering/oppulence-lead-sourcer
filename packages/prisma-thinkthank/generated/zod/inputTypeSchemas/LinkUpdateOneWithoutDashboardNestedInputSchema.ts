...
export const LinkUpdateOneWithoutDashboardNestedInputSchema: z.ZodType<Prisma.LinkUpdateOneWithoutDashboardNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LinkUpdateToOneWithWhereWithoutDashboardInputSchema),z.lazy(() => LinkUpdateWithoutDashboardInputSchema),z.lazy(() => LinkUncheckedUpdateWithoutDashboardInputSchema) ]).optional(),
}).strict();
