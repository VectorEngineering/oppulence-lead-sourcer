...
export const InstalledIntegrationUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.InstalledIntegrationUpsertWithWhereUniqueWithoutUserInput> =
    z
        .object({
            where: z.lazy(() => InstalledIntegrationWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => InstalledIntegrationUpdateWithoutUserInputSchema),
                z.lazy(() => InstalledIntegrationUncheckedUpdateWithoutUserInputSchema)
            ]),
            create: z.union([
