...
import { z } from 'zod';
import { BankAccountProjectIdAccountIdCompoundUniqueInputSchema } from './BankAccountProjectIdAccountIdCompoundUniqueInputSchema';
...
export const BankAccountWhereUniqueInputSchema: z.ZodType<Prisma.BankAccountWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    projectId_accountId: z.lazy(() => BankAccountProjectIdAccountIdCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.string().cuid(),
  }),
...
.and(z.object({
  ...
  projectId_accountId: z.lazy(() => BankAccountProjectIdAccountIdCompoundUniqueInputSchema).optional(),
  ...
  routingNumber: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  mask: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  name: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  officialName: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  displayName: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  description: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  type: z.union([ z.lazy(() => EnumAccountTypeNullableFilterSchema),z.lazy(() => AccountTypeSchema) ]).optional().nullable(),
  subtype: z.union([ z.lazy(() => EnumAccountSubTypeNullableFilterSchema),z.lazy(() => AccountSubTypeSchema) ]).optional().nullable(),
  ownershipType: z.union([ z.lazy(() => EnumAccountOwnershipTypeNullableFilterSchema),z.lazy(() => AccountOwnershipTypeSchema) ]).optional().nullable(),
  purpose: z.union([ z.lazy(() => EnumAccountPurposeNullableFilterSchema),z.lazy(() => AccountPurposeSchema) ]).optional().nullable(),
  balance: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  baseBalance: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  availableBalance: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  pendingBalance: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  creditLimit: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  minBalance: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  targetBalance: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  overdraftLimit: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  interestRate: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  ...
  exchangeRateTimestamp: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  ...
  spendingLimit: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  ...
  approvalThreshold: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  ...
  nextSyncAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  ...
  riskLevel: z.union([ z.lazy(() => EnumRiskLevelNullableFilterSchema),z.lazy(() => RiskLevelSchema) ]).optional().nullable(),
  complianceStatus: z.union([ z.lazy(() => EnumComplianceStatusNullableFilterSchema),z.lazy(() => ComplianceStatusSchema) ]).optional().nullable(),
  ...
  lastActivityAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
