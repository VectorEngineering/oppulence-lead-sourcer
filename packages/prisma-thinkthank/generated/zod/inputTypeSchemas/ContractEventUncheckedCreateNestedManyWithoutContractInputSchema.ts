...
export const ContractEventUncheckedCreateNestedManyWithoutContractInputSchema: z.ZodType<Prisma.ContractEventUncheckedCreateNestedManyWithoutContractInput> =
    z
        .object({
            create: z
                .union([
