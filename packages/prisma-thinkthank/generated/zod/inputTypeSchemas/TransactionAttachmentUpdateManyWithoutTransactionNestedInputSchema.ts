...
export const TransactionAttachmentUpdateManyWithoutTransactionNestedInputSchema: z.ZodType<Prisma.TransactionAttachmentUpdateManyWithoutTransactionNestedInput> =
    z
        .object({
            create: z
                .union([
