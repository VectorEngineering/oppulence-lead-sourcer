...
export const ContractDocumentUncheckedUpdateManyWithoutContractNestedInputSchema: z.ZodType<Prisma.ContractDocumentUncheckedUpdateManyWithoutContractNestedInput> =
    z
        .object({
            create: z
                .union([
