...
export const BankConnectionUpdateToOneWithWhereWithoutBankAccountsInputSchema: z.ZodType<Prisma.BankConnectionUpdateToOneWithWhereWithoutBankAccountsInput> = z.object({
  where: z.lazy(() => BankConnectionWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => BankConnectionUpdateWithoutBankAccountsInputSchema),z.lazy(() => BankConnectionUncheckedUpdateWithoutBankAccountsInputSchema) ]),
}).strict();
