...
export const InboxUpdateManyWithoutTransactionNestedInputSchema: z.ZodType<Prisma.InboxUpdateManyWithoutTransactionNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => InboxUpsertWithWhereUniqueWithoutTransactionInputSchema),
                z.lazy(() => InboxUpsertWithWhereUniqueWithoutTransactionInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => InboxUpdateWithWhereUniqueWithoutTransactionInputSchema),
                z.lazy(() => InboxUpdateWithWhereUniqueWithoutTransactionInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => InboxUpdateManyWithWhereWithoutTransactionInputSchema),
                z.lazy(() => InboxUpdateManyWithWhereWithoutTransactionInputSchema).array()
            ])
            .optional(),
...
export default InboxUpdateManyWithoutTransactionNestedInputSchema
