...
export const InboxUpdateOneWithoutChildrenNestedInputSchema: z.ZodType<Prisma.InboxUpdateOneWithoutChildrenNestedInput> = z.object({
  create: z.union([ z.lazy(() => InboxCreateWithoutChildrenInputSchema),z.lazy(() => InboxUncheckedCreateWithoutChildrenInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => InboxUpdateToOneWithWhereWithoutChildrenInputSchema),z.lazy(() => InboxUpdateWithoutChildrenInputSchema),z.lazy(() => InboxUncheckedUpdateWithoutChildrenInputSchema) ]).optional(),
}).strict();
