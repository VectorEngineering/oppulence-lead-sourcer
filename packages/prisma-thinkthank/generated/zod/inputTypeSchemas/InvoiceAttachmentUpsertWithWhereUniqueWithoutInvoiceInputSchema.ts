...
export const InvoiceAttachmentUpsertWithWhereUniqueWithoutInvoiceInputSchema: z.ZodType<Prisma.InvoiceAttachmentUpsertWithWhereUniqueWithoutInvoiceInput> = z.object({
  where: z.lazy(() => InvoiceAttachmentWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => InvoiceAttachmentUpdateWithoutInvoiceInputSchema),z.lazy(() => InvoiceAttachmentUncheckedUpdateWithoutInvoiceInputSchema) ]),
