...
export const InboxCreateWithoutTransactionInputSchema: z.ZodType<Prisma.InboxCreateWithoutTransactionInput> = z
    .object({
...
export default InboxCreateWithoutTransactionInputSchema
