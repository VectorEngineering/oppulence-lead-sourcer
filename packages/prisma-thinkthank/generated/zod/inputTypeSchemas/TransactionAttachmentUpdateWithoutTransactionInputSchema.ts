...
import { ProjectUpdateOneRequiredWithoutTransactionAttachmentNestedInputSchema } from './ProjectUpdateOneRequiredWithoutTransactionAttachmentNestedInputSchema';
import { InboxUpdateManyWithoutAttachmentNestedInputSchema } from './InboxUpdateManyWithoutAttachmentNestedInputSchema';

export const TransactionAttachmentUpdateWithoutTransactionInputSchema: z.ZodType<Prisma.TransactionAttachmentUpdateWithoutTransactionInput> = z.object({
  ...
  project: z.lazy(() => ProjectUpdateOneRequiredWithoutTransactionAttachmentNestedInputSchema).optional(),
  inbox: z.lazy(() => InboxUpdateManyWithoutAttachmentNestedInputSchema).optional()
}).strict();

export default TransactionAttachmentUpdateWithoutTransactionInputSchema;
