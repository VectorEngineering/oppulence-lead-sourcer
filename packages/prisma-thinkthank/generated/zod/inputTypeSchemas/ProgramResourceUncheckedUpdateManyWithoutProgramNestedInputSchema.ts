...
export const ProgramResourceUncheckedUpdateManyWithoutProgramNestedInputSchema: z.ZodType<Prisma.ProgramResourceUncheckedUpdateManyWithoutProgramNestedInput> =
    z
        .object({
            create: z
                .union([
