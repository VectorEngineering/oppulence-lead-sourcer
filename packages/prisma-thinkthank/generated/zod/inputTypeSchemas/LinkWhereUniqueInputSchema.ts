...
import { z } from 'zod';
import { LinkDomainKeyCompoundUniqueInputSchema } from './LinkDomainKeyCompoundUniqueInputSchema';
import { LinkProjectIdExternalIdCompoundUniqueInputSchema } from './LinkProjectIdExternalIdCompoundUniqueInputSchema';
...
export const LinkWhereUniqueInputSchema: z.ZodType<Prisma.LinkWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    shortLink: z.string(),
    domain_key: z.lazy(() => LinkDomainKeyCompoundUniqueInputSchema),
    projectId_externalId: z.lazy(() => LinkProjectIdExternalIdCompoundUniqueInputSchema)
  }),
  z.object({
    id: z.string().cuid(),
    shortLink: z.string(),
...
.and(z.object({
  ...
  domain_key: z.lazy(() => LinkDomainKeyCompoundUniqueInputSchema).optional(),
  projectId_externalId: z.lazy(() => LinkProjectIdExternalIdCompoundUniqueInputSchema).optional(),
  ...
  leads: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  sales: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  saleAmount: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  ...
  projectDomain: z.union([ z.lazy(() => DomainNullableRelationFilterSchema),z.lazy(() => DomainWhereInputSchema) ]).optional().nullable(),
  tags: z.lazy(() => LinkTagListRelationFilterSchema).optional(),
  webhooks: z.lazy(() => LinkWebhookListRelationFilterSchema).optional(),
  dashboard: z.union([ z.lazy(() => DashboardNullableRelationFilterSchema),z.lazy(() => DashboardWhereInputSchema) ]).optional().nullable(),
  programEnrollment: z.union([ z.lazy(() => ProgramEnrollmentNullableRelationFilterSchema),z.lazy(() => ProgramEnrollmentWhereInputSchema) ]).optional().nullable(),
  programInvite: z.union([ z.lazy(() => ProgramInviteNullableRelationFilterSchema),z.lazy(() => ProgramInviteWhereInputSchema) ]).optional().nullable(),
  program: z.union([ z.lazy(() => ProgramNullableRelationFilterSchema),z.lazy(() => ProgramWhereInputSchema) ]).optional().nullable(),
  customers: z.lazy(() => CustomerListRelationFilterSchema).optional()
}).strict());

export default LinkWhereUniqueInputSchema;
