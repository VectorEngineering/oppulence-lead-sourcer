...
import { NestedEnumTransactionFrequencyNullableWithAggregatesFilterSchema } from './NestedEnumTransactionFrequencyNullableWithAggregatesFilterSchema';
...
export const EnumTransactionFrequencyNullableWithAggregatesFilterSchema: z.ZodType<Prisma.EnumTransactionFrequencyNullableWithAggregatesFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => TransactionFrequencySchema),z.lazy(() => NestedEnumTransactionFrequencyNullableWithAggregatesFilterSchema) ]).optional().nullable(),
...
export default EnumTransactionFrequencyNullableWithAggregatesFilterSchema;
