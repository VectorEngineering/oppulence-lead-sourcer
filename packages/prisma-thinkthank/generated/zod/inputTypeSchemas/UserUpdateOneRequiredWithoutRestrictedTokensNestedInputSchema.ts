...
export const UserUpdateOneRequiredWithoutRestrictedTokensNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutRestrictedTokensNestedInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutRestrictedTokensInputSchema),z.lazy(() => UserUncheckedCreateWithoutRestrictedTokensInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutRestrictedTokensInputSchema),z.lazy(() => UserUpdateWithoutRestrictedTokensInputSchema),z.lazy(() => UserUncheckedUpdateWithoutRestrictedTokensInputSchema) ]).optional(),
}).strict();
