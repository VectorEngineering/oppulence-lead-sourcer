...
export const PartnerUserUpdateManyWithWhereWithoutPartnerInputSchema: z.ZodType<Prisma.PartnerUserUpdateManyWithWhereWithoutPartnerInput> =
    z
        .object({
            where: z.lazy(() => PartnerUserScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => PartnerUserUpdateManyMutationInputSchema),
                z.lazy(() => PartnerUserUncheckedUpdateManyWithoutPartnerInputSchema)
            ])
        })
        .strict()
