...
export const ContractVersionScalarWhereInputSchema: z.ZodType<Prisma.ContractVersionScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => ContractVersionScalarWhereInputSchema),z.lazy(() => ContractVersionScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ContractVersionScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => ContractVersionScalarWhereInputSchema),z.lazy(() => ContractVersionScalarWhereInputSchema).array() ]).optional(),
...
export default ContractVersionScalarWhereInputSchema;
