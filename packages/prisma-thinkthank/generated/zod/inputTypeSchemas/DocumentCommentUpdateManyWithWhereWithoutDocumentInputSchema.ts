...
export const DocumentCommentUpdateManyWithWhereWithoutDocumentInputSchema: z.ZodType<Prisma.DocumentCommentUpdateManyWithWhereWithoutDocumentInput> = z.object({
  where: z.lazy(() => DocumentCommentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => DocumentCommentUpdateManyMutationInputSchema),z.lazy(() => DocumentCommentUncheckedUpdateManyWithoutDocumentInputSchema) ]),
}).strict();
