...
export const InvoiceCommentUpdateOneWithoutRepliesNestedInputSchema: z.ZodType<Prisma.InvoiceCommentUpdateOneWithoutRepliesNestedInput> = z.object({
  create: z.union([ z.lazy(() => InvoiceCommentCreateWithoutRepliesInputSchema),z.lazy(() => InvoiceCommentUncheckedCreateWithoutRepliesInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => InvoiceCommentUpdateToOneWithWhereWithoutRepliesInputSchema),z.lazy(() => InvoiceCommentUpdateWithoutRepliesInputSchema),z.lazy(() => InvoiceCommentUncheckedUpdateWithoutRepliesInputSchema) ]).optional(),
}).strict();
