...
export const RestrictedTokenUpsertWithWhereUniqueWithoutInstalledIntegrationInputSchema: z.ZodType<Prisma.RestrictedTokenUpsertWithWhereUniqueWithoutInstalledIntegrationInput> = z.object({
  where: z.lazy(() => RestrictedTokenWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => RestrictedTokenUpdateWithoutInstalledIntegrationInputSchema),z.lazy(() => RestrictedTokenUncheckedUpdateWithoutInstalledIntegrationInputSchema) ]),
