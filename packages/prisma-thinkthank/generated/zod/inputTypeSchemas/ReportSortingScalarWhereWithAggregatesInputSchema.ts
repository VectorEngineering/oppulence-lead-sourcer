...
export const ReportSortingScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ReportSortingScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => ReportSortingScalarWhereWithAggregatesInputSchema),z.lazy(() => ReportSortingScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => ReportSortingScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => ReportSortingScalarWhereWithAggregatesInputSchema),z.lazy(() => ReportSortingScalarWhereWithAggregatesInputSchema).array() ]).optional(),
