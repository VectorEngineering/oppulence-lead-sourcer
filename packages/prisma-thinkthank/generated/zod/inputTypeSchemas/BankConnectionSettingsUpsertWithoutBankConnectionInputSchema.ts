...
export const BankConnectionSettingsUpsertWithoutBankConnectionInputSchema: z.ZodType<Prisma.BankConnectionSettingsUpsertWithoutBankConnectionInput> = z.object({
  update: z.union([ z.lazy(() => BankConnectionSettingsUpdateWithoutBankConnectionInputSchema),z.lazy(() => BankConnectionSettingsUncheckedUpdateWithoutBankConnectionInputSchema) ]),
  create: z.union([ z.lazy(() => BankConnectionSettingsCreateWithoutBankConnectionInputSchema),z.lazy(() => BankConnectionSettingsUncheckedCreateWithoutBankConnectionInputSchema) ]),
