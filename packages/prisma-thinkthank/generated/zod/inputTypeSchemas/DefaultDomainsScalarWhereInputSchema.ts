...
export const DefaultDomainsScalarWhereInputSchema: z.ZodType<Prisma.DefaultDomainsScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => DefaultDomainsScalarWhereInputSchema),z.lazy(() => DefaultDomainsScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => DefaultDomainsScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => DefaultDomainsScalarWhereInputSchema),z.lazy(() => DefaultDomainsScalarWhereInputSchema).array() ]).optional(),
