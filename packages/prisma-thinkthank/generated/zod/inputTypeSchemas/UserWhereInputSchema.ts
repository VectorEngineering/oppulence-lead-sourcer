...
export const UserWhereInputSchema: z.ZodType<Prisma.UserWhereInput> = z
    .object({
        ...
        aiAssistantSettings: z
            .union([z.lazy(() => AIAssistantSettingsNullableRelationFilterSchema), z.lazy(() => AIAssistantSettingsWhereInputSchema)])
            .optional()
            .nullable(),
        financialSettings: z
            .union([z.lazy(() => FinancialSettingsNullableRelationFilterSchema), z.lazy(() => FinancialSettingsWhereInputSchema)])
            .optional()
            .nullable(),
