...
export const InvoiceUpdateWithWhereUniqueWithoutTemplateInputSchema: z.ZodType<Prisma.InvoiceUpdateWithWhereUniqueWithoutTemplateInput> = z.object({
  where: z.lazy(() => InvoiceWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => InvoiceUpdateWithoutTemplateInputSchema),z.lazy(() => InvoiceUncheckedUpdateWithoutTemplateInputSchema) ]),
}).strict();
