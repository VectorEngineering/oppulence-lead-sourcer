...
export const OAuthAppUpdateToOneWithWhereWithoutOAuthCodesInputSchema: z.ZodType<Prisma.OAuthAppUpdateToOneWithWhereWithoutOAuthCodesInput> = z.object({
  where: z.lazy(() => OAuthAppWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => OAuthAppUpdateWithoutOAuthCodesInputSchema),z.lazy(() => OAuthAppUncheckedUpdateWithoutOAuthCodesInputSchema) ]),
}).strict();
