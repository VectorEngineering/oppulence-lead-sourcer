...
export const InboxUncheckedUpdateManyWithoutAttachmentNestedInputSchema: z.ZodType<Prisma.InboxUncheckedUpdateManyWithoutAttachmentNestedInput> = z.object({
  create: z.union([ z.lazy(() => InboxCreateWithoutAttachmentInputSchema),z.lazy(() => InboxCreateWithoutAttachmentInputSchema).array(),z.lazy(() => InboxUncheckedCreateWithoutAttachmentInputSchema),z.lazy(() => InboxUncheckedCreateWithoutAttachmentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => InboxCreateOrConnectWithoutAttachmentInputSchema),z.lazy(() => InboxCreateOrConnectWithoutAttachmentInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => InboxUpsertWithWhereUniqueWithoutAttachmentInputSchema),z.lazy(() => InboxUpsertWithWhereUniqueWithoutAttachmentInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => InboxUpdateWithWhereUniqueWithoutAttachmentInputSchema),z.lazy(() => InboxUpdateWithWhereUniqueWithoutAttachmentInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => InboxUpdateManyWithWhereWithoutAttachmentInputSchema),z.lazy(() => InboxUpdateManyWithWhereWithoutAttachmentInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => InboxScalarWhereInputSchema),z.lazy(() => InboxScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default InboxUncheckedUpdateManyWithoutAttachmentNestedInputSchema;
