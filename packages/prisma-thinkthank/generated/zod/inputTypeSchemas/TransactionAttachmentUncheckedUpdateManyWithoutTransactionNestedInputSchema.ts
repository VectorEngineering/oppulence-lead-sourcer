...
export const TransactionAttachmentUncheckedUpdateManyWithoutTransactionNestedInputSchema: z.ZodType<Prisma.TransactionAttachmentUncheckedUpdateManyWithoutTransactionNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => TransactionAttachmentCreateWithoutTransactionInputSchema),
                    z.lazy(() => TransactionAttachmentCreateWithoutTransactionInputSchema).array(),
                    z.lazy(() => TransactionAttachmentUncheckedCreateWithoutTransactionInputSchema),
                    z.lazy(() => TransactionAttachmentUncheckedCreateWithoutTransactionInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => TransactionAttachmentCreateOrConnectWithoutTransactionInputSchema),
                    z.lazy(() => TransactionAttachmentCreateOrConnectWithoutTransactionInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => TransactionAttachmentUpsertWithWhereUniqueWithoutTransactionInputSchema),
                    z.lazy(() => TransactionAttachmentUpsertWithWhereUniqueWithoutTransactionInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => TransactionAttachmentUpdateWithWhereUniqueWithoutTransactionInputSchema),
                    z.lazy(() => TransactionAttachmentUpdateWithWhereUniqueWithoutTransactionInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => TransactionAttachmentUpdateManyWithWhereWithoutTransactionInputSchema),
                    z.lazy(() => TransactionAttachmentUpdateManyWithWhereWithoutTransactionInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
...
export default TransactionAttachmentUncheckedUpdateManyWithoutTransactionNestedInputSchema
