...
import { TagUncheckedUpdateManyWithoutBankAccountNestedInputSchema } from './TagUncheckedUpdateManyWithoutBankAccountNestedInputSchema'
import { TransactionUncheckedUpdateManyWithoutBankAccountNestedInputSchema } from './TransactionUncheckedUpdateManyWithoutBankAccountNestedInputSchema'

export const BankAccountUncheckedUpdateWithoutCreatorInputSchema: z.ZodType<Prisma.BankAccountUncheckedUpdateWithoutCreatorInput> = z
    .object({
        ...
        description: z
            ...
            .nullable(),
        type: z
            .union([z.lazy(() => AccountTypeSchema), z.lazy(() => NullableEnumAccountTypeFieldUpdateOperationsInputSchema)])
            .optional()
            .nullable(),
        subtype: z
            .union([z.lazy(() => AccountSubTypeSchema), z.lazy(() => NullableEnumAccountSubTypeFieldUpdateOperationsInputSchema)])
            .optional()
            .nullable(),
        ownershipType: z
            .union([
                z.lazy(() => AccountOwnershipTypeSchema),
                z.lazy(() => NullableEnumAccountOwnershipTypeFieldUpdateOperationsInputSchema)
            ])
            .optional()
            .nullable(),
        purpose: z
            .union([z.lazy(() => AccountPurposeSchema), z.lazy(() => NullableEnumAccountPurposeFieldUpdateOperationsInputSchema)])
            .optional()
            .nullable(),
        balance: z
        ...
        approvalThreshold: z
            ...
            .nullable(),
        status: z
            .union([z.lazy(() => ConnectionStatusSchema), z.lazy(() => NullableEnumConnectionStatusFieldUpdateOperationsInputSchema)])
            .optional()
            .nullable(),
        errorDetails: z
            .union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputSchema)])
        ...
        lastErrorAt: z
            ...
            .nullable(),
        riskLevel: z
            .union([z.lazy(() => RiskLevelSchema), z.lazy(() => NullableEnumRiskLevelFieldUpdateOperationsInputSchema)])
            .optional()
            .nullable(),
        complianceStatus: z
            .union([z.lazy(() => ComplianceStatusSchema), z.lazy(() => NullableEnumComplianceStatusFieldUpdateOperationsInputSchema)])
            .optional()
            .nullable(),
        lastReviewDate: z
            .union([z.coerce.date(), z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema)])
        ...
        reviewNotes: z
            ...
            .optional()
            .nullable(),
        bankConnectionId: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputSchema)]).optional(),
        ...
        lastActivityAt: z
            ...
            .optional()
            .nullable(),
        tags: z.lazy(() => TagUncheckedUpdateManyWithoutBankAccountNestedInputSchema).optional(),
        transactions: z.lazy(() => TransactionUncheckedUpdateManyWithoutBankAccountNestedInputSchema).optional()
    })
    .strict()

export default BankAccountUncheckedUpdateWithoutCreatorInputSchema
