...
export const FinancialSettingsWhereUniqueInputSchema: z.ZodType<Prisma.FinancialSettingsWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
            userId: z.string()
    ...
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => FinancialSettingsWhereInputSchema), z.lazy(() => FinancialSettingsWhereInputSchema).array()])
                    .optional(),
                OR: z
                ...
                matchingStrategy: z
                    .union([z.lazy(() => EnumMatchingStrategyFilterSchema), z.lazy(() => MatchingStrategySchema)])
                    .optional(),
