...
export const TagUpdateOneRequiredWithoutLinksNestedInputSchema: z.ZodType<Prisma.TagUpdateOneRequiredWithoutLinksNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => TagUpdateToOneWithWhereWithoutLinksInputSchema),z.lazy(() => TagUpdateWithoutLinksInputSchema),z.lazy(() => TagUncheckedUpdateWithoutLinksInputSchema) ]).optional(),
}).strict();
