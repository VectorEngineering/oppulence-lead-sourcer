...
export const TransactionAttachmentUncheckedCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.TransactionAttachmentUncheckedCreateNestedManyWithoutProjectInput> =
    z
        .object({
            create: z
                .union([
