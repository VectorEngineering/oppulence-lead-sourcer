...
export const CustomerUncheckedCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.CustomerUncheckedCreateNestedManyWithoutProjectInput> =
    z
        .object({
            create: z
                .union([
...
export default CustomerUncheckedCreateNestedManyWithoutProjectInputSchema
