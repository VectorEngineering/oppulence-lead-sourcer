...
export const AppUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.AppUncheckedUpdateManyWithoutProjectNestedInput> = z.object({
  create: z.union([ z.lazy(() => AppCreateWithoutProjectInputSchema),z.lazy(() => AppCreateWithoutProjectInputSchema).array(),z.lazy(() => AppUncheckedCreateWithoutProjectInputSchema),z.lazy(() => AppUncheckedCreateWithoutProjectInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => AppCreateOrConnectWithoutProjectInputSchema),z.lazy(() => AppCreateOrConnectWithoutProjectInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => AppUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => AppUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => AppUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => AppUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => AppUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => AppUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => AppScalarWhereInputSchema),z.lazy(() => AppScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default AppUncheckedUpdateManyWithoutProjectNestedInputSchema;
