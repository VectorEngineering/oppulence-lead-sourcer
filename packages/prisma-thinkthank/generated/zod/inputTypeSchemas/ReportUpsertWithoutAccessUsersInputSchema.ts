...
export const ReportUpsertWithoutAccessUsersInputSchema: z.ZodType<Prisma.ReportUpsertWithoutAccessUsersInput> = z.object({
  update: z.union([ z.lazy(() => ReportUpdateWithoutAccessUsersInputSchema),z.lazy(() => ReportUncheckedUpdateWithoutAccessUsersInputSchema) ]),
  create: z.union([ z.lazy(() => ReportCreateWithoutAccessUsersInputSchema),z.lazy(() => ReportUncheckedCreateWithoutAccessUsersInputSchema) ]),
