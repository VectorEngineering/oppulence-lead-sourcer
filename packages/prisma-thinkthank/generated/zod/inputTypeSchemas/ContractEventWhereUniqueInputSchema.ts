...
export const ContractEventWhereUniqueInputSchema: z.ZodType<Prisma.ContractEventWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => ContractEventWhereInputSchema),z.lazy(() => ContractEventWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ContractEventWhereInputSchema).array().optional(),
...
export default ContractEventWhereUniqueInputSchema;
