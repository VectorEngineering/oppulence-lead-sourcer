...
export const ProgramInviteUpdateOneWithoutLinkNestedInputSchema: z.ZodType<Prisma.ProgramInviteUpdateOneWithoutLinkNestedInput> = z
    .object({
        create: z
            .union([
        ...
        update: z
            .union([
                z.lazy(() => ProgramInviteUpdateToOneWithWhereWithoutLinkInputSchema),
...
export default ProgramInviteUpdateOneWithoutLinkNestedInputSchema
