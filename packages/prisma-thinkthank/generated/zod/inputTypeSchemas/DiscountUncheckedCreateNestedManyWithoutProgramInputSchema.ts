...
export const DiscountUncheckedCreateNestedManyWithoutProgramInputSchema: z.ZodType<Prisma.DiscountUncheckedCreateNestedManyWithoutProgramInput> =
    z
        .object({
            create: z
                .union([
...
export default DiscountUncheckedCreateNestedManyWithoutProgramInputSchema
