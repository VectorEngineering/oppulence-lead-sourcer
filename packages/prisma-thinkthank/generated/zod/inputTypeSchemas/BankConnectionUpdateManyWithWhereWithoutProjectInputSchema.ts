...
export const BankConnectionUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.BankConnectionUpdateManyWithWhereWithoutProjectInput> = z.object({
  where: z.lazy(() => BankConnectionScalarWhereInputSchema),
  data: z.union([ z.lazy(() => BankConnectionUpdateManyMutationInputSchema),z.lazy(() => BankConnectionUncheckedUpdateManyWithoutProjectInputSchema) ]),
}).strict();
