...
export const IntegrationUpdateOneRequiredWithoutInstallationsNestedInputSchema: z.ZodType<Prisma.IntegrationUpdateOneRequiredWithoutInstallationsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => IntegrationUpdateToOneWithWhereWithoutInstallationsInputSchema),
