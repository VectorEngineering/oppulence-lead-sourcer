...
export const RegisteredDomainUncheckedCreateNestedOneWithoutDomainInputSchema: z.ZodType<Prisma.RegisteredDomainUncheckedCreateNestedOneWithoutDomainInput> =
    z
        .object({
            create: z
                .union([
