...
export const NestedEnumTransactionPriorityWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumTransactionPriorityWithAggregatesFilter> =
    z
        .object({
            ...
            notIn: z
                ...
                .optional(),
            not: z
                .union([z.lazy(() => TransactionPrioritySchema), z.lazy(() => NestedEnumTransactionPriorityWithAggregatesFilterSchema)])
                .optional(),
