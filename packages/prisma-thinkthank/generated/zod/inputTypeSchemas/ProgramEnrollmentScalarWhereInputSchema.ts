...
export const ProgramEnrollmentScalarWhereInputSchema: z.ZodType<Prisma.ProgramEnrollmentScalarWhereInput> = z
    .object({
        AND: z
            .union([z.lazy(() => ProgramEnrollmentScalarWhereInputSchema), z.lazy(() => ProgramEnrollmentScalarWhereInputSchema).array()])
            .optional(),
        OR: z
            .lazy(() => ProgramEnrollmentScalarWhereInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([z.lazy(() => ProgramEnrollmentScalarWhereInputSchema), z.lazy(() => ProgramEnrollmentScalarWhereInputSchema).array()])
