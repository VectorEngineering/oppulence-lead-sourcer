...
export const BankConnectionSettingsUncheckedCreateNestedManyWithoutWebhooksInputSchema: z.ZodType<Prisma.BankConnectionSettingsUncheckedCreateNestedManyWithoutWebhooksInput> =
    z
        .object({
            create: z
                .union([
