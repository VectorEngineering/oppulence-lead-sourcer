...
export const DefaultDomainsUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.DefaultDomainsUpdateManyWithoutProjectNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => DefaultDomainsCreateWithoutProjectInputSchema),
                    z.lazy(() => DefaultDomainsCreateWithoutProjectInputSchema).array(),
                    z.lazy(() => DefaultDomainsUncheckedCreateWithoutProjectInputSchema),
                    z.lazy(() => DefaultDomainsUncheckedCreateWithoutProjectInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => DefaultDomainsCreateOrConnectWithoutProjectInputSchema),
                    z.lazy(() => DefaultDomainsCreateOrConnectWithoutProjectInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => DefaultDomainsUpsertWithWhereUniqueWithoutProjectInputSchema),
                    z.lazy(() => DefaultDomainsUpsertWithWhereUniqueWithoutProjectInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => DefaultDomainsCreateManyProjectInputEnvelopeSchema).optional(),
            set: z
                .union([z.lazy(() => DefaultDomainsWhereUniqueInputSchema), z.lazy(() => DefaultDomainsWhereUniqueInputSchema).array()])
                .optional(),
            disconnect: z
                .union([z.lazy(() => DefaultDomainsWhereUniqueInputSchema), z.lazy(() => DefaultDomainsWhereUniqueInputSchema).array()])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => DefaultDomainsUpdateWithWhereUniqueWithoutProjectInputSchema),
                    z.lazy(() => DefaultDomainsUpdateWithWhereUniqueWithoutProjectInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => DefaultDomainsUpdateManyWithWhereWithoutProjectInputSchema),
                    z.lazy(() => DefaultDomainsUpdateManyWithWhereWithoutProjectInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default DefaultDomainsUpdateManyWithoutProjectNestedInputSchema
