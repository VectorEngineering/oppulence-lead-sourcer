...
export const TransactionCategoryUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.TransactionCategoryUncheckedUpdateManyWithoutProjectNestedInput> =
    z
        .object({
            create: z
                .union([
