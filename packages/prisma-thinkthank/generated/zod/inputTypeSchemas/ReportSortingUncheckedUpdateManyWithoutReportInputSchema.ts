...
export const ReportSortingUncheckedUpdateManyWithoutReportInputSchema: z.ZodType<Prisma.ReportSortingUncheckedUpdateManyWithoutReportInput> =
    z
        .object({
            id: z.union([z.string().cuid(), z.lazy(() => StringFieldUpdateOperationsInputSchema)]).optional(),
            field: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputSchema)]).optional(),
            direction: z
                .union([z.lazy(() => SortDirectionSchema), z.lazy(() => EnumSortDirectionFieldUpdateOperationsInputSchema)])
                .optional(),
            position: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputSchema)]).optional()
        })
        .strict()

export default ReportSortingUncheckedUpdateManyWithoutReportInputSchema
