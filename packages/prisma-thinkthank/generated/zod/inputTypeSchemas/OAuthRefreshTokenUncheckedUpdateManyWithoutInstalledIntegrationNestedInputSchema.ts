...
export const OAuthRefreshTokenUncheckedUpdateManyWithoutInstalledIntegrationNestedInputSchema: z.ZodType<Prisma.OAuthRefreshTokenUncheckedUpdateManyWithoutInstalledIntegrationNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => OAuthRefreshTokenCreateWithoutInstalledIntegrationInputSchema),
                    z.lazy(() => OAuthRefreshTokenCreateWithoutInstalledIntegrationInputSchema).array(),
                    z.lazy(() => OAuthRefreshTokenUncheckedCreateWithoutInstalledIntegrationInputSchema),
                    z.lazy(() => OAuthRefreshTokenUncheckedCreateWithoutInstalledIntegrationInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => OAuthRefreshTokenCreateOrConnectWithoutInstalledIntegrationInputSchema),
                    z.lazy(() => OAuthRefreshTokenCreateOrConnectWithoutInstalledIntegrationInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => OAuthRefreshTokenUpsertWithWhereUniqueWithoutInstalledIntegrationInputSchema),
                    z.lazy(() => OAuthRefreshTokenUpsertWithWhereUniqueWithoutInstalledIntegrationInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => OAuthRefreshTokenUpdateWithWhereUniqueWithoutInstalledIntegrationInputSchema),
                    z.lazy(() => OAuthRefreshTokenUpdateWithWhereUniqueWithoutInstalledIntegrationInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => OAuthRefreshTokenUpdateManyWithWhereWithoutInstalledIntegrationInputSchema),
                    z.lazy(() => OAuthRefreshTokenUpdateManyWithWhereWithoutInstalledIntegrationInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
...
export default OAuthRefreshTokenUncheckedUpdateManyWithoutInstalledIntegrationNestedInputSchema
