...
export const BankConnectionSettingsUpsertWithWhereUniqueWithoutWebhooksInputSchema: z.ZodType<Prisma.BankConnectionSettingsUpsertWithWhereUniqueWithoutWebhooksInput> = z.object({
  where: z.lazy(() => BankConnectionSettingsWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => BankConnectionSettingsUpdateWithoutWebhooksInputSchema),z.lazy(() => BankConnectionSettingsUncheckedUpdateWithoutWebhooksInputSchema) ]),
