...
export const ProjectUpdateOneRequiredWithoutTransactionEnrichmentNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutTransactionEnrichmentNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutTransactionEnrichmentInputSchema),
                    z.lazy(() => ProjectUpdateWithoutTransactionEnrichmentInputSchema),
                    z.lazy(() => ProjectUncheckedUpdateWithoutTransactionEnrichmentInputSchema)
                ])
                .optional()
        })
        .strict()
