...
export const BankAccountUncheckedCreateWithoutTagsInputSchema: z.ZodType<Prisma.BankAccountUncheckedCreateWithoutTagsInput> = z
    .object({
...
export default BankAccountUncheckedCreateWithoutTagsInputSchema
