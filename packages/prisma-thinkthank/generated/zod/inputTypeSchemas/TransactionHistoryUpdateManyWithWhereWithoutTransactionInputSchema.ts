...
export const TransactionHistoryUpdateManyWithWhereWithoutTransactionInputSchema: z.ZodType<Prisma.TransactionHistoryUpdateManyWithWhereWithoutTransactionInput> =
    z
        .object({
            where: z.lazy(() => TransactionHistoryScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => TransactionHistoryUpdateManyMutationInputSchema),
                z.lazy(() => TransactionHistoryUncheckedUpdateManyWithoutTransactionInputSchema)
            ])
        })
        .strict()
