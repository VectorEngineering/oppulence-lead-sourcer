...
export const ProgramApplicationUpdateOneWithoutEnrollmentNestedInputSchema: z.ZodType<Prisma.ProgramApplicationUpdateOneWithoutEnrollmentNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => ProgramApplicationCreateWithoutEnrollmentInputSchema),
                    z.lazy(() => ProgramApplicationUncheckedCreateWithoutEnrollmentInputSchema)
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => ProgramApplicationUpdateToOneWithWhereWithoutEnrollmentInputSchema),
                    z.lazy(() => ProgramApplicationUpdateWithoutEnrollmentInputSchema),
                    z.lazy(() => ProgramApplicationUncheckedUpdateWithoutEnrollmentInputSchema)
                ])
                .optional()
        })
        .strict()
