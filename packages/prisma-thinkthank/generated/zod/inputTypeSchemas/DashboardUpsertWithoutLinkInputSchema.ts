...
export const DashboardUpsertWithoutLinkInputSchema: z.ZodType<Prisma.DashboardUpsertWithoutLinkInput> = z
    .object({
        update: z.union([
        ...
        create: z.union([
            z.lazy(() => DashboardCreateWithoutLinkInputSchema),
            z.lazy(() => DashboardUncheckedCreateWithoutLinkInputSchema)
        ]),
