...
export const BankConnectionSettingsUncheckedUpdateManyWithoutCreatorNestedInputSchema: z.ZodType<Prisma.BankConnectionSettingsUncheckedUpdateManyWithoutCreatorNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => BankConnectionSettingsCreateWithoutCreatorInputSchema),
                    z.lazy(() => BankConnectionSettingsCreateWithoutCreatorInputSchema).array(),
                    z.lazy(() => BankConnectionSettingsUncheckedCreateWithoutCreatorInputSchema),
                    z.lazy(() => BankConnectionSettingsUncheckedCreateWithoutCreatorInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => BankConnectionSettingsCreateOrConnectWithoutCreatorInputSchema),
                    z.lazy(() => BankConnectionSettingsCreateOrConnectWithoutCreatorInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => BankConnectionSettingsUpsertWithWhereUniqueWithoutCreatorInputSchema),
                    z.lazy(() => BankConnectionSettingsUpsertWithWhereUniqueWithoutCreatorInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => BankConnectionSettingsUpdateWithWhereUniqueWithoutCreatorInputSchema),
                    z.lazy(() => BankConnectionSettingsUpdateWithWhereUniqueWithoutCreatorInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => BankConnectionSettingsUpdateManyWithWhereWithoutCreatorInputSchema),
                    z.lazy(() => BankConnectionSettingsUpdateManyWithWhereWithoutCreatorInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
...
export default BankConnectionSettingsUncheckedUpdateManyWithoutCreatorNestedInputSchema
