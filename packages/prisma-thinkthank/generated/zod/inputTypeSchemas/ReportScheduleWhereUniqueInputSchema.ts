...
export const ReportScheduleWhereUniqueInputSchema: z.ZodType<Prisma.ReportScheduleWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => ReportScheduleWhereInputSchema), z.lazy(() => ReportScheduleWhereInputSchema).array()])
                    .optional(),
                OR: z
                    .lazy(() => ReportScheduleWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([z.lazy(() => ReportScheduleWhereInputSchema), z.lazy(() => ReportScheduleWhereInputSchema).array()])
