...
export const TransactionAttachmentScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.TransactionAttachmentScalarWhereWithAggregatesInput> =
    z
        .object({
            AND: z
                .union([
                    z.lazy(() => TransactionAttachmentScalarWhereWithAggregatesInputSchema),
                    z.lazy(() => TransactionAttachmentScalarWhereWithAggregatesInputSchema).array()
                ])
                .optional(),
            OR: z
                .lazy(() => TransactionAttachmentScalarWhereWithAggregatesInputSchema)
                .array()
                .optional(),
            NOT: z
                .union([
