...
export const DashboardUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.DashboardUncheckedUpdateManyWithoutProjectNestedInput> = z.object({
  create: z.union([ z.lazy(() => DashboardCreateWithoutProjectInputSchema),z.lazy(() => DashboardCreateWithoutProjectInputSchema).array(),z.lazy(() => DashboardUncheckedCreateWithoutProjectInputSchema),z.lazy(() => DashboardUncheckedCreateWithoutProjectInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => DashboardCreateOrConnectWithoutProjectInputSchema),z.lazy(() => DashboardCreateOrConnectWithoutProjectInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => DashboardUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => DashboardUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => DashboardUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => DashboardUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => DashboardUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => DashboardUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => DashboardScalarWhereInputSchema),z.lazy(() => DashboardScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default DashboardUncheckedUpdateManyWithoutProjectNestedInputSchema;
