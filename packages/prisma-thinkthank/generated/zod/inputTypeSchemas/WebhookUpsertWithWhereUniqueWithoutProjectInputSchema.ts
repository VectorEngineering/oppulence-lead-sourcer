...
export const WebhookUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.WebhookUpsertWithWhereUniqueWithoutProjectInput> = z
    .object({
        where: z.lazy(() => WebhookWhereUniqueInputSchema),
        update: z.union([
            z.lazy(() => WebhookUpdateWithoutProjectInputSchema),
            z.lazy(() => WebhookUncheckedUpdateWithoutProjectInputSchema)
        ]),
        create: z.union([
