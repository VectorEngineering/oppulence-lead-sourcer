...
import { InvoiceCommentUncheckedUpdateManyWithoutInvoiceNestedInputSchema } from './InvoiceCommentUncheckedUpdateManyWithoutInvoiceNestedInputSchema';
...
export const InvoiceUncheckedUpdateWithoutAttachmentsInputSchema: z.ZodType<Prisma.InvoiceUncheckedUpdateWithoutAttachmentsInput> = z.object({
  ...
  comments: z.lazy(() => InvoiceCommentUncheckedUpdateManyWithoutInvoiceNestedInputSchema).optional(),
  history: z.lazy(() => InvoiceHistoryUncheckedUpdateManyWithoutInvoiceNestedInputSchema).optional()
}).strict();

export default InvoiceUncheckedUpdateWithoutAttachmentsInputSchema;
