...
export const ProgramScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ProgramScalarWhereWithAggregatesInput> = z.object({
  ...
  wordmark: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  brandColor: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  ...
  commissionDuration: z.union([ z.lazy(() => IntNullableWithAggregatesFilterSchema),z.number() ]).optional().nullable(),
  commissionInterval: z.union([ z.lazy(() => EnumCommissionIntervalNullableWithAggregatesFilterSchema),z.lazy(() => CommissionIntervalSchema) ]).optional().nullable(),
