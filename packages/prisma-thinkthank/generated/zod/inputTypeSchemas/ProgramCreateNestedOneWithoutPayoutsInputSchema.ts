...
export const ProgramCreateNestedOneWithoutPayoutsInputSchema: z.ZodType<Prisma.ProgramCreateNestedOneWithoutPayoutsInput> = z
    .object({
        create: z
            .union([z.lazy(() => ProgramCreateWithoutPayoutsInputSchema), z.lazy(() => ProgramUncheckedCreateWithoutPayoutsInputSchema)])
            .optional(),
