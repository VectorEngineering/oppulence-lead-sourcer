...
export const OAuthCodeUpdateWithWhereUniqueWithoutOAuthAppInputSchema: z.ZodType<Prisma.OAuthCodeUpdateWithWhereUniqueWithoutOAuthAppInput> = z.object({
  where: z.lazy(() => OAuthCodeWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => OAuthCodeUpdateWithoutOAuthAppInputSchema),z.lazy(() => OAuthCodeUncheckedUpdateWithoutOAuthAppInputSchema) ]),
}).strict();
