...
export const IntegrationUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.IntegrationUpdateManyWithoutProjectNestedInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => IntegrationCreateWithoutProjectInputSchema),
                z.lazy(() => IntegrationCreateWithoutProjectInputSchema).array(),
                z.lazy(() => IntegrationUncheckedCreateWithoutProjectInputSchema),
                z.lazy(() => IntegrationUncheckedCreateWithoutProjectInputSchema).array()
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => IntegrationCreateOrConnectWithoutProjectInputSchema),
                z.lazy(() => IntegrationCreateOrConnectWithoutProjectInputSchema).array()
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => IntegrationUpsertWithWhereUniqueWithoutProjectInputSchema),
                z.lazy(() => IntegrationUpsertWithWhereUniqueWithoutProjectInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => IntegrationUpdateWithWhereUniqueWithoutProjectInputSchema),
                z.lazy(() => IntegrationUpdateWithWhereUniqueWithoutProjectInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => IntegrationUpdateManyWithWhereWithoutProjectInputSchema),
                z.lazy(() => IntegrationUpdateManyWithWhereWithoutProjectInputSchema).array()
            ])
            .optional(),
        deleteMany: z
            .union([z.lazy(() => IntegrationScalarWhereInputSchema), z.lazy(() => IntegrationScalarWhereInputSchema).array()])
            .optional()
    })
    .strict()

export default IntegrationUpdateManyWithoutProjectNestedInputSchema
