...
import { InboxUpdateOneRequiredWithoutSharesNestedInputSchema } from './InboxUpdateOneRequiredWithoutSharesNestedInputSchema';

export const InboxShareUpdateInputSchema: z.ZodType<Prisma.InboxShareUpdateInput> = z.object({
  ...
  inbox: z.lazy(() => InboxUpdateOneRequiredWithoutSharesNestedInputSchema).optional()
}).strict();

export default InboxShareUpdateInputSchema;
