...
export const DocumentAnnotationUncheckedCreateNestedManyWithoutDocumentInputSchema: z.ZodType<Prisma.DocumentAnnotationUncheckedCreateNestedManyWithoutDocumentInput> =
    z
        .object({
            create: z
                .union([
