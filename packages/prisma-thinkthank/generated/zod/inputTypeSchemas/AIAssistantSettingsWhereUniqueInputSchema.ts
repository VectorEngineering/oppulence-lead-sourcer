...
export const AIAssistantSettingsWhereUniqueInputSchema: z.ZodType<Prisma.AIAssistantSettingsWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    userId: z.string()
  }),
...
.and(z.object({
  ...
  maxQuestionsPerDay: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
