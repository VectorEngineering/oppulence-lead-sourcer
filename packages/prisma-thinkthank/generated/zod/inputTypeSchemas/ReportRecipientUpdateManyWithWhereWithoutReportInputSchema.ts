...
export const ReportRecipientUpdateManyWithWhereWithoutReportInputSchema: z.ZodType<Prisma.ReportRecipientUpdateManyWithWhereWithoutReportInput> =
    z
        .object({
            where: z.lazy(() => ReportRecipientScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => ReportRecipientUpdateManyMutationInputSchema),
                z.lazy(() => ReportRecipientUncheckedUpdateManyWithoutReportInputSchema)
            ])
        })
        .strict()
