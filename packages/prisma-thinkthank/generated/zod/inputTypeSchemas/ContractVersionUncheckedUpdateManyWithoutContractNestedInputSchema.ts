...
export const ContractVersionUncheckedUpdateManyWithoutContractNestedInputSchema: z.ZodType<Prisma.ContractVersionUncheckedUpdateManyWithoutContractNestedInput> =
    z
        .object({
            create: z
                .union([
