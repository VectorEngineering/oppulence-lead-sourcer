...
export const jackson_storeWhereUniqueInputSchema: z.ZodType<Prisma.jackson_storeWhereUniqueInput> = z.object({
  key: z.string()
})
.and(z.object({
  key: z.string().optional(),
  AND: z.union([ z.lazy(() => jackson_storeWhereInputSchema),z.lazy(() => jackson_storeWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => jackson_storeWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => jackson_storeWhereInputSchema),z.lazy(() => jackson_storeWhereInputSchema).array() ]).optional(),
  value: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  iv: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  modifiedAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
}).strict());
