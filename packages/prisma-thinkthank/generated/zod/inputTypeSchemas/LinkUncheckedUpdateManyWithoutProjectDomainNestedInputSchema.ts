...
export const LinkUncheckedUpdateManyWithoutProjectDomainNestedInputSchema: z.ZodType<Prisma.LinkUncheckedUpdateManyWithoutProjectDomainNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LinkUpsertWithWhereUniqueWithoutProjectDomainInputSchema),z.lazy(() => LinkUpsertWithWhereUniqueWithoutProjectDomainInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LinkUpdateWithWhereUniqueWithoutProjectDomainInputSchema),z.lazy(() => LinkUpdateWithWhereUniqueWithoutProjectDomainInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LinkUpdateManyWithWhereWithoutProjectDomainInputSchema),z.lazy(() => LinkUpdateManyWithWhereWithoutProjectDomainInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LinkScalarWhereInputSchema),z.lazy(() => LinkScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LinkUncheckedUpdateManyWithoutProjectDomainNestedInputSchema;
