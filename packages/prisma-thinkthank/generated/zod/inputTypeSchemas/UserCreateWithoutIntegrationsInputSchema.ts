...
export const UserCreateWithoutIntegrationsInputSchema: z.ZodType<Prisma.UserCreateWithoutIntegrationsInput> = z
    .object({
...
export default UserCreateWithoutIntegrationsInputSchema
