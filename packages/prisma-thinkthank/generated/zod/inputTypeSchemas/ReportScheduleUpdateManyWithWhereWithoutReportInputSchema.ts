...
export const ReportScheduleUpdateManyWithWhereWithoutReportInputSchema: z.ZodType<Prisma.ReportScheduleUpdateManyWithWhereWithoutReportInput> =
    z
        .object({
            where: z.lazy(() => ReportScheduleScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => ReportScheduleUpdateManyMutationInputSchema),
                z.lazy(() => ReportScheduleUncheckedUpdateManyWithoutReportInputSchema)
            ])
        })
        .strict()
