...
export const TransactionUpdateToOneWithWhereWithoutAttachmentsInputSchema: z.ZodType<Prisma.TransactionUpdateToOneWithWhereWithoutAttachmentsInput> = z.object({
  where: z.lazy(() => TransactionWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => TransactionUpdateWithoutAttachmentsInputSchema),z.lazy(() => TransactionUncheckedUpdateWithoutAttachmentsInputSchema) ]),
}).strict();
