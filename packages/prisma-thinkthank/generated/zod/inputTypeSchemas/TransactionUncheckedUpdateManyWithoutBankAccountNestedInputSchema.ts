...
export const TransactionUncheckedUpdateManyWithoutBankAccountNestedInputSchema: z.ZodType<Prisma.TransactionUncheckedUpdateManyWithoutBankAccountNestedInput> = z.object({
  create: z.union([ z.lazy(() => TransactionCreateWithoutBankAccountInputSchema),z.lazy(() => TransactionCreateWithoutBankAccountInputSchema).array(),z.lazy(() => TransactionUncheckedCreateWithoutBankAccountInputSchema),z.lazy(() => TransactionUncheckedCreateWithoutBankAccountInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => TransactionCreateOrConnectWithoutBankAccountInputSchema),z.lazy(() => TransactionCreateOrConnectWithoutBankAccountInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => TransactionUpsertWithWhereUniqueWithoutBankAccountInputSchema),z.lazy(() => TransactionUpsertWithWhereUniqueWithoutBankAccountInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => TransactionUpdateWithWhereUniqueWithoutBankAccountInputSchema),z.lazy(() => TransactionUpdateWithWhereUniqueWithoutBankAccountInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => TransactionUpdateManyWithWhereWithoutBankAccountInputSchema),z.lazy(() => TransactionUpdateManyWithWhereWithoutBankAccountInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => TransactionScalarWhereInputSchema),z.lazy(() => TransactionScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default TransactionUncheckedUpdateManyWithoutBankAccountNestedInputSchema;
