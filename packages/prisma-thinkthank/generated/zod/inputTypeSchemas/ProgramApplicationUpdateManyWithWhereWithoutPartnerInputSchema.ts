...
export const ProgramApplicationUpdateManyWithWhereWithoutPartnerInputSchema: z.ZodType<Prisma.ProgramApplicationUpdateManyWithWhereWithoutPartnerInput> =
    z
        .object({
            where: z.lazy(() => ProgramApplicationScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => ProgramApplicationUpdateManyMutationInputSchema),
                z.lazy(() => ProgramApplicationUncheckedUpdateManyWithoutPartnerInputSchema)
            ])
        })
        .strict()
