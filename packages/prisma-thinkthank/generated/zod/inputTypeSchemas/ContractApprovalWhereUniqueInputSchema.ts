...
export const ContractApprovalWhereUniqueInputSchema: z.ZodType<Prisma.ContractApprovalWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => ContractApprovalWhereInputSchema),z.lazy(() => ContractApprovalWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ContractApprovalWhereInputSchema).array().optional(),
