...
export const ProgramUpdateOneRequiredWithoutPartnersNestedInputSchema: z.ZodType<Prisma.ProgramUpdateOneRequiredWithoutPartnersNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProgramUpdateToOneWithWhereWithoutPartnersInputSchema),
