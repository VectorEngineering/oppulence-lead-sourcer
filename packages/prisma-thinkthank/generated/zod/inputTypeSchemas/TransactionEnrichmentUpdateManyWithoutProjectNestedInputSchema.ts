...
export const TransactionEnrichmentUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.TransactionEnrichmentUpdateManyWithoutProjectNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => TransactionEnrichmentUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => TransactionEnrichmentUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  createMany: z.lazy(() => TransactionEnrichmentCreateManyProjectInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => TransactionEnrichmentWhereUniqueInputSchema),z.lazy(() => TransactionEnrichmentWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => TransactionEnrichmentWhereUniqueInputSchema),z.lazy(() => TransactionEnrichmentWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => TransactionEnrichmentWhereUniqueInputSchema),z.lazy(() => TransactionEnrichmentWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => TransactionEnrichmentUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => TransactionEnrichmentUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => TransactionEnrichmentUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => TransactionEnrichmentUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => TransactionEnrichmentScalarWhereInputSchema),z.lazy(() => TransactionEnrichmentScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default TransactionEnrichmentUpdateManyWithoutProjectNestedInputSchema;
