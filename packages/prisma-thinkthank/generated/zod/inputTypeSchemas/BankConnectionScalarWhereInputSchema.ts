...
export const BankConnectionScalarWhereInputSchema: z.ZodType<Prisma.BankConnectionScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => BankConnectionScalarWhereInputSchema),z.lazy(() => BankConnectionScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => BankConnectionScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => BankConnectionScalarWhereInputSchema),z.lazy(() => BankConnectionScalarWhereInputSchema).array() ]).optional(),
