...
export const TagUpdateManyWithoutTransactionNestedInputSchema: z.ZodType<Prisma.TagUpdateManyWithoutTransactionNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => TagUpsertWithWhereUniqueWithoutTransactionInputSchema),z.lazy(() => TagUpsertWithWhereUniqueWithoutTransactionInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => TagUpdateWithWhereUniqueWithoutTransactionInputSchema),z.lazy(() => TagUpdateWithWhereUniqueWithoutTransactionInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => TagUpdateManyWithWhereWithoutTransactionInputSchema),z.lazy(() => TagUpdateManyWithWhereWithoutTransactionInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => TagScalarWhereInputSchema),z.lazy(() => TagScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default TagUpdateManyWithoutTransactionNestedInputSchema;
