...
import { InvoiceTemplateCountOrderByAggregateInputSchema } from './InvoiceTemplateCountOrderByAggregateInputSchema';
import { InvoiceTemplateAvgOrderByAggregateInputSchema } from './InvoiceTemplateAvgOrderByAggregateInputSchema';
import { InvoiceTemplateMaxOrderByAggregateInputSchema } from './InvoiceTemplateMaxOrderByAggregateInputSchema';
import { InvoiceTemplateMinOrderByAggregateInputSchema } from './InvoiceTemplateMinOrderByAggregateInputSchema';
import { InvoiceTemplateSumOrderByAggregateInputSchema } from './InvoiceTemplateSumOrderByAggregateInputSchema';

export const InvoiceTemplateOrderByWithAggregationInputSchema: z.ZodType<Prisma.InvoiceTemplateOrderByWithAggregationInput> = z.object({
  ...
  _count: z.lazy(() => InvoiceTemplateCountOrderByAggregateInputSchema).optional(),
  _avg: z.lazy(() => InvoiceTemplateAvgOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => InvoiceTemplateMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => InvoiceTemplateMinOrderByAggregateInputSchema).optional(),
  _sum: z.lazy(() => InvoiceTemplateSumOrderByAggregateInputSchema).optional()
}).strict();

export default InvoiceTemplateOrderByWithAggregationInputSchema;
