...
import { ProjectCreateNestedOneWithoutContractTemplateInputSchema } from './ProjectCreateNestedOneWithoutContractTemplateInputSchema';

export const ContractTemplateCreateInputSchema: z.ZodType<Prisma.ContractTemplateCreateInput> = z.object({
  ...
  project: z.lazy(() => ProjectCreateNestedOneWithoutContractTemplateInputSchema)
}).strict();

export default ContractTemplateCreateInputSchema;
