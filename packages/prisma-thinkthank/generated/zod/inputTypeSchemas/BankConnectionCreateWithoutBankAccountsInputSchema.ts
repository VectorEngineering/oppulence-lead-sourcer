...
import { BankConnectionSettingsCreateNestedOneWithoutBankConnectionInputSchema } from './BankConnectionSettingsCreateNestedOneWithoutBankConnectionInputSchema';
...
export const BankConnectionCreateWithoutBankAccountsInputSchema: z.ZodType<Prisma.BankConnectionCreateWithoutBankAccountsInput> = z.object({
  ...
  settings: z.lazy(() => BankConnectionSettingsCreateNestedOneWithoutBankConnectionInputSchema).optional(),
  project: z.lazy(() => ProjectCreateNestedOneWithoutBankConnectionsInputSchema)
}).strict();

export default BankConnectionCreateWithoutBankAccountsInputSchema;
