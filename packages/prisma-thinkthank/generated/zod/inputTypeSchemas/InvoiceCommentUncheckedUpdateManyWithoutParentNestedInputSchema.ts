...
export const InvoiceCommentUncheckedUpdateManyWithoutParentNestedInputSchema: z.ZodType<Prisma.InvoiceCommentUncheckedUpdateManyWithoutParentNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => InvoiceCommentUpsertWithWhereUniqueWithoutParentInputSchema),
                    z.lazy(() => InvoiceCommentUpsertWithWhereUniqueWithoutParentInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => InvoiceCommentUpdateWithWhereUniqueWithoutParentInputSchema),
                    z.lazy(() => InvoiceCommentUpdateWithWhereUniqueWithoutParentInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => InvoiceCommentUpdateManyWithWhereWithoutParentInputSchema),
                    z.lazy(() => InvoiceCommentUpdateManyWithWhereWithoutParentInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default InvoiceCommentUncheckedUpdateManyWithoutParentNestedInputSchema
