...
export const TransactionUpdateOneRequiredWithoutAttachmentsNestedInputSchema: z.ZodType<Prisma.TransactionUpdateOneRequiredWithoutAttachmentsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => TransactionUpdateToOneWithWhereWithoutAttachmentsInputSchema),z.lazy(() => TransactionUpdateWithoutAttachmentsInputSchema),z.lazy(() => TransactionUncheckedUpdateWithoutAttachmentsInputSchema) ]).optional(),
}).strict();
