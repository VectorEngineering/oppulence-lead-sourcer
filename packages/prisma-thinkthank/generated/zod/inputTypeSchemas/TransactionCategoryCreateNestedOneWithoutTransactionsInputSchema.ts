...
export const TransactionCategoryCreateNestedOneWithoutTransactionsInputSchema: z.ZodType<Prisma.TransactionCategoryCreateNestedOneWithoutTransactionsInput> =
    z
        .object({
            create: z
                .union([
