...
import { ProgramUpdateOneRequiredWithoutSalesNestedInputSchema } from './ProgramUpdateOneRequiredWithoutSalesNestedInputSchema';
import { PartnerUpdateOneRequiredWithoutSalesNestedInputSchema } from './PartnerUpdateOneRequiredWithoutSalesNestedInputSchema';
import { PayoutUpdateOneWithoutSalesNestedInputSchema } from './PayoutUpdateOneWithoutSalesNestedInputSchema';
import { CustomerUpdateOneRequiredWithoutSalesNestedInputSchema } from './CustomerUpdateOneRequiredWithoutSalesNestedInputSchema';
...
export const SaleUpdateInputSchema: z.ZodType<Prisma.SaleUpdateInput> = z.object({
  ...
  recurringInterval: z.union([ z.lazy(() => CommissionIntervalSchema),z.lazy(() => NullableEnumCommissionIntervalFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  recurringDuration: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  isLifetimeRecurring: z.union([ z.boolean(),z.lazy(() => NullableBoolFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  program: z.lazy(() => ProgramUpdateOneRequiredWithoutSalesNestedInputSchema).optional(),
  partner: z.lazy(() => PartnerUpdateOneRequiredWithoutSalesNestedInputSchema).optional(),
  payout: z.lazy(() => PayoutUpdateOneWithoutSalesNestedInputSchema).optional(),
  customer: z.lazy(() => CustomerUpdateOneRequiredWithoutSalesNestedInputSchema).optional()
}).strict();

export default SaleUpdateInputSchema;
