...
export const ReportRecipientUncheckedUpdateManyWithoutReportNestedInputSchema: z.ZodType<Prisma.ReportRecipientUncheckedUpdateManyWithoutReportNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => ReportRecipientUpsertWithWhereUniqueWithoutReportInputSchema),
                    z.lazy(() => ReportRecipientUpsertWithWhereUniqueWithoutReportInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => ReportRecipientUpdateWithWhereUniqueWithoutReportInputSchema),
                    z.lazy(() => ReportRecipientUpdateWithWhereUniqueWithoutReportInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => ReportRecipientUpdateManyWithWhereWithoutReportInputSchema),
                    z.lazy(() => ReportRecipientUpdateManyWithWhereWithoutReportInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default ReportRecipientUncheckedUpdateManyWithoutReportNestedInputSchema
