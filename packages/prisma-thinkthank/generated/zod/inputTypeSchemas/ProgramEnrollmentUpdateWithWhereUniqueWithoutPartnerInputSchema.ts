...
export const ProgramEnrollmentUpdateWithWhereUniqueWithoutPartnerInputSchema: z.ZodType<Prisma.ProgramEnrollmentUpdateWithWhereUniqueWithoutPartnerInput> = z.object({
  where: z.lazy(() => ProgramEnrollmentWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ProgramEnrollmentUpdateWithoutPartnerInputSchema),z.lazy(() => ProgramEnrollmentUncheckedUpdateWithoutPartnerInputSchema) ]),
}).strict();
