...
export const CustomerTagUncheckedUpdateManyWithoutTagNestedInputSchema: z.ZodType<Prisma.CustomerTagUncheckedUpdateManyWithoutTagNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => CustomerTagCreateWithoutTagInputSchema),
                    z.lazy(() => CustomerTagCreateWithoutTagInputSchema).array(),
                    z.lazy(() => CustomerTagUncheckedCreateWithoutTagInputSchema),
                    z.lazy(() => CustomerTagUncheckedCreateWithoutTagInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => CustomerTagCreateOrConnectWithoutTagInputSchema),
                    z.lazy(() => CustomerTagCreateOrConnectWithoutTagInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => CustomerTagUpsertWithWhereUniqueWithoutTagInputSchema),
                    z.lazy(() => CustomerTagUpsertWithWhereUniqueWithoutTagInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => CustomerTagUpdateWithWhereUniqueWithoutTagInputSchema),
                    z.lazy(() => CustomerTagUpdateWithWhereUniqueWithoutTagInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => CustomerTagUpdateManyWithWhereWithoutTagInputSchema),
                    z.lazy(() => CustomerTagUpdateManyWithWhereWithoutTagInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default CustomerTagUncheckedUpdateManyWithoutTagNestedInputSchema
