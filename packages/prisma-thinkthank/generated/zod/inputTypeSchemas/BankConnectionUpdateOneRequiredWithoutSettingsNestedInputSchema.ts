...
export const BankConnectionUpdateOneRequiredWithoutSettingsNestedInputSchema: z.ZodType<Prisma.BankConnectionUpdateOneRequiredWithoutSettingsNestedInput> = z.object({
  create: z.union([ z.lazy(() => BankConnectionCreateWithoutSettingsInputSchema),z.lazy(() => BankConnectionUncheckedCreateWithoutSettingsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => BankConnectionUpdateToOneWithWhereWithoutSettingsInputSchema),z.lazy(() => BankConnectionUpdateWithoutSettingsInputSchema),z.lazy(() => BankConnectionUncheckedUpdateWithoutSettingsInputSchema) ]).optional(),
}).strict();
