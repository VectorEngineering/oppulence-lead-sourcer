...
export const ContractCreateManyCustomerInputSchema: z.ZodType<Prisma.ContractCreateManyCustomerInput> = z
    .object({
...
export default ContractCreateManyCustomerInputSchema
