...
export const ProgramUpdateToOneWithWhereWithoutApplicationsInputSchema: z.ZodType<Prisma.ProgramUpdateToOneWithWhereWithoutApplicationsInput> = z.object({
  where: z.lazy(() => ProgramWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ProgramUpdateWithoutApplicationsInputSchema),z.lazy(() => ProgramUncheckedUpdateWithoutApplicationsInputSchema) ]),
}).strict();
