...
export const WebhookCreateNestedManyWithoutBankConnectionSettingsInputSchema: z.ZodType<Prisma.WebhookCreateNestedManyWithoutBankConnectionSettingsInput> =
    z
        .object({
            create: z
                .union([
