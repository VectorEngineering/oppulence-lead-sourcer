...
export const ProjectUpdateOneRequiredWithoutProgramsNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutProgramsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProjectCreateWithoutProgramsInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutProgramsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutProgramsInputSchema),z.lazy(() => ProjectUpdateWithoutProgramsInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutProgramsInputSchema) ]).optional(),
}).strict();
