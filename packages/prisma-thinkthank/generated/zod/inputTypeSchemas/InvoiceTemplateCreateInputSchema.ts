...
import { ProjectCreateNestedOneWithoutInvoiceTemplateInputSchema } from './ProjectCreateNestedOneWithoutInvoiceTemplateInputSchema';
import { InvoiceCreateNestedManyWithoutTemplateInputSchema } from './InvoiceCreateNestedManyWithoutTemplateInputSchema';

export const InvoiceTemplateCreateInputSchema: z.ZodType<Prisma.InvoiceTemplateCreateInput> = z.object({
  ...
  size: z.lazy(() => InvoiceSizeSchema).optional().nullable(),
  ...
  project: z.lazy(() => ProjectCreateNestedOneWithoutInvoiceTemplateInputSchema),
  Invoice: z.lazy(() => InvoiceCreateNestedManyWithoutTemplateInputSchema).optional()
}).strict();

export default InvoiceTemplateCreateInputSchema;
