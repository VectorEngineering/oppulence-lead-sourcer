...
export const CustomerTagUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.CustomerTagUpsertWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => CustomerTagWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => CustomerTagUpdateWithoutProjectInputSchema),z.lazy(() => CustomerTagUncheckedUpdateWithoutProjectInputSchema) ]),
  create: z.union([ z.lazy(() => CustomerTagCreateWithoutProjectInputSchema),z.lazy(() => CustomerTagUncheckedCreateWithoutProjectInputSchema) ]),
}).strict();
