...
export const WebhookUpsertWithWhereUniqueWithoutBankConnectionSettingsInputSchema: z.ZodType<Prisma.WebhookUpsertWithWhereUniqueWithoutBankConnectionSettingsInput> = z.object({
  where: z.lazy(() => WebhookWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => WebhookUpdateWithoutBankConnectionSettingsInputSchema),z.lazy(() => WebhookUncheckedUpdateWithoutBankConnectionSettingsInputSchema) ]),
  create: z.union([ z.lazy(() => WebhookCreateWithoutBankConnectionSettingsInputSchema),z.lazy(() => WebhookUncheckedCreateWithoutBankConnectionSettingsInputSchema) ]),
}).strict();
