...
export const TransactionHistoryUncheckedUpdateManyWithoutTransactionNestedInputSchema: z.ZodType<Prisma.TransactionHistoryUncheckedUpdateManyWithoutTransactionNestedInput> =
    z
        .object({
            create: z
                .union([
