...
export const NestedEnumAccountOwnershipTypeNullableWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumAccountOwnershipTypeNullableWithAggregatesFilter> =
    z
        .object({
            equals: z
            ...
            not: z
                .union([
                    ...
                    z.lazy(() => NestedEnumAccountOwnershipTypeNullableWithAggregatesFilterSchema)
                ])
                .optional()
                .nullable(),
