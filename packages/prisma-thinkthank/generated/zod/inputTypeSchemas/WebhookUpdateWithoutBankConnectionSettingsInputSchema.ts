...
import { LinkWebhookUpdateManyWithoutWebhookNestedInputSchema } from './LinkWebhookUpdateManyWithoutWebhookNestedInputSchema';
import { WebhookLogUpdateManyWithoutWebhookNestedInputSchema } from './WebhookLogUpdateManyWithoutWebhookNestedInputSchema';

export const WebhookUpdateWithoutBankConnectionSettingsInputSchema: z.ZodType<Prisma.WebhookUpdateWithoutBankConnectionSettingsInput> = z.object({
  ...
  links: z.lazy(() => LinkWebhookUpdateManyWithoutWebhookNestedInputSchema).optional(),
  logs: z.lazy(() => WebhookLogUpdateManyWithoutWebhookNestedInputSchema).optional()
}).strict();

export default WebhookUpdateWithoutBankConnectionSettingsInputSchema;
