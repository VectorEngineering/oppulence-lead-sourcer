...
export const CustomerUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.CustomerUncheckedUpdateManyWithoutProjectNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => CustomerCreateWithoutProjectInputSchema),
                    z.lazy(() => CustomerCreateWithoutProjectInputSchema).array(),
                    z.lazy(() => CustomerUncheckedCreateWithoutProjectInputSchema),
                    z.lazy(() => CustomerUncheckedCreateWithoutProjectInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => CustomerCreateOrConnectWithoutProjectInputSchema),
                    z.lazy(() => CustomerCreateOrConnectWithoutProjectInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => CustomerUpsertWithWhereUniqueWithoutProjectInputSchema),
                    z.lazy(() => CustomerUpsertWithWhereUniqueWithoutProjectInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => CustomerUpdateWithWhereUniqueWithoutProjectInputSchema),
                    z.lazy(() => CustomerUpdateWithWhereUniqueWithoutProjectInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => CustomerUpdateManyWithWhereWithoutProjectInputSchema),
                    z.lazy(() => CustomerUpdateManyWithWhereWithoutProjectInputSchema).array()
                ])
                .optional(),
            deleteMany: z
