...
export const DocumentAnnotationWhereUniqueInputSchema: z.ZodType<Prisma.DocumentAnnotationWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => DocumentAnnotationWhereInputSchema), z.lazy(() => DocumentAnnotationWhereInputSchema).array()])
                    .optional(),
                OR: z
                    .lazy(() => DocumentAnnotationWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([z.lazy(() => DocumentAnnotationWhereInputSchema), z.lazy(() => DocumentAnnotationWhereInputSchema).array()])
                ...
                createdBy: z
                    ...
                    .nullable(),
                document: z
                    .union([z.lazy(() => ContractDocumentRelationFilterSchema), z.lazy(() => ContractDocumentWhereInputSchema)])
                    .optional()
            })
            .strict()
    )
