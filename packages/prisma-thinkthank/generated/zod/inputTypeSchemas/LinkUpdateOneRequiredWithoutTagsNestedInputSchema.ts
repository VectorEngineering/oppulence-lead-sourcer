...
export const LinkUpdateOneRequiredWithoutTagsNestedInputSchema: z.ZodType<Prisma.LinkUpdateOneRequiredWithoutTagsNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => LinkCreateWithoutTagsInputSchema), z.lazy(() => LinkUncheckedCreateWithoutTagsInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LinkUpdateToOneWithWhereWithoutTagsInputSchema),
                z.lazy(() => LinkUpdateWithoutTagsInputSchema),
                z.lazy(() => LinkUncheckedUpdateWithoutTagsInputSchema)
            ])
            .optional()
    })
    .strict()
