...
export const BankConnectionSettingsUpdateManyWithWhereWithoutWebhooksInputSchema: z.ZodType<Prisma.BankConnectionSettingsUpdateManyWithWhereWithoutWebhooksInput> =
    z
        .object({
            where: z.lazy(() => BankConnectionSettingsScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => BankConnectionSettingsUpdateManyMutationInputSchema),
                z.lazy(() => BankConnectionSettingsUncheckedUpdateManyWithoutWebhooksInputSchema)
            ])
        })
        .strict()
