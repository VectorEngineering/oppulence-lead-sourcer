...
export const NestedEnumAccountSubTypeNullableWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumAccountSubTypeNullableWithAggregatesFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => AccountSubTypeSchema),z.lazy(() => NestedEnumAccountSubTypeNullableWithAggregatesFilterSchema) ]).optional().nullable(),
