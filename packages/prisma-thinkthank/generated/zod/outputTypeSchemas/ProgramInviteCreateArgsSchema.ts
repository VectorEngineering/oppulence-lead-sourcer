...
export const ProgramInviteCreateArgsSchema: z.ZodType<Prisma.ProgramInviteCreateArgs> = z.object({
  select: ProgramInviteSelectSchema.optional(),
  include: ProgramInviteIncludeSchema.optional(),
  data: z.union([ ProgramInviteCreateInputSchema,ProgramInviteUncheckedCreateInputSchema ]),
}).strict() ;

export default ProgramInviteCreateArgsSchema;
