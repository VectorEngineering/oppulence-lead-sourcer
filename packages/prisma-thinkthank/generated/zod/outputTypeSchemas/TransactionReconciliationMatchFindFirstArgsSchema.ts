...
export const TransactionReconciliationMatchFindFirstArgsSchema: z.ZodType<Prisma.TransactionReconciliationMatchFindFirstArgs> = z.object({
  ...
  orderBy: z.union([ TransactionReconciliationMatchOrderByWithRelationInputSchema.array(),TransactionReconciliationMatchOrderByWithRelationInputSchema ]).optional(),
  cursor: TransactionReconciliationMatchWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ TransactionReconciliationMatchScalarFieldEnumSchema,TransactionReconciliationMatchScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default TransactionReconciliationMatchFindFirstArgsSchema;
