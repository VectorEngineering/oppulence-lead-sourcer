...
export const RegisteredDomainGroupByArgsSchema: z.ZodType<Prisma.RegisteredDomainGroupByArgs> = z
    .object({
        where: RegisteredDomainWhereInputSchema.optional(),
        orderBy: z
            .union([RegisteredDomainOrderByWithAggregationInputSchema.array(), RegisteredDomainOrderByWithAggregationInputSchema])
            .optional(),
