...
import { TransactionCategoryUpdateInputSchema } from '../inputTypeSchemas/TransactionCategoryUpdateInputSchema'
import { TransactionCategoryUncheckedUpdateInputSchema } from '../inputTypeSchemas/TransactionCategoryUncheckedUpdateInputSchema'
import { ProjectArgsSchema } from './ProjectArgsSchema'
import { TransactionFindManyArgsSchema } from './TransactionFindManyArgsSchema'
import { TransactionCategoryArgsSchema } from './TransactionCategoryArgsSchema'
import { TransactionCategoryFindManyArgsSchema } from './TransactionCategoryFindManyArgsSchema'
import { TransactionCategoryCountOutputTypeArgsSchema } from './TransactionCategoryCountOutputTypeArgsSchema'
...
export const TransactionCategoryUpsertArgsSchema: z.ZodType<Prisma.TransactionCategoryUpsertArgs> = z
    .object({
        ...
        create: z.union([TransactionCategoryCreateInputSchema, TransactionCategoryUncheckedCreateInputSchema]),
        update: z.union([TransactionCategoryUpdateInputSchema, TransactionCategoryUncheckedUpdateInputSchema])
    })
    .strict()

export default TransactionCategoryUpsertArgsSchema
