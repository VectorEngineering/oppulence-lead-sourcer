...
export const jackson_indexGroupByArgsSchema: z.ZodType<Prisma.jackson_indexGroupByArgs> = z
    .object({
        where: jackson_indexWhereInputSchema.optional(),
        orderBy: z
            .union([jackson_indexOrderByWithAggregationInputSchema.array(), jackson_indexOrderByWithAggregationInputSchema])
            .optional(),
