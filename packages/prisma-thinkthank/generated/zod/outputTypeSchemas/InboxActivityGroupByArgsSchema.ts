...
export const InboxActivityGroupByArgsSchema: z.ZodType<Prisma.InboxActivityGroupByArgs> = z
    .object({
        where: InboxActivityWhereInputSchema.optional(),
        orderBy: z
            .union([InboxActivityOrderByWithAggregationInputSchema.array(), InboxActivityOrderByWithAggregationInputSchema])
            .optional(),
