...
export const BankConnectionSettingsGroupByArgsSchema: z.ZodType<Prisma.BankConnectionSettingsGroupByArgs> = z.object({
  where: BankConnectionSettingsWhereInputSchema.optional(),
  orderBy: z.union([ BankConnectionSettingsOrderByWithAggregationInputSchema.array(),BankConnectionSettingsOrderByWithAggregationInputSchema ]).optional(),
