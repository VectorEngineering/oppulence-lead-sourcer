...
export const LinkWebhookFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.LinkWebhookFindUniqueOrThrowArgs> = z.object({
  select: LinkWebhookSelectSchema.optional(),
  include: LinkWebhookIncludeSchema.optional(),
  where: LinkWebhookWhereUniqueInputSchema,
}).strict() ;

export default LinkWebhookFindUniqueOrThrowArgsSchema;
