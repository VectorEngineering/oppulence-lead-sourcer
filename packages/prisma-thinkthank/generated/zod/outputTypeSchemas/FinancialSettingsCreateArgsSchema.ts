...
export const FinancialSettingsCreateArgsSchema: z.ZodType<Prisma.FinancialSettingsCreateArgs> = z.object({
  select: FinancialSettingsSelectSchema.optional(),
  include: FinancialSettingsIncludeSchema.optional(),
  data: z.union([ FinancialSettingsCreateInputSchema,FinancialSettingsUncheckedCreateInputSchema ]),
}).strict() ;

export default FinancialSettingsCreateArgsSchema;
