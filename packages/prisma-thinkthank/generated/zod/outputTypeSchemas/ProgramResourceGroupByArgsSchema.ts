...
export const ProgramResourceGroupByArgsSchema: z.ZodType<Prisma.ProgramResourceGroupByArgs> = z.object({
  where: ProgramResourceWhereInputSchema.optional(),
  orderBy: z.union([ ProgramResourceOrderByWithAggregationInputSchema.array(),ProgramResourceOrderByWithAggregationInputSchema ]).optional(),
