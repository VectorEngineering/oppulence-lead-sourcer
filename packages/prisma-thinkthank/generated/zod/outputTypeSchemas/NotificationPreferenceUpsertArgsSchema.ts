...
import { NotificationPreferenceCreateInputSchema } from '../inputTypeSchemas/NotificationPreferenceCreateInputSchema'
import { NotificationPreferenceUncheckedCreateInputSchema } from '../inputTypeSchemas/NotificationPreferenceUncheckedCreateInputSchema'
import { NotificationPreferenceUpdateInputSchema } from '../inputTypeSchemas/NotificationPreferenceUpdateInputSchema'
import { NotificationPreferenceUncheckedUpdateInputSchema } from '../inputTypeSchemas/NotificationPreferenceUncheckedUpdateInputSchema'
import { ProjectUsersArgsSchema } from "../outputTypeSchemas/ProjectUsersArgsSchema"
// Select schema needs to be in file to prevent circular imports
//------------------------------------------------------

export const NotificationPreferenceSelectSchema: z.ZodType<Prisma.NotificationPreferenceSelect> = z.object({
...
export const NotificationPreferenceUpsertArgsSchema: z.ZodType<Prisma.NotificationPreferenceUpsertArgs> = z.object({
  ...
  create: z.union([ NotificationPreferenceCreateInputSchema,NotificationPreferenceUncheckedCreateInputSchema ]),
  update: z.union([ NotificationPreferenceUpdateInputSchema,NotificationPreferenceUncheckedUpdateInputSchema ]),
}).strict() ;

export default NotificationPreferenceUpsertArgsSchema;
