...
export const TransactionReconciliationMatchGroupByArgsSchema: z.ZodType<Prisma.TransactionReconciliationMatchGroupByArgs> = z
    .object({
        where: TransactionReconciliationMatchWhereInputSchema.optional(),
        orderBy: z
            .union([
                TransactionReconciliationMatchOrderByWithAggregationInputSchema.array(),
                TransactionReconciliationMatchOrderByWithAggregationInputSchema
            ])
            .optional(),
