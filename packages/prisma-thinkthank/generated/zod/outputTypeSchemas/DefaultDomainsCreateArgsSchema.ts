...
export const DefaultDomainsCreateArgsSchema: z.ZodType<Prisma.DefaultDomainsCreateArgs> = z.object({
  select: DefaultDomainsSelectSchema.optional(),
  include: DefaultDomainsIncludeSchema.optional(),
  data: z.union([ DefaultDomainsCreateInputSchema,DefaultDomainsUncheckedCreateInputSchema ]),
}).strict() ;

export default DefaultDomainsCreateArgsSchema;
