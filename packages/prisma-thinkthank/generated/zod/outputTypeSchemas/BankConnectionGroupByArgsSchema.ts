...
export const BankConnectionGroupByArgsSchema: z.ZodType<Prisma.BankConnectionGroupByArgs> = z.object({
  where: BankConnectionWhereInputSchema.optional(),
  orderBy: z.union([ BankConnectionOrderByWithAggregationInputSchema.array(),BankConnectionOrderByWithAggregationInputSchema ]).optional(),
