...
export const BankConnectionUpdateArgsSchema: z.ZodType<Prisma.BankConnectionUpdateArgs> = z.object({
  select: BankConnectionSelectSchema.optional(),
  include: BankConnectionIncludeSchema.optional(),
  data: z.union([ BankConnectionUpdateInputSchema,BankConnectionUncheckedUpdateInputSchema ]),
  where: BankConnectionWhereUniqueInputSchema,
}).strict() ;

export default BankConnectionUpdateArgsSchema;
