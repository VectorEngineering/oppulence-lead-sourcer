...
export const DocumentAnnotationGroupByArgsSchema: z.ZodType<Prisma.DocumentAnnotationGroupByArgs> = z
    .object({
        where: DocumentAnnotationWhereInputSchema.optional(),
        orderBy: z
            .union([DocumentAnnotationOrderByWithAggregationInputSchema.array(), DocumentAnnotationOrderByWithAggregationInputSchema])
            .optional(),
