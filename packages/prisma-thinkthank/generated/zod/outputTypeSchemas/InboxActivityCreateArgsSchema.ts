...
export const InboxActivityCreateArgsSchema: z.ZodType<Prisma.InboxActivityCreateArgs> = z.object({
  select: InboxActivitySelectSchema.optional(),
  include: InboxActivityIncludeSchema.optional(),
  data: z.union([ InboxActivityCreateInputSchema,InboxActivityUncheckedCreateInputSchema ]),
}).strict() ;

export default InboxActivityCreateArgsSchema;
