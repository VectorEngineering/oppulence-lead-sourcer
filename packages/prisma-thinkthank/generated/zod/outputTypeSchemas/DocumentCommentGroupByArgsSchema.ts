...
export const DocumentCommentGroupByArgsSchema: z.ZodType<Prisma.DocumentCommentGroupByArgs> = z.object({
  where: DocumentCommentWhereInputSchema.optional(),
  orderBy: z.union([ DocumentCommentOrderByWithAggregationInputSchema.array(),DocumentCommentOrderByWithAggregationInputSchema ]).optional(),
