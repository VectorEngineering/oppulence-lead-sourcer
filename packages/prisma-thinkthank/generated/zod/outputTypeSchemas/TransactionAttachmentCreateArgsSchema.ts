...
export const TransactionAttachmentSelectSchema: z.ZodType<Prisma.TransactionAttachmentSelect> = z.object({
...
export const TransactionAttachmentCreateArgsSchema: z.ZodType<Prisma.TransactionAttachmentCreateArgs> = z.object({
  select: TransactionAttachmentSelectSchema.optional(),
  include: TransactionAttachmentIncludeSchema.optional(),
  data: z.union([ TransactionAttachmentCreateInputSchema,TransactionAttachmentUncheckedCreateInputSchema ]),
}).strict() ;

export default TransactionAttachmentCreateArgsSchema;
