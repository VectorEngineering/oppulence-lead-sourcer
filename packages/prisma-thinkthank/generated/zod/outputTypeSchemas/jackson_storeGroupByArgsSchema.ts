...
export const jackson_storeGroupByArgsSchema: z.ZodType<Prisma.jackson_storeGroupByArgs> = z
    .object({
        where: jackson_storeWhereInputSchema.optional(),
        orderBy: z
            .union([jackson_storeOrderByWithAggregationInputSchema.array(), jackson_storeOrderByWithAggregationInputSchema])
            .optional(),
