...
export const ReportRecipientGroupByArgsSchema: z.ZodType<Prisma.ReportRecipientGroupByArgs> = z.object({
  where: ReportRecipientWhereInputSchema.optional(),
  orderBy: z.union([ ReportRecipientOrderByWithAggregationInputSchema.array(),ReportRecipientOrderByWithAggregationInputSchema ]).optional(),
