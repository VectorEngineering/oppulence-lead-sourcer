...
export const ReportSortingUpsertArgsSchema: z.ZodType<Prisma.ReportSortingUpsertArgs> = z.object({
  ...
  create: z.union([ ReportSortingCreateInputSchema,ReportSortingUncheckedCreateInputSchema ]),
  update: z.union([ ReportSortingUpdateInputSchema,ReportSortingUncheckedUpdateInputSchema ]),
}).strict() ;

export default ReportSortingUpsertArgsSchema;
