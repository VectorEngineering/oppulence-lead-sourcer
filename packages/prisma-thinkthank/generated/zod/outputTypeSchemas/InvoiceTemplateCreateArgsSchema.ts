...
export const InvoiceTemplateCreateArgsSchema: z.ZodType<Prisma.InvoiceTemplateCreateArgs> = z
    .object({
        select: InvoiceTemplateSelectSchema.optional(),
        include: InvoiceTemplateIncludeSchema.optional(),
        data: z.union([InvoiceTemplateCreateInputSchema, InvoiceTemplateUncheckedCreateInputSchema])
    })
    .strict()

export default InvoiceTemplateCreateArgsSchema
