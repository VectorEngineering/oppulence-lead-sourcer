...
export const ReportSortingGroupByArgsSchema: z.ZodType<Prisma.ReportSortingGroupByArgs> = z
    .object({
        where: ReportSortingWhereInputSchema.optional(),
        orderBy: z
            .union([ReportSortingOrderByWithAggregationInputSchema.array(), ReportSortingOrderByWithAggregationInputSchema])
            .optional(),
