...
import { BankConnectionSettingsUpdateInputSchema } from '../inputTypeSchemas/BankConnectionSettingsUpdateInputSchema'
import { BankConnectionSettingsUncheckedUpdateInputSchema } from '../inputTypeSchemas/BankConnectionSettingsUncheckedUpdateInputSchema'
...
export const BankConnectionSettingsUpsertArgsSchema: z.ZodType<Prisma.BankConnectionSettingsUpsertArgs> = z.object({
  ...
  create: z.union([ BankConnectionSettingsCreateInputSchema,BankConnectionSettingsUncheckedCreateInputSchema ]),
  update: z.union([ BankConnectionSettingsUpdateInputSchema,BankConnectionSettingsUncheckedUpdateInputSchema ]),
}).strict() ;

export default BankConnectionSettingsUpsertArgsSchema;
