...
import { DefaultDomainsCreateInputSchema } from '../inputTypeSchemas/DefaultDomainsCreateInputSchema'
import { DefaultDomainsUncheckedCreateInputSchema } from '../inputTypeSchemas/DefaultDomainsUncheckedCreateInputSchema'
...
export const DefaultDomainsSelectSchema: z.ZodType<Prisma.DefaultDomainsSelect> = z.object({
...
export const DefaultDomainsUpsertArgsSchema: z.ZodType<Prisma.DefaultDomainsUpsertArgs> = z.object({
  ...
  create: z.union([ DefaultDomainsCreateInputSchema,DefaultDomainsUncheckedCreateInputSchema ]),
  update: z.union([ DefaultDomainsUpdateInputSchema,DefaultDomainsUncheckedUpdateInputSchema ]),
}).strict() ;

export default DefaultDomainsUpsertArgsSchema;
