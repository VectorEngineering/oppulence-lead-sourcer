...
import { Banner, Button, Link, SignInView, Spinner } from '@stripe/ui-extension-sdk/ui'
import { useEffect, useRef, useState } from 'react'
import { getOAuthUrl, getToken, getUserInfo, getValidToken } from '../utils/oauth'
...
const AppSettings = ({ userContext, oauthContext }: ExtensionContextValue) => {
    ...
    const disconnectWorkspace = async ({ workspace }: { workspace: Workspace }) => {
        ...
        <SignInView
            ...
            footerContent={
                <>
                    ...
                    <Link href={`${platform.platformUrl}/register`} target='_blank' external>
                        Sign up
                    </Link>
                </>
            }
