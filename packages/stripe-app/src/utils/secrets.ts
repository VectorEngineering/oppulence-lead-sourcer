...
export async function setSecret({ stripe, name, payload }: { stripe: Stripe; name: SecretName; payload: string }) {
...
export async function getSecret<T>({ stripe, name }: { stripe: Stripe; name: SecretName }) {
    try {
...
export async function deleteSecret({ stripe, name }: { stripe: Stripe; name: SecretName }) {
