...
export const WorkspaceUpdateOneRequiredWithoutWorkspaceInvitationsNestedInputSchema: z.ZodType<Prisma.WorkspaceUpdateOneRequiredWithoutWorkspaceInvitationsNestedInput> = z.object({
  create: z.union([ z.lazy(() => WorkspaceCreateWithoutWorkspaceInvitationsInputSchema),z.lazy(() => WorkspaceUncheckedCreateWithoutWorkspaceInvitationsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => WorkspaceUpdateToOneWithWhereWithoutWorkspaceInvitationsInputSchema),z.lazy(() => WorkspaceUpdateWithoutWorkspaceInvitationsInputSchema),z.lazy(() => WorkspaceUncheckedUpdateWithoutWorkspaceInvitationsInputSchema) ]).optional(),
}).strict();
