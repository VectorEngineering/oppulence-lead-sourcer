...
export const UserUpdateOneRequiredWithoutEndpointsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutEndpointsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutEndpointsInputSchema),z.lazy(() => UserUpdateWithoutEndpointsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutEndpointsInputSchema) ]).optional(),
}).strict();
