...
export const WorkspaceUpdateToOneWithWhereWithoutWorkspaceInvitationsInputSchema: z.ZodType<Prisma.WorkspaceUpdateToOneWithWhereWithoutWorkspaceInvitationsInput> = z.object({
  where: z.lazy(() => WorkspaceWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => WorkspaceUpdateWithoutWorkspaceInvitationsInputSchema),z.lazy(() => WorkspaceUncheckedUpdateWithoutWorkspaceInvitationsInputSchema) ]),
}).strict();
