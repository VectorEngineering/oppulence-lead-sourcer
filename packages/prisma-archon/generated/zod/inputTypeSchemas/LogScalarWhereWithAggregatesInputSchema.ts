...
export const LogScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LogScalarWhereWithAggregatesInput> = z.object({
  ...
  type: z.union([ z.lazy(() => EnumLogTypeNullableWithAggregatesFilterSchema),z.lazy(() => LogTypeSchema) ]).optional().nullable(),
  postType: z.union([ z.lazy(() => EnumLogPostTypeNullableWithAggregatesFilterSchema),z.lazy(() => LogPostTypeSchema) ]).optional().nullable(),
