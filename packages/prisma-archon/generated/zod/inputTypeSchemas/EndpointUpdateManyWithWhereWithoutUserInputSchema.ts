...
export const EndpointUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.EndpointUpdateManyWithWhereWithoutUserInput> = z.object({
  where: z.lazy(() => EndpointScalarWhereInputSchema),
  data: z.union([ z.lazy(() => EndpointUpdateManyMutationInputSchema),z.lazy(() => EndpointUncheckedUpdateManyWithoutUserInputSchema) ]),
}).strict();
