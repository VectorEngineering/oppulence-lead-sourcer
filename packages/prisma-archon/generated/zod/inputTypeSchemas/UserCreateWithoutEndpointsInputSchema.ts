...
export const UserCreateWithoutEndpointsInputSchema: z.ZodType<Prisma.UserCreateWithoutEndpointsInput> = z.object({
  id: z.string(),
  email: z.string(),
...
export default UserCreateWithoutEndpointsInputSchema;
