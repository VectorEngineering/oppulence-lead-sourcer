...
export const WorkspaceMemberUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.WorkspaceMemberUncheckedCreateNestedManyWithoutUserInput> =
    z
        .object({
            create: z
                .union([
...
export default WorkspaceMemberUncheckedCreateNestedManyWithoutUserInputSchema
