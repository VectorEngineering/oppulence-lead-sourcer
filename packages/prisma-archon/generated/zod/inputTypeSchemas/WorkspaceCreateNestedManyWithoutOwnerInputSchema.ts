...
export const WorkspaceCreateNestedManyWithoutOwnerInputSchema: z.ZodType<Prisma.WorkspaceCreateNestedManyWithoutOwnerInput> = z
    .object({
        create: z
            .union([
...
export default WorkspaceCreateNestedManyWithoutOwnerInputSchema
