...
export const EndpointUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.EndpointUncheckedUpdateManyWithoutUserNestedInput> = z.object({
  create: z.union([ z.lazy(() => EndpointCreateWithoutUserInputSchema),z.lazy(() => EndpointCreateWithoutUserInputSchema).array(),z.lazy(() => EndpointUncheckedCreateWithoutUserInputSchema),z.lazy(() => EndpointUncheckedCreateWithoutUserInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => EndpointCreateOrConnectWithoutUserInputSchema),z.lazy(() => EndpointCreateOrConnectWithoutUserInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => EndpointUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => EndpointUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  ...
  disconnect: z.union([ z.lazy(() => EndpointWhereUniqueInputSchema),z.lazy(() => EndpointWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => EndpointUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => EndpointUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => EndpointUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => EndpointUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => EndpointScalarWhereInputSchema),z.lazy(() => EndpointScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default EndpointUncheckedUpdateManyWithoutUserNestedInputSchema;
