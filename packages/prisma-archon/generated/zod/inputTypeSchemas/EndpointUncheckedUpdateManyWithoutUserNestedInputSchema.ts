...
export const EndpointUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.EndpointUncheckedUpdateManyWithoutUserNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            updateMany: z
                ...
                .optional(),
            deleteMany: z
                .union([z.lazy(() => EndpointScalarWhereInputSchema), z.lazy(() => EndpointScalarWhereInputSchema).array()])
                .optional()
        })
        .strict()
