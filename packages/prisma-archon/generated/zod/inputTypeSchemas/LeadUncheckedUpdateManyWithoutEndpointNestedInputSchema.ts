...
export const LeadUncheckedUpdateManyWithoutEndpointNestedInputSchema: z.ZodType<Prisma.LeadUncheckedUpdateManyWithoutEndpointNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCreateWithoutEndpointInputSchema),z.lazy(() => LeadCreateWithoutEndpointInputSchema).array(),z.lazy(() => LeadUncheckedCreateWithoutEndpointInputSchema),z.lazy(() => LeadUncheckedCreateWithoutEndpointInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LeadCreateOrConnectWithoutEndpointInputSchema),z.lazy(() => LeadCreateOrConnectWithoutEndpointInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LeadUpsertWithWhereUniqueWithoutEndpointInputSchema),z.lazy(() => LeadUpsertWithWhereUniqueWithoutEndpointInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateWithWhereUniqueWithoutEndpointInputSchema),z.lazy(() => LeadUpdateWithWhereUniqueWithoutEndpointInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadUpdateManyWithWhereWithoutEndpointInputSchema),z.lazy(() => LeadUpdateManyWithWhereWithoutEndpointInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadScalarWhereInputSchema),z.lazy(() => LeadScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadUncheckedUpdateManyWithoutEndpointNestedInputSchema;
