...
export const EndpointUpdateArgsSchema: z.ZodType<Prisma.EndpointUpdateArgs> = z.object({
  select: EndpointSelectSchema.optional(),
  include: EndpointIncludeSchema.optional(),
  data: z.union([ EndpointUpdateInputSchema,EndpointUncheckedUpdateInputSchema ]),
  where: EndpointWhereUniqueInputSchema,
}).strict() ;

export default EndpointUpdateArgsSchema;
