...
export const WorkspaceInvitationGroupByArgsSchema: z.ZodType<Prisma.WorkspaceInvitationGroupByArgs> = z
    .object({
        where: WorkspaceInvitationWhereInputSchema.optional(),
        orderBy: z
            .union([WorkspaceInvitationOrderByWithAggregationInputSchema.array(), WorkspaceInvitationOrderByWithAggregationInputSchema])
            .optional(),
