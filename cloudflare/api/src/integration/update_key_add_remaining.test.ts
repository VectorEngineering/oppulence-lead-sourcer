...
import type { V1KeysUpdateRemainingRequest, V1KeysUpdateRemainingResponse } from '@/routes/v1_keys_updateRemaining'
...
describe('some', () => {
    test("update a key's remaining limit", async (t) => {
        ...
        const updateKeyResponse = await h.post<V1KeysUpdateRemainingRequest, V1KeysUpdateRemainingResponse>({
