...
import { type RateLimiter, RatelimitError, type RatelimitRequest, type RatelimitResponse } from './interface'
export class AgentRatelimiter implements RateLimiter {
    ...
    public async limit(c: Context, req: RatelimitRequest): Promise<Result<RatelimitResponse, RatelimitError>> {
     ...
     * Do not use
     */
    public async multiLimit(c: Context, req: Array<RatelimitRequest>): Promise<Result<RatelimitResponse, RatelimitError>> {
    ...
    private async _limit(c: Context, req: RatelimitRequest): Promise<Result<RatelimitResponse, RatelimitError>> {
