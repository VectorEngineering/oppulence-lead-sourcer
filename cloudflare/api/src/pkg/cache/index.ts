import { type Cache as C, Namespace, createCache } from '@playbookmedia/cache'
import { withMetrics } from '@playbookmedia/cache/middleware'
import { CloudflareStore, MemoryStore, type Store } from '@playbookmedia/cache/stores'
...
export function initCache(c: Context<HonoEnv>, metrics: Metrics): C<CacheNamespaces> {
    ...
    return createCache({
        ...
        verificationsByKeyId: new Namespace<CacheNamespaces['verificationsByKeyId']>(c.executionCtx, defaultOpts),
        ratelimitByIdentifier: new Namespace<CacheNamespaces['ratelimitByIdentifier']>(c.executionCtx, defaultOpts),
        keysByApiId: new Namespace<CacheNamespaces['keysByApiId']>(c.executionCtx, defaultOpts),
        identityByExternalId: new Namespace<CacheNamespaces['identityByExternalId']>(c.executionCtx, defaultOpts),
        auditLogBucketByWorkspaceIdAndName: new Namespace<CacheNamespaces['auditLogBucketByWorkspaceIdAndName']>(
            c.executionCtx,
            defaultOpts
        )
    })
