...
import type { V1IdentitiesDeleteIdentityRequest, V1IdentitiesDeleteIdentityResponse } from './v1_identities_deleteIdentity'
...
describe('correct permissions', () => {
    describe.each([
        ...
        test('returns 200', async (t) => {
            ...
            const root = await h.createRootKey(permissions.map((p) => (typeof p === 'string' ? p : p(identityId))))
