...
import { type Ratelimit, eq, schema } from '@playbookmedia/db'
...
export type V1IdentitiesUpdateIdentityRequest = z.infer<(typeof route.request.body.content)['application/json']['schema']>
export type V1IdentitiesUpdateIdentityResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
