...
import { and, eq, isNull, sql } from '@playbookmedia/db'
...
export type V1ApisDeleteKeysRequest = z.infer<(typeof route.request.body.content)['application/json']['schema']>
export type V1ApisDeleteKeysResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
