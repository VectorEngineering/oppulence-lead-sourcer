...
export type V1PermissionsCreatePermissionRequest = z.infer<(typeof route.request.body.content)['application/json']['schema']>
export type V1PermissionsCreatePermissionResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
