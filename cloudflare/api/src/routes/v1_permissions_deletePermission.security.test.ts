...
import type { V1PermissionsDeletePermissionRequest, V1PermissionsDeletePermissionResponse } from './v1_permissions_deletePermission'
...
describe('correct roles', () => {
    describe.each([
        ...
        test('returns 200', async (t) => {
            ...
            const res = await h.post<V1PermissionsDeletePermissionRequest, V1PermissionsDeletePermissionResponse>({
                url: '/v1/permissions.deletePermission',
                headers: {
                    'Content-Type': 'application/json',
