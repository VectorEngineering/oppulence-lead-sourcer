...
export type LegacyApisListKeysResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
...
export const registerLegacyApisListKeys = (app: App) =>
    app.openapi(route, async (c) => {
        ...
        const keysWhere: Parameters<typeof and> = [isNull(schema.keys.deletedAt), eq(schema.keys.keyAuthId, api.keyAuthId)]
        if (ownerId) {
