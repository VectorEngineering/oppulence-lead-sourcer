...
import type { V1RatelimitSetOverrideRequest, V1RatelimitSetOverrideResponse } from './v1_ratelimits_setOverride'
...
describe('correct roles', () => {
    describe.each([{ name: 'set override', roles: ['ratelimit.*.set_override'] }])('$name', ({ roles }) => {
