...
import { and, eq, gt, isNull, schema, sql } from '@playbookmedia/db'
...
export type V1RatelimitListOverridesResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
