...
describe('correct permissions', () => {
    describe.each([
        ...
        },
        {
            ...
            permissions: ['identity.*.read_identity', (envId: string) => `identity.${envId}.read_identity`]
        },
        ...
        test('returns 200', async (t) => {
            ...
            const root = await h.createRootKey(permissions.map((p) => (typeof p === 'string' ? p : p('default'))))
