...
import type { V1RatelimitGetOverrideRequest, V1RatelimitGetOverrideResponse } from './v1_ratelimits_getOverride'
...
describe('correct roles', () => {
    describe.each([{ name: 'get override', roles: ['ratelimit.*.read_override'] }])('$name', ({ roles }) => {
