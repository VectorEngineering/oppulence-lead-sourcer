...
import type { V1RatelimitListOverridesRequest, V1RatelimitListOverridesResponse } from './v1_ratelimits_listOverrides'
...
describe('correct roles', () => {
    describe.each([{ name: 'list override', roles: ['ratelimit.*.read_override'] }])('$name', ({ roles }) => {
