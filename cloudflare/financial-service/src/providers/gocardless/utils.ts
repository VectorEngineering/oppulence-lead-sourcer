...
export function getMaxHistoricalDays({ transactionTotalDays, institutionId }: GetMaxHistoricalDays) {
...
export function getAccessValidForDays({ institutionId }: GetAccessValidForDays) {
    const RESTRICTED_TO_90DAYS = [
        'CUMBERLAND_CMBSGB2A',
