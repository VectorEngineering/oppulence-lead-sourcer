import { transformAccount, transformAccountBalance, transformTransaction } from '@/providers/gocardless/transform'
...
test('Transform income transaction', () => {
    expect(
        transformTransaction(
            {
                transactionId: '8wwecA0PsWWCLPLazQzht2oOcxSIQ5UlWPHaNBpC3tjYtc002faJcjWzRpyO4sjz66kRpb7_5rA',
