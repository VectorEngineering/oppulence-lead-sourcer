...
export const transformTransaction = (transaction: TransformTransaction, accountId: string): BaseTransaction => {
...
export const transformAccount = ({ id, account, balance, institution }: TransformAccount): BaseAccount => {
    return {
        id,
        type: 'depository',
