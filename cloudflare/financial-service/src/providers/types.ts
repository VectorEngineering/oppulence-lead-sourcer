...
export type RecurringTransactionFrequency = 'weekly' | 'bi-weekly' | 'monthly' | 'yearly' | 'semi-monthly' | 'unknown'
...
export type RecurringTransactionStatus = 'mature' | 'early_detection' | 'tombstoned' | 'unknown'
