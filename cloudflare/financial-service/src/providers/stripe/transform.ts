...
import type { Account as BaseAccount, Balance as BaseBalance, Transaction as BaseTransaction, Institution } from '../types'
import type { StripeTransformAccountPayload, StripeTransformTransactionPayload } from './types'
import {
    formatStripeAmount,
 ...
 */
export const transformTransaction = ({ transaction, accountId }: StripeTransformTransactionPayload): BaseTransaction => ({
    id: transaction.id,
