 ...
 */
export type V1GoCardLessAgreementApiRequest = z.infer<(typeof route.request.body)['content']['application/json']['schema']>

/**
 * Type representing the response for the GoCardLess Agreement API.
 */
export type V1GoCardLessAgreementApiResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
