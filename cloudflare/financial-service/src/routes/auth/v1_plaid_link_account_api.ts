 ...
 */
export type V1ApisPlaidLinkApiRequest = z.infer<(typeof route.request.body)['content']['application/json']['schema']>
 ...
 */
export type V1ApisPlaidLinkApiResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
