 ...
 */
export type V1GoCardLessLinkApiRequest = z.infer<(typeof route.request.body)['content']['application/json']['schema']>

/**
 * Type representing the response for the GoCardLess Link API.
 */
export type V1GoCardLessLinkApiResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
