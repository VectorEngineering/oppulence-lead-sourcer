 ...
 */
export type V1GoCardLessExchangeApiRequest = z.infer<(typeof route.request.body)['content']['application/json']['schema']>

/**
 * Type representing the response for the GoCardLess Exchange API.
 */
export type V1GoCardLessExchangeApiResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
