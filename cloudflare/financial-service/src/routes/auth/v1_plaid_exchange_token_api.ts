...
export type V1ApisPlaidExchangeTokenApiRequest = z.infer<(typeof route.request.body)['content']['application/json']['schema']>
export type V1ApisPlaidExchangeTokenApiResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
