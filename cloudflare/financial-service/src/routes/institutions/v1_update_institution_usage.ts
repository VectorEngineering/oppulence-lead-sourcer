...
export type V1UpdateInstitutionApiRequest = z.infer<typeof route.request.params>
export type V1UpdateInstitutionApiResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
...
export const registerUpdateInstitutionUsageRoute = (app: App) => {
    app.openapi(route, async (c) => {
        ...
        try {
            ...
            const originalData: Document = typeof original === 'string' && JSON.parse(original)
