...
import { type V1CreateUserRequest, type V1CreateUserResponse } from './v1_create_user'
import { V1UpdateUserRequest, V1UpdateUserResponse, V1UpdateUserResponse400, V1UpdateUserResponse404 } from './v1_update_user'
...
describe('V1 Update User Route', () => {
    ...
    describe('PUT /v1/users/:id - Concurrency Handling', () => {
        test('should handle concurrent updates correctly', async () => {
            ...
            expect(updates.some((update) => update.name === finalResponse.body.name && update.email === finalResponse.body.email)).toBe(
                true
            )
        })
    })
