...
export type V1UpdateUserRequest = z.infer<typeof updateUserRoute.request.params> &
    z.infer<(typeof updateUserRoute.request.body.content)['application/json']['schema']>
export type V1UpdateUserResponse = z.infer<(typeof updateUserRoute.responses)[200]['content']['application/json']['schema']>
export type V1UpdateUserResponse401 = z.infer<(typeof updateUserRoute.responses)[401]['content']['application/json']['schema']>
export type V1UpdateUserResponse404 = z.infer<(typeof updateUserRoute.responses)[404]['content']['application/json']['schema']>
export type V1UpdateUserResponse400 = z.infer<(typeof updateUserRoute.responses)[400]['content']['application/json']['schema']>
