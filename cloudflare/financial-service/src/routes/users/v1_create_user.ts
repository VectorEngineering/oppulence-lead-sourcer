import { BadRequestError, ConflictError, openApiErrorResponses as ErrorResponses } from '@/errors'
...
export type V1CreateUserResponse400 = z.infer<(typeof createUserRoute.responses)[400]['content']['application/json']['schema']>

export type V1CreateUserResponse409 = z.infer<(typeof createUserRoute.responses)[409]['content']['application/json']['schema']>
