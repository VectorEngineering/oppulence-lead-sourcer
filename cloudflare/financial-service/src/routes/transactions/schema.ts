...
export const TransactionSchema = z
    .object({
        ...
        personal_finance_category_confidence_level: z.string().nullable().optional().openapi({
            example: 'HIGH'
        }),
 ...
 */
const RecurringTransactionFrequencySchema = z.enum(['weekly', 'bi-weekly', 'monthly', 'yearly', 'semi-monthly', 'unknown']).openapi({
    example: 'monthly'
})
 ...
 */
const RecurringTransactionStatusSchema = z.enum(['mature', 'early_detection', 'tombstoned', 'unknown']).openapi({
    example: 'mature'
})
