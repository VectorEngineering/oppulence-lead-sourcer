...
export type V1ApisDeleteAccountsApiRequest = z.infer<typeof route.request.query>
export type V1ApisDeleteAccountsApiResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
