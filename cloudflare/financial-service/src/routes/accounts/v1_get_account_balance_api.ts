...
export type V1ApisGetAccountsBalanceRequest = z.infer<typeof route.request.query>
export type V1ApisGetAccountsBalanceResponse = z.infer<(typeof route.responses)[200]['content']['application/json']['schema']>
