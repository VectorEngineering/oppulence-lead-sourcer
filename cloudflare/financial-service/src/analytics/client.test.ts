...
describe('Analytics', () => {
    ...
    describe('insertSdkTelemetry', () => {
        it('should log SDK telemetry events', async () => {
            ...
            expect(consoleMock.info).toHaveBeenCalledWith(expect.stringContaining('Inserting SDK telemetry'))
        })
        ...
        it('should handle different platform values', async () => {
            ...
            for (const platform of platforms) {
                ...
                expect(consoleMock.info).toHaveBeenLastCalledWith(expect.stringContaining(platform))
            }
        })
        ...
        it('should handle array of versions', async () => {
            ...
            expect(consoleMock.info).toHaveBeenCalledWith(expect.stringContaining('1.0.0'))
        })
    })
    ...
    describe('insertApiRequest', () => {
        it('should log API request events with sensitive data removed', async () => {
            ...
            expect(consoleMock.info).toHaveBeenCalledWith(expect.stringContaining('Inserting API request'))
        })
        ...
        it('should handle different HTTP methods', async () => {
            ...
            for (const method of methods) {
                ...
                expect(consoleMock.info).toHaveBeenLastCalledWith(expect.stringContaining(method))
            }
        })
        ...
        it('should handle different response status codes', async () => {
            ...
            for (const status of statusCodes) {
                ...
                expect(consoleMock.info).toHaveBeenLastCalledWith(expect.stringContaining(status.toString()))
            }
        })
        ...
        it('should handle API errors', async () => {
            ...
            expect(consoleMock.info).toHaveBeenCalledWith(expect.stringContaining('Test error message'))
        })
        ...
        it('should handle request headers', async () => {
            ...
            expect(consoleMock.info).toHaveBeenCalledWith(expect.stringContaining('Content-Type'))
            expect(consoleMock.info).toHaveBeenCalledWith(expect.stringContaining('Authorization'))
        })
        ...
        it('should handle various service latencies', async () => {
            ...
            for (const latency of latencies) {
                ...
                expect(consoleMock.info).toHaveBeenLastCalledWith(expect.stringContaining(latency.toString()))
            }
        })
