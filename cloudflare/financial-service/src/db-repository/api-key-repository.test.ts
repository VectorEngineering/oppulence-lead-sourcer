...
import { TestContext, cleanupTestContext, setupTestContext } from '@/test-util/test-context'
...
describe('APIKeyRepository Integration Tests', () => {
    ...
    describe('Relationship Tests', () => {
        it('should not create API key for non-existent user', async () => {
            ...
            await expect(repository.create(input)).rejects.toThrow(/FOREIGN KEY constraint failed/)
        })
    })
    ...
    describe('Transaction Tests', () => {
        it('should rollback all operations on error', async () => {
            ...
            try {
                await db.executeTransaction(async (_) => {
