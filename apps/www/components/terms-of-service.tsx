          ...
          <div className="mx-auto max-w-3xl text-left text-gray-800 md:pb-16">
            ...
            <div className="space-y-4">
              ...
              <p>
                ...
                with Oppulence in effect, then such master subscription
              ...
              <ol className="list-decimal space-y-4 pl-8">
                <li>
                  <strong className="text-gray-900">
                    Oppulence Service Overview
                  </strong>
                  . Our Oppulence platform offers a suite of financial tools
                  ...
                  <ol className="list-decimal space-y-4 pl-8">
                    <li>
                      <p>
                        ...
                        Playbook Media reserves the right to determine pricing
                        for the Service. Oppulence will make reasonable efforts
                        to keep pricing information published on the Service up
                        to date. We encourage you to check our pricing page
                        periodically for current pricing information. Oppulence
                        may change the fees for any feature of the Service,
                        including additional fees or charges, if Oppulence gives
                        you advance notice of changes before they apply through
                        the Service user interface, a pop-up notice, email, or
                        through other reasonable means. Your continued use of
                        the Service after the price change becomes effective
                        constitutes your agreement to pay the changed amount.
                        You will be responsible for all taxes associated with
                        the Service, other than taxes based on Oppulence’s net
                        income. Oppulence, at its sole discretion, may make
                        promotional offers with different features and different
                        pricing to any of Oppulence’s customers. These
                    ...
                    <li>
                      <p>
                        ...
                        . Notwithstanding any amounts owed to Oppulence
                        ...
                        Please contact Stripe for more information. Oppulence
                    ...
                    <li>
                      <p>
                        ...
                        then you authorize Oppulence or its third-party payment
                        ...
                        Oppulence or its third-party payment processor will bill
                    ...
                    <li>
                      <p>
                        ...
                        . Oppulence may suspend or terminate access to the
                        ...
                        Subscription Fee is due, then Oppulence reserves the
                  ...
                  <ol className="list-decimal space-y-4 pl-8">
                    <li>
                      <p>
                        ...
                        you and Oppulence had previously executed an Order Form.
                      </p>
                    </li>
                    ...
                    <li>
                      <p>
                        ...
                        automatically terminate. In addition, Oppulence may, at
                    ...
                    <li>
                      <p>
                        ...
                        Oppulence any unpaid amount that was due prior to
                        ...
                        Warranties by Oppulence), 14 (Limitation of Liability),
                    ...
                    <li>
                      <p>
                        ...
                        . Oppulence reserves the right to modify or discontinue
                        ...
                        you. Oppulence will have no liability for any change to
                ...
                <li>
                  <p>
                    ...
                    Oppulence, its affiliates and their respective shareholders,
                  ...
                  <ol className="list-decimal space-y-4 pl-8">
                    ...
                    <li>
                      <p>
                        ...
                        Oppulence does not disclaim any warranty or other right
                        that Oppulence is prohibited from disclaiming under
                        applicable law.
                      </p>
                    </li>
                  </ol>
                  ...
                  <ol className="list-decimal space-y-4 pl-8">
                    <li>
                      <p>
                        ...
                        have arisen or may arise between you and Oppulence,
                        ...
                        that, by entering into these Terms, you and Oppulence
                    ...
                    <li>
                      <p>
                        ...
                        . Oppulence is always interested in resolving disputes
                    ...
                    <li className="space-y-4">
                      ...
                      <p>
                        Unless Oppulence and you agree otherwise, any
                        ...
                        AAA. If your claim is for $10,000 or less, Oppulence
                    ...
                    <li className="space-y-4">
                      <p>
                        ...
                        either Oppulence or you under the AAA Rules, Oppulence
                    ...
                    <li>
                      <p>
                        ...
                        contrary, Oppulence agrees that if it makes any future
                        ...
                        Oppulence written notice within thirty (30) calendar
                  ...
                  <ol className="list-decimal space-y-4 pl-8">
                    <li>
                      <p>
                        ...
                        understanding and agreement between you and Oppulence
                    ...
                    <li>
                      <p>
                        ...
                        Oppulence submit to the personal and exclusive
                    ...
                    <li>
                      <p>
                        ...
                        of your personal information. The Oppulence Privacy
                    ...
                    <li>
                      <p>
                        ...
                        . The Service is offered by Oppulence, Inc., located at
