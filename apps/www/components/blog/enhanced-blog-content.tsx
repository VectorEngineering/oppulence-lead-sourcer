...
export default function EnhancedBlogContent({ initialPosts }: EnhancedBlogContentProps) {
    // Local state for UI
                ...
                <div className="md:hidden">
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant="outline" className="w-full justify-between border-2 py-6 rounded-xl">
                        ...
                        <TabsList className="flex h-auto w-full flex-wrap justify-center gap-2 bg-transparent p-0">
                            {allTags.map((tag) => (
                                <TabsTrigger
                                    key={tag}
                                    value={tag}
                                    className="capitalize data-[state=active]:bg-primary data-[state=active]:text-primary-foreground rounded-full border-2 px-4 py-2"
                                >
                                    {tag}
                                    <Badge variant="secondary" className="ml-2">
                                        {tagCounts[tag] || 0}
                    ...
                    >
                        ...
                        <div className="mb-16">
                            <div className="mb-8 flex items-center justify-between">
                                ...
                                <Skeleton className="h-px flex-1 ml-8" />
                            </div>
