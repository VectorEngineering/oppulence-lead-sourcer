          ...
          <div className="mx-auto max-w-3xl pb-12 text-left text-gray-800 md:pb-16">
            ...
            <div className="text-base font-normal">
              <p>
                ...
                and users of the Oppulence desktop app and websites
                (collectively, “Oppulence”, “App” or “services”), which are
                offered by Oppulence Inc. and/or any of its affiliates
            ...
            <div className="space-y-4 text-base font-normal">
              <p>
                If you are a customer of Oppulence, this Privacy Policy does not
            ...
            <div className="space-y-4 text-base font-normal">
              <p>
                ...
                creating an account on the App. In each case, Oppulence collects
                such personal information only insofar as is necessary or
                appropriate to fulfill the purpose of your interaction with or
                your request to Oppulence. We will not disclose your personal
                information other than as described in this Privacy Policy.
              </p>
              <p>
                Like most website operators, Oppulence automatically collects
            ...
            <h2 className="mb-7 mt-14 text-3xl font-medium text-gray-900">
              Information Oppulence does not collect
            </h2>
            <div className="space-y-4 text-base font-normal">
              <p>
                Oppulence does not intentionally collect sensitive or special
              ...
              <p>
                Oppulence does not knowingly collect information from or direct
            ...
            <div className="thin-bullets space-y-4 text-base font-normal">
              ...
              <p>
                ...
                Oppulence About Your Privacy&apos; section of this Privacy
                Policy.
              </p>
            </div>

            <h2 className="mb-7 mt-14 text-3xl font-medium text-gray-900">
              How Oppulence uses and protects your personal information
            </h2>
            <div className="thin-bullets space-y-4 text-base font-normal">
              <p>
              ...
              <p>
                Oppulence may sell, transfer or otherwise share some or all of
              ...
              <p>
                ...
                Oppulence engages a number of service providers or partners to
              ...
              <p>
                ...
                other than to perform the services as instructed by Oppulence.
              </p>
              <p>
              ...
              <p>
                Oppulence takes measures reasonably necessary to protect your
            ...
            <div className="space-y-4 text-base font-normal">
              ...
              <p>
                ...
                &apos;Contacting Oppulence About Your Privacy&apos; section of
                this Privacy Policy.
              </p>
            </div>

            <h2 className="mb-7 mt-14 text-3xl font-medium text-gray-900">
              Oppulence communications with you
            </h2>
            <div className="space-y-4 text-base font-normal">
              <p>
                If you are a registered user of the services and have supplied
                your email address, Oppulence may occasionally send you an email
                to tell you about security, system information, new features,
                solicit your feedback, or just keep you up to date with
                what&apos;s going on with Oppulence and our products. We
            ...
            <div className="thin-bullets space-y-4 text-base font-normal">
              ...
              <p>
                ...
                given below in the &apos;Contacting Oppulence About Your
            ...
            <div className="space-y-4 text-base font-normal">
              ...
              <p>
                Oppulence will retain your information for as long as your
                ...
                the details in the &apos;Contacting Oppulence About Your
                Privacy&apos; section of this Privacy Policy.
              </p>
              <p>
            ...
            <h2 className="mb-7 mt-14 text-3xl font-medium text-gray-900">
              Contacting Oppulence About Your Privacy
            </h2>
            <div className="space-y-4 text-base font-normal">
              <p>
                The relevant data controller for any personal information
                processed in connection with our services is Oppulence Inc.
              </p>
              <p>
            ...
            <div className="space-y-4 text-base font-normal">
              <p>
                Oppulence may change its privacy policy from time to time, and
                in Oppulence&apos;s sole discretion.
              </p>
              <p>
