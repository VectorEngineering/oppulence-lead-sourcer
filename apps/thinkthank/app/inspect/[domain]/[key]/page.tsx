import { Background, Footer, LinkPreview, LinkPreviewPlaceholder, Nav, NavMobile } from '@dub/ui'
            ...
            <main className='flex min-h-screen flex-col justify-between'>
                ...
                <div className='z-10 mx-2 my-10 flex max-w-md flex-col space-y-5 px-2.5 text-center sm:mx-auto sm:max-w-lg sm:px-0 lg:mb-16'>
                    ...
                    <h2 className='text-lg text-gray-600 sm:text-xl'>
                        Inspect a short link on {platform.company} to make sure it&apos;s safe to click on. If you think this link is
