...
export default function LinkInspectorCard({ domain, _key, url }: { domain: string; _key: string; url: string }) {
    const key = _key
            ...
            <div className='flex items-center space-x-3'>
                ...
                <div>
                    <div className='flex items-center space-x-1 sm:space-x-2'>
                        <a className='font-semibold text-blue-800' href={linkConstructor({ domain, key })} target='_blank' rel='noreferrer'>
