...
import { TAB_ITEM_ANIMATION_SETTINGS, currencyFormatter, fetcher, formatDate, formatDateTime } from '@dub/utils'
...
export function EmbedSales({ salesCount }: { salesCount: number }) {
    ...
    const { data: sales, isLoading } = useSWR<PartnerSaleResponse[]>(`/api/embed/sales?page=${pagination.pageIndex}`, fetcher, {
