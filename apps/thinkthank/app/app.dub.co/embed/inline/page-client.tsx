...
import type { Link, PayoutStatus, Program } from '@dub/prisma-thinkthank/client'
import { Button, Check, Copy, Logo, MoneyBill2, ToggleGroup, useCopyToClipboard } from '@dub/ui'
...
export function EmbedInlinePageClient({
    ...
    return (
        <div className='flex min-h-screen flex-col' style={{ '--accent-color': program.brandColor || '#a8a8a8' } as CSSProperties}>
            <div className='p-5'>
                <div className='relative flex flex-col overflow-hidden rounded-lg border border-neutral-300 p-4 md:p-6'>
                    ...
                    <div className='relative mt-16 text-lg text-neutral-900 sm:max-w-[50%]'>
                        <ProgramCommissionDescription program={program} discount={discount} />
                    </div>
                ...
                <div className='mt-4 grid gap-2 sm:h-32 sm:grid-cols-3'>
                    <EmbedActivity clicks={link.clicks} leads={link.leads} sales={link.sales} />
