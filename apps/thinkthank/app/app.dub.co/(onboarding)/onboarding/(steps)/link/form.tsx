        ...
        <>
                    ...
                    if (!res.ok) {
                        ...
                        if (error) {
                            if (error.message.includes('Upgrade to')) {
                                toast.custom(() => (
                                    <UpgradeRequiredToast title={`You've discovered a ${nextPlan.name} feature!`} message={error.message} />
                                ))
                            } else {
            ...
            >
                ...
                <div className='flex flex-col gap-2'>
                    <span className='block text-sm font-medium text-gray-700'>Link Preview</span>
                    <div className='relative aspect-[1.91/1] w-full overflow-hidden rounded-md border border-gray-300 bg-gray-100'>
                        {previewImage ? (
                            <img src={previewImage} alt='Preview' className='relative size-full rounded-[inherit] object-cover' />
                        ) : (
                ...
                <Button type='submit' text='Create link' loading={isSubmitting || isSubmitSuccessful} />
            </form>
