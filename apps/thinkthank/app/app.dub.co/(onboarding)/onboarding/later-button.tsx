...
export function LaterButton({ next, className, children }: PropsWithChildren<{ next: OnboardingStep | 'finish'; className?: string }>) {
    ...
    return (
        ...
        >
            <LoadingSpinner className={cn('size-3 transition-opacity', !(isLoading || isSuccessful) && 'opacity-0')} />
