...
export const UpdatePassword = () => {
    ...
    return (
        <form className='rounded-lg border border-gray-200 bg-white' onSubmit={onSubmit}>
            <div>
                <div className='flex flex-col gap-3 border-b border-gray-200 p-5 sm:p-10'>
                    <h2 className='text-xl font-medium'>Password</h2>
                    <p className='pb-2 text-sm text-gray-500'>Manage your account password on {platform.company}.</p>
                </div>
            ...
            <div className='flex items-center justify-between space-x-4 rounded-b-lg border-t border-gray-200 bg-gray-50 p-3 sm:px-10'>
                ...
                <div className='shrink-0'>
                    <Button text='Update Password' loading={isSubmitting} disabled={!isDirty} type='submit' />
                </div>
            </div>
        </form>
    )
