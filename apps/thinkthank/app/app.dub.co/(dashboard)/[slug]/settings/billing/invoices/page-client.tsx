...
import { Button, InvoiceDollar, Receipt2, StatusBadge, TabSelect, buttonVariants, useRouterStuff } from '@dub/ui'
...
export default function WorkspaceInvoicesClient() {
    ...
    const { data: invoices } = useSWR<InvoiceProps[]>(`/api/workspaces/${slug}/billing/invoices?type=${invoiceType}`, fetcher)
