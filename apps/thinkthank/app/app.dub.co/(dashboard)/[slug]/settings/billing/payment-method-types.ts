    ...
    [
        {
            ...
            title: 'Card',
            icon: CreditCard,
            description: paymentMethod?.card ? `Connected ${paymentMethod.card.brand} ***${paymentMethod.card.last4}` : 'No card connected'
        },
        {
        ...
        },
        {
            ...
            description: paymentMethod?.link ? `Connected Link account ${paymentMethod.link?.email}` : 'No Link account connected'
        }
    ] satisfies {
