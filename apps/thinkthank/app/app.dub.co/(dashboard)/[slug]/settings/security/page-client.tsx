...
const SAMLSection = () => {
    ...
    const data = useMemo(() => {
        if (loading) {
            ...
            return {
                logo: <img src={SAML_PROVIDERS.find((p) => p.name === provider)!.logo} alt={provider + ' logo'} className='h-8 w-8' />,
                title: `${provider} SAML`,
                ...
                <div className='relative flex flex-col space-y-6 p-5 sm:p-10'>
                    <div className='flex flex-col space-y-3'>
                        ...
                        <p className='text-sm text-gray-500'>
                            Set up SAML Single Sign-On (SSO) to allow your team to sign in to {platform.company} with your identity
                            provider.
                        </p>
                    </div>
                    ...
                    <div className='mt-2 flex items-center justify-between rounded-md border border-gray-200 px-4 py-3'>
                        <div className='flex items-center space-x-4'>
                            {data.logo || <div className='h-8 w-8 animate-pulse rounded-full bg-gray-100' />}
                                ...
                                <Popover
                                    content={
                                        <div className='grid w-full gap-1 p-2 sm:w-48'>
                                            ...
                                            >
                                                <IconMenu text='Remove' icon={<ShieldOff className='h-4 w-4' />} />
                                            </Button>
                                        </div>
                                    }
                                    align='end'
...
const SCIMSection = () => {
    ...
    const data = useMemo(() => {
        if (loading) {
            ...
            return {
                logo: <img src={SAML_PROVIDERS.find((p) => p.scim === provider)!.logo} alt={`${provider} logo`} className='h-8 w-8' />,
            ...
            <div className='rounded-lg border border-gray-200 bg-white'>
                <div className='relative flex flex-col space-y-6 p-5 sm:p-10'>
                    <div className='flex flex-col space-y-3'>
                        ...
                        <p className='text-sm text-gray-500'>Automatically provision and deprovision users from your identity provider.</p>
                    </div>
                                ...
                                <Popover
                                    content={
                                        <div className='grid w-full gap-1 p-2 sm:w-48'>
                                            ...
                                            >
                                                <IconMenu text='View configuration' icon={<FolderSync className='h-4 w-4' />} />
                                            </Button>
                                            <Button
                                                onClick={() => {
