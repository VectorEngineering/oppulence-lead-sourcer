...
export default async function IntegrationPage({ params }: { params: { slug: string; integrationSlug: string } }) {
    ...
    const credentials = installed ? integration.installations[0]?.credentials : undefined

    const webhookId = installed ? integration.installations[0]?.webhook?.id : undefined
