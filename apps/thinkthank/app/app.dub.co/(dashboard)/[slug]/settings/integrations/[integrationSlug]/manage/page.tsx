...
export default async function IntegrationManagePage({ params }: { params: { slug: string; integrationSlug: string } }) {
    ...
    return (
        <MaxWidthWrapper className='grid max-w-screen-lg gap-8'>
            <Link href={`/${params.slug}/settings/integrations`} className='flex items-center gap-x-1'>
                <ChevronLeft className='size-4' />
                <p className='text-sm font-medium text-gray-500'>Back to integrations</p>
            </Link>
