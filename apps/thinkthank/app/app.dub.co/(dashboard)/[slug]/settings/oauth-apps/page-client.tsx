...
export default function OAuthAppsPageClient() {
    ...
    const { data: oAuthApps, isLoading } = useSWR<OAuthAppProps[]>(`/api/oauth/apps?workspaceId=${workspaceId}`, fetcher)
        ...
        <div className='grid gap-5'>
            <div className='flex flex-wrap justify-between gap-6'>
                <div className='flex items-center gap-x-2'>
                    <h1 className='text-2xl font-semibold tracking-tight text-black'>OAuth Applications</h1>
                    <InfoTooltip
                        content={
                            <TooltipContent
