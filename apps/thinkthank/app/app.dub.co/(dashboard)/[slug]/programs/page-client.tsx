                ...
                >
                    <div className='scrollbar-hide flex size-full grow flex-col overflow-y-auto rounded-lg bg-white'>
                        <div className='flex items-center justify-between border-b border-neutral-200 px-8 py-5'>
                            <Drawer.Title className='text-xl font-medium text-zinc-900'>Create program</Drawer.Title>
        ...
        <div className='flex flex-col'>
            <div className='flex-1 space-y-8'>
                <div className='flex flex-col gap-4'>
                    <h3 className='text-base font-semibold leading-[17.60px] text-neutral-900'>Summary</h3>
                ...
                <div className='flex flex-col gap-4'>
                    <div className='flex flex-col gap-1.5'>
                        <h3 className='text-base font-semibold leading-[17.60px] text-neutral-900'>Commission</h3>
                        <p className='text-sm font-normal leading-[21px] text-neutral-600'>Set how the partner will get rewarded</p>
                    </div>
                        ...
                        <div className='flex w-full gap-3'>
                            {commissionTypes.map(({ value, description, label }) => (
                                ...
                                >
                                    ...
                                    />
                                    <span className='mb-1 text-sm font-semibold leading-none text-neutral-900'>{label}</span>
                                    <span className='text-sm font-normal leading-none text-neutral-900'>{description}</span>
                                </label>
                            ))}
                        </div>
            ...
            <div className="relative mt-2 rounded-md shadow-sm">
              ...
              >
                ...
                <div className='flex flex-col gap-4'>
                    <div className='flex flex-col gap-1.5'>
                        <h3 className='text-base font-semibold leading-[17.60px] text-neutral-900'>Payout</h3>
                        <p className='text-sm font-normal leading-[21px] text-neutral-600'>Set how much the partner will get rewarded</p>
                    </div>
                    ...
                    <p className='space-y-4'>
                        ...
                        <div>
                            <label htmlFor='duration' className='text-sm font-medium text-neutral-800'>
                                Amount
                            </label>
                            <div className='relative mt-2 rounded-md shadow-sm'>
                                <input
                        ...
                        <div>
                            ...
                            <p className='mt-2 text-sm text-neutral-500'>Minimum payout is $100</p>
                        </div>
                    </p>
                </div>
            </div>
