...
import { AnimatedSizeContainer, Button, Filter, Icon, Popover, StatusBadge, Table, usePagination, useRouterStuff, useTable } from '@dub/ui'
...
export function PayoutTable() {
    ...
    const { filters, activeFilters, onSelect, onRemove, onRemoveAll, isFiltered, setSearch, setSelectedFilter } = usePayoutFilters({
        sortBy,
        sortOrder
    })
    ...
    const [detailsSheetState, setDetailsSheetState] = useState<
        { open: false; payout: PayoutResponse | null } | { open: true; payout: PayoutResponse }
    ...
    const table = useTable({
        ...
        columns: [
            ...
            // Menu
            {
                ...
                size: 43,
                maxSize: 43,
                cell: ({ row }) => (row.original.type === 'sales' ? <RowMenuButton row={row} /> : '')
            }
        ],
        pagination,
