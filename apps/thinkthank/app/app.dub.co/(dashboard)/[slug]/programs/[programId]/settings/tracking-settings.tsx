...
function TrackingSettingsForm({ program }: { program: ProgramProps }) {
    ...
    const { activeWorkspaceDomains: domains, loading: loadingDomains } = useDomains()
            ...
            <div className='divide-y divide-neutral-200 px-6'>
                <SettingsRow heading='Default Referral Link'>
                    <div className='flex flex-col gap-6'>
                        <div>
                            ...
                            <div className='relative mt-2 rounded-md shadow-sm'>
                                ...
                                >
                                    ...
                                    {domains?.map((domain) => (
                                        <option value={domain.slug} key={domain.slug} selected={domain.slug === program.domain}>
                                            {domain.slug}
                                        </option>
                                    ))}
                                </select>
                        ...
                        <div>
                            <label htmlFor='url' className='text-sm font-medium text-neutral-800'>
                                Destination URL
                            </label>
                ...
                <SettingsRow heading='Link structure'>
                            ...
                            return (
                                <label
                                    ...
                                    className={cn(
                                        ...
                                        linkStructure.comingSoon ? 'cursor-default opacity-80' : 'hover:bg-neutral-50',
                                ...
                                >
                                    ...
                                    <div className='flex grow flex-col text-sm'>
                                        ...
                                        <span className='text-neutral-600'>{linkStructure.example}</span>
                                    </div>
                    ...
                    <div className='mt-6'>
                        <label>
                            <span className='text-sm font-medium text-neutral-800'>Cookie length</span>
                            <div className='relative mt-2 rounded-md shadow-sm'>
                                <select
                                    className='block w-full rounded-md border-neutral-300 text-neutral-900 focus:border-neutral-500 focus:outline-none focus:ring-neutral-500 sm:text-sm'
                        ...
                        <p className='mt-2 text-xs text-neutral-400'>Days your cookie will remain active and track referrals</p>
                    </div>

                    <div className='mt-6'>
                        <span className='text-sm font-medium text-neutral-800'>Installation</span>
