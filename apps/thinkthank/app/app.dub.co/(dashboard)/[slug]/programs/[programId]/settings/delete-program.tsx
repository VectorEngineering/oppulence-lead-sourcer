        ...
        <div className='rounded-lg border border-gray-200 bg-white'>
            <div className='flex flex-col gap-1 p-8'>
                ...
                <p className='text-sm font-normal text-neutral-600'>
                    Permanently delete your partner program, and all of your data. This action cannot be undone - please proceed with
                    caution.
                </p>
            </div>
                    ...
                    <Button
                        ...
                        disabledTooltip={
                            <div className='px-3 py-2 text-sm text-neutral-600'>
                                <a className='underline' href={`mailto:${platform.email.from.default}?subject=Delete my program`}>
                                    Contact us
                                </a>{' '}
