...
type FormData = Pick<ProgramProps, 'commissionAmount' | 'commissionType' | 'commissionDuration' | 'commissionInterval'>
...
function ProgramSettingsForm({ program }: { program: ProgramProps }) {
    ...
    const form = useForm<FormData>({
        ...
        defaultValues: {
            ...program,
            commissionAmount: program.commissionType === 'flat' ? program.commissionAmount / 100 : program.commissionAmount
        }
    })
    ...
    const [commissionAmount, commissionType, commissionDuration, commissionInterval] = watch([
        'commissionAmount',
        'commissionType',
        'commissionDuration',
        'commissionInterval'
        ...
        <>
            ...
            <form
                ...
                onSubmit={handleSubmit(async (data) => {
                    await executeAsync({
                        ...
                        ...data,
                        commissionAmount: data.commissionType === 'flat' ? data.commissionAmount * 100 : data.commissionAmount
                    })
            ...
            >
                ...
                <div className='divide-y divide-neutral-200 px-6'>
                    ...
                    <SettingsRow heading='Commission' description='See how the affiliate will get rewarded'>
                        <div className='-m-1'>
                            <AnimatedSizeContainer height transition={{ ease: 'easeInOut', duration: 0.2 }}>
                                <div className='p-1'>
                                    <div className='grid grid-cols-1 gap-3 lg:grid-cols-2'>
                                        {commissionTypes.map((commissionType) => {
                                            const isSelected =
                                                commissionDuration && commissionDuration > 1 === commissionType.recurring ? true : false
                                            ...
                                            return (
                                                <label
                                                    ...
                                                    className={cn(
                                                        ...
                                                        isSelected && 'border-black bg-neutral-50 text-neutral-900 ring-1 ring-black'
                                                    )}
                                                >
                                                    <input
                                                        type='radio'
                                                        ...
                                                        onChange={(e) => {
                                                            if (e.target.checked) {
                                                                setValue('commissionDuration', commissionType.recurring ? 12 : 1, {
                                                                    shouldDirty: true
                                                                })
                                                            }
                                                        }}
                                                    ...
                                                    <div className='flex grow flex-col text-sm'>
                                                        <span className='font-medium'>{commissionType.label}</span>
                                    ...
                                    <div
                                        className={cn(
                                            ...
                                            commissionDuration && commissionDuration > 1 ? 'h-auto' : 'h-0 opacity-0'
                                        )}
                                    ...
                                    >
                                        <div className='pt-6'>
                                            <label htmlFor='duration' className='pt-6 text-sm font-medium text-neutral-800'>
                                                Duration
                                            </label>
                                            <div className='relati`ve mt-2 rounded-md shadow-sm'>
                                                ...
                                                >
                                                    {(commissionInterval === 'year' ? [1, 2] : [1, 3, 6, 12, 18, 24]).map((v) => (
                    ...
                    <SettingsRow heading='Payout' description='Set how much the affiliate will get rewarded'>
                        <div className='flex flex-col gap-6'>
                            <div>
                                <label htmlFor='commissionType' className='text-sm font-medium text-neutral-800'>
                                    Payout model
                                </label>
                                ...
                                <div className='relative mt-2 rounded-md shadow-sm'>
                                    ...
                                    <input
                                        className={cn(
                                            ...
                                            errors.commissionAmount && 'border-red-600 focus:border-red-500 focus:ring-red-600',
                ...
                <div className='flex items-center justify-end rounded-b-lg border-t border-neutral-200 bg-neutral-50 px-6 py-5'>
                    <div>
                        <Button text='Save changes' className='h-8' loading={isSubmitting} disabled={!isValid || !isDirty} />
                    </div>
                </div>
            </form>
        </>
                    ...
                    <p className='p-4 text-sm font-normal leading-relaxed text-neutral-900'>
                        <ProgramCommissionDescription
                            program={{
                                ...data,
                                commissionAmount:
                                    (data.commissionType === 'flat' ? data.commissionAmount * 100 : data.commissionAmount) || 0
                            }}
