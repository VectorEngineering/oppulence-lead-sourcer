...
export function InvitePartnerButton() {
    const { invitePartnerSheet, setIsOpen: setShowInvitePartnerSheet } = useInvitePartnerSheet()
    ...
    return (
        <>
            {invitePartnerSheet}
            <Button type='button' onClick={() => setShowInvitePartnerSheet(true)} text='Invite partner' shortcut='P' />
        </>
    )
}
