        ...
        <form onSubmit={handleSubmit(onSubmit)} className='flex h-full flex-col'>
                ...
                <div className='p-6'>
                    <div className='flex flex-col gap-4'>
                        ...
                        <div>
                            ...
                            <AnimatedSizeContainer height transition={{ duration: 0.2, ease: 'easeInOut' }} className='-m-1 mt-1'>
                                <div className='p-1'>
                                    <PartnerLinkSelector
                                        ...
                                        error={!!errors.linkId}
                                    />
                                    {errors.linkId && <p className='mt-2 text-xs text-red-600'>{errors.linkId.message}</p>}
                                </div>
                            ...
                            <div className='mt-2 overflow-hidden rounded-md border border-neutral-200'>
                                <div className='grid gap-4 p-6 pb-10'>
                                    ...
                                    <h3 className='font-medium text-gray-900'>
                                        {program?.name || platform.company} invited you to join {platform.company} Partners
                                    </h3>
                                    <p className='text-sm text-gray-500'>
                                        {program?.name || platform.company} uses {platform.company} Partners to power their partnership
            ...
            <div className='flex grow flex-col justify-end'>
                <div className='flex items-center justify-end gap-2 border-t border-neutral-200 p-5'>
                    ...
                    />
                    <Button type='submit' variant='primary' text='Send invite' className='w-fit' loading={isExecuting} />
                </div>
            </div>
        </form>
    )
