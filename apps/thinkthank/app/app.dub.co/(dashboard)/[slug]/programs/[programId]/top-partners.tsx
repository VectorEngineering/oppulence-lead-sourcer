    ...
    return (
        <div className='rounded-md border border-neutral-200'>
            <div className='flex items-center justify-between border-b border-neutral-200 p-5'>
                <h2 className='text-base font-semibold text-neutral-900'>Top partners</h2>
                    ...
                    {isLoading ? (
                        ...
                        <div className='grid grid-cols-1 gap-1'>
                            {partners.slice(0, 5).map((partner) => (
                                <div key={partner.id} className='flex h-12 items-center justify-between p-2'>
                                    <div className='flex items-center gap-2 text-xs'>
                                        <img
                                        ...
                                        <div className='flex flex-col'>
                                            ...
                                            <span className='text-neutral-500'>{COUNTRIES[partner.country ?? ''] ?? '-'}</span>
                                        </div>
                                    </div>
                        ...
                        <div className='flex size-full items-center justify-center text-sm text-neutral-500'>No partners found</div>
                    )}
                </div>
            </div>
        </div>
