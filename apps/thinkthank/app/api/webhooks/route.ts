import { identifyWebhookReceiver, isLinkLevelWebhook } from '@/lib/webhook/utils'
...
import { WebhookReceiver } from '@dub/prisma-thinkthank/client'
...
export const POST = withWorkspace(
    async ({ req, workspace, session }) => {
        const { name, url, triggers, linkIds, secret } = createWebhookSchema.parse(await parseRequestBody(req))
        ...
        const isZapierWebhook = identifyWebhookReceiver(url) === WebhookReceiver.zapier
