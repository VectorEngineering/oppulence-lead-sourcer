...
import { getDomainQuerySchema, getUrlQuerySchema } from '@/lib/zod/schemas/links'
...
export async function GET(req: NextRequest) {
    try {
        const { url, domain } = getUrlQuerySchema.and(getDomainQuerySchema).parse(getSearchParams(req.url))
