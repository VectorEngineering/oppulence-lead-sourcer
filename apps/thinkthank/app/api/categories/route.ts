...
import { createTransactionCategoryBodySchema, getTransactionCategoriesQuerySchemaExtended } from '@/lib/zod/schemas/transaction-categories'
...
export const GET = withWorkspace(
    async ({ workspace, headers, searchParams }) => {
        const { search, page, pageSize, includeTransactionsCount } = getTransactionCategoriesQuerySchemaExtended.parse(searchParams)
