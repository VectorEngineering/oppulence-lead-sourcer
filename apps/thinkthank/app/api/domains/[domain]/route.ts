import { addDomainToVercel, markDomainAsDeleted, removeDomainFromVercel, validateDomain } from '@/lib/api/domains'
import { DomainSchema, updateDomainBodySchema } from '@/lib/zod/schemas/domains'
...
export const PATCH = withWorkspace(
    async ({ req, workspace, params }) => {
        ...
        const domainUpdated = newDomain && newDomain.toLowerCase() !== domain.toLowerCase()
