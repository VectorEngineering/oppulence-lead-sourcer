import { dashboardSchema, updateDashboardBodySchema } from '@/lib/zod/schemas/dashboard'
...
const getDashboardOrThrow = async ({ id, workspaceId }: { id: string; workspaceId: string }) => {
