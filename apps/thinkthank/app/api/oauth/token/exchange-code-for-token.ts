...
export const exchangeAuthCodeForToken = async (req: NextRequest, params: z.infer<typeof authCodeExchangeSchema>) => {
    ...
    if (app.pkce) {
        const codeChallenge = accessCode.codeChallengeMethod === 'S256' ? await generateCodeChallengeHash(codeVerifier!) : codeVerifier
