import { APP_DOMAIN, STRIPE_INTEGRATION_ID, getSearchParams } from '@dub/utils'
...
export const GET = async (req: NextRequest) => {
    ...
    const { state, stripe_user_id: stripeAccountId, error, error_description } = parsed.data
    ...
    if (error) {
        ...
        redirect(`${APP_DOMAIN}/${workspace.slug}/settings/integrations/stripe?stripeConnectError=${error_description}`)
