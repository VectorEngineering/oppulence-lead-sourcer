import { SaleResponseSchema, getSalesQuerySchema } from '@/lib/zod/schemas/partners'
...
export const GET = withWorkspace(async ({ workspace, params, searchParams }) => {
    ...
    const { page, pageSize, status, sortBy, sortOrder, customerId, payoutId, partnerId } = parsed
