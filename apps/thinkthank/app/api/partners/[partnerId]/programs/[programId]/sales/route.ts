import { PartnerSaleResponseSchema, getPartnerSalesQuerySchema } from '@/lib/zod/schemas/partners'
...
export const GET = withPartner(async ({ partner, params, searchParams }) => {
    ...
    const { page, pageSize, status, sortBy, sortOrder, customerId, payoutId } = parsed
