import { PartnerPayoutResponseSchema, payoutsQuerySchema } from '@/lib/zod/schemas/payouts'
...
export const GET = withPartner(async ({ partner, searchParams }) => {
    const { status, sortBy, sortOrder, page, pageSize } = payoutsQuerySchema.parse(searchParams)
