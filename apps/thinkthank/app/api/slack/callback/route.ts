...
import { Project, WebhookReceiver } from '@dub/prisma-thinkthank/client'
import { APP_DOMAIN_WITH_NGROK, SLACK_INTEGRATION_ID, getSearchParams } from '@dub/utils'
...
export const GET = async (req: Request) => {
    ...
    try {
        ...
        formData.append('redirect_uri', `${APP_DOMAIN_WITH_NGROK}/api/slack/callback`)
