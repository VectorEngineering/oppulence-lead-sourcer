            ...
            <div className='animate-slide-up-fade mt-8 w-full [--offset:10px] [animation-delay:500ms] [animation-duration:1s] [animation-fill-mode:both]'>
                <div className='divide-y divide-neutral-200 overflow-hidden rounded-lg border border-neutral-200'>
                    <div className='flex items-center justify-center bg-neutral-50 p-6'>
                        <img src={`${platform.assetsUrl}/stripe-wordmark.png`} alt='Stripe wordmark' className='aspect-[96/40] h-12' />
                    </div>
                    <div className='bg-white p-4 text-sm text-neutral-600'>
                        We use Stripe to ensure you get paid on time and to keep your personal bank details secure. Click{' '}
                        <strong>Continue to Stripe</strong> to setup your payouts account.
                        <br />
                        <br />
                        You can complete this at a later date, but won&lsquo;t be able to collect any payouts until it&lsquo;s completed.
                    </div>
                </div>
                <div className='mt-6 grid gap-4'>
                    <StripeConnectButton text='Continue to Stripe' />
                    <Link href='/programs' className='text-sm text-neutral-500 transition-colors enabled:hover:text-neutral-800'>
