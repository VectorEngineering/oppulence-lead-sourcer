...
import { RegisterProvider, useRegisterContext } from '@/ui/auth/register/context'
    ...
    return (
        <>
            <div className='rounded-lg border border-neutral-200 bg-white p-8 pb-10'>
                <h1 className='text-lg font-medium text-neutral-800'>Create a {platform.company} Partner account</h1>
                <div className='mt-8'>
            ...
            <p className='mt-4 text-center text-sm text-gray-500'>
                ...
                <Link href='/login' className='font-semibold text-gray-500 underline underline-offset-2 transition-colors hover:text-black'>
                    Sign in
                </Link>
            </p>
        </>
...
function Verify() {
    ...
    return (
        <>
            <div className='rounded-lg border border-neutral-200 bg-white p-8 pb-10'>
                <h1 className='text-lg font-medium text-neutral-800'>Verify your email address</h1>
