    ...
    return (
        <div className='mx-auto my-10 w-full max-w-md md:mt-16 lg:mt-20'>
            <div className='rounded-lg border border-neutral-200 bg-white p-8 pb-10'>
                <h1 className='text-lg font-medium text-neutral-800'>Reset your password</h1>
                <p className='mt-3 text-sm text-gray-500'>Enter a new password for your account.</p>
