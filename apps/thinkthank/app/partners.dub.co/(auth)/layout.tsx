            ...
            <div className='flex grow flex-col justify-end'>
                <div className='relative flex w-full flex-col items-center justify-center gap-2 py-10 pb-6'>
                    ...
                    <div className='flex gap-3 text-center text-xs text-gray-500 underline underline-offset-2'>
                        <a href={`${platform.webUrl}/legal/privacy`} target='_blank' className='hover:text-gray-800' rel='noreferrer'>
                            Privacy Policy
                        </a>
                        <a href={`${platform.webUrl}/legal/terms`} target='_blank' className='hover:text-gray-800' rel='noreferrer'>
                            Terms of Service
                        </a>
                        <a href={platform.platformUrl} target='_blank' className='hover:text-gray-800' rel='noreferrer'>
