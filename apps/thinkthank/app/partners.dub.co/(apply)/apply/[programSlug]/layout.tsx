...
export async function generateMetadata({ params: { programSlug } }: { params: { programSlug: string } }) {
...
export default async function ApplyLayout({ children, params: { programSlug } }: PropsWithChildren<{ params: { programSlug: string } }>) {
    const program = await getProgram({ slug: programSlug })
