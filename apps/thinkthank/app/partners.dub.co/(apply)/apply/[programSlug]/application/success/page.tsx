...
const FEATURES = [
    {
        ...
        description: 'Our expanding marketplace is full of high-quality programs. We guarantee their quality.'
    },
    {
        icon: MoneyBills2,
        title: 'Get paid how you want',
        description: 'Connect your bank account, PayPal, or other payout choices. Get paid in any country.'
    },
    {
        icon: LinesY,
        title: 'Full analytics',
        description: "View how your efforts are doing and how much you've earned with our program analytics."
    },
    {
        icon: CursorRays,
        ...
        >
            ...
            <div className='p-6'>
                <div className='grid grid-cols-1 gap-5 sm:pt-20'>
                    <h1 className='text-4xl font-semibold'>Application {hasPartnerProfile ? 'submitted' : 'saved'}</h1>
                    <div className='flex flex-col gap-4 text-base text-neutral-700'>
                        {hasPartnerProfile && (
                            <p>
                                ...
                                {application && (
                                    <>
                                        {' '}
                                        You&apos;ll receive an update at <strong className='font-semibold'>{application.email}</strong>.
                                    </>
                                )}
                            </p>
                        )}
                        {!hasPartnerProfile && (
                            <p>
                                Complete your account setup on <strong className='font-semibold'>{platform.company} Partners</strong> to
