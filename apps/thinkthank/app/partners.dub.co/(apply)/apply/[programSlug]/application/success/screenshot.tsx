...
export function Screenshot({ program, ...rest }: { program: Pick<ProgramProps, 'name' | 'logo'> } & SVGProps<SVGSVGElement>) {
    const id = useId()
        ...
        >
            <g clipPath={`url(#${id}-a)`}>
                ...
                <g clipPath={`url(#${id}-b)`}>
                    ...
                    />
                    <path fill='#737373' d='M183.815 28.06a.89.89 0 1 1 .001-1.78.89.89 0 0 1-.001 1.78' />
                </g>
                <path fill='currentColor' d='M204 24c0-6.627 5.373-12 12-12s12 5.373 12 12-5.373 12-12 12-12-5.373-12-12' opacity='0.4' />
                <g filter={`url(#${id}-c)`} opacity='0.1'>
                    <circle cx='181.5' cy='181.5' r='181.5' fill={`url(#${id}-d)`} transform='matrix(-1 0 0 1 186 661)' />
                </g>
                {/* Little logo */}
                <image
                    x='18'
                ...
                />
                <text xmlSpace='preserve' fill='#171717' fontSize='13' fontWeight='600' letterSpacing='0em' style={{ whiteSpace: 'pre' }}>
                    <tspan x='60' y='83.727'>
                        {truncate(program.name, 18)}
                    </tspan>
                </text>
                <circle cx='62' cy='94' r='2' fill='#4ADE80' />
                <text xmlSpace='preserve' fill='#737373' fontSize='10' fontWeight='500' letterSpacing='0em' style={{ whiteSpace: 'pre' }}>
                    <tspan x='68' y='97.636'>
                        Enrolled
                    </tspan>
                </text>
                <g clipPath={`url(#${id}-e)`}>
                    ...
                    <g clipPath={`url(#${id}-f)`}>
                        ...
                        />
                        <path fill='currentColor' d='M24.222 139.667a.667.667 0 1 0 0-1.334.667.667 0 0 0 0 1.334' />
                        <path
                            stroke='currentColor'
                            strokeLinecap='round'
                            strokeLinejoin='round'
                ...
                />
                <path stroke='#737373' strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' d='M23.333 162.556h9.334' />
                <text xmlSpace='preserve' fill='#525252' fontSize='13' fontWeight='500' letterSpacing='0em' style={{ whiteSpace: 'pre' }}>
                    <tspan x='46' y='173.727'>
                        Payouts
                    </tspan>
                </text>
                <g stroke='#737373' strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' clipPath={`url(#${id}-g)`}>
                ...
                />
                <path fill='#737373' d='M24.444 263.222a.666.666 0 1 0 .001-1.332.666.666 0 0 0 0 1.332' />
                <path
                    stroke='#737373'
                    strokeLinecap='round'
                    strokeLinejoin='round'
                ...
                <path fill='#fff' d='M1695.5 8v-.5H256c-9.113 0-16.5 7.387-16.5 16.5v916.5h1456V8' />
                <path stroke='#E5E5E5' d='M1695.5 8v-.5H256c-9.113 0-16.5 7.387-16.5 16.5v916.5h1456V8Z' />
                <text
                    xmlSpace='preserve'
                    fill='#171717'
                    fontSize='24'
                ...
                <g clipPath={`url(#${id}-h)`}>
                    <rect width='1200' height='306' x='367.5' y='104' fill='#FAFAFA' rx='12' />
                    <rect xmlns='http://www.w3.org/2000/svg' width='1200' height='306' x='367.5' y='104' fill={`url(#${id}-grid)`} />
                    ...
                    />
                    <text xmlSpace='preserve' fill='#737373' fontSize='14' letterSpacing='0em' style={{ whiteSpace: 'pre' }}>
                    ...
                    <path
                        ...
                        d='M392 355.6c0-1.688 0-2.925.08-3.9.079-.97.234-1.637.519-2.197a5.5 5.5 0 0 1 2.404-2.404c.56-.285 1.227-.44 2.197-.519.975-.08 2.212-.08 3.9-.08h280.8c1.688 0 2.925 0 3.9.08.97.079 1.637.234 2.197.519a5.5 5.5 0 0 1 2.404 2.404c.285.56.44 1.227.519 2.197.08.975.08 2.212.08 3.9v20.8c0 1.688 0 2.925-.08 3.9-.079.97-.234 1.637-.519 2.197a5.5 5.5 0 0 1-2.404 2.404c-.56.285-1.227.44-2.197.519-.975.08-2.212.08-3.9.08H401.1c-1.688 0-2.925 0-3.9-.08-.97-.079-1.637-.234-2.197-.519a5.5 5.5 0 0 1-2.404-2.404c-.285-.56-.44-1.227-.519-2.197-.08-.975-.08-2.212-.08-3.9z'
                    />
                    <text xmlSpace='preserve' fill='#262626' fontSize='14' letterSpacing='0em' style={{ whiteSpace: 'pre' }}>
                    ...
                    />
                    <path fill='#171717' d='M707.5 352a6 6 0 0 1 6-6h135a6 6 0 0 1 6 6v28a6 6 0 0 1-6 6h-135a6 6 0 0 1-6-6z' />
                    <path
                        stroke='#fff'
                        strokeLinecap='round'
                        strokeLinejoin='round'
                    ...
                    />
                    <text xmlSpace='preserve' fill='#fff' fontSize='14' fontWeight='500' letterSpacing='0em' style={{ whiteSpace: 'pre' }}>
                        <tspan x='743.521' y='371.091'>
                            Invite via email
                        </tspan>
                    </text>
                    <g filter={`url(#${id}-j)`} style={{ mixBlendMode: 'overlay' }}>
                        <path fill='#000' fillOpacity='0.5' d='M1680 507h-70.15c0-327.214-574.37-436.919-854.85-429.005V21h925z' />
                    </g>
                    <g filter={`url(#${id}-k)`} style={{ mixBlendMode: 'soft-light' }}>
                        <circle cx='600' cy='600' r='600' fill='currentColor' transform='matrix(-1 0 0 1 2007.5 -343)' />
                    </g>
                    <g clipPath={`url(#${id}-l)`}>
                        ...
                        <rect width='6' height='6' x='1490.5' y='254' fill='#fff' rx='3' transform='rotate(90 1490.5 254)' />
                        <rect
                            width='6.75'
                            height='6.75'
                            x='1490.88'
                        ...
                        />
                        <circle cx='1487.5' cy='257' r='1' fill='#000' fillOpacity='0.3' transform='rotate(90 1487.5 257)' />
                        <rect width='6' height='6' x='1450.5' y='340' fill='#fff' rx='3' transform='rotate(-180 1450.5 340)' />
                        <rect
                            width='6.75'
                            height='6.75'
                            x='1450.87'
                        ...
                        />
                        <circle cx='1447.5' cy='337' r='1' fill='#000' fillOpacity='0.3' transform='rotate(-180 1447.5 337)' />
                        <rect width='6' height='6' x='1324.5' y='260' fill='#fff' rx='3' transform='rotate(-90 1324.5 260)' />
                        <rect
                            width='6.75'
                            height='6.75'
                            x='1324.12'
                        ...
                        />
                        <circle cx='1327.5' cy='257' r='1' fill='#000' fillOpacity='0.3' transform='rotate(-90 1327.5 257)' />
                        <rect width='6' height='6' x='1370.5' y='340' fill='#fff' rx='3' transform='rotate(-180 1370.5 340)' />
                        <rect
                            width='6.75'
                            height='6.75'
                            x='1370.87'
                        ...
                        />
                        <circle cx='1367.5' cy='337' r='1' fill='#000' fillOpacity='0.3' transform='rotate(-180 1367.5 337)' />
                        <path
                            stroke={`url(#${id}-m)`}
                            strokeWidth='0.75'
                    ...
                    <g filter={`url(#${id}-r)`}>
                        <path fill={`url(#${id}-s)`} fillOpacity='0.01' d='M1327.5 177h160v160h-160z' />
                        <path fill='#fff' fillOpacity='0.5' d='M1327.5 177h160v160h-160z' />
                    </g>
                    <path stroke='#000' strokeOpacity='0.1' strokeWidth='0.75' d='M1327.5 177h160v160h-160z' />
                    {/* Big logo */}
                    <image
                        x='1367.5'
                        y='217'
                    ...
                    <g filter={`url(#${id}-t)`} opacity='0.5'>
                        ...
                        <path stroke='#000' strokeOpacity='0.2' strokeWidth='0.75' d='M1227.5 137h40v40h-40z' />
                        <g stroke='#212121' strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' opacity='0.5'>
                    ...
                    <g filter={`url(#${id}-u)`} opacity='0.5'>
                        ...
                        <path stroke='#000' strokeOpacity='0.2' strokeWidth='0.75' d='M1507.5 337h40v40h-40z' />
                        <g
                            stroke='#212121'
                            strokeLinecap='round'
                            strokeLinejoin='round'
                    ...
                    <g filter={`url(#${id}-w)`} opacity='0.1'>
                        <circle cx='600' cy='600' r='600' fill='currentColor' transform='matrix(-1 0 0 1 2007.5 -356)' />
                    </g>
                </g>
                <rect width='1199' height='305' x='368' y='104.5' stroke='#E5E5E5' rx='11.5' />
                <path
                    stroke='#E5E5E5'
                ...
                <text xmlSpace='preserve' fill='#262626' fontSize='24' fontWeight='500' letterSpacing='0em' style={{ whiteSpace: 'pre' }}>
                ...
                <path
                    ...
                    d='M1403 464c0-3.038 2.46-5.5 5.5-5.5h129c3.04 0 5.5 2.462 5.5 5.5v20c0 3.038-2.46 5.5-5.5 5.5h-129c-3.04 0-5.5-2.462-5.5-5.5z'
                />
                <g stroke='#171717' strokeLinecap='round' strokeLinejoin='round' strokeWidth='1.5' clipPath={`url(#${id}-x)`}>
                ...
                <text xmlSpace='preserve' fill='#171717' fontSize='12' fontWeight='500' letterSpacing='0em' style={{ whiteSpace: 'pre' }}>
                ...
                />
                <text xmlSpace='preserve' fill='#525252' fontSize='12' letterSpacing='0em' style={{ whiteSpace: 'pre' }}>
                ...
                <mask id={`${id}-z`} width='1112' height='293' x='433' y='539' maskUnits='userSpaceOnUse' style={{ maskType: 'alpha' }}>
            ...
            <defs>
                <pattern xmlns='http://www.w3.org/2000/svg' id={`${id}-smallGrid`} width='20' height='20' patternUnits='userSpaceOnUse'>
                    <path d='M 20 0 L 0 0 0 20' fill='none' stroke='#0004' strokeWidth='0.5' />
                </pattern>
                <pattern xmlns='http://www.w3.org/2000/svg' id={`${id}-grid`} width='80' height='80' patternUnits='userSpaceOnUse'>
                    <rect width='80' height='80' fill={`url(#${id}-smallGrid)`} />
                    <path d='M 80 0 L 0 0 0 80' fill='none' stroke='#0001' strokeWidth='1' />
                </pattern>
                <clipPath id={`${id}-a`}>
                ...
                <clipPath id={`${id}-e`}>
                    <path fill='#fff' d='M12 130a6 6 0 0 1 6-6h204a6 6 0 0 1 6 6v18a6 6 0 0 1-6 6H18a6 6 0 0 1-6-6z' />
                </clipPath>
                <clipPath id={`${id}-f`}>
                ...
                <clipPath id={`${id}-h`}>
                    <rect width='1200' height='306' x='367.5' y='104' fill='#fff' rx='12' />
                </clipPath>
                <clipPath id={`${id}-l`}>
                ...
                <linearGradient id={`${id}-i`} x1='367' x2='1330.65' y1='410' y2='25.44' gradientUnits='userSpaceOnUse'>
                    <stop stopColor='#FAFAFA' />
                    <stop offset='0.489' stopColor='#FAFAFA' />
                    <stop offset='1' stopColor='#fff' stopOpacity='0' />
                </linearGradient>
                <linearGradient id={`${id}-m`} x1='1407.5' x2='1407.5' y1='97.5' y2='175.5' gradientUnits='userSpaceOnUse'>
                    <stop stopOpacity='0' />
                    <stop offset='1' />
                </linearGradient>
                <linearGradient id={`${id}-n`} x1='1567' x2='1489' y1='257' y2='257' gradientUnits='userSpaceOnUse'>
                    <stop stopOpacity='0' />
                    <stop offset='1' />
                </linearGradient>
                <linearGradient id={`${id}-o`} x1='1447.5' x2='1447.5' y1='416.5' y2='338.5' gradientUnits='userSpaceOnUse'>
                    <stop stopOpacity='0' />
                    <stop offset='1' />
                </linearGradient>
                <linearGradient id={`${id}-p`} x1='1210' x2='1326' y1='257' y2='257' gradientUnits='userSpaceOnUse'>
                    <stop stopOpacity='0' />
                    <stop offset='1' />
                </linearGradient>
                <linearGradient id={`${id}-q`} x1='1367.5' x2='1367.5' y1='416.5' y2='338.5' gradientUnits='userSpaceOnUse'>
                    <stop stopOpacity='0' />
                    <stop offset='1' />
                </linearGradient>
                <linearGradient id={`${id}-s`} x1='1407.5' x2='1407.5' y1='337' y2='177' gradientUnits='userSpaceOnUse'>
                    <stop stopColor='#fff' stopOpacity='0.23' />
                    <stop offset='1' stopColor='#fff' stopOpacity='0.3' />
                </linearGradient>
                <linearGradient id={`${id}-y`} x1='989' x2='989' y1='539' y2='832' gradientUnits='userSpaceOnUse'>
                    <stop />
                ...
                >
                    ...
                    <feGaussianBlur result='effect1_foregroundBlur_0_1039' stdDeviation='100' />
                </filter>
                <filter
                    id={`${id}-j`}
                    width='1245'
                ...
                >
                    <feFlood floodOpacity='0' result='BackgroundImageFix' />
                    <feBlend in='SourceGraphic' in2='BackgroundImageFix' result='shape' />
                    <feGaussianBlur result='effect1_foregroundBlur_0_1039' stdDeviation='80' />
                </filter>
                <filter
                    id={`${id}-k`}
                    width='1440'
                ...
                >
                    <feFlood floodOpacity='0' result='BackgroundImageFix' />
                    <feBlend in='SourceGraphic' in2='BackgroundImageFix' result='shape' />
                    <feGaussianBlur result='effect1_foregroundBlur_0_1039' stdDeviation='60' />
                </filter>
                <filter
                    id={`${id}-r`}
                    width='160.75'
                ...
                >
                    ...
                    <feMorphology in='SourceAlpha' radius='6' result='effect1_innerShadow_0_1039' />
                    <feOffset />
