...
export default async function ApplicationPage({ params: { programSlug } }: { params: { programSlug: string } }) {
        ...
        >
            ...
            <div className='p-6'>
                ...
                <div className='grid grid-cols-1 gap-5 sm:pt-20'>
                    <p className='font-mono text-xs font-medium uppercase text-[var(--brand)]'>Affiliate Program</p>
                    <h1 className='text-4xl font-semibold'>{program.name} application</h1>
                    <p className='text-base text-neutral-700'>Submit your application to join the affiliate program.</p>
                </div>
                ...
                {/* Application form */}
                <div className='mt-10'>
                    <ProgramApplicationForm program={{ id: program.id, name: program.name, slug: program.slug }} />
                </div>
            </div>
        </div>
    )
