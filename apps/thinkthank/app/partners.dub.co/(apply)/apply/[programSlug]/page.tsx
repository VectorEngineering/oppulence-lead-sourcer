...
export default async function ApplyPage({ params: { programSlug } }: { params: { programSlug: string } }) {
    ...
    return (
        ...
        >
            <Header program={{ logo: program.logo, wordmark: program.wordmark }} slug={programSlug} />
            <div className='p-6'>
                {/* Hero section */}
                <div className='grid grid-cols-1 gap-5 sm:pt-20'>
                    ...
                    >
                        Share {program.name} with your audience and for each subscription generated through your referral, you&apos;ll earn
                        a share of the revenue on any plans they purchase.
                    </p>
              ...
              for more details.
                ...
                <div className='mt-16 grid grid-cols-1 gap-10'>
                    {landerData.blocks.map((block, idx) => {
                        ...
                        return Component ? <Component key={idx} block={block} logo={program.logo} /> : null
                    })}
                </div>
            </div>
        </div>
