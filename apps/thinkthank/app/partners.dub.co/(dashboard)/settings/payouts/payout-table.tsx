...
export function PayoutTable() {
    ...
    const [detailsSheetState, setDetailsSheetState] = useState<
        { open: false; payout: PartnerPayoutResponse | null } | { open: true; payout: PartnerPayoutResponse }
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <div className='flex items-center gap-2'>
                        <img
                            src={row.original.program.logo || `${DICEBEAR_AVATAR_URL}${row.original.program.name}`}
