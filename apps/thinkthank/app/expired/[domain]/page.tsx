...
export const metadata = constructMetadata({
    title: 'Expired Link',
    description: 'This link has expired. Please contact the owner of this link to get a new one.',
    noIndex: true
})

export default async function ExpiredLinkPage({ params }: { params: { domain: string } }) {
    ...
    return (
        <main className='flex min-h-screen flex-col justify-between'>
            ...
            <div className='z-10 mx-2 my-10 flex max-w-md flex-col items-center space-y-5 px-2.5 text-center sm:mx-auto sm:max-w-lg sm:px-0 lg:mb-16'>
                ...
                <p className='text-lg text-gray-600'>This link has expired. Please contact the owner of this link to get a new one.</p>
                <a
