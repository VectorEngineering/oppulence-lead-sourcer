...
export function SetWriteKey({ credentials, installed }: { credentials: SegmentIntegrationCredentials; installed: boolean }) {
            ...
            <div className='w-full rounded-lg border border-gray-200 bg-white'>
                ...
                <div className='p-4'>
                    <p className='text-sm leading-normal text-gray-600'>
                        To send click events to Segment, you need to add your Segment write key below.{' '}
                        <a
                ...
                <div className='flex items-center justify-end rounded-b-lg border-t border-gray-200 bg-gray-50 px-4 py-3'>
                    <div className='shrink-0'>
                        <Button
                            ...
                            disabledTooltip={plan === 'free' || plan === 'pro' ? planDisabledTooltip : undefined}
                        />
                    </div>
                </div>
            </div>
