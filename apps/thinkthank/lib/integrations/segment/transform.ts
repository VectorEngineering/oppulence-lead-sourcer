import { ClickEventWebhookData, LeadEventWebhookData, SaleEventWebhookData } from '@/lib/webhook/types'
...
export const formatEventForSegment = (payload: z.infer<typeof webhookPayloadSchema>) => {
