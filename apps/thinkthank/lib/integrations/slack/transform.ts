...
import { ClickEventWebhookData, LeadEventWebhookData, SaleEventWebhookData } from '../../webhook/types'

const createLinkTemplate = ({ data, event }: { data: LinkWebhookEvent['data']; event: WebhookTrigger }) => {
    const eventMessages = {
...
export const formatEventForSlack = (payload: z.infer<typeof webhookPayloadSchema>) => {
