...
import { InstalledIntegration } from '@dub/prisma-thinkthank/client'
import { getSlackEnv } from './env'
import { SlackCredential } from './type'

export const uninstallSlackIntegration = async ({ installation }: { installation: InstalledIntegration }) => {
