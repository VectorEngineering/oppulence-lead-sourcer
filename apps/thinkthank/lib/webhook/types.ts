...
import { clickWebhookEventSchema, leadWebhookEventSchema, saleWebhookEventSchema } from './schemas'
...
export type EventDataProps = LinkEventDataProps | ClickEventDataProps | LeadEventDataProps | SaleEventDataProps
