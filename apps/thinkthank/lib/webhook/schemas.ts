...
export const webhookPayloadSchema = z.object({
    ...
    event: z.enum(WEBHOOK_TRIGGERS).describe('The type of event that triggered the webhook.'),
    createdAt: z.string().describe('The date and time when the event was created in UTC.'),
...
export const webhookEventSchema = z
    .union([
        z
            .object({
                id: z.string(),
                event: z.union([z.literal('link.created'), z.literal('link.updated'), z.literal('link.deleted')]),
                createdAt: z.string(),
