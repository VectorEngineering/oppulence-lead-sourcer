...
export function QRCodeSVG(props: QRPropsSVG) {
    ...
    let cells = qrcodegen.QrCode.encodeText(value, ERROR_LEVEL_MAP[effectiveLevel]).getModules()
    ...
    if (imageSettings != null && calculatedImageSettings != null) {
        ...
        if (isOGContext) {
            const { imgWidth, imgHeight, imgLeft, imgTop } = convertImageSettingsToPixels(calculatedImageSettings, size, numCells, margin)
