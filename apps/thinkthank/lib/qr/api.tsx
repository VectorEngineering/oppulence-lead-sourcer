...
import { DEFAULT_BGCOLOR, DEFAULT_FGCOLOR, DEFAULT_LEVEL, DEFAULT_MARGIN, DEFAULT_SIZE, ERROR_LEVEL_MAP } from './constants'
...
export async function getQRAsSVG(props: QRPropsSVG) {
    ...
    if (imageSettings != null && calculatedImageSettings != null) {
        ...
        const base64Image = await fetch(`https://wsrv.nl/?url=${imageSettings.src}&w=100&h=100&encoding=base64`).then((res) => res.text())
    ...
    return (
        <svg height={size} width={size} viewBox={`0 0 ${numCells} ${numCells}`} xmlns='http://www.w3.org/2000/svg' {...otherProps}>
