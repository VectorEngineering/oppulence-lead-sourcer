import { Program, ProgramEnrollment } from '@dub/prisma-thinkthank/client'
...
export const calculateEarnings = ({
    ...
    const commissionAmount = partner && partner.commissionAmount !== null ? partner.commissionAmount : program.commissionAmount
