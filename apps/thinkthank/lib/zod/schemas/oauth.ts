    ...
    z.object({
        redirectUris: z
            ...
            .refine(
                ...
                {
                    message: "redirect_uri must be a valid URL starting with 'https://' or 'http://'"
                }
            ),
...
// Token grant schema
export const tokenGrantSchema = z.discriminatedUnion('grant_type', [authCodeExchangeSchema, refreshTokenSchema], {
    errorMap: () => ({
