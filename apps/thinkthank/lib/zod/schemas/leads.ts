...
export const trackLeadRequestSchema = z.object({
    clickId: z
        ...
        .describe('The ID of the click in th Dub. You can read this value from `dub_id` cookie.'),
    eventName: z
    ...
    externalId: z
        ...
        .describe("This is the unique identifier for the customer in the client's app. This is used to track the customer's journey."),
    customerId: z
        .string()
        .trim()
        .max(100)
    ...
    customerName: z.string().max(100).nullish().default(null).describe("Name of the customer in the client's app."),
    customerEmail: z.string().email().max(100).nullish().default(null).describe("Email of the customer in the client's app."),
    customerAvatar: z.string().nullish().default(null).describe("Avatar of the customer in the client's app."),
    metadata: z.record(z.unknown()).nullish().default(null).describe('Additional metadata to be stored with the lead event')
})
