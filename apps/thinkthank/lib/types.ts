import {
    ...
    Webhook,
    YearInReview
} from '@dub/prisma-thinkthank/client'
import { CustomerSchema, customerActivityResponseSchema, customerActivitySchema } from './zod/schemas/customers'
import { leadEventResponseSchema, trackLeadResponseSchema } from './zod/schemas/leads'
import { createOAuthAppSchema, oAuthAppSchema } from './zod/schemas/oauth'
import { EnrolledPartnerSchema, PartnerSaleResponseSchema, PartnerSchema, SaleResponseSchema, SaleSchema } from './zod/schemas/partners'
import { PartnerPayoutResponseSchema, PayoutResponseSchema, PayoutSchema } from './zod/schemas/payouts'
import { PartnerProgramInviteSchema, ProgramEnrollmentSchema, ProgramInviteSchema, ProgramSchema } from './zod/schemas/programs'
import { saleEventResponseSchema, trackSaleResponseSchema } from './zod/schemas/sales'
import { WebhookSchema, createWebhookSchema, webhookEventSchemaTB } from './zod/schemas/webhooks'
...
export const plans = ['free', 'pro', 'business', 'business plus', 'business extra', 'business max', 'enterprise'] as const
...
export type NewOrExistingIntegration = Omit<IntegrationProps, 'id' | 'verified' | 'installations'> & {
    id?: string
}
...
export type InstalledIntegrationInfoProps = Pick<
    IntegrationProps,
    'id' | 'slug' | 'logo' | 'name' | 'developer' | 'description' | 'verified' | 'readme' | 'website' | 'screenshots' | 'installUrl'
> & {
    createdAt: Date
    installations: number
    installed: {
...
export type WebhookCacheProps = Pick<Webhook, 'id' | 'url' | 'secret' | 'triggers' | 'disabledAt'>
...
export type PartnerProgramInviteProps = z.infer<typeof PartnerProgramInviteSchema>
