    ...
    return (
        ...
        >
            <div className='flex flex-col space-y-3 p-5 sm:p-10'>
                ...
                <p className='text-sm text-gray-500'>This is your workspace's logo on {platform.company}.</p>
                <div className='mt-1'>
                    <FileUpload
                        accept='images'
            ...
            <div className='flex items-center justify-between space-x-4 rounded-b-lg border-t border-gray-200 bg-gray-50 p-3 sm:px-10'>
                ...
                <div className='shrink-0'>
                    <Button
                        ...
                        {...(!isOwner && {
                            disabledTooltip: 'Only workspace owners can change the workspace logo.'
                        })}
                    />
                </div>
            </div>
