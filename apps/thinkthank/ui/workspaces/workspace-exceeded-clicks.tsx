        ...
        <MaxWidthWrapper>
            <div className='my-10 flex flex-col items-center justify-center rounded-md border border-gray-200 bg-white py-12'>
                ...
                <p className='z-10 max-w-sm text-center text-sm text-gray-600'>
                    Your workspace has exceeded your monthly clicks limits. We're still collecting data on your links, but you need to
                    upgrade to view them.
                </p>
                <img src={`${platform.assetsUrl}/video-park.svg`} alt='No links yet' width={400} height={400} className='-my-8' />

                <Link
                    href={`/${slug}/upgrade`}
                    className={cn(buttonVariants(), 'flex h-9 items-center justify-center rounded-md border px-4 text-sm')}
                >
