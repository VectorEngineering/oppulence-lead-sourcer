export default function WorkspaceArrow({ className }: { className?: string }) {
    return (
        <svg
                ...
                <g>
                    <defs>
                        <mask id='shape_DMhXIOleLZoVYRbAUpH5t_clip'>
                            <rect x='-222.934999821233' y='-170.22265625' width='254.74' height='249.35' fill='white' />
                            <path
                    ...
                    <g mask='url(#shape_DMhXIOleLZoVYRbAUpH5t_clip)'>
                        <rect x='-100' y='-100' width='254.74' height='249.35' fill='transparent' stroke='none' />
                        <path
