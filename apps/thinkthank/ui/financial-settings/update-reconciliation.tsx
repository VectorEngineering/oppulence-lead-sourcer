        ...
        >
            <div className='flex flex-col space-y-3 p-5 sm:p-10'>
                ...
                <div className='flex items-center justify-between rounded-lg border border-gray-200 p-4 transition-all hover:bg-gray-50'>
                    ...
                    <Switch fn={() => setAutoReconciliation(!autoReconciliation)} checked={autoReconciliation} disabled={saving} />
                </div>

                {autoReconciliation && (
                    <div className='w-full max-w-md space-y-4'>
                        <div>
                            <label className='block text-sm font-medium text-gray-700' htmlFor='reconciliation-window'>
                        ...
                        <div>
                            <label className='block text-sm font-medium text-gray-700' htmlFor='matching-strategy'>
                                Matching Strategy
                            </label>
