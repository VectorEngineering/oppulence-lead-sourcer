...
export default function UpdateCurrency({ defaultCurrency, enableMultiCurrency, supportedCurrencies }: UpdateCurrencyProps) {
    const router = useRouter()
    const [selectedCurrency, setSelectedCurrency] = useState(defaultCurrency)
    const [isMultiCurrencyEnabled, setIsMultiCurrencyEnabled] = useState(enableMultiCurrency)
    const [selectedSupportedCurrencies, setSelectedSupportedCurrencies] = useState<string[]>(supportedCurrencies || [])
        ...
        >
            <div className='flex flex-col space-y-3 p-5 sm:p-10'>
                <div className='flex flex-col space-y-3'>
                    ...
                    <p className='text-sm text-gray-500'>Configure your default currency and multi-currency support.</p>
                    ...
                    <div className='flex flex-col space-y-4 pt-4'>
                        ...
                        <div className='flex items-center justify-between'>
                            <div>
                                <label className='block text-sm font-medium text-gray-700' htmlFor='multi-currency-toggle'>
                        ...
                        {isMultiCurrencyEnabled && (
                            <div>
                                <label htmlFor='supported-currencies' className='block text-sm font-medium text-gray-700'>
