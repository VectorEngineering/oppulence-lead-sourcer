...
export const SSOSignIn = () => {
    ...
    const { setClickedMethod, clickedMethod, setLastUsedAuthMethod, setShowSSOOption, showSSOOption } = useContext(LoginFormContext)
            ...
            {showSSOOption && (
                <div>
                    ...
                    <div className='flex items-center space-x-2'>
                        <h2 className='text-sm font-medium text-gray-900'>Workspace Slug</h2>
                        <InfoTooltip
