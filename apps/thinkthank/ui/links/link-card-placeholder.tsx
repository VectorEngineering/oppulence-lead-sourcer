            ...
            <div className='flex grow items-center gap-3'>
                ...
                <div
                    className={cn(
                        ...
                        variant === 'loose' ? 'h-[60px] flex-col justify-center' : 'h-[32px] flex-row items-center'
                    )}
                >
                    <div className='h-5 w-32 animate-pulse rounded-md bg-gray-200 sm:w-44' />
                    <div className={cn('h-4 w-28 animate-pulse rounded-md bg-gray-200', variant === 'compact' && 'hidden sm:block')} />
                </div>
            </div>
