...
import { InfoTooltip, SimpleTooltipContent, UTM_PARAMETERS, useMediaQuery } from '@dub/ui'
...
export const DestinationUrlInput = forwardRef<HTMLInputElement, DestinationUrlInputProps>(
    ({ _key: key, domain, domains, error, right, ...inputProps }: DestinationUrlInputProps, ref) => {
        const inputId = useId()
            ...
            <div>
                ...
                <div className='relative mt-2 flex rounded-md shadow-sm'>
                    <input
                        ...
                        id={inputId}
                        placeholder={
                            domains?.find(({ slug }) => slug === domain)?.placeholder || `${platform.webUrl}/help/article/what-is-dub`
                        }
