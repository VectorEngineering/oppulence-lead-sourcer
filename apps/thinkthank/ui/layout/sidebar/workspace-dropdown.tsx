...
import { BlurImage, Popover, getUserAvatarUrl, useScrollProgress } from '@dub/ui'
...
export function WorkspaceDropdown() {
    ...
    return (
        <div>
            <Popover
                content={<WorkspaceList selected={selected} workspaces={workspaces} setOpenPopover={setOpenPopover} />}
                align='start'
                ...
                >
                    <div className='flex min-w-0 items-center gap-x-2.5 pr-2'>
                        ...
                        <div className={cn(key ? 'hidden' : 'block', 'min-w-0 sm:block')}>
                            <div className='truncate text-sm font-medium leading-5 text-neutral-900'>{selected.name}</div>
                            {selected.slug !== '/' && (
            ...
            >
                ...
                <div className='p-2'>
                    <div className='flex items-center justify-between pb-1'>
                        <p className='px-1 text-xs font-medium text-neutral-500'>Workspaces</p>
                    </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        {slug !== '/' && (
                                            <div className={cn('truncate text-xs capitalize leading-tight', getPlanColor(plan))}>
                                                {plan}
                                            </div>
                                        )}
                                    </div>
