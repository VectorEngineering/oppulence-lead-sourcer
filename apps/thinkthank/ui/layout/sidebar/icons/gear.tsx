...
export function Gear({ 'data-hovered': hovered, ...rest }: { 'data-hovered'?: boolean } & SVGProps<SVGSVGElement>) {
    ...
    useEffect(() => {
        ...
        if (hovered) {
            ref.current.animate([{ transform: 'rotate(0)' }, { transform: 'rotate(180deg)' }], {
                duration: 300
            })
        }
    }, [hovered])
    ...
    return (
        <svg height='18' width='18' viewBox='0 0 18 18' xmlns='http://www.w3.org/2000/svg' ref={ref} {...rest}>
            <g fill='currentColor'>
                <circle
                    cx='9'
                    cy='9'
