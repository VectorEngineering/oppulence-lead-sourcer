...
export function CursorRays({ 'data-hovered': hovered, className, ...rest }: { 'data-hovered'?: boolean } & SVGProps<SVGSVGElement>) {
    ...
    return (
        ...
        >
            <g fill='currentColor'>
                ...
                <g ref={raysRef} className='[transform-box:fill-box] [transform-origin:center] [&_*]:[vector-effect:non-scaling-stroke]'>
                    <line
                        fill='none'
                        stroke='currentColor'
                        strokeLinecap='round'
