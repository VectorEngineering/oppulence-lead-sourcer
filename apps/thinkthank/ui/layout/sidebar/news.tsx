...
export function News({ articles }: { articles: NewsArticle[] }) {
    const [dismissedNews, setDismissedNews] = useLocalStorage<string[]>('dismissed-news', [])
        ...
        >
            <div className={cn(hideContent && 'invisible')}>
                <div className='flex flex-col gap-1'>
                    <span className='line-clamp-1 font-medium text-neutral-900'>{title}</span>
                    <p className='line-clamp-2 h-10 leading-5 text-neutral-500'>{description}</p>
                </div>
                <div className='relative mt-3 aspect-[16/9] w-full shrink-0 overflow-hidden rounded border border-neutral-200 bg-neutral-100'>
                    {image && (
                        <Image src={image} alt='' fill sizes='10vw' className='rounded object-cover object-center' draggable={false} />
                    )}
                </div>
                <div
                    className={cn(
...
function AnimatedLogo(props: SVGProps<SVGSVGElement>) {
    return (
        <svg viewBox='0 0 48 21' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
            <path
                fillRule='evenodd'
                clipRule='evenodd'
            ...
            >
                <animate attributeName='stroke-dashoffset' dur='2500ms' values='63;0;0;0;63' fill='freeze' />
            </path>
            <path
                fillRule='evenodd'
                clipRule='evenodd'
                ...
                stroke-linecap='round'
            >
                <animate attributeName='stroke-dashoffset' dur='2500ms' values='69;0;0;0;69' fill='freeze' />
            </path>
            <path
                fillRule='evenodd'
                clipRule='evenodd'
                ...
                stroke-linecap='round'
            >
                <animate attributeName='stroke-dashoffset' dur='2500ms' values='-60;0;0;0;-60' fill='freeze' />
            </path>
        </svg>
    )
}
