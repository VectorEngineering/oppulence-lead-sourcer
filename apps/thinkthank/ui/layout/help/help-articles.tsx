...
export function HelpArticles({ setScreen }: { setScreen: Dispatch<SetStateAction<'main' | 'contact'>> }) {
    ...
    return (
        <div>
            <div className='p-2 sm:p-4'>
                <div className='p-2'>
                    <h3 className='text-lg font-semibold text-gray-700'>👋 How can we help?</h3>
                </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className='flex flex-col space-y-1'>
                                <p className='text-sm font-medium text-blue-600'>Can't find what you're looking for?</p>
                                <p className='text-xs text-gray-400'>Send us a message and we'll get back to you as soon as possible.</p>
                            </div>
                        </Command.Empty>
                        <CommandResults />
                    </Command.List>
            ...
            <div className='flex justify-between border-t border-gray-200 px-3 py-4 sm:px-6'>
                {session ? (
                    <button onClick={() => setScreen('contact')} className='flex items-center space-x-2 hover:underline'>
                ...
                <a href={`${platform.webUrl}/help`} target='_blank' className='flex items-center space-x-2 hover:underline'>
...
const CommandResults = () => {
    const { popularHelpArticles: POPULAR_HELP_CONTENT, allHelpArticles: ALL_HELP_CONTENT } = useContext(HelpContext)
