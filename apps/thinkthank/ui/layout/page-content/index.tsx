...
export function PageContent({
    ...
    return (
        <div className='bg-neutral-100 md:bg-white'>
            <MaxWidthWrapper className={cn('mt-3', (hasTitle || hasDescription) && 'md:mt-6 md:py-3')}>
                            ...
                            <div>
                                {hasTitle && (
                                    <div className='flex items-center gap-2'>
                                        ...
                                        <h1 className='text-xl font-semibold leading-7 text-neutral-900 md:text-2xl'>{title}</h1>
                                    </div>
                                )}
            ...
            <div className='bg-white pt-2.5 max-md:mt-3 max-md:rounded-t-[16px]'>
                {hasDescription && (
                    <MaxWidthWrapper className=''>
                        <p className='mb-3 mt-1 text-base text-neutral-500 md:hidden'>{description}</p>
                    </MaxWidthWrapper>
                )}
                {children}
            </div>
