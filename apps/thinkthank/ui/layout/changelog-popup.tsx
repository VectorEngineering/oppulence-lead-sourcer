...
const CHANGELOG_DESCRIPTION = "Today, we're launching our new Link Builder to help you manage your links better."
        ...
        >
            ...
            >
                ...
                <div className='grid max-w-sm gap-1.5 p-4 text-center'>
                    <p className='text-center font-semibold text-gray-800 underline-offset-4 group-hover:underline'>{CHANGELOG_TITLE}</p>
                    <p className='text-pretty text-sm text-gray-500'>{CHANGELOG_DESCRIPTION}</p>
                </div>
            </Link>
        </motion.div>
    )
