    ...
    return (
        ...
        >
            <div className='flex flex-col space-y-3 p-5 sm:p-10'>
                ...
                <p className='text-sm text-gray-500'>This is your avatar image on {platform.company}.</p>
                <div className='mt-1'>
                    <FileUpload
                        accept='images'
            ...
            <div className='flex items-center justify-between space-x-4 rounded-b-lg border-t border-gray-200 bg-gray-50 p-3 sm:px-10'>
                <p className='text-sm text-gray-500'>Square image recommended. Accepted file types: .png, .jpg. Max file size: 2MB.</p>
                <div className='shrink-0'>
                    <Button text='Save changes' loading={uploading} disabled={!image || session?.user?.image === image} />
                </div>
            </div>
        </form>
    )
