        ...
        <div className='rounded-lg border border-red-600 bg-white'>
            ...
            <div className='flex flex-col space-y-3 p-5 sm:p-10'>
                ...
                <p className='text-sm text-gray-500'>
                    Permanently delete your {platform.company} account, all of your workspaces, links and their respective stats. This
            ...
            <div className='flex items-center justify-end p-3 sm:px-10'>
                <div>
                    <Button text='Delete Account' variant='danger' onClick={() => setShowDeleteAccountModal(true)} />
                </div>
            </div>
        </div>
    )
