...
export const eventColumns = {
    ...
    leads: {
        ...
        defaultVisible: ['event', 'link', 'customer', 'country', 'device', 'timestamp']
    },
    sales: {
        all: [
            'event',
        ...
        defaultVisible: ['event', 'link', 'customer', 'country', 'saleAmount', 'timestamp']
    }
}
...
export function useColumnVisibility() {
    const [columnVisibility, setColumnVisibility] = useLocalStorage<Record<EventType, VisibilityState>>('events-table-columns', {
    ...
    return {
        columnVisibility,
        setColumnVisibility: (tab, visibility) => setColumnVisibility({ ...columnVisibility, [tab]: visibility })
    }
}
