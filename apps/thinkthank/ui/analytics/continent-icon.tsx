import { Africa, Asia, Europe, Globe, NorthAmerica, Oceania, SouthAmerica } from '@dub/ui/icons'

export default function ContinentIcon({ display, className }: { display: string; className?: string }) {
    switch (display) {
        case 'AF':
