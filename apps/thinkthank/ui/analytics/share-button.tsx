...
const ShareButtonInner = memo(({ domain, _key }: { domain: string; _key: string }) => {
    const { ShareDashboardModal, setShowShareDashboardModal } = useShareDashboardModal({ domain, _key })
