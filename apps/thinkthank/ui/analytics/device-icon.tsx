...
import { CursorRays, Desktop, GamingConsole, MobilePhone, QRCode, TV, Tablet, Watch } from '@dub/ui/icons'
...
export default function DeviceIcon({ display, tab, className }: { display: string; tab: DeviceTabs; className: string }) {
    if (tab === 'devices') {
        ...
        if (display === 'Mac OS') {
            return <BlurImage src='https://assets.dub.co/misc/icons/macos.png' alt={display} width={20} height={20} className='h-4 w-4' />
        } else if (display === 'iOS') {
