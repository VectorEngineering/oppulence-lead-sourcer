                    ...
                    data.length > 0 ? (
                        <BarList
                            ...
                            data={
                                data
                                    ?.map((d) => ({
                                        icon: <LinkLogo apexDomain={getApexDomain(d.url)} className='size-5 sm:size-5' />,
                                        title: (tab === 'links' && d['shortLink'] ? d['shortLink'] : d.url) ?? 'Unknown',
                                        // TODO: simplify this once we switch from domain+key to linkId
                                        href: queryParams({
                                            ...((tab === 'links' && searchParams.has('domain') && searchParams.has('key')) ||
