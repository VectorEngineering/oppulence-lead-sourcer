        ...
        <Modal showModal={showGoogleOauthModal} setShowModal={setShowGoogleOauthModal}>
            <div className='flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16'>
                ...
                <p className='text-center text-sm text-gray-500'>
                    This allows you to sign in to your {platform.company} account with Google.{' '}
                    <a
...
export function useGoogleOauthModal() {
    ...
    const GoogleOauthModalCallback = useCallback(() => {
        return <GoogleOauthModal showGoogleOauthModal={showGoogleOauthModal} setShowGoogleOauthModal={setShowGoogleOauthModal} />
