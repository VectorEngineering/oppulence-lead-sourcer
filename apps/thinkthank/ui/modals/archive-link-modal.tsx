...
const sendArchiveRequest = ({ linkId, archive, workspaceId }: { linkId: string; archive: boolean; workspaceId?: string }) => {
...
function ArchiveLinkModal(props: ArchiveLinkModalProps) {
    return (
        <Modal showModal={props.showArchiveLinkModal} setShowModal={props.setShowArchiveLinkModal}>
            <ArchiveLinkModalInner {...props} />
        </Modal>
    )
}

function ArchiveLinkModalInner({ setShowArchiveLinkModal, props }: ArchiveLinkModalProps) {
...
export function useArchiveLinkModal({ props }: { props: LinkProps }) {
    ...
    const ArchiveLinkModalCallback = useCallback(() => {
        return props ? (
            <ArchiveLinkModal showArchiveLinkModal={showArchiveLinkModal} setShowArchiveLinkModal={setShowArchiveLinkModal} props={props} />
        ) : null
