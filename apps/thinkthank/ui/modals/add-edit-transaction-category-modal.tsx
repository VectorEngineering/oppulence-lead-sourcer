import { CATEGORY_COLORS_LIST, type TransactionCategoryColorProps } from '@/ui/transactions/transaction-category-badge'
import { Button, InfoTooltip, Label, Logo, Modal, RadioGroup, RadioGroupItem, Switch, TooltipContent, useMediaQuery } from '@dub/ui'
...
import useTransactionCategories, { type TransactionCategoryProps } from '@/lib/swr/use-transaction-categories'
...
function AddEditTransactionCategoryModal({
    ...
    const saveDisabled = useMemo(
        () => saving || !data.name || (props && Object.entries(props).every(([key, value]) => data[key] === value)),
        [props, data, saving]
    )
    ...
    return (
        <Modal showModal={showAddEditCategoryModal} setShowModal={setShowAddEditCategoryModal} className='max-h-[90vh] max-w-2xl'>
            <div className='flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-6 sm:px-16'>
                ...
                <div className='flex flex-col space-y-1 text-center'>
                    <h3 className='text-xl font-semibold text-gray-900'>{props ? 'Edit' : 'Create'} Transaction Category</h3>
                    <p className='text-sm text-gray-500'>Use transaction categories to organize and track your transactions.</p>
                </div>
            </div>
                    ...
                    <div className='col-span-full'>
                        ...
                        <div className='space-y-4 rounded-lg bg-gray-50 p-4'>
                            <div className='flex items-center justify-between'>
                                ...
                                <Switch checked={data.trackingEnabled} fn={(checked) => setData({ ...data, trackingEnabled: checked })} />
                            </div>
                    ...
                    <div className='col-span-full'>
                        ...
                        <div className='space-y-4 rounded-lg bg-gray-50 p-4'>
                            <div className='flex items-center justify-between'>
                                ...
                                <Switch checked={data.taxDeductible} fn={(checked) => setData({ ...data, taxDeductible: checked })} />
                            </div>
                    ...
                    <div className='col-span-full'>
                        ...
                        <div className='rounded-lg bg-gray-50 p-4'>
                            <div className='flex items-center justify-between'>
                                ...
                                <Switch checked={data.isActive} fn={(checked) => setData({ ...data, isActive: checked })} />
                            </div>
                        </div>
                    </div>
                </div>
...
function AddTransactionCategoryButton({ setShowAddEditCategoryModal }: { setShowAddEditCategoryModal: Dispatch<SetStateAction<boolean>> }) {
...
export function useAddEditTransactionCategoryModal({ props }: { props?: TransactionCategoryProps } = {}) {
    ...
    return useMemo(
        ...
        [setShowAddEditCategoryModal, AddEditTransactionCategoryModalCallback, AddTransactionCategoryButtonCallback]
    )
}
