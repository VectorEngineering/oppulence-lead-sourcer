...
const sendArchiveRequest = ({ domain, archive, workspaceId }: { domain: string; archive: boolean; workspaceId?: string }) => {
...
function ArchiveDomainModal({
    ...
    return (
        <Modal showModal={showArchiveDomainModal} setShowModal={setShowArchiveDomainModal}>
