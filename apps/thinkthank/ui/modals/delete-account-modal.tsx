            ...
            >
                <div>
                    <label htmlFor='verification' className='block text-sm text-gray-700'>
                        To verify, type <span className='font-semibold text-black'>confirm delete account</span> below
                    </label>
...
export function useDeleteAccountModal() {
    ...
    const DeleteAccountModalCallback = useCallback(() => {
        return <DeleteAccountModal showDeleteAccountModal={showDeleteAccountModal} setShowDeleteAccountModal={setShowDeleteAccountModal} />
