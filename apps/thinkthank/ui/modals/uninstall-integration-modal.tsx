...
import { BlurImage, Button, Logo, Modal, TokenAvatar, useMediaQuery } from '@dub/ui'
...
function UninstallIntegrationModal({
    ...
    return (
        <Modal showModal={showUninstallIntegrationModal} setShowModal={setShowUninstallIntegrationModal}>
            <div className='flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16'>
                ...
                <p className='text-center text-sm text-gray-500'>
                    This will remove the integration from your workspace. Are you sure you want to continue?
                </p>
            </div>
            ...
            <div className='flex flex-col space-y-4 bg-gray-50 px-4 py-8 text-left sm:px-16'>
                ...
                <Button
                    ...
                    onClick={() => {
                        setRemoving(true)
                        fetch(`/api/integrations/uninstall?workspaceId=${workspaceId}&installationId=${installed?.id}`, {
                            method: 'DELETE',
...
export function useUninstallIntegrationModal({ integration }: { integration: InstalledIntegrationInfoProps }) {
    const [showUninstallIntegrationModal, setShowUninstallIntegrationModal] = useState(false)
