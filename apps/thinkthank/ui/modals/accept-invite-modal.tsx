...
function AcceptInviteModal({
    ...
    return (
        <Modal showModal={showAcceptInviteModal} setShowModal={setShowAcceptInviteModal} preventDefaultClose>
            {error?.status === 409 ? (
                <>
                    <div className='flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16'>
                        ...
                        <p className='text-center text-sm text-gray-500'>
                            ...
                            <span className='font-mono text-purple-600'>{slug || '......'}</span> workspace on {platform.company}
                        </p>
                    </div>
                ...
                <>
                    <div className='flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16'>
                        ...
                        <p className='text-center text-sm text-gray-500'>This invite has expired or is no longer valid.</p>
                    </div>
                    <div className='flex flex-col space-y-6 bg-gray-50 px-4 py-8 text-left sm:px-16'>
                        <Button
...
export function useAcceptInviteModal() {
    ...
    const AcceptInviteModalCallback = useCallback(() => {
        return <AcceptInviteModal showAcceptInviteModal={showAcceptInviteModal} setShowAcceptInviteModal={setShowAcceptInviteModal} />
