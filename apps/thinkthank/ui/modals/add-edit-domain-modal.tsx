...
function AddEditDomainModal({
    ...
    return (
        <Modal
            ...
            className='max-w-lg'
        >
            <h3 className='border-b border-neutral-200 px-4 py-4 text-lg font-medium sm:px-6'>{props ? 'Update' : 'Add'} Domain</h3>
...
export function useAddEditDomainModal({ props, buttonProps }: { props?: DomainProps; buttonProps?: Partial<ButtonProps> } = {}) {
    ...
    const AddDomainButtonCallback = useCallback(() => {
        return <AddDomainButton setShowAddEditDomainModal={setShowAddEditDomainModal} buttonProps={buttonProps} />
    ...
    return useMemo(
        ...
        [setShowAddEditDomainModal, AddEditDomainModalCallback, AddDomainButtonCallback]
    )
}
