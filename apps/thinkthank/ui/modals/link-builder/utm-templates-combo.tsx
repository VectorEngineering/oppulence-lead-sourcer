...
import { Button, Combobox, DiamondTurnRight, Tooltip, UTM_PARAMETERS } from '@dub/ui'
...
export function UTMTemplatesCombo({
    ...
    const { data } = useSWR<UtmTemplateProps[]>(workspaceId && `/api/utm?workspaceId=${workspaceId}`, fetcher, {
