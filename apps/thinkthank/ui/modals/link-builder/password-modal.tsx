import { Button, ButtonTooltip, Modal, SimpleTooltipContent, Tooltip, useKeyboardShortcut, useMediaQuery } from '@dub/ui'
...
function PasswordModal({
    ...
    return (
        <Modal showModal={showPasswordModal} setShowModal={setShowPasswordModal} className='sm:max-w-md'>
            <PasswordModalInner setShowPasswordModal={setShowPasswordModal} />
        </Modal>
    )
}

function PasswordModalInner({ setShowPasswordModal }: { setShowPasswordModal: Dispatch<SetStateAction<boolean>> }) {
                    ...
                    <Tooltip
                        content={
                            <div className='px-2 py-1 text-xs text-gray-700'>
                                Press <strong className='font-medium text-gray-950'>P</strong> to open this quickly
                            </div>
                        }
                        side='right'
                    >
...
function PasswordButton({ setShowPasswordModal }: { setShowPasswordModal: Dispatch<SetStateAction<boolean>> }) {
    ...
    return (
        <Button
            ...
            icon={<InputPassword className={cn('size-4', password && 'text-blue-500')} />}
...
export function usePasswordModal() {
    ...
    const PasswordModalCallback = useCallback(() => {
        return <PasswordModal showPasswordModal={showPasswordModal} setShowPasswordModal={setShowPasswordModal} />
