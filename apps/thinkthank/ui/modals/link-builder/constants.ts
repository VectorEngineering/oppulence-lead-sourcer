import { CircleHalfDottedClock, Crosshairs3, Incognito, InputPassword, SquareChart, WindowSearch } from '@dub/ui/icons'
...
export const TOGGLES = [
    {
        ...
        icon: Incognito,
        label: 'Link Cloaking',
        description: 'Mask your destination URL so your users only see the short link in the browser address bar.',
    ...
    },
    {
        ...
        description: 'Track conversions on your short link to measure the effectiveness of your marketing campaigns.',
...
export const MOBILE_MORE_ITEMS = [
    {
        ...
        remove: (setValue: UseFormSetValue<ExpandedLinkProps>) => setValue('password', null, { shouldDirty: true }),
        type: 'modal'
    },
    {
        key: 'expiresAt',
    ...
    },
    {
        ...
        description: 'Target your links to specific audiences based on their location, device, or browser.',
        learnMoreUrl: `${platform.webUrl}/help/article/geo-targeting`,
        shortcutKey: 'x',
        enabled: (data: LinkFormData) => Boolean(data.ios || data.android || Object.keys(data.geo || {}).length > 0),
        remove: (setValue: UseFormSetValue<ExpandedLinkProps>) => {
