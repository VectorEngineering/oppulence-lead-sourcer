...
function DeleteLinkModal(props: DeleteLinkModalProps) {
    return (
        <Modal showModal={props.showDeleteLinkModal} setShowModal={props.setShowDeleteLinkModal}>
            <DeleteLinkModalInner {...props} />
        </Modal>
    )
}

function DeleteLinkModalInner({ setShowDeleteLinkModal, props }: DeleteLinkModalProps) {
            ...
            >
                <div>
                    <label htmlFor='verification' className='block text-sm text-gray-700'>
                        To verify, type <span className='font-semibold'>{shortlink}</span> below
                    </label>
...
export function useDeleteLinkModal({ props }: { props?: LinkProps }) {
    ...
    const DeleteLinkModalCallback = useCallback(() => {
        return props ? (
            <DeleteLinkModal showDeleteLinkModal={showDeleteLinkModal} setShowDeleteLinkModal={setShowDeleteLinkModal} props={props} />
        ) : null
