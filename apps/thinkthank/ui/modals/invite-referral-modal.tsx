...
function InviteReferralModal({
    ...
    return (
        <Modal showModal={showInviteReferralModal} setShowModal={setShowInviteReferralModal}>
            <div className='flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16'>
                <Logo />
                <h3 className='text-lg font-medium'>Invite via Email</h3>
                <p className='text-center text-sm text-gray-500'>
                    Invite a friend or colleague to use {platform.company} with your referral link.
                </p>
            </div>
            <form
                onSubmit={async (e) => {
            ...
            >
                <div>
                    ...
                    <p className='mt-2 text-xs text-gray-500'>Your name and email address will be shared in this invitation.</p>
                </div>
