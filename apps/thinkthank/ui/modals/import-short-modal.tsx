...
function ImportShortModal({
    ...
    const {
        ...
        workspaceId && showImportShortModal && `/api/workspaces/${workspaceId}/import/short`,
        fetcher,
        {
            onError: (err) => {
        ...
        >
            <div className='flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-8 sm:px-16'>
                <div className='flex items-center space-x-3 py-4'>
                    <img src={`${platform.assetsUrl}/icons/short.svg`} alt='Short.io logo' className='h-10 w-10' />
                    <ArrowRight className='h-5 w-5 text-gray-600' />
                    <Logo />
                </div>
                <h3 className='text-lg font-medium'>Import Your Short.io Links</h3>
                <p className='text-center text-sm text-gray-500'>
                    Easily import all your existing Short.io links into {platform.company} with just a few clicks.
                </p>
            </div>
                    ...
                    domains.length > 0 ? (
                        ...
                        <div className='flex flex-col items-center justify-center gap-2'>
                            ...
                            <p className='max-w-md text-center text-sm text-gray-500'>
                                We weren't able to retrieve any links from your Short.io account.
                            </p>
                            <a
                    ...
                    >
                        <div>
                            <div className='flex items-center space-x-2'>
                                <h2 className='text-sm font-medium text-gray-900'>Short.io API Key</h2>
                                <InfoTooltip
                                    content={
                                        <SimpleTooltipContent
...
export function useImportShortModal() {
    ...
    const ImportShortModalCallback = useCallback(() => {
        return <ImportShortModal showImportShortModal={showImportShortModal} setShowImportShortModal={setShowImportShortModal} />
