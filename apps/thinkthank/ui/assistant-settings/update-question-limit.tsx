...
export default function UpdateQuestionLimit({ maxQuestionsPerDay: initialLimit }: { maxQuestionsPerDay: number | null }) {
        ...
        >
            <div className='flex flex-col space-y-3 p-5 sm:p-10'>
                ...
                <div className='w-full max-w-md space-y-2'>
                    {QUESTION_LIMIT_OPTIONS.map((option) => (
                        ...
                        >
                            ...
                            />
                            <label htmlFor={`limit-${option.value || 'unlimited'}`} className='flex flex-1 cursor-pointer flex-col'>
                ...
                <div className='flex items-center justify-between space-x-4 rounded-b-lg border border-gray-200 bg-gray-50 p-3 sm:px-10'>
                    <p className='text-sm text-gray-500'>This will control how many questions you can ask the AI assistant per day.</p>
                    <div>
                        <Button
