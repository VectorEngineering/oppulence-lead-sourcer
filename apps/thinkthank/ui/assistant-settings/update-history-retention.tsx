...
export default function UpdateHistoryRetention({ currentRetentionDays }: { currentRetentionDays: number }) {
            ...
            <div className='flex flex-col space-y-3 p-5 sm:p-10'>
                <div className='flex items-center justify-between'>
                    <div>
                        ...
                        <p className='text-sm text-gray-500'>Choose how long to retain your conversation history</p>
                    </div>
                </div>
                ...
                <div className='flex items-center justify-between space-x-4 rounded-b-lg border border-gray-200 bg-gray-50 p-3 sm:px-10'>
                    <p className='text-sm text-gray-500'>Older conversations will be automatically deleted after the selected period.</p>
                    <div>
                        <Button
