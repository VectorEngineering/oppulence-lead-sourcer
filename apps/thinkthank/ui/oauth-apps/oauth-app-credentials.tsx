        ...
        <div className='flex flex-col space-y-3 text-left'>
            ...
            {clientSecret && (
                <div className='space-y-2'>
                    ...
                    <div className='flex items-center justify-between rounded-md border border-gray-300 bg-white p-3'>
                        <p className='text-nowrap font-mono text-sm text-gray-500'>{clientSecret}</p>
                        <div className='flex flex-col gap-2'>
                            <CopyButton value={clientSecret} className='rounded-md' />
                        </div>
                    </div>
                    <span className='text-xs text-red-400'>Be sure to copy your client secret. You won’t be able to see it again.</span>
                </div>
            )}
            ...
            {!clientSecret && partialClientSecret && (
                <div className='space-y-2'>
                    <label className='text-sm font-medium text-gray-500'>Client Secret</label>
                    <div className='flex items-center justify-between rounded-md border border-gray-300 bg-white p-3'>
                        <p className='text-nowrap font-mono text-sm text-gray-500'>{partialClientSecret}</p>
                    </div>
                </div>
            )}
        </div>
