...
export default function WorkspaceLeadsSummary({
    ...
    return (
        <Html>
            <Head />
            <Preview>
                Workspace Leads Summary: {summary.period} - {summary.overview.totalLeads.toString()} total leads,{' '}
            ...
            <Tailwind>
                <Body className='mx-auto my-auto bg-white font-sans'>
                    <Container className='mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5'>
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Workspace Leads Summary 📊</Heading>
                        <Text className='text-sm leading-6 text-black'>
                            Here's a comprehensive overview of your workspace's lead performance for {summary.period}. The data shows strong
                            acquisition and qualification metrics, with several notable trends and insights.
                        </Text>
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Growth Trends 📈</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            Your workspace shows positive momentum across key metrics. These trends indicate effective lead generation and
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Lead Sources 🎯</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            Understanding your most effective lead sources helps optimize acquisition strategies and resource allocation.
                        </Text>
                        <Section className='my-4'>
                            <div className='rounded-lg border border-solid border-gray-200 p-4'>
                                {summary.sources.map((source, index) => (
                                    <div key={`${index}-${source.name}-${Math.random()}`} className={index !== 0 ? 'mt-4' : ''}>
                                        <Row>
                                        ...
                                        {index !== summary.sources.length - 1 && <Hr className='my-4 border-gray-200' />}
                                    </div>
                                ))}
                            </div>
                        </Section>

                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Top Performing Leads 🏆</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            These high-potential leads demonstrate strong engagement and match ideal customer profiles. Priority follow-up
                            is recommended.
                        </Text>
                        <Section className='my-4'>
                            <div className='rounded-lg border border-solid border-gray-200 p-4'>
                                {summary.topPerforming.map((lead, index) => (
                                    <div key={`${index}-${lead.name}-${Math.random()}`} className={index !== 0 ? 'mt-4' : ''}>
                                        <Row>
                                            <Column className='px-2'>
                                            ...
                                            <Column className='px-2'>
                                                ...
                                                <Text className='m-0 text-base font-medium text-green-600'>{lead.score}</Text>
                                            </Column>
                                            <Column className='px-2'>
                                        ...
                                        {index !== summary.topPerforming.length - 1 && <Hr className='my-4 border-gray-200' />}
                                    </div>
                                ))}
                            </div>
                        </Section>

                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Key Insights 💡</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            Analysis of your lead data reveals valuable insights that can help optimize your lead generation and conversion
                            strategies.
                        </Text>
                        <Section className='my-4'>
                            <div className='rounded-lg border border-solid border-gray-200 p-4'>
                        ...
                        <Text className='mb-4 mt-8 text-sm leading-6 text-black'>
                            Your workspace shows strong lead generation and qualification performance. Focus on the identified insights and
                            maintain proactive engagement to drive continued growth.
                        </Text>
