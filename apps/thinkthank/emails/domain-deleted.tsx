            ...
            <Tailwind>
                <Body className='mx-auto my-auto bg-white font-sans'>
                    <Container className='mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5'>
                        ...
                        <Heading className='mx-0 my-7 p-0 text-center text-xl font-semibold text-black'>Domain Deleted</Heading>
                        <Text className='text-sm leading-6 text-black'>
                            Your domain <code className='text-purple-600'>{domain}</code> for your {platform.company} workspace{' '}
                        ...
                        <Text className='text-sm leading-6 text-black'>
                            If you would like to restore the domain, you can easily create it again on {platform.company} with the link
                            below.
                        </Text>
                        ...
                        <Text className='text-sm leading-6 text-black'>
                            If you did not want to keep using this domain on {platform.company} anyway, you can simply ignore this email.
                        </Text>
                        <Footer email={email} />
                    </Container>
                </Body>
