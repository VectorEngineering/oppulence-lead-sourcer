            ...
            <Tailwind>
                <Body className='mx-auto my-auto bg-white font-sans'>
                    <Container className='mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5'>
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>New Lead Assignment 🎯</Heading>
                        <Text className='text-sm leading-6 text-black'>
                            A high-potential lead has been assigned to your pipeline. Based on their initial engagement and profile, this
                            opportunity requires prompt attention. The lead has shown significant interest in our enterprise solutions and
                        ...
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            Below are the key details about your newly assigned lead. They represent {lead.company}, a company in the{' '}
                            {lead.industry} sector, and have demonstrated strong interest through their recent interactions with our
                            platform.
                        </Text>
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Assignment Details 📋</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            This lead has been strategically assigned to ensure optimal engagement and follow-up. Given the lead's high
                            priority status and demonstrated interest, prompt action within the specified timeline is crucial for
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Context & Notes 📝</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            Important context about this lead's interests and engagement. These insights should guide your initial outreach
                            strategy and help you prepare for meaningful conversations about their specific needs and challenges.
                        </Text>
                        <Section className='my-4'>
                            <div className='rounded-lg border border-solid border-gray-200 p-4'>
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Recommended Action Plan 📋</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            Based on the lead's profile and engagement patterns, we've outlined a strategic approach for your next steps.
                            Following this sequence will help ensure effective engagement and maximize the opportunity for conversion.
                        </Text>
                        <Section className='my-4'>
                            <div className='rounded-lg border border-solid border-gray-200 p-4'>
                        ...
                        <Text className='mb-4 mt-8 text-sm leading-6 text-black'>
                            Remember to document all interactions and updates in the lead management system. Quick and strategic follow-up
                            is key to maintaining engagement with this high-potential opportunity.
                        </Text>
