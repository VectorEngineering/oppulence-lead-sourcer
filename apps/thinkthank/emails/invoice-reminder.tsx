                ...
                <Body className='mx-auto my-auto bg-white font-sans'>
                    <Container className='mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5'>
                        <Section className='mt-8 text-center'>
                            ...
                            <Row>
                                <Column align='center'>
                                    ...
                                    >
                                        <Clock className={`h-6 w-6 ${isOverdue ? 'text-orange-600' : 'text-blue-600'}`} />
                                    </div>
                                </Column>
                            </Row>
                        </Section>
                                ...
                                <Column className='px-4'>
                                    <div
                                        className={`rounded-lg border p-4 ${
                                            isOverdue ? 'border-orange-200 bg-orange-50' : 'border-blue-200 bg-blue-50'
                                        }`}
                                    >
                                        <Text className='m-0 text-sm text-gray-900'>
                                            ...
                                            <br />
                                            <br />
                                            This is a {isOverdue ? 'reminder that payment is overdue' : 'friendly reminder'} for invoice{' '}
                                            <strong>{invoiceNumber}</strong> from {teamName}.
                                            {isOverdue && ` The payment is currently ${daysPastDue} days past due.`}
                                        </Text>
                                    </div>
                                </Column>
                            </Row>
                                    ...
                                    <div className='rounded-lg border border-gray-200 bg-gray-50 p-4'>
                                        ...
                                        <div className='mt-2 space-y-2'>
                                            ...
                                            <Row>
                                                ...
                                                <Column>
                                                    <Text className='m-0 text-sm text-gray-700'>Billed To: {companyName}</Text>
                                                </Column>
                                            </Row>
                                        </div>
                                    </div>
                            ...
                            <Row>
                                <Column className='px-4'>
                                    <div className='rounded-lg border border-gray-200 bg-white p-4'>
                                        <Text className='m-0 text-sm font-medium text-gray-900'>Payment Methods:</Text>
                                        <div className='mt-2'>
                        ...
                        <Text className='text-sm leading-6 text-gray-600'>
                            If you have already processed this payment, please disregard this reminder. For any questions about the invoice
                            or payment process, please contact us at{' '}
