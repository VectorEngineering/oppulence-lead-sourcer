...
export default function Footer({
        ...
        return (
            <Tailwind>
                ...
                <Text className='text-[12px] leading-6 text-gray-500'>
                    ...
                    <Link className='text-gray-700 underline' href={`${platform.platformUrl}/account/settings`}>
                        Unsubscribe here.
                    </Link>
                </Text>
    ...
    return (
        <Tailwind>
            <Hr className='mx-0 my-6 w-full border border-gray-200' />
            <Text className='text-[12px] leading-6 text-gray-500'>
                This email was intended for <span className='text-black'>{email}</span>. If you were not expecting this email, you can
                ignore this email. If you are concerned about your account's safety, please reply to this email to get in touch with us.
            </Text>
