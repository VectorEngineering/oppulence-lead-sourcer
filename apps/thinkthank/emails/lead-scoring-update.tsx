...
export default function LeadScoringUpdate({
    ...
    lead = {
        ...
        previousScore: 45,
        newScore: 85,
        factors: ['Visited pricing page 3 times', 'Downloaded whitepaper', 'Engaged with email campaign', 'Company size increased'],
    ...
    return (
        <Html>
            <Head />
            <Preview>
                Lead Score Update: {lead.company} ({lead.previousScore.toString()} → {lead.newScore.toString()}) {isPositive ? '📈' : '📉'}
            </Preview>
            <Tailwind>
                <Body className='mx-auto my-auto bg-white font-sans'>
                    <Container className='mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5'>
                        ...
                        <Text className='text-sm leading-6 text-black'>
                            Our lead scoring system has detected significant changes in engagement patterns for this lead. The updated score
                            reflects meaningful interactions and behavioral signals that indicate evolving sales readiness and potential
                        ...
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            This lead from the {lead.industry} sector has shown notable changes in their engagement level. Understanding
                            their profile will help you contextualize the score change and adapt your engagement strategy accordingly.
                        </Text>
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Engagement Signals 📊</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            Recent interactions have contributed to the score change. These engagement signals provide insights into the
                            lead's interests and level of intent, helping you understand their journey and potential needs.
                        </Text>
                        <Section className='my-4'>
                            <div className='rounded-lg border border-solid border-gray-200 p-4'>
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Key Activities 📈</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            The following activities have significantly influenced the lead's score. Each interaction provides valuable
                            context about their interests and potential pain points that you can address in your next engagement.
                        </Text>
                        <Section className='my-4'>
                            <div className='rounded-lg border border-solid border-gray-200 p-4'>
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Strategic Recommendation 🎯</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            Based on the score change and recent engagement patterns, we've formulated a targeted recommendation. This
                            guidance is designed to help you capitalize on the lead's current interest level and move the opportunity
                            forward effectively.
                        </Text>
                        <Section className='my-4'>
                            <div className='rounded-lg border border-solid border-gray-200 p-4'>
                        ...
                        <Text className='mb-4 mt-8 text-sm leading-6 text-black'>
                            This score update indicates a significant shift in the lead's engagement level. Taking prompt action based on
                            these insights will help maintain momentum and maximize the opportunity for successful conversion.
                        </Text>
