                ...
                <Body className='mx-auto my-auto bg-white font-sans'>
                    <Container className='mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5'>
                        ...
                        <Text className='text-sm leading-6 text-black'>
                            We have successfully <strong>imported {Intl.NumberFormat('en-us').format(count)} links</strong> from {provider}{' '}
                            into your {platform.company} workspace,{' '}
                            ...
                            <Section>
                                ...
                                {links.map(({ domain, key, createdAt }, index) => (
                                    <div key={`${index}-${domain}-${key}-${Math.random()}`}>
                                        ...
                                        {index !== links.length - 1 && <Hr className='my-2 w-full border border-gray-200' />}
                                    </div>
                                ))}
                            </Section>
                        )}
