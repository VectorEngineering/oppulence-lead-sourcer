            ...
            <Tailwind>
                <Body className='mx-auto my-auto bg-white font-sans'>
                    <Container className='mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5'>
                        ...
                        <Heading className='mx-0 my-7 p-0 text-center text-xl font-semibold text-black'>Your Login Link</Heading>
                        <Text className='text-sm leading-6 text-black'>Welcome to {platform.company}!</Text>
                        <Text className='text-sm leading-6 text-black'>Please click the magic link below to sign in to your account.</Text>
