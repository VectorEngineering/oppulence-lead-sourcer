            ...
            <Tailwind>
                <Body className='mx-auto my-auto bg-white font-sans'>
                    <Container className='mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5'>
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>New Lead Acquired! 🎯</Heading>
                        <Text className='text-sm leading-6 text-black'>
                            A promising new lead has been identified! Based on their engagement patterns and profile, this prospect shows
                            strong potential for conversion. Here's everything you need to know to take action.
                        </Text>
                        ...
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            Detailed information about the lead to help you understand their background and potential fit.
                        </Text>
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Areas of Interest 🎯</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            Based on their engagement, these are the key areas of interest that should guide your initial outreach strategy.
                        </Text>
                        <Section className='my-4'>
                            <div className='rounded-lg border border-solid border-gray-200 p-4'>
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Engagement Details 📊</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            Recent interactions and engagement metrics that indicate high interest and readiness for follow-up.
                        </Text>
                        <Section className='my-4'>
                            <div className='rounded-lg border border-solid border-gray-200 p-4'>
                                <Row>
                                ...
                                <Row>
                                    <Column className='px-2'>
                                        ...
                                        <Text className='m-0 text-base font-medium'>{lead.engagement.downloadedContent}</Text>
                                    </Column>
                                    <Column className='px-2'>
                        ...
                        <Heading className='mx-0 mb-4 mt-8 p-0 text-xl font-semibold text-black'>Recommended Actions 📋</Heading>
                        <Text className='mb-4 text-sm leading-6 text-black'>
                            Based on the lead's profile and engagement, here are the suggested next steps to maximize conversion potential.
                        </Text>
                        <Section className='my-4'>
                            <div className='rounded-lg border border-solid border-gray-200 p-4'>
                        ...
                        <Text className='mb-4 mt-8 text-sm leading-6 text-black'>
                            This lead shows strong potential based on their engagement patterns and profile. Quick follow-up is recommended
                            to maintain momentum and maximize conversion chances.
                        </Text>
