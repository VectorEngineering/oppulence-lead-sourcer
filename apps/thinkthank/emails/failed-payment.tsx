...
import type { Project } from '@dub/prisma-thinkthank/client'
            ...
            <Tailwind>
                <Body className='mx-auto my-auto bg-white font-sans'>
                    <Container className='mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5'>
                        ...
                        <Text className='text-sm leading-6 text-black'>Hey{user.name ? `, ${user.name}` : ''}!</Text>
                        <Text className='text-sm leading-6 text-black'>
                            Your payment of <code className='text-purple-600'>${amountDue / 100}</code> for your {platform.company}{' '}
                            workspace <code className='text-purple-600'>{workspace.name}</code> has failed. Please update your payment
