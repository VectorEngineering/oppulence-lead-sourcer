    ...
    <div className="min-w-[50%] space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight">
          {isUpdating ? "Update your workspace" : "Create a workspace"}
        </h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex">
            <div className="rounded-l-md border border-r-0 bg-gray-50 px-5 py-2 text-sm text-gray-500">
              workspace/
            </div>
            <Input
              id="description"
          ...
          <p className="text-sm text-gray-500">
            Choose a URL for your workspace or use the auto-generated one
          </p>
        </div>
