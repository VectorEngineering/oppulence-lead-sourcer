...
export default async function Page() {
    ...
    const { data: endpointsData, serverError: endpointsServerError } = endpoints || {}

    // check for errors
    if (!leadsData || !endpointsData || leadsServerError || endpointsServerError) {
        notFound()
    }
    ...
    return (
        <>
            ...
            <PageWrapper>
                ...
                <DataTable columns={columns} data={leadsData} endpoints={endpointsData} />
            </PageWrapper>
        </>
    )
}
