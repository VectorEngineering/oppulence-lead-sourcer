 ...
 */
type ValidationType = 'phone' | 'email' | 'string' | 'number' | 'date' | 'boolean' | 'url' | 'zip_code'
 ...
 */
type SchemaToZodMap = {
    [P in GeneralSchema['key']]: ReturnType<(typeof validations)[GeneralSchema['value']]>
}
 ...
 */
type ServerActionFunction = (formData: FormData) => Promise<{ error: string } | undefined>
