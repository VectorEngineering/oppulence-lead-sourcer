...
export const validations: { [key in ValidationType]: z.ZodType<any, any> } = {
    ...
    zip_code: z.string().min(5, 'Not a valid zip code.').max(5, 'Not a valid zip code.')
}
 ...
 */
export const generateDynamicSchema = (schema: GeneralSchema[]): z.ZodRawShape => {
...
> => {
    ...
    for (const key in dynamicSchema) {
