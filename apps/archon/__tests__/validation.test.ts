...
describe('validateAndParseData', () => {
    ...
    test('should handle missing required fields', () => {
        ...
        const result = validation.validateAndParseData(dynamicSchema, incompleteData)
    ...
    test('should ignore extra fields not in the schema', () => {
        ...
        const result = validation.validateAndParseData(dynamicSchema, dataWithExtraFields)
