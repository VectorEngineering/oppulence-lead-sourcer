...
// next imports
import { createEndpoint } from '@/app/actions/endpoints/create-endpoint-action'
import { createEndpointFormSchema as formSchema } from '@/app/actions/endpoints/schema'
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl className='bg-secondary'>
                                            <Input placeholder='Success URL...' {...field} disabled={!form.watch('formEnabled')} />
                                        </FormControl>
                                    </FormItem>
                                )}
                            />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl className='bg-secondary'>
                                            <Input placeholder='Fail URL...' {...field} disabled={!form.watch('formEnabled')} />
                                        </FormControl>
                                    </FormItem>
                                )}
                            />
