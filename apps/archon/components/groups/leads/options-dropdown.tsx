...
import { parseActionError } from '@/app/actions/action-utils'
import { deleteLead } from '@/app/actions/leads/delete-lead-action'
        ...
        <>
            <DropdownMenu>
                ...
                <DropdownMenuContent>
                    ...
                    <DropdownMenuItem onClick={() => setShowDeleteAlert(true)}>Delete</DropdownMenuItem>
                </DropdownMenuContent>
            </DropdownMenu>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            <span className='font-bold text-red-500'>permanently delete this lead.</span>
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
