...
const statusColors = {
    [WorkflowStatus.DRAFT]: 'bg-dark-400 text-dark-600',
                    ...
                    <div>
                        <h3 className='text-base font-bold text-muted-foreground flex items-center'>
                            <TooltipWrapper content={workflow.description}>
                                <Link href={`/workflow/editor/${workflow.id}`} className='flex items-center hover:underline text-xs'>
                                    {workflow.name}
                                </Link>
                            </TooltipWrapper>
                            {isDraft && (
                                <span className='ml-2 px-2 py-0.5 text-xs font-medium bg-dark-100 text-dark-800 rounded-full border px-3 py-1'>
                                    Draft
                                </span>
                            )}
