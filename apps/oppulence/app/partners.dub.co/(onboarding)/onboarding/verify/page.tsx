      ...
      <div className="animate-slide-up-fade mt-8 w-full [--offset:10px] [animation-delay:500ms] [animation-duration:1s] [animation-fill-mode:both]">
        <div className="divide-y divide-neutral-200 overflow-hidden rounded-lg border border-neutral-200">
          ...
          <div className="bg-white p-4 text-sm text-neutral-600">
            We use Stripe to ensure you get paid on time and to keep your personal bank details
            secure. Click <strong>Continue to Stripe</strong> to setup your payouts account.
            <br />
            <br />
            You can complete this at a later date, but won&lsquo;t be able to collect any payouts
            until it&lsquo;s completed.
          </div>
        </div>
