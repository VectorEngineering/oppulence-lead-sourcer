    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 gap-5 sm:pt-20">
          ...
          >
            Share {program.name} with your audience and for each subscription generated through your
            referral, you&apos;ll earn a share of the revenue on any plans they purchase.
          </p>
