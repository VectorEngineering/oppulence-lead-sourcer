...
export function StepPage({
  ...
  return (
    ...
    >
      ...
      <h1 className="mt-4 text-center text-2xl font-medium leading-tight">{title}</h1>
      <p className="mt-1.5 text-center text-base leading-tight text-gray-500">{description}</p>
