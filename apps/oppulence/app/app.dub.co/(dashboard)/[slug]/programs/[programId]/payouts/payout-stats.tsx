...
import { PayoutStatus } from '@dub/prisma-oppulence/client'
...
export function PayoutStats() {
  ...
  const { payoutsCount: eligiblePayoutsCount, loading: eligiblePayoutsLoading } = usePayoutsCount<
    PayoutsCount[]
  >({
    groupBy: 'status',
            ...
            {loading || eligiblePayoutsLoading ? (
              ...
              >
                <span className="underline decoration-dotted underline-offset-2">
                  {currencyFormatter(
                    eligiblePendingPayouts?.amount ? eligiblePendingPayouts.amount / 100 : 0,
                    {
                      maximumFractionDigits: 2,
                    }
                  ) + ' USD'}
