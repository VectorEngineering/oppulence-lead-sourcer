...
type FormData = Pick<
  ProgramProps,
  'commissionAmount' | 'commissionType' | 'commissionDuration' | 'commissionInterval'
>
      ...
      <form
        ...
        onSubmit={handleSubmit(async data => {
          await executeAsync({
            ...
            ...data,
            commissionAmount:
              data.commissionType === 'flat' ? data.commissionAmount * 100 : data.commissionAmount,
          })
                ...
                <div className="p-1">
                  <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
                    {commissionTypes.map(commissionType => {
                      const isSelected =
                        commissionDuration && commissionDuration > 1 === commissionType.recurring
                          ? true
                          : false
                  ...
                  >
                    <div className="pt-6">
                      ...
                      <div className="relati`ve mt-2 rounded-md shadow-sm">
                        ...
                        >
                          {(commissionInterval === 'year' ? [1, 2] : [1, 3, 6, 12, 18, 24]).map(
                            v => (
