    ...
    <div>
      <div className="max-w-screen-sm pb-8">
        ...
        <p className="mt-3 text-sm text-gray-500">
          Adjust your personal notification preferences and choose which updates you want to
          receive. These settings will only be applied to your personal account.
        </p>
      </div>
