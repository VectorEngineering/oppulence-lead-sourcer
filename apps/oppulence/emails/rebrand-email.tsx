...
export default function RebrandEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Today, we're thrilled to announce our rebrand. We are now {platform.company}.
      </Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              We're thrilled to share an important milestone in our journey! As part of our
              continuous evolution and commitment to providing you with the best possible
              experience, we're embarking on an exciting brand transformation.
            </Text>
            <Text className="text-sm leading-6 text-black">
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              <strong>ship.dub​.co</strong> instead of <strong>ship.dub​.sh</strong>. We'd
              appreciate it if you can add <strong>ship.dub​.co</strong> to your email whitelist to
              ensure you receive our emails.
            </Text>
            <Hr />
            <Text className="text-sm leading-6 text-black">
              Along with the rebrand, we've also been working on a multitude of new features. In the
              last 30 days, we rolled out 9 major updates:
            </Text>
