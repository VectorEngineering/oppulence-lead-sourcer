...
export default function ClicksExceeded({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Your {platform.company} workspace, {name || ''} has exceeded the {capitalize(plan) || ''}{' '}
        Plan limit of {nFormatter(usageLimit)} link clicks/month.
      </Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              <strong>{nFormatter(usage, { digits: 2 })} link clicks</strong> across all your links
              in your current billing cycle.
            </Text>
            <Text className="text-sm leading-6 text-black">
              All your existing links will continue to work, and we are still collecting data on
              them, but you'll need to upgrade to the{' '}
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              . Feel free to ignore this email if you don't plan on upgrading, or reply to let us
