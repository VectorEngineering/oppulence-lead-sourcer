        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              In the last 30 days, your {appName} workspace, <strong>{workspaceName}</strong>{' '}
              received <strong>{nFormatter(totalClicks)} link clicks</strong>. You also created{' '}
            ...
            {createdLinks === 0 ? (
              <>
                <Text className="text-sm leading-6 text-black">
                  It looks like you haven't created any links in the last 30 days. If there's
                  anything that we can do to help, please reply to this email to get in touch with
                  us.
                </Text>
