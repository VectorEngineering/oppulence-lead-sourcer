        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              ...
              {WEBHOOK_FAILURE_NOTIFY_THRESHOLD} times in a row and has been deactivated to prevent
              further issues.
            </Text>
            <Text className="text-sm leading-6 text-black">
              Please review the webhook details and update the URL if necessary to restore
              functionality.
            </Text>
