        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              Congratulations – someone just signed up for {platform.company} using your referral
              link:{' '}
            ...
            <Text className="text-sm leading-6 text-black">
              As a thank you from us for spreading the word about {platform.company}, you've earned
              an additional {REFERRAL_CLICKS_QUOTA_BONUS} clicks quota for your{' '}
              <a
