        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              Incredible achievement! 🎯 We're thrilled to announce another successful deal closure.
              This win not only strengthens our growing portfolio but also showcases the exceptional
              effectiveness of our sales strategy. The team's dedication and expertise have
              delivered outstanding results once again. Here are the exciting details:
            </Text>
