        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-gray-600">
              ...
              <strong className="text-black">{saleAmountInDollars}</strong> purchase on{' '}
            ...
            <Text className="text-sm leading-6 text-gray-600">
              Your received <strong className="text-black">{earningsInDollars}</strong> in
              commission for this sale and it will be included in your next payout.
            </Text>
