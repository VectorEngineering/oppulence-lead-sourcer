        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              We're excited to share significant progress in your sales pipeline! A lead has
              advanced to a new stage, indicating positive momentum in the sales process. This
              movement reflects growing engagement and alignment with our solutions.
            </Text>
            ...
            <Text className="mb-4 text-sm leading-6 text-black">
              This opportunity represents a key account in your pipeline. Understanding their
              profile and journey so far will help ensure smooth progression through subsequent
              stages and maintain positive momentum.
            </Text>
            ...
            <Text className="mb-4 text-sm leading-6 text-black">
              The lead has progressed from {lead.previousStage} to {lead.newStage}. This advancement
              indicates increasing engagement and readiness to move forward in the sales process.
              Understanding the context of this transition will help inform your next steps.
            </Text>
            <Section className="my-4">
              <Row>
                <Column className="px-2">
            ...
            <Text className="mb-4 text-sm leading-6 text-black">
              The following notes provide important context about this stage transition. These
              insights will help you understand the lead's current position and prepare for the next
              phase of engagement.
            </Text>
            <Section className="my-4">
              <div className="rounded-lg border border-solid border-gray-200 p-4">
            ...
            <Text className="mb-4 mt-8 text-sm leading-6 text-black">
              This stage transition represents a critical moment in the sales process. Quick
              follow-up with appropriate next steps will help maintain momentum and progress towards
              successful closure.
            </Text>
