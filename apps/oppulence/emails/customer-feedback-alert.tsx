        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              Important feedback received! 📝 We've gathered valuable insights from one of our
              customers that will help us enhance our service quality and user experience. This
              feedback provides crucial information for our continuous improvement initiatives.
            </Text>
