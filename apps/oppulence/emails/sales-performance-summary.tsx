        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 max-w-[500px] rounded border border-solid border-gray-200 px-10 py-5">
            ...
            <Text className="text-sm leading-6 text-black">
              Here's a comprehensive overview of your sales performance for {performance.period}.
              The data shows strong execution and highlights areas where we can further optimize for
            ...
            <Text className="mb-4 text-sm leading-6 text-black">
              Your pipeline shows robust health and positive momentum. The growth metrics indicate
              strong market positioning and effective sales execution, setting a solid foundation
            ...
            <Text className="mb-4 text-sm leading-6 text-black">
              These standout deals showcase successful execution of our sales strategy.
              Understanding the factors behind these wins can help replicate this success across the
              pipeline.
            </Text>
            <Section className="my-4">
              <div className="rounded-lg border border-solid border-gray-200 p-4">
            ...
            <Text className="mb-4 text-sm leading-6 text-black">
              Key performance indicators show positive momentum across critical metrics. These
              trends reflect the effectiveness of our current sales strategies and highlight areas
            ...
            <Text className="mb-4 text-sm leading-6 text-black">
              Based on current performance and trends, we've identified key actions to maintain
              momentum and drive continued growth. Implementing these steps will help optimize your
            ...
            <Text className="mb-4 mt-8 text-sm leading-6 text-black">
              Keep up the excellent work! Regular review of these metrics and proactive
              implementation of recommended steps will help maintain this positive momentum and
              drive even better results in the coming period.
            </Text>
