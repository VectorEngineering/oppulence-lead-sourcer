...
function EventsTableContainer() {
  ...
  const requiresUpgrade = (plan === 'free' || plan === 'pro') && !conversionEnabled
    ...
    <EventsTable
      ...
      upgradeOverlay={
        <EmptyState
          ...
          description={`Want more data on your link ${
            selectedTab === 'clicks' ? 'clicks & QR code scans' : selectedTab
          }? Upgrade to our Business Plan to get a detailed, real-time stream of events in your workspace.`}
