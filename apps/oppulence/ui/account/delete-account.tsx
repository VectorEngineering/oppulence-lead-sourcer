    ...
    <div className="rounded-lg border border-red-600 bg-white">
      ...
      <div className="flex flex-col space-y-3 p-5 sm:p-10">
        ...
        <p className="text-sm text-gray-500">
          Permanently delete your {platform.company} account, all of your workspaces, links and
          their respective stats. This action cannot be undone - please proceed with caution.
        </p>
      </div>
