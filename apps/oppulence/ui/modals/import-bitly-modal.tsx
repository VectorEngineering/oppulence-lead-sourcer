...
function ImportBitlyModal({
  ...
  const {
    ...
    workspaceId && showImportBitlyModal && `/api/workspaces/${workspaceId}/import/bitly`,
    fetcher,
    {
      onError: err => {
    ...
    >
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-8 sm:px-16">
        ...
        <p className="text-center text-sm text-gray-500">
          Easily import all your existing Bitly links into {platform.company} with just a few
          clicks.
        </p>
      </div>
            ...
            <div className="divide-y divide-gray-200">
              {groups.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center gap-2 pb-2">
                  ...
                  <p className="text-center text-sm text-gray-500">
                    It looks like you don't have any Bitly groups with custom domains (non bit.ly
                    domains).
                  </p>
                </div>
              )}
