    ...
    <Modal showModal={showDeleteWorkspaceModal} setShowModal={setShowDeleteWorkspaceModal}>
      <div className="flex flex-col items-center justify-center space-y-3 border-b border-gray-200 px-4 py-4 pt-8 sm:px-16">
        ...
        <p className="text-center text-sm text-gray-500">
          Warning: This will permanently delete your workspace, custom domain, and all associated
      ...
      >
        <div>
          <label htmlFor="workspace-slug" className="block text-sm font-medium text-gray-700">
            Enter the workspace slug <span className="font-semibold text-black">{slug}</span> to
            continue:
          </label>
        ...
        <div>
          <label htmlFor="verification" className="block text-sm text-gray-700">
            To verify, type{' '}
            <span className="font-semibold text-black">confirm delete workspace</span> below
          </label>
          <div className="relative mt-1 rounded-md shadow-sm">
            <input
              type="text"
