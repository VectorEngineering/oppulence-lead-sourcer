      ...
      <div className="flex items-start space-x-3">
        <div className="flex-1">
          <p className="font-medium text-gray-900 dark:text-gray-100">
            On <span className="text-blue-600 dark:text-blue-400">{platform.company}</span>, team
            collaboration is essential for effective spend management and maintaining financial
            oversight across your organization.
          </p>
        </div>
      </div>
