    ...
    <Card className="min-h-[200px] max-w-lg space-y-3 p-[5%] text-sm">
      <div className="flex items-start space-x-3">
        <div className="flex-1">
          <p className="font-medium text-gray-900 dark:text-gray-100">
            ...
            <span className="italic">Workspace</span> is a dedicated place to manage and control
            your business' spending and expenses.
          </p>
        </div>
      </div>
      ...
      <div className="border-t border-gray-200 pt-2 dark:border-gray-700">
        <p className="text-gray-700 dark:text-gray-300">
          Think of it as a <span className="font-semibold">Team</span> or{' '}
          <span className="font-semibold">Organization</span> where you can invite your teammates to
          collaborate and maintain oversight over company spending.
        </p>
      </div>
