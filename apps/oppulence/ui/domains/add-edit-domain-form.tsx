...
import { Crown, Milestone, QrCode, Search, TextCursorInput } from 'lucide-react'
          ...
          <div className="mt-2">
            <div
              className={cn(
                ...
                currentStatusProps.className || 'bg-neutral-200 text-neutral-500'
              )}
            >
              ...
              return (
                <div key={id}>
                  ...
                  <label className="flex items-center justify-between gap-4">
                    ...
                    <Switch
                      checked={showOption}
                      fn={(checked: boolean | ((prevState: boolean) => boolean)) => {
