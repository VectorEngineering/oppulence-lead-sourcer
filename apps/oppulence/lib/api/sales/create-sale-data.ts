import { Prisma, Program, SaleStatus } from '@dub/prisma-oppulence/client'
...
export const createSaleData = ({
  ...
  const commissionAmount =
    partner.commissionAmount !== null ? partner.commissionAmount : program.commissionAmount
  ...
  return {
    ...
    recurringCommission:
      program.commissionDuration && program.commissionDuration > 1 ? true : false,
