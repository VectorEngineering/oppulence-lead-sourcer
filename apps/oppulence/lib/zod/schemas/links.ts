...
export const createLinkBodySchema = z.object({
  ...
  key: z
    ...
    .max(190)
    .optional()
    .describe('The short link slug. If not provided, a random 7-character slug will be generated.'),
  externalId: z
    .string()
    .min(1)
    .max(255)
  ...
  password: z
    .string()
    .nullish()
    .describe('The password required to access the destination URL of the short link.'),
  proxy: z
    .boolean()
    .optional()
    .default(false)
  ...
  ios: parseUrlSchema
    .nullish()
    .describe('The iOS destination URL for the short link for iOS device targeting.'),
  android: parseUrlSchema
    .nullish()
    .describe('The Android destination URL for the short link for Android device targeting.'),
  geo: z
...
export const LinkSchema = z
  .object({
    ...
    expiresAt: z
      .string()
      .nullable()
      .describe('The date and time when the short link will expire in ISO-8601 format.'),
    expiredUrl: z
      .string()
      .url()
      .nullable()
    ...
    webhookIds: z
      .array(z.string())
      .describe('The IDs of the webhooks that the short link is associated with.'),
    ...
    saleAmount: z
      .number()
      .default(0)
      .describe('The total dollar amount of sales the short links has generated (in cents).'),
