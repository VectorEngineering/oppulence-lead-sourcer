...
export const getQRCodeQuerySchema = z.object({
  ...
  logo: z
    .string()
    .optional()
    .describe('The logo to include in the QR code. Can only be used with a paid plan on Dub.co.'),
  size: z.coerce
    .number()
    .optional()
    .default(600)
    .describe('The size of the QR code in pixels. Defaults to `600` if not provided.'),
  level: z
    .enum(QR_LEVELS)
    .optional()
    .default('L')
