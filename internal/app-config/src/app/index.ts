...
const sharedTitle = 'Vector Platform | Your Personal Financial Assistant'
...
/**
 * Configuration object for the Vector Platform platform tailored for businesses, particularly those in cyclical industries.
 *
 * This configuration defines platform-wide settings, pricing plans, navigation, metadata, and financial engine details for
 * Vector Platform, a platform designed to empower businesses with advanced financial analytics and AI-powered insights.
 *
...
export const BusinessConfig: SiteConfig = {
    ...
    email: { from: 'Vector Platform <founders@inbox.getvector.app>' },
    title: sharedTitle,
    description: sharedDescription,
    platformUrl: 'https://app-business.getvector.app',
    webUrl: 'https://getvector.app',
    desktopUrl: 'solomonai://',
    dubProjectSlug: 'vector',
    mfaIssuer: 'app-business.getvector.app',
    ...
    supportEmail: 'yoanyomba@vector.co',
    helpUrl: 'https:/vector.io',
     ...
     */
    metadata: {
        metadataBase: new URL('https://app-business.getvector.app'),
        ...sharedMetadata,
        twitter: sharedMetadata,
        openGraph: {
            ...sharedMetadata,
            url: 'https://app-business.getvector.app',
            siteName: 'Vector Platform',
            locale: 'en_US',
            type: 'website'
        }
    },
    ...
    documentationUrl: 'https://platform-docs.getvector.app'
}
