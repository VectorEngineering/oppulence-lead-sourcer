...
describe('prefixes', () => {
  ...
  it('should generate valid IDs for fintech-specific prefixes', () => {
    const fintechPrefixes = [
      'account', 'transaction', 'payment', 'paymentMethod',
      'customer', 'subscription', 'invoice', 'refund',
      'dispute', 'balance', 'payout', 'bankAccount',
      'card', 'charge', 'transfer', 'wallet',
      'merchantAccount', 'pricing', 'product', 'tax',
      'fee'
    ] as const;
