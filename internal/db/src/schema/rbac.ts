...
import { bigint, datetime, index, mysqlTable, primaryKey, unique, uniqueIndex, varchar } from 'drizzle-orm/mysql-core'
...
export const permissions = mysqlTable(
    ...
    (table) => {
        return {
            ...
            uniqueNamePerWorkspaceIdx: unique('unique_name_per_workspace_idx').on(table.name, table.workspaceId)
        }
    }
)
...
export const rolesPermissions = mysqlTable(
    ...
    (table) => {
        return {
            ...
            uniqueTuplePermissionIdRoleId: unique('unique_tuple_permission_id_role_id').on(table.permissionId, table.roleId)
        }
    }
)
