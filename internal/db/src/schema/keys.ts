...
import { bigint, boolean, datetime, index, int, mysqlEnum, mysqlTable, text, tinyint, uniqueIndex, varchar } from 'drizzle-orm/mysql-core'
...
export const keys = mysqlTable(
    ...
    (table) => ({
        ...
        keyAuthAndDeletedIndex: index('key_auth_id_deleted_at_idx').on(table.keyAuthId, table.deletedAt),
