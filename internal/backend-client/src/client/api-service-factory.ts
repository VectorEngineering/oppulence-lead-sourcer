...
export class ApiServiceFactory {
    ...
    private static middlewares: Middleware[] = [addCustomHeaderMiddleware, errorHandlingMiddleware]
     ...
     * @throws {Error} If the configuration is invalid.
     */
    public static initialize(config: ApiConfig, additionalMiddlewares?: Middleware[]): void {
