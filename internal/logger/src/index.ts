...
const commonFields = z.object({
  ...
  application: z.enum(["api", "semantic-cache", "agent", "logdrain", "vault", "payments", "accounts", "transactions", "fraud-detection", "kyc", "trading", "portfolio", "risk-management", "compliance", "reporting"]),
