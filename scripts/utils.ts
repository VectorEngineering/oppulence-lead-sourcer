 ...
 */
export async function replaceInFile(filePath: string, searchReplace: Record<string, string>, ignoredFiles: string[] = []): Promise<void> {
 ...
 */
export async function updateNamespaceInPrettierConfig(cwd: string, newNamespace: string): Promise<void> {
