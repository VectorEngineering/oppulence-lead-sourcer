...
export const WorkspaceInvitationUncheckedUpdateManyWithoutWorkspaceNestedInputSchema: z.ZodType<Prisma.WorkspaceInvitationUncheckedUpdateManyWithoutWorkspaceNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => WorkspaceInvitationCreateWithoutWorkspaceInputSchema),
                    z.lazy(() => WorkspaceInvitationCreateWithoutWorkspaceInputSchema).array(),
                    z.lazy(() => WorkspaceInvitationUncheckedCreateWithoutWorkspaceInputSchema),
                    z.lazy(() => WorkspaceInvitationUncheckedCreateWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => WorkspaceInvitationCreateOrConnectWithoutWorkspaceInputSchema),
                    z.lazy(() => WorkspaceInvitationCreateOrConnectWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => WorkspaceInvitationUpsertWithWhereUniqueWithoutWorkspaceInputSchema),
                    z.lazy(() => WorkspaceInvitationUpsertWithWhereUniqueWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => WorkspaceInvitationCreateManyWorkspaceInputEnvelopeSchema).optional(),
            set: z
                .union([
                    z.lazy(() => WorkspaceInvitationWhereUniqueInputSchema),
                    z.lazy(() => WorkspaceInvitationWhereUniqueInputSchema).array()
                ])
                .optional(),
            disconnect: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => WorkspaceInvitationUpdateWithWhereUniqueWithoutWorkspaceInputSchema),
                    z.lazy(() => WorkspaceInvitationUpdateWithWhereUniqueWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => WorkspaceInvitationUpdateManyWithWhereWithoutWorkspaceInputSchema),
                    z.lazy(() => WorkspaceInvitationUpdateManyWithWhereWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
                    z.lazy(() => WorkspaceInvitationScalarWhereInputSchema),
                    z.lazy(() => WorkspaceInvitationScalarWhereInputSchema).array()
                ])
                .optional()
        })
        .strict()

export default WorkspaceInvitationUncheckedUpdateManyWithoutWorkspaceNestedInputSchema
