...
export const WorkspaceOrderByRelevanceInputSchema: z.ZodType<Prisma.WorkspaceOrderByRelevanceInput> = z
    .object({
        fields: z.union([
            z.lazy(() => WorkspaceOrderByRelevanceFieldEnumSchema),
            z.lazy(() => WorkspaceOrderByRelevanceFieldEnumSchema).array()
        ]),
