...
export const WorkspaceUpdateManyWithoutOwnerNestedInputSchema: z.ZodType<Prisma.WorkspaceUpdateManyWithoutOwnerNestedInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => WorkspaceCreateWithoutOwnerInputSchema),
                z.lazy(() => WorkspaceCreateWithoutOwnerInputSchema).array(),
                z.lazy(() => WorkspaceUncheckedCreateWithoutOwnerInputSchema),
                z.lazy(() => WorkspaceUncheckedCreateWithoutOwnerInputSchema).array()
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => WorkspaceCreateOrConnectWithoutOwnerInputSchema),
                z.lazy(() => WorkspaceCreateOrConnectWithoutOwnerInputSchema).array()
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => WorkspaceUpsertWithWhereUniqueWithoutOwnerInputSchema),
                z.lazy(() => WorkspaceUpsertWithWhereUniqueWithoutOwnerInputSchema).array()
            ])
            .optional(),
        ...
        disconnect: z
            .union([z.lazy(() => WorkspaceWhereUniqueInputSchema), z.lazy(() => WorkspaceWhereUniqueInputSchema).array()])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => WorkspaceUpdateWithWhereUniqueWithoutOwnerInputSchema),
                z.lazy(() => WorkspaceUpdateWithWhereUniqueWithoutOwnerInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => WorkspaceUpdateManyWithWhereWithoutOwnerInputSchema),
                z.lazy(() => WorkspaceUpdateManyWithWhereWithoutOwnerInputSchema).array()
            ])
            .optional(),
        deleteMany: z
            .union([z.lazy(() => WorkspaceScalarWhereInputSchema), z.lazy(() => WorkspaceScalarWhereInputSchema).array()])
            .optional()
    })
    .strict()

export default WorkspaceUpdateManyWithoutOwnerNestedInputSchema
