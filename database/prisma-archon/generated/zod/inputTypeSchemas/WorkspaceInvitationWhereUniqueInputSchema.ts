...
export const WorkspaceInvitationWhereUniqueInputSchema: z.ZodType<Prisma.WorkspaceInvitationWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => WorkspaceInvitationWhereInputSchema), z.lazy(() => WorkspaceInvitationWhereInputSchema).array()])
                    .optional(),
                OR: z
                    .lazy(() => WorkspaceInvitationWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([z.lazy(() => WorkspaceInvitationWhereInputSchema), z.lazy(() => WorkspaceInvitationWhereInputSchema).array()])
