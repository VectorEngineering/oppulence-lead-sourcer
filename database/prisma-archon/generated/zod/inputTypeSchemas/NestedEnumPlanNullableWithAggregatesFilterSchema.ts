...
export const NestedEnumPlanNullableWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumPlanNullableWithAggregatesFilter> = z
    .object({
        equals: z
            .lazy(() => PlanSchema)
            .optional()
...
export default NestedEnumPlanNullableWithAggregatesFilterSchema
