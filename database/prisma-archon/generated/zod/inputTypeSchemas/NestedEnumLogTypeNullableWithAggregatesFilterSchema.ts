...
export const NestedEnumLogTypeNullableWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumLogTypeNullableWithAggregatesFilter> = z
    .object({
        equals: z
            .lazy(() => LogTypeSchema)
            .optional()
        ...
        notIn: z
            ...
            .nullable(),
        not: z
            .union([z.lazy(() => LogTypeSchema), z.lazy(() => NestedEnumLogTypeNullableWithAggregatesFilterSchema)])
            .optional()
            .nullable(),
