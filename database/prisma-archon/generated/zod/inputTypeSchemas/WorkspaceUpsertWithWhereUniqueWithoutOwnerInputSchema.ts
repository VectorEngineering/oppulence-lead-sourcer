...
export const WorkspaceUpsertWithWhereUniqueWithoutOwnerInputSchema: z.ZodType<Prisma.WorkspaceUpsertWithWhereUniqueWithoutOwnerInput> = z
    .object({
        where: z.lazy(() => WorkspaceWhereUniqueInputSchema),
        update: z.union([
            z.lazy(() => WorkspaceUpdateWithoutOwnerInputSchema),
            z.lazy(() => WorkspaceUncheckedUpdateWithoutOwnerInputSchema)
        ]),
        create: z.union([
