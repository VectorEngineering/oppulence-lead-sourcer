...
export const EndpointUpdateOneRequiredWithoutLogsNestedInputSchema: z.ZodType<Prisma.EndpointUpdateOneRequiredWithoutLogsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => EndpointUpdateToOneWithWhereWithoutLogsInputSchema),z.lazy(() => EndpointUpdateWithoutLogsInputSchema),z.lazy(() => EndpointUncheckedUpdateWithoutLogsInputSchema) ]).optional(),
}).strict();
