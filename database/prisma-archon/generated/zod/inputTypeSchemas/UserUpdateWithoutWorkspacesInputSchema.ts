...
import { WorkspaceMemberUpdateManyWithoutUserNestedInputSchema } from './WorkspaceMemberUpdateManyWithoutUserNestedInputSchema'
import { EndpointUpdateManyWithoutUserNestedInputSchema } from './EndpointUpdateManyWithoutUserNestedInputSchema'

export const UserUpdateWithoutWorkspacesInputSchema: z.ZodType<Prisma.UserUpdateWithoutWorkspacesInput> = z
    .object({
        ...
        plan: z
            .union([z.lazy(() => PlanSchema), z.lazy(() => NullableEnumPlanFieldUpdateOperationsInputSchema)])
            .optional()
            .nullable(),
        stripeCustomerId: z
            .union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputSchema)])
        ...
        useCase: z
            ...
            .optional()
            .nullable(),
        workspaceMembers: z.lazy(() => WorkspaceMemberUpdateManyWithoutUserNestedInputSchema).optional(),
        endpoints: z.lazy(() => EndpointUpdateManyWithoutUserNestedInputSchema).optional()
    })
    .strict()
