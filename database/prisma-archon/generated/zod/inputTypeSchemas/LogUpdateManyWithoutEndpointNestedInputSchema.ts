...
export const LogUpdateManyWithoutEndpointNestedInputSchema: z.ZodType<Prisma.LogUpdateManyWithoutEndpointNestedInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => LogCreateWithoutEndpointInputSchema),
                z.lazy(() => LogCreateWithoutEndpointInputSchema).array(),
                z.lazy(() => LogUncheckedCreateWithoutEndpointInputSchema),
                z.lazy(() => LogUncheckedCreateWithoutEndpointInputSchema).array()
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => LogCreateOrConnectWithoutEndpointInputSchema),
                z.lazy(() => LogCreateOrConnectWithoutEndpointInputSchema).array()
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => LogUpsertWithWhereUniqueWithoutEndpointInputSchema),
                z.lazy(() => LogUpsertWithWhereUniqueWithoutEndpointInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LogUpdateWithWhereUniqueWithoutEndpointInputSchema),
                z.lazy(() => LogUpdateWithWhereUniqueWithoutEndpointInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => LogUpdateManyWithWhereWithoutEndpointInputSchema),
                z.lazy(() => LogUpdateManyWithWhereWithoutEndpointInputSchema).array()
            ])
            .optional(),
...
export default LogUpdateManyWithoutEndpointNestedInputSchema
