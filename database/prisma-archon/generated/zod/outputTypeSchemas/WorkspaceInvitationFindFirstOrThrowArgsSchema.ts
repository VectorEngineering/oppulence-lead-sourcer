...
export const WorkspaceInvitationFindFirstOrThrowArgsSchema: z.ZodType<Prisma.WorkspaceInvitationFindFirstOrThrowArgs> = z
    .object({
        ...
        orderBy: z
            .union([WorkspaceInvitationOrderByWithRelationInputSchema.array(), WorkspaceInvitationOrderByWithRelationInputSchema])
            .optional(),
...
export default WorkspaceInvitationFindFirstOrThrowArgsSchema
