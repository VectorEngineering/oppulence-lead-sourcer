...
export const EndpointCreateArgsSchema: z.ZodType<Prisma.EndpointCreateArgs> = z.object({
  select: EndpointSelectSchema.optional(),
  include: EndpointIncludeSchema.optional(),
  data: z.union([ EndpointCreateInputSchema,EndpointUncheckedCreateInputSchema ]),
}).strict() ;

export default EndpointCreateArgsSchema;
