...
export const InvoiceAttachmentGroupByArgsSchema: z.ZodType<Prisma.InvoiceAttachmentGroupByArgs> = z
    .object({
        where: InvoiceAttachmentWhereInputSchema.optional(),
        orderBy: z
            .union([InvoiceAttachmentOrderByWithAggregationInputSchema.array(), InvoiceAttachmentOrderByWithAggregationInputSchema])
            .optional(),
