...
export const PartnerInviteUpsertArgsSchema: z.ZodType<Prisma.PartnerInviteUpsertArgs> = z.object({
  ...
  create: z.union([ PartnerInviteCreateInputSchema,PartnerInviteUncheckedCreateInputSchema ]),
  update: z.union([ PartnerInviteUpdateInputSchema,PartnerInviteUncheckedUpdateInputSchema ]),
}).strict() ;

export default PartnerInviteUpsertArgsSchema;
