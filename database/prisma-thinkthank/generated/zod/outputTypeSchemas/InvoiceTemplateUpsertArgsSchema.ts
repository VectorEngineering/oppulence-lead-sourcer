...
import { InvoiceTemplateCreateInputSchema } from '../inputTypeSchemas/InvoiceTemplateCreateInputSchema'
import { InvoiceTemplateUncheckedCreateInputSchema } from '../inputTypeSchemas/InvoiceTemplateUncheckedCreateInputSchema'
import { InvoiceTemplateUpdateInputSchema } from '../inputTypeSchemas/InvoiceTemplateUpdateInputSchema'
import { InvoiceTemplateUncheckedUpdateInputSchema } from '../inputTypeSchemas/InvoiceTemplateUncheckedUpdateInputSchema'
import { ProjectArgsSchema } from './ProjectArgsSchema'
import { InvoiceFindManyArgsSchema } from './InvoiceFindManyArgsSchema'
import { InvoiceTemplateCountOutputTypeArgsSchema } from './InvoiceTemplateCountOutputTypeArgsSchema'
...
export const InvoiceTemplateUpsertArgsSchema: z.ZodType<Prisma.InvoiceTemplateUpsertArgs> = z
    .object({
        ...
        create: z.union([InvoiceTemplateCreateInputSchema, InvoiceTemplateUncheckedCreateInputSchema]),
        update: z.union([InvoiceTemplateUpdateInputSchema, InvoiceTemplateUncheckedUpdateInputSchema])
    })
    .strict()

export default InvoiceTemplateUpsertArgsSchema
