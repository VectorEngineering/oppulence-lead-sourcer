...
export const ContractVersionCreateArgsSchema: z.ZodType<Prisma.ContractVersionCreateArgs> = z.object({
  select: ContractVersionSelectSchema.optional(),
  include: ContractVersionIncludeSchema.optional(),
  data: z.union([ ContractVersionCreateInputSchema,ContractVersionUncheckedCreateInputSchema ]),
}).strict() ;

export default ContractVersionCreateArgsSchema;
