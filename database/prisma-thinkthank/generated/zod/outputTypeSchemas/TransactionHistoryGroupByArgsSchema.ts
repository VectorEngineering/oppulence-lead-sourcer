...
export const TransactionHistoryGroupByArgsSchema: z.ZodType<Prisma.TransactionHistoryGroupByArgs> = z.object({
  where: TransactionHistoryWhereInputSchema.optional(),
  orderBy: z.union([ TransactionHistoryOrderByWithAggregationInputSchema.array(),TransactionHistoryOrderByWithAggregationInputSchema ]).optional(),
