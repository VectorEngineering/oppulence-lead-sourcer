...
export const InstalledIntegrationCreateArgsSchema: z.ZodType<Prisma.InstalledIntegrationCreateArgs> = z.object({
  select: InstalledIntegrationSelectSchema.optional(),
  include: InstalledIntegrationIncludeSchema.optional(),
  data: z.union([ InstalledIntegrationCreateInputSchema,InstalledIntegrationUncheckedCreateInputSchema ]),
}).strict() ;

export default InstalledIntegrationCreateArgsSchema;
