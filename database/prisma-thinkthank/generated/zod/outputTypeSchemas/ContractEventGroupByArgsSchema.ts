...
export const ContractEventGroupByArgsSchema: z.ZodType<Prisma.ContractEventGroupByArgs> = z
    .object({
        where: ContractEventWhereInputSchema.optional(),
        orderBy: z
            .union([ContractEventOrderByWithAggregationInputSchema.array(), ContractEventOrderByWithAggregationInputSchema])
            .optional(),
