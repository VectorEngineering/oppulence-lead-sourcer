...
export const TransactionEnrichmentGroupByArgsSchema: z.ZodType<Prisma.TransactionEnrichmentGroupByArgs> = z
    .object({
        where: TransactionEnrichmentWhereInputSchema.optional(),
        orderBy: z
            .union([TransactionEnrichmentOrderByWithAggregationInputSchema.array(), TransactionEnrichmentOrderByWithAggregationInputSchema])
            .optional(),
