...
export const TransactionCategoryUpdateArgsSchema: z.ZodType<Prisma.TransactionCategoryUpdateArgs> = z
    .object({
        select: TransactionCategorySelectSchema.optional(),
        include: TransactionCategoryIncludeSchema.optional(),
        data: z.union([TransactionCategoryUpdateInputSchema, TransactionCategoryUncheckedUpdateInputSchema]),
        where: TransactionCategoryWhereUniqueInputSchema
    })
    .strict()

export default TransactionCategoryUpdateArgsSchema
