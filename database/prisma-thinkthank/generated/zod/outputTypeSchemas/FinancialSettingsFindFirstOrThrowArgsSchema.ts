...
export const FinancialSettingsFindFirstOrThrowArgsSchema: z.ZodType<Prisma.FinancialSettingsFindFirstOrThrowArgs> = z
    .object({
        ...
        orderBy: z
            .union([FinancialSettingsOrderByWithRelationInputSchema.array(), FinancialSettingsOrderByWithRelationInputSchema])
            .optional(),
        cursor: FinancialSettingsWhereUniqueInputSchema.optional(),
        take: z.number().optional(),
        skip: z.number().optional(),
        distinct: z.union([FinancialSettingsScalarFieldEnumSchema, FinancialSettingsScalarFieldEnumSchema.array()]).optional()
    })
    .strict()

export default FinancialSettingsFindFirstOrThrowArgsSchema
