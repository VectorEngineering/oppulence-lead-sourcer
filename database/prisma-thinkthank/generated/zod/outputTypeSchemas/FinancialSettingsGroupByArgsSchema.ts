...
export const FinancialSettingsGroupByArgsSchema: z.ZodType<Prisma.FinancialSettingsGroupByArgs> = z
    .object({
        where: FinancialSettingsWhereInputSchema.optional(),
        orderBy: z
            .union([FinancialSettingsOrderByWithAggregationInputSchema.array(), FinancialSettingsOrderByWithAggregationInputSchema])
            .optional(),
