...
export const OAuthRefreshTokenGroupByArgsSchema: z.ZodType<Prisma.OAuthRefreshTokenGroupByArgs> = z
    .object({
        where: OAuthRefreshTokenWhereInputSchema.optional(),
        orderBy: z
            .union([OAuthRefreshTokenOrderByWithAggregationInputSchema.array(), OAuthRefreshTokenOrderByWithAggregationInputSchema])
            .optional(),
