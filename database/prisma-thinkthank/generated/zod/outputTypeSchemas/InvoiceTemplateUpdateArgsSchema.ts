...
export const InvoiceTemplateUpdateArgsSchema: z.ZodType<Prisma.InvoiceTemplateUpdateArgs> = z
    .object({
        select: InvoiceTemplateSelectSchema.optional(),
        include: InvoiceTemplateIncludeSchema.optional(),
        data: z.union([InvoiceTemplateUpdateInputSchema, InvoiceTemplateUncheckedUpdateInputSchema]),
        where: InvoiceTemplateWhereUniqueInputSchema
    })
    .strict()

export default InvoiceTemplateUpdateArgsSchema
