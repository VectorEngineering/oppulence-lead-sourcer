...
export const InboxLabelSelectSchema: z.ZodType<Prisma.InboxLabelSelect> = z.object({
...
export const InboxLabelUpdateArgsSchema: z.ZodType<Prisma.InboxLabelUpdateArgs> = z.object({
  select: InboxLabelSelectSchema.optional(),
  include: InboxLabelIncludeSchema.optional(),
  data: z.union([ InboxLabelUpdateInputSchema,InboxLabelUncheckedUpdateInputSchema ]),
  where: InboxLabelWhereUniqueInputSchema,
}).strict() ;

export default InboxLabelUpdateArgsSchema;
