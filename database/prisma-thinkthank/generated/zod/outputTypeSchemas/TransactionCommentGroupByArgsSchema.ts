...
export const TransactionCommentGroupByArgsSchema: z.ZodType<Prisma.TransactionCommentGroupByArgs> = z
    .object({
        where: TransactionCommentWhereInputSchema.optional(),
        orderBy: z
            .union([TransactionCommentOrderByWithAggregationInputSchema.array(), TransactionCommentOrderByWithAggregationInputSchema])
            .optional(),
