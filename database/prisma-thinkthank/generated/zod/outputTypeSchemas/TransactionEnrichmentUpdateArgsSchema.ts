...
export const TransactionEnrichmentUpdateArgsSchema: z.ZodType<Prisma.TransactionEnrichmentUpdateArgs> = z.object({
  select: TransactionEnrichmentSelectSchema.optional(),
  include: TransactionEnrichmentIncludeSchema.optional(),
  data: z.union([ TransactionEnrichmentUpdateInputSchema,TransactionEnrichmentUncheckedUpdateInputSchema ]),
  where: TransactionEnrichmentWhereUniqueInputSchema,
}).strict() ;

export default TransactionEnrichmentUpdateArgsSchema;
