...
export const OAuthCodeUpdateArgsSchema: z.ZodType<Prisma.OAuthCodeUpdateArgs> = z.object({
  select: OAuthCodeSelectSchema.optional(),
  include: OAuthCodeIncludeSchema.optional(),
  data: z.union([ OAuthCodeUpdateInputSchema,OAuthCodeUncheckedUpdateInputSchema ]),
  where: OAuthCodeWhereUniqueInputSchema,
}).strict() ;

export default OAuthCodeUpdateArgsSchema;
