...
export const DashboardFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.DashboardFindUniqueOrThrowArgs> = z.object({
  select: DashboardSelectSchema.optional(),
  include: DashboardIncludeSchema.optional(),
  where: DashboardWhereUniqueInputSchema,
}).strict() ;

export default DashboardFindUniqueOrThrowArgsSchema;
