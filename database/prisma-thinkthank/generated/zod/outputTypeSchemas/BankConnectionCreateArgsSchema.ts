...
export const BankConnectionCreateArgsSchema: z.ZodType<Prisma.BankConnectionCreateArgs> = z.object({
  select: BankConnectionSelectSchema.optional(),
  include: BankConnectionIncludeSchema.optional(),
  data: z.union([ BankConnectionCreateInputSchema,BankConnectionUncheckedCreateInputSchema ]),
}).strict() ;

export default BankConnectionCreateArgsSchema;
