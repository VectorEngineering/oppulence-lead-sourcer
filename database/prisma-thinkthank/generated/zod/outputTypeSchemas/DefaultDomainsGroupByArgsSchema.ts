...
export const DefaultDomainsGroupByArgsSchema: z.ZodType<Prisma.DefaultDomainsGroupByArgs> = z.object({
  where: DefaultDomainsWhereInputSchema.optional(),
  orderBy: z.union([ DefaultDomainsOrderByWithAggregationInputSchema.array(),DefaultDomainsOrderByWithAggregationInputSchema ]).optional(),
