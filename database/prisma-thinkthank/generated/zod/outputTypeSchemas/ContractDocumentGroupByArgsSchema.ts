...
export const ContractDocumentGroupByArgsSchema: z.ZodType<Prisma.ContractDocumentGroupByArgs> = z
    .object({
        where: ContractDocumentWhereInputSchema.optional(),
        orderBy: z
            .union([ContractDocumentOrderByWithAggregationInputSchema.array(), ContractDocumentOrderByWithAggregationInputSchema])
            .optional(),
