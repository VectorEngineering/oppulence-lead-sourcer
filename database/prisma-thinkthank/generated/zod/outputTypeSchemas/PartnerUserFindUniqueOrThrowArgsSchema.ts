...
export const PartnerUserFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.PartnerUserFindUniqueOrThrowArgs> = z.object({
  select: PartnerUserSelectSchema.optional(),
  include: PartnerUserIncludeSchema.optional(),
  where: PartnerUserWhereUniqueInputSchema,
}).strict() ;

export default PartnerUserFindUniqueOrThrowArgsSchema;
