...
import { BankConnectionFindManyArgsSchema } from './BankConnectionFindManyArgsSchema'
...
import { TransactionEnrichmentFindManyArgsSchema } from './TransactionEnrichmentFindManyArgsSchema'
...
export const ProjectSelectSchema: z.ZodType<Prisma.ProjectSelect> = z
    .object({
        ...
        bankConnections: z.union([z.boolean(), z.lazy(() => BankConnectionFindManyArgsSchema)]).optional(),
        ...
        TransactionAttachment: z.union([z.boolean(), z.lazy(() => TransactionAttachmentFindManyArgsSchema)]).optional(),
        TransactionCategory: z.union([z.boolean(), z.lazy(() => TransactionCategoryFindManyArgsSchema)]).optional(),
        TransactionEnrichment: z.union([z.boolean(), z.lazy(() => TransactionEnrichmentFindManyArgsSchema)]).optional(),
...
export default ProjectFindUniqueArgsSchema
