...
export const ContractApprovalGroupByArgsSchema: z.ZodType<Prisma.ContractApprovalGroupByArgs> = z.object({
  where: ContractApprovalWhereInputSchema.optional(),
  orderBy: z.union([ ContractApprovalOrderByWithAggregationInputSchema.array(),ContractApprovalOrderByWithAggregationInputSchema ]).optional(),
