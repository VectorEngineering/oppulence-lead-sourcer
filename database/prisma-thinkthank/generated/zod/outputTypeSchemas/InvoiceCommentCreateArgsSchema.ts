...
export const InvoiceCommentCreateArgsSchema: z.ZodType<Prisma.InvoiceCommentCreateArgs> = z.object({
  select: InvoiceCommentSelectSchema.optional(),
  include: InvoiceCommentIncludeSchema.optional(),
  data: z.union([ InvoiceCommentCreateInputSchema,InvoiceCommentUncheckedCreateInputSchema ]),
}).strict() ;

export default InvoiceCommentCreateArgsSchema;
