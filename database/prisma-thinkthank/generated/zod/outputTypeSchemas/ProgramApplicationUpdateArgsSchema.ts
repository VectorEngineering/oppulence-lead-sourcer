...
export const ProgramApplicationUpdateArgsSchema: z.ZodType<Prisma.ProgramApplicationUpdateArgs> = z.object({
  select: ProgramApplicationSelectSchema.optional(),
  include: ProgramApplicationIncludeSchema.optional(),
  data: z.union([ ProgramApplicationUpdateInputSchema,ProgramApplicationUncheckedUpdateInputSchema ]),
  where: ProgramApplicationWhereUniqueInputSchema,
}).strict() ;

export default ProgramApplicationUpdateArgsSchema;
