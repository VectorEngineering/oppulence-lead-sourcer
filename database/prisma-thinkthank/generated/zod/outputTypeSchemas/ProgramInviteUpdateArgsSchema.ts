...
export const ProgramInviteUpdateArgsSchema: z.ZodType<Prisma.ProgramInviteUpdateArgs> = z.object({
  select: ProgramInviteSelectSchema.optional(),
  include: ProgramInviteIncludeSchema.optional(),
  data: z.union([ ProgramInviteUpdateInputSchema,ProgramInviteUncheckedUpdateInputSchema ]),
  where: ProgramInviteWhereUniqueInputSchema,
}).strict() ;

export default ProgramInviteUpdateArgsSchema;
