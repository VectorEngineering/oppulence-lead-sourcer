...
export const InvoiceTemplateGroupByArgsSchema: z.ZodType<Prisma.InvoiceTemplateGroupByArgs> = z.object({
  where: InvoiceTemplateWhereInputSchema.optional(),
  orderBy: z.union([ InvoiceTemplateOrderByWithAggregationInputSchema.array(),InvoiceTemplateOrderByWithAggregationInputSchema ]).optional(),
