...
export const ContractTemplateCreateArgsSchema: z.ZodType<Prisma.ContractTemplateCreateArgs> = z.object({
  select: ContractTemplateSelectSchema.optional(),
  include: ContractTemplateIncludeSchema.optional(),
  data: z.union([ ContractTemplateCreateInputSchema,ContractTemplateUncheckedCreateInputSchema ]),
}).strict() ;

export default ContractTemplateCreateArgsSchema;
