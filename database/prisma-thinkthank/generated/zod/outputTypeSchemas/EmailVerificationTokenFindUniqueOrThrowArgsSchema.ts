...
export const EmailVerificationTokenFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.EmailVerificationTokenFindUniqueOrThrowArgs> = z
    .object({
...
export default EmailVerificationTokenFindUniqueOrThrowArgsSchema
