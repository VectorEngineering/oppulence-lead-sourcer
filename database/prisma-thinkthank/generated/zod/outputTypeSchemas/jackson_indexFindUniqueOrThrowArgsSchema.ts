...
export const jackson_indexFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.jackson_indexFindUniqueOrThrowArgs> = z.object({
  select: jackson_indexSelectSchema.optional(),
  where: jackson_indexWhereUniqueInputSchema,
}).strict() ;

export default jackson_indexFindUniqueOrThrowArgsSchema;
