...
export const ProgramEnrollmentGroupByArgsSchema: z.ZodType<Prisma.ProgramEnrollmentGroupByArgs> = z
    .object({
        where: ProgramEnrollmentWhereInputSchema.optional(),
        orderBy: z
            .union([ProgramEnrollmentOrderByWithAggregationInputSchema.array(), ProgramEnrollmentOrderByWithAggregationInputSchema])
            .optional(),
