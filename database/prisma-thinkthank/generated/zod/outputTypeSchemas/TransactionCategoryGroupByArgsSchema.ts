...
export const TransactionCategoryGroupByArgsSchema: z.ZodType<Prisma.TransactionCategoryGroupByArgs> = z.object({
  where: TransactionCategoryWhereInputSchema.optional(),
  orderBy: z.union([ TransactionCategoryOrderByWithAggregationInputSchema.array(),TransactionCategoryOrderByWithAggregationInputSchema ]).optional(),
