...
export const TransactionReconciliationMatchUpdateManyArgsSchema: z.ZodType<Prisma.TransactionReconciliationMatchUpdateManyArgs> = z
    .object({
        data: z.union([
            TransactionReconciliationMatchUpdateManyMutationInputSchema,
            TransactionReconciliationMatchUncheckedUpdateManyInputSchema
        ]),
