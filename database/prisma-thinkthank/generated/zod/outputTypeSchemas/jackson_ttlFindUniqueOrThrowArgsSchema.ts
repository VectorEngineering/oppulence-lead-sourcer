...
export const jackson_ttlFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.jackson_ttlFindUniqueOrThrowArgs> = z.object({
  select: jackson_ttlSelectSchema.optional(),
  where: jackson_ttlWhereUniqueInputSchema,
}).strict() ;

export default jackson_ttlFindUniqueOrThrowArgsSchema;
