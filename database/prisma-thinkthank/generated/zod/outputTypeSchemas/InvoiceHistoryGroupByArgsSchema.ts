...
export const InvoiceHistoryGroupByArgsSchema: z.ZodType<Prisma.InvoiceHistoryGroupByArgs> = z
    .object({
        where: InvoiceHistoryWhereInputSchema.optional(),
        orderBy: z
            .union([InvoiceHistoryOrderByWithAggregationInputSchema.array(), InvoiceHistoryOrderByWithAggregationInputSchema])
            .optional(),
