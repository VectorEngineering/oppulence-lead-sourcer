...
export const TransactionAttachmentGroupByArgsSchema: z.ZodType<Prisma.TransactionAttachmentGroupByArgs> = z.object({
  where: TransactionAttachmentWhereInputSchema.optional(),
  orderBy: z.union([ TransactionAttachmentOrderByWithAggregationInputSchema.array(),TransactionAttachmentOrderByWithAggregationInputSchema ]).optional(),
