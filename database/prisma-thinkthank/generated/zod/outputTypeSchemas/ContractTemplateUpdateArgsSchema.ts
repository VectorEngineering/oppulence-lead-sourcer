...
export const ContractTemplateUpdateArgsSchema: z.ZodType<Prisma.ContractTemplateUpdateArgs> = z.object({
  select: ContractTemplateSelectSchema.optional(),
  include: ContractTemplateIncludeSchema.optional(),
  data: z.union([ ContractTemplateUpdateInputSchema,ContractTemplateUncheckedUpdateInputSchema ]),
  where: ContractTemplateWhereUniqueInputSchema,
}).strict() ;

export default ContractTemplateUpdateArgsSchema;
