...
export const DashboardCreateArgsSchema: z.ZodType<Prisma.DashboardCreateArgs> = z.object({
  select: DashboardSelectSchema.optional(),
  include: DashboardIncludeSchema.optional(),
  data: z.union([ DashboardCreateInputSchema,DashboardUncheckedCreateInputSchema ]),
}).strict() ;

export default DashboardCreateArgsSchema;
