...
export const DocumentAnnotationFindFirstOrThrowArgsSchema: z.ZodType<Prisma.DocumentAnnotationFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ DocumentAnnotationOrderByWithRelationInputSchema.array(),DocumentAnnotationOrderByWithRelationInputSchema ]).optional(),
...
export default DocumentAnnotationFindFirstOrThrowArgsSchema;
