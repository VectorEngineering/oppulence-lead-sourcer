...
export const ProgramEnrollmentUpdateArgsSchema: z.ZodType<Prisma.ProgramEnrollmentUpdateArgs> = z.object({
  select: ProgramEnrollmentSelectSchema.optional(),
  include: ProgramEnrollmentIncludeSchema.optional(),
  data: z.union([ ProgramEnrollmentUpdateInputSchema,ProgramEnrollmentUncheckedUpdateInputSchema ]),
  where: ProgramEnrollmentWhereUniqueInputSchema,
}).strict() ;

export default ProgramEnrollmentUpdateArgsSchema;
