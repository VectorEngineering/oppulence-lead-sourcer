...
export const BankConnectionSettingsUpdateArgsSchema: z.ZodType<Prisma.BankConnectionSettingsUpdateArgs> = z.object({
  select: BankConnectionSettingsSelectSchema.optional(),
  include: BankConnectionSettingsIncludeSchema.optional(),
  data: z.union([ BankConnectionSettingsUpdateInputSchema,BankConnectionSettingsUncheckedUpdateInputSchema ]),
  where: BankConnectionSettingsWhereUniqueInputSchema,
}).strict() ;

export default BankConnectionSettingsUpdateArgsSchema;
