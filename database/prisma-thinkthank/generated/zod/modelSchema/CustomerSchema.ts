...
export const CustomerSchema = z.object({
  ...
  creditLimit: z.instanceof(Prisma.Decimal, { message: "Field 'creditLimit' must be a Decimal. Location: ['Models', 'Customer']"}).nullish(),
  ...
  latePaymentPenalty: z.instanceof(Prisma.Decimal, { message: "Field 'latePaymentPenalty' must be a Decimal. Location: ['Models', 'Customer']"}).nullish(),
  ...
  withholdingTaxRate: z.instanceof(Prisma.Decimal, { message: "Field 'withholdingTaxRate' must be a Decimal. Location: ['Models', 'Customer']"}).nullish(),
  taxDocuments: JsonValueSchema.nullable(),
  availableCredit: z.instanceof(Prisma.Decimal, { message: "Field 'availableCredit' must be a Decimal. Location: ['Models', 'Customer']"}).nullish(),
  riskRating: z.string().nullish(),
  insurancePolicy: z.string().nullish(),
  insuranceExpiry: z.coerce.date().nullish(),
  insuranceCoverage: z.instanceof(Prisma.Decimal, { message: "Field 'insuranceCoverage' must be a Decimal. Location: ['Models', 'Customer']"}).nullish(),
  earlyPaymentDiscount: z.instanceof(Prisma.Decimal, { message: "Field 'earlyPaymentDiscount' must be a Decimal. Location: ['Models', 'Customer']"}).nullish(),
  minimumOrderValue: z.instanceof(Prisma.Decimal, { message: "Field 'minimumOrderValue' must be a Decimal. Location: ['Models', 'Customer']"}).nullish(),
  maximumOrderValue: z.instanceof(Prisma.Decimal, { message: "Field 'maximumOrderValue' must be a Decimal. Location: ['Models', 'Customer']"}).nullish(),
  ...
  lifetimeValue: z.instanceof(Prisma.Decimal, { message: "Field 'lifetimeValue' must be a Decimal. Location: ['Models', 'Customer']"}).nullish(),
  acquisitionCost: z.instanceof(Prisma.Decimal, { message: "Field 'acquisitionCost' must be a Decimal. Location: ['Models', 'Customer']"}).nullish(),
  retentionRate: z.instanceof(Prisma.Decimal, { message: "Field 'retentionRate' must be a Decimal. Location: ['Models', 'Customer']"}).nullish(),
