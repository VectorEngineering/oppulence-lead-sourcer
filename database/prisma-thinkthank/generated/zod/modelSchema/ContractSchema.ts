...
export const ContractSchema = z.object({
    ...
    terminationFee: z
        .instanceof(Prisma.Decimal, { message: "Field 'terminationFee' must be a Decimal. Location: ['Models', 'Contract']" })
        .nullish(),
    ...
    limitationOfLiability: z
        .instanceof(Prisma.Decimal, { message: "Field 'limitationOfLiability' must be a Decimal. Location: ['Models', 'Contract']" })
        .nullish(),
...
export const ContractOptionalDefaultsSchema = ContractSchema.merge(
    z.object({
