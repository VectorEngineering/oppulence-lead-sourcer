...
export const InvoiceUpdateOneWithoutPayoutsNestedInputSchema: z.ZodType<Prisma.InvoiceUpdateOneWithoutPayoutsNestedInput> = z
    .object({
        create: z
        ...
        update: z
            .union([
                z.lazy(() => InvoiceUpdateToOneWithWhereWithoutPayoutsInputSchema),
