...
export const InboxUpdateOneRequiredWithoutLabelsNestedInputSchema: z.ZodType<Prisma.InboxUpdateOneRequiredWithoutLabelsNestedInput> = z
    .object({
        create: z
        ...
        update: z
            .union([
                z.lazy(() => InboxUpdateToOneWithWhereWithoutLabelsInputSchema),
                z.lazy(() => InboxUpdateWithoutLabelsInputSchema),
                z.lazy(() => InboxUncheckedUpdateWithoutLabelsInputSchema)
            ])
            .optional()
    })
    .strict()
