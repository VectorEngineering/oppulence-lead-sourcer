...
export const ProjectUsersCreateNestedOneWithoutNotificationPreferenceInputSchema: z.ZodType<Prisma.ProjectUsersCreateNestedOneWithoutNotificationPreferenceInput> =
    z
        .object({
            create: z
                .union([
