...
export const TransactionCommentUncheckedCreateNestedManyWithoutTransactionInputSchema: z.ZodType<Prisma.TransactionCommentUncheckedCreateNestedManyWithoutTransactionInput> =
    z
        .object({
            create: z
                .union([
