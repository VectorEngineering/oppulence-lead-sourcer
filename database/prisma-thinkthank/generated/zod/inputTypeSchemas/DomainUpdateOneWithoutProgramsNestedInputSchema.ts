...
export const DomainUpdateOneWithoutProgramsNestedInputSchema: z.ZodType<Prisma.DomainUpdateOneWithoutProgramsNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => DomainCreateWithoutProgramsInputSchema), z.lazy(() => DomainUncheckedCreateWithoutProgramsInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => DomainUpdateToOneWithWhereWithoutProgramsInputSchema),
                z.lazy(() => DomainUpdateWithoutProgramsInputSchema),
                z.lazy(() => DomainUncheckedUpdateWithoutProgramsInputSchema)
            ])
            .optional()
    })
    .strict()
