...
export const ProgramUncheckedUpdateManyWithoutWorkspaceNestedInputSchema: z.ZodType<Prisma.ProgramUncheckedUpdateManyWithoutWorkspaceNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => ProgramUpsertWithWhereUniqueWithoutWorkspaceInputSchema),
                    z.lazy(() => ProgramUpsertWithWhereUniqueWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => ProgramUpdateWithWhereUniqueWithoutWorkspaceInputSchema),
                    z.lazy(() => ProgramUpdateWithWhereUniqueWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => ProgramUpdateManyWithWhereWithoutWorkspaceInputSchema),
                    z.lazy(() => ProgramUpdateManyWithWhereWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default ProgramUncheckedUpdateManyWithoutWorkspaceNestedInputSchema
