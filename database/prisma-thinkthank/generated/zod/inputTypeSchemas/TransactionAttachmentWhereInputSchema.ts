...
export const TransactionAttachmentWhereInputSchema: z.ZodType<Prisma.TransactionAttachmentWhereInput> = z
    .object({
        AND: z
            .union([z.lazy(() => TransactionAttachmentWhereInputSchema), z.lazy(() => TransactionAttachmentWhereInputSchema).array()])
            .optional(),
        OR: z
