...
export const TransactionCategoryWhereUniqueInputSchema: z.ZodType<Prisma.TransactionCategoryWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
...
.and(z.object({
  ...
  parent: z.union([ z.lazy(() => TransactionCategoryNullableRelationFilterSchema),z.lazy(() => TransactionCategoryWhereInputSchema) ]).optional().nullable(),
