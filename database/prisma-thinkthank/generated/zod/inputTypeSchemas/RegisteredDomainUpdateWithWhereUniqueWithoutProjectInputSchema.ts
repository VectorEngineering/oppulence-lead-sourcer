...
export const RegisteredDomainUpdateWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.RegisteredDomainUpdateWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => RegisteredDomainWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => RegisteredDomainUpdateWithoutProjectInputSchema),z.lazy(() => RegisteredDomainUncheckedUpdateWithoutProjectInputSchema) ]),
}).strict();
