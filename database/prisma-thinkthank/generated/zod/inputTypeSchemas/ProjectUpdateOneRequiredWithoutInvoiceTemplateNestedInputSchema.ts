...
export const ProjectUpdateOneRequiredWithoutInvoiceTemplateNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutInvoiceTemplateNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutInvoiceTemplateInputSchema),
