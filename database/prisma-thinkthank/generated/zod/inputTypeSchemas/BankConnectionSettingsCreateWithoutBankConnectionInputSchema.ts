...
import { UserCreateNestedOneWithoutBankConnectionSettingsInputSchema } from './UserCreateNestedOneWithoutBankConnectionSettingsInputSchema';

export const BankConnectionSettingsCreateWithoutBankConnectionInputSchema: z.ZodType<Prisma.BankConnectionSettingsCreateWithoutBankConnectionInput> = z.object({
  ...
  creator: z.lazy(() => UserCreateNestedOneWithoutBankConnectionSettingsInputSchema)
}).strict();

export default BankConnectionSettingsCreateWithoutBankConnectionInputSchema;
