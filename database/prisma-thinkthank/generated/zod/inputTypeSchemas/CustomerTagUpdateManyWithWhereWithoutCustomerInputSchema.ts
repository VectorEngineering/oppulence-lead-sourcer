...
export const CustomerTagUpdateManyWithWhereWithoutCustomerInputSchema: z.ZodType<Prisma.CustomerTagUpdateManyWithWhereWithoutCustomerInput> =
    z
        .object({
            where: z.lazy(() => CustomerTagScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => CustomerTagUpdateManyMutationInputSchema),
                z.lazy(() => CustomerTagUncheckedUpdateManyWithoutCustomerInputSchema)
            ])
        })
        .strict()
