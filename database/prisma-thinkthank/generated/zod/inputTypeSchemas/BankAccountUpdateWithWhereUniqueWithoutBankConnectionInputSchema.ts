...
export const BankAccountUpdateWithWhereUniqueWithoutBankConnectionInputSchema: z.ZodType<Prisma.BankAccountUpdateWithWhereUniqueWithoutBankConnectionInput> = z.object({
  where: z.lazy(() => BankAccountWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => BankAccountUpdateWithoutBankConnectionInputSchema),z.lazy(() => BankAccountUncheckedUpdateWithoutBankConnectionInputSchema) ]),
}).strict();
