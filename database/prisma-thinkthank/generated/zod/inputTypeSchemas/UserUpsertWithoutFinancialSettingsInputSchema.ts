...
export const UserUpsertWithoutFinancialSettingsInputSchema: z.ZodType<Prisma.UserUpsertWithoutFinancialSettingsInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutFinancialSettingsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutFinancialSettingsInputSchema) ]),
  create: z.union([ z.lazy(() => UserCreateWithoutFinancialSettingsInputSchema),z.lazy(() => UserUncheckedCreateWithoutFinancialSettingsInputSchema) ]),
