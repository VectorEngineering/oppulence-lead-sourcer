...
export const InboxCreateNestedOneWithoutActivitiesInputSchema: z.ZodType<Prisma.InboxCreateNestedOneWithoutActivitiesInput> = z
    .object({
        create: z
            .union([z.lazy(() => InboxCreateWithoutActivitiesInputSchema), z.lazy(() => InboxUncheckedCreateWithoutActivitiesInputSchema)])
            .optional(),
