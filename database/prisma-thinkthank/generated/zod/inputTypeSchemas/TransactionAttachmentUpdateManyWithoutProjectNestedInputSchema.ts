...
export const TransactionAttachmentUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.TransactionAttachmentUpdateManyWithoutProjectNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => TransactionAttachmentUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => TransactionAttachmentUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => TransactionAttachmentUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => TransactionAttachmentUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => TransactionAttachmentUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => TransactionAttachmentUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
...
export default TransactionAttachmentUpdateManyWithoutProjectNestedInputSchema;
