...
export const BankConnectionSettingsWhereUniqueInputSchema: z.ZodType<Prisma.BankConnectionSettingsWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
            ...
            .object({
                ...
                AND: z
                    .union([
                        ...
                        z.lazy(() => BankConnectionSettingsWhereInputSchema).array()
                    ])
                    .optional(),
                OR: z
                ...
                connectionStatus: z
                    .union([z.lazy(() => EnumConnectionStatusFilterSchema), z.lazy(() => ConnectionStatusSchema)])
                    .optional(),
