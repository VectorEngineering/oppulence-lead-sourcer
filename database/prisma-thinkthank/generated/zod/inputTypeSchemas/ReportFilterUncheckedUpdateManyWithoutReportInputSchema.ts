...
export const ReportFilterUncheckedUpdateManyWithoutReportInputSchema: z.ZodType<Prisma.ReportFilterUncheckedUpdateManyWithoutReportInput> =
    z
        .object({
            id: z.union([z.string().cuid(), z.lazy(() => StringFieldUpdateOperationsInputSchema)]).optional(),
            field: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputSchema)]).optional(),
            operator: z
                .union([z.lazy(() => FilterOperatorSchema), z.lazy(() => EnumFilterOperatorFieldUpdateOperationsInputSchema)])
                .optional(),
...
export default ReportFilterUncheckedUpdateManyWithoutReportInputSchema
