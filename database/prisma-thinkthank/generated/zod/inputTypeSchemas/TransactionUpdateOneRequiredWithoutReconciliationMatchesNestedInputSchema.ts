...
export const TransactionUpdateOneRequiredWithoutReconciliationMatchesNestedInputSchema: z.ZodType<Prisma.TransactionUpdateOneRequiredWithoutReconciliationMatchesNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => TransactionUpdateToOneWithWhereWithoutReconciliationMatchesInputSchema),
