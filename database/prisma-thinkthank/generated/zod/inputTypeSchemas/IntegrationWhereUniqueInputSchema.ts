...
export const IntegrationWhereUniqueInputSchema: z.ZodType<Prisma.IntegrationWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
            slug: z.string()
    ...
    .and(
        z
            .object({
                ...
                oAuthApp: z
                    .union([z.lazy(() => OAuthAppNullableRelationFilterSchema), z.lazy(() => OAuthAppWhereInputSchema)])
                    .optional()
                    .nullable(),
