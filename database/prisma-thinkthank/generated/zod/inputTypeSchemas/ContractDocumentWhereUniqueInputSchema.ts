...
export const ContractDocumentWhereUniqueInputSchema: z.ZodType<Prisma.ContractDocumentWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => ContractDocumentWhereInputSchema), z.lazy(() => ContractDocumentWhereInputSchema).array()])
                    .optional(),
                OR: z
