...
export const ContractDocumentWhereUniqueInputSchema: z.ZodType<Prisma.ContractDocumentWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => ContractDocumentWhereInputSchema),z.lazy(() => ContractDocumentWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ContractDocumentWhereInputSchema).array().optional(),
  ...
  importance: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  pageCount: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  ...
  encoding: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  compression: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  storageProvider: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  storagePath: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  backupUrl: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  cdnUrl: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  encryptionType: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  signatureStatus: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  reviewStatus: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  previousVersion: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  isLatestVersion: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  retentionPeriod: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  retentionExpiryDate: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  complianceStatus: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  complianceNotes: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  extractedText: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ocrStatus: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  externalId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  externalSystem: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  externalUrl: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  synchronizationStatus: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  viewCount: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  downloadCount: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  lastViewedBy: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  lastViewedAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  lastDownloadedBy: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  lastDownloadedAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  validateStatus: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  validationErrors: z.lazy(() => JsonNullableFilterSchema).optional(),
  validatedBy: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  restoredAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  restoredBy: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
...
export default ContractDocumentWhereUniqueInputSchema;
