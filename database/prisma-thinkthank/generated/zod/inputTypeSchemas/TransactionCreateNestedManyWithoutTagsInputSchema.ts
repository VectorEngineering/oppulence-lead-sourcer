...
export const TransactionCreateNestedManyWithoutTagsInputSchema: z.ZodType<Prisma.TransactionCreateNestedManyWithoutTagsInput> = z
    .object({
        create: z
            .union([
...
export default TransactionCreateNestedManyWithoutTagsInputSchema
