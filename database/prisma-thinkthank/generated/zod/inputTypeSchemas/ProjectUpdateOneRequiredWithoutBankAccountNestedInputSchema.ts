...
export const ProjectUpdateOneRequiredWithoutBankAccountNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutBankAccountNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutBankAccountInputSchema),z.lazy(() => ProjectUpdateWithoutBankAccountInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutBankAccountInputSchema) ]).optional(),
}).strict();
