...
export const RestrictedTokenUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.RestrictedTokenUpdateManyWithWhereWithoutProjectInput> =
    z
        .object({
            where: z.lazy(() => RestrictedTokenScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => RestrictedTokenUpdateManyMutationInputSchema),
                z.lazy(() => RestrictedTokenUncheckedUpdateManyWithoutProjectInputSchema)
            ])
        })
        .strict()
