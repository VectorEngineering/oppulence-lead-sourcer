...
export const ProjectUpdateOneRequiredWithoutAppsNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutAppsNestedInput> = z
    .object({
        create: z
        ...
        update: z
            .union([
                z.lazy(() => ProjectUpdateToOneWithWhereWithoutAppsInputSchema),
                z.lazy(() => ProjectUpdateWithoutAppsInputSchema),
                z.lazy(() => ProjectUncheckedUpdateWithoutAppsInputSchema)
            ])
            .optional()
    })
    .strict()
