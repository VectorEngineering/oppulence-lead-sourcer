...
export const DefaultDomainsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.DefaultDomainsScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => DefaultDomainsScalarWhereWithAggregatesInputSchema),
                z.lazy(() => DefaultDomainsScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => DefaultDomainsScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
