...
export const ReportRecipientUpdateWithWhereUniqueWithoutReportInputSchema: z.ZodType<Prisma.ReportRecipientUpdateWithWhereUniqueWithoutReportInput> =
    z
        .object({
            where: z.lazy(() => ReportRecipientWhereUniqueInputSchema),
            data: z.union([
                z.lazy(() => ReportRecipientUpdateWithoutReportInputSchema),
                z.lazy(() => ReportRecipientUncheckedUpdateWithoutReportInputSchema)
            ])
        })
        .strict()
