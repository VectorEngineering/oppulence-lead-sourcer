...
export const PartnerInviteUncheckedUpdateManyWithoutPartnerNestedInputSchema: z.ZodType<Prisma.PartnerInviteUncheckedUpdateManyWithoutPartnerNestedInput> =
    z
        .object({
            create: z
                .union([
