...
export const AIAssistantSettingsUncheckedCreateNestedOneWithoutUserInputSchema: z.ZodType<Prisma.AIAssistantSettingsUncheckedCreateNestedOneWithoutUserInput> =
    z
        .object({
            create: z
                .union([
