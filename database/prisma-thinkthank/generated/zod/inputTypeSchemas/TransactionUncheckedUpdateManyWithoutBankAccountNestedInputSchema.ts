...
export const TransactionUncheckedUpdateManyWithoutBankAccountNestedInputSchema: z.ZodType<Prisma.TransactionUncheckedUpdateManyWithoutBankAccountNestedInput> =
    z
        .object({
            create: z
                .union([
