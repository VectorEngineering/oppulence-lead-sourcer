...
export const TransactionEnrichmentScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.TransactionEnrichmentScalarWhereWithAggregatesInput> =
    z
        .object({
            AND: z
                .union([
                    z.lazy(() => TransactionEnrichmentScalarWhereWithAggregatesInputSchema),
                    z.lazy(() => TransactionEnrichmentScalarWhereWithAggregatesInputSchema).array()
                ])
                .optional(),
            OR: z
                .lazy(() => TransactionEnrichmentScalarWhereWithAggregatesInputSchema)
                .array()
                .optional(),
            NOT: z
                .union([
