...
import { WebhookUncheckedUpdateManyWithoutBankConnectionSettingsNestedInputSchema } from './WebhookUncheckedUpdateManyWithoutBankConnectionSettingsNestedInputSchema';

export const BankConnectionSettingsUncheckedUpdateWithoutCreatorInputSchema: z.ZodType<Prisma.BankConnectionSettingsUncheckedUpdateWithoutCreatorInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  syncEnabled: z.union([ z.boolean(),z.lazy(() => BoolFieldUpdateOperationsInputSchema) ]).optional(),
  syncStartTime: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  syncDayOfWeek: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  syncDayOfMonth: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  connectionStatus: z.union([ z.lazy(() => ConnectionStatusSchema),z.lazy(() => EnumConnectionStatusFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  webhooks: z.lazy(() => WebhookUncheckedUpdateManyWithoutBankConnectionSettingsNestedInputSchema).optional()
}).strict();

export default BankConnectionSettingsUncheckedUpdateWithoutCreatorInputSchema;
