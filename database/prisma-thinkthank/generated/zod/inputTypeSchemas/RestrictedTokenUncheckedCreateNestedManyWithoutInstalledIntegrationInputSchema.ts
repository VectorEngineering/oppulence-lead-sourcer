...
export const RestrictedTokenUncheckedCreateNestedManyWithoutInstalledIntegrationInputSchema: z.ZodType<Prisma.RestrictedTokenUncheckedCreateNestedManyWithoutInstalledIntegrationInput> =
    z
        .object({
            create: z
                .union([
