...
export const IntegrationCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.IntegrationCreateNestedManyWithoutProjectInput> = z
    .object({
        create: z
            .union([
...
export default IntegrationCreateNestedManyWithoutProjectInputSchema
