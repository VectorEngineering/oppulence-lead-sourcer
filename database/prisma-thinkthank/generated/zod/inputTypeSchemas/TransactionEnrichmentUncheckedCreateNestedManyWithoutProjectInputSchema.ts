...
export const TransactionEnrichmentUncheckedCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.TransactionEnrichmentUncheckedCreateNestedManyWithoutProjectInput> =
    z
        .object({
            create: z
                .union([
