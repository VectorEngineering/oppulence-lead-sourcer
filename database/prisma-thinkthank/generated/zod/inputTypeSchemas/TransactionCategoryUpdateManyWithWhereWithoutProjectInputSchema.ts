...
export const TransactionCategoryUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.TransactionCategoryUpdateManyWithWhereWithoutProjectInput> =
    z
        .object({
            where: z.lazy(() => TransactionCategoryScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => TransactionCategoryUpdateManyMutationInputSchema),
                z.lazy(() => TransactionCategoryUncheckedUpdateManyWithoutProjectInputSchema)
            ])
        })
        .strict()
