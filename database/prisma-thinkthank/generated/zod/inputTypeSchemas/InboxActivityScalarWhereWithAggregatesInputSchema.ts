...
export const InboxActivityScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.InboxActivityScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => InboxActivityScalarWhereWithAggregatesInputSchema),z.lazy(() => InboxActivityScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => InboxActivityScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => InboxActivityScalarWhereWithAggregatesInputSchema),z.lazy(() => InboxActivityScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  requestId: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  ...
  severity: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
