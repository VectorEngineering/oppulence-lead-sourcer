...
export const PartnerUpdateOneRequiredWithoutInvitesNestedInputSchema: z.ZodType<Prisma.PartnerUpdateOneRequiredWithoutInvitesNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => PartnerUpdateToOneWithWhereWithoutInvitesInputSchema),
