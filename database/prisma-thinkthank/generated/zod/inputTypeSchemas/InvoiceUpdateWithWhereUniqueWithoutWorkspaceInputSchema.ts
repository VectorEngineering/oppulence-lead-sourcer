...
export const InvoiceUpdateWithWhereUniqueWithoutWorkspaceInputSchema: z.ZodType<Prisma.InvoiceUpdateWithWhereUniqueWithoutWorkspaceInput> = z.object({
  where: z.lazy(() => InvoiceWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => InvoiceUpdateWithoutWorkspaceInputSchema),z.lazy(() => InvoiceUncheckedUpdateWithoutWorkspaceInputSchema) ]),
}).strict();
