...
export const InvoiceWhereUniqueInputSchema: z.ZodType<Prisma.InvoiceWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
            number: z.string()
    ...
    .and(
        z
            .object({
                ...
                fee: z.union([z.lazy(() => IntFilterSchema), z.number().int()]).optional(),
                ...
                customer: z
                    .union([z.lazy(() => CustomerNullableRelationFilterSchema), z.lazy(() => CustomerWhereInputSchema)])
                    .optional()
                    .nullable(),
                ...
                template: z
                    .union([z.lazy(() => InvoiceTemplateNullableRelationFilterSchema), z.lazy(() => InvoiceTemplateWhereInputSchema)])
                    .optional()
                    .nullable()
            })
            .strict()
