...
export const AppScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.AppScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([z.lazy(() => AppScalarWhereWithAggregatesInputSchema), z.lazy(() => AppScalarWhereWithAggregatesInputSchema).array()])
            .optional(),
        OR: z
            .lazy(() => AppScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([z.lazy(() => AppScalarWhereWithAggregatesInputSchema), z.lazy(() => AppScalarWhereWithAggregatesInputSchema).array()])
