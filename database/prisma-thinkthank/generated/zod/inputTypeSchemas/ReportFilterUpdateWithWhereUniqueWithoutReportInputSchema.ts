...
export const ReportFilterUpdateWithWhereUniqueWithoutReportInputSchema: z.ZodType<Prisma.ReportFilterUpdateWithWhereUniqueWithoutReportInput> =
    z
        .object({
            where: z.lazy(() => ReportFilterWhereUniqueInputSchema),
            data: z.union([
                z.lazy(() => ReportFilterUpdateWithoutReportInputSchema),
                z.lazy(() => ReportFilterUncheckedUpdateWithoutReportInputSchema)
            ])
        })
        .strict()
