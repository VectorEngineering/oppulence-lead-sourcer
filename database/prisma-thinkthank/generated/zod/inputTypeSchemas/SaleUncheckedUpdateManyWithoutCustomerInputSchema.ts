...
export const SaleUncheckedUpdateManyWithoutCustomerInputSchema: z.ZodType<Prisma.SaleUncheckedUpdateManyWithoutCustomerInput> = z.object({
  ...
  payoutId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export default SaleUncheckedUpdateManyWithoutCustomerInputSchema;
