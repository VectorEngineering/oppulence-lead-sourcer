...
export const BankConnectionUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.BankConnectionUncheckedUpdateManyWithoutProjectNestedInput> =
    z
        .object({
            create: z
                .union([
