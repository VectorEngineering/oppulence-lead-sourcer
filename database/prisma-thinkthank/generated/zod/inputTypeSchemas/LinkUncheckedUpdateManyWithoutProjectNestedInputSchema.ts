...
export const LinkUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.LinkUncheckedUpdateManyWithoutProjectNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LinkUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => LinkUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LinkUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => LinkUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LinkUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => LinkUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LinkScalarWhereInputSchema),z.lazy(() => LinkScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LinkUncheckedUpdateManyWithoutProjectNestedInputSchema;
