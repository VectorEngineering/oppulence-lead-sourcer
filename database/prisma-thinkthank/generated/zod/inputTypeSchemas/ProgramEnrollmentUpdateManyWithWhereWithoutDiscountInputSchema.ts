...
export const ProgramEnrollmentUpdateManyWithWhereWithoutDiscountInputSchema: z.ZodType<Prisma.ProgramEnrollmentUpdateManyWithWhereWithoutDiscountInput> =
    z
        .object({
            where: z.lazy(() => ProgramEnrollmentScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => ProgramEnrollmentUpdateManyMutationInputSchema),
                z.lazy(() => ProgramEnrollmentUncheckedUpdateManyWithoutDiscountInputSchema)
            ])
        })
        .strict()
