...
export const CustomerUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.CustomerUpsertWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => CustomerWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => CustomerUpdateWithoutProjectInputSchema),z.lazy(() => CustomerUncheckedUpdateWithoutProjectInputSchema) ]),
