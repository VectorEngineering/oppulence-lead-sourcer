...
export const InvoiceTemplateUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.InvoiceTemplateUncheckedUpdateManyWithoutProjectNestedInput> =
    z
        .object({
            create: z
                .union([
