...
export const PartnerUpdateOneRequiredWithoutSalesNestedInputSchema: z.ZodType<Prisma.PartnerUpdateOneRequiredWithoutSalesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => PartnerUpdateToOneWithWhereWithoutSalesInputSchema),z.lazy(() => PartnerUpdateWithoutSalesInputSchema),z.lazy(() => PartnerUncheckedUpdateWithoutSalesInputSchema) ]).optional(),
}).strict();
