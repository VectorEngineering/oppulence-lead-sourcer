...
export const InstalledIntegrationUpdateOneWithoutWebhookNestedInputSchema: z.ZodType<Prisma.InstalledIntegrationUpdateOneWithoutWebhookNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => InstalledIntegrationUpdateToOneWithWhereWithoutWebhookInputSchema),z.lazy(() => InstalledIntegrationUpdateWithoutWebhookInputSchema),z.lazy(() => InstalledIntegrationUncheckedUpdateWithoutWebhookInputSchema) ]).optional(),
}).strict();
