...
export const ProgramApplicationUncheckedCreateNestedManyWithoutProgramInputSchema: z.ZodType<Prisma.ProgramApplicationUncheckedCreateNestedManyWithoutProgramInput> =
    z
        .object({
            create: z
                .union([
