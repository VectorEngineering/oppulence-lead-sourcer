...
export const DocumentAnnotationUpdateManyWithWhereWithoutDocumentInputSchema: z.ZodType<Prisma.DocumentAnnotationUpdateManyWithWhereWithoutDocumentInput> = z.object({
  where: z.lazy(() => DocumentAnnotationScalarWhereInputSchema),
  data: z.union([ z.lazy(() => DocumentAnnotationUpdateManyMutationInputSchema),z.lazy(() => DocumentAnnotationUncheckedUpdateManyWithoutDocumentInputSchema) ]),
}).strict();
