...
export const SaleUpdateManyWithoutPayoutNestedInputSchema: z.ZodType<Prisma.SaleUpdateManyWithoutPayoutNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => SaleUpsertWithWhereUniqueWithoutPayoutInputSchema),
                z.lazy(() => SaleUpsertWithWhereUniqueWithoutPayoutInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => SaleUpdateWithWhereUniqueWithoutPayoutInputSchema),
                z.lazy(() => SaleUpdateWithWhereUniqueWithoutPayoutInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => SaleUpdateManyWithWhereWithoutPayoutInputSchema),
                z.lazy(() => SaleUpdateManyWithWhereWithoutPayoutInputSchema).array()
            ])
            .optional(),
...
export default SaleUpdateManyWithoutPayoutNestedInputSchema
