...
export const TransactionUpsertWithWhereUniqueWithoutAssignedToInputSchema: z.ZodType<Prisma.TransactionUpsertWithWhereUniqueWithoutAssignedToInput> =
    z
        .object({
            where: z.lazy(() => TransactionWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => TransactionUpdateWithoutAssignedToInputSchema),
                z.lazy(() => TransactionUncheckedUpdateWithoutAssignedToInputSchema)
            ]),
            create: z.union([
