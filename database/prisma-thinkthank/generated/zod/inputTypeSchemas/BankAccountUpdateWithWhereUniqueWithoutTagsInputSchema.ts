...
export const BankAccountUpdateWithWhereUniqueWithoutTagsInputSchema: z.ZodType<Prisma.BankAccountUpdateWithWhereUniqueWithoutTagsInput> = z
    .object({
        where: z.lazy(() => BankAccountWhereUniqueInputSchema),
        data: z.union([
            z.lazy(() => BankAccountUpdateWithoutTagsInputSchema),
            z.lazy(() => BankAccountUncheckedUpdateWithoutTagsInputSchema)
        ])
    })
    .strict()
