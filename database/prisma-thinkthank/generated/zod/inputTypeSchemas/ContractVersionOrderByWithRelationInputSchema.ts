...
import { ContractVersionOrderByRelevanceInputSchema } from './ContractVersionOrderByRelevanceInputSchema';

export const ContractVersionOrderByWithRelationInputSchema: z.ZodType<Prisma.ContractVersionOrderByWithRelationInput> = z.object({
  ...
  _relevance: z.lazy(() => ContractVersionOrderByRelevanceInputSchema).optional()
}).strict();

export default ContractVersionOrderByWithRelationInputSchema;
