...
export const OAuthAppUpdateOneRequiredWithoutOAuthCodesNestedInputSchema: z.ZodType<Prisma.OAuthAppUpdateOneRequiredWithoutOAuthCodesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => OAuthAppUpdateToOneWithWhereWithoutOAuthCodesInputSchema),z.lazy(() => OAuthAppUpdateWithoutOAuthCodesInputSchema),z.lazy(() => OAuthAppUncheckedUpdateWithoutOAuthCodesInputSchema) ]).optional(),
}).strict();
