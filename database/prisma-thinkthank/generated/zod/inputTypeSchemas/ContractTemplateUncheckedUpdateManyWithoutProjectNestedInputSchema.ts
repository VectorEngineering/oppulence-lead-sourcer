...
export const ContractTemplateUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.ContractTemplateUncheckedUpdateManyWithoutProjectNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ContractTemplateUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => ContractTemplateUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ContractTemplateCreateManyProjectInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ContractTemplateWhereUniqueInputSchema),z.lazy(() => ContractTemplateWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ContractTemplateWhereUniqueInputSchema),z.lazy(() => ContractTemplateWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ContractTemplateWhereUniqueInputSchema),z.lazy(() => ContractTemplateWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ContractTemplateUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => ContractTemplateUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ContractTemplateUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => ContractTemplateUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ContractTemplateScalarWhereInputSchema),z.lazy(() => ContractTemplateScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ContractTemplateUncheckedUpdateManyWithoutProjectNestedInputSchema;
