...
export const ProgramEnrollmentUpdateWithoutApplicationInputSchema: z.ZodType<Prisma.ProgramEnrollmentUpdateWithoutApplicationInput> = z
    .object({
        ...
        commissionAmount: z
            ...
            .nullable(),
        status: z
            .union([z.lazy(() => ProgramEnrollmentStatusSchema), z.lazy(() => EnumProgramEnrollmentStatusFieldUpdateOperationsInputSchema)])
            .optional(),
...
export default ProgramEnrollmentUpdateWithoutApplicationInputSchema
