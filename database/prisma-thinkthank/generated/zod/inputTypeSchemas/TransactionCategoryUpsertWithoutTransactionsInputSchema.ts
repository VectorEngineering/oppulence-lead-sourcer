...
export const TransactionCategoryUpsertWithoutTransactionsInputSchema: z.ZodType<Prisma.TransactionCategoryUpsertWithoutTransactionsInput> = z.object({
  update: z.union([ z.lazy(() => TransactionCategoryUpdateWithoutTransactionsInputSchema),z.lazy(() => TransactionCategoryUncheckedUpdateWithoutTransactionsInputSchema) ]),
