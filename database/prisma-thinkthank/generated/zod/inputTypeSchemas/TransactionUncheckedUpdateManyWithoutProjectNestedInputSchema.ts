...
export const TransactionUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.TransactionUncheckedUpdateManyWithoutProjectNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => TransactionUpsertWithWhereUniqueWithoutProjectInputSchema),
                    z.lazy(() => TransactionUpsertWithWhereUniqueWithoutProjectInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => TransactionUpdateWithWhereUniqueWithoutProjectInputSchema),
                    z.lazy(() => TransactionUpdateWithWhereUniqueWithoutProjectInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => TransactionUpdateManyWithWhereWithoutProjectInputSchema),
                    z.lazy(() => TransactionUpdateManyWithWhereWithoutProjectInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default TransactionUncheckedUpdateManyWithoutProjectNestedInputSchema
