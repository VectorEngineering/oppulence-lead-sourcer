...
export const WebhookScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.WebhookScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => WebhookScalarWhereWithAggregatesInputSchema),
                z.lazy(() => WebhookScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => WebhookScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
