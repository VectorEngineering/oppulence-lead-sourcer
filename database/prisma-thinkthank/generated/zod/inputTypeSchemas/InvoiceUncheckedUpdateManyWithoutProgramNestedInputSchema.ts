...
export const InvoiceUncheckedUpdateManyWithoutProgramNestedInputSchema: z.ZodType<Prisma.InvoiceUncheckedUpdateManyWithoutProgramNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => InvoiceCreateWithoutProgramInputSchema),
                    z.lazy(() => InvoiceCreateWithoutProgramInputSchema).array(),
                    z.lazy(() => InvoiceUncheckedCreateWithoutProgramInputSchema),
                    z.lazy(() => InvoiceUncheckedCreateWithoutProgramInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => InvoiceCreateOrConnectWithoutProgramInputSchema),
                    z.lazy(() => InvoiceCreateOrConnectWithoutProgramInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => InvoiceUpsertWithWhereUniqueWithoutProgramInputSchema),
                    z.lazy(() => InvoiceUpsertWithWhereUniqueWithoutProgramInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => InvoiceUpdateWithWhereUniqueWithoutProgramInputSchema),
                    z.lazy(() => InvoiceUpdateWithWhereUniqueWithoutProgramInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => InvoiceUpdateManyWithWhereWithoutProgramInputSchema),
                    z.lazy(() => InvoiceUpdateManyWithWhereWithoutProgramInputSchema).array()
                ])
                .optional(),
            deleteMany: z
