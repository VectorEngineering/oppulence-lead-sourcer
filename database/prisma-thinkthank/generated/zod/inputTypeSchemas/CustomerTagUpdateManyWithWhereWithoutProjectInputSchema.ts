...
export const CustomerTagUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.CustomerTagUpdateManyWithWhereWithoutProjectInput> = z.object({
  where: z.lazy(() => CustomerTagScalarWhereInputSchema),
  data: z.union([ z.lazy(() => CustomerTagUpdateManyMutationInputSchema),z.lazy(() => CustomerTagUncheckedUpdateManyWithoutProjectInputSchema) ]),
}).strict();
