...
export const LinkWebhookUncheckedUpdateManyWithoutWebhookNestedInputSchema: z.ZodType<Prisma.LinkWebhookUncheckedUpdateManyWithoutWebhookNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => LinkWebhookUpsertWithWhereUniqueWithoutWebhookInputSchema),
                    z.lazy(() => LinkWebhookUpsertWithWhereUniqueWithoutWebhookInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => LinkWebhookUpdateWithWhereUniqueWithoutWebhookInputSchema),
                    z.lazy(() => LinkWebhookUpdateWithWhereUniqueWithoutWebhookInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => LinkWebhookUpdateManyWithWhereWithoutWebhookInputSchema),
                    z.lazy(() => LinkWebhookUpdateManyWithWhereWithoutWebhookInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([z.lazy(() => LinkWebhookScalarWhereInputSchema), z.lazy(() => LinkWebhookScalarWhereInputSchema).array()])
                .optional()
        })
        .strict()

export default LinkWebhookUncheckedUpdateManyWithoutWebhookNestedInputSchema
