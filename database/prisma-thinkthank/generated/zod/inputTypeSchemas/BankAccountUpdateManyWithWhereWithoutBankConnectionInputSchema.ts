...
export const BankAccountUpdateManyWithWhereWithoutBankConnectionInputSchema: z.ZodType<Prisma.BankAccountUpdateManyWithWhereWithoutBankConnectionInput> = z.object({
  where: z.lazy(() => BankAccountScalarWhereInputSchema),
  data: z.union([ z.lazy(() => BankAccountUpdateManyMutationInputSchema),z.lazy(() => BankAccountUncheckedUpdateManyWithoutBankConnectionInputSchema) ]),
}).strict();
