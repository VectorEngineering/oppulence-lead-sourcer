...
export const ProgramEnrollmentUncheckedUpdateManyWithoutPartnerNestedInputSchema: z.ZodType<Prisma.ProgramEnrollmentUncheckedUpdateManyWithoutPartnerNestedInput> =
    z
        .object({
            create: z
                .union([
