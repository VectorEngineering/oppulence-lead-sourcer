...
export const PartnerUpsertWithoutPayoutsInputSchema: z.ZodType<Prisma.PartnerUpsertWithoutPayoutsInput> = z.object({
  update: z.union([ z.lazy(() => PartnerUpdateWithoutPayoutsInputSchema),z.lazy(() => PartnerUncheckedUpdateWithoutPayoutsInputSchema) ]),
  create: z.union([ z.lazy(() => PartnerCreateWithoutPayoutsInputSchema),z.lazy(() => PartnerUncheckedCreateWithoutPayoutsInputSchema) ]),
