...
export const TransactionUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.TransactionUpsertWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => TransactionWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => TransactionUpdateWithoutProjectInputSchema),z.lazy(() => TransactionUncheckedUpdateWithoutProjectInputSchema) ]),
  create: z.union([ z.lazy(() => TransactionCreateWithoutProjectInputSchema),z.lazy(() => TransactionUncheckedCreateWithoutProjectInputSchema) ]),
}).strict();
