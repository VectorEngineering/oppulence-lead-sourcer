...
export const InvoiceTemplateUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.InvoiceTemplateUpsertWithWhereUniqueWithoutProjectInput> =
    z
        .object({
            where: z.lazy(() => InvoiceTemplateWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => InvoiceTemplateUpdateWithoutProjectInputSchema),
                z.lazy(() => InvoiceTemplateUncheckedUpdateWithoutProjectInputSchema)
            ]),
            create: z.union([
