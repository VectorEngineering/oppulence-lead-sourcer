...
export const UserUpdateOneRequiredWithoutReportAccessNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutReportAccessNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => UserUpdateToOneWithWhereWithoutReportAccessInputSchema),
