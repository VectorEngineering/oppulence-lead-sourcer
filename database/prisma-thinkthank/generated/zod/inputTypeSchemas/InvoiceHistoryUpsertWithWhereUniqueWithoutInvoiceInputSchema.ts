...
export const InvoiceHistoryUpsertWithWhereUniqueWithoutInvoiceInputSchema: z.ZodType<Prisma.InvoiceHistoryUpsertWithWhereUniqueWithoutInvoiceInput> =
    z
        .object({
            where: z.lazy(() => InvoiceHistoryWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => InvoiceHistoryUpdateWithoutInvoiceInputSchema),
                z.lazy(() => InvoiceHistoryUncheckedUpdateWithoutInvoiceInputSchema)
            ]),
            create: z.union([
