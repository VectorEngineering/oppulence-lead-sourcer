...
export const TransactionCommentWhereUniqueInputSchema: z.ZodType<Prisma.TransactionCommentWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => TransactionCommentWhereInputSchema),z.lazy(() => TransactionCommentWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => TransactionCommentWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => TransactionCommentWhereInputSchema),z.lazy(() => TransactionCommentWhereInputSchema).array() ]).optional(),
