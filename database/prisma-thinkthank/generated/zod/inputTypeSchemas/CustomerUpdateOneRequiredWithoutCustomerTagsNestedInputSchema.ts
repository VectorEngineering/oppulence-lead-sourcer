...
export const CustomerUpdateOneRequiredWithoutCustomerTagsNestedInputSchema: z.ZodType<Prisma.CustomerUpdateOneRequiredWithoutCustomerTagsNestedInput> = z.object({
  create: z.union([ z.lazy(() => CustomerCreateWithoutCustomerTagsInputSchema),z.lazy(() => CustomerUncheckedCreateWithoutCustomerTagsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => CustomerUpdateToOneWithWhereWithoutCustomerTagsInputSchema),z.lazy(() => CustomerUpdateWithoutCustomerTagsInputSchema),z.lazy(() => CustomerUncheckedUpdateWithoutCustomerTagsInputSchema) ]).optional(),
}).strict();
