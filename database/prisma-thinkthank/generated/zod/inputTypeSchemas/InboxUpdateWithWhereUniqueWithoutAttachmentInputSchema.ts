...
export const InboxUpdateWithWhereUniqueWithoutAttachmentInputSchema: z.ZodType<Prisma.InboxUpdateWithWhereUniqueWithoutAttachmentInput> = z.object({
  where: z.lazy(() => InboxWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => InboxUpdateWithoutAttachmentInputSchema),z.lazy(() => InboxUncheckedUpdateWithoutAttachmentInputSchema) ]),
}).strict();
