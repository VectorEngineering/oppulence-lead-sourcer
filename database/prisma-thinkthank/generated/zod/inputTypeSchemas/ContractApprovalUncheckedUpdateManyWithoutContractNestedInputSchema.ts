...
export const ContractApprovalUncheckedUpdateManyWithoutContractNestedInputSchema: z.ZodType<Prisma.ContractApprovalUncheckedUpdateManyWithoutContractNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ContractApprovalUpsertWithWhereUniqueWithoutContractInputSchema),z.lazy(() => ContractApprovalUpsertWithWhereUniqueWithoutContractInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ContractApprovalCreateManyContractInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ContractApprovalWhereUniqueInputSchema),z.lazy(() => ContractApprovalWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ContractApprovalWhereUniqueInputSchema),z.lazy(() => ContractApprovalWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ContractApprovalWhereUniqueInputSchema),z.lazy(() => ContractApprovalWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ContractApprovalUpdateWithWhereUniqueWithoutContractInputSchema),z.lazy(() => ContractApprovalUpdateWithWhereUniqueWithoutContractInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ContractApprovalUpdateManyWithWhereWithoutContractInputSchema),z.lazy(() => ContractApprovalUpdateManyWithWhereWithoutContractInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ContractApprovalScalarWhereInputSchema),z.lazy(() => ContractApprovalScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ContractApprovalUncheckedUpdateManyWithoutContractNestedInputSchema;
