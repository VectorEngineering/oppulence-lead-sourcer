...
export const ContractApprovalUncheckedUpdateManyWithoutContractNestedInputSchema: z.ZodType<Prisma.ContractApprovalUncheckedUpdateManyWithoutContractNestedInput> =
    z
        .object({
            create: z
                .union([
