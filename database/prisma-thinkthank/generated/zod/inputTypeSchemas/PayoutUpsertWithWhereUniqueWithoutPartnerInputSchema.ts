...
export const PayoutUpsertWithWhereUniqueWithoutPartnerInputSchema: z.ZodType<Prisma.PayoutUpsertWithWhereUniqueWithoutPartnerInput> = z.object({
  where: z.lazy(() => PayoutWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => PayoutUpdateWithoutPartnerInputSchema),z.lazy(() => PayoutUncheckedUpdateWithoutPartnerInputSchema) ]),
