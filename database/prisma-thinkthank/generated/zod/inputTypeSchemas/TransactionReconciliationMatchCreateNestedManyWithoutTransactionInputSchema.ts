...
export const TransactionReconciliationMatchCreateNestedManyWithoutTransactionInputSchema: z.ZodType<Prisma.TransactionReconciliationMatchCreateNestedManyWithoutTransactionInput> =
    z
        .object({
            create: z
                .union([
