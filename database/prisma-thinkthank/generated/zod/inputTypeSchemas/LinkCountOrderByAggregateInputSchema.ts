...
export const LinkCountOrderByAggregateInputSchema: z.ZodType<Prisma.LinkCountOrderByAggregateInput> = z
    .object({
        ...
        geo: z.lazy(() => SortOrderSchema).optional(),
...
export default LinkCountOrderByAggregateInputSchema
