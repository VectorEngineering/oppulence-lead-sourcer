...
export const ProjectUpdateOneWithoutUtmTemplatesNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneWithoutUtmTemplatesNestedInput> = z
    .object({
        create: z
            .union([
        ...
        update: z
            .union([
                z.lazy(() => ProjectUpdateToOneWithWhereWithoutUtmTemplatesInputSchema),
