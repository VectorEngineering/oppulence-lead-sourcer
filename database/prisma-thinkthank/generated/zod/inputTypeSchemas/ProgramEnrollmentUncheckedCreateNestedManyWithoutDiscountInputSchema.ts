...
export const ProgramEnrollmentUncheckedCreateNestedManyWithoutDiscountInputSchema: z.ZodType<Prisma.ProgramEnrollmentUncheckedCreateNestedManyWithoutDiscountInput> =
    z
        .object({
            create: z
                .union([
