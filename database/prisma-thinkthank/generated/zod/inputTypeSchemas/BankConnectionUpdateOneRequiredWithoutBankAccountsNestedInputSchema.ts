...
export const BankConnectionUpdateOneRequiredWithoutBankAccountsNestedInputSchema: z.ZodType<Prisma.BankConnectionUpdateOneRequiredWithoutBankAccountsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => BankConnectionUpdateToOneWithWhereWithoutBankAccountsInputSchema),z.lazy(() => BankConnectionUpdateWithoutBankAccountsInputSchema),z.lazy(() => BankConnectionUncheckedUpdateWithoutBankAccountsInputSchema) ]).optional(),
}).strict();
