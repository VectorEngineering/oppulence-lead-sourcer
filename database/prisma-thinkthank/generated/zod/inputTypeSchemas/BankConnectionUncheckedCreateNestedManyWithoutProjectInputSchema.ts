...
export const BankConnectionUncheckedCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.BankConnectionUncheckedCreateNestedManyWithoutProjectInput> =
    z
        .object({
            create: z
                .union([
