...
export const ProjectCreateNestedOneWithoutInvitesInputSchema: z.ZodType<Prisma.ProjectCreateNestedOneWithoutInvitesInput> = z
    .object({
        create: z
            .union([z.lazy(() => ProjectCreateWithoutInvitesInputSchema), z.lazy(() => ProjectUncheckedCreateWithoutInvitesInputSchema)])
            .optional(),
