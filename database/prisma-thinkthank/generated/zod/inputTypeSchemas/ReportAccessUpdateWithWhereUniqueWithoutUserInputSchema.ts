...
export const ReportAccessUpdateWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.ReportAccessUpdateWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => ReportAccessWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ReportAccessUpdateWithoutUserInputSchema),z.lazy(() => ReportAccessUncheckedUpdateWithoutUserInputSchema) ]),
}).strict();
