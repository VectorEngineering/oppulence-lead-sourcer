...
export const InboxActivityUpdateManyWithWhereWithoutInboxInputSchema: z.ZodType<Prisma.InboxActivityUpdateManyWithWhereWithoutInboxInput> = z.object({
  where: z.lazy(() => InboxActivityScalarWhereInputSchema),
  data: z.union([ z.lazy(() => InboxActivityUpdateManyMutationInputSchema),z.lazy(() => InboxActivityUncheckedUpdateManyWithoutInboxInputSchema) ]),
}).strict();
