...
export const ProgramEnrollmentWhereUniqueInputSchema: z.ZodType<Prisma.ProgramEnrollmentWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
            linkId: z.string(),
    ...
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => ProgramEnrollmentWhereInputSchema), z.lazy(() => ProgramEnrollmentWhereInputSchema).array()])
                    .optional(),
                OR: z
                    .lazy(() => ProgramEnrollmentWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([z.lazy(() => ProgramEnrollmentWhereInputSchema), z.lazy(() => ProgramEnrollmentWhereInputSchema).array()])
                ...
                discountId: z
                    ...
                    .nullable(),
                status: z
                    .union([z.lazy(() => EnumProgramEnrollmentStatusFilterSchema), z.lazy(() => ProgramEnrollmentStatusSchema)])
                    .optional(),
                ...
                link: z
                    ...
                    .nullable(),
                discount: z
                    .union([z.lazy(() => DiscountNullableRelationFilterSchema), z.lazy(() => DiscountWhereInputSchema)])
                    .optional()
                    .nullable(),
                application: z
                    .union([z.lazy(() => ProgramApplicationNullableRelationFilterSchema), z.lazy(() => ProgramApplicationWhereInputSchema)])
                    .optional()
                    .nullable()
            })
            .strict()
