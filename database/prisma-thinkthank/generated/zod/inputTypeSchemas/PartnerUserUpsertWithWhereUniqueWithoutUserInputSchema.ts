...
export const PartnerUserUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.PartnerUserUpsertWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => PartnerUserWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => PartnerUserUpdateWithoutUserInputSchema),z.lazy(() => PartnerUserUncheckedUpdateWithoutUserInputSchema) ]),
  create: z.union([ z.lazy(() => PartnerUserCreateWithoutUserInputSchema),z.lazy(() => PartnerUserUncheckedCreateWithoutUserInputSchema) ]),
}).strict();
