...
export const RestrictedTokenUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.RestrictedTokenUpsertWithWhereUniqueWithoutProjectInput> =
    z
        .object({
            where: z.lazy(() => RestrictedTokenWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => RestrictedTokenUpdateWithoutProjectInputSchema),
                z.lazy(() => RestrictedTokenUncheckedUpdateWithoutProjectInputSchema)
            ]),
            create: z.union([
