...
export const TransactionCategoryUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.TransactionCategoryUpsertWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => TransactionCategoryWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => TransactionCategoryUpdateWithoutProjectInputSchema),z.lazy(() => TransactionCategoryUncheckedUpdateWithoutProjectInputSchema) ]),
