...
export const BankAccountUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.BankAccountUpdateManyWithoutProjectNestedInput> = z.object({
  create: z.union([ z.lazy(() => BankAccountCreateWithoutProjectInputSchema),z.lazy(() => BankAccountCreateWithoutProjectInputSchema).array(),z.lazy(() => BankAccountUncheckedCreateWithoutProjectInputSchema),z.lazy(() => BankAccountUncheckedCreateWithoutProjectInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => BankAccountCreateOrConnectWithoutProjectInputSchema),z.lazy(() => BankAccountCreateOrConnectWithoutProjectInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => BankAccountUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => BankAccountUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => BankAccountUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => BankAccountUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => BankAccountUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => BankAccountUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => BankAccountScalarWhereInputSchema),z.lazy(() => BankAccountScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default BankAccountUpdateManyWithoutProjectNestedInputSchema;
