...
import { TransactionAttachmentCreateNestedOneWithoutInboxInputSchema } from './TransactionAttachmentCreateNestedOneWithoutInboxInputSchema'
import { TransactionCreateNestedOneWithoutInboxInputSchema } from './TransactionCreateNestedOneWithoutInboxInputSchema'
...
import { InboxLabelCreateNestedManyWithoutInboxInputSchema } from './InboxLabelCreateNestedManyWithoutInboxInputSchema'

export const InboxCreateWithoutActivitiesInputSchema: z.ZodType<Prisma.InboxCreateWithoutActivitiesInput> = z
    .object({
        ...
        attachment: z.lazy(() => TransactionAttachmentCreateNestedOneWithoutInboxInputSchema).optional(),
        transaction: z.lazy(() => TransactionCreateNestedOneWithoutInboxInputSchema).optional(),
        ...
        labels: z.lazy(() => InboxLabelCreateNestedManyWithoutInboxInputSchema).optional()
    })
    .strict()

export default InboxCreateWithoutActivitiesInputSchema
