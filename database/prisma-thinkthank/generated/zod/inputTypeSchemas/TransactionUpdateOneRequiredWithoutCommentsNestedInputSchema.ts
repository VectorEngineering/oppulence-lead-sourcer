...
export const TransactionUpdateOneRequiredWithoutCommentsNestedInputSchema: z.ZodType<Prisma.TransactionUpdateOneRequiredWithoutCommentsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => TransactionUpdateToOneWithWhereWithoutCommentsInputSchema),
