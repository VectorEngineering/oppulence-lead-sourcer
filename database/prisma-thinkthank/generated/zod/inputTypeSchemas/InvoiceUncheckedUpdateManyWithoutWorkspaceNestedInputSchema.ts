...
export const InvoiceUncheckedUpdateManyWithoutWorkspaceNestedInputSchema: z.ZodType<Prisma.InvoiceUncheckedUpdateManyWithoutWorkspaceNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => InvoiceCreateWithoutWorkspaceInputSchema),
                    z.lazy(() => InvoiceCreateWithoutWorkspaceInputSchema).array(),
                    z.lazy(() => InvoiceUncheckedCreateWithoutWorkspaceInputSchema),
                    z.lazy(() => InvoiceUncheckedCreateWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => InvoiceCreateOrConnectWithoutWorkspaceInputSchema),
                    z.lazy(() => InvoiceCreateOrConnectWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => InvoiceUpsertWithWhereUniqueWithoutWorkspaceInputSchema),
                    z.lazy(() => InvoiceUpsertWithWhereUniqueWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => InvoiceUpdateWithWhereUniqueWithoutWorkspaceInputSchema),
                    z.lazy(() => InvoiceUpdateWithWhereUniqueWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => InvoiceUpdateManyWithWhereWithoutWorkspaceInputSchema),
                    z.lazy(() => InvoiceUpdateManyWithWhereWithoutWorkspaceInputSchema).array()
                ])
                .optional(),
            deleteMany: z
