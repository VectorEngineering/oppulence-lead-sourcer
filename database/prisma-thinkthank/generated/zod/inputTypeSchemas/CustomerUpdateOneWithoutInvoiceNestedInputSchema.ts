...
export const CustomerUpdateOneWithoutInvoiceNestedInputSchema: z.ZodType<Prisma.CustomerUpdateOneWithoutInvoiceNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => CustomerCreateWithoutInvoiceInputSchema), z.lazy(() => CustomerUncheckedCreateWithoutInvoiceInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => CustomerUpdateToOneWithWhereWithoutInvoiceInputSchema),
