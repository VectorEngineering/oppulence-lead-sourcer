...
export const OAuthCodeUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.OAuthCodeUpdateManyWithWhereWithoutUserInput> = z.object({
  where: z.lazy(() => OAuthCodeScalarWhereInputSchema),
  data: z.union([ z.lazy(() => OAuthCodeUpdateManyMutationInputSchema),z.lazy(() => OAuthCodeUncheckedUpdateManyWithoutUserInputSchema) ]),
}).strict();
