...
export const UserUpdateOneRequiredWithoutAiAssistantSettingsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutAiAssistantSettingsNestedInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutAiAssistantSettingsInputSchema),z.lazy(() => UserUncheckedCreateWithoutAiAssistantSettingsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutAiAssistantSettingsInputSchema),z.lazy(() => UserUpdateWithoutAiAssistantSettingsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutAiAssistantSettingsInputSchema) ]).optional(),
}).strict();
