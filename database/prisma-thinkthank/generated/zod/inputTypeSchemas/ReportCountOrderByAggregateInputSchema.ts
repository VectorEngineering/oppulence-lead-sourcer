...
export const ReportCountOrderByAggregateInputSchema: z.ZodType<Prisma.ReportCountOrderByAggregateInput> = z
    .object({
...
export default ReportCountOrderByAggregateInputSchema
