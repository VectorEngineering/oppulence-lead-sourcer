...
export const ProjectUpdateOneRequiredWithoutYearInReviewsNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutYearInReviewsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutYearInReviewsInputSchema),
