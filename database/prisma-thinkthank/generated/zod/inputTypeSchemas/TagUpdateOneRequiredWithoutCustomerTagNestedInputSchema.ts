...
export const TagUpdateOneRequiredWithoutCustomerTagNestedInputSchema: z.ZodType<Prisma.TagUpdateOneRequiredWithoutCustomerTagNestedInput> = z.object({
  create: z.union([ z.lazy(() => TagCreateWithoutCustomerTagInputSchema),z.lazy(() => TagUncheckedCreateWithoutCustomerTagInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => TagUpdateToOneWithWhereWithoutCustomerTagInputSchema),z.lazy(() => TagUpdateWithoutCustomerTagInputSchema),z.lazy(() => TagUncheckedUpdateWithoutCustomerTagInputSchema) ]).optional(),
}).strict();
