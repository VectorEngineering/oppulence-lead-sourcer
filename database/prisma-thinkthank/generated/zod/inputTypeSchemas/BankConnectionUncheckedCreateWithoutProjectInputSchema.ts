...
import { BankConnectionSettingsUncheckedCreateNestedOneWithoutBankConnectionInputSchema } from './BankConnectionSettingsUncheckedCreateNestedOneWithoutBankConnectionInputSchema';
import { BankAccountUncheckedCreateNestedManyWithoutBankConnectionInputSchema } from './BankAccountUncheckedCreateNestedManyWithoutBankConnectionInputSchema';

export const BankConnectionUncheckedCreateWithoutProjectInputSchema: z.ZodType<Prisma.BankConnectionUncheckedCreateWithoutProjectInput> = z.object({
  ...
  settings: z.lazy(() => BankConnectionSettingsUncheckedCreateNestedOneWithoutBankConnectionInputSchema).optional(),
  bankAccounts: z.lazy(() => BankAccountUncheckedCreateNestedManyWithoutBankConnectionInputSchema).optional()
}).strict();

export default BankConnectionUncheckedCreateWithoutProjectInputSchema;
