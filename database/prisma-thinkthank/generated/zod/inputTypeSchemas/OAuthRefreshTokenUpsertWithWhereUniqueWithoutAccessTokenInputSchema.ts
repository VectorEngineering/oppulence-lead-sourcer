...
export const OAuthRefreshTokenUpsertWithWhereUniqueWithoutAccessTokenInputSchema: z.ZodType<Prisma.OAuthRefreshTokenUpsertWithWhereUniqueWithoutAccessTokenInput> =
    z
        .object({
            where: z.lazy(() => OAuthRefreshTokenWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => OAuthRefreshTokenUpdateWithoutAccessTokenInputSchema),
                z.lazy(() => OAuthRefreshTokenUncheckedUpdateWithoutAccessTokenInputSchema)
            ]),
            create: z.union([
