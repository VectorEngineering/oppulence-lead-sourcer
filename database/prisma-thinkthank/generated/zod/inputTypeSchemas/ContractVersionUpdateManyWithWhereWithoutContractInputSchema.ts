...
export const ContractVersionUpdateManyWithWhereWithoutContractInputSchema: z.ZodType<Prisma.ContractVersionUpdateManyWithWhereWithoutContractInput> =
    z
        .object({
            where: z.lazy(() => ContractVersionScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => ContractVersionUpdateManyMutationInputSchema),
                z.lazy(() => ContractVersionUncheckedUpdateManyWithoutContractInputSchema)
            ])
        })
        .strict()
