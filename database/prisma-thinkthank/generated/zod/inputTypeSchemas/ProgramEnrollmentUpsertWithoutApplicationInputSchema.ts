...
export const ProgramEnrollmentUpsertWithoutApplicationInputSchema: z.ZodType<Prisma.ProgramEnrollmentUpsertWithoutApplicationInput> = z.object({
  update: z.union([ z.lazy(() => ProgramEnrollmentUpdateWithoutApplicationInputSchema),z.lazy(() => ProgramEnrollmentUncheckedUpdateWithoutApplicationInputSchema) ]),
