...
export const TransactionReconciliationMatchScalarWhereInputSchema: z.ZodType<Prisma.TransactionReconciliationMatchScalarWhereInput> = z
    .object({
        AND: z
            .union([
            ...
            .optional(),
        OR: z
            .lazy(() => TransactionReconciliationMatchScalarWhereInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
