...
export const InstalledIntegrationUpdateManyWithWhereWithoutIntegrationInputSchema: z.ZodType<Prisma.InstalledIntegrationUpdateManyWithWhereWithoutIntegrationInput> =
    z
        .object({
            where: z.lazy(() => InstalledIntegrationScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => InstalledIntegrationUpdateManyMutationInputSchema),
                z.lazy(() => InstalledIntegrationUncheckedUpdateManyWithoutIntegrationInputSchema)
            ])
        })
        .strict()
