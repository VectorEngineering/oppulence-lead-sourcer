...
export const NestedEnumTransactionCategoryTagNullableFilterSchema: z.ZodType<Prisma.NestedEnumTransactionCategoryTagNullableFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => TransactionCategoryTagSchema),z.lazy(() => NestedEnumTransactionCategoryTagNullableFilterSchema) ]).optional().nullable(),
}).strict();
