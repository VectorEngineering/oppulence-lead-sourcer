...
export const ReportUpdateOneRequiredWithoutSortingsNestedInputSchema: z.ZodType<Prisma.ReportUpdateOneRequiredWithoutSortingsNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => ReportCreateWithoutSortingsInputSchema),
                    z.lazy(() => ReportUncheckedCreateWithoutSortingsInputSchema)
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => ReportUpdateToOneWithWhereWithoutSortingsInputSchema),
                    z.lazy(() => ReportUpdateWithoutSortingsInputSchema),
                    z.lazy(() => ReportUncheckedUpdateWithoutSortingsInputSchema)
                ])
                .optional()
        })
        .strict()
