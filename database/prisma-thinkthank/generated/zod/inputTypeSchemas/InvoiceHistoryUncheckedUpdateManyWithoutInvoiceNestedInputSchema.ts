...
export const InvoiceHistoryUncheckedUpdateManyWithoutInvoiceNestedInputSchema: z.ZodType<Prisma.InvoiceHistoryUncheckedUpdateManyWithoutInvoiceNestedInput> =
    z
        .object({
            create: z
                .union([
