...
export const TransactionAttachmentUpsertWithoutInboxInputSchema: z.ZodType<Prisma.TransactionAttachmentUpsertWithoutInboxInput> = z.object({
  update: z.union([ z.lazy(() => TransactionAttachmentUpdateWithoutInboxInputSchema),z.lazy(() => TransactionAttachmentUncheckedUpdateWithoutInboxInputSchema) ]),
