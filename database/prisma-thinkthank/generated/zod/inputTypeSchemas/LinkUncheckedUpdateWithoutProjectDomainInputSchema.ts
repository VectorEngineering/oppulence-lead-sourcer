...
import { LinkTagUncheckedUpdateManyWithoutLinkNestedInputSchema } from './LinkTagUncheckedUpdateManyWithoutLinkNestedInputSchema';
import { LinkWebhookUncheckedUpdateManyWithoutLinkNestedInputSchema } from './LinkWebhookUncheckedUpdateManyWithoutLinkNestedInputSchema';
import { DashboardUncheckedUpdateOneWithoutLinkNestedInputSchema } from './DashboardUncheckedUpdateOneWithoutLinkNestedInputSchema';
import { ProgramEnrollmentUncheckedUpdateOneWithoutLinkNestedInputSchema } from './ProgramEnrollmentUncheckedUpdateOneWithoutLinkNestedInputSchema';
import { ProgramInviteUncheckedUpdateOneWithoutLinkNestedInputSchema } from './ProgramInviteUncheckedUpdateOneWithoutLinkNestedInputSchema';
import { CustomerUncheckedUpdateManyWithoutLinkNestedInputSchema } from './CustomerUncheckedUpdateManyWithoutLinkNestedInputSchema';

export const LinkUncheckedUpdateWithoutProjectDomainInputSchema: z.ZodType<Prisma.LinkUncheckedUpdateWithoutProjectDomainInput> = z.object({
  ...
  tags: z.lazy(() => LinkTagUncheckedUpdateManyWithoutLinkNestedInputSchema).optional(),
  webhooks: z.lazy(() => LinkWebhookUncheckedUpdateManyWithoutLinkNestedInputSchema).optional(),
  dashboard: z.lazy(() => DashboardUncheckedUpdateOneWithoutLinkNestedInputSchema).optional(),
  programEnrollment: z.lazy(() => ProgramEnrollmentUncheckedUpdateOneWithoutLinkNestedInputSchema).optional(),
  programInvite: z.lazy(() => ProgramInviteUncheckedUpdateOneWithoutLinkNestedInputSchema).optional(),
  customers: z.lazy(() => CustomerUncheckedUpdateManyWithoutLinkNestedInputSchema).optional()
}).strict();

export default LinkUncheckedUpdateWithoutProjectDomainInputSchema;
