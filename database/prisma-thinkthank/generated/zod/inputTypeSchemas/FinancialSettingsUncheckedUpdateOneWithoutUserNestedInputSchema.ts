...
export const FinancialSettingsUncheckedUpdateOneWithoutUserNestedInputSchema: z.ZodType<Prisma.FinancialSettingsUncheckedUpdateOneWithoutUserNestedInput> =
    z
        .object({
            create: z
                .union([
