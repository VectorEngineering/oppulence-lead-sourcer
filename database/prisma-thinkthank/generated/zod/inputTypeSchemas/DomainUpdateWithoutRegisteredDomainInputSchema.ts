...
import { ProjectUpdateOneWithoutDomainsNestedInputSchema } from './ProjectUpdateOneWithoutDomainsNestedInputSchema';
...
export const DomainUpdateWithoutRegisteredDomainInputSchema: z.ZodType<Prisma.DomainUpdateWithoutRegisteredDomainInput> = z.object({
  ...
  project: z.lazy(() => ProjectUpdateOneWithoutDomainsNestedInputSchema).optional(),
  programs: z.lazy(() => ProgramUpdateManyWithoutPrimaryDomainNestedInputSchema).optional()
}).strict();

export default DomainUpdateWithoutRegisteredDomainInputSchema;
