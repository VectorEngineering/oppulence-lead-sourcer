...
export const ContractUpdateOneRequiredWithoutContractDocumentsNestedInputSchema: z.ZodType<Prisma.ContractUpdateOneRequiredWithoutContractDocumentsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ContractCreateWithoutContractDocumentsInputSchema),z.lazy(() => ContractUncheckedCreateWithoutContractDocumentsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ContractUpdateToOneWithWhereWithoutContractDocumentsInputSchema),z.lazy(() => ContractUpdateWithoutContractDocumentsInputSchema),z.lazy(() => ContractUncheckedUpdateWithoutContractDocumentsInputSchema) ]).optional(),
}).strict();
