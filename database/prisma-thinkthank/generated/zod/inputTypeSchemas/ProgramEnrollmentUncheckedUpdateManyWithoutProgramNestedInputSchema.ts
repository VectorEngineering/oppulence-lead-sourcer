...
export const ProgramEnrollmentUncheckedUpdateManyWithoutProgramNestedInputSchema: z.ZodType<Prisma.ProgramEnrollmentUncheckedUpdateManyWithoutProgramNestedInput> =
    z
        .object({
            create: z
                .union([
