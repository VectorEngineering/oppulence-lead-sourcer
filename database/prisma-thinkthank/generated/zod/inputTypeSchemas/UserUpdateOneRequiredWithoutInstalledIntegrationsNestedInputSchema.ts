...
export const UserUpdateOneRequiredWithoutInstalledIntegrationsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutInstalledIntegrationsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutInstalledIntegrationsInputSchema),z.lazy(() => UserUpdateWithoutInstalledIntegrationsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutInstalledIntegrationsInputSchema) ]).optional(),
}).strict();
