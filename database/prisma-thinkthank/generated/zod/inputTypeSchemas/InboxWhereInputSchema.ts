...
export const InboxWhereInputSchema: z.ZodType<Prisma.InboxWhereInput> = z.object({
  ...
  sortOrder: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
  ...
  maxAccessCount: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
