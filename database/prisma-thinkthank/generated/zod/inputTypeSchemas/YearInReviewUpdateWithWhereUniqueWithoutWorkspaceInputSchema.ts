...
export const YearInReviewUpdateWithWhereUniqueWithoutWorkspaceInputSchema: z.ZodType<Prisma.YearInReviewUpdateWithWhereUniqueWithoutWorkspaceInput> = z.object({
  where: z.lazy(() => YearInReviewWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => YearInReviewUpdateWithoutWorkspaceInputSchema),z.lazy(() => YearInReviewUncheckedUpdateWithoutWorkspaceInputSchema) ]),
}).strict();
