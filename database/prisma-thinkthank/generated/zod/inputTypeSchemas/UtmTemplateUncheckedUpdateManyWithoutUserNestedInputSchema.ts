...
export const UtmTemplateUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.UtmTemplateUncheckedUpdateManyWithoutUserNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => UtmTemplateCreateWithoutUserInputSchema),
                    z.lazy(() => UtmTemplateCreateWithoutUserInputSchema).array(),
                    z.lazy(() => UtmTemplateUncheckedCreateWithoutUserInputSchema),
                    z.lazy(() => UtmTemplateUncheckedCreateWithoutUserInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => UtmTemplateCreateOrConnectWithoutUserInputSchema),
                    z.lazy(() => UtmTemplateCreateOrConnectWithoutUserInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => UtmTemplateUpsertWithWhereUniqueWithoutUserInputSchema),
                    z.lazy(() => UtmTemplateUpsertWithWhereUniqueWithoutUserInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => UtmTemplateUpdateWithWhereUniqueWithoutUserInputSchema),
                    z.lazy(() => UtmTemplateUpdateWithWhereUniqueWithoutUserInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => UtmTemplateUpdateManyWithWhereWithoutUserInputSchema),
                    z.lazy(() => UtmTemplateUpdateManyWithWhereWithoutUserInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default UtmTemplateUncheckedUpdateManyWithoutUserNestedInputSchema
