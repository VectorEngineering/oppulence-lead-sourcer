...
export const InboxUpsertWithoutActivitiesInputSchema: z.ZodType<Prisma.InboxUpsertWithoutActivitiesInput> = z.object({
  update: z.union([ z.lazy(() => InboxUpdateWithoutActivitiesInputSchema),z.lazy(() => InboxUncheckedUpdateWithoutActivitiesInputSchema) ]),
