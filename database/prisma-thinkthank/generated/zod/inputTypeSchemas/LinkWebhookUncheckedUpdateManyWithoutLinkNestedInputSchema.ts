...
export const LinkWebhookUncheckedUpdateManyWithoutLinkNestedInputSchema: z.ZodType<Prisma.LinkWebhookUncheckedUpdateManyWithoutLinkNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => LinkWebhookUpsertWithWhereUniqueWithoutLinkInputSchema),
                    z.lazy(() => LinkWebhookUpsertWithWhereUniqueWithoutLinkInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => LinkWebhookUpdateWithWhereUniqueWithoutLinkInputSchema),
                    z.lazy(() => LinkWebhookUpdateWithWhereUniqueWithoutLinkInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => LinkWebhookUpdateManyWithWhereWithoutLinkInputSchema),
                    z.lazy(() => LinkWebhookUpdateManyWithWhereWithoutLinkInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default LinkWebhookUncheckedUpdateManyWithoutLinkNestedInputSchema
