...
export const InvoiceAttachmentUncheckedCreateNestedManyWithoutInvoiceInputSchema: z.ZodType<Prisma.InvoiceAttachmentUncheckedCreateNestedManyWithoutInvoiceInput> =
    z
        .object({
            create: z
                .union([
