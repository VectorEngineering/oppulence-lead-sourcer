...
export const ProgramUpsertWithoutInvoicesInputSchema: z.ZodType<Prisma.ProgramUpsertWithoutInvoicesInput> = z.object({
  update: z.union([ z.lazy(() => ProgramUpdateWithoutInvoicesInputSchema),z.lazy(() => ProgramUncheckedUpdateWithoutInvoicesInputSchema) ]),
  create: z.union([ z.lazy(() => ProgramCreateWithoutInvoicesInputSchema),z.lazy(() => ProgramUncheckedCreateWithoutInvoicesInputSchema) ]),
