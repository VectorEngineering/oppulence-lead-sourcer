...
export const BankAccountUpdateManyWithWhereWithoutTagsInputSchema: z.ZodType<Prisma.BankAccountUpdateManyWithWhereWithoutTagsInput> = z
    .object({
        where: z.lazy(() => BankAccountScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => BankAccountUpdateManyMutationInputSchema),
            z.lazy(() => BankAccountUncheckedUpdateManyWithoutTagsInputSchema)
        ])
    })
    .strict()
