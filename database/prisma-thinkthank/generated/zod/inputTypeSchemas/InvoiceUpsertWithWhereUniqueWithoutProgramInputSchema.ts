...
export const InvoiceUpsertWithWhereUniqueWithoutProgramInputSchema: z.ZodType<Prisma.InvoiceUpsertWithWhereUniqueWithoutProgramInput> = z.object({
  where: z.lazy(() => InvoiceWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => InvoiceUpdateWithoutProgramInputSchema),z.lazy(() => InvoiceUncheckedUpdateWithoutProgramInputSchema) ]),
  create: z.union([ z.lazy(() => InvoiceCreateWithoutProgramInputSchema),z.lazy(() => InvoiceUncheckedCreateWithoutProgramInputSchema) ]),
}).strict();
