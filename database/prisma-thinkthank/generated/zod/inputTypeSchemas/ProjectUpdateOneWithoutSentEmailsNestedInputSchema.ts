...
export const ProjectUpdateOneWithoutSentEmailsNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneWithoutSentEmailsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProjectCreateWithoutSentEmailsInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutSentEmailsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutSentEmailsInputSchema),z.lazy(() => ProjectUpdateWithoutSentEmailsInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutSentEmailsInputSchema) ]).optional(),
}).strict();
