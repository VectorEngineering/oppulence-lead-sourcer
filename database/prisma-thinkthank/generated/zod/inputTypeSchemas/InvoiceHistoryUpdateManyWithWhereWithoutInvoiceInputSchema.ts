...
export const InvoiceHistoryUpdateManyWithWhereWithoutInvoiceInputSchema: z.ZodType<Prisma.InvoiceHistoryUpdateManyWithWhereWithoutInvoiceInput> = z.object({
  where: z.lazy(() => InvoiceHistoryScalarWhereInputSchema),
  data: z.union([ z.lazy(() => InvoiceHistoryUpdateManyMutationInputSchema),z.lazy(() => InvoiceHistoryUncheckedUpdateManyWithoutInvoiceInputSchema) ]),
}).strict();
