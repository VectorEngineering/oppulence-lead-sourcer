...
export const UserUpdateOneWithoutDashboardsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutDashboardsNestedInput> = z
    .object({
        create: z
        ...
        update: z
            .union([
                z.lazy(() => UserUpdateToOneWithWhereWithoutDashboardsInputSchema),
