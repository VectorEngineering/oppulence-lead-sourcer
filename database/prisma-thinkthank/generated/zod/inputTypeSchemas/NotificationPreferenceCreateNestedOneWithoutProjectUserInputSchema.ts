...
export const NotificationPreferenceCreateNestedOneWithoutProjectUserInputSchema: z.ZodType<Prisma.NotificationPreferenceCreateNestedOneWithoutProjectUserInput> =
    z
        .object({
            create: z
                .union([
