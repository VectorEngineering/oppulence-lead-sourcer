...
export const OAuthRefreshTokenUpdateManyWithWhereWithoutAccessTokenInputSchema: z.ZodType<Prisma.OAuthRefreshTokenUpdateManyWithWhereWithoutAccessTokenInput> =
    z
        .object({
            where: z.lazy(() => OAuthRefreshTokenScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => OAuthRefreshTokenUpdateManyMutationInputSchema),
                z.lazy(() => OAuthRefreshTokenUncheckedUpdateManyWithoutAccessTokenInputSchema)
            ])
        })
        .strict()
