...
export const InstalledIntegrationUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.InstalledIntegrationUpdateManyWithWhereWithoutProjectInput> =
    z
        .object({
            where: z.lazy(() => InstalledIntegrationScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => InstalledIntegrationUpdateManyMutationInputSchema),
                z.lazy(() => InstalledIntegrationUncheckedUpdateManyWithoutProjectInputSchema)
            ])
        })
        .strict()
