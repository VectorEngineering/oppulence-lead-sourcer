...
import { BankAccountUpdateManyWithoutTagsNestedInputSchema } from './BankAccountUpdateManyWithoutTagsNestedInputSchema';

export const TagUpdateWithoutCustomerTagInputSchema: z.ZodType<Prisma.TagUpdateWithoutCustomerTagInput> = z.object({
  ...
  BankAccount: z.lazy(() => BankAccountUpdateManyWithoutTagsNestedInputSchema).optional()
}).strict();

export default TagUpdateWithoutCustomerTagInputSchema;
