...
export const InvoiceAttachmentWhereUniqueInputSchema: z.ZodType<Prisma.InvoiceAttachmentWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => InvoiceAttachmentWhereInputSchema),z.lazy(() => InvoiceAttachmentWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => InvoiceAttachmentWhereInputSchema).array().optional(),
