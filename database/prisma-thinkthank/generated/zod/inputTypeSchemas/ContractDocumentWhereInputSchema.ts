...
export const ContractDocumentWhereInputSchema: z.ZodType<Prisma.ContractDocumentWhereInput> = z.object({
  ...
  retentionPeriod: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
