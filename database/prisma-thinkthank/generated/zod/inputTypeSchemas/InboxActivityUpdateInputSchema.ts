...
import { InboxUpdateOneRequiredWithoutActivitiesNestedInputSchema } from './InboxUpdateOneRequiredWithoutActivitiesNestedInputSchema';

export const InboxActivityUpdateInputSchema: z.ZodType<Prisma.InboxActivityUpdateInput> = z.object({
  ...
  requestId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  severity: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  inbox: z.lazy(() => InboxUpdateOneRequiredWithoutActivitiesNestedInputSchema).optional()
}).strict();

export default InboxActivityUpdateInputSchema;
