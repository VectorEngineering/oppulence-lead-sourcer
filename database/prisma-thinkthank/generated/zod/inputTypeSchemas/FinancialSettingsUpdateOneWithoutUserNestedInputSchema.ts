...
export const FinancialSettingsUpdateOneWithoutUserNestedInputSchema: z.ZodType<Prisma.FinancialSettingsUpdateOneWithoutUserNestedInput> = z
    .object({
        create: z
            .union([
        ...
        update: z
            .union([
                z.lazy(() => FinancialSettingsUpdateToOneWithWhereWithoutUserInputSchema),
...
export default FinancialSettingsUpdateOneWithoutUserNestedInputSchema
