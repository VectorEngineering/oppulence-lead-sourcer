...
export const ProgramInviteUncheckedUpdateManyWithoutProgramNestedInputSchema: z.ZodType<Prisma.ProgramInviteUncheckedUpdateManyWithoutProgramNestedInput> =
    z
        .object({
            create: z
                .union([
