...
export const PayoutUpsertWithWhereUniqueWithoutProgramInputSchema: z.ZodType<Prisma.PayoutUpsertWithWhereUniqueWithoutProgramInput> = z.object({
  where: z.lazy(() => PayoutWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => PayoutUpdateWithoutProgramInputSchema),z.lazy(() => PayoutUncheckedUpdateWithoutProgramInputSchema) ]),
