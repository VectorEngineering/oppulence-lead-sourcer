...
export const ProgramCreateNestedOneWithoutInvitesInputSchema: z.ZodType<Prisma.ProgramCreateNestedOneWithoutInvitesInput> = z
    .object({
        create: z
            .union([z.lazy(() => ProgramCreateWithoutInvitesInputSchema), z.lazy(() => ProgramUncheckedCreateWithoutInvitesInputSchema)])
            .optional(),
