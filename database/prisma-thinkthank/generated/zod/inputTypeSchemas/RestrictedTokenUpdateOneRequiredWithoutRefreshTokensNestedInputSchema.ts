...
export const RestrictedTokenUpdateOneRequiredWithoutRefreshTokensNestedInputSchema: z.ZodType<Prisma.RestrictedTokenUpdateOneRequiredWithoutRefreshTokensNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => RestrictedTokenUpdateToOneWithWhereWithoutRefreshTokensInputSchema),
