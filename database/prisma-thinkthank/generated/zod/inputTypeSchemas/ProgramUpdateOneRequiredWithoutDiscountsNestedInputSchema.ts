...
export const ProgramUpdateOneRequiredWithoutDiscountsNestedInputSchema: z.ZodType<Prisma.ProgramUpdateOneRequiredWithoutDiscountsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProgramUpdateToOneWithWhereWithoutDiscountsInputSchema),
                    z.lazy(() => ProgramUpdateWithoutDiscountsInputSchema),
                    z.lazy(() => ProgramUncheckedUpdateWithoutDiscountsInputSchema)
                ])
                .optional()
        })
        .strict()
