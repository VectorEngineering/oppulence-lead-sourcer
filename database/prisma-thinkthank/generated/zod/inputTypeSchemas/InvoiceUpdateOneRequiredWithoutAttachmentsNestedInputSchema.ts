...
export const InvoiceUpdateOneRequiredWithoutAttachmentsNestedInputSchema: z.ZodType<Prisma.InvoiceUpdateOneRequiredWithoutAttachmentsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => InvoiceUpdateToOneWithWhereWithoutAttachmentsInputSchema),z.lazy(() => InvoiceUpdateWithoutAttachmentsInputSchema),z.lazy(() => InvoiceUncheckedUpdateWithoutAttachmentsInputSchema) ]).optional(),
}).strict();
