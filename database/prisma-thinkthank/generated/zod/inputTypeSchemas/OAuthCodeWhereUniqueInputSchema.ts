...
export const OAuthCodeWhereUniqueInputSchema: z.ZodType<Prisma.OAuthCodeWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    code: z.string()
  }),
...
.and(z.object({
  ...
  OR: z.lazy(() => OAuthCodeWhereInputSchema).array().optional(),
...
export default OAuthCodeWhereUniqueInputSchema;
