...
export const OAuthRefreshTokenUpdateManyWithoutAccessTokenNestedInputSchema: z.ZodType<Prisma.OAuthRefreshTokenUpdateManyWithoutAccessTokenNestedInput> = z.object({
  create: z.union([ z.lazy(() => OAuthRefreshTokenCreateWithoutAccessTokenInputSchema),z.lazy(() => OAuthRefreshTokenCreateWithoutAccessTokenInputSchema).array(),z.lazy(() => OAuthRefreshTokenUncheckedCreateWithoutAccessTokenInputSchema),z.lazy(() => OAuthRefreshTokenUncheckedCreateWithoutAccessTokenInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => OAuthRefreshTokenCreateOrConnectWithoutAccessTokenInputSchema),z.lazy(() => OAuthRefreshTokenCreateOrConnectWithoutAccessTokenInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => OAuthRefreshTokenUpsertWithWhereUniqueWithoutAccessTokenInputSchema),z.lazy(() => OAuthRefreshTokenUpsertWithWhereUniqueWithoutAccessTokenInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => OAuthRefreshTokenUpdateWithWhereUniqueWithoutAccessTokenInputSchema),z.lazy(() => OAuthRefreshTokenUpdateWithWhereUniqueWithoutAccessTokenInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => OAuthRefreshTokenUpdateManyWithWhereWithoutAccessTokenInputSchema),z.lazy(() => OAuthRefreshTokenUpdateManyWithWhereWithoutAccessTokenInputSchema).array() ]).optional(),
...
export default OAuthRefreshTokenUpdateManyWithoutAccessTokenNestedInputSchema;
