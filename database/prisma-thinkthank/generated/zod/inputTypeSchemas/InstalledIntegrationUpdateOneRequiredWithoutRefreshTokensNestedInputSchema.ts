...
export const InstalledIntegrationUpdateOneRequiredWithoutRefreshTokensNestedInputSchema: z.ZodType<Prisma.InstalledIntegrationUpdateOneRequiredWithoutRefreshTokensNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => InstalledIntegrationUpdateToOneWithWhereWithoutRefreshTokensInputSchema),
