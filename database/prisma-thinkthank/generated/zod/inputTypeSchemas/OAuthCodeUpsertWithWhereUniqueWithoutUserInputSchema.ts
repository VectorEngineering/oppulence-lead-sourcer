...
export const OAuthCodeUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.OAuthCodeUpsertWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => OAuthCodeWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => OAuthCodeUpdateWithoutUserInputSchema),z.lazy(() => OAuthCodeUncheckedUpdateWithoutUserInputSchema) ]),
