...
export const ProjectUsersUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.ProjectUsersUpsertWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => ProjectUsersWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ProjectUsersUpdateWithoutProjectInputSchema),z.lazy(() => ProjectUsersUncheckedUpdateWithoutProjectInputSchema) ]),
  create: z.union([ z.lazy(() => ProjectUsersCreateWithoutProjectInputSchema),z.lazy(() => ProjectUsersUncheckedCreateWithoutProjectInputSchema) ]),
}).strict();
