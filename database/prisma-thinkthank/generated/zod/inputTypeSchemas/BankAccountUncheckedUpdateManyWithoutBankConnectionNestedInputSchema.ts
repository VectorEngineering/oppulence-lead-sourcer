...
export const BankAccountUncheckedUpdateManyWithoutBankConnectionNestedInputSchema: z.ZodType<Prisma.BankAccountUncheckedUpdateManyWithoutBankConnectionNestedInput> =
    z
        .object({
            create: z
                .union([
