...
export const WebhookUpdateManyWithoutBankConnectionSettingsNestedInputSchema: z.ZodType<Prisma.WebhookUpdateManyWithoutBankConnectionSettingsNestedInput> = z.object({
  create: z.union([ z.lazy(() => WebhookCreateWithoutBankConnectionSettingsInputSchema),z.lazy(() => WebhookCreateWithoutBankConnectionSettingsInputSchema).array(),z.lazy(() => WebhookUncheckedCreateWithoutBankConnectionSettingsInputSchema),z.lazy(() => WebhookUncheckedCreateWithoutBankConnectionSettingsInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => WebhookCreateOrConnectWithoutBankConnectionSettingsInputSchema),z.lazy(() => WebhookCreateOrConnectWithoutBankConnectionSettingsInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => WebhookUpsertWithWhereUniqueWithoutBankConnectionSettingsInputSchema),z.lazy(() => WebhookUpsertWithWhereUniqueWithoutBankConnectionSettingsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => WebhookUpdateWithWhereUniqueWithoutBankConnectionSettingsInputSchema),z.lazy(() => WebhookUpdateWithWhereUniqueWithoutBankConnectionSettingsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => WebhookUpdateManyWithWhereWithoutBankConnectionSettingsInputSchema),z.lazy(() => WebhookUpdateManyWithWhereWithoutBankConnectionSettingsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => WebhookScalarWhereInputSchema),z.lazy(() => WebhookScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default WebhookUpdateManyWithoutBankConnectionSettingsNestedInputSchema;
