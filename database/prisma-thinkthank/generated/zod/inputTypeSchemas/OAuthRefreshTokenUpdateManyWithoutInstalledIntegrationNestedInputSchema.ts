...
export const OAuthRefreshTokenUpdateManyWithoutInstalledIntegrationNestedInputSchema: z.ZodType<Prisma.OAuthRefreshTokenUpdateManyWithoutInstalledIntegrationNestedInput> =
    z
        .object({
            create: z
                .union([
