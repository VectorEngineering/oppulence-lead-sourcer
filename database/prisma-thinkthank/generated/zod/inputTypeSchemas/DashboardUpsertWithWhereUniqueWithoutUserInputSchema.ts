...
export const DashboardUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.DashboardUpsertWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => DashboardWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => DashboardUpdateWithoutUserInputSchema),z.lazy(() => DashboardUncheckedUpdateWithoutUserInputSchema) ]),
