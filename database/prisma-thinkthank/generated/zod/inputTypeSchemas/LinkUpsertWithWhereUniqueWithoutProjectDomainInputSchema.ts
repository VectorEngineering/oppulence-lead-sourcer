...
export const LinkUpsertWithWhereUniqueWithoutProjectDomainInputSchema: z.ZodType<Prisma.LinkUpsertWithWhereUniqueWithoutProjectDomainInput> =
    z
        .object({
            where: z.lazy(() => LinkWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => LinkUpdateWithoutProjectDomainInputSchema),
                z.lazy(() => LinkUncheckedUpdateWithoutProjectDomainInputSchema)
            ]),
            create: z.union([
