...
export const TransactionCategoryScalarWhereInputSchema: z.ZodType<Prisma.TransactionCategoryScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => TransactionCategoryScalarWhereInputSchema),z.lazy(() => TransactionCategoryScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => TransactionCategoryScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => TransactionCategoryScalarWhereInputSchema),z.lazy(() => TransactionCategoryScalarWhereInputSchema).array() ]).optional(),
...
export default TransactionCategoryScalarWhereInputSchema;
