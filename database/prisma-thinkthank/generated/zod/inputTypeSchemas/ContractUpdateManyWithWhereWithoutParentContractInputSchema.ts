...
export const ContractUpdateManyWithWhereWithoutParentContractInputSchema: z.ZodType<Prisma.ContractUpdateManyWithWhereWithoutParentContractInput> =
    z
        .object({
            where: z.lazy(() => ContractScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => ContractUpdateManyMutationInputSchema),
                z.lazy(() => ContractUncheckedUpdateManyWithoutParentContractInputSchema)
            ])
        })
        .strict()
