...
export const DiscountUpdateOneWithoutProgramEnrollmentsNestedInputSchema: z.ZodType<Prisma.DiscountUpdateOneWithoutProgramEnrollmentsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => DiscountUpdateToOneWithWhereWithoutProgramEnrollmentsInputSchema),z.lazy(() => DiscountUpdateWithoutProgramEnrollmentsInputSchema),z.lazy(() => DiscountUncheckedUpdateWithoutProgramEnrollmentsInputSchema) ]).optional(),
}).strict();
