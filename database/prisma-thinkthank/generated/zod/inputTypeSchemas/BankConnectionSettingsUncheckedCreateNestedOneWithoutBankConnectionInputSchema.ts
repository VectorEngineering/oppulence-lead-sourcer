...
export const BankConnectionSettingsUncheckedCreateNestedOneWithoutBankConnectionInputSchema: z.ZodType<Prisma.BankConnectionSettingsUncheckedCreateNestedOneWithoutBankConnectionInput> =
    z
        .object({
            create: z
                .union([
