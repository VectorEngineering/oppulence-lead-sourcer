...
export const CustomerCreateManyProjectInputSchema: z.ZodType<Prisma.CustomerCreateManyProjectInput> = z
    .object({
...
export default CustomerCreateManyProjectInputSchema
