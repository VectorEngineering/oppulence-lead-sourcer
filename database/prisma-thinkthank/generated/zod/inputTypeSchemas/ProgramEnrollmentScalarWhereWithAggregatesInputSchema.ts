...
export const ProgramEnrollmentScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ProgramEnrollmentScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => ProgramEnrollmentScalarWhereWithAggregatesInputSchema),
                z.lazy(() => ProgramEnrollmentScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => ProgramEnrollmentScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
        ...
        applicationId: z
            ...
            .nullable(),
        status: z
            .union([z.lazy(() => EnumProgramEnrollmentStatusWithAggregatesFilterSchema), z.lazy(() => ProgramEnrollmentStatusSchema)])
            .optional(),
