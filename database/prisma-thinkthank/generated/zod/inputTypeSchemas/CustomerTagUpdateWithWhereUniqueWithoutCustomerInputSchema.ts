...
export const CustomerTagUpdateWithWhereUniqueWithoutCustomerInputSchema: z.ZodType<Prisma.CustomerTagUpdateWithWhereUniqueWithoutCustomerInput> =
    z
        .object({
            where: z.lazy(() => CustomerTagWhereUniqueInputSchema),
            data: z.union([
                z.lazy(() => CustomerTagUpdateWithoutCustomerInputSchema),
                z.lazy(() => CustomerTagUncheckedUpdateWithoutCustomerInputSchema)
            ])
        })
        .strict()
