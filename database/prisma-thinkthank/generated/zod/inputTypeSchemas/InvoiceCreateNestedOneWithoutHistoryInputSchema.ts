...
export const InvoiceCreateNestedOneWithoutHistoryInputSchema: z.ZodType<Prisma.InvoiceCreateNestedOneWithoutHistoryInput> = z
    .object({
        create: z
            .union([z.lazy(() => InvoiceCreateWithoutHistoryInputSchema), z.lazy(() => InvoiceUncheckedCreateWithoutHistoryInputSchema)])
            .optional(),
