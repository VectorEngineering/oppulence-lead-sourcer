...
export const TransactionCategoryUpdateOneWithoutChildrenNestedInputSchema: z.ZodType<Prisma.TransactionCategoryUpdateOneWithoutChildrenNestedInput> = z.object({
  create: z.union([ z.lazy(() => TransactionCategoryCreateWithoutChildrenInputSchema),z.lazy(() => TransactionCategoryUncheckedCreateWithoutChildrenInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => TransactionCategoryUpdateToOneWithWhereWithoutChildrenInputSchema),z.lazy(() => TransactionCategoryUpdateWithoutChildrenInputSchema),z.lazy(() => TransactionCategoryUncheckedUpdateWithoutChildrenInputSchema) ]).optional(),
}).strict();
