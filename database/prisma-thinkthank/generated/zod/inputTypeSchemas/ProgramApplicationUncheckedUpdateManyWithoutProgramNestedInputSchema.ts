...
export const ProgramApplicationUncheckedUpdateManyWithoutProgramNestedInputSchema: z.ZodType<Prisma.ProgramApplicationUncheckedUpdateManyWithoutProgramNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => ProgramApplicationCreateWithoutProgramInputSchema),
                    z.lazy(() => ProgramApplicationCreateWithoutProgramInputSchema).array(),
                    z.lazy(() => ProgramApplicationUncheckedCreateWithoutProgramInputSchema),
                    z.lazy(() => ProgramApplicationUncheckedCreateWithoutProgramInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => ProgramApplicationCreateOrConnectWithoutProgramInputSchema),
                    z.lazy(() => ProgramApplicationCreateOrConnectWithoutProgramInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => ProgramApplicationUpsertWithWhereUniqueWithoutProgramInputSchema),
                    z.lazy(() => ProgramApplicationUpsertWithWhereUniqueWithoutProgramInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => ProgramApplicationUpdateWithWhereUniqueWithoutProgramInputSchema),
                    z.lazy(() => ProgramApplicationUpdateWithWhereUniqueWithoutProgramInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => ProgramApplicationUpdateManyWithWhereWithoutProgramInputSchema),
                    z.lazy(() => ProgramApplicationUpdateManyWithWhereWithoutProgramInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
...
export default ProgramApplicationUncheckedUpdateManyWithoutProgramNestedInputSchema
