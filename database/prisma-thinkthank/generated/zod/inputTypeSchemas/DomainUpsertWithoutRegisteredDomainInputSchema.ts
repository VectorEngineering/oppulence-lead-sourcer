...
export const DomainUpsertWithoutRegisteredDomainInputSchema: z.ZodType<Prisma.DomainUpsertWithoutRegisteredDomainInput> = z.object({
  update: z.union([ z.lazy(() => DomainUpdateWithoutRegisteredDomainInputSchema),z.lazy(() => DomainUncheckedUpdateWithoutRegisteredDomainInputSchema) ]),
  create: z.union([ z.lazy(() => DomainCreateWithoutRegisteredDomainInputSchema),z.lazy(() => DomainUncheckedCreateWithoutRegisteredDomainInputSchema) ]),
