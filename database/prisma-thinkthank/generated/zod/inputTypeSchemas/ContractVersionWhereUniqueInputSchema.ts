...
export const ContractVersionWhereUniqueInputSchema: z.ZodType<Prisma.ContractVersionWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
    ...
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => ContractVersionWhereInputSchema), z.lazy(() => ContractVersionWhereInputSchema).array()])
                    .optional(),
                OR: z
