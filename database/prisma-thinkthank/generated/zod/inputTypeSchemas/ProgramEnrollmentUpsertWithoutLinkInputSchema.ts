...
export const ProgramEnrollmentUpsertWithoutLinkInputSchema: z.ZodType<Prisma.ProgramEnrollmentUpsertWithoutLinkInput> = z.object({
  update: z.union([ z.lazy(() => ProgramEnrollmentUpdateWithoutLinkInputSchema),z.lazy(() => ProgramEnrollmentUncheckedUpdateWithoutLinkInputSchema) ]),
  create: z.union([ z.lazy(() => ProgramEnrollmentCreateWithoutLinkInputSchema),z.lazy(() => ProgramEnrollmentUncheckedCreateWithoutLinkInputSchema) ]),
