...
export const BankConnectionSettingsUncheckedUpdateOneWithoutBankConnectionNestedInputSchema: z.ZodType<Prisma.BankConnectionSettingsUncheckedUpdateOneWithoutBankConnectionNestedInput> =
    z
        .object({
            create: z
                .union([
