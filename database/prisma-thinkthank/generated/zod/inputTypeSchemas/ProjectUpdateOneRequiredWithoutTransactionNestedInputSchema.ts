...
export const ProjectUpdateOneRequiredWithoutTransactionNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutTransactionNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutTransactionInputSchema),
                    z.lazy(() => ProjectUpdateWithoutTransactionInputSchema),
                    z.lazy(() => ProjectUncheckedUpdateWithoutTransactionInputSchema)
                ])
                .optional()
        })
        .strict()
