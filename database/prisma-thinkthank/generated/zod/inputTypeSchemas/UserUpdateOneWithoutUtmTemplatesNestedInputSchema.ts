...
export const UserUpdateOneWithoutUtmTemplatesNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutUtmTemplatesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutUtmTemplatesInputSchema),z.lazy(() => UserUpdateWithoutUtmTemplatesInputSchema),z.lazy(() => UserUncheckedUpdateWithoutUtmTemplatesInputSchema) ]).optional(),
}).strict();
