...
export const UtmTemplateUncheckedCreateNestedManyWithoutUserInputSchema: z.ZodType<Prisma.UtmTemplateUncheckedCreateNestedManyWithoutUserInput> =
    z
        .object({
            create: z
                .union([
...
export default UtmTemplateUncheckedCreateNestedManyWithoutUserInputSchema
