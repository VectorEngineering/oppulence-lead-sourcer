...
export const InvoiceUncheckedUpdateManyWithoutTemplateNestedInputSchema: z.ZodType<Prisma.InvoiceUncheckedUpdateManyWithoutTemplateNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => InvoiceUpsertWithWhereUniqueWithoutTemplateInputSchema),
                    z.lazy(() => InvoiceUpsertWithWhereUniqueWithoutTemplateInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => InvoiceUpdateWithWhereUniqueWithoutTemplateInputSchema),
                    z.lazy(() => InvoiceUpdateWithWhereUniqueWithoutTemplateInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => InvoiceUpdateManyWithWhereWithoutTemplateInputSchema),
                    z.lazy(() => InvoiceUpdateManyWithWhereWithoutTemplateInputSchema).array()
                ])
                .optional(),
            deleteMany: z
