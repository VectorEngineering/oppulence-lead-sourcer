...
export const ContractTemplateWhereInputSchema: z.ZodType<Prisma.ContractTemplateWhereInput> = z.object({
  AND: z.union([ z.lazy(() => ContractTemplateWhereInputSchema),z.lazy(() => ContractTemplateWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ContractTemplateWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => ContractTemplateWhereInputSchema),z.lazy(() => ContractTemplateWhereInputSchema).array() ]).optional(),
...
export default ContractTemplateWhereInputSchema;
