...
export const TransactionUpdateOneWithoutInboxNestedInputSchema: z.ZodType<Prisma.TransactionUpdateOneWithoutInboxNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => TransactionUpdateToOneWithWhereWithoutInboxInputSchema),z.lazy(() => TransactionUpdateWithoutInboxInputSchema),z.lazy(() => TransactionUncheckedUpdateWithoutInboxInputSchema) ]).optional(),
}).strict();
