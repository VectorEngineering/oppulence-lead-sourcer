...
export const InboxShareUncheckedUpdateManyWithoutInboxNestedInputSchema: z.ZodType<Prisma.InboxShareUncheckedUpdateManyWithoutInboxNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => InboxShareCreateWithoutInboxInputSchema),
                    z.lazy(() => InboxShareCreateWithoutInboxInputSchema).array(),
                    z.lazy(() => InboxShareUncheckedCreateWithoutInboxInputSchema),
                    z.lazy(() => InboxShareUncheckedCreateWithoutInboxInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => InboxShareCreateOrConnectWithoutInboxInputSchema),
                    z.lazy(() => InboxShareCreateOrConnectWithoutInboxInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => InboxShareUpsertWithWhereUniqueWithoutInboxInputSchema),
                    z.lazy(() => InboxShareUpsertWithWhereUniqueWithoutInboxInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => InboxShareCreateManyInboxInputEnvelopeSchema).optional(),
            set: z
                .union([z.lazy(() => InboxShareWhereUniqueInputSchema), z.lazy(() => InboxShareWhereUniqueInputSchema).array()])
                .optional(),
            disconnect: z
                .union([z.lazy(() => InboxShareWhereUniqueInputSchema), z.lazy(() => InboxShareWhereUniqueInputSchema).array()])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => InboxShareUpdateWithWhereUniqueWithoutInboxInputSchema),
                    z.lazy(() => InboxShareUpdateWithWhereUniqueWithoutInboxInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => InboxShareUpdateManyWithWhereWithoutInboxInputSchema),
                    z.lazy(() => InboxShareUpdateManyWithWhereWithoutInboxInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([z.lazy(() => InboxShareScalarWhereInputSchema), z.lazy(() => InboxShareScalarWhereInputSchema).array()])
                .optional()
        })
        .strict()

export default InboxShareUncheckedUpdateManyWithoutInboxNestedInputSchema
