...
export const ProgramInviteUpdateWithWhereUniqueWithoutProgramInputSchema: z.ZodType<Prisma.ProgramInviteUpdateWithWhereUniqueWithoutProgramInput> = z.object({
  where: z.lazy(() => ProgramInviteWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ProgramInviteUpdateWithoutProgramInputSchema),z.lazy(() => ProgramInviteUncheckedUpdateWithoutProgramInputSchema) ]),
}).strict();
