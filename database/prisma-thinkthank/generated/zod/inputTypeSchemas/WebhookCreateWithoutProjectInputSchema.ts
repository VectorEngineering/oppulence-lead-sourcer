...
export const WebhookCreateWithoutProjectInputSchema: z.ZodType<Prisma.WebhookCreateWithoutProjectInput> = z.object({
...
export default WebhookCreateWithoutProjectInputSchema;
