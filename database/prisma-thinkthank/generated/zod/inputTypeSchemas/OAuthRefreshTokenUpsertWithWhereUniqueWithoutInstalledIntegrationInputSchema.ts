...
export const OAuthRefreshTokenUpsertWithWhereUniqueWithoutInstalledIntegrationInputSchema: z.ZodType<Prisma.OAuthRefreshTokenUpsertWithWhereUniqueWithoutInstalledIntegrationInput> =
    z
        .object({
            where: z.lazy(() => OAuthRefreshTokenWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => OAuthRefreshTokenUpdateWithoutInstalledIntegrationInputSchema),
                z.lazy(() => OAuthRefreshTokenUncheckedUpdateWithoutInstalledIntegrationInputSchema)
            ]),
            create: z.union([
