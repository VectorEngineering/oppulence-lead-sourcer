...
export const ProgramResourceWhereUniqueInputSchema: z.ZodType<Prisma.ProgramResourceWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => ProgramResourceWhereInputSchema),z.lazy(() => ProgramResourceWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ProgramResourceWhereInputSchema).array().optional(),
