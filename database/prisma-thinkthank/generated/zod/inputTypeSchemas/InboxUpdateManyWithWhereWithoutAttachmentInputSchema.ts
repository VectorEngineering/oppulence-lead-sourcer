...
export const InboxUpdateManyWithWhereWithoutAttachmentInputSchema: z.ZodType<Prisma.InboxUpdateManyWithWhereWithoutAttachmentInput> = z
    .object({
        where: z.lazy(() => InboxScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => InboxUpdateManyMutationInputSchema),
            z.lazy(() => InboxUncheckedUpdateManyWithoutAttachmentInputSchema)
        ])
    })
    .strict()
