...
export const BankConnectionUpdateToOneWithWhereWithoutSettingsInputSchema: z.ZodType<Prisma.BankConnectionUpdateToOneWithWhereWithoutSettingsInput> = z.object({
  where: z.lazy(() => BankConnectionWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => BankConnectionUpdateWithoutSettingsInputSchema),z.lazy(() => BankConnectionUncheckedUpdateWithoutSettingsInputSchema) ]),
}).strict();
