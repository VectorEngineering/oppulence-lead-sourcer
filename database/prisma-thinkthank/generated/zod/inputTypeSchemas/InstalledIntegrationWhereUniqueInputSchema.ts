...
export const InstalledIntegrationWhereUniqueInputSchema: z.ZodType<Prisma.InstalledIntegrationWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
    ...
    .and(
        z
            .object({
                ...
                userId_integrationId_projectId: z
                    .lazy(() => InstalledIntegrationUserIdIntegrationIdProjectIdCompoundUniqueInputSchema)
                    .optional(),
                AND: z
