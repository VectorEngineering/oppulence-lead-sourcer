...
export const OAuthAppUpsertWithoutOAuthCodesInputSchema: z.ZodType<Prisma.OAuthAppUpsertWithoutOAuthCodesInput> = z.object({
  update: z.union([ z.lazy(() => OAuthAppUpdateWithoutOAuthCodesInputSchema),z.lazy(() => OAuthAppUncheckedUpdateWithoutOAuthCodesInputSchema) ]),
