...
import { InvoiceCreateNestedOneWithoutCommentsInputSchema } from './InvoiceCreateNestedOneWithoutCommentsInputSchema';
...
export const InvoiceCommentCreateWithoutRepliesInputSchema: z.ZodType<Prisma.InvoiceCommentCreateWithoutRepliesInput> = z.object({
  ...
  invoice: z.lazy(() => InvoiceCreateNestedOneWithoutCommentsInputSchema),
  parent: z.lazy(() => InvoiceCommentCreateNestedOneWithoutRepliesInputSchema).optional()
}).strict();

export default InvoiceCommentCreateWithoutRepliesInputSchema;
