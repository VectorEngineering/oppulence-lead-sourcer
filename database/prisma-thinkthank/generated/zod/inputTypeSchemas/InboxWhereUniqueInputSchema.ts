...
export const InboxWhereUniqueInputSchema: z.ZodType<Prisma.InboxWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                classification: z
                    .union([z.lazy(() => EnumInboxClassificationFilterSchema), z.lazy(() => InboxClassificationSchema)])
                    .optional(),
                password: z
                    .union([z.lazy(() => StringNullableFilterSchema), z.string()])
                    .optional()
                ...
                attachment: z
                    .union([
                        z.lazy(() => TransactionAttachmentNullableRelationFilterSchema),
                        z.lazy(() => TransactionAttachmentWhereInputSchema)
                    ])
                    .optional()
                    .nullable(),
                transaction: z
                    .union([z.lazy(() => TransactionNullableRelationFilterSchema), z.lazy(() => TransactionWhereInputSchema)])
                    .optional()
                    .nullable(),
                parent: z
