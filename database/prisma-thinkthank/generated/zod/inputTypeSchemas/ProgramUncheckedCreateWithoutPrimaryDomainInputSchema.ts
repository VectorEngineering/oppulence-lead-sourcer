...
import { ProgramInviteUncheckedCreateNestedManyWithoutProgramInputSchema } from './ProgramInviteUncheckedCreateNestedManyWithoutProgramInputSchema';
...
export const ProgramUncheckedCreateWithoutPrimaryDomainInputSchema: z.ZodType<Prisma.ProgramUncheckedCreateWithoutPrimaryDomainInput> = z.object({
  ...
  invites: z.lazy(() => ProgramInviteUncheckedCreateNestedManyWithoutProgramInputSchema).optional(),
  links: z.lazy(() => LinkUncheckedCreateNestedManyWithoutProgramInputSchema).optional()
}).strict();

export default ProgramUncheckedCreateWithoutPrimaryDomainInputSchema;
