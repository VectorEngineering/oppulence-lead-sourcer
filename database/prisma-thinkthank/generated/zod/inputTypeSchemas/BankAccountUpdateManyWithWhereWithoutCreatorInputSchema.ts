...
export const BankAccountUpdateManyWithWhereWithoutCreatorInputSchema: z.ZodType<Prisma.BankAccountUpdateManyWithWhereWithoutCreatorInput> =
    z
        .object({
            where: z.lazy(() => BankAccountScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => BankAccountUpdateManyMutationInputSchema),
                z.lazy(() => BankAccountUncheckedUpdateManyWithoutCreatorInputSchema)
            ])
        })
        .strict()
