...
export const BankConnectionSettingsUpdateManyWithWhereWithoutCreatorInputSchema: z.ZodType<Prisma.BankConnectionSettingsUpdateManyWithWhereWithoutCreatorInput> =
    z
        .object({
            where: z.lazy(() => BankConnectionSettingsScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => BankConnectionSettingsUpdateManyMutationInputSchema),
                z.lazy(() => BankConnectionSettingsUncheckedUpdateManyWithoutCreatorInputSchema)
            ])
        })
        .strict()
