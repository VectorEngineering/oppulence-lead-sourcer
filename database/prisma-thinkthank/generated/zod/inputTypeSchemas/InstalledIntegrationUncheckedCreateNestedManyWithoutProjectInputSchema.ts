...
export const InstalledIntegrationUncheckedCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.InstalledIntegrationUncheckedCreateNestedManyWithoutProjectInput> =
    z
        .object({
            create: z
                .union([
