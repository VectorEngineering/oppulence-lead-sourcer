...
export const InstalledIntegrationUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.InstalledIntegrationUncheckedUpdateManyWithoutUserNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => InstalledIntegrationUpsertWithWhereUniqueWithoutUserInputSchema),
                    z.lazy(() => InstalledIntegrationUpsertWithWhereUniqueWithoutUserInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => InstalledIntegrationUpdateWithWhereUniqueWithoutUserInputSchema),
                    z.lazy(() => InstalledIntegrationUpdateWithWhereUniqueWithoutUserInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => InstalledIntegrationUpdateManyWithWhereWithoutUserInputSchema),
                    z.lazy(() => InstalledIntegrationUpdateManyWithWhereWithoutUserInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
...
export default InstalledIntegrationUncheckedUpdateManyWithoutUserNestedInputSchema
