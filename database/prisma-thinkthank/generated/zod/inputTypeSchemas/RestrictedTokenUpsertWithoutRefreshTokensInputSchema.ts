...
export const RestrictedTokenUpsertWithoutRefreshTokensInputSchema: z.ZodType<Prisma.RestrictedTokenUpsertWithoutRefreshTokensInput> = z.object({
  update: z.union([ z.lazy(() => RestrictedTokenUpdateWithoutRefreshTokensInputSchema),z.lazy(() => RestrictedTokenUncheckedUpdateWithoutRefreshTokensInputSchema) ]),
