...
export const NestedEnumTransactionReconciliationStatusFilterSchema: z.ZodType<Prisma.NestedEnumTransactionReconciliationStatusFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => TransactionReconciliationStatusSchema),z.lazy(() => NestedEnumTransactionReconciliationStatusFilterSchema) ]).optional(),
}).strict();
