...
export const DiscountScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.DiscountScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => DiscountScalarWhereWithAggregatesInputSchema),
                z.lazy(() => DiscountScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => DiscountScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
