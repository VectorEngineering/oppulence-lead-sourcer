...
export const IntegrationUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.IntegrationUpdateManyWithoutUserNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => IntegrationUpsertWithWhereUniqueWithoutUserInputSchema),
                z.lazy(() => IntegrationUpsertWithWhereUniqueWithoutUserInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => IntegrationUpdateWithWhereUniqueWithoutUserInputSchema),
                z.lazy(() => IntegrationUpdateWithWhereUniqueWithoutUserInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => IntegrationUpdateManyWithWhereWithoutUserInputSchema),
                z.lazy(() => IntegrationUpdateManyWithWhereWithoutUserInputSchema).array()
            ])
            .optional(),
        deleteMany: z
...
export default IntegrationUpdateManyWithoutUserNestedInputSchema
