...
export const BankConnectionScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.BankConnectionScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => BankConnectionScalarWhereWithAggregatesInputSchema),
                z.lazy(() => BankConnectionScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => BankConnectionScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
        ...
        primaryColor: z
            ...
            .nullable(),
        provider: z
            .union([z.lazy(() => EnumBankProviderNullableWithAggregatesFilterSchema), z.lazy(() => BankProviderSchema)])
            .optional()
            .nullable(),
        status: z
