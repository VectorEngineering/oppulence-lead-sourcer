...
export const InstalledIntegrationUpsertWithoutRefreshTokensInputSchema: z.ZodType<Prisma.InstalledIntegrationUpsertWithoutRefreshTokensInput> = z.object({
  update: z.union([ z.lazy(() => InstalledIntegrationUpdateWithoutRefreshTokensInputSchema),z.lazy(() => InstalledIntegrationUncheckedUpdateWithoutRefreshTokensInputSchema) ]),
