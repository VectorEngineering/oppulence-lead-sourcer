...
export const BankAccountUpdateOneWithoutTransactionsNestedInputSchema: z.ZodType<Prisma.BankAccountUpdateOneWithoutTransactionsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => BankAccountUpdateToOneWithWhereWithoutTransactionsInputSchema),z.lazy(() => BankAccountUpdateWithoutTransactionsInputSchema),z.lazy(() => BankAccountUncheckedUpdateWithoutTransactionsInputSchema) ]).optional(),
}).strict();
