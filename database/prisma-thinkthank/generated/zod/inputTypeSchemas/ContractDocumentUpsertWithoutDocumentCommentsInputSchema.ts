...
export const ContractDocumentUpsertWithoutDocumentCommentsInputSchema: z.ZodType<Prisma.ContractDocumentUpsertWithoutDocumentCommentsInput> = z.object({
  update: z.union([ z.lazy(() => ContractDocumentUpdateWithoutDocumentCommentsInputSchema),z.lazy(() => ContractDocumentUncheckedUpdateWithoutDocumentCommentsInputSchema) ]),
  create: z.union([ z.lazy(() => ContractDocumentCreateWithoutDocumentCommentsInputSchema),z.lazy(() => ContractDocumentUncheckedCreateWithoutDocumentCommentsInputSchema) ]),
