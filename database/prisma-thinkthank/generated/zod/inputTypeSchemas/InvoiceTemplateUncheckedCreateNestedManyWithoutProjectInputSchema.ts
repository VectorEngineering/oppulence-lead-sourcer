...
export const InvoiceTemplateUncheckedCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.InvoiceTemplateUncheckedCreateNestedManyWithoutProjectInput> =
    z
        .object({
            create: z
                .union([
