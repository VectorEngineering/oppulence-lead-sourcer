...
export const ReportScheduleUncheckedUpdateManyWithoutReportInputSchema: z.ZodType<Prisma.ReportScheduleUncheckedUpdateManyWithoutReportInput> = z.object({
  ...
  nextRun: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
}).strict();

export default ReportScheduleUncheckedUpdateManyWithoutReportInputSchema;
