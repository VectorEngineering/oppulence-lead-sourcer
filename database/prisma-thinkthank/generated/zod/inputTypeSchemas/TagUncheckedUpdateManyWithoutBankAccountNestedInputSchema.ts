...
export const TagUncheckedUpdateManyWithoutBankAccountNestedInputSchema: z.ZodType<Prisma.TagUncheckedUpdateManyWithoutBankAccountNestedInput> = z.object({
  create: z.union([ z.lazy(() => TagCreateWithoutBankAccountInputSchema),z.lazy(() => TagCreateWithoutBankAccountInputSchema).array(),z.lazy(() => TagUncheckedCreateWithoutBankAccountInputSchema),z.lazy(() => TagUncheckedCreateWithoutBankAccountInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => TagCreateOrConnectWithoutBankAccountInputSchema),z.lazy(() => TagCreateOrConnectWithoutBankAccountInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => TagUpsertWithWhereUniqueWithoutBankAccountInputSchema),z.lazy(() => TagUpsertWithWhereUniqueWithoutBankAccountInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => TagUpdateWithWhereUniqueWithoutBankAccountInputSchema),z.lazy(() => TagUpdateWithWhereUniqueWithoutBankAccountInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => TagUpdateManyWithWhereWithoutBankAccountInputSchema),z.lazy(() => TagUpdateManyWithWhereWithoutBankAccountInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => TagScalarWhereInputSchema),z.lazy(() => TagScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default TagUncheckedUpdateManyWithoutBankAccountNestedInputSchema;
