...
export const DocumentCreateNestedManyWithoutOwnerInputSchema: z.ZodType<Prisma.DocumentCreateNestedManyWithoutOwnerInput> = z
    .object({
        create: z
            .union([
...
export default DocumentCreateNestedManyWithoutOwnerInputSchema
