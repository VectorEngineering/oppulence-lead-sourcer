...
export const UserUpdateOneRequiredWithoutPartnersNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutPartnersNestedInput> = z
    .object({
        create: z
        ...
        update: z
            .union([
                z.lazy(() => UserUpdateToOneWithWhereWithoutPartnersInputSchema),
                z.lazy(() => UserUpdateWithoutPartnersInputSchema),
                z.lazy(() => UserUncheckedUpdateWithoutPartnersInputSchema)
            ])
            .optional()
    })
    .strict()
