...
export const ReportUpdateToOneWithWhereWithoutAccessUsersInputSchema: z.ZodType<Prisma.ReportUpdateToOneWithWhereWithoutAccessUsersInput> = z.object({
  where: z.lazy(() => ReportWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ReportUpdateWithoutAccessUsersInputSchema),z.lazy(() => ReportUncheckedUpdateWithoutAccessUsersInputSchema) ]),
}).strict();
