...
export const TransactionUpdateManyWithoutTagsNestedInputSchema: z.ZodType<Prisma.TransactionUpdateManyWithoutTagsNestedInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => TransactionCreateWithoutTagsInputSchema),
                z.lazy(() => TransactionCreateWithoutTagsInputSchema).array(),
                z.lazy(() => TransactionUncheckedCreateWithoutTagsInputSchema),
                z.lazy(() => TransactionUncheckedCreateWithoutTagsInputSchema).array()
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => TransactionCreateOrConnectWithoutTagsInputSchema),
                z.lazy(() => TransactionCreateOrConnectWithoutTagsInputSchema).array()
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => TransactionUpsertWithWhereUniqueWithoutTagsInputSchema),
                z.lazy(() => TransactionUpsertWithWhereUniqueWithoutTagsInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => TransactionUpdateWithWhereUniqueWithoutTagsInputSchema),
                z.lazy(() => TransactionUpdateWithWhereUniqueWithoutTagsInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => TransactionUpdateManyWithWhereWithoutTagsInputSchema),
                z.lazy(() => TransactionUpdateManyWithWhereWithoutTagsInputSchema).array()
            ])
            .optional(),
        deleteMany: z
...
export default TransactionUpdateManyWithoutTagsNestedInputSchema
