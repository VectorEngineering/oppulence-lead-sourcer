...
export const DomainUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.DomainUpsertWithWhereUniqueWithoutProjectInput> = z
    .object({
        where: z.lazy(() => DomainWhereUniqueInputSchema),
        update: z.union([
            z.lazy(() => DomainUpdateWithoutProjectInputSchema),
            z.lazy(() => DomainUncheckedUpdateWithoutProjectInputSchema)
        ]),
