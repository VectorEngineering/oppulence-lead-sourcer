...
export const DashboardUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.DashboardUpdateManyWithWhereWithoutProjectInput> = z.object({
  where: z.lazy(() => DashboardScalarWhereInputSchema),
  data: z.union([ z.lazy(() => DashboardUpdateManyMutationInputSchema),z.lazy(() => DashboardUncheckedUpdateManyWithoutProjectInputSchema) ]),
}).strict();
