...
export const WebhookUpdateManyWithWhereWithoutBankConnectionSettingsInputSchema: z.ZodType<Prisma.WebhookUpdateManyWithWhereWithoutBankConnectionSettingsInput> =
    z
        .object({
            where: z.lazy(() => WebhookScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => WebhookUpdateManyMutationInputSchema),
                z.lazy(() => WebhookUncheckedUpdateManyWithoutBankConnectionSettingsInputSchema)
            ])
        })
        .strict()
