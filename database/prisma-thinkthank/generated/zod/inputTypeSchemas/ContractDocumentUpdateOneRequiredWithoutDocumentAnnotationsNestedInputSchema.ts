...
export const ContractDocumentUpdateOneRequiredWithoutDocumentAnnotationsNestedInputSchema: z.ZodType<Prisma.ContractDocumentUpdateOneRequiredWithoutDocumentAnnotationsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ContractDocumentUpdateToOneWithWhereWithoutDocumentAnnotationsInputSchema),
