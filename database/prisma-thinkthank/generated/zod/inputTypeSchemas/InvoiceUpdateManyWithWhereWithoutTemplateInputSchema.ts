...
export const InvoiceUpdateManyWithWhereWithoutTemplateInputSchema: z.ZodType<Prisma.InvoiceUpdateManyWithWhereWithoutTemplateInput> = z
    .object({
        where: z.lazy(() => InvoiceScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => InvoiceUpdateManyMutationInputSchema),
            z.lazy(() => InvoiceUncheckedUpdateManyWithoutTemplateInputSchema)
        ])
    })
    .strict()
