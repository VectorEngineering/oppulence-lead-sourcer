...
export const BankConnectionSettingsCreateNestedOneWithoutBankConnectionInputSchema: z.ZodType<Prisma.BankConnectionSettingsCreateNestedOneWithoutBankConnectionInput> =
    z
        .object({
            create: z
                .union([
