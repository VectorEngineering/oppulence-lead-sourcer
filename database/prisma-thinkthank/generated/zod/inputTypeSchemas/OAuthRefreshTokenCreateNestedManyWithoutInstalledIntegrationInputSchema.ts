...
export const OAuthRefreshTokenCreateNestedManyWithoutInstalledIntegrationInputSchema: z.ZodType<Prisma.OAuthRefreshTokenCreateNestedManyWithoutInstalledIntegrationInput> =
    z
        .object({
            create: z
                .union([
