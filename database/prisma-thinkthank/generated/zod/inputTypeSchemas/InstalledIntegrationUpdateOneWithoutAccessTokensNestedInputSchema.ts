...
export const InstalledIntegrationUpdateOneWithoutAccessTokensNestedInputSchema: z.ZodType<Prisma.InstalledIntegrationUpdateOneWithoutAccessTokensNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => InstalledIntegrationUpdateToOneWithWhereWithoutAccessTokensInputSchema),
                    z.lazy(() => InstalledIntegrationUpdateWithoutAccessTokensInputSchema),
                    z.lazy(() => InstalledIntegrationUncheckedUpdateWithoutAccessTokensInputSchema)
                ])
                .optional()
        })
        .strict()
