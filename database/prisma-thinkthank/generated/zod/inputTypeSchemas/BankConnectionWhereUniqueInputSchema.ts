...
export const BankConnectionWhereUniqueInputSchema: z.ZodType<Prisma.BankConnectionWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
    ...
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => BankConnectionWhereInputSchema), z.lazy(() => BankConnectionWhereInputSchema).array()])
                    .optional(),
                OR: z
                    .lazy(() => BankConnectionWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([z.lazy(() => BankConnectionWhereInputSchema), z.lazy(() => BankConnectionWhereInputSchema).array()])
                ...
                settings: z
                    .union([
                        z.lazy(() => BankConnectionSettingsNullableRelationFilterSchema),
                        z.lazy(() => BankConnectionSettingsWhereInputSchema)
                    ])
                    .optional()
                    .nullable(),
