...
export const ProjectUpdateOneRequiredWithoutWebhooksNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutWebhooksNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProjectCreateWithoutWebhooksInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutWebhooksInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutWebhooksInputSchema),z.lazy(() => ProjectUpdateWithoutWebhooksInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutWebhooksInputSchema) ]).optional(),
}).strict();
