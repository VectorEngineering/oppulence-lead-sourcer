...
export const ContractApprovalUpdateManyWithWhereWithoutContractInputSchema: z.ZodType<Prisma.ContractApprovalUpdateManyWithWhereWithoutContractInput> =
    z
        .object({
            where: z.lazy(() => ContractApprovalScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => ContractApprovalUpdateManyMutationInputSchema),
                z.lazy(() => ContractApprovalUncheckedUpdateManyWithoutContractInputSchema)
            ])
        })
        .strict()
