...
export const ProgramUpdateOneRequiredWithoutSalesNestedInputSchema: z.ZodType<Prisma.ProgramUpdateOneRequiredWithoutSalesNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => ProgramCreateWithoutSalesInputSchema), z.lazy(() => ProgramUncheckedCreateWithoutSalesInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => ProgramUpdateToOneWithWhereWithoutSalesInputSchema),
                z.lazy(() => ProgramUpdateWithoutSalesInputSchema),
                z.lazy(() => ProgramUncheckedUpdateWithoutSalesInputSchema)
            ])
            .optional()
    })
    .strict()
