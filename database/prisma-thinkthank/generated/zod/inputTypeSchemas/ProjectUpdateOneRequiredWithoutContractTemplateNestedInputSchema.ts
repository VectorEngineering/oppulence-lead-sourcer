...
export const ProjectUpdateOneRequiredWithoutContractTemplateNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutContractTemplateNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutContractTemplateInputSchema),
