...
import { DashboardCreateNestedOneWithoutLinkInputSchema } from './DashboardCreateNestedOneWithoutLinkInputSchema';
...
export const LinkCreateWithoutProgramEnrollmentInputSchema: z.ZodType<Prisma.LinkCreateWithoutProgramEnrollmentInput> = z.object({
  ...
  dashboard: z.lazy(() => DashboardCreateNestedOneWithoutLinkInputSchema).optional(),
...
export default LinkCreateWithoutProgramEnrollmentInputSchema;
