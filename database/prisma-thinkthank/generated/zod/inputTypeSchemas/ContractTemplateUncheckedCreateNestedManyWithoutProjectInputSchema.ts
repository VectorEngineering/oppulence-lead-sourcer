...
export const ContractTemplateUncheckedCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.ContractTemplateUncheckedCreateNestedManyWithoutProjectInput> =
    z
        .object({
            create: z
                .union([
