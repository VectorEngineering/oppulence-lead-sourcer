...
export const ProjectUpdateOneRequiredWithoutRestrictedTokensNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutRestrictedTokensNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutRestrictedTokensInputSchema),z.lazy(() => ProjectUpdateWithoutRestrictedTokensInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutRestrictedTokensInputSchema) ]).optional(),
}).strict();
