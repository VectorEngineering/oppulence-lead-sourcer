...
export const TransactionWhereInputSchema: z.ZodType<Prisma.TransactionWhereInput> = z.object({
  ...
  category: z.union([ z.lazy(() => TransactionCategoryNullableRelationFilterSchema),z.lazy(() => TransactionCategoryWhereInputSchema) ]).optional().nullable(),
  bankAccount: z.union([ z.lazy(() => BankAccountNullableRelationFilterSchema),z.lazy(() => BankAccountWhereInputSchema) ]).optional().nullable(),
