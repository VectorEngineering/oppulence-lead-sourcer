...
export const ReportColumnWhereUniqueInputSchema: z.ZodType<Prisma.ReportColumnWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => ReportColumnWhereInputSchema),z.lazy(() => ReportColumnWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ReportColumnWhereInputSchema).array().optional(),
