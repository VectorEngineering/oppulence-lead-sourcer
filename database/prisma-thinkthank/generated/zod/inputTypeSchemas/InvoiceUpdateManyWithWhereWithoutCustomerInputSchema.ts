...
export const InvoiceUpdateManyWithWhereWithoutCustomerInputSchema: z.ZodType<Prisma.InvoiceUpdateManyWithWhereWithoutCustomerInput> = z
    .object({
        where: z.lazy(() => InvoiceScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => InvoiceUpdateManyMutationInputSchema),
            z.lazy(() => InvoiceUncheckedUpdateManyWithoutCustomerInputSchema)
        ])
    })
    .strict()
