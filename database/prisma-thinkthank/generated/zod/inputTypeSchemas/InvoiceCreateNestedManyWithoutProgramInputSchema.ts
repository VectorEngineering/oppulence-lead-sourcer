...
export const InvoiceCreateNestedManyWithoutProgramInputSchema: z.ZodType<Prisma.InvoiceCreateNestedManyWithoutProgramInput> = z
    .object({
        create: z
            .union([
...
export default InvoiceCreateNestedManyWithoutProgramInputSchema
