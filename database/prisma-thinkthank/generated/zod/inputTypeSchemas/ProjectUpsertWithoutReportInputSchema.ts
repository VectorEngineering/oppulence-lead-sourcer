...
export const ProjectUpsertWithoutReportInputSchema: z.ZodType<Prisma.ProjectUpsertWithoutReportInput> = z
    .object({
        update: z.union([
        ...
        create: z.union([
            z.lazy(() => ProjectCreateWithoutReportInputSchema),
            z.lazy(() => ProjectUncheckedCreateWithoutReportInputSchema)
        ]),
