...
export const ProgramUpsertWithWhereUniqueWithoutWorkspaceInputSchema: z.ZodType<Prisma.ProgramUpsertWithWhereUniqueWithoutWorkspaceInput> = z.object({
  where: z.lazy(() => ProgramWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ProgramUpdateWithoutWorkspaceInputSchema),z.lazy(() => ProgramUncheckedUpdateWithoutWorkspaceInputSchema) ]),
