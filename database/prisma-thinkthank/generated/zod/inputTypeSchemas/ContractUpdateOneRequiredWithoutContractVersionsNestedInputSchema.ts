...
export const ContractUpdateOneRequiredWithoutContractVersionsNestedInputSchema: z.ZodType<Prisma.ContractUpdateOneRequiredWithoutContractVersionsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ContractCreateWithoutContractVersionsInputSchema),z.lazy(() => ContractUncheckedCreateWithoutContractVersionsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ContractUpdateToOneWithWhereWithoutContractVersionsInputSchema),z.lazy(() => ContractUpdateWithoutContractVersionsInputSchema),z.lazy(() => ContractUncheckedUpdateWithoutContractVersionsInputSchema) ]).optional(),
}).strict();
