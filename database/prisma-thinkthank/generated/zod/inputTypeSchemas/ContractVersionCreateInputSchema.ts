...
import { ContractCreateNestedOneWithoutContractVersionsInputSchema } from './ContractCreateNestedOneWithoutContractVersionsInputSchema';

export const ContractVersionCreateInputSchema: z.ZodType<Prisma.ContractVersionCreateInput> = z.object({
  ...
  contract: z.lazy(() => ContractCreateNestedOneWithoutContractVersionsInputSchema)
}).strict();

export default ContractVersionCreateInputSchema;
