...
export const BankAccountUpdateWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.BankAccountUpdateWithWhereUniqueWithoutProjectInput> =
    z
        .object({
            where: z.lazy(() => BankAccountWhereUniqueInputSchema),
            data: z.union([
                z.lazy(() => BankAccountUpdateWithoutProjectInputSchema),
                z.lazy(() => BankAccountUncheckedUpdateWithoutProjectInputSchema)
            ])
        })
        .strict()
