...
export const ProgramUpdateOneRequiredWithoutPayoutsNestedInputSchema: z.ZodType<Prisma.ProgramUpdateOneRequiredWithoutPayoutsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProgramUpdateToOneWithWhereWithoutPayoutsInputSchema),
