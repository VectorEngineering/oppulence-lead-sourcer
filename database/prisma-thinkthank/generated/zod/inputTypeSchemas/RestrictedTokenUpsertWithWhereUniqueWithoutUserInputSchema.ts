...
export const RestrictedTokenUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.RestrictedTokenUpsertWithWhereUniqueWithoutUserInput> =
    z
        .object({
            where: z.lazy(() => RestrictedTokenWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => RestrictedTokenUpdateWithoutUserInputSchema),
                z.lazy(() => RestrictedTokenUncheckedUpdateWithoutUserInputSchema)
            ]),
            create: z.union([
