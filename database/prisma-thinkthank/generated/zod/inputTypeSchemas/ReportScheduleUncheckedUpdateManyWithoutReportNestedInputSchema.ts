...
export const ReportScheduleUncheckedUpdateManyWithoutReportNestedInputSchema: z.ZodType<Prisma.ReportScheduleUncheckedUpdateManyWithoutReportNestedInput> =
    z
        .object({
            create: z
                .union([
