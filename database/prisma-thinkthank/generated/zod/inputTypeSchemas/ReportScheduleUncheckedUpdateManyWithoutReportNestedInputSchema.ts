...
export const ReportScheduleUncheckedUpdateManyWithoutReportNestedInputSchema: z.ZodType<Prisma.ReportScheduleUncheckedUpdateManyWithoutReportNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ReportScheduleUpsertWithWhereUniqueWithoutReportInputSchema),z.lazy(() => ReportScheduleUpsertWithWhereUniqueWithoutReportInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ReportScheduleCreateManyReportInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ReportScheduleWhereUniqueInputSchema),z.lazy(() => ReportScheduleWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ReportScheduleWhereUniqueInputSchema),z.lazy(() => ReportScheduleWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ReportScheduleWhereUniqueInputSchema),z.lazy(() => ReportScheduleWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => ReportScheduleWhereUniqueInputSchema),z.lazy(() => ReportScheduleWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ReportScheduleUpdateWithWhereUniqueWithoutReportInputSchema),z.lazy(() => ReportScheduleUpdateWithWhereUniqueWithoutReportInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ReportScheduleUpdateManyWithWhereWithoutReportInputSchema),z.lazy(() => ReportScheduleUpdateManyWithWhereWithoutReportInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ReportScheduleScalarWhereInputSchema),z.lazy(() => ReportScheduleScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ReportScheduleUncheckedUpdateManyWithoutReportNestedInputSchema;
