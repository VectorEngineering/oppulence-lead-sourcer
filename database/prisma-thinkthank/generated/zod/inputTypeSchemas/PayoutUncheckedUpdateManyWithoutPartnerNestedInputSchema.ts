...
export const PayoutUncheckedUpdateManyWithoutPartnerNestedInputSchema: z.ZodType<Prisma.PayoutUncheckedUpdateManyWithoutPartnerNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => PayoutUpsertWithWhereUniqueWithoutPartnerInputSchema),z.lazy(() => PayoutUpsertWithWhereUniqueWithoutPartnerInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => PayoutUpdateWithWhereUniqueWithoutPartnerInputSchema),z.lazy(() => PayoutUpdateWithWhereUniqueWithoutPartnerInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => PayoutUpdateManyWithWhereWithoutPartnerInputSchema),z.lazy(() => PayoutUpdateManyWithWhereWithoutPartnerInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => PayoutScalarWhereInputSchema),z.lazy(() => PayoutScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default PayoutUncheckedUpdateManyWithoutPartnerNestedInputSchema;
