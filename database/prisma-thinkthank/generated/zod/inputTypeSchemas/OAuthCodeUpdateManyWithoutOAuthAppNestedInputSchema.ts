...
export const OAuthCodeUpdateManyWithoutOAuthAppNestedInputSchema: z.ZodType<Prisma.OAuthCodeUpdateManyWithoutOAuthAppNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => OAuthCodeUpsertWithWhereUniqueWithoutOAuthAppInputSchema),
                z.lazy(() => OAuthCodeUpsertWithWhereUniqueWithoutOAuthAppInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => OAuthCodeUpdateWithWhereUniqueWithoutOAuthAppInputSchema),
                z.lazy(() => OAuthCodeUpdateWithWhereUniqueWithoutOAuthAppInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => OAuthCodeUpdateManyWithWhereWithoutOAuthAppInputSchema),
                z.lazy(() => OAuthCodeUpdateManyWithWhereWithoutOAuthAppInputSchema).array()
            ])
            .optional(),
        deleteMany: z
...
export default OAuthCodeUpdateManyWithoutOAuthAppNestedInputSchema
