...
export const LinkUpsertWithoutCustomersInputSchema: z.ZodType<Prisma.LinkUpsertWithoutCustomersInput> = z.object({
  update: z.union([ z.lazy(() => LinkUpdateWithoutCustomersInputSchema),z.lazy(() => LinkUncheckedUpdateWithoutCustomersInputSchema) ]),
