...
export const BankConnectionSettingsScalarWhereInputSchema: z.ZodType<Prisma.BankConnectionSettingsScalarWhereInput> = z
    .object({
        AND: z
            .union([
            ...
            .optional(),
        OR: z
            .lazy(() => BankConnectionSettingsScalarWhereInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
