...
export const InboxActivityUpsertWithWhereUniqueWithoutInboxInputSchema: z.ZodType<Prisma.InboxActivityUpsertWithWhereUniqueWithoutInboxInput> = z.object({
  where: z.lazy(() => InboxActivityWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => InboxActivityUpdateWithoutInboxInputSchema),z.lazy(() => InboxActivityUncheckedUpdateWithoutInboxInputSchema) ]),
  create: z.union([ z.lazy(() => InboxActivityCreateWithoutInboxInputSchema),z.lazy(() => InboxActivityUncheckedCreateWithoutInboxInputSchema) ]),
}).strict();
