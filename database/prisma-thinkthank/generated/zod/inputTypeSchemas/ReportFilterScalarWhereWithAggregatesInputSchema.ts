...
export const ReportFilterScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ReportFilterScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => ReportFilterScalarWhereWithAggregatesInputSchema),z.lazy(() => ReportFilterScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => ReportFilterScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => ReportFilterScalarWhereWithAggregatesInputSchema),z.lazy(() => ReportFilterScalarWhereWithAggregatesInputSchema).array() ]).optional(),
