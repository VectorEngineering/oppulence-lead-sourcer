...
export const PartnerUserUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.PartnerUserUpdateManyWithWhereWithoutUserInput> = z
    .object({
        where: z.lazy(() => PartnerUserScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => PartnerUserUpdateManyMutationInputSchema),
            z.lazy(() => PartnerUserUncheckedUpdateManyWithoutUserInputSchema)
        ])
    })
    .strict()
