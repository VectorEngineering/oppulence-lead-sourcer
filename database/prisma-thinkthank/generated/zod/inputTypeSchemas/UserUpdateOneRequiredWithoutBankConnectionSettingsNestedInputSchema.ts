...
export const UserUpdateOneRequiredWithoutBankConnectionSettingsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutBankConnectionSettingsNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => UserCreateWithoutBankConnectionSettingsInputSchema),
                    z.lazy(() => UserUncheckedCreateWithoutBankConnectionSettingsInputSchema)
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => UserUpdateToOneWithWhereWithoutBankConnectionSettingsInputSchema),
