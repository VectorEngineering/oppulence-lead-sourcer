...
export const NullableEnumTransactionFrequencyFieldUpdateOperationsInputSchema: z.ZodType<Prisma.NullableEnumTransactionFrequencyFieldUpdateOperationsInput> =
    z
        .object({
            set: z
