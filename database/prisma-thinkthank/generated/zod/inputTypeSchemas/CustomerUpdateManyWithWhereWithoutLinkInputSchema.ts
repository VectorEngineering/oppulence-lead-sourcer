...
export const CustomerUpdateManyWithWhereWithoutLinkInputSchema: z.ZodType<Prisma.CustomerUpdateManyWithWhereWithoutLinkInput> = z
    .object({
        where: z.lazy(() => CustomerScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => CustomerUpdateManyMutationInputSchema),
            z.lazy(() => CustomerUncheckedUpdateManyWithoutLinkInputSchema)
        ])
    })
    .strict()
