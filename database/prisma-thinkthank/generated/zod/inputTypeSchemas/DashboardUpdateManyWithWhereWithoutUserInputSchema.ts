...
export const DashboardUpdateManyWithWhereWithoutUserInputSchema: z.ZodType<Prisma.DashboardUpdateManyWithWhereWithoutUserInput> = z
    .object({
        where: z.lazy(() => DashboardScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => DashboardUpdateManyMutationInputSchema),
            z.lazy(() => DashboardUncheckedUpdateManyWithoutUserInputSchema)
        ])
    })
    .strict()
