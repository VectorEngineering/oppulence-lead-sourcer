...
export const OAuthRefreshTokenWhereUniqueInputSchema: z.ZodType<Prisma.OAuthRefreshTokenWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
    ...
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => OAuthRefreshTokenWhereInputSchema), z.lazy(() => OAuthRefreshTokenWhereInputSchema).array()])
                    .optional(),
                OR: z
                ...
                accessToken: z
                    .union([z.lazy(() => RestrictedTokenRelationFilterSchema), z.lazy(() => RestrictedTokenWhereInputSchema)])
                    .optional(),
