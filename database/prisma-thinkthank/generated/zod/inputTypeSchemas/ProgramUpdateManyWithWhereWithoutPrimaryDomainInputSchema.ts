...
export const ProgramUpdateManyWithWhereWithoutPrimaryDomainInputSchema: z.ZodType<Prisma.ProgramUpdateManyWithWhereWithoutPrimaryDomainInput> = z.object({
  where: z.lazy(() => ProgramScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ProgramUpdateManyMutationInputSchema),z.lazy(() => ProgramUncheckedUpdateManyWithoutPrimaryDomainInputSchema) ]),
}).strict();
