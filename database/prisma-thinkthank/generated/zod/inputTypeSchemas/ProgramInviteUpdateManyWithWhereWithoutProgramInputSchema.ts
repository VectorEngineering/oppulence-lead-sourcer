...
export const ProgramInviteUpdateManyWithWhereWithoutProgramInputSchema: z.ZodType<Prisma.ProgramInviteUpdateManyWithWhereWithoutProgramInput> =
    z
        .object({
            where: z.lazy(() => ProgramInviteScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => ProgramInviteUpdateManyMutationInputSchema),
                z.lazy(() => ProgramInviteUncheckedUpdateManyWithoutProgramInputSchema)
            ])
        })
        .strict()
