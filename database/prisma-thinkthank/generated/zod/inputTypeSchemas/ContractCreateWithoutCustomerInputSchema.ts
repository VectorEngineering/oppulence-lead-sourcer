...
export const ContractCreateWithoutCustomerInputSchema: z.ZodType<Prisma.ContractCreateWithoutCustomerInput> = z
    .object({
...
export default ContractCreateWithoutCustomerInputSchema
