...
export const IntegrationUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.IntegrationUpsertWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => IntegrationWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => IntegrationUpdateWithoutProjectInputSchema),z.lazy(() => IntegrationUncheckedUpdateWithoutProjectInputSchema) ]),
  create: z.union([ z.lazy(() => IntegrationCreateWithoutProjectInputSchema),z.lazy(() => IntegrationUncheckedCreateWithoutProjectInputSchema) ]),
}).strict();
