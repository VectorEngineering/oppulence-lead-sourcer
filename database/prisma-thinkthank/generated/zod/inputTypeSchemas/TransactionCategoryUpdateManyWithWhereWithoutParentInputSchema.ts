...
export const TransactionCategoryUpdateManyWithWhereWithoutParentInputSchema: z.ZodType<Prisma.TransactionCategoryUpdateManyWithWhereWithoutParentInput> = z.object({
  where: z.lazy(() => TransactionCategoryScalarWhereInputSchema),
  data: z.union([ z.lazy(() => TransactionCategoryUpdateManyMutationInputSchema),z.lazy(() => TransactionCategoryUncheckedUpdateManyWithoutParentInputSchema) ]),
}).strict();
