...
export const ProjectUpdateOneRequiredWithoutCustomersNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutCustomersNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => ProjectCreateWithoutCustomersInputSchema),
                    z.lazy(() => ProjectUncheckedCreateWithoutCustomersInputSchema)
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutCustomersInputSchema),
