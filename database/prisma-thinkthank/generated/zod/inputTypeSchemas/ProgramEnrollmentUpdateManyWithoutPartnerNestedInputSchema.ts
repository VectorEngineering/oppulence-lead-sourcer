...
export const ProgramEnrollmentUpdateManyWithoutPartnerNestedInputSchema: z.ZodType<Prisma.ProgramEnrollmentUpdateManyWithoutPartnerNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => ProgramEnrollmentCreateWithoutPartnerInputSchema),
                    z.lazy(() => ProgramEnrollmentCreateWithoutPartnerInputSchema).array(),
                    z.lazy(() => ProgramEnrollmentUncheckedCreateWithoutPartnerInputSchema),
                    z.lazy(() => ProgramEnrollmentUncheckedCreateWithoutPartnerInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => ProgramEnrollmentCreateOrConnectWithoutPartnerInputSchema),
                    z.lazy(() => ProgramEnrollmentCreateOrConnectWithoutPartnerInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => ProgramEnrollmentUpsertWithWhereUniqueWithoutPartnerInputSchema),
                    z.lazy(() => ProgramEnrollmentUpsertWithWhereUniqueWithoutPartnerInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => ProgramEnrollmentUpdateWithWhereUniqueWithoutPartnerInputSchema),
                    z.lazy(() => ProgramEnrollmentUpdateWithWhereUniqueWithoutPartnerInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => ProgramEnrollmentUpdateManyWithWhereWithoutPartnerInputSchema),
                    z.lazy(() => ProgramEnrollmentUpdateManyWithWhereWithoutPartnerInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
...
export default ProgramEnrollmentUpdateManyWithoutPartnerNestedInputSchema
