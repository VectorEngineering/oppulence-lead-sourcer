...
export const PartnerUpdateOneRequiredWithoutProgramsNestedInputSchema: z.ZodType<Prisma.PartnerUpdateOneRequiredWithoutProgramsNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => PartnerCreateWithoutProgramsInputSchema),
                    z.lazy(() => PartnerUncheckedCreateWithoutProgramsInputSchema)
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => PartnerUpdateToOneWithWhereWithoutProgramsInputSchema),
                    z.lazy(() => PartnerUpdateWithoutProgramsInputSchema),
                    z.lazy(() => PartnerUncheckedUpdateWithoutProgramsInputSchema)
                ])
                .optional()
        })
        .strict()
