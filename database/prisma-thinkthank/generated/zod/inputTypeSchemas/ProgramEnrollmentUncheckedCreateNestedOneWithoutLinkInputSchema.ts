...
export const ProgramEnrollmentUncheckedCreateNestedOneWithoutLinkInputSchema: z.ZodType<Prisma.ProgramEnrollmentUncheckedCreateNestedOneWithoutLinkInput> =
    z
        .object({
            create: z
                .union([
