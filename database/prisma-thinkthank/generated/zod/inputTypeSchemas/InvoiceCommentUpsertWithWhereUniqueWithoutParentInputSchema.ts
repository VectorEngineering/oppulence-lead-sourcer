...
export const InvoiceCommentUpsertWithWhereUniqueWithoutParentInputSchema: z.ZodType<Prisma.InvoiceCommentUpsertWithWhereUniqueWithoutParentInput> = z.object({
  where: z.lazy(() => InvoiceCommentWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => InvoiceCommentUpdateWithoutParentInputSchema),z.lazy(() => InvoiceCommentUncheckedUpdateWithoutParentInputSchema) ]),
  create: z.union([ z.lazy(() => InvoiceCommentCreateWithoutParentInputSchema),z.lazy(() => InvoiceCommentUncheckedCreateWithoutParentInputSchema) ]),
}).strict();
