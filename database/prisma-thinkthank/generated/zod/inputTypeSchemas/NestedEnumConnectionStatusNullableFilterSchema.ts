...
export const NestedEnumConnectionStatusNullableFilterSchema: z.ZodType<Prisma.NestedEnumConnectionStatusNullableFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => ConnectionStatusSchema),z.lazy(() => NestedEnumConnectionStatusNullableFilterSchema) ]).optional().nullable(),
}).strict();
