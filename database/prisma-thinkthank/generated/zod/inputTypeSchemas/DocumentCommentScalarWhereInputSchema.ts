...
export const DocumentCommentScalarWhereInputSchema: z.ZodType<Prisma.DocumentCommentScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => DocumentCommentScalarWhereInputSchema),z.lazy(() => DocumentCommentScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => DocumentCommentScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => DocumentCommentScalarWhereInputSchema),z.lazy(() => DocumentCommentScalarWhereInputSchema).array() ]).optional(),
