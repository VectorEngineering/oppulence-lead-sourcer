...
export const InvoiceUpdateManyWithWhereWithoutProgramInputSchema: z.ZodType<Prisma.InvoiceUpdateManyWithWhereWithoutProgramInput> = z
    .object({
        where: z.lazy(() => InvoiceScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => InvoiceUpdateManyMutationInputSchema),
            z.lazy(() => InvoiceUncheckedUpdateManyWithoutProgramInputSchema)
        ])
    })
    .strict()
