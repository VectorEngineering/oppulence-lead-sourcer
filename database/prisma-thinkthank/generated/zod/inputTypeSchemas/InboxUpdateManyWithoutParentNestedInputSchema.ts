...
export const InboxUpdateManyWithoutParentNestedInputSchema: z.ZodType<Prisma.InboxUpdateManyWithoutParentNestedInput> = z.object({
  create: z.union([ z.lazy(() => InboxCreateWithoutParentInputSchema),z.lazy(() => InboxCreateWithoutParentInputSchema).array(),z.lazy(() => InboxUncheckedCreateWithoutParentInputSchema),z.lazy(() => InboxUncheckedCreateWithoutParentInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => InboxCreateOrConnectWithoutParentInputSchema),z.lazy(() => InboxCreateOrConnectWithoutParentInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => InboxUpsertWithWhereUniqueWithoutParentInputSchema),z.lazy(() => InboxUpsertWithWhereUniqueWithoutParentInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => InboxUpdateWithWhereUniqueWithoutParentInputSchema),z.lazy(() => InboxUpdateWithWhereUniqueWithoutParentInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => InboxUpdateManyWithWhereWithoutParentInputSchema),z.lazy(() => InboxUpdateManyWithWhereWithoutParentInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => InboxScalarWhereInputSchema),z.lazy(() => InboxScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default InboxUpdateManyWithoutParentNestedInputSchema;
