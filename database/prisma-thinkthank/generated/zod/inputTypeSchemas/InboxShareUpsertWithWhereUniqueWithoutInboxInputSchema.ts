...
export const InboxShareUpsertWithWhereUniqueWithoutInboxInputSchema: z.ZodType<Prisma.InboxShareUpsertWithWhereUniqueWithoutInboxInput> = z.object({
  where: z.lazy(() => InboxShareWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => InboxShareUpdateWithoutInboxInputSchema),z.lazy(() => InboxShareUncheckedUpdateWithoutInboxInputSchema) ]),
