...
export const DocumentCommentUncheckedCreateNestedManyWithoutDocumentInputSchema: z.ZodType<Prisma.DocumentCommentUncheckedCreateNestedManyWithoutDocumentInput> =
    z
        .object({
            create: z
                .union([
