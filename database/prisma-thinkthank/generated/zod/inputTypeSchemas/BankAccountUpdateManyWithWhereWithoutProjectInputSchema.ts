...
export const BankAccountUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.BankAccountUpdateManyWithWhereWithoutProjectInput> =
    z
        .object({
            where: z.lazy(() => BankAccountScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => BankAccountUpdateManyMutationInputSchema),
                z.lazy(() => BankAccountUncheckedUpdateManyWithoutProjectInputSchema)
            ])
        })
        .strict()
