...
import { TransactionCategoryNullableRelationFilterSchema } from './TransactionCategoryNullableRelationFilterSchema'
import { TransactionCategoryWhereInputSchema } from './TransactionCategoryWhereInputSchema'
import { BankAccountNullableRelationFilterSchema } from './BankAccountNullableRelationFilterSchema'
...
import { TransactionCommentListRelationFilterSchema } from './TransactionCommentListRelationFilterSchema'
import { TransactionHistoryListRelationFilterSchema } from './TransactionHistoryListRelationFilterSchema'
import { TransactionReconciliationMatchListRelationFilterSchema } from './TransactionReconciliationMatchListRelationFilterSchema'
        ...
        z
            .object({
                ...
                verificationStatus: z
                    .union([z.lazy(() => EnumTransactionVerificationStatusFilterSchema), z.lazy(() => TransactionVerificationStatusSchema)])
                    .optional(),
                reconciliationStatus: z
                    .union([
                        z.lazy(() => EnumTransactionReconciliationStatusFilterSchema),
                ...
                riskLevel: z
                    .union([z.lazy(() => EnumTransactionRiskLevelFilterSchema), z.lazy(() => TransactionRiskLevelSchema)])
                    .optional(),
                categoryTag: z
                    .union([z.lazy(() => EnumTransactionCategoryTagNullableFilterSchema), z.lazy(() => TransactionCategoryTagSchema)])
                    .optional()
                    .nullable(),
                categoryId: z
                    .union([z.lazy(() => StringNullableFilterSchema), z.string()])
                ...
                recurring: z
                    ...
                    .nullable(),
                frequency: z
                    .union([z.lazy(() => EnumTransactionFrequencyNullableFilterSchema), z.lazy(() => TransactionFrequencySchema)])
                    .optional()
                    .nullable(),
                nextDueDate: z
                    .union([z.lazy(() => DateTimeNullableFilterSchema), z.coerce.date()])
                ...
                category: z
                    .union([
                        z.lazy(() => TransactionCategoryNullableRelationFilterSchema),
                        z.lazy(() => TransactionCategoryWhereInputSchema)
                    ])
                    .optional()
                    .nullable(),
                bankAccount: z
                    .union([z.lazy(() => BankAccountNullableRelationFilterSchema), z.lazy(() => BankAccountWhereInputSchema)])
                    .optional()
                    .nullable(),
                assignedTo: z
                ...
                attachments: z.lazy(() => TransactionAttachmentListRelationFilterSchema).optional(),
                tags: z.lazy(() => TagListRelationFilterSchema).optional(),
                comments: z.lazy(() => TransactionCommentListRelationFilterSchema).optional(),
                history: z.lazy(() => TransactionHistoryListRelationFilterSchema).optional(),
                reconciliationMatches: z.lazy(() => TransactionReconciliationMatchListRelationFilterSchema).optional(),
