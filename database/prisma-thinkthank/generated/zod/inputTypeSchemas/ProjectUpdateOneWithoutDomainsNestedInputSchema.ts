...
export const ProjectUpdateOneWithoutDomainsNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneWithoutDomainsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutDomainsInputSchema),z.lazy(() => ProjectUpdateWithoutDomainsInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutDomainsInputSchema) ]).optional(),
}).strict();
