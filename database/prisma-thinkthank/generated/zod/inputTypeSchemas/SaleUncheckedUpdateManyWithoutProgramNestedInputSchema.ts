...
export const SaleUncheckedUpdateManyWithoutProgramNestedInputSchema: z.ZodType<Prisma.SaleUncheckedUpdateManyWithoutProgramNestedInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => SaleCreateWithoutProgramInputSchema),
                z.lazy(() => SaleCreateWithoutProgramInputSchema).array(),
                z.lazy(() => SaleUncheckedCreateWithoutProgramInputSchema),
                z.lazy(() => SaleUncheckedCreateWithoutProgramInputSchema).array()
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => SaleCreateOrConnectWithoutProgramInputSchema),
                z.lazy(() => SaleCreateOrConnectWithoutProgramInputSchema).array()
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => SaleUpsertWithWhereUniqueWithoutProgramInputSchema),
                z.lazy(() => SaleUpsertWithWhereUniqueWithoutProgramInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => SaleUpdateWithWhereUniqueWithoutProgramInputSchema),
                z.lazy(() => SaleUpdateWithWhereUniqueWithoutProgramInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => SaleUpdateManyWithWhereWithoutProgramInputSchema),
                z.lazy(() => SaleUpdateManyWithWhereWithoutProgramInputSchema).array()
            ])
            .optional(),
...
export default SaleUncheckedUpdateManyWithoutProgramNestedInputSchema
