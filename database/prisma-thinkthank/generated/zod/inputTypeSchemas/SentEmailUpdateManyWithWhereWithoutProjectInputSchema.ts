...
export const SentEmailUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.SentEmailUpdateManyWithWhereWithoutProjectInput> = z.object({
  where: z.lazy(() => SentEmailScalarWhereInputSchema),
  data: z.union([ z.lazy(() => SentEmailUpdateManyMutationInputSchema),z.lazy(() => SentEmailUncheckedUpdateManyWithoutProjectInputSchema) ]),
}).strict();
