...
export const ProgramApplicationCreateNestedManyWithoutProgramInputSchema: z.ZodType<Prisma.ProgramApplicationCreateNestedManyWithoutProgramInput> =
    z
        .object({
            create: z
                .union([
...
export default ProgramApplicationCreateNestedManyWithoutProgramInputSchema
