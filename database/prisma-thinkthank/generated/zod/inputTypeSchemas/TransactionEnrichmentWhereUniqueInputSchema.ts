...
export const TransactionEnrichmentWhereUniqueInputSchema: z.ZodType<Prisma.TransactionEnrichmentWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([
                        z.lazy(() => TransactionEnrichmentWhereInputSchema),
                        z.lazy(() => TransactionEnrichmentWhereInputSchema).array()
                    ])
                    .optional(),
                OR: z
                    .lazy(() => TransactionEnrichmentWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([
...
export default TransactionEnrichmentWhereUniqueInputSchema
