...
export const ContractDocumentCreateNestedOneWithoutDocumentCommentsInputSchema: z.ZodType<Prisma.ContractDocumentCreateNestedOneWithoutDocumentCommentsInput> =
    z
        .object({
            create: z
                .union([
