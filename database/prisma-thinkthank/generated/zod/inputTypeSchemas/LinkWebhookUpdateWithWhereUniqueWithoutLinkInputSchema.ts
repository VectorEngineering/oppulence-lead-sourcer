...
export const LinkWebhookUpdateWithWhereUniqueWithoutLinkInputSchema: z.ZodType<Prisma.LinkWebhookUpdateWithWhereUniqueWithoutLinkInput> = z
    .object({
        where: z.lazy(() => LinkWebhookWhereUniqueInputSchema),
        data: z.union([
            z.lazy(() => LinkWebhookUpdateWithoutLinkInputSchema),
            z.lazy(() => LinkWebhookUncheckedUpdateWithoutLinkInputSchema)
        ])
    })
    .strict()
