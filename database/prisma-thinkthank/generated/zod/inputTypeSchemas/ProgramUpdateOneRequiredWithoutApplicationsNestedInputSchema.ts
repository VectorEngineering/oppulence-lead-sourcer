...
export const ProgramUpdateOneRequiredWithoutApplicationsNestedInputSchema: z.ZodType<Prisma.ProgramUpdateOneRequiredWithoutApplicationsNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => ProgramCreateWithoutApplicationsInputSchema),
                    z.lazy(() => ProgramUncheckedCreateWithoutApplicationsInputSchema)
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => ProgramUpdateToOneWithWhereWithoutApplicationsInputSchema),
