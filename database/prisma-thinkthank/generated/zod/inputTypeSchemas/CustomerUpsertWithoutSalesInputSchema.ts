...
export const CustomerUpsertWithoutSalesInputSchema: z.ZodType<Prisma.CustomerUpsertWithoutSalesInput> = z
    .object({
        update: z.union([
        ...
        create: z.union([
            z.lazy(() => CustomerCreateWithoutSalesInputSchema),
            z.lazy(() => CustomerUncheckedCreateWithoutSalesInputSchema)
        ]),
