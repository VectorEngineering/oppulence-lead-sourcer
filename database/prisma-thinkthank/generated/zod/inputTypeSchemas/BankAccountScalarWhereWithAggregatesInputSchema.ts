...
export const BankAccountScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.BankAccountScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => BankAccountScalarWhereWithAggregatesInputSchema),
                z.lazy(() => BankAccountScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => BankAccountScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
        ...
        description: z
            ...
            .nullable(),
        type: z
            .union([z.lazy(() => EnumAccountTypeNullableWithAggregatesFilterSchema), z.lazy(() => AccountTypeSchema)])
            .optional()
            .nullable(),
        subtype: z
            .union([z.lazy(() => EnumAccountSubTypeNullableWithAggregatesFilterSchema), z.lazy(() => AccountSubTypeSchema)])
            .optional()
            .nullable(),
        ownershipType: z
            .union([z.lazy(() => EnumAccountOwnershipTypeNullableWithAggregatesFilterSchema), z.lazy(() => AccountOwnershipTypeSchema)])
            .optional()
            .nullable(),
        purpose: z
            .union([z.lazy(() => EnumAccountPurposeNullableWithAggregatesFilterSchema), z.lazy(() => AccountPurposeSchema)])
            .optional()
            .nullable(),
        balance: z
        ...
        approvalThreshold: z
            ...
            .nullable(),
        status: z
            .union([z.lazy(() => EnumConnectionStatusNullableWithAggregatesFilterSchema), z.lazy(() => ConnectionStatusSchema)])
            .optional()
            .nullable(),
        errorDetails: z
            .union([z.lazy(() => StringNullableWithAggregatesFilterSchema), z.string()])
        ...
        lastErrorAt: z
            ...
            .nullable(),
        riskLevel: z
            .union([z.lazy(() => EnumRiskLevelNullableWithAggregatesFilterSchema), z.lazy(() => RiskLevelSchema)])
            .optional()
            .nullable(),
        complianceStatus: z
            .union([z.lazy(() => EnumComplianceStatusNullableWithAggregatesFilterSchema), z.lazy(() => ComplianceStatusSchema)])
            .optional()
            .nullable(),
        lastReviewDate: z
            .union([z.lazy(() => DateTimeNullableWithAggregatesFilterSchema), z.coerce.date()])
