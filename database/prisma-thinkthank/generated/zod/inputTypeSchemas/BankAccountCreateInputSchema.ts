...
import { TagCreateNestedManyWithoutBankAccountInputSchema } from './TagCreateNestedManyWithoutBankAccountInputSchema'
import { BankConnectionCreateNestedOneWithoutBankAccountsInputSchema } from './BankConnectionCreateNestedOneWithoutBankAccountsInputSchema'
import { ProjectCreateNestedOneWithoutBankAccountInputSchema } from './ProjectCreateNestedOneWithoutBankAccountInputSchema'
import { UserCreateNestedOneWithoutBankAccountsInputSchema } from './UserCreateNestedOneWithoutBankAccountsInputSchema'
import { TransactionCreateNestedManyWithoutBankAccountInputSchema } from './TransactionCreateNestedManyWithoutBankAccountInputSchema'

export const BankAccountCreateInputSchema: z.ZodType<Prisma.BankAccountCreateInput> = z
    .object({
        ...
        subtype: z
            ...
            .nullable(),
        ownershipType: z
            .lazy(() => AccountOwnershipTypeSchema)
            .optional()
            .nullable(),
        purpose: z
        ...
        tags: z.lazy(() => TagCreateNestedManyWithoutBankAccountInputSchema).optional(),
        bankConnection: z.lazy(() => BankConnectionCreateNestedOneWithoutBankAccountsInputSchema),
        project: z.lazy(() => ProjectCreateNestedOneWithoutBankAccountInputSchema),
        creator: z.lazy(() => UserCreateNestedOneWithoutBankAccountsInputSchema),
        transactions: z.lazy(() => TransactionCreateNestedManyWithoutBankAccountInputSchema).optional()
    })
    .strict()
