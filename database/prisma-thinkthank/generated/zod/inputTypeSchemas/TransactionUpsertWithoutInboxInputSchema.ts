...
export const TransactionUpsertWithoutInboxInputSchema: z.ZodType<Prisma.TransactionUpsertWithoutInboxInput> = z.object({
  update: z.union([ z.lazy(() => TransactionUpdateWithoutInboxInputSchema),z.lazy(() => TransactionUncheckedUpdateWithoutInboxInputSchema) ]),
