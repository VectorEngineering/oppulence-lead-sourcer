...
export const ReportUpdateOneRequiredWithoutColumnsNestedInputSchema: z.ZodType<Prisma.ReportUpdateOneRequiredWithoutColumnsNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => ReportCreateWithoutColumnsInputSchema), z.lazy(() => ReportUncheckedCreateWithoutColumnsInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => ReportUpdateToOneWithWhereWithoutColumnsInputSchema),
                z.lazy(() => ReportUpdateWithoutColumnsInputSchema),
                z.lazy(() => ReportUncheckedUpdateWithoutColumnsInputSchema)
            ])
            .optional()
    })
    .strict()
