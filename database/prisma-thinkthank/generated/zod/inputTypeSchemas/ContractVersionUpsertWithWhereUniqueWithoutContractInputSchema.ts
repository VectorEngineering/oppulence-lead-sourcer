...
export const ContractVersionUpsertWithWhereUniqueWithoutContractInputSchema: z.ZodType<Prisma.ContractVersionUpsertWithWhereUniqueWithoutContractInput> = z.object({
  where: z.lazy(() => ContractVersionWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ContractVersionUpdateWithoutContractInputSchema),z.lazy(() => ContractVersionUncheckedUpdateWithoutContractInputSchema) ]),
