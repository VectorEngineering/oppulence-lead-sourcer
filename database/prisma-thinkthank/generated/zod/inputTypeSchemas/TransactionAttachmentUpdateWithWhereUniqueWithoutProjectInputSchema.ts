...
export const TransactionAttachmentUpdateWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.TransactionAttachmentUpdateWithWhereUniqueWithoutProjectInput> =
    z
        .object({
            where: z.lazy(() => TransactionAttachmentWhereUniqueInputSchema),
            data: z.union([
                z.lazy(() => TransactionAttachmentUpdateWithoutProjectInputSchema),
                z.lazy(() => TransactionAttachmentUncheckedUpdateWithoutProjectInputSchema)
            ])
        })
        .strict()
