...
export const ProgramCreateWithoutSalesInputSchema: z.ZodType<Prisma.ProgramCreateWithoutSalesInput> = z.object({
...
export default ProgramCreateWithoutSalesInputSchema;
