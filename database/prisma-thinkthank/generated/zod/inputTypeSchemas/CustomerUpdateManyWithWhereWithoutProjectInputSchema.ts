...
export const CustomerUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.CustomerUpdateManyWithWhereWithoutProjectInput> = z
    .object({
        where: z.lazy(() => CustomerScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => CustomerUpdateManyMutationInputSchema),
            z.lazy(() => CustomerUncheckedUpdateManyWithoutProjectInputSchema)
        ])
    })
    .strict()
