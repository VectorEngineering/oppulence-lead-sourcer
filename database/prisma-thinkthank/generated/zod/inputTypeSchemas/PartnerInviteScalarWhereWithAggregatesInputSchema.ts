...
export const PartnerInviteScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.PartnerInviteScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => PartnerInviteScalarWhereWithAggregatesInputSchema),
                z.lazy(() => PartnerInviteScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => PartnerInviteScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
