...
export const ReportFilterUpdateManyWithoutReportNestedInputSchema: z.ZodType<Prisma.ReportFilterUpdateManyWithoutReportNestedInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => ReportFilterCreateWithoutReportInputSchema),
                z.lazy(() => ReportFilterCreateWithoutReportInputSchema).array(),
                z.lazy(() => ReportFilterUncheckedCreateWithoutReportInputSchema),
                z.lazy(() => ReportFilterUncheckedCreateWithoutReportInputSchema).array()
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => ReportFilterCreateOrConnectWithoutReportInputSchema),
                z.lazy(() => ReportFilterCreateOrConnectWithoutReportInputSchema).array()
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => ReportFilterUpsertWithWhereUniqueWithoutReportInputSchema),
                z.lazy(() => ReportFilterUpsertWithWhereUniqueWithoutReportInputSchema).array()
            ])
            .optional(),
        createMany: z.lazy(() => ReportFilterCreateManyReportInputEnvelopeSchema).optional(),
        set: z
            .union([z.lazy(() => ReportFilterWhereUniqueInputSchema), z.lazy(() => ReportFilterWhereUniqueInputSchema).array()])
            .optional(),
        disconnect: z
            .union([z.lazy(() => ReportFilterWhereUniqueInputSchema), z.lazy(() => ReportFilterWhereUniqueInputSchema).array()])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => ReportFilterUpdateWithWhereUniqueWithoutReportInputSchema),
                z.lazy(() => ReportFilterUpdateWithWhereUniqueWithoutReportInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => ReportFilterUpdateManyWithWhereWithoutReportInputSchema),
                z.lazy(() => ReportFilterUpdateManyWithWhereWithoutReportInputSchema).array()
            ])
            .optional(),
        deleteMany: z
            .union([z.lazy(() => ReportFilterScalarWhereInputSchema), z.lazy(() => ReportFilterScalarWhereInputSchema).array()])
            .optional()
    })
    .strict()

export default ReportFilterUpdateManyWithoutReportNestedInputSchema
