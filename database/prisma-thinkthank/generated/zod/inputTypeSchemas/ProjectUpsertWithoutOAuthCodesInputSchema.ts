...
export const ProjectUpsertWithoutOAuthCodesInputSchema: z.ZodType<Prisma.ProjectUpsertWithoutOAuthCodesInput> = z.object({
  update: z.union([ z.lazy(() => ProjectUpdateWithoutOAuthCodesInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutOAuthCodesInputSchema) ]),
  create: z.union([ z.lazy(() => ProjectCreateWithoutOAuthCodesInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutOAuthCodesInputSchema) ]),
