...
export const OAuthAppScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.OAuthAppScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => OAuthAppScalarWhereWithAggregatesInputSchema),z.lazy(() => OAuthAppScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => OAuthAppScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => OAuthAppScalarWhereWithAggregatesInputSchema),z.lazy(() => OAuthAppScalarWhereWithAggregatesInputSchema).array() ]).optional(),
