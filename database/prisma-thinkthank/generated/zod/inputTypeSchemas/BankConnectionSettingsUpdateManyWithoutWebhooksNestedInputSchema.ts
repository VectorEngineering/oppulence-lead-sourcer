...
export const BankConnectionSettingsUpdateManyWithoutWebhooksNestedInputSchema: z.ZodType<Prisma.BankConnectionSettingsUpdateManyWithoutWebhooksNestedInput> =
    z
        .object({
            create: z
                .union([
