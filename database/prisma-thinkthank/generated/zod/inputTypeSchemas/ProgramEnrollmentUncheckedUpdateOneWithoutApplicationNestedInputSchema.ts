...
export const ProgramEnrollmentUncheckedUpdateOneWithoutApplicationNestedInputSchema: z.ZodType<Prisma.ProgramEnrollmentUncheckedUpdateOneWithoutApplicationNestedInput> =
    z
        .object({
            create: z
                .union([
