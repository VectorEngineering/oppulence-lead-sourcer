...
export const InboxLabelScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.InboxLabelScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => InboxLabelScalarWhereWithAggregatesInputSchema),
                z.lazy(() => InboxLabelScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => InboxLabelScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
