...
export const ReportScheduleUpdateWithWhereUniqueWithoutReportInputSchema: z.ZodType<Prisma.ReportScheduleUpdateWithWhereUniqueWithoutReportInput> =
    z
        .object({
            where: z.lazy(() => ReportScheduleWhereUniqueInputSchema),
            data: z.union([
                z.lazy(() => ReportScheduleUpdateWithoutReportInputSchema),
                z.lazy(() => ReportScheduleUncheckedUpdateWithoutReportInputSchema)
            ])
        })
        .strict()
