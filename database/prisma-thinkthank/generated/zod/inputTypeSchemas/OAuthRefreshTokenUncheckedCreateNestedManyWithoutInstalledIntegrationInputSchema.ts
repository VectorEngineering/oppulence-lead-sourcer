...
export const OAuthRefreshTokenUncheckedCreateNestedManyWithoutInstalledIntegrationInputSchema: z.ZodType<Prisma.OAuthRefreshTokenUncheckedCreateNestedManyWithoutInstalledIntegrationInput> =
    z
        .object({
            create: z
                .union([
...
export default OAuthRefreshTokenUncheckedCreateNestedManyWithoutInstalledIntegrationInputSchema
