...
export const TransactionUncheckedUpdateManyWithoutAssignedToNestedInputSchema: z.ZodType<Prisma.TransactionUncheckedUpdateManyWithoutAssignedToNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => TransactionUpsertWithWhereUniqueWithoutAssignedToInputSchema),
                    z.lazy(() => TransactionUpsertWithWhereUniqueWithoutAssignedToInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => TransactionUpdateWithWhereUniqueWithoutAssignedToInputSchema),
                    z.lazy(() => TransactionUpdateWithWhereUniqueWithoutAssignedToInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => TransactionUpdateManyWithWhereWithoutAssignedToInputSchema),
                    z.lazy(() => TransactionUpdateManyWithWhereWithoutAssignedToInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default TransactionUncheckedUpdateManyWithoutAssignedToNestedInputSchema
