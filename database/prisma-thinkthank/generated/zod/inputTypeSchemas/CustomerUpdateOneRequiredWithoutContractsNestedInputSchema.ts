...
export const CustomerUpdateOneRequiredWithoutContractsNestedInputSchema: z.ZodType<Prisma.CustomerUpdateOneRequiredWithoutContractsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => CustomerUpdateToOneWithWhereWithoutContractsInputSchema),
