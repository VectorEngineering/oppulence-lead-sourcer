...
export const ReportUpdateOneRequiredWithoutRecipientsNestedInputSchema: z.ZodType<Prisma.ReportUpdateOneRequiredWithoutRecipientsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ReportUpdateToOneWithWhereWithoutRecipientsInputSchema),
