...
export const InboxUpsertWithoutChildrenInputSchema: z.ZodType<Prisma.InboxUpsertWithoutChildrenInput> = z
    .object({
        update: z.union([
        ...
        create: z.union([
            z.lazy(() => InboxCreateWithoutChildrenInputSchema),
            z.lazy(() => InboxUncheckedCreateWithoutChildrenInputSchema)
        ]),
