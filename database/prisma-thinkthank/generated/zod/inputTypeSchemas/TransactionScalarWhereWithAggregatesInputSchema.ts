...
export const TransactionScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.TransactionScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
        ...
        verificationStatus: z
            .union([
                z.lazy(() => EnumTransactionVerificationStatusWithAggregatesFilterSchema),
                z.lazy(() => TransactionVerificationStatusSchema)
            ])
            .optional(),
        reconciliationStatus: z
            .union([
                z.lazy(() => EnumTransactionReconciliationStatusWithAggregatesFilterSchema),
                z.lazy(() => TransactionReconciliationStatusSchema)
            ])
            .optional(),
        priority: z
            .union([z.lazy(() => EnumTransactionPriorityWithAggregatesFilterSchema), z.lazy(() => TransactionPrioritySchema)])
            .optional(),
        riskLevel: z
            .union([z.lazy(() => EnumTransactionRiskLevelWithAggregatesFilterSchema), z.lazy(() => TransactionRiskLevelSchema)])
            .optional(),
        categoryTag: z
            .union([z.lazy(() => EnumTransactionCategoryTagNullableWithAggregatesFilterSchema), z.lazy(() => TransactionCategoryTagSchema)])
            .optional()
            .nullable(),
        categoryId: z
            .union([z.lazy(() => StringNullableWithAggregatesFilterSchema), z.string()])
        ...
        recurring: z
            ...
            .nullable(),
        frequency: z
            .union([z.lazy(() => EnumTransactionFrequencyNullableWithAggregatesFilterSchema), z.lazy(() => TransactionFrequencySchema)])
            .optional()
            .nullable(),
        nextDueDate: z
            .union([z.lazy(() => DateTimeNullableWithAggregatesFilterSchema), z.coerce.date()])
