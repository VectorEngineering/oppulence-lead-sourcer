...
export const ProjectUpdateOneRequiredWithoutBankConnectionsNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutBankConnectionsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutBankConnectionsInputSchema),z.lazy(() => ProjectUpdateWithoutBankConnectionsInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutBankConnectionsInputSchema) ]).optional(),
}).strict();
