...
export const ProgramApplicationUpdateManyWithWhereWithoutProgramInputSchema: z.ZodType<Prisma.ProgramApplicationUpdateManyWithWhereWithoutProgramInput> = z.object({
  where: z.lazy(() => ProgramApplicationScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ProgramApplicationUpdateManyMutationInputSchema),z.lazy(() => ProgramApplicationUncheckedUpdateManyWithoutProgramInputSchema) ]),
}).strict();
