...
export const ContractApprovalUncheckedCreateNestedManyWithoutContractInputSchema: z.ZodType<Prisma.ContractApprovalUncheckedCreateNestedManyWithoutContractInput> =
    z
        .object({
            create: z
                .union([
