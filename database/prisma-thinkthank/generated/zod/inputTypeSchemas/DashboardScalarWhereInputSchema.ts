...
export const DashboardScalarWhereInputSchema: z.ZodType<Prisma.DashboardScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => DashboardScalarWhereInputSchema),z.lazy(() => DashboardScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => DashboardScalarWhereInputSchema).array().optional(),
