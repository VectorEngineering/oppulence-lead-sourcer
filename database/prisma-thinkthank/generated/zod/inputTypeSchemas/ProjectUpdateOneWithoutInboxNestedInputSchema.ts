...
export const ProjectUpdateOneWithoutInboxNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneWithoutInboxNestedInput> = z
    .object({
        create: z
        ...
        update: z
            .union([
                z.lazy(() => ProjectUpdateToOneWithWhereWithoutInboxInputSchema),
                z.lazy(() => ProjectUpdateWithoutInboxInputSchema),
                z.lazy(() => ProjectUncheckedUpdateWithoutInboxInputSchema)
            ])
            .optional()
    })
    .strict()
