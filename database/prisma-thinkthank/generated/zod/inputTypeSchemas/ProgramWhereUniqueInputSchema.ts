...
export const ProgramWhereUniqueInputSchema: z.ZodType<Prisma.ProgramWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    slug: z.string()
  }),
...
.and(z.object({
  ...
  commissionDuration: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  ...
  primaryDomain: z.union([ z.lazy(() => DomainNullableRelationFilterSchema),z.lazy(() => DomainWhereInputSchema) ]).optional().nullable(),
