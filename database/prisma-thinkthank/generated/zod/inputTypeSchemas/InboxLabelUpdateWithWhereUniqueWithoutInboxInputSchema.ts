...
export const InboxLabelUpdateWithWhereUniqueWithoutInboxInputSchema: z.ZodType<Prisma.InboxLabelUpdateWithWhereUniqueWithoutInboxInput> = z.object({
  where: z.lazy(() => InboxLabelWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => InboxLabelUpdateWithoutInboxInputSchema),z.lazy(() => InboxLabelUncheckedUpdateWithoutInboxInputSchema) ]),
}).strict();
