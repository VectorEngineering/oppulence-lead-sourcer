...
export const UserUpdateOneRequiredWithoutBankAccountsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutBankAccountsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => UserUpdateToOneWithWhereWithoutBankAccountsInputSchema),
