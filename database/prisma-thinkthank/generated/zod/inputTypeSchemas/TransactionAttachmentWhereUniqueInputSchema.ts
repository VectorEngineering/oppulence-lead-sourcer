...
export const TransactionAttachmentWhereUniqueInputSchema: z.ZodType<Prisma.TransactionAttachmentWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
            ...
            .object({
                ...
                AND: z
                    .union([
                        ...
                        z.lazy(() => TransactionAttachmentWhereInputSchema).array()
                    ])
                    .optional(),
                OR: z
...
export default TransactionAttachmentWhereUniqueInputSchema
