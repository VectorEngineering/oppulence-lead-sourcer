...
export const ReportUpsertWithoutFiltersInputSchema: z.ZodType<Prisma.ReportUpsertWithoutFiltersInput> = z
    .object({
        update: z.union([
        ...
        create: z.union([
            z.lazy(() => ReportCreateWithoutFiltersInputSchema),
            z.lazy(() => ReportUncheckedCreateWithoutFiltersInputSchema)
        ]),
