...
export const InvoiceUncheckedCreateWithoutCustomerInputSchema: z.ZodType<Prisma.InvoiceUncheckedCreateWithoutCustomerInput> = z
    .object({
...
export default InvoiceUncheckedCreateWithoutCustomerInputSchema
