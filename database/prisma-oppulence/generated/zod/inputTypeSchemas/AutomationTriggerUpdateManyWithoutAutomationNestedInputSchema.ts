...
export const AutomationTriggerUpdateManyWithoutAutomationNestedInputSchema: z.ZodType<Prisma.AutomationTriggerUpdateManyWithoutAutomationNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => AutomationTriggerCreateWithoutAutomationInputSchema),
                    z.lazy(() => AutomationTriggerCreateWithoutAutomationInputSchema).array(),
                    z.lazy(() => AutomationTriggerUncheckedCreateWithoutAutomationInputSchema),
                    z.lazy(() => AutomationTriggerUncheckedCreateWithoutAutomationInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => AutomationTriggerCreateOrConnectWithoutAutomationInputSchema),
                    z.lazy(() => AutomationTriggerCreateOrConnectWithoutAutomationInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => AutomationTriggerUpsertWithWhereUniqueWithoutAutomationInputSchema),
                    z.lazy(() => AutomationTriggerUpsertWithWhereUniqueWithoutAutomationInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => AutomationTriggerCreateManyAutomationInputEnvelopeSchema).optional(),
            set: z
                .union([
                    z.lazy(() => AutomationTriggerWhereUniqueInputSchema),
                    z.lazy(() => AutomationTriggerWhereUniqueInputSchema).array()
                ])
                .optional(),
            disconnect: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => AutomationTriggerUpdateWithWhereUniqueWithoutAutomationInputSchema),
                    z.lazy(() => AutomationTriggerUpdateWithWhereUniqueWithoutAutomationInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => AutomationTriggerUpdateManyWithWhereWithoutAutomationInputSchema),
                    z.lazy(() => AutomationTriggerUpdateManyWithWhereWithoutAutomationInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
                    z.lazy(() => AutomationTriggerScalarWhereInputSchema),
                    z.lazy(() => AutomationTriggerScalarWhereInputSchema).array()
                ])
                .optional()
        })
        .strict()

export default AutomationTriggerUpdateManyWithoutAutomationNestedInputSchema
