...
export const CustomerCreateNestedManyWithoutLinkInputSchema: z.ZodType<Prisma.CustomerCreateNestedManyWithoutLinkInput> = z
    .object({
        create: z
            .union([
...
export default CustomerCreateNestedManyWithoutLinkInputSchema
