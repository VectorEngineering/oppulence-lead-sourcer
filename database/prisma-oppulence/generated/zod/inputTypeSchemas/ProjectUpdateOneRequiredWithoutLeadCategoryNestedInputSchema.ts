...
export const ProjectUpdateOneRequiredWithoutLeadCategoryNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutLeadCategoryNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutLeadCategoryInputSchema),
