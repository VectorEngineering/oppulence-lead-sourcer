...
export const AccessRuleConditionUncheckedCreateNestedManyWithoutRuleInputSchema: z.ZodType<Prisma.AccessRuleConditionUncheckedCreateNestedManyWithoutRuleInput> =
    z
        .object({
            create: z
                .union([
