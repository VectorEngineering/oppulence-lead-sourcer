...
export const LeadUpdateOneRequiredWithoutLeadComplianceAuditNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutLeadComplianceAuditNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadUpdateToOneWithWhereWithoutLeadComplianceAuditInputSchema),
