...
export const LeadCommunicationWhereUniqueInputSchema: z.ZodType<Prisma.LeadCommunicationWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => LeadCommunicationWhereInputSchema), z.lazy(() => LeadCommunicationWhereInputSchema).array()])
                    .optional(),
                OR: z
                    .lazy(() => LeadCommunicationWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([z.lazy(() => LeadCommunicationWhereInputSchema), z.lazy(() => LeadCommunicationWhereInputSchema).array()])
