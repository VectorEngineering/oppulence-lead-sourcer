...
export const LeadCommunicationUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadCommunicationUncheckedUpdateManyWithoutLeadNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => LeadCommunicationUpsertWithWhereUniqueWithoutLeadInputSchema),
                    z.lazy(() => LeadCommunicationUpsertWithWhereUniqueWithoutLeadInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => LeadCommunicationUpdateWithWhereUniqueWithoutLeadInputSchema),
                    z.lazy(() => LeadCommunicationUpdateWithWhereUniqueWithoutLeadInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => LeadCommunicationUpdateManyWithWhereWithoutLeadInputSchema),
                    z.lazy(() => LeadCommunicationUpdateManyWithWhereWithoutLeadInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
                    z.lazy(() => LeadCommunicationScalarWhereInputSchema),
                    z.lazy(() => LeadCommunicationScalarWhereInputSchema).array()
                ])
                .optional()
        })
        .strict()

export default LeadCommunicationUncheckedUpdateManyWithoutLeadNestedInputSchema
