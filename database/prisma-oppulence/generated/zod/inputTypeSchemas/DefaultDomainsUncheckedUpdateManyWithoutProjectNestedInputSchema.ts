...
export const DefaultDomainsUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.DefaultDomainsUncheckedUpdateManyWithoutProjectNestedInput> =
    z
        .object({
            create: z
                .union([
