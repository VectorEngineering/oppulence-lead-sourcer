...
export const DealProductWhereInputSchema: z.ZodType<Prisma.DealProductWhereInput> = z
    .object({
        AND: z.union([z.lazy(() => DealProductWhereInputSchema), z.lazy(() => DealProductWhereInputSchema).array()]).optional(),
        OR: z
            .lazy(() => DealProductWhereInputSchema)
            .array()
            .optional(),
...
export default DealProductWhereInputSchema
