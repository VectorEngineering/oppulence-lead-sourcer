...
export const DealTaskScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.DealTaskScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => DealTaskScalarWhereWithAggregatesInputSchema),
                z.lazy(() => DealTaskScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => DealTaskScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
        ...
        dueDate: z
            ...
            .nullable(),
        priority: z
            .union([z.lazy(() => EnumDealTaskPriorityNullableWithAggregatesFilterSchema), z.lazy(() => DealTaskPrioritySchema)])
            .optional()
            .nullable(),
