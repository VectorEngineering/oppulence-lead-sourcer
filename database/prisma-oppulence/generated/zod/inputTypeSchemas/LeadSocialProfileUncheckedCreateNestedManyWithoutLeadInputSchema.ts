...
export const LeadSocialProfileUncheckedCreateNestedManyWithoutLeadInputSchema: z.ZodType<Prisma.LeadSocialProfileUncheckedCreateNestedManyWithoutLeadInput> =
    z
        .object({
            create: z
                .union([
