...
export const LeadNurturingScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadNurturingScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadNurturingScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadNurturingScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadNurturingScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
