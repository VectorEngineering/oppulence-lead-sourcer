...
export const LeadUpdateOneRequiredWithoutCompetitorsNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutCompetitorsNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => LeadCreateWithoutCompetitorsInputSchema),
                    z.lazy(() => LeadUncheckedCreateWithoutCompetitorsInputSchema)
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => LeadUpdateToOneWithWhereWithoutCompetitorsInputSchema),
                    z.lazy(() => LeadUpdateWithoutCompetitorsInputSchema),
                    z.lazy(() => LeadUncheckedUpdateWithoutCompetitorsInputSchema)
                ])
                .optional()
        })
        .strict()
