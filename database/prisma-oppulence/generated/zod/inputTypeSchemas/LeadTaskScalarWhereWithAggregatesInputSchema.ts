...
export const LeadTaskScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadTaskScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadTaskScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadTaskScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadTaskScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
