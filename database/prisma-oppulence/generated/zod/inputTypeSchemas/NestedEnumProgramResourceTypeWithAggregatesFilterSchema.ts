...
export const NestedEnumProgramResourceTypeWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumProgramResourceTypeWithAggregatesFilter> =
    z
        .object({
            equals: z.lazy(() => ProgramResourceTypeSchema).optional(),
            in: z
                .lazy(() => ProgramResourceTypeSchema)
                .array()
                .optional(),
            notIn: z
                .lazy(() => ProgramResourceTypeSchema)
                ...
                .optional(),
            not: z
                .union([z.lazy(() => ProgramResourceTypeSchema), z.lazy(() => NestedEnumProgramResourceTypeWithAggregatesFilterSchema)])
                .optional(),
