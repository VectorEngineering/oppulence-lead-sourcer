...
export const ProjectUncheckedUpdateManyInputSchema: z.ZodType<Prisma.ProjectUncheckedUpdateManyInput> = z
    .object({
...
export default ProjectUncheckedUpdateManyInputSchema
