...
export const PipelineKpiUpsertWithWhereUniqueWithoutPipelineInputSchema: z.ZodType<Prisma.PipelineKpiUpsertWithWhereUniqueWithoutPipelineInput> =
    z
        .object({
            where: z.lazy(() => PipelineKpiWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => PipelineKpiUpdateWithoutPipelineInputSchema),
                z.lazy(() => PipelineKpiUncheckedUpdateWithoutPipelineInputSchema)
            ]),
            create: z.union([
