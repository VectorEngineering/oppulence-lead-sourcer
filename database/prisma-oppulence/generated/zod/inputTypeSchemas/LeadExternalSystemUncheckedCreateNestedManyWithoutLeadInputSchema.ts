...
export const LeadExternalSystemUncheckedCreateNestedManyWithoutLeadInputSchema: z.ZodType<Prisma.LeadExternalSystemUncheckedCreateNestedManyWithoutLeadInput> =
    z
        .object({
            create: z
                .union([
