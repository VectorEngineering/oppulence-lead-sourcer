...
export const CampaignUpsertWithWhereUniqueWithoutLeadsInputSchema: z.ZodType<Prisma.CampaignUpsertWithWhereUniqueWithoutLeadsInput> = z
    .object({
        where: z.lazy(() => CampaignWhereUniqueInputSchema),
        update: z.union([
            z.lazy(() => CampaignUpdateWithoutLeadsInputSchema),
            z.lazy(() => CampaignUncheckedUpdateWithoutLeadsInputSchema)
        ]),
