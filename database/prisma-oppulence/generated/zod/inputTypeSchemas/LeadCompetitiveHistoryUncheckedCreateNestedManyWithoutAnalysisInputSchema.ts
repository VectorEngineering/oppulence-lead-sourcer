...
export const LeadCompetitiveHistoryUncheckedCreateNestedManyWithoutAnalysisInputSchema: z.ZodType<Prisma.LeadCompetitiveHistoryUncheckedCreateNestedManyWithoutAnalysisInput> =
    z
        .object({
            create: z
                .union([
