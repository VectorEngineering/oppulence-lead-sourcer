...
export const ProjectInviteUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.ProjectInviteUncheckedUpdateManyWithoutProjectNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => ProjectInviteUpsertWithWhereUniqueWithoutProjectInputSchema),
                    z.lazy(() => ProjectInviteUpsertWithWhereUniqueWithoutProjectInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => ProjectInviteUpdateWithWhereUniqueWithoutProjectInputSchema),
                    z.lazy(() => ProjectInviteUpdateWithWhereUniqueWithoutProjectInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => ProjectInviteUpdateManyWithWhereWithoutProjectInputSchema),
                    z.lazy(() => ProjectInviteUpdateManyWithWhereWithoutProjectInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default ProjectInviteUncheckedUpdateManyWithoutProjectNestedInputSchema
