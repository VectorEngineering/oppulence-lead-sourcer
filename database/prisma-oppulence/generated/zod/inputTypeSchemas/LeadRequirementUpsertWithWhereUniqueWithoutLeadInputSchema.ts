...
export const LeadRequirementUpsertWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadRequirementUpsertWithWhereUniqueWithoutLeadInput> =
    z
        .object({
            where: z.lazy(() => LeadRequirementWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => LeadRequirementUpdateWithoutLeadInputSchema),
                z.lazy(() => LeadRequirementUncheckedUpdateWithoutLeadInputSchema)
            ]),
            create: z.union([
