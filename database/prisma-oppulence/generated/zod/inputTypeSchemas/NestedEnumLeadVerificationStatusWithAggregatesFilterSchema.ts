...
export const NestedEnumLeadVerificationStatusWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumLeadVerificationStatusWithAggregatesFilter> =
    z
        .object({
            ...
            not: z
                .union([
                    ...
                    z.lazy(() => NestedEnumLeadVerificationStatusWithAggregatesFilterSchema)
                ])
                .optional(),
