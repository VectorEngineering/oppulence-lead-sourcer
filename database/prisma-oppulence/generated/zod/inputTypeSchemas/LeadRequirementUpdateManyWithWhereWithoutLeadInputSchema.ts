...
export const LeadRequirementUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadRequirementUpdateManyWithWhereWithoutLeadInput> =
    z
        .object({
            where: z.lazy(() => LeadRequirementScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LeadRequirementUpdateManyMutationInputSchema),
                z.lazy(() => LeadRequirementUncheckedUpdateManyWithoutLeadInputSchema)
            ])
        })
        .strict()
