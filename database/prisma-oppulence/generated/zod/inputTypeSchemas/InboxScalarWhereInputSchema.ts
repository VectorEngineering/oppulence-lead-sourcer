...
export const InboxScalarWhereInputSchema: z.ZodType<Prisma.InboxScalarWhereInput> = z
    .object({
        AND: z.union([z.lazy(() => InboxScalarWhereInputSchema), z.lazy(() => InboxScalarWhereInputSchema).array()]).optional(),
        OR: z
            .lazy(() => InboxScalarWhereInputSchema)
            .array()
            .optional(),
        NOT: z.union([z.lazy(() => InboxScalarWhereInputSchema), z.lazy(() => InboxScalarWhereInputSchema).array()]).optional(),
...
export default InboxScalarWhereInputSchema
