...
export const ContractDocumentUncheckedCreateNestedManyWithoutContractInputSchema: z.ZodType<Prisma.ContractDocumentUncheckedCreateNestedManyWithoutContractInput> =
    z
        .object({
            create: z
                .union([
