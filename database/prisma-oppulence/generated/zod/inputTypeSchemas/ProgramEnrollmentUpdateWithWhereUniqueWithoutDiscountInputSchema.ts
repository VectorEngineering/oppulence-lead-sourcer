...
export const ProgramEnrollmentUpdateWithWhereUniqueWithoutDiscountInputSchema: z.ZodType<Prisma.ProgramEnrollmentUpdateWithWhereUniqueWithoutDiscountInput> =
    z
        .object({
            where: z.lazy(() => ProgramEnrollmentWhereUniqueInputSchema),
            data: z.union([
                z.lazy(() => ProgramEnrollmentUpdateWithoutDiscountInputSchema),
                z.lazy(() => ProgramEnrollmentUncheckedUpdateWithoutDiscountInputSchema)
            ])
        })
        .strict()
