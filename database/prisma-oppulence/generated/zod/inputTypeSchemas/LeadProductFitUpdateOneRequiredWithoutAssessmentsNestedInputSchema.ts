...
export const LeadProductFitUpdateOneRequiredWithoutAssessmentsNestedInputSchema: z.ZodType<Prisma.LeadProductFitUpdateOneRequiredWithoutAssessmentsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadProductFitUpdateToOneWithWhereWithoutAssessmentsInputSchema),
