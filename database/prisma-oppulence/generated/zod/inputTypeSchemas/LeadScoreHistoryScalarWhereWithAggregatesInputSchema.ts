...
export const LeadScoreHistoryScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadScoreHistoryScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadScoreHistoryScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadScoreHistoryScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadScoreHistoryScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
