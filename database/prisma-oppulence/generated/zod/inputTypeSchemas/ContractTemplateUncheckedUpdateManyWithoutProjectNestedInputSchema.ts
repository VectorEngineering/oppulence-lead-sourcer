...
export const ContractTemplateUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.ContractTemplateUncheckedUpdateManyWithoutProjectNestedInput> =
    z
        .object({
            create: z
                .union([
