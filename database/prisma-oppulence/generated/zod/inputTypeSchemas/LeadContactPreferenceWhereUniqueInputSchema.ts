...
export const LeadContactPreferenceWhereUniqueInputSchema: z.ZodType<Prisma.LeadContactPreferenceWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([
                        z.lazy(() => LeadContactPreferenceWhereInputSchema),
                        z.lazy(() => LeadContactPreferenceWhereInputSchema).array()
                    ])
                    .optional(),
                OR: z
                    .lazy(() => LeadContactPreferenceWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([
