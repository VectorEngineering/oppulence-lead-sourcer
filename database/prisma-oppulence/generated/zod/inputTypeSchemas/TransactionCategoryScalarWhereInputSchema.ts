...
export const TransactionCategoryScalarWhereInputSchema: z.ZodType<Prisma.TransactionCategoryScalarWhereInput> = z
    .object({
        AND: z
            .union([
            ...
            .optional(),
        OR: z
            .lazy(() => TransactionCategoryScalarWhereInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
