...
export const DealHistoryUncheckedUpdateManyWithoutDealNestedInputSchema: z.ZodType<Prisma.DealHistoryUncheckedUpdateManyWithoutDealNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => DealHistoryUpsertWithWhereUniqueWithoutDealInputSchema),
                    z.lazy(() => DealHistoryUpsertWithWhereUniqueWithoutDealInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => DealHistoryUpdateWithWhereUniqueWithoutDealInputSchema),
                    z.lazy(() => DealHistoryUpdateWithWhereUniqueWithoutDealInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => DealHistoryUpdateManyWithWhereWithoutDealInputSchema),
                    z.lazy(() => DealHistoryUpdateManyWithWhereWithoutDealInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([z.lazy(() => DealHistoryScalarWhereInputSchema), z.lazy(() => DealHistoryScalarWhereInputSchema).array()])
                .optional()
        })
        .strict()

export default DealHistoryUncheckedUpdateManyWithoutDealNestedInputSchema
