...
export const DefaultDomainsUncheckedCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.DefaultDomainsUncheckedCreateNestedManyWithoutProjectInput> =
    z
        .object({
            create: z
                .union([
