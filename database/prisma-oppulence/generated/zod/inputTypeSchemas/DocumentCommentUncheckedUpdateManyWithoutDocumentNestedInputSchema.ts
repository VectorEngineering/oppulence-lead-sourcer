...
export const DocumentCommentUncheckedUpdateManyWithoutDocumentNestedInputSchema: z.ZodType<Prisma.DocumentCommentUncheckedUpdateManyWithoutDocumentNestedInput> =
    z
        .object({
            create: z
                .union([
