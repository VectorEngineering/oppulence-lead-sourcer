...
export const ReportUpsertWithoutColumnsInputSchema: z.ZodType<Prisma.ReportUpsertWithoutColumnsInput> = z
    .object({
        update: z.union([
        ...
        create: z.union([
            z.lazy(() => ReportCreateWithoutColumnsInputSchema),
            z.lazy(() => ReportUncheckedCreateWithoutColumnsInputSchema)
        ]),
