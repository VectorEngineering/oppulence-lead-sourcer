...
export const LeadCommunicationUpsertWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadCommunicationUpsertWithWhereUniqueWithoutLeadInput> =
    z
        .object({
            where: z.lazy(() => LeadCommunicationWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => LeadCommunicationUpdateWithoutLeadInputSchema),
                z.lazy(() => LeadCommunicationUncheckedUpdateWithoutLeadInputSchema)
            ]),
            create: z.union([
