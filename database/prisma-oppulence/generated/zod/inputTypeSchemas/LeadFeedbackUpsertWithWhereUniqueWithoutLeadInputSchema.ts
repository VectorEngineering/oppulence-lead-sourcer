...
export const LeadFeedbackUpsertWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadFeedbackUpsertWithWhereUniqueWithoutLeadInput> =
    z
        .object({
            where: z.lazy(() => LeadFeedbackWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => LeadFeedbackUpdateWithoutLeadInputSchema),
                z.lazy(() => LeadFeedbackUncheckedUpdateWithoutLeadInputSchema)
            ]),
            create: z.union([
