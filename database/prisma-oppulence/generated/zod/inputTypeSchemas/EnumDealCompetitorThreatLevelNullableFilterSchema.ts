...
export const EnumDealCompetitorThreatLevelNullableFilterSchema: z.ZodType<Prisma.EnumDealCompetitorThreatLevelNullableFilter> = z
    .object({
        equals: z
        ...
        notIn: z
            ...
            .nullable(),
        not: z
            .union([z.lazy(() => DealCompetitorThreatLevelSchema), z.lazy(() => NestedEnumDealCompetitorThreatLevelNullableFilterSchema)])
            .optional()
            .nullable()
    })
    .strict()
