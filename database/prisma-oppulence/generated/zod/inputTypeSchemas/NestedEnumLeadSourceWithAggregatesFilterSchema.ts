...
export const NestedEnumLeadSourceWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumLeadSourceWithAggregatesFilter> = z
    .object({
        equals: z.lazy(() => LeadSourceSchema).optional(),
        in: z
            .lazy(() => LeadSourceSchema)
            .array()
            .optional(),
        notIn: z
            .lazy(() => LeadSourceSchema)
...
export default NestedEnumLeadSourceWithAggregatesFilterSchema
