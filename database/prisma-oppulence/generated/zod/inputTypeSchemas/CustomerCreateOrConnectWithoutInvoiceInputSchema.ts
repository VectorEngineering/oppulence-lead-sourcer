...
export const CustomerCreateOrConnectWithoutInvoiceInputSchema: z.ZodType<Prisma.CustomerCreateOrConnectWithoutInvoiceInput> = z
    .object({
        where: z.lazy(() => CustomerWhereUniqueInputSchema),
        create: z.union([
            z.lazy(() => CustomerCreateWithoutInvoiceInputSchema),
            z.lazy(() => CustomerUncheckedCreateWithoutInvoiceInputSchema)
        ])
    })
    .strict()
