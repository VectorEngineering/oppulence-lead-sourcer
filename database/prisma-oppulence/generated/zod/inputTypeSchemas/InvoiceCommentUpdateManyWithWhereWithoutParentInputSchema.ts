...
export const InvoiceCommentUpdateManyWithWhereWithoutParentInputSchema: z.ZodType<Prisma.InvoiceCommentUpdateManyWithWhereWithoutParentInput> =
    z
        .object({
            where: z.lazy(() => InvoiceCommentScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => InvoiceCommentUpdateManyMutationInputSchema),
                z.lazy(() => InvoiceCommentUncheckedUpdateManyWithoutParentInputSchema)
            ])
        })
        .strict()
