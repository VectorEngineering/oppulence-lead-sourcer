...
export const LeadCompetitiveAnalysisWhereInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisWhereInput> = z
    .object({
        AND: z
            .union([z.lazy(() => LeadCompetitiveAnalysisWhereInputSchema), z.lazy(() => LeadCompetitiveAnalysisWhereInputSchema).array()])
            .optional(),
        OR: z
