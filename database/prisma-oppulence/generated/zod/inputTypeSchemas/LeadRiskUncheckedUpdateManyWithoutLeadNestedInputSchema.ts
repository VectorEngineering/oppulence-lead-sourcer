...
export const LeadRiskUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadRiskUncheckedUpdateManyWithoutLeadNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => LeadRiskUpsertWithWhereUniqueWithoutLeadInputSchema),
                    z.lazy(() => LeadRiskUpsertWithWhereUniqueWithoutLeadInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => LeadRiskUpdateWithWhereUniqueWithoutLeadInputSchema),
                    z.lazy(() => LeadRiskUpdateWithWhereUniqueWithoutLeadInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => LeadRiskUpdateManyWithWhereWithoutLeadInputSchema),
                    z.lazy(() => LeadRiskUpdateManyWithWhereWithoutLeadInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([z.lazy(() => LeadRiskScalarWhereInputSchema), z.lazy(() => LeadRiskScalarWhereInputSchema).array()])
                .optional()
        })
        .strict()

export default LeadRiskUncheckedUpdateManyWithoutLeadNestedInputSchema
