...
export const PipelineIntegrationUncheckedUpdateManyWithoutPipelineNestedInputSchema: z.ZodType<Prisma.PipelineIntegrationUncheckedUpdateManyWithoutPipelineNestedInput> =
    z
        .object({
            create: z
                .union([
