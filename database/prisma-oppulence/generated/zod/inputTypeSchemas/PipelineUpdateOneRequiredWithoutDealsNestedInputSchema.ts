...
export const PipelineUpdateOneRequiredWithoutDealsNestedInputSchema: z.ZodType<Prisma.PipelineUpdateOneRequiredWithoutDealsNestedInput> = z
    .object({
        create: z
        ...
        update: z
            .union([
                z.lazy(() => PipelineUpdateToOneWithWhereWithoutDealsInputSchema),
