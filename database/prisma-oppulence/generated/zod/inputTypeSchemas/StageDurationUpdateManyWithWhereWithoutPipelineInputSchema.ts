...
export const StageDurationUpdateManyWithWhereWithoutPipelineInputSchema: z.ZodType<Prisma.StageDurationUpdateManyWithWhereWithoutPipelineInput> =
    z
        .object({
            where: z.lazy(() => StageDurationScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => StageDurationUpdateManyMutationInputSchema),
                z.lazy(() => StageDurationUncheckedUpdateManyWithoutPipelineInputSchema)
            ])
        })
        .strict()
