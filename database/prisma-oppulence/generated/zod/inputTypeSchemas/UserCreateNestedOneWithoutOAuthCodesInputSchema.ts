...
export const UserCreateNestedOneWithoutOAuthCodesInputSchema: z.ZodType<Prisma.UserCreateNestedOneWithoutOAuthCodesInput> = z
    .object({
        create: z
            .union([z.lazy(() => UserCreateWithoutOAuthCodesInputSchema), z.lazy(() => UserUncheckedCreateWithoutOAuthCodesInputSchema)])
            .optional(),
