...
export const LeadFeedbackUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadFeedbackUpdateManyWithWhereWithoutLeadInput> = z
    .object({
        where: z.lazy(() => LeadFeedbackScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => LeadFeedbackUpdateManyMutationInputSchema),
            z.lazy(() => LeadFeedbackUncheckedUpdateManyWithoutLeadInputSchema)
        ])
    })
    .strict()
