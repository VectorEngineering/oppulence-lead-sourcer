...
export const CampaignAvgOrderByAggregateInputSchema: z.ZodType<Prisma.CampaignAvgOrderByAggregateInput> = z
    .object({
...
export default CampaignAvgOrderByAggregateInputSchema
