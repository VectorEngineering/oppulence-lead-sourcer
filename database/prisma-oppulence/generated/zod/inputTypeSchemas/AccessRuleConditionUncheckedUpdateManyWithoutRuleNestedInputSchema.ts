...
export const AccessRuleConditionUncheckedUpdateManyWithoutRuleNestedInputSchema: z.ZodType<Prisma.AccessRuleConditionUncheckedUpdateManyWithoutRuleNestedInput> =
    z
        .object({
            create: z
                .union([
