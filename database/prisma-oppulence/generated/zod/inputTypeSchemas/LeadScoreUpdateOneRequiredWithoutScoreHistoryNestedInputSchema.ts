...
export const LeadScoreUpdateOneRequiredWithoutScoreHistoryNestedInputSchema: z.ZodType<Prisma.LeadScoreUpdateOneRequiredWithoutScoreHistoryNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadScoreUpdateToOneWithWhereWithoutScoreHistoryInputSchema),
