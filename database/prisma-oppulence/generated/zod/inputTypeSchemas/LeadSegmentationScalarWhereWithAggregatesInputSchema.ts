...
export const LeadSegmentationScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadSegmentationScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadSegmentationScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadSegmentationScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadSegmentationScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
