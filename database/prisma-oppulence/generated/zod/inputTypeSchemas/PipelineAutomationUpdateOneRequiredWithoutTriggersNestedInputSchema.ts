...
export const PipelineAutomationUpdateOneRequiredWithoutTriggersNestedInputSchema: z.ZodType<Prisma.PipelineAutomationUpdateOneRequiredWithoutTriggersNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => PipelineAutomationUpdateToOneWithWhereWithoutTriggersInputSchema),
