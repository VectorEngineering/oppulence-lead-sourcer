...
export const PartnerUpdateOneRequiredWithoutPayoutsNestedInputSchema: z.ZodType<Prisma.PartnerUpdateOneRequiredWithoutPayoutsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => PartnerUpdateToOneWithWhereWithoutPayoutsInputSchema),
