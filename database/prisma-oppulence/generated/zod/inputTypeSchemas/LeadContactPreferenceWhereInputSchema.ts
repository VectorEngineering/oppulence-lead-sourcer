...
export const LeadContactPreferenceWhereInputSchema: z.ZodType<Prisma.LeadContactPreferenceWhereInput> = z
    .object({
        AND: z
            .union([z.lazy(() => LeadContactPreferenceWhereInputSchema), z.lazy(() => LeadContactPreferenceWhereInputSchema).array()])
            .optional(),
        OR: z
