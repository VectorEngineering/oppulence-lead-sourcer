...
export const LeadBudgetRevisionScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadBudgetRevisionScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadBudgetRevisionScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadBudgetRevisionScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadBudgetRevisionScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
