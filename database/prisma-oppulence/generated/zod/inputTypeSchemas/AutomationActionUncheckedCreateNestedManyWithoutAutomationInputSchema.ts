...
export const AutomationActionUncheckedCreateNestedManyWithoutAutomationInputSchema: z.ZodType<Prisma.AutomationActionUncheckedCreateNestedManyWithoutAutomationInput> =
    z
        .object({
            create: z
                .union([
...
export default AutomationActionUncheckedCreateNestedManyWithoutAutomationInputSchema
