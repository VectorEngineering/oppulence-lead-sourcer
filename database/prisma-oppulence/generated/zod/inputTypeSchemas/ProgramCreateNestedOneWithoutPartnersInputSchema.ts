...
export const ProgramCreateNestedOneWithoutPartnersInputSchema: z.ZodType<Prisma.ProgramCreateNestedOneWithoutPartnersInput> = z
    .object({
        create: z
            .union([z.lazy(() => ProgramCreateWithoutPartnersInputSchema), z.lazy(() => ProgramUncheckedCreateWithoutPartnersInputSchema)])
            .optional(),
