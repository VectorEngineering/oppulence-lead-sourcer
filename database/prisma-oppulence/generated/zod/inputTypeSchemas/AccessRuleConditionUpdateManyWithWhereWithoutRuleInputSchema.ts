...
export const AccessRuleConditionUpdateManyWithWhereWithoutRuleInputSchema: z.ZodType<Prisma.AccessRuleConditionUpdateManyWithWhereWithoutRuleInput> =
    z
        .object({
            where: z.lazy(() => AccessRuleConditionScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => AccessRuleConditionUpdateManyMutationInputSchema),
                z.lazy(() => AccessRuleConditionUncheckedUpdateManyWithoutRuleInputSchema)
            ])
        })
        .strict()
