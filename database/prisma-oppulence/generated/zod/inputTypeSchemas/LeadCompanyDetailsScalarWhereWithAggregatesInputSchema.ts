...
export const LeadCompanyDetailsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadCompanyDetailsScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadCompanyDetailsScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadCompanyDetailsScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadCompanyDetailsScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
