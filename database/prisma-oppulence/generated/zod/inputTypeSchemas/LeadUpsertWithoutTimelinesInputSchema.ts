...
export const LeadUpsertWithoutTimelinesInputSchema: z.ZodType<Prisma.LeadUpsertWithoutTimelinesInput> = z
    .object({
        update: z.union([
        ...
        create: z.union([
            z.lazy(() => LeadCreateWithoutTimelinesInputSchema),
            z.lazy(() => LeadUncheckedCreateWithoutTimelinesInputSchema)
        ]),
