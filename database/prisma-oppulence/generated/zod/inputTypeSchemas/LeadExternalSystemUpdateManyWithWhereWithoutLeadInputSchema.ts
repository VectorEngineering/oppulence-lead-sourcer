...
export const LeadExternalSystemUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadExternalSystemUpdateManyWithWhereWithoutLeadInput> =
    z
        .object({
            where: z.lazy(() => LeadExternalSystemScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LeadExternalSystemUpdateManyMutationInputSchema),
                z.lazy(() => LeadExternalSystemUncheckedUpdateManyWithoutLeadInputSchema)
            ])
        })
        .strict()
