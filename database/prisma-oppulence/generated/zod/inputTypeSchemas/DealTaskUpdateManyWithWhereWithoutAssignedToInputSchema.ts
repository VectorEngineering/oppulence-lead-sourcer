...
export const DealTaskUpdateManyWithWhereWithoutAssignedToInputSchema: z.ZodType<Prisma.DealTaskUpdateManyWithWhereWithoutAssignedToInput> =
    z
        .object({
            where: z.lazy(() => DealTaskScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => DealTaskUpdateManyMutationInputSchema),
                z.lazy(() => DealTaskUncheckedUpdateManyWithoutAssignedToInputSchema)
            ])
        })
        .strict()
