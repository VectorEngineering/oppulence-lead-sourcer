...
export const CustomerTagUpsertWithWhereUniqueWithoutTagInputSchema: z.ZodType<Prisma.CustomerTagUpsertWithWhereUniqueWithoutTagInput> = z
    .object({
        where: z.lazy(() => CustomerTagWhereUniqueInputSchema),
        update: z.union([
            z.lazy(() => CustomerTagUpdateWithoutTagInputSchema),
            z.lazy(() => CustomerTagUncheckedUpdateWithoutTagInputSchema)
        ]),
        create: z.union([
