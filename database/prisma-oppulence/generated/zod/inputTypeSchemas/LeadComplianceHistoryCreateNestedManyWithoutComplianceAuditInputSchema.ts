...
export const LeadComplianceHistoryCreateNestedManyWithoutComplianceAuditInputSchema: z.ZodType<Prisma.LeadComplianceHistoryCreateNestedManyWithoutComplianceAuditInput> =
    z
        .object({
            create: z
                .union([
