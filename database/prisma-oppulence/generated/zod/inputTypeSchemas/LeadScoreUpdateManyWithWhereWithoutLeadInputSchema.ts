...
export const LeadScoreUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadScoreUpdateManyWithWhereWithoutLeadInput> = z
    .object({
        where: z.lazy(() => LeadScoreScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => LeadScoreUpdateManyMutationInputSchema),
            z.lazy(() => LeadScoreUncheckedUpdateManyWithoutLeadInputSchema)
        ])
    })
    .strict()
