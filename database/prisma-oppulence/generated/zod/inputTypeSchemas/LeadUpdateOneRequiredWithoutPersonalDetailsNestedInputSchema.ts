...
export const LeadUpdateOneRequiredWithoutPersonalDetailsNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutPersonalDetailsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadUpdateToOneWithWhereWithoutPersonalDetailsInputSchema),
                    z.lazy(() => LeadUpdateWithoutPersonalDetailsInputSchema),
                    z.lazy(() => LeadUncheckedUpdateWithoutPersonalDetailsInputSchema)
                ])
                .optional()
        })
        .strict()
