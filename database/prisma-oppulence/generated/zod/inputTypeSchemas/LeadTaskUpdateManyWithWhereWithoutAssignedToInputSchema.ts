...
export const LeadTaskUpdateManyWithWhereWithoutAssignedToInputSchema: z.ZodType<Prisma.LeadTaskUpdateManyWithWhereWithoutAssignedToInput> =
    z
        .object({
            where: z.lazy(() => LeadTaskScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LeadTaskUpdateManyMutationInputSchema),
                z.lazy(() => LeadTaskUncheckedUpdateManyWithoutAssignedToInputSchema)
            ])
        })
        .strict()
