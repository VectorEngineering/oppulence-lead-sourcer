...
export const DealUncheckedCreateWithoutProjectInputSchema: z.ZodType<Prisma.DealUncheckedCreateWithoutProjectInput> = z
    .object({
...
export default DealUncheckedCreateWithoutProjectInputSchema
