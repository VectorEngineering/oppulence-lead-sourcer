...
export const ContractEventUpdateManyWithWhereWithoutContractInputSchema: z.ZodType<Prisma.ContractEventUpdateManyWithWhereWithoutContractInput> =
    z
        .object({
            where: z.lazy(() => ContractEventScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => ContractEventUpdateManyMutationInputSchema),
                z.lazy(() => ContractEventUncheckedUpdateManyWithoutContractInputSchema)
            ])
        })
        .strict()
