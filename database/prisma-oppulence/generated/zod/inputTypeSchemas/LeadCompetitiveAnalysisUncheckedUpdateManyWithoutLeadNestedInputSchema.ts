...
export const LeadCompetitiveAnalysisUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisUncheckedUpdateManyWithoutLeadNestedInput> =
    z
        .object({
            create: z
                .union([
