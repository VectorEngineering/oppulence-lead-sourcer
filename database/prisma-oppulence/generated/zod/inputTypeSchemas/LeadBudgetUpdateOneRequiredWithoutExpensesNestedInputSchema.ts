...
export const LeadBudgetUpdateOneRequiredWithoutExpensesNestedInputSchema: z.ZodType<Prisma.LeadBudgetUpdateOneRequiredWithoutExpensesNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadBudgetUpdateToOneWithWhereWithoutExpensesInputSchema),
                    z.lazy(() => LeadBudgetUpdateWithoutExpensesInputSchema),
                    z.lazy(() => LeadBudgetUncheckedUpdateWithoutExpensesInputSchema)
                ])
                .optional()
        })
        .strict()
