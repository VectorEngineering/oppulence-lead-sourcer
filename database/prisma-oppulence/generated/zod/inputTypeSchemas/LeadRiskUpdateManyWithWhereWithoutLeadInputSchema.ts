...
export const LeadRiskUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadRiskUpdateManyWithWhereWithoutLeadInput> = z
    .object({
        where: z.lazy(() => LeadRiskScalarWhereInputSchema),
        data: z.union([
            z.lazy(() => LeadRiskUpdateManyMutationInputSchema),
            z.lazy(() => LeadRiskUncheckedUpdateManyWithoutLeadInputSchema)
        ])
    })
    .strict()
