...
export const DocumentAnnotationUpdateManyWithoutDocumentNestedInputSchema: z.ZodType<Prisma.DocumentAnnotationUpdateManyWithoutDocumentNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => DocumentAnnotationCreateWithoutDocumentInputSchema),
                    z.lazy(() => DocumentAnnotationCreateWithoutDocumentInputSchema).array(),
                    z.lazy(() => DocumentAnnotationUncheckedCreateWithoutDocumentInputSchema),
                    z.lazy(() => DocumentAnnotationUncheckedCreateWithoutDocumentInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => DocumentAnnotationCreateOrConnectWithoutDocumentInputSchema),
                    z.lazy(() => DocumentAnnotationCreateOrConnectWithoutDocumentInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => DocumentAnnotationUpsertWithWhereUniqueWithoutDocumentInputSchema),
                    z.lazy(() => DocumentAnnotationUpsertWithWhereUniqueWithoutDocumentInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => DocumentAnnotationCreateManyDocumentInputEnvelopeSchema).optional(),
            set: z
                .union([
                    z.lazy(() => DocumentAnnotationWhereUniqueInputSchema),
                    z.lazy(() => DocumentAnnotationWhereUniqueInputSchema).array()
                ])
                .optional(),
            disconnect: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => DocumentAnnotationUpdateWithWhereUniqueWithoutDocumentInputSchema),
                    z.lazy(() => DocumentAnnotationUpdateWithWhereUniqueWithoutDocumentInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => DocumentAnnotationUpdateManyWithWhereWithoutDocumentInputSchema),
                    z.lazy(() => DocumentAnnotationUpdateManyWithWhereWithoutDocumentInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
                    z.lazy(() => DocumentAnnotationScalarWhereInputSchema),
                    z.lazy(() => DocumentAnnotationScalarWhereInputSchema).array()
                ])
                .optional()
        })
        .strict()

export default DocumentAnnotationUpdateManyWithoutDocumentNestedInputSchema
