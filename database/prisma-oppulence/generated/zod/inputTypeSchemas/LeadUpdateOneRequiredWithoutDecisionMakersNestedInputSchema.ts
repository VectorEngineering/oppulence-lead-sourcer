...
export const LeadUpdateOneRequiredWithoutDecisionMakersNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutDecisionMakersNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadUpdateToOneWithWhereWithoutDecisionMakersInputSchema),
