...
export const ProgramCreateNestedOneWithoutInvoicesInputSchema: z.ZodType<Prisma.ProgramCreateNestedOneWithoutInvoicesInput> = z
    .object({
        create: z
            .union([z.lazy(() => ProgramCreateWithoutInvoicesInputSchema), z.lazy(() => ProgramUncheckedCreateWithoutInvoicesInputSchema)])
            .optional(),
