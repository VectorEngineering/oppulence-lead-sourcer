...
export const ProjectInviteUncheckedCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.ProjectInviteUncheckedCreateNestedManyWithoutProjectInput> =
    z
        .object({
            create: z
                .union([
