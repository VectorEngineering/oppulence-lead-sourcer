...
export const EnumPipelineKpiCalculationWithAggregatesFilterSchema: z.ZodType<Prisma.EnumPipelineKpiCalculationWithAggregatesFilter> = z
    .object({
        ...
        notIn: z
            ...
            .optional(),
        not: z
            .union([z.lazy(() => PipelineKpiCalculationSchema), z.lazy(() => NestedEnumPipelineKpiCalculationWithAggregatesFilterSchema)])
            .optional(),
