...
export const LeadUpdateOneRequiredWithoutCommunicationsNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutCommunicationsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadUpdateToOneWithWhereWithoutCommunicationsInputSchema),
                    z.lazy(() => LeadUpdateWithoutCommunicationsInputSchema),
                    z.lazy(() => LeadUncheckedUpdateWithoutCommunicationsInputSchema)
                ])
                .optional()
        })
        .strict()
