...
export const LeadTouchpointUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadTouchpointUpdateManyWithWhereWithoutLeadInput> =
    z
        .object({
            where: z.lazy(() => LeadTouchpointScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LeadTouchpointUpdateManyMutationInputSchema),
                z.lazy(() => LeadTouchpointUncheckedUpdateManyWithoutLeadInputSchema)
            ])
        })
        .strict()
