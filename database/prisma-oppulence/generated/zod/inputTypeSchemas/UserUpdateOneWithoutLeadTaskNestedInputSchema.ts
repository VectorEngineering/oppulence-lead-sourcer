...
export const UserUpdateOneWithoutLeadTaskNestedInputSchema: z.ZodType<Prisma.UserUpdateOneWithoutLeadTaskNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => UserCreateWithoutLeadTaskInputSchema), z.lazy(() => UserUncheckedCreateWithoutLeadTaskInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => UserUpdateToOneWithWhereWithoutLeadTaskInputSchema),
                z.lazy(() => UserUpdateWithoutLeadTaskInputSchema),
                z.lazy(() => UserUncheckedUpdateWithoutLeadTaskInputSchema)
            ])
            .optional()
    })
    .strict()
