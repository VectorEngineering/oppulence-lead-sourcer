...
export const LeadPersonalDetailsUncheckedCreateNestedOneWithoutLeadInputSchema: z.ZodType<Prisma.LeadPersonalDetailsUncheckedCreateNestedOneWithoutLeadInput> =
    z
        .object({
            create: z
                .union([
