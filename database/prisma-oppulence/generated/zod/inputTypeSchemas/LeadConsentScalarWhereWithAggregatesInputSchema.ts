...
export const LeadConsentScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadConsentScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadConsentScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadConsentScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadConsentScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
