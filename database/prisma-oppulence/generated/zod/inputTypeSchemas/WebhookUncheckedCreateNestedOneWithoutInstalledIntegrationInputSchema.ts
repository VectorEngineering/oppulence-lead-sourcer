...
export const WebhookUncheckedCreateNestedOneWithoutInstalledIntegrationInputSchema: z.ZodType<Prisma.WebhookUncheckedCreateNestedOneWithoutInstalledIntegrationInput> =
    z
        .object({
            create: z
                .union([
