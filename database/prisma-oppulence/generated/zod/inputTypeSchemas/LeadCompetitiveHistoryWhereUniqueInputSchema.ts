...
export const LeadCompetitiveHistoryWhereUniqueInputSchema: z.ZodType<Prisma.LeadCompetitiveHistoryWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([
                        z.lazy(() => LeadCompetitiveHistoryWhereInputSchema),
                        z.lazy(() => LeadCompetitiveHistoryWhereInputSchema).array()
                    ])
                    .optional(),
                OR: z
                ...
                analysis: z
                    .union([
                        z.lazy(() => LeadCompetitiveAnalysisRelationFilterSchema),
                        z.lazy(() => LeadCompetitiveAnalysisWhereInputSchema)
                    ])
                    .optional()
            })
            .strict()
