...
export const LeadProductFitUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadProductFitUncheckedUpdateManyWithoutLeadNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => LeadProductFitCreateWithoutLeadInputSchema),
                    z.lazy(() => LeadProductFitCreateWithoutLeadInputSchema).array(),
                    z.lazy(() => LeadProductFitUncheckedCreateWithoutLeadInputSchema),
                    z.lazy(() => LeadProductFitUncheckedCreateWithoutLeadInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => LeadProductFitCreateOrConnectWithoutLeadInputSchema),
                    z.lazy(() => LeadProductFitCreateOrConnectWithoutLeadInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => LeadProductFitUpsertWithWhereUniqueWithoutLeadInputSchema),
                    z.lazy(() => LeadProductFitUpsertWithWhereUniqueWithoutLeadInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => LeadProductFitCreateManyLeadInputEnvelopeSchema).optional(),
            set: z
                .union([z.lazy(() => LeadProductFitWhereUniqueInputSchema), z.lazy(() => LeadProductFitWhereUniqueInputSchema).array()])
                .optional(),
            disconnect: z
                .union([z.lazy(() => LeadProductFitWhereUniqueInputSchema), z.lazy(() => LeadProductFitWhereUniqueInputSchema).array()])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => LeadProductFitUpdateWithWhereUniqueWithoutLeadInputSchema),
                    z.lazy(() => LeadProductFitUpdateWithWhereUniqueWithoutLeadInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => LeadProductFitUpdateManyWithWhereWithoutLeadInputSchema),
                    z.lazy(() => LeadProductFitUpdateManyWithWhereWithoutLeadInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default LeadProductFitUncheckedUpdateManyWithoutLeadNestedInputSchema
