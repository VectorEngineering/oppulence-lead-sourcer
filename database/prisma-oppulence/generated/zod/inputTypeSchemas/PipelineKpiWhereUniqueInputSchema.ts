...
export const PipelineKpiWhereUniqueInputSchema: z.ZodType<Prisma.PipelineKpiWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                OR: z
                    .lazy(() => PipelineKpiWhereInputSchema)
                    .array()
                    .optional(),
                ...
                description: z
                    ...
                    .nullable(),
                frequency: z
                    .union([z.lazy(() => EnumPipelineKpiFrequencyFilterSchema), z.lazy(() => PipelineKpiFrequencySchema)])
                    .optional(),
                calculation: z
                    .union([z.lazy(() => EnumPipelineKpiCalculationFilterSchema), z.lazy(() => PipelineKpiCalculationSchema)])
                    .optional(),
                formula: z
                    .union([z.lazy(() => StringNullableFilterSchema), z.string()])
                    .optional()
