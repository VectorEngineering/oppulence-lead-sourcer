...
export const AutomationConditionUncheckedUpdateManyWithoutAutomationNestedInputSchema: z.ZodType<Prisma.AutomationConditionUncheckedUpdateManyWithoutAutomationNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => AutomationConditionCreateWithoutAutomationInputSchema),
                    z.lazy(() => AutomationConditionCreateWithoutAutomationInputSchema).array(),
                    z.lazy(() => AutomationConditionUncheckedCreateWithoutAutomationInputSchema),
                    z.lazy(() => AutomationConditionUncheckedCreateWithoutAutomationInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => AutomationConditionCreateOrConnectWithoutAutomationInputSchema),
                    z.lazy(() => AutomationConditionCreateOrConnectWithoutAutomationInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => AutomationConditionUpsertWithWhereUniqueWithoutAutomationInputSchema),
                    z.lazy(() => AutomationConditionUpsertWithWhereUniqueWithoutAutomationInputSchema).array()
                ])
                .optional(),
            createMany: z.lazy(() => AutomationConditionCreateManyAutomationInputEnvelopeSchema).optional(),
            set: z
                .union([
                    z.lazy(() => AutomationConditionWhereUniqueInputSchema),
                    z.lazy(() => AutomationConditionWhereUniqueInputSchema).array()
                ])
                .optional(),
            disconnect: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => AutomationConditionUpdateWithWhereUniqueWithoutAutomationInputSchema),
                    z.lazy(() => AutomationConditionUpdateWithWhereUniqueWithoutAutomationInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => AutomationConditionUpdateManyWithWhereWithoutAutomationInputSchema),
                    z.lazy(() => AutomationConditionUpdateManyWithWhereWithoutAutomationInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
...
export default AutomationConditionUncheckedUpdateManyWithoutAutomationNestedInputSchema
