...
export const DealCompetitorUpdateManyWithWhereWithoutDealInputSchema: z.ZodType<Prisma.DealCompetitorUpdateManyWithWhereWithoutDealInput> =
    z
        .object({
            where: z.lazy(() => DealCompetitorScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => DealCompetitorUpdateManyMutationInputSchema),
                z.lazy(() => DealCompetitorUncheckedUpdateManyWithoutDealInputSchema)
            ])
        })
        .strict()
