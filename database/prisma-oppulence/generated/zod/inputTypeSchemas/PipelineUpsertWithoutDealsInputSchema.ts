...
export const PipelineUpsertWithoutDealsInputSchema: z.ZodType<Prisma.PipelineUpsertWithoutDealsInput> = z
    .object({
        update: z.union([
            z.lazy(() => PipelineUpdateWithoutDealsInputSchema),
            z.lazy(() => PipelineUncheckedUpdateWithoutDealsInputSchema)
        ]),
        create: z.union([
            z.lazy(() => PipelineCreateWithoutDealsInputSchema),
            z.lazy(() => PipelineUncheckedCreateWithoutDealsInputSchema)
        ]),
