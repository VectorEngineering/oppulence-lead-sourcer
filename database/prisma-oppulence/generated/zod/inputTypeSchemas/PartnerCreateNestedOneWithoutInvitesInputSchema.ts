...
export const PartnerCreateNestedOneWithoutInvitesInputSchema: z.ZodType<Prisma.PartnerCreateNestedOneWithoutInvitesInput> = z
    .object({
        create: z
            .union([z.lazy(() => PartnerCreateWithoutInvitesInputSchema), z.lazy(() => PartnerUncheckedCreateWithoutInvitesInputSchema)])
            .optional(),
