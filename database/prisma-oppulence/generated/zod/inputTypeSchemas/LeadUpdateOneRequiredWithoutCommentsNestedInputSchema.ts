...
export const LeadUpdateOneRequiredWithoutCommentsNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutCommentsNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => LeadCreateWithoutCommentsInputSchema), z.lazy(() => LeadUncheckedCreateWithoutCommentsInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LeadUpdateToOneWithWhereWithoutCommentsInputSchema),
                z.lazy(() => LeadUpdateWithoutCommentsInputSchema),
                z.lazy(() => LeadUncheckedUpdateWithoutCommentsInputSchema)
            ])
            .optional()
    })
    .strict()
