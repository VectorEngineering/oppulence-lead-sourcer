...
export const LeadSegmentationWhereUniqueInputSchema: z.ZodType<Prisma.LeadSegmentationWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
            leadId: z.string()
    ...
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => LeadSegmentationWhereInputSchema), z.lazy(() => LeadSegmentationWhereInputSchema).array()])
                    .optional(),
                OR: z
