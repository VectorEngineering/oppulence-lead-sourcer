...
export const LeadProductFitWhereUniqueInputSchema: z.ZodType<Prisma.LeadProductFitWhereUniqueInput> = z
    .union([
        z.object({
            id: z.string().cuid(),
            leadId: z.string()
    ...
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => LeadProductFitWhereInputSchema), z.lazy(() => LeadProductFitWhereInputSchema).array()])
                    .optional(),
                OR: z
                    .lazy(() => LeadProductFitWhereInputSchema)
                    .array()
                    .optional(),
                NOT: z
                    .union([z.lazy(() => LeadProductFitWhereInputSchema), z.lazy(() => LeadProductFitWhereInputSchema).array()])
