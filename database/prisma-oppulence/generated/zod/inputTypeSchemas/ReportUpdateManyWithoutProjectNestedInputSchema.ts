...
export const ReportUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.ReportUpdateManyWithoutProjectNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                ...
                z.lazy(() => ReportUpsertWithWhereUniqueWithoutProjectInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                ...
                z.lazy(() => ReportUpdateWithWhereUniqueWithoutProjectInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => ReportUpdateManyWithWhereWithoutProjectInputSchema),
                z.lazy(() => ReportUpdateManyWithWhereWithoutProjectInputSchema).array()
            ])
            .optional(),
