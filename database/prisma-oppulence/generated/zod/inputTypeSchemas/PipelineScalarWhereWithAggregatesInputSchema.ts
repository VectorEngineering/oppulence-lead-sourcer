...
export const PipelineScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.PipelineScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => PipelineScalarWhereWithAggregatesInputSchema),
                z.lazy(() => PipelineScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => PipelineScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
