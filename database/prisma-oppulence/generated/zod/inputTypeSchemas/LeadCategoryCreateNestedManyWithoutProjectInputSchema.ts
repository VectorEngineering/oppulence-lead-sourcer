...
export const LeadCategoryCreateNestedManyWithoutProjectInputSchema: z.ZodType<Prisma.LeadCategoryCreateNestedManyWithoutProjectInput> = z
    .object({
        create: z
            .union([
...
export default LeadCategoryCreateNestedManyWithoutProjectInputSchema
