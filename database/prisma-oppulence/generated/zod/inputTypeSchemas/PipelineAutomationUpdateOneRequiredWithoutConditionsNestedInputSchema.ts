...
export const PipelineAutomationUpdateOneRequiredWithoutConditionsNestedInputSchema: z.ZodType<Prisma.PipelineAutomationUpdateOneRequiredWithoutConditionsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => PipelineAutomationUpdateToOneWithWhereWithoutConditionsInputSchema),
