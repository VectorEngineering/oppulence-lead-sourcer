...
export const ReportColumnUpsertWithWhereUniqueWithoutReportInputSchema: z.ZodType<Prisma.ReportColumnUpsertWithWhereUniqueWithoutReportInput> =
    z
        .object({
            where: z.lazy(() => ReportColumnWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => ReportColumnUpdateWithoutReportInputSchema),
                z.lazy(() => ReportColumnUncheckedUpdateWithoutReportInputSchema)
            ]),
            create: z.union([
