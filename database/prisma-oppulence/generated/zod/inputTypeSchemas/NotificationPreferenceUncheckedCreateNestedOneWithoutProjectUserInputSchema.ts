...
export const NotificationPreferenceUncheckedCreateNestedOneWithoutProjectUserInputSchema: z.ZodType<Prisma.NotificationPreferenceUncheckedCreateNestedOneWithoutProjectUserInput> =
    z
        .object({
            create: z
                .union([
