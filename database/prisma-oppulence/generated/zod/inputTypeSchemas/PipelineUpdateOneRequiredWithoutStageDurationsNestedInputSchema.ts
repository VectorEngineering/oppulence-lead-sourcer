...
export const PipelineUpdateOneRequiredWithoutStageDurationsNestedInputSchema: z.ZodType<Prisma.PipelineUpdateOneRequiredWithoutStageDurationsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => PipelineUpdateToOneWithWhereWithoutStageDurationsInputSchema),
