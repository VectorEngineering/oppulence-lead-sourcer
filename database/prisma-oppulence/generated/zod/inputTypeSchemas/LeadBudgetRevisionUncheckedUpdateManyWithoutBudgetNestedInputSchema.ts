...
export const LeadBudgetRevisionUncheckedUpdateManyWithoutBudgetNestedInputSchema: z.ZodType<Prisma.LeadBudgetRevisionUncheckedUpdateManyWithoutBudgetNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => LeadBudgetRevisionUpsertWithWhereUniqueWithoutBudgetInputSchema),
                    z.lazy(() => LeadBudgetRevisionUpsertWithWhereUniqueWithoutBudgetInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => LeadBudgetRevisionUpdateWithWhereUniqueWithoutBudgetInputSchema),
                    z.lazy(() => LeadBudgetRevisionUpdateWithWhereUniqueWithoutBudgetInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => LeadBudgetRevisionUpdateManyWithWhereWithoutBudgetInputSchema),
                    z.lazy(() => LeadBudgetRevisionUpdateManyWithWhereWithoutBudgetInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([
                    z.lazy(() => LeadBudgetRevisionScalarWhereInputSchema),
                    z.lazy(() => LeadBudgetRevisionScalarWhereInputSchema).array()
                ])
                .optional()
        })
        .strict()

export default LeadBudgetRevisionUncheckedUpdateManyWithoutBudgetNestedInputSchema
