...
import { PipelineUpdateOneRequiredWithoutKpisNestedInputSchema } from './PipelineUpdateOneRequiredWithoutKpisNestedInputSchema'

export const PipelineKpiUpdateInputSchema: z.ZodType<Prisma.PipelineKpiUpdateInput> = z
    .object({
        ...
        description: z
            ...
            .nullable(),
        frequency: z
            .union([z.lazy(() => PipelineKpiFrequencySchema), z.lazy(() => EnumPipelineKpiFrequencyFieldUpdateOperationsInputSchema)])
            .optional(),
        calculation: z
            .union([z.lazy(() => PipelineKpiCalculationSchema), z.lazy(() => EnumPipelineKpiCalculationFieldUpdateOperationsInputSchema)])
            .optional(),
        formula: z
            .union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputSchema)])
            .optional()
        ...
        pipeline: z.lazy(() => PipelineUpdateOneRequiredWithoutKpisNestedInputSchema).optional()
    })
    .strict()

export default PipelineKpiUpdateInputSchema
