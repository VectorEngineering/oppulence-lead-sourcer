...
export const LeadCreateNestedOneWithoutCompetitorsInputSchema: z.ZodType<Prisma.LeadCreateNestedOneWithoutCompetitorsInput> = z
    .object({
        create: z
            .union([z.lazy(() => LeadCreateWithoutCompetitorsInputSchema), z.lazy(() => LeadUncheckedCreateWithoutCompetitorsInputSchema)])
            .optional(),
