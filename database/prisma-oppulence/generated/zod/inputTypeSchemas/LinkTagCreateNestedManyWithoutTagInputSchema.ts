...
export const LinkTagCreateNestedManyWithoutTagInputSchema: z.ZodType<Prisma.LinkTagCreateNestedManyWithoutTagInput> = z
    .object({
        create: z
            .union([
...
export default LinkTagCreateNestedManyWithoutTagInputSchema
