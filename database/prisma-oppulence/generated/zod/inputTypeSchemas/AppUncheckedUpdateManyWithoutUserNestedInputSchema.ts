...
export const AppUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.AppUncheckedUpdateManyWithoutUserNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => AppUpsertWithWhereUniqueWithoutUserInputSchema),
                z.lazy(() => AppUpsertWithWhereUniqueWithoutUserInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => AppUpdateWithWhereUniqueWithoutUserInputSchema),
                z.lazy(() => AppUpdateWithWhereUniqueWithoutUserInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => AppUpdateManyWithWhereWithoutUserInputSchema),
                z.lazy(() => AppUpdateManyWithWhereWithoutUserInputSchema).array()
            ])
            .optional(),
...
export default AppUncheckedUpdateManyWithoutUserNestedInputSchema
