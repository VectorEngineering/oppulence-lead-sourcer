...
export const LeadBudgetExpenseScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadBudgetExpenseScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadBudgetExpenseScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadBudgetExpenseScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadBudgetExpenseScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
