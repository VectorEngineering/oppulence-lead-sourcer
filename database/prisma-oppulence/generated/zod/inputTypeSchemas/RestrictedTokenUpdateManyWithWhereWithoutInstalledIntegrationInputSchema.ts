...
export const RestrictedTokenUpdateManyWithWhereWithoutInstalledIntegrationInputSchema: z.ZodType<Prisma.RestrictedTokenUpdateManyWithWhereWithoutInstalledIntegrationInput> =
    z
        .object({
            where: z.lazy(() => RestrictedTokenScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => RestrictedTokenUpdateManyMutationInputSchema),
                z.lazy(() => RestrictedTokenUncheckedUpdateManyWithoutInstalledIntegrationInputSchema)
            ])
        })
        .strict()
