...
export const LeadTimelineWhereUniqueInputSchema: z.ZodType<Prisma.LeadTimelineWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                OR: z
                    .lazy(() => LeadTimelineWhereInputSchema)
                    .array()
                    .optional(),
...
export default LeadTimelineWhereUniqueInputSchema
