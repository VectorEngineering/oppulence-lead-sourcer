...
export const DealCountOrderByAggregateInputSchema: z.ZodType<Prisma.DealCountOrderByAggregateInput> = z
    .object({
...
export default DealCountOrderByAggregateInputSchema
