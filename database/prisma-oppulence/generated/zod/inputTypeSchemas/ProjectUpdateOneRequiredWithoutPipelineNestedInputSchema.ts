...
export const ProjectUpdateOneRequiredWithoutPipelineNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutPipelineNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => ProjectUpdateToOneWithWhereWithoutPipelineInputSchema),
