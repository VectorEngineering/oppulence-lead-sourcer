...
export const CustomerTagUncheckedUpdateManyWithoutCustomerNestedInputSchema: z.ZodType<Prisma.CustomerTagUncheckedUpdateManyWithoutCustomerNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => CustomerTagUpsertWithWhereUniqueWithoutCustomerInputSchema),
                    z.lazy(() => CustomerTagUpsertWithWhereUniqueWithoutCustomerInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => CustomerTagUpdateWithWhereUniqueWithoutCustomerInputSchema),
                    z.lazy(() => CustomerTagUpdateWithWhereUniqueWithoutCustomerInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => CustomerTagUpdateManyWithWhereWithoutCustomerInputSchema),
                    z.lazy(() => CustomerTagUpdateManyWithWhereWithoutCustomerInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default CustomerTagUncheckedUpdateManyWithoutCustomerNestedInputSchema
