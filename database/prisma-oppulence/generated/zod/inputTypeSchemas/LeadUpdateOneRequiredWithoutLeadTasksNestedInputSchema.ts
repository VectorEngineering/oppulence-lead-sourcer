...
export const LeadUpdateOneRequiredWithoutLeadTasksNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutLeadTasksNestedInput> = z
    .object({
        create: z
            .union([z.lazy(() => LeadCreateWithoutLeadTasksInputSchema), z.lazy(() => LeadUncheckedCreateWithoutLeadTasksInputSchema)])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LeadUpdateToOneWithWhereWithoutLeadTasksInputSchema),
                z.lazy(() => LeadUpdateWithoutLeadTasksInputSchema),
                z.lazy(() => LeadUncheckedUpdateWithoutLeadTasksInputSchema)
            ])
            .optional()
    })
    .strict()
