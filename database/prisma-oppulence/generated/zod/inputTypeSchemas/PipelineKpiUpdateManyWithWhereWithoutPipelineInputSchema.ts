...
export const PipelineKpiUpdateManyWithWhereWithoutPipelineInputSchema: z.ZodType<Prisma.PipelineKpiUpdateManyWithWhereWithoutPipelineInput> =
    z
        .object({
            where: z.lazy(() => PipelineKpiScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => PipelineKpiUpdateManyMutationInputSchema),
                z.lazy(() => PipelineKpiUncheckedUpdateManyWithoutPipelineInputSchema)
            ])
        })
        .strict()
