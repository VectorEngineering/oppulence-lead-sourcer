...
export const LeadScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadScalarWhereWithAggregatesInput> = z
    .object({
        ...
        verificationStatus: z
            .union([z.lazy(() => EnumLeadVerificationStatusWithAggregatesFilterSchema), z.lazy(() => LeadVerificationStatusSchema)])
            .optional(),
        priority: z.union([z.lazy(() => EnumLeadPriorityWithAggregatesFilterSchema), z.lazy(() => LeadPrioritySchema)]).optional(),
        categoryTag: z
            .union([z.lazy(() => EnumLeadCategoryTagNullableWithAggregatesFilterSchema), z.lazy(() => LeadCategoryTagSchema)])
            .optional()
            .nullable(),
        closeDate: z
