...
export const ProjectUpdateOneRequiredWithoutUsersNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutUsersNestedInput> = z
    .object({
        create: z
        ...
        update: z
            .union([
                z.lazy(() => ProjectUpdateToOneWithWhereWithoutUsersInputSchema),
                z.lazy(() => ProjectUpdateWithoutUsersInputSchema),
                z.lazy(() => ProjectUncheckedUpdateWithoutUsersInputSchema)
            ])
            .optional()
    })
    .strict()
