...
export const PipelineKpiUncheckedUpdateManyWithoutPipelineInputSchema: z.ZodType<Prisma.PipelineKpiUncheckedUpdateManyWithoutPipelineInput> =
    z
        .object({
            ...
            current: z
                ...
                .nullable(),
            unit: z
                .union([z.lazy(() => PipelineKpiUnitSchema), z.lazy(() => EnumPipelineKpiUnitFieldUpdateOperationsInputSchema)])
                .optional(),
            description: z
            ...
            calculation: z
                .union([
                    ...
                    z.lazy(() => EnumPipelineKpiCalculationFieldUpdateOperationsInputSchema)
                ])
                .optional(),
            formula: z
                .union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputSchema)])
...
export default PipelineKpiUncheckedUpdateManyWithoutPipelineInputSchema
