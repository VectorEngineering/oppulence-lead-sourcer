...
export const InvoiceCommentUncheckedUpdateManyWithoutInvoiceNestedInputSchema: z.ZodType<Prisma.InvoiceCommentUncheckedUpdateManyWithoutInvoiceNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => InvoiceCommentCreateWithoutInvoiceInputSchema),
                    z.lazy(() => InvoiceCommentCreateWithoutInvoiceInputSchema).array(),
                    z.lazy(() => InvoiceCommentUncheckedCreateWithoutInvoiceInputSchema),
                    z.lazy(() => InvoiceCommentUncheckedCreateWithoutInvoiceInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => InvoiceCommentCreateOrConnectWithoutInvoiceInputSchema),
                    z.lazy(() => InvoiceCommentCreateOrConnectWithoutInvoiceInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => InvoiceCommentUpsertWithWhereUniqueWithoutInvoiceInputSchema),
                    z.lazy(() => InvoiceCommentUpsertWithWhereUniqueWithoutInvoiceInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => InvoiceCommentUpdateWithWhereUniqueWithoutInvoiceInputSchema),
                    z.lazy(() => InvoiceCommentUpdateWithWhereUniqueWithoutInvoiceInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => InvoiceCommentUpdateManyWithWhereWithoutInvoiceInputSchema),
                    z.lazy(() => InvoiceCommentUpdateManyWithWhereWithoutInvoiceInputSchema).array()
                ])
                .optional(),
            deleteMany: z
                .union([z.lazy(() => InvoiceCommentScalarWhereInputSchema), z.lazy(() => InvoiceCommentScalarWhereInputSchema).array()])
                .optional()
        })
        .strict()

export default InvoiceCommentUncheckedUpdateManyWithoutInvoiceNestedInputSchema
