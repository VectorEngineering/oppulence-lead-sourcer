...
export const LeadUpdateOneRequiredWithoutTouchpointsNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutTouchpointsNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            update: z
                .union([
                    z.lazy(() => LeadUpdateToOneWithWhereWithoutTouchpointsInputSchema),
