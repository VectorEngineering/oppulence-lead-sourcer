...
export const LeadTouchpointUncheckedCreateNestedManyWithoutCampaignInputSchema: z.ZodType<Prisma.LeadTouchpointUncheckedCreateNestedManyWithoutCampaignInput> =
    z
        .object({
            create: z
                .union([
