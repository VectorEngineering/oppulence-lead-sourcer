...
export const LeadSegmentationUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadSegmentationUpdateManyWithWhereWithoutLeadInput> =
    z
        .object({
            where: z.lazy(() => LeadSegmentationScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => LeadSegmentationUpdateManyMutationInputSchema),
                z.lazy(() => LeadSegmentationUncheckedUpdateManyWithoutLeadInputSchema)
            ])
        })
        .strict()
