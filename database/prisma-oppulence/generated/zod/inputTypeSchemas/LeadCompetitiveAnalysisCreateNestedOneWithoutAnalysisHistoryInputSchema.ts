...
export const LeadCompetitiveAnalysisCreateNestedOneWithoutAnalysisHistoryInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisCreateNestedOneWithoutAnalysisHistoryInput> =
    z
        .object({
            create: z
                .union([
