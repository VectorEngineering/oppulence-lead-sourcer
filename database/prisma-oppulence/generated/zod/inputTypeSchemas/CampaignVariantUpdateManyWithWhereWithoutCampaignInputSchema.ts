...
export const CampaignVariantUpdateManyWithWhereWithoutCampaignInputSchema: z.ZodType<Prisma.CampaignVariantUpdateManyWithWhereWithoutCampaignInput> =
    z
        .object({
            where: z.lazy(() => CampaignVariantScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => CampaignVariantUpdateManyMutationInputSchema),
                z.lazy(() => CampaignVariantUncheckedUpdateManyWithoutCampaignInputSchema)
            ])
        })
        .strict()
