...
export const UtmTemplateUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.UtmTemplateUpdateManyWithWhereWithoutProjectInput> =
    z
        .object({
            where: z.lazy(() => UtmTemplateScalarWhereInputSchema),
            data: z.union([
                z.lazy(() => UtmTemplateUpdateManyMutationInputSchema),
                z.lazy(() => UtmTemplateUncheckedUpdateManyWithoutProjectInputSchema)
            ])
        })
        .strict()
