...
export const LeadComplianceHistoryUpdateManyWithoutComplianceAuditNestedInputSchema: z.ZodType<Prisma.LeadComplianceHistoryUpdateManyWithoutComplianceAuditNestedInput> =
    z
        .object({
            create: z
                .union([
