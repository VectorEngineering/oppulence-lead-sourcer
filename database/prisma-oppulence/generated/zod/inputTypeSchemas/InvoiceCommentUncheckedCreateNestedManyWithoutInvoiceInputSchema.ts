...
export const InvoiceCommentUncheckedCreateNestedManyWithoutInvoiceInputSchema: z.ZodType<Prisma.InvoiceCommentUncheckedCreateNestedManyWithoutInvoiceInput> =
    z
        .object({
            create: z
                .union([
