...
export const PartnerUserUncheckedUpdateManyWithoutPartnerNestedInputSchema: z.ZodType<Prisma.PartnerUserUncheckedUpdateManyWithoutPartnerNestedInput> =
    z
        .object({
            create: z
                .union([
            ...
            upsert: z
                .union([
                    z.lazy(() => PartnerUserUpsertWithWhereUniqueWithoutPartnerInputSchema),
                    z.lazy(() => PartnerUserUpsertWithWhereUniqueWithoutPartnerInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => PartnerUserUpdateWithWhereUniqueWithoutPartnerInputSchema),
                    z.lazy(() => PartnerUserUpdateWithWhereUniqueWithoutPartnerInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => PartnerUserUpdateManyWithWhereWithoutPartnerInputSchema),
                    z.lazy(() => PartnerUserUpdateManyWithWhereWithoutPartnerInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default PartnerUserUncheckedUpdateManyWithoutPartnerNestedInputSchema
