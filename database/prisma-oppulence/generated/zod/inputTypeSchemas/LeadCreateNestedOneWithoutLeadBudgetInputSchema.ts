...
export const LeadCreateNestedOneWithoutLeadBudgetInputSchema: z.ZodType<Prisma.LeadCreateNestedOneWithoutLeadBudgetInput> = z
    .object({
        create: z
            .union([z.lazy(() => LeadCreateWithoutLeadBudgetInputSchema), z.lazy(() => LeadUncheckedCreateWithoutLeadBudgetInputSchema)])
            .optional(),
