...
export const LeadCompetitiveHistoryUpsertWithWhereUniqueWithoutAnalysisInputSchema: z.ZodType<Prisma.LeadCompetitiveHistoryUpsertWithWhereUniqueWithoutAnalysisInput> =
    z
        .object({
            where: z.lazy(() => LeadCompetitiveHistoryWhereUniqueInputSchema),
            update: z.union([
                z.lazy(() => LeadCompetitiveHistoryUpdateWithoutAnalysisInputSchema),
                z.lazy(() => LeadCompetitiveHistoryUncheckedUpdateWithoutAnalysisInputSchema)
            ]),
            create: z.union([
