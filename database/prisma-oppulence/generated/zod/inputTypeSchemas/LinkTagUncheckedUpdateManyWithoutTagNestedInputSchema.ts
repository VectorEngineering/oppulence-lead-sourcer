...
export const LinkTagUncheckedUpdateManyWithoutTagNestedInputSchema: z.ZodType<Prisma.LinkTagUncheckedUpdateManyWithoutTagNestedInput> = z
    .object({
        create: z
            .union([
                z.lazy(() => LinkTagCreateWithoutTagInputSchema),
                z.lazy(() => LinkTagCreateWithoutTagInputSchema).array(),
                z.lazy(() => LinkTagUncheckedCreateWithoutTagInputSchema),
                z.lazy(() => LinkTagUncheckedCreateWithoutTagInputSchema).array()
            ])
            .optional(),
        connectOrCreate: z
            .union([
                z.lazy(() => LinkTagCreateOrConnectWithoutTagInputSchema),
                z.lazy(() => LinkTagCreateOrConnectWithoutTagInputSchema).array()
            ])
            .optional(),
        upsert: z
            .union([
                z.lazy(() => LinkTagUpsertWithWhereUniqueWithoutTagInputSchema),
                z.lazy(() => LinkTagUpsertWithWhereUniqueWithoutTagInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LinkTagUpdateWithWhereUniqueWithoutTagInputSchema),
                z.lazy(() => LinkTagUpdateWithWhereUniqueWithoutTagInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => LinkTagUpdateManyWithWhereWithoutTagInputSchema),
                z.lazy(() => LinkTagUpdateManyWithWhereWithoutTagInputSchema).array()
            ])
            .optional(),
...
export default LinkTagUncheckedUpdateManyWithoutTagNestedInputSchema
