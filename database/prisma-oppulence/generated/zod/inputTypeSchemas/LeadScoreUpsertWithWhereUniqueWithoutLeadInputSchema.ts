...
export const LeadScoreUpsertWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadScoreUpsertWithWhereUniqueWithoutLeadInput> = z
    .object({
        where: z.lazy(() => LeadScoreWhereUniqueInputSchema),
        update: z.union([
            z.lazy(() => LeadScoreUpdateWithoutLeadInputSchema),
            z.lazy(() => LeadScoreUncheckedUpdateWithoutLeadInputSchema)
        ]),
