...
export const AutomationTriggerUncheckedCreateNestedManyWithoutAutomationInputSchema: z.ZodType<Prisma.AutomationTriggerUncheckedCreateNestedManyWithoutAutomationInput> =
    z
        .object({
            create: z
                .union([
