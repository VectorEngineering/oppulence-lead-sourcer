...
export const LinkUpdateManyWithoutProgramNestedInputSchema: z.ZodType<Prisma.LinkUpdateManyWithoutProgramNestedInput> = z
    .object({
        create: z
            .union([
        ...
        upsert: z
            .union([
                z.lazy(() => LinkUpsertWithWhereUniqueWithoutProgramInputSchema),
                z.lazy(() => LinkUpsertWithWhereUniqueWithoutProgramInputSchema).array()
            ])
            .optional(),
        ...
        update: z
            .union([
                z.lazy(() => LinkUpdateWithWhereUniqueWithoutProgramInputSchema),
                z.lazy(() => LinkUpdateWithWhereUniqueWithoutProgramInputSchema).array()
            ])
            .optional(),
        updateMany: z
            .union([
                z.lazy(() => LinkUpdateManyWithWhereWithoutProgramInputSchema),
                z.lazy(() => LinkUpdateManyWithWhereWithoutProgramInputSchema).array()
            ])
            .optional(),
...
export default LinkUpdateManyWithoutProgramNestedInputSchema
