...
export const LeadComplianceAuditWhereInputSchema: z.ZodType<Prisma.LeadComplianceAuditWhereInput> = z
    .object({
        AND: z
            .union([z.lazy(() => LeadComplianceAuditWhereInputSchema), z.lazy(() => LeadComplianceAuditWhereInputSchema).array()])
            .optional(),
        OR: z
            .lazy(() => LeadComplianceAuditWhereInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([z.lazy(() => LeadComplianceAuditWhereInputSchema), z.lazy(() => LeadComplianceAuditWhereInputSchema).array()])
...
export default LeadComplianceAuditWhereInputSchema
