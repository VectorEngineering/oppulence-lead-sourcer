...
export const DashboardUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.DashboardUncheckedUpdateManyWithoutUserNestedInput> =
    z
        .object({
            create: z
                .union([
                    z.lazy(() => DashboardCreateWithoutUserInputSchema),
                    z.lazy(() => DashboardCreateWithoutUserInputSchema).array(),
                    z.lazy(() => DashboardUncheckedCreateWithoutUserInputSchema),
                    z.lazy(() => DashboardUncheckedCreateWithoutUserInputSchema).array()
                ])
                .optional(),
            connectOrCreate: z
                .union([
                    z.lazy(() => DashboardCreateOrConnectWithoutUserInputSchema),
                    z.lazy(() => DashboardCreateOrConnectWithoutUserInputSchema).array()
                ])
                .optional(),
            upsert: z
                .union([
                    z.lazy(() => DashboardUpsertWithWhereUniqueWithoutUserInputSchema),
                    z.lazy(() => DashboardUpsertWithWhereUniqueWithoutUserInputSchema).array()
                ])
                .optional(),
            ...
            update: z
                .union([
                    z.lazy(() => DashboardUpdateWithWhereUniqueWithoutUserInputSchema),
                    z.lazy(() => DashboardUpdateWithWhereUniqueWithoutUserInputSchema).array()
                ])
                .optional(),
            updateMany: z
                .union([
                    z.lazy(() => DashboardUpdateManyWithWhereWithoutUserInputSchema),
                    z.lazy(() => DashboardUpdateManyWithWhereWithoutUserInputSchema).array()
                ])
                .optional(),
            deleteMany: z
...
export default DashboardUncheckedUpdateManyWithoutUserNestedInputSchema
