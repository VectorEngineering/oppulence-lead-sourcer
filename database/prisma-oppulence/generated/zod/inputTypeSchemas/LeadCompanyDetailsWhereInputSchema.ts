...
export const LeadCompanyDetailsWhereInputSchema: z.ZodType<Prisma.LeadCompanyDetailsWhereInput> = z
    .object({
        AND: z
            .union([z.lazy(() => LeadCompanyDetailsWhereInputSchema), z.lazy(() => LeadCompanyDetailsWhereInputSchema).array()])
            .optional(),
        OR: z
            .lazy(() => LeadCompanyDetailsWhereInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([z.lazy(() => LeadCompanyDetailsWhereInputSchema), z.lazy(() => LeadCompanyDetailsWhereInputSchema).array()])
