...
export const NestedEnumLeadSocialPlatformWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumLeadSocialPlatformWithAggregatesFilter> = z
    .object({
        equals: z.lazy(() => LeadSocialPlatformSchema).optional(),
        in: z
            .lazy(() => LeadSocialPlatformSchema)
            .array()
            .optional(),
        notIn: z
            .lazy(() => LeadSocialPlatformSchema)
            ...
            .optional(),
        not: z
            .union([z.lazy(() => LeadSocialPlatformSchema), z.lazy(() => NestedEnumLeadSocialPlatformWithAggregatesFilterSchema)])
            .optional(),
