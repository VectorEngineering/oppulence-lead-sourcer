...
export const LeadCompanyDetailsUncheckedUpdateOneWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadCompanyDetailsUncheckedUpdateOneWithoutLeadNestedInput> =
    z
        .object({
            create: z
                .union([
