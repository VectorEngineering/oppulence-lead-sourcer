...
export const InvoiceTemplateWhereUniqueInputSchema: z.ZodType<Prisma.InvoiceTemplateWhereUniqueInput> = z
    .object({
        id: z.string().cuid()
    })
    .and(
        z
            .object({
                ...
                AND: z
                    .union([z.lazy(() => InvoiceTemplateWhereInputSchema), z.lazy(() => InvoiceTemplateWhereInputSchema).array()])
                    .optional(),
                OR: z
                ...
                dateFormat: z
                    ...
                    .nullable(),
                deliveryType: z
                    .union([z.lazy(() => EnumInvoiceDeliveryTypeFilterSchema), z.lazy(() => InvoiceDeliveryTypeSchema)])
                    .optional(),
                descriptionLabel: z
                    .union([z.lazy(() => StringNullableFilterSchema), z.string()])
                    .optional()
                ...
                quantityLabel: z
                    ...
                    .nullable(),
                size: z
                    .union([z.lazy(() => EnumInvoiceSizeNullableFilterSchema), z.lazy(() => InvoiceSizeSchema)])
                    .optional()
                    .nullable(),
                taxLabel: z
                    .union([z.lazy(() => StringNullableFilterSchema), z.string()])
