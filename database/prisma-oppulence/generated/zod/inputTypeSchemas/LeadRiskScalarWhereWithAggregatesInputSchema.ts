...
export const LeadRiskScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadRiskScalarWhereWithAggregatesInput> = z
    .object({
        AND: z
            .union([
                z.lazy(() => LeadRiskScalarWhereWithAggregatesInputSchema),
                z.lazy(() => LeadRiskScalarWhereWithAggregatesInputSchema).array()
            ])
            .optional(),
        OR: z
            .lazy(() => LeadRiskScalarWhereWithAggregatesInputSchema)
            .array()
            .optional(),
        NOT: z
            .union([
