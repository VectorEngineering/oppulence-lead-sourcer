...
import { ContractDocumentUpdateInputSchema } from '../inputTypeSchemas/ContractDocumentUpdateInputSchema'
import { ContractDocumentUncheckedUpdateInputSchema } from '../inputTypeSchemas/ContractDocumentUncheckedUpdateInputSchema'
import { ContractArgsSchema } from './ContractArgsSchema'
import { DocumentCommentFindManyArgsSchema } from './DocumentCommentFindManyArgsSchema'
import { DocumentAnnotationFindManyArgsSchema } from './DocumentAnnotationFindManyArgsSchema'
import { ContractDocumentCountOutputTypeArgsSchema } from './ContractDocumentCountOutputTypeArgsSchema'
...
export const ContractDocumentUpsertArgsSchema: z.ZodType<Prisma.ContractDocumentUpsertArgs> = z
    .object({
        select: ContractDocumentSelectSchema.optional(),
        include: ContractDocumentIncludeSchema.optional(),
        where: ContractDocumentWhereUniqueInputSchema,
        create: z.union([ContractDocumentCreateInputSchema, ContractDocumentUncheckedCreateInputSchema]),
        update: z.union([ContractDocumentUpdateInputSchema, ContractDocumentUncheckedUpdateInputSchema])
    })
    .strict()

export default ContractDocumentUpsertArgsSchema
