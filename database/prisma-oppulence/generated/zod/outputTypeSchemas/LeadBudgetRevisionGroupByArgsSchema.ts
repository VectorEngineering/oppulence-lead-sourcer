...
export const LeadBudgetRevisionGroupByArgsSchema: z.ZodType<Prisma.LeadBudgetRevisionGroupByArgs> = z
    .object({
        where: LeadBudgetRevisionWhereInputSchema.optional(),
        orderBy: z
            .union([LeadBudgetRevisionOrderByWithAggregationInputSchema.array(), LeadBudgetRevisionOrderByWithAggregationInputSchema])
            .optional(),
