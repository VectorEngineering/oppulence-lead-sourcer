...
export const LeadProductFitAssessmentGroupByArgsSchema: z.ZodType<Prisma.LeadProductFitAssessmentGroupByArgs> = z
    .object({
        where: LeadProductFitAssessmentWhereInputSchema.optional(),
        orderBy: z
            .union([
                LeadProductFitAssessmentOrderByWithAggregationInputSchema.array(),
                LeadProductFitAssessmentOrderByWithAggregationInputSchema
            ])
            .optional(),
