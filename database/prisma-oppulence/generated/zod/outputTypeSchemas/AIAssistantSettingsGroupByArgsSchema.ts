...
export const AIAssistantSettingsGroupByArgsSchema: z.ZodType<Prisma.AIAssistantSettingsGroupByArgs> = z
    .object({
        where: AIAssistantSettingsWhereInputSchema.optional(),
        orderBy: z
            .union([AIAssistantSettingsOrderByWithAggregationInputSchema.array(), AIAssistantSettingsOrderByWithAggregationInputSchema])
            .optional(),
