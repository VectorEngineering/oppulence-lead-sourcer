...
export const AutomationActionFindFirstOrThrowArgsSchema: z.ZodType<Prisma.AutomationActionFindFirstOrThrowArgs> = z
    .object({
        ...
        orderBy: z
            .union([AutomationActionOrderByWithRelationInputSchema.array(), AutomationActionOrderByWithRelationInputSchema])
            .optional(),
...
export default AutomationActionFindFirstOrThrowArgsSchema
