...
export const AccessRuleConditionFindFirstArgsSchema: z.ZodType<Prisma.AccessRuleConditionFindFirstArgs> = z
    .object({
        ...
        orderBy: z
            .union([AccessRuleConditionOrderByWithRelationInputSchema.array(), AccessRuleConditionOrderByWithRelationInputSchema])
            .optional(),
...
export default AccessRuleConditionFindFirstArgsSchema
