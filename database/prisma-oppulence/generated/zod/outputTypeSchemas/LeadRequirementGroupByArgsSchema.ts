...
export const LeadRequirementGroupByArgsSchema: z.ZodType<Prisma.LeadRequirementGroupByArgs> = z
    .object({
        where: LeadRequirementWhereInputSchema.optional(),
        orderBy: z
            .union([LeadRequirementOrderByWithAggregationInputSchema.array(), LeadRequirementOrderByWithAggregationInputSchema])
            .optional(),
