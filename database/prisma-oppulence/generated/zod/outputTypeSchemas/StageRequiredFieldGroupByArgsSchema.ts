...
export const StageRequiredFieldGroupByArgsSchema: z.ZodType<Prisma.StageRequiredFieldGroupByArgs> = z
    .object({
        where: StageRequiredFieldWhereInputSchema.optional(),
        orderBy: z
            .union([StageRequiredFieldOrderByWithAggregationInputSchema.array(), StageRequiredFieldOrderByWithAggregationInputSchema])
            .optional(),
