...
export const LeadComplianceAuditGroupByArgsSchema: z.ZodType<Prisma.LeadComplianceAuditGroupByArgs> = z
    .object({
        where: LeadComplianceAuditWhereInputSchema.optional(),
        orderBy: z
            .union([LeadComplianceAuditOrderByWithAggregationInputSchema.array(), LeadComplianceAuditOrderByWithAggregationInputSchema])
            .optional(),
