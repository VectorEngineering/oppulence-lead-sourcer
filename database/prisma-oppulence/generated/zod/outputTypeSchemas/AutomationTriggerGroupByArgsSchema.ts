...
export const AutomationTriggerGroupByArgsSchema: z.ZodType<Prisma.AutomationTriggerGroupByArgs> = z
    .object({
        where: AutomationTriggerWhereInputSchema.optional(),
        orderBy: z
            .union([AutomationTriggerOrderByWithAggregationInputSchema.array(), AutomationTriggerOrderByWithAggregationInputSchema])
            .optional(),
