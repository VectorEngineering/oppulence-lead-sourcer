...
export const LeadPersonalDetailsSelectSchema: z.ZodType<Prisma.LeadPersonalDetailsSelect> = z
    .object({
...
export const LeadPersonalDetailsUpsertArgsSchema: z.ZodType<Prisma.LeadPersonalDetailsUpsertArgs> = z
    .object({
        ...
        create: z.union([LeadPersonalDetailsCreateInputSchema, LeadPersonalDetailsUncheckedCreateInputSchema]),
        update: z.union([LeadPersonalDetailsUpdateInputSchema, LeadPersonalDetailsUncheckedUpdateInputSchema])
    })
    .strict()

export default LeadPersonalDetailsUpsertArgsSchema
