...
export const LeadDecisionMakerGroupByArgsSchema: z.ZodType<Prisma.LeadDecisionMakerGroupByArgs> = z
    .object({
        where: LeadDecisionMakerWhereInputSchema.optional(),
        orderBy: z
            .union([LeadDecisionMakerOrderByWithAggregationInputSchema.array(), LeadDecisionMakerOrderByWithAggregationInputSchema])
            .optional(),
