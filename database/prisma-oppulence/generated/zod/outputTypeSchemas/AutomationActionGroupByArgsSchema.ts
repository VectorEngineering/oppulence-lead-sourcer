...
export const AutomationActionGroupByArgsSchema: z.ZodType<Prisma.AutomationActionGroupByArgs> = z
    .object({
        where: AutomationActionWhereInputSchema.optional(),
        orderBy: z
            .union([AutomationActionOrderByWithAggregationInputSchema.array(), AutomationActionOrderByWithAggregationInputSchema])
            .optional(),
