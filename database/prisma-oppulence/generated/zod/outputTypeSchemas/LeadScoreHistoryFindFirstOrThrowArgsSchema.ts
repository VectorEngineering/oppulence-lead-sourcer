...
export const LeadScoreHistoryFindFirstOrThrowArgsSchema: z.ZodType<Prisma.LeadScoreHistoryFindFirstOrThrowArgs> = z
    .object({
        ...
        orderBy: z
            .union([LeadScoreHistoryOrderByWithRelationInputSchema.array(), LeadScoreHistoryOrderByWithRelationInputSchema])
            .optional(),
...
export default LeadScoreHistoryFindFirstOrThrowArgsSchema
