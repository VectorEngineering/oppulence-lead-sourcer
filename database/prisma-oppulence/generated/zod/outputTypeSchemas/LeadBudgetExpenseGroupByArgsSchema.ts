...
export const LeadBudgetExpenseGroupByArgsSchema: z.ZodType<Prisma.LeadBudgetExpenseGroupByArgs> = z
    .object({
        where: LeadBudgetExpenseWhereInputSchema.optional(),
        orderBy: z
            .union([LeadBudgetExpenseOrderByWithAggregationInputSchema.array(), LeadBudgetExpenseOrderByWithAggregationInputSchema])
            .optional(),
