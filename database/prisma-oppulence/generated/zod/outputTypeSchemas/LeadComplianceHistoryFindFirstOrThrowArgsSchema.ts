...
export const LeadComplianceHistoryFindFirstOrThrowArgsSchema: z.ZodType<Prisma.LeadComplianceHistoryFindFirstOrThrowArgs> = z
    .object({
        ...
        orderBy: z
            .union([LeadComplianceHistoryOrderByWithRelationInputSchema.array(), LeadComplianceHistoryOrderByWithRelationInputSchema])
            .optional(),
...
export default LeadComplianceHistoryFindFirstOrThrowArgsSchema
