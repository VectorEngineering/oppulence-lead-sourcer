...
export const LeadCompetitiveAnalysisGroupByArgsSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisGroupByArgs> = z
    .object({
        where: LeadCompetitiveAnalysisWhereInputSchema.optional(),
        orderBy: z
            .union([
                LeadCompetitiveAnalysisOrderByWithAggregationInputSchema.array(),
                LeadCompetitiveAnalysisOrderByWithAggregationInputSchema
            ])
            .optional(),
