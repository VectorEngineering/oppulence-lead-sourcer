...
export const LeadExternalSystemGroupByArgsSchema: z.ZodType<Prisma.LeadExternalSystemGroupByArgs> = z
    .object({
        where: LeadExternalSystemWhereInputSchema.optional(),
        orderBy: z
            .union([LeadExternalSystemOrderByWithAggregationInputSchema.array(), LeadExternalSystemOrderByWithAggregationInputSchema])
            .optional(),
