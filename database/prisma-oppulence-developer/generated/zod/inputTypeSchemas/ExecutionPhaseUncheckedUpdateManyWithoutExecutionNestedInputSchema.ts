...
export const ExecutionPhaseUncheckedUpdateManyWithoutExecutionNestedInputSchema: z.ZodType<Prisma.ExecutionPhaseUncheckedUpdateManyWithoutExecutionNestedInput> =
    z
        .object({
            create: z
                .union([
