...
declare module '@eslint/eslintrc' {
    ...
    export class FlatCompat {
        constructor({ baseDirectory, resolvePluginsRelativeTo }: { baseDirectory: string; resolvePluginsRelativeTo: string })
...
declare module '@eslint/compat' {
    ...
    export const fixupConfigRules: (config: Linter.FlatConfig | string) => ConfigWithExtends[]
}
