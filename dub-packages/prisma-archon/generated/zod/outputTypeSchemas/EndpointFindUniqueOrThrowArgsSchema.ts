...
export const EndpointFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.EndpointFindUniqueOrThrowArgs> = z.object({
  select: EndpointSelectSchema.optional(),
  include: EndpointIncludeSchema.optional(),
  where: EndpointWhereUniqueInputSchema,
}).strict() ;

export default EndpointFindUniqueOrThrowArgsSchema;
