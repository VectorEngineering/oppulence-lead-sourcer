...
export const EndpointUpdateOneRequiredWithoutLeadsNestedInputSchema: z.ZodType<Prisma.EndpointUpdateOneRequiredWithoutLeadsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => EndpointUpdateToOneWithWhereWithoutLeadsInputSchema),z.lazy(() => EndpointUpdateWithoutLeadsInputSchema),z.lazy(() => EndpointUncheckedUpdateWithoutLeadsInputSchema) ]).optional(),
}).strict();
