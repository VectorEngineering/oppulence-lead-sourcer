...
export const TransactionEnrichmentCreateArgsSchema: z.ZodType<Prisma.TransactionEnrichmentCreateArgs> = z.object({
  select: TransactionEnrichmentSelectSchema.optional(),
  include: TransactionEnrichmentIncludeSchema.optional(),
  data: z.union([ TransactionEnrichmentCreateInputSchema,TransactionEnrichmentUncheckedCreateInputSchema ]),
}).strict() ;

export default TransactionEnrichmentCreateArgsSchema;
