...
import { FinancialSettingsCreateInputSchema } from '../inputTypeSchemas/FinancialSettingsCreateInputSchema'
import { FinancialSettingsUncheckedCreateInputSchema } from '../inputTypeSchemas/FinancialSettingsUncheckedCreateInputSchema'
import { FinancialSettingsUpdateInputSchema } from '../inputTypeSchemas/FinancialSettingsUpdateInputSchema'
import { FinancialSettingsUncheckedUpdateInputSchema } from '../inputTypeSchemas/FinancialSettingsUncheckedUpdateInputSchema'
import { UserArgsSchema } from "../outputTypeSchemas/UserArgsSchema"
// Select schema needs to be in file to prevent circular imports
//------------------------------------------------------

export const FinancialSettingsSelectSchema: z.ZodType<Prisma.FinancialSettingsSelect> = z.object({
...
export const FinancialSettingsUpsertArgsSchema: z.ZodType<Prisma.FinancialSettingsUpsertArgs> = z.object({
  ...
  create: z.union([ FinancialSettingsCreateInputSchema,FinancialSettingsUncheckedCreateInputSchema ]),
  update: z.union([ FinancialSettingsUpdateInputSchema,FinancialSettingsUncheckedUpdateInputSchema ]),
}).strict() ;

export default FinancialSettingsUpsertArgsSchema;
