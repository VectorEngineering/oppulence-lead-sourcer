...
export const ContractVersionGroupByArgsSchema: z.ZodType<Prisma.ContractVersionGroupByArgs> = z.object({
  where: ContractVersionWhereInputSchema.optional(),
  orderBy: z.union([ ContractVersionOrderByWithAggregationInputSchema.array(),ContractVersionOrderByWithAggregationInputSchema ]).optional(),
