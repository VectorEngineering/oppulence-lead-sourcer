...
export const InboxActivitySelectSchema: z.ZodType<Prisma.InboxActivitySelect> = z.object({
...
export const InboxActivityUpdateArgsSchema: z.ZodType<Prisma.InboxActivityUpdateArgs> = z.object({
  select: InboxActivitySelectSchema.optional(),
  include: InboxActivityIncludeSchema.optional(),
  data: z.union([ InboxActivityUpdateInputSchema,InboxActivityUncheckedUpdateInputSchema ]),
  where: InboxActivityWhereUniqueInputSchema,
}).strict() ;

export default InboxActivityUpdateArgsSchema;
