...
export const TransactionCommentUpdateArgsSchema: z.ZodType<Prisma.TransactionCommentUpdateArgs> = z.object({
  select: TransactionCommentSelectSchema.optional(),
  include: TransactionCommentIncludeSchema.optional(),
  data: z.union([ TransactionCommentUpdateInputSchema,TransactionCommentUncheckedUpdateInputSchema ]),
  where: TransactionCommentWhereUniqueInputSchema,
}).strict() ;

export default TransactionCommentUpdateArgsSchema;
