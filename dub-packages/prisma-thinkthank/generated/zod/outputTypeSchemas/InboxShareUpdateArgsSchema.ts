...
export const InboxShareUpdateArgsSchema: z.ZodType<Prisma.InboxShareUpdateArgs> = z.object({
  select: InboxShareSelectSchema.optional(),
  include: InboxShareIncludeSchema.optional(),
  data: z.union([ InboxShareUpdateInputSchema,InboxShareUncheckedUpdateInputSchema ]),
  where: InboxShareWhereUniqueInputSchema,
}).strict() ;

export default InboxShareUpdateArgsSchema;
