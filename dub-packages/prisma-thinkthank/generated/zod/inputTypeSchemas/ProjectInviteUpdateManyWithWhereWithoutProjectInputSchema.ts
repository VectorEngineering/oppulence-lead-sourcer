...
export const ProjectInviteUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.ProjectInviteUpdateManyWithWhereWithoutProjectInput> = z.object({
  where: z.lazy(() => ProjectInviteScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ProjectInviteUpdateManyMutationInputSchema),z.lazy(() => ProjectInviteUncheckedUpdateManyWithoutProjectInputSchema) ]),
}).strict();
