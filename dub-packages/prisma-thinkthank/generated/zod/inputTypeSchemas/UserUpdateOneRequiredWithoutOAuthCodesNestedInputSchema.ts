...
export const UserUpdateOneRequiredWithoutOAuthCodesNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutOAuthCodesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutOAuthCodesInputSchema),z.lazy(() => UserUpdateWithoutOAuthCodesInputSchema),z.lazy(() => UserUncheckedUpdateWithoutOAuthCodesInputSchema) ]).optional(),
}).strict();
