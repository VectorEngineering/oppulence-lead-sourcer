...
export const PartnerUpdateOneWithoutApplicationsNestedInputSchema: z.ZodType<Prisma.PartnerUpdateOneWithoutApplicationsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => PartnerUpdateToOneWithWhereWithoutApplicationsInputSchema),z.lazy(() => PartnerUpdateWithoutApplicationsInputSchema),z.lazy(() => PartnerUncheckedUpdateWithoutApplicationsInputSchema) ]).optional(),
}).strict();
