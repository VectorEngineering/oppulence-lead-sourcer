...
export const InboxUncheckedUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.InboxUncheckedUpdateManyWithoutProjectNestedInput> = z.object({
  create: z.union([ z.lazy(() => InboxCreateWithoutProjectInputSchema),z.lazy(() => InboxCreateWithoutProjectInputSchema).array(),z.lazy(() => InboxUncheckedCreateWithoutProjectInputSchema),z.lazy(() => InboxUncheckedCreateWithoutProjectInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => InboxCreateOrConnectWithoutProjectInputSchema),z.lazy(() => InboxCreateOrConnectWithoutProjectInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => InboxUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => InboxUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => InboxUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => InboxUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => InboxUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => InboxUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => InboxScalarWhereInputSchema),z.lazy(() => InboxScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default InboxUncheckedUpdateManyWithoutProjectNestedInputSchema;
