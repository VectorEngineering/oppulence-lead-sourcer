...
export const TransactionAttachmentScalarWhereInputSchema: z.ZodType<Prisma.TransactionAttachmentScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => TransactionAttachmentScalarWhereInputSchema),z.lazy(() => TransactionAttachmentScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => TransactionAttachmentScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => TransactionAttachmentScalarWhereInputSchema),z.lazy(() => TransactionAttachmentScalarWhereInputSchema).array() ]).optional(),
