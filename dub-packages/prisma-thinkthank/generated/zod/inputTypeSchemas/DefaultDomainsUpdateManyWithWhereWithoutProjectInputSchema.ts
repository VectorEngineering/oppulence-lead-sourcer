...
export const DefaultDomainsUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.DefaultDomainsUpdateManyWithWhereWithoutProjectInput> = z.object({
  where: z.lazy(() => DefaultDomainsScalarWhereInputSchema),
  data: z.union([ z.lazy(() => DefaultDomainsUpdateManyMutationInputSchema),z.lazy(() => DefaultDomainsUncheckedUpdateManyWithoutProjectInputSchema) ]),
}).strict();
