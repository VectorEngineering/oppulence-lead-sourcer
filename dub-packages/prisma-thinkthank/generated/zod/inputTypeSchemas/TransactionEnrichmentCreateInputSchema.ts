...
import { ProjectCreateNestedOneWithoutTransactionEnrichmentInputSchema } from './ProjectCreateNestedOneWithoutTransactionEnrichmentInputSchema';

export const TransactionEnrichmentCreateInputSchema: z.ZodType<Prisma.TransactionEnrichmentCreateInput> = z.object({
  ...
  project: z.lazy(() => ProjectCreateNestedOneWithoutTransactionEnrichmentInputSchema)
}).strict();

export default TransactionEnrichmentCreateInputSchema;
