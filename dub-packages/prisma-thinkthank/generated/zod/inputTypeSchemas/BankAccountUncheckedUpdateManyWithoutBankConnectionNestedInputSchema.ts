...
export const BankAccountUncheckedUpdateManyWithoutBankConnectionNestedInputSchema: z.ZodType<Prisma.BankAccountUncheckedUpdateManyWithoutBankConnectionNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => BankAccountUpsertWithWhereUniqueWithoutBankConnectionInputSchema),z.lazy(() => BankAccountUpsertWithWhereUniqueWithoutBankConnectionInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => BankAccountUpdateWithWhereUniqueWithoutBankConnectionInputSchema),z.lazy(() => BankAccountUpdateWithWhereUniqueWithoutBankConnectionInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => BankAccountUpdateManyWithWhereWithoutBankConnectionInputSchema),z.lazy(() => BankAccountUpdateManyWithWhereWithoutBankConnectionInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => BankAccountScalarWhereInputSchema),z.lazy(() => BankAccountScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default BankAccountUncheckedUpdateManyWithoutBankConnectionNestedInputSchema;
