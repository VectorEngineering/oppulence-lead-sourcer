...
export const WebhookWhereInputSchema: z.ZodType<Prisma.WebhookWhereInput> = z.object({
  ...
  timeout: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
