...
export const UtmTemplateScalarWhereInputSchema: z.ZodType<Prisma.UtmTemplateScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => UtmTemplateScalarWhereInputSchema),z.lazy(() => UtmTemplateScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => UtmTemplateScalarWhereInputSchema).array().optional(),
