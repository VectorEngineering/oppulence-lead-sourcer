...
export const BankConnectionUpsertWithoutSettingsInputSchema: z.ZodType<Prisma.BankConnectionUpsertWithoutSettingsInput> = z.object({
  update: z.union([ z.lazy(() => BankConnectionUpdateWithoutSettingsInputSchema),z.lazy(() => BankConnectionUncheckedUpdateWithoutSettingsInputSchema) ]),
  create: z.union([ z.lazy(() => BankConnectionCreateWithoutSettingsInputSchema),z.lazy(() => BankConnectionUncheckedCreateWithoutSettingsInputSchema) ]),
