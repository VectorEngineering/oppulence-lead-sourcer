...
export const IntegrationUpdateOneWithoutOAuthAppNestedInputSchema: z.ZodType<Prisma.IntegrationUpdateOneWithoutOAuthAppNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => IntegrationUpdateToOneWithWhereWithoutOAuthAppInputSchema),z.lazy(() => IntegrationUpdateWithoutOAuthAppInputSchema),z.lazy(() => IntegrationUncheckedUpdateWithoutOAuthAppInputSchema) ]).optional(),
}).strict();
