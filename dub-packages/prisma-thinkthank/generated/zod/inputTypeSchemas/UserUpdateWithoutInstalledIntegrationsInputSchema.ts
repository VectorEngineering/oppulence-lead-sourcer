...
import { UtmTemplateUpdateManyWithoutUserNestedInputSchema } from './UtmTemplateUpdateManyWithoutUserNestedInputSchema';
import { AppUpdateManyWithoutUserNestedInputSchema } from './AppUpdateManyWithoutUserNestedInputSchema';
import { BankAccountUpdateManyWithoutCreatorNestedInputSchema } from './BankAccountUpdateManyWithoutCreatorNestedInputSchema';
import { TransactionUpdateManyWithoutAssignedToNestedInputSchema } from './TransactionUpdateManyWithoutAssignedToNestedInputSchema';
...
import { BankConnectionSettingsUpdateManyWithoutCreatorNestedInputSchema } from './BankConnectionSettingsUpdateManyWithoutCreatorNestedInputSchema';

export const UserUpdateWithoutInstalledIntegrationsInputSchema: z.ZodType<Prisma.UserUpdateWithoutInstalledIntegrationsInput> = z.object({
  ...
  utmTemplates: z.lazy(() => UtmTemplateUpdateManyWithoutUserNestedInputSchema).optional(),
  apps: z.lazy(() => AppUpdateManyWithoutUserNestedInputSchema).optional(),
  bankAccounts: z.lazy(() => BankAccountUpdateManyWithoutCreatorNestedInputSchema).optional(),
  Transaction: z.lazy(() => TransactionUpdateManyWithoutAssignedToNestedInputSchema).optional(),
  ...
  BankConnectionSettings: z.lazy(() => BankConnectionSettingsUpdateManyWithoutCreatorNestedInputSchema).optional()
}).strict();

export default UserUpdateWithoutInstalledIntegrationsInputSchema;
