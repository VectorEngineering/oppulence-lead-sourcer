...
export const DashboardUpdateOneWithoutLinkNestedInputSchema: z.ZodType<Prisma.DashboardUpdateOneWithoutLinkNestedInput> = z.object({
  create: z.union([ z.lazy(() => DashboardCreateWithoutLinkInputSchema),z.lazy(() => DashboardUncheckedCreateWithoutLinkInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => DashboardUpdateToOneWithWhereWithoutLinkInputSchema),z.lazy(() => DashboardUpdateWithoutLinkInputSchema),z.lazy(() => DashboardUncheckedUpdateWithoutLinkInputSchema) ]).optional(),
}).strict();

export default DashboardUpdateOneWithoutLinkNestedInputSchema;
