...
export const BankConnectionSettingsScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.BankConnectionSettingsScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => BankConnectionSettingsScalarWhereWithAggregatesInputSchema),z.lazy(() => BankConnectionSettingsScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => BankConnectionSettingsScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => BankConnectionSettingsScalarWhereWithAggregatesInputSchema),z.lazy(() => BankConnectionSettingsScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  syncEnabled: z.union([ z.lazy(() => BoolWithAggregatesFilterSchema),z.boolean() ]).optional(),
  syncStartTime: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  syncDayOfWeek: z.union([ z.lazy(() => IntNullableWithAggregatesFilterSchema),z.number() ]).optional().nullable(),
  syncDayOfMonth: z.union([ z.lazy(() => IntNullableWithAggregatesFilterSchema),z.number() ]).optional().nullable(),
  ...
  connectionStatus: z.union([ z.lazy(() => EnumConnectionStatusWithAggregatesFilterSchema),z.lazy(() => ConnectionStatusSchema) ]).optional(),
