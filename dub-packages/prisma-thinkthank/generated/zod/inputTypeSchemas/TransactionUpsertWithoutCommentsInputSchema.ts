...
export const TransactionUpsertWithoutCommentsInputSchema: z.ZodType<Prisma.TransactionUpsertWithoutCommentsInput> = z.object({
  update: z.union([ z.lazy(() => TransactionUpdateWithoutCommentsInputSchema),z.lazy(() => TransactionUncheckedUpdateWithoutCommentsInputSchema) ]),
