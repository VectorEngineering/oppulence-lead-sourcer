...
export const NestedEnumAccountTypeNullableWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumAccountTypeNullableWithAggregatesFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => AccountTypeSchema),z.lazy(() => NestedEnumAccountTypeNullableWithAggregatesFilterSchema) ]).optional().nullable(),
