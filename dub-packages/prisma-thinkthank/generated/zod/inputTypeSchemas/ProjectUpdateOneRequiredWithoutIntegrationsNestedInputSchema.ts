...
export const ProjectUpdateOneRequiredWithoutIntegrationsNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutIntegrationsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutIntegrationsInputSchema),z.lazy(() => ProjectUpdateWithoutIntegrationsInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutIntegrationsInputSchema) ]).optional(),
}).strict();
