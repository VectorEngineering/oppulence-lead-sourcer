...
export const UserUpsertWithoutRestrictedTokensInputSchema: z.ZodType<Prisma.UserUpsertWithoutRestrictedTokensInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutRestrictedTokensInputSchema),z.lazy(() => UserUncheckedUpdateWithoutRestrictedTokensInputSchema) ]),
  create: z.union([ z.lazy(() => UserCreateWithoutRestrictedTokensInputSchema),z.lazy(() => UserUncheckedCreateWithoutRestrictedTokensInputSchema) ]),
