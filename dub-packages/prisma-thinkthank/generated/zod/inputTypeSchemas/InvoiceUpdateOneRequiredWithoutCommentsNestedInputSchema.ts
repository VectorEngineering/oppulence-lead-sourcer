...
export const InvoiceUpdateOneRequiredWithoutCommentsNestedInputSchema: z.ZodType<Prisma.InvoiceUpdateOneRequiredWithoutCommentsNestedInput> = z.object({
  create: z.union([ z.lazy(() => InvoiceCreateWithoutCommentsInputSchema),z.lazy(() => InvoiceUncheckedCreateWithoutCommentsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => InvoiceUpdateToOneWithWhereWithoutCommentsInputSchema),z.lazy(() => InvoiceUpdateWithoutCommentsInputSchema),z.lazy(() => InvoiceUncheckedUpdateWithoutCommentsInputSchema) ]).optional(),
}).strict();
