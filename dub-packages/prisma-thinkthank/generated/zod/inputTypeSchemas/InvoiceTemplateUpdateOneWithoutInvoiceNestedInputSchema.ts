...
export const InvoiceTemplateUpdateOneWithoutInvoiceNestedInputSchema: z.ZodType<Prisma.InvoiceTemplateUpdateOneWithoutInvoiceNestedInput> = z.object({
  create: z.union([ z.lazy(() => InvoiceTemplateCreateWithoutInvoiceInputSchema),z.lazy(() => InvoiceTemplateUncheckedCreateWithoutInvoiceInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => InvoiceTemplateUpdateToOneWithWhereWithoutInvoiceInputSchema),z.lazy(() => InvoiceTemplateUpdateWithoutInvoiceInputSchema),z.lazy(() => InvoiceTemplateUncheckedUpdateWithoutInvoiceInputSchema) ]).optional(),
}).strict();
