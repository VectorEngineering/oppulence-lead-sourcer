...
import { TransactionAttachmentNullableRelationFilterSchema } from './TransactionAttachmentNullableRelationFilterSchema';
import { TransactionAttachmentWhereInputSchema } from './TransactionAttachmentWhereInputSchema';
import { TransactionNullableRelationFilterSchema } from './TransactionNullableRelationFilterSchema';
...
export const InboxWhereUniqueInputSchema: z.ZodType<Prisma.InboxWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => InboxWhereInputSchema),z.lazy(() => InboxWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => InboxWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => InboxWhereInputSchema),z.lazy(() => InboxWhereInputSchema).array() ]).optional(),
  name: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  originalName: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  description: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  type: z.union([ z.lazy(() => EnumInboxTypeNullableFilterSchema),z.lazy(() => InboxTypeSchema) ]).optional().nullable(),
  status: z.union([ z.lazy(() => EnumInboxStatusNullableFilterSchema),z.lazy(() => InboxStatusSchema) ]).optional().nullable(),
  ...
  fileExtension: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  size: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  contentType: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  checksum: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  compression: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  storageLocation: z.union([ z.lazy(() => EnumStorageLocationFilterSchema),z.lazy(() => StorageLocationSchema) ]).optional(),
  virusScanStatus: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  virusScanDate: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  securityFlags: z.lazy(() => JsonNullableFilterSchema).optional(),
  accessAttempts: z.lazy(() => JsonNullableFilterSchema).optional(),
  lastSecurityAudit: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  encryptionMethod: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  encryptionKeyId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  digitalSignature: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  certificateId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  folderId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  sortOrder: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  ...
  encryptionKey: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  maxAccessCount: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  ...
  retentionDate: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  legalHold: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  dispositionDate: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  archiveDate: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  purgeDate: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  ...
  taxAmount: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  totalAmount: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  ...
  lastValidated: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  lastBackupDate: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  processingStatus: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  workflow: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  ocrLanguage: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ocrConfidence: z.union([ z.lazy(() => FloatNullableFilterSchema),z.number() ]).optional().nullable(),
  ocrEngine: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  versionNotes: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  branchName: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  mergeHistory: z.lazy(() => JsonNullableFilterSchema).optional(),
  forwardedTo: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  forwardedBy: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  forwardedAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  sharedWith: z.lazy(() => JsonNullableFilterSchema).optional(),
  collaborators: z.lazy(() => JsonNullableFilterSchema).optional(),
  lockHolder: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  lockExpiresAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  lastModifiedBy: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  lastModifiedById: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  ...
  dataPrivacyLevel: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  regulatoryFlags: z.lazy(() => JsonNullableFilterSchema).optional(),
  auditTrail: z.lazy(() => JsonNullableFilterSchema).optional(),
  backupStatus: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  lastBackupId: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  recoveryPoint: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  backupLocation: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  project: z.union([ z.lazy(() => ProjectNullableRelationFilterSchema),z.lazy(() => ProjectWhereInputSchema) ]).optional().nullable(),
  attachment: z.union([ z.lazy(() => TransactionAttachmentNullableRelationFilterSchema),z.lazy(() => TransactionAttachmentWhereInputSchema) ]).optional().nullable(),
  transaction: z.union([ z.lazy(() => TransactionNullableRelationFilterSchema),z.lazy(() => TransactionWhereInputSchema) ]).optional().nullable(),
  parent: z.union([ z.lazy(() => InboxNullableRelationFilterSchema),z.lazy(() => InboxWhereInputSchema) ]).optional().nullable(),
...
export default InboxWhereUniqueInputSchema;
