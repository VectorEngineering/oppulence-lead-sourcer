...
export const BankConnectionUpsertWithoutBankAccountsInputSchema: z.ZodType<Prisma.BankConnectionUpsertWithoutBankAccountsInput> = z.object({
  update: z.union([ z.lazy(() => BankConnectionUpdateWithoutBankAccountsInputSchema),z.lazy(() => BankConnectionUncheckedUpdateWithoutBankAccountsInputSchema) ]),
  create: z.union([ z.lazy(() => BankConnectionCreateWithoutBankAccountsInputSchema),z.lazy(() => BankConnectionUncheckedCreateWithoutBankAccountsInputSchema) ]),
