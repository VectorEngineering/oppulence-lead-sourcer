...
export const NestedEnumTransactionMethodWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumTransactionMethodWithAggregatesFilter> = z.object({
  ...
  not: z.union([ z.lazy(() => TransactionMethodSchema),z.lazy(() => NestedEnumTransactionMethodWithAggregatesFilterSchema) ]).optional(),
