...
export const BankConnectionUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.BankConnectionUpsertWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => BankConnectionWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => BankConnectionUpdateWithoutProjectInputSchema),z.lazy(() => BankConnectionUncheckedUpdateWithoutProjectInputSchema) ]),
