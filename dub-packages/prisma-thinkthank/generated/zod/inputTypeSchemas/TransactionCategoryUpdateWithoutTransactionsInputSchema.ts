...
import { ProjectUpdateOneRequiredWithoutTransactionCategoryNestedInputSchema } from './ProjectUpdateOneRequiredWithoutTransactionCategoryNestedInputSchema';
import { TransactionCategoryUpdateOneWithoutChildrenNestedInputSchema } from './TransactionCategoryUpdateOneWithoutChildrenNestedInputSchema';
import { TransactionCategoryUpdateManyWithoutParentNestedInputSchema } from './TransactionCategoryUpdateManyWithoutParentNestedInputSchema';

export const TransactionCategoryUpdateWithoutTransactionsInputSchema: z.ZodType<Prisma.TransactionCategoryUpdateWithoutTransactionsInput> = z.object({
  ...
  project: z.lazy(() => ProjectUpdateOneRequiredWithoutTransactionCategoryNestedInputSchema).optional(),
  parent: z.lazy(() => TransactionCategoryUpdateOneWithoutChildrenNestedInputSchema).optional(),
  children: z.lazy(() => TransactionCategoryUpdateManyWithoutParentNestedInputSchema).optional()
}).strict();

export default TransactionCategoryUpdateWithoutTransactionsInputSchema;
