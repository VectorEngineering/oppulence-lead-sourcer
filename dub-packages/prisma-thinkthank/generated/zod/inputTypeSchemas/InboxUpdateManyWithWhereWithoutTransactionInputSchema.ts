...
export const InboxUpdateManyWithWhereWithoutTransactionInputSchema: z.ZodType<Prisma.InboxUpdateManyWithWhereWithoutTransactionInput> = z.object({
  where: z.lazy(() => InboxScalarWhereInputSchema),
  data: z.union([ z.lazy(() => InboxUpdateManyMutationInputSchema),z.lazy(() => InboxUncheckedUpdateManyWithoutTransactionInputSchema) ]),
}).strict();
