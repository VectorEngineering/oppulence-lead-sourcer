...
export const InstalledIntegrationUpsertWithWhereUniqueWithoutIntegrationInputSchema: z.ZodType<Prisma.InstalledIntegrationUpsertWithWhereUniqueWithoutIntegrationInput> = z.object({
  where: z.lazy(() => InstalledIntegrationWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => InstalledIntegrationUpdateWithoutIntegrationInputSchema),z.lazy(() => InstalledIntegrationUncheckedUpdateWithoutIntegrationInputSchema) ]),
  create: z.union([ z.lazy(() => InstalledIntegrationCreateWithoutIntegrationInputSchema),z.lazy(() => InstalledIntegrationUncheckedCreateWithoutIntegrationInputSchema) ]),
}).strict();
