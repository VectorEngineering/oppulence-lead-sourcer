...
export const TransactionUpdateOneRequiredWithoutHistoryNestedInputSchema: z.ZodType<Prisma.TransactionUpdateOneRequiredWithoutHistoryNestedInput> = z.object({
  create: z.union([ z.lazy(() => TransactionCreateWithoutHistoryInputSchema),z.lazy(() => TransactionUncheckedCreateWithoutHistoryInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => TransactionUpdateToOneWithWhereWithoutHistoryInputSchema),z.lazy(() => TransactionUpdateWithoutHistoryInputSchema),z.lazy(() => TransactionUncheckedUpdateWithoutHistoryInputSchema) ]).optional(),
}).strict();
