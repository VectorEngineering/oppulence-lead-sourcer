...
export const ReportAccessUpsertWithWhereUniqueWithoutReportInputSchema: z.ZodType<Prisma.ReportAccessUpsertWithWhereUniqueWithoutReportInput> = z.object({
  where: z.lazy(() => ReportAccessWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ReportAccessUpdateWithoutReportInputSchema),z.lazy(() => ReportAccessUncheckedUpdateWithoutReportInputSchema) ]),
