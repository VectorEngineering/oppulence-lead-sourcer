...
export const UtmTemplateUpdateWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.UtmTemplateUpdateWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => UtmTemplateWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => UtmTemplateUpdateWithoutUserInputSchema),z.lazy(() => UtmTemplateUncheckedUpdateWithoutUserInputSchema) ]),
}).strict();
