...
export const ProgramInviteUpsertWithoutLinkInputSchema: z.ZodType<Prisma.ProgramInviteUpsertWithoutLinkInput> = z.object({
  update: z.union([ z.lazy(() => ProgramInviteUpdateWithoutLinkInputSchema),z.lazy(() => ProgramInviteUncheckedUpdateWithoutLinkInputSchema) ]),
  create: z.union([ z.lazy(() => ProgramInviteCreateWithoutLinkInputSchema),z.lazy(() => ProgramInviteUncheckedCreateWithoutLinkInputSchema) ]),
