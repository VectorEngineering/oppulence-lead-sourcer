...
import { InvoiceCommentCreateNestedManyWithoutInvoiceInputSchema } from './InvoiceCommentCreateNestedManyWithoutInvoiceInputSchema';
...
import { InvoiceTemplateCreateNestedOneWithoutInvoiceInputSchema } from './InvoiceTemplateCreateNestedOneWithoutInvoiceInputSchema';

export const InvoiceCreateWithoutAttachmentsInputSchema: z.ZodType<Prisma.InvoiceCreateWithoutAttachmentsInput> = z.object({
  ...
  comments: z.lazy(() => InvoiceCommentCreateNestedManyWithoutInvoiceInputSchema).optional(),
  history: z.lazy(() => InvoiceHistoryCreateNestedManyWithoutInvoiceInputSchema).optional(),
  template: z.lazy(() => InvoiceTemplateCreateNestedOneWithoutInvoiceInputSchema).optional()
}).strict();

export default InvoiceCreateWithoutAttachmentsInputSchema;
