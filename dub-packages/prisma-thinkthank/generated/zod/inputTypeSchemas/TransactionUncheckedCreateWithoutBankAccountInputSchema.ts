...
import { TransactionAttachmentUncheckedCreateNestedManyWithoutTransactionInputSchema } from './TransactionAttachmentUncheckedCreateNestedManyWithoutTransactionInputSchema';
import { TagUncheckedCreateNestedManyWithoutTransactionInputSchema } from './TagUncheckedCreateNestedManyWithoutTransactionInputSchema';
import { TransactionCommentUncheckedCreateNestedManyWithoutTransactionInputSchema } from './TransactionCommentUncheckedCreateNestedManyWithoutTransactionInputSchema';
import { TransactionHistoryUncheckedCreateNestedManyWithoutTransactionInputSchema } from './TransactionHistoryUncheckedCreateNestedManyWithoutTransactionInputSchema';
import { TransactionReconciliationMatchUncheckedCreateNestedManyWithoutTransactionInputSchema } from './TransactionReconciliationMatchUncheckedCreateNestedManyWithoutTransactionInputSchema';
import { InboxUncheckedCreateNestedManyWithoutTransactionInputSchema } from './InboxUncheckedCreateNestedManyWithoutTransactionInputSchema';

export const TransactionUncheckedCreateWithoutBankAccountInputSchema: z.ZodType<Prisma.TransactionUncheckedCreateWithoutBankAccountInput> = z.object({
  ...
  projectId: z.string(),
  attachments: z.lazy(() => TransactionAttachmentUncheckedCreateNestedManyWithoutTransactionInputSchema).optional(),
  tags: z.lazy(() => TagUncheckedCreateNestedManyWithoutTransactionInputSchema).optional(),
  comments: z.lazy(() => TransactionCommentUncheckedCreateNestedManyWithoutTransactionInputSchema).optional(),
  history: z.lazy(() => TransactionHistoryUncheckedCreateNestedManyWithoutTransactionInputSchema).optional(),
  reconciliationMatches: z.lazy(() => TransactionReconciliationMatchUncheckedCreateNestedManyWithoutTransactionInputSchema).optional(),
  Inbox: z.lazy(() => InboxUncheckedCreateNestedManyWithoutTransactionInputSchema).optional()
}).strict();

export default TransactionUncheckedCreateWithoutBankAccountInputSchema;
