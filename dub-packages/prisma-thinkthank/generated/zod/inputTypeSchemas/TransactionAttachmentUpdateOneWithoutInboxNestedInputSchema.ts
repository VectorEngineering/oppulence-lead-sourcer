...
export const TransactionAttachmentUpdateOneWithoutInboxNestedInputSchema: z.ZodType<Prisma.TransactionAttachmentUpdateOneWithoutInboxNestedInput> = z.object({
  create: z.union([ z.lazy(() => TransactionAttachmentCreateWithoutInboxInputSchema),z.lazy(() => TransactionAttachmentUncheckedCreateWithoutInboxInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => TransactionAttachmentUpdateToOneWithWhereWithoutInboxInputSchema),z.lazy(() => TransactionAttachmentUpdateWithoutInboxInputSchema),z.lazy(() => TransactionAttachmentUncheckedUpdateWithoutInboxInputSchema) ]).optional(),
}).strict();
