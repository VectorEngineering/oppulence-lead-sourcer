...
export const BankAccountUpdateManyWithoutCreatorNestedInputSchema: z.ZodType<Prisma.BankAccountUpdateManyWithoutCreatorNestedInput> = z.object({
  create: z.union([ z.lazy(() => BankAccountCreateWithoutCreatorInputSchema),z.lazy(() => BankAccountCreateWithoutCreatorInputSchema).array(),z.lazy(() => BankAccountUncheckedCreateWithoutCreatorInputSchema),z.lazy(() => BankAccountUncheckedCreateWithoutCreatorInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => BankAccountCreateOrConnectWithoutCreatorInputSchema),z.lazy(() => BankAccountCreateOrConnectWithoutCreatorInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => BankAccountUpsertWithWhereUniqueWithoutCreatorInputSchema),z.lazy(() => BankAccountUpsertWithWhereUniqueWithoutCreatorInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => BankAccountUpdateWithWhereUniqueWithoutCreatorInputSchema),z.lazy(() => BankAccountUpdateWithWhereUniqueWithoutCreatorInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => BankAccountUpdateManyWithWhereWithoutCreatorInputSchema),z.lazy(() => BankAccountUpdateManyWithWhereWithoutCreatorInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => BankAccountScalarWhereInputSchema),z.lazy(() => BankAccountScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default BankAccountUpdateManyWithoutCreatorNestedInputSchema;
