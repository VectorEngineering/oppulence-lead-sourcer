...
export const TransactionCategoryUpdateManyWithoutParentNestedInputSchema: z.ZodType<Prisma.TransactionCategoryUpdateManyWithoutParentNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => TransactionCategoryUpsertWithWhereUniqueWithoutParentInputSchema),z.lazy(() => TransactionCategoryUpsertWithWhereUniqueWithoutParentInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => TransactionCategoryUpdateWithWhereUniqueWithoutParentInputSchema),z.lazy(() => TransactionCategoryUpdateWithWhereUniqueWithoutParentInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => TransactionCategoryUpdateManyWithWhereWithoutParentInputSchema),z.lazy(() => TransactionCategoryUpdateManyWithWhereWithoutParentInputSchema).array() ]).optional(),
...
export default TransactionCategoryUpdateManyWithoutParentNestedInputSchema;
