...
export const ReportColumnUncheckedUpdateManyWithoutReportInputSchema: z.ZodType<Prisma.ReportColumnUncheckedUpdateManyWithoutReportInput> = z.object({
  ...
  format: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
}).strict();

export default ReportColumnUncheckedUpdateManyWithoutReportInputSchema;
