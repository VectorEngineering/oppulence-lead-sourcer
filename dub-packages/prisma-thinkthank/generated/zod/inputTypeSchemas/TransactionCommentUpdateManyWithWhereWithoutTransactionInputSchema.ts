...
export const TransactionCommentUpdateManyWithWhereWithoutTransactionInputSchema: z.ZodType<Prisma.TransactionCommentUpdateManyWithWhereWithoutTransactionInput> = z.object({
  where: z.lazy(() => TransactionCommentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => TransactionCommentUpdateManyMutationInputSchema),z.lazy(() => TransactionCommentUncheckedUpdateManyWithoutTransactionInputSchema) ]),
}).strict();
