...
export const OAuthCodeUpdateManyWithWhereWithoutOAuthAppInputSchema: z.ZodType<Prisma.OAuthCodeUpdateManyWithWhereWithoutOAuthAppInput> = z.object({
  where: z.lazy(() => OAuthCodeScalarWhereInputSchema),
  data: z.union([ z.lazy(() => OAuthCodeUpdateManyMutationInputSchema),z.lazy(() => OAuthCodeUncheckedUpdateManyWithoutOAuthAppInputSchema) ]),
}).strict();
