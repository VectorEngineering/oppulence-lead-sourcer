...
export const ContractUpsertWithoutChildContractsInputSchema: z.ZodType<Prisma.ContractUpsertWithoutChildContractsInput> = z.object({
  update: z.union([ z.lazy(() => ContractUpdateWithoutChildContractsInputSchema),z.lazy(() => ContractUncheckedUpdateWithoutChildContractsInputSchema) ]),
  create: z.union([ z.lazy(() => ContractCreateWithoutChildContractsInputSchema),z.lazy(() => ContractUncheckedCreateWithoutChildContractsInputSchema) ]),
