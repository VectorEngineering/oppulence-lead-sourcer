...
export const LinkWebhookWhereUniqueInputSchema: z.ZodType<Prisma.LinkWebhookWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
...
.and(z.object({
  ...
  OR: z.lazy(() => LinkWebhookWhereInputSchema).array().optional(),
