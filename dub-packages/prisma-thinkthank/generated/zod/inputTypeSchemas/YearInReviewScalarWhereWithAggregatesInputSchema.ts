...
export const YearInReviewScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.YearInReviewScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => YearInReviewScalarWhereWithAggregatesInputSchema),z.lazy(() => YearInReviewScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => YearInReviewScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => YearInReviewScalarWhereWithAggregatesInputSchema),z.lazy(() => YearInReviewScalarWhereWithAggregatesInputSchema).array() ]).optional(),
