...
export const WebhookUpsertWithoutInstalledIntegrationInputSchema: z.ZodType<Prisma.WebhookUpsertWithoutInstalledIntegrationInput> = z.object({
  update: z.union([ z.lazy(() => WebhookUpdateWithoutInstalledIntegrationInputSchema),z.lazy(() => WebhookUncheckedUpdateWithoutInstalledIntegrationInputSchema) ]),
  create: z.union([ z.lazy(() => WebhookCreateWithoutInstalledIntegrationInputSchema),z.lazy(() => WebhookUncheckedCreateWithoutInstalledIntegrationInputSchema) ]),
