...
export const UserUpsertWithoutBankAccountsInputSchema: z.ZodType<Prisma.UserUpsertWithoutBankAccountsInput> = z.object({
  update: z.union([ z.lazy(() => UserUpdateWithoutBankAccountsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutBankAccountsInputSchema) ]),
  create: z.union([ z.lazy(() => UserCreateWithoutBankAccountsInputSchema),z.lazy(() => UserUncheckedCreateWithoutBankAccountsInputSchema) ]),
