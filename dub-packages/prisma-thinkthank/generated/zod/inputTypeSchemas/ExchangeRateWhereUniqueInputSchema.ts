...
export const ExchangeRateWhereUniqueInputSchema: z.ZodType<Prisma.ExchangeRateWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  ...
  targetCurrency: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
