...
export const TransactionUpsertWithoutReconciliationMatchesInputSchema: z.ZodType<Prisma.TransactionUpsertWithoutReconciliationMatchesInput> = z.object({
  update: z.union([ z.lazy(() => TransactionUpdateWithoutReconciliationMatchesInputSchema),z.lazy(() => TransactionUncheckedUpdateWithoutReconciliationMatchesInputSchema) ]),
  create: z.union([ z.lazy(() => TransactionCreateWithoutReconciliationMatchesInputSchema),z.lazy(() => TransactionUncheckedCreateWithoutReconciliationMatchesInputSchema) ]),
