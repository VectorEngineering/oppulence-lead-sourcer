...
export const TransactionAttachmentUpdateManyWithWhereWithoutTransactionInputSchema: z.ZodType<Prisma.TransactionAttachmentUpdateManyWithWhereWithoutTransactionInput> = z.object({
  where: z.lazy(() => TransactionAttachmentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => TransactionAttachmentUpdateManyMutationInputSchema),z.lazy(() => TransactionAttachmentUncheckedUpdateManyWithoutTransactionInputSchema) ]),
}).strict();
