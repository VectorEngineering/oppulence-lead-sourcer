...
export const ProgramEnrollmentUncheckedUpdateManyWithoutProgramNestedInputSchema: z.ZodType<Prisma.ProgramEnrollmentUncheckedUpdateManyWithoutProgramNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ProgramEnrollmentUpsertWithWhereUniqueWithoutProgramInputSchema),z.lazy(() => ProgramEnrollmentUpsertWithWhereUniqueWithoutProgramInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProgramEnrollmentUpdateWithWhereUniqueWithoutProgramInputSchema),z.lazy(() => ProgramEnrollmentUpdateWithWhereUniqueWithoutProgramInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProgramEnrollmentUpdateManyWithWhereWithoutProgramInputSchema),z.lazy(() => ProgramEnrollmentUpdateManyWithWhereWithoutProgramInputSchema).array() ]).optional(),
...
export default ProgramEnrollmentUncheckedUpdateManyWithoutProgramNestedInputSchema;
