...
export const TransactionCategoryUpdateWithWhereUniqueWithoutParentInputSchema: z.ZodType<Prisma.TransactionCategoryUpdateWithWhereUniqueWithoutParentInput> = z.object({
  where: z.lazy(() => TransactionCategoryWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => TransactionCategoryUpdateWithoutParentInputSchema),z.lazy(() => TransactionCategoryUncheckedUpdateWithoutParentInputSchema) ]),
}).strict();
