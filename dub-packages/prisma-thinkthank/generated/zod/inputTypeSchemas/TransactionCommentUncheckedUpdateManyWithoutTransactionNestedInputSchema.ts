...
export const TransactionCommentUncheckedUpdateManyWithoutTransactionNestedInputSchema: z.ZodType<Prisma.TransactionCommentUncheckedUpdateManyWithoutTransactionNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => TransactionCommentUpsertWithWhereUniqueWithoutTransactionInputSchema),z.lazy(() => TransactionCommentUpsertWithWhereUniqueWithoutTransactionInputSchema).array() ]).optional(),
  createMany: z.lazy(() => TransactionCommentCreateManyTransactionInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => TransactionCommentWhereUniqueInputSchema),z.lazy(() => TransactionCommentWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => TransactionCommentWhereUniqueInputSchema),z.lazy(() => TransactionCommentWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => TransactionCommentWhereUniqueInputSchema),z.lazy(() => TransactionCommentWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => TransactionCommentUpdateWithWhereUniqueWithoutTransactionInputSchema),z.lazy(() => TransactionCommentUpdateWithWhereUniqueWithoutTransactionInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => TransactionCommentUpdateManyWithWhereWithoutTransactionInputSchema),z.lazy(() => TransactionCommentUpdateManyWithWhereWithoutTransactionInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => TransactionCommentScalarWhereInputSchema),z.lazy(() => TransactionCommentScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default TransactionCommentUncheckedUpdateManyWithoutTransactionNestedInputSchema;
