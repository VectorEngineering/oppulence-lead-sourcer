...
export const ContractApprovalUpsertWithWhereUniqueWithoutContractInputSchema: z.ZodType<Prisma.ContractApprovalUpsertWithWhereUniqueWithoutContractInput> = z.object({
  where: z.lazy(() => ContractApprovalWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ContractApprovalUpdateWithoutContractInputSchema),z.lazy(() => ContractApprovalUncheckedUpdateWithoutContractInputSchema) ]),
  create: z.union([ z.lazy(() => ContractApprovalCreateWithoutContractInputSchema),z.lazy(() => ContractApprovalUncheckedCreateWithoutContractInputSchema) ]),
}).strict();
