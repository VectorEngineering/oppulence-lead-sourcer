...
export const ProjectInviteUpdateWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.ProjectInviteUpdateWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => ProjectInviteWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ProjectInviteUpdateWithoutProjectInputSchema),z.lazy(() => ProjectInviteUncheckedUpdateWithoutProjectInputSchema) ]),
}).strict();
