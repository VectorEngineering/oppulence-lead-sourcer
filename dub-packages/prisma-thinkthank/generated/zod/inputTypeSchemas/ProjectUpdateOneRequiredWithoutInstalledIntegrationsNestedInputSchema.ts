...
export const ProjectUpdateOneRequiredWithoutInstalledIntegrationsNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutInstalledIntegrationsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProjectCreateWithoutInstalledIntegrationsInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutInstalledIntegrationsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutInstalledIntegrationsInputSchema),z.lazy(() => ProjectUpdateWithoutInstalledIntegrationsInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutInstalledIntegrationsInputSchema) ]).optional(),
}).strict();
