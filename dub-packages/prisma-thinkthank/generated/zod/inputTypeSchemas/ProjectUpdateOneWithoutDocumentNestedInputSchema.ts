...
export const ProjectUpdateOneWithoutDocumentNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneWithoutDocumentNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProjectCreateWithoutDocumentInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutDocumentInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutDocumentInputSchema),z.lazy(() => ProjectUpdateWithoutDocumentInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutDocumentInputSchema) ]).optional(),
}).strict();
