...
export const InboxUpdateOneRequiredWithoutActivitiesNestedInputSchema: z.ZodType<Prisma.InboxUpdateOneRequiredWithoutActivitiesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => InboxUpdateToOneWithWhereWithoutActivitiesInputSchema),z.lazy(() => InboxUpdateWithoutActivitiesInputSchema),z.lazy(() => InboxUncheckedUpdateWithoutActivitiesInputSchema) ]).optional(),
}).strict();
