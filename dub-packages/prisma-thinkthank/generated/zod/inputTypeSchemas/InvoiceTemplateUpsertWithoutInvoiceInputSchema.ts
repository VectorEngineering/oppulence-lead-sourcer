...
export const InvoiceTemplateUpsertWithoutInvoiceInputSchema: z.ZodType<Prisma.InvoiceTemplateUpsertWithoutInvoiceInput> = z.object({
  update: z.union([ z.lazy(() => InvoiceTemplateUpdateWithoutInvoiceInputSchema),z.lazy(() => InvoiceTemplateUncheckedUpdateWithoutInvoiceInputSchema) ]),
  create: z.union([ z.lazy(() => InvoiceTemplateCreateWithoutInvoiceInputSchema),z.lazy(() => InvoiceTemplateUncheckedCreateWithoutInvoiceInputSchema) ]),
