...
export const ProjectUpsertWithoutBankAccountInputSchema: z.ZodType<Prisma.ProjectUpsertWithoutBankAccountInput> = z.object({
  update: z.union([ z.lazy(() => ProjectUpdateWithoutBankAccountInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutBankAccountInputSchema) ]),
  create: z.union([ z.lazy(() => ProjectCreateWithoutBankAccountInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutBankAccountInputSchema) ]),
