...
export const UtmTemplateUpsertWithWhereUniqueWithoutUserInputSchema: z.ZodType<Prisma.UtmTemplateUpsertWithWhereUniqueWithoutUserInput> = z.object({
  where: z.lazy(() => UtmTemplateWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => UtmTemplateUpdateWithoutUserInputSchema),z.lazy(() => UtmTemplateUncheckedUpdateWithoutUserInputSchema) ]),
