...
export const TransactionUpdateToOneWithWhereWithoutHistoryInputSchema: z.ZodType<Prisma.TransactionUpdateToOneWithWhereWithoutHistoryInput> = z.object({
  where: z.lazy(() => TransactionWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => TransactionUpdateWithoutHistoryInputSchema),z.lazy(() => TransactionUncheckedUpdateWithoutHistoryInputSchema) ]),
}).strict();
