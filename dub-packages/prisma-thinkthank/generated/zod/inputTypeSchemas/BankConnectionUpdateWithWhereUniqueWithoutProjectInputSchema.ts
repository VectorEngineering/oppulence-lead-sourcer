...
export const BankConnectionUpdateWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.BankConnectionUpdateWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => BankConnectionWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => BankConnectionUpdateWithoutProjectInputSchema),z.lazy(() => BankConnectionUncheckedUpdateWithoutProjectInputSchema) ]),
}).strict();
