...
export const LeadUpdateToOneWithWhereWithoutLeadFeedbackInputSchema: z.ZodType<Prisma.LeadUpdateToOneWithWhereWithoutLeadFeedbackInput> = z.object({
  where: z.lazy(() => LeadWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => LeadUpdateWithoutLeadFeedbackInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutLeadFeedbackInputSchema) ]),
}).strict();
