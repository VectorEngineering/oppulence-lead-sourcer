...
export const InstalledIntegrationUncheckedUpdateManyWithoutIntegrationNestedInputSchema: z.ZodType<Prisma.InstalledIntegrationUncheckedUpdateManyWithoutIntegrationNestedInput> = z.object({
  create: z.union([ z.lazy(() => InstalledIntegrationCreateWithoutIntegrationInputSchema),z.lazy(() => InstalledIntegrationCreateWithoutIntegrationInputSchema).array(),z.lazy(() => InstalledIntegrationUncheckedCreateWithoutIntegrationInputSchema),z.lazy(() => InstalledIntegrationUncheckedCreateWithoutIntegrationInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => InstalledIntegrationCreateOrConnectWithoutIntegrationInputSchema),z.lazy(() => InstalledIntegrationCreateOrConnectWithoutIntegrationInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => InstalledIntegrationUpsertWithWhereUniqueWithoutIntegrationInputSchema),z.lazy(() => InstalledIntegrationUpsertWithWhereUniqueWithoutIntegrationInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => InstalledIntegrationUpdateWithWhereUniqueWithoutIntegrationInputSchema),z.lazy(() => InstalledIntegrationUpdateWithWhereUniqueWithoutIntegrationInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => InstalledIntegrationUpdateManyWithWhereWithoutIntegrationInputSchema),z.lazy(() => InstalledIntegrationUpdateManyWithWhereWithoutIntegrationInputSchema).array() ]).optional(),
...
export default InstalledIntegrationUncheckedUpdateManyWithoutIntegrationNestedInputSchema;
