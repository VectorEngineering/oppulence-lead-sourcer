...
export const DealUpsertWithWhereUniqueWithoutAttachmentsInputSchema: z.ZodType<Prisma.DealUpsertWithWhereUniqueWithoutAttachmentsInput> = z.object({
  where: z.lazy(() => DealWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => DealUpdateWithoutAttachmentsInputSchema),z.lazy(() => DealUncheckedUpdateWithoutAttachmentsInputSchema) ]),
  create: z.union([ z.lazy(() => DealCreateWithoutAttachmentsInputSchema),z.lazy(() => DealUncheckedCreateWithoutAttachmentsInputSchema) ]),
}).strict();
