...
export const PipelineIntegrationScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.PipelineIntegrationScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => PipelineIntegrationScalarWhereWithAggregatesInputSchema),z.lazy(() => PipelineIntegrationScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => PipelineIntegrationScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => PipelineIntegrationScalarWhereWithAggregatesInputSchema),z.lazy(() => PipelineIntegrationScalarWhereWithAggregatesInputSchema).array() ]).optional(),
