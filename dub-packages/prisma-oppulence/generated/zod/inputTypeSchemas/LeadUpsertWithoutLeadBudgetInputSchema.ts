...
export const LeadUpsertWithoutLeadBudgetInputSchema: z.ZodType<Prisma.LeadUpsertWithoutLeadBudgetInput> = z.object({
  update: z.union([ z.lazy(() => LeadUpdateWithoutLeadBudgetInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutLeadBudgetInputSchema) ]),
  create: z.union([ z.lazy(() => LeadCreateWithoutLeadBudgetInputSchema),z.lazy(() => LeadUncheckedCreateWithoutLeadBudgetInputSchema) ]),
