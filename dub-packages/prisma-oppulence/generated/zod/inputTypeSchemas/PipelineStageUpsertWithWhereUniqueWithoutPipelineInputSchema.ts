...
export const PipelineStageUpsertWithWhereUniqueWithoutPipelineInputSchema: z.ZodType<Prisma.PipelineStageUpsertWithWhereUniqueWithoutPipelineInput> = z.object({
  where: z.lazy(() => PipelineStageWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => PipelineStageUpdateWithoutPipelineInputSchema),z.lazy(() => PipelineStageUncheckedUpdateWithoutPipelineInputSchema) ]),
  create: z.union([ z.lazy(() => PipelineStageCreateWithoutPipelineInputSchema),z.lazy(() => PipelineStageUncheckedCreateWithoutPipelineInputSchema) ]),
}).strict();
