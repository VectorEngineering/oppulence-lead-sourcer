...
export const PipelineStageUpsertWithoutDealsInputSchema: z.ZodType<Prisma.PipelineStageUpsertWithoutDealsInput> = z.object({
  update: z.union([ z.lazy(() => PipelineStageUpdateWithoutDealsInputSchema),z.lazy(() => PipelineStageUncheckedUpdateWithoutDealsInputSchema) ]),
