...
import { DealUpdateOneRequiredWithoutTasksNestedInputSchema } from './DealUpdateOneRequiredWithoutTasksNestedInputSchema';
import { UserUpdateOneWithoutDealTaskNestedInputSchema } from './UserUpdateOneWithoutDealTaskNestedInputSchema';

export const DealTaskUpdateInputSchema: z.ZodType<Prisma.DealTaskUpdateInput> = z.object({
  ...
  priority: z.union([ z.lazy(() => DealTaskPrioritySchema),z.lazy(() => NullableEnumDealTaskPriorityFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  deal: z.lazy(() => DealUpdateOneRequiredWithoutTasksNestedInputSchema).optional(),
  assignedTo: z.lazy(() => UserUpdateOneWithoutDealTaskNestedInputSchema).optional()
}).strict();

export default DealTaskUpdateInputSchema;
