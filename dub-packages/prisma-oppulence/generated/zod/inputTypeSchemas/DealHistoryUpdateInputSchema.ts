...
import { DealUpdateOneRequiredWithoutHistoryNestedInputSchema } from './DealUpdateOneRequiredWithoutHistoryNestedInputSchema';

export const DealHistoryUpdateInputSchema: z.ZodType<Prisma.DealHistoryUpdateInput> = z.object({
  ...
  deal: z.lazy(() => DealUpdateOneRequiredWithoutHistoryNestedInputSchema).optional()
}).strict();

export default DealHistoryUpdateInputSchema;
