...
export const LeadCompetitorUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadCompetitorUncheckedUpdateManyWithoutLeadNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LeadCompetitorUpsertWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadCompetitorUpsertWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LeadCompetitorCreateManyLeadInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => LeadCompetitorWhereUniqueInputSchema),z.lazy(() => LeadCompetitorWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => LeadCompetitorWhereUniqueInputSchema),z.lazy(() => LeadCompetitorWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => LeadCompetitorWhereUniqueInputSchema),z.lazy(() => LeadCompetitorWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => LeadCompetitorWhereUniqueInputSchema),z.lazy(() => LeadCompetitorWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => LeadCompetitorUpdateWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadCompetitorUpdateWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadCompetitorUpdateManyWithWhereWithoutLeadInputSchema),z.lazy(() => LeadCompetitorUpdateManyWithWhereWithoutLeadInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadCompetitorScalarWhereInputSchema),z.lazy(() => LeadCompetitorScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadCompetitorUncheckedUpdateManyWithoutLeadNestedInputSchema;
