...
export const LeadProductFitAssessmentUpdateManyWithWhereWithoutProductFitInputSchema: z.ZodType<Prisma.LeadProductFitAssessmentUpdateManyWithWhereWithoutProductFitInput> = z.object({
  where: z.lazy(() => LeadProductFitAssessmentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LeadProductFitAssessmentUpdateManyMutationInputSchema),z.lazy(() => LeadProductFitAssessmentUncheckedUpdateManyWithoutProductFitInputSchema) ]),
}).strict();
