...
export const LeadSegmentationHistoryUpsertWithWhereUniqueWithoutSegmentationInputSchema: z.ZodType<Prisma.LeadSegmentationHistoryUpsertWithWhereUniqueWithoutSegmentationInput> = z.object({
  where: z.lazy(() => LeadSegmentationHistoryWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LeadSegmentationHistoryUpdateWithoutSegmentationInputSchema),z.lazy(() => LeadSegmentationHistoryUncheckedUpdateWithoutSegmentationInputSchema) ]),
