...
import { LeadBudgetExpenseUncheckedCreateNestedManyWithoutBudgetInputSchema } from './LeadBudgetExpenseUncheckedCreateNestedManyWithoutBudgetInputSchema';

export const LeadBudgetUncheckedCreateWithoutRevisionsInputSchema: z.ZodType<Prisma.LeadBudgetUncheckedCreateWithoutRevisionsInput> = z.object({
  ...
  expenses: z.lazy(() => LeadBudgetExpenseUncheckedCreateNestedManyWithoutBudgetInputSchema).optional()
}).strict();

export default LeadBudgetUncheckedCreateWithoutRevisionsInputSchema;
