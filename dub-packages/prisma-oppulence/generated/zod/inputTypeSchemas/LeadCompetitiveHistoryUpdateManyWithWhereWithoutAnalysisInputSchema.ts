...
export const LeadCompetitiveHistoryUpdateManyWithWhereWithoutAnalysisInputSchema: z.ZodType<Prisma.LeadCompetitiveHistoryUpdateManyWithWhereWithoutAnalysisInput> = z.object({
  where: z.lazy(() => LeadCompetitiveHistoryScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LeadCompetitiveHistoryUpdateManyMutationInputSchema),z.lazy(() => LeadCompetitiveHistoryUncheckedUpdateManyWithoutAnalysisInputSchema) ]),
}).strict();
