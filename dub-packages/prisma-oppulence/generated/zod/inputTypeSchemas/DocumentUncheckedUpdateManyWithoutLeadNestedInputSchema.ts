...
export const DocumentUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.DocumentUncheckedUpdateManyWithoutLeadNestedInput> = z.object({
  create: z.union([ z.lazy(() => DocumentCreateWithoutLeadInputSchema),z.lazy(() => DocumentCreateWithoutLeadInputSchema).array(),z.lazy(() => DocumentUncheckedCreateWithoutLeadInputSchema),z.lazy(() => DocumentUncheckedCreateWithoutLeadInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => DocumentCreateOrConnectWithoutLeadInputSchema),z.lazy(() => DocumentCreateOrConnectWithoutLeadInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => DocumentUpsertWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => DocumentUpsertWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => DocumentUpdateWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => DocumentUpdateWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => DocumentUpdateManyWithWhereWithoutLeadInputSchema),z.lazy(() => DocumentUpdateManyWithWhereWithoutLeadInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => DocumentScalarWhereInputSchema),z.lazy(() => DocumentScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default DocumentUncheckedUpdateManyWithoutLeadNestedInputSchema;
