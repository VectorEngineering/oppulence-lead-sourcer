...
export const RegisteredDomainUpdateManyWithWhereWithoutProjectInputSchema: z.ZodType<Prisma.RegisteredDomainUpdateManyWithWhereWithoutProjectInput> = z.object({
  where: z.lazy(() => RegisteredDomainScalarWhereInputSchema),
  data: z.union([ z.lazy(() => RegisteredDomainUpdateManyMutationInputSchema),z.lazy(() => RegisteredDomainUncheckedUpdateManyWithoutProjectInputSchema) ]),
}).strict();
