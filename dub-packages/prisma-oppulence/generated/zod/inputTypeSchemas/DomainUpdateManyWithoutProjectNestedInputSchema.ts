...
export const DomainUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.DomainUpdateManyWithoutProjectNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => DomainUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => DomainUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => DomainUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => DomainUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => DomainUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => DomainUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => DomainScalarWhereInputSchema),z.lazy(() => DomainScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default DomainUpdateManyWithoutProjectNestedInputSchema;
