...
export const jackson_ttlWhereUniqueInputSchema: z.ZodType<Prisma.jackson_ttlWhereUniqueInput> = z.object({
  key: z.string()
})
.and(z.object({
  key: z.string().optional(),
  AND: z.union([ z.lazy(() => jackson_ttlWhereInputSchema),z.lazy(() => jackson_ttlWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => jackson_ttlWhereInputSchema).array().optional(),
