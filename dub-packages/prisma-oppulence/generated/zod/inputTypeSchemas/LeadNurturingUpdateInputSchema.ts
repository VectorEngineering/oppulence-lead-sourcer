...
import { LeadUpdateOneRequiredWithoutLeadNurturingNestedInputSchema } from './LeadUpdateOneRequiredWithoutLeadNurturingNestedInputSchema';

export const LeadNurturingUpdateInputSchema: z.ZodType<Prisma.LeadNurturingUpdateInput> = z.object({
  ...
  lastEngagement: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  lead: z.lazy(() => LeadUpdateOneRequiredWithoutLeadNurturingNestedInputSchema).optional()
}).strict();

export default LeadNurturingUpdateInputSchema;
