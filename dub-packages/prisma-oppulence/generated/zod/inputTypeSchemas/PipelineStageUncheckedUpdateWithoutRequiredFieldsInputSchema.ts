...
export const PipelineStageUncheckedUpdateWithoutRequiredFieldsInputSchema: z.ZodType<Prisma.PipelineStageUncheckedUpdateWithoutRequiredFieldsInput> = z.object({
  ...
  autoMoveAfterDays: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  nextStageId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export default PipelineStageUncheckedUpdateWithoutRequiredFieldsInputSchema;
