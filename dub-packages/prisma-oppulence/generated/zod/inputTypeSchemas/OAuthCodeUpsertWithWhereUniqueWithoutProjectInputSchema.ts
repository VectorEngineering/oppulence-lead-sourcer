...
export const OAuthCodeUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.OAuthCodeUpsertWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => OAuthCodeWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => OAuthCodeUpdateWithoutProjectInputSchema),z.lazy(() => OAuthCodeUncheckedUpdateWithoutProjectInputSchema) ]),
  create: z.union([ z.lazy(() => OAuthCodeCreateWithoutProjectInputSchema),z.lazy(() => OAuthCodeUncheckedCreateWithoutProjectInputSchema) ]),
}).strict();
