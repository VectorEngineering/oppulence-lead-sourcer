...
export const ContractTemplateScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ContractTemplateScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => ContractTemplateScalarWhereWithAggregatesInputSchema),z.lazy(() => ContractTemplateScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => ContractTemplateScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => ContractTemplateScalarWhereWithAggregatesInputSchema),z.lazy(() => ContractTemplateScalarWhereWithAggregatesInputSchema).array() ]).optional(),
