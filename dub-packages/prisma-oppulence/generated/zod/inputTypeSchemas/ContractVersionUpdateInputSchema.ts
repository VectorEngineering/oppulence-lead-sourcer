...
import { ContractUpdateOneRequiredWithoutContractVersionsNestedInputSchema } from './ContractUpdateOneRequiredWithoutContractVersionsNestedInputSchema';

export const ContractVersionUpdateInputSchema: z.ZodType<Prisma.ContractVersionUpdateInput> = z.object({
  ...
  contract: z.lazy(() => ContractUpdateOneRequiredWithoutContractVersionsNestedInputSchema).optional()
}).strict();

export default ContractVersionUpdateInputSchema;
