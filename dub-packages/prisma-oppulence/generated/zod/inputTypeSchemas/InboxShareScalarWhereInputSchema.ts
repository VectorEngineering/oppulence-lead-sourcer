...
export const InboxShareScalarWhereInputSchema: z.ZodType<Prisma.InboxShareScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => InboxShareScalarWhereInputSchema),z.lazy(() => InboxShareScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => InboxShareScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => InboxShareScalarWhereInputSchema),z.lazy(() => InboxShareScalarWhereInputSchema).array() ]).optional(),
...
export default InboxShareScalarWhereInputSchema;
