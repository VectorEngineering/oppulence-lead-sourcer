...
export const UserUpdateOneRequiredWithoutFinancialSettingsNestedInputSchema: z.ZodType<Prisma.UserUpdateOneRequiredWithoutFinancialSettingsNestedInput> = z.object({
  create: z.union([ z.lazy(() => UserCreateWithoutFinancialSettingsInputSchema),z.lazy(() => UserUncheckedCreateWithoutFinancialSettingsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => UserUpdateToOneWithWhereWithoutFinancialSettingsInputSchema),z.lazy(() => UserUpdateWithoutFinancialSettingsInputSchema),z.lazy(() => UserUncheckedUpdateWithoutFinancialSettingsInputSchema) ]).optional(),
}).strict();
