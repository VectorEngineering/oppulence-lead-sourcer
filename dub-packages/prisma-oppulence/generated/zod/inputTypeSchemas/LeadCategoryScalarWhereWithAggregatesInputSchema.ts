...
export const LeadCategoryScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadCategoryScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => LeadCategoryScalarWhereWithAggregatesInputSchema),z.lazy(() => LeadCategoryScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadCategoryScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LeadCategoryScalarWhereWithAggregatesInputSchema),z.lazy(() => LeadCategoryScalarWhereWithAggregatesInputSchema).array() ]).optional(),
