...
import { LeadComplianceHistoryUncheckedCreateNestedManyWithoutComplianceAuditInputSchema } from './LeadComplianceHistoryUncheckedCreateNestedManyWithoutComplianceAuditInputSchema';

export const LeadComplianceAuditUncheckedCreateWithoutLeadInputSchema: z.ZodType<Prisma.LeadComplianceAuditUncheckedCreateWithoutLeadInput> = z.object({
  ...
  auditHistory: z.lazy(() => LeadComplianceHistoryUncheckedCreateNestedManyWithoutComplianceAuditInputSchema).optional()
}).strict();

export default LeadComplianceAuditUncheckedCreateWithoutLeadInputSchema;
