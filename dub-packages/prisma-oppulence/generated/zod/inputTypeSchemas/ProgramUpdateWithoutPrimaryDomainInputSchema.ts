...
import { LinkUpdateManyWithoutProgramNestedInputSchema } from './LinkUpdateManyWithoutProgramNestedInputSchema';

export const ProgramUpdateWithoutPrimaryDomainInputSchema: z.ZodType<Prisma.ProgramUpdateWithoutPrimaryDomainInput> = z.object({
  ...
  links: z.lazy(() => LinkUpdateManyWithoutProgramNestedInputSchema).optional()
}).strict();

export default ProgramUpdateWithoutPrimaryDomainInputSchema;
