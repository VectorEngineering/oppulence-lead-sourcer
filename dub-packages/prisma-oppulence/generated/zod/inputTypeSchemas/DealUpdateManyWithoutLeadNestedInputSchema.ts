...
export const DealUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.DealUpdateManyWithoutLeadNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => DealUpsertWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => DealUpsertWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => DealUpdateWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => DealUpdateWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => DealUpdateManyWithWhereWithoutLeadInputSchema),z.lazy(() => DealUpdateManyWithWhereWithoutLeadInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => DealScalarWhereInputSchema),z.lazy(() => DealScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default DealUpdateManyWithoutLeadNestedInputSchema;
