...
export const LeadScoreCountOrderByAggregateInputSchema: z.ZodType<Prisma.LeadScoreCountOrderByAggregateInput> = z.object({
  ...
  mlFeatures: z.lazy(() => SortOrderSchema).optional(),
  confidenceScore: z.lazy(() => SortOrderSchema).optional()
}).strict();

export default LeadScoreCountOrderByAggregateInputSchema;
