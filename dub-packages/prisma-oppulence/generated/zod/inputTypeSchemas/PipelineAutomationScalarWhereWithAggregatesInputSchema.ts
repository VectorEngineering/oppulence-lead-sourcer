...
export const PipelineAutomationScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.PipelineAutomationScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => PipelineAutomationScalarWhereWithAggregatesInputSchema),z.lazy(() => PipelineAutomationScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => PipelineAutomationScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => PipelineAutomationScalarWhereWithAggregatesInputSchema),z.lazy(() => PipelineAutomationScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  actionType: z.union([ z.lazy(() => EnumAutomationActionTypeWithAggregatesFilterSchema),z.lazy(() => AutomationActionTypeSchema) ]).optional(),
