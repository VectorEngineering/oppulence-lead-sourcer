...
import { UserUpdateOneRequiredWithoutAiAssistantSettingsNestedInputSchema } from './UserUpdateOneRequiredWithoutAiAssistantSettingsNestedInputSchema';

export const AIAssistantSettingsUpdateInputSchema: z.ZodType<Prisma.AIAssistantSettingsUpdateInput> = z.object({
  ...
  user: z.lazy(() => UserUpdateOneRequiredWithoutAiAssistantSettingsNestedInputSchema).optional()
}).strict();

export default AIAssistantSettingsUpdateInputSchema;
