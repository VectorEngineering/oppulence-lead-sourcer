...
export const DealUpdateOneRequiredWithoutTasksNestedInputSchema: z.ZodType<Prisma.DealUpdateOneRequiredWithoutTasksNestedInput> = z.object({
  create: z.union([ z.lazy(() => DealCreateWithoutTasksInputSchema),z.lazy(() => DealUncheckedCreateWithoutTasksInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => DealUpdateToOneWithWhereWithoutTasksInputSchema),z.lazy(() => DealUpdateWithoutTasksInputSchema),z.lazy(() => DealUncheckedUpdateWithoutTasksInputSchema) ]).optional(),
}).strict();
