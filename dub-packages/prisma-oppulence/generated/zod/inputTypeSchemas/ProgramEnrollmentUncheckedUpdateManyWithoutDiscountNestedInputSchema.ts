...
export const ProgramEnrollmentUncheckedUpdateManyWithoutDiscountNestedInputSchema: z.ZodType<Prisma.ProgramEnrollmentUncheckedUpdateManyWithoutDiscountNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ProgramEnrollmentUpsertWithWhereUniqueWithoutDiscountInputSchema),z.lazy(() => ProgramEnrollmentUpsertWithWhereUniqueWithoutDiscountInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProgramEnrollmentUpdateWithWhereUniqueWithoutDiscountInputSchema),z.lazy(() => ProgramEnrollmentUpdateWithWhereUniqueWithoutDiscountInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProgramEnrollmentUpdateManyWithWhereWithoutDiscountInputSchema),z.lazy(() => ProgramEnrollmentUpdateManyWithWhereWithoutDiscountInputSchema).array() ]).optional(),
...
export default ProgramEnrollmentUncheckedUpdateManyWithoutDiscountNestedInputSchema;
