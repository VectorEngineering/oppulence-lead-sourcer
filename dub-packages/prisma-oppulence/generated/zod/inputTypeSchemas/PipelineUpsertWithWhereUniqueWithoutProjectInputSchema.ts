...
export const PipelineUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.PipelineUpsertWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => PipelineWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => PipelineUpdateWithoutProjectInputSchema),z.lazy(() => PipelineUncheckedUpdateWithoutProjectInputSchema) ]),
  create: z.union([ z.lazy(() => PipelineCreateWithoutProjectInputSchema),z.lazy(() => PipelineUncheckedCreateWithoutProjectInputSchema) ]),
}).strict();
