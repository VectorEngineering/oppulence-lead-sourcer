...
export const CampaignUpsertWithWhereUniqueWithoutTouchpointsInputSchema: z.ZodType<Prisma.CampaignUpsertWithWhereUniqueWithoutTouchpointsInput> = z.object({
  where: z.lazy(() => CampaignWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => CampaignUpdateWithoutTouchpointsInputSchema),z.lazy(() => CampaignUncheckedUpdateWithoutTouchpointsInputSchema) ]),
  create: z.union([ z.lazy(() => CampaignCreateWithoutTouchpointsInputSchema),z.lazy(() => CampaignUncheckedCreateWithoutTouchpointsInputSchema) ]),
}).strict();
