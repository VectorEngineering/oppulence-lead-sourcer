...
export const LeadUpdateOneRequiredWithoutCompanyDetailsNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutCompanyDetailsNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCreateWithoutCompanyDetailsInputSchema),z.lazy(() => LeadUncheckedCreateWithoutCompanyDetailsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateToOneWithWhereWithoutCompanyDetailsInputSchema),z.lazy(() => LeadUpdateWithoutCompanyDetailsInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutCompanyDetailsInputSchema) ]).optional(),
}).strict();
