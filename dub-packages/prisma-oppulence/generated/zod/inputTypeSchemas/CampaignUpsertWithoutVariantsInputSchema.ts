...
export const CampaignUpsertWithoutVariantsInputSchema: z.ZodType<Prisma.CampaignUpsertWithoutVariantsInput> = z.object({
  update: z.union([ z.lazy(() => CampaignUpdateWithoutVariantsInputSchema),z.lazy(() => CampaignUncheckedUpdateWithoutVariantsInputSchema) ]),
  create: z.union([ z.lazy(() => CampaignCreateWithoutVariantsInputSchema),z.lazy(() => CampaignUncheckedCreateWithoutVariantsInputSchema) ]),
