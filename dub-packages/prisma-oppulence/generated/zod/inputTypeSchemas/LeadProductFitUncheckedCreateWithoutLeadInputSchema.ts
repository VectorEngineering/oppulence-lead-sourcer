...
import { LeadProductFitAssessmentUncheckedCreateNestedManyWithoutProductFitInputSchema } from './LeadProductFitAssessmentUncheckedCreateNestedManyWithoutProductFitInputSchema';

export const LeadProductFitUncheckedCreateWithoutLeadInputSchema: z.ZodType<Prisma.LeadProductFitUncheckedCreateWithoutLeadInput> = z.object({
  ...
  assessments: z.lazy(() => LeadProductFitAssessmentUncheckedCreateNestedManyWithoutProductFitInputSchema).optional()
}).strict();

export default LeadProductFitUncheckedCreateWithoutLeadInputSchema;
