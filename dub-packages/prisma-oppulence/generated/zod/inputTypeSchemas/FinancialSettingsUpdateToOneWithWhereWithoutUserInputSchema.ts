...
export const FinancialSettingsUpdateToOneWithWhereWithoutUserInputSchema: z.ZodType<Prisma.FinancialSettingsUpdateToOneWithWhereWithoutUserInput> = z.object({
  where: z.lazy(() => FinancialSettingsWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => FinancialSettingsUpdateWithoutUserInputSchema),z.lazy(() => FinancialSettingsUncheckedUpdateWithoutUserInputSchema) ]),
}).strict();
