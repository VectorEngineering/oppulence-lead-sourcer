...
export const InvoiceCommentUpdateToOneWithWhereWithoutRepliesInputSchema: z.ZodType<Prisma.InvoiceCommentUpdateToOneWithWhereWithoutRepliesInput> = z.object({
  where: z.lazy(() => InvoiceCommentWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => InvoiceCommentUpdateWithoutRepliesInputSchema),z.lazy(() => InvoiceCommentUncheckedUpdateWithoutRepliesInputSchema) ]),
}).strict();
