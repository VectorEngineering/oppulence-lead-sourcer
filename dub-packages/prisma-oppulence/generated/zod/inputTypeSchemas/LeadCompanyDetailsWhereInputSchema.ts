...
export const LeadCompanyDetailsWhereInputSchema: z.ZodType<Prisma.LeadCompanyDetailsWhereInput> = z.object({
  ...
  employeeCount: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
  foundedYear: z.union([ z.lazy(() => IntNullableFilterSchema),z.number() ]).optional().nullable(),
...
export default LeadCompanyDetailsWhereInputSchema;
