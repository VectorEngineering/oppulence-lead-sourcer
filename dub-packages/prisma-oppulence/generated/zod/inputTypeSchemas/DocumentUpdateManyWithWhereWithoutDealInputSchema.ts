...
export const DocumentUpdateManyWithWhereWithoutDealInputSchema: z.ZodType<Prisma.DocumentUpdateManyWithWhereWithoutDealInput> = z.object({
  where: z.lazy(() => DocumentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => DocumentUpdateManyMutationInputSchema),z.lazy(() => DocumentUncheckedUpdateManyWithoutDealInputSchema) ]),
}).strict();
