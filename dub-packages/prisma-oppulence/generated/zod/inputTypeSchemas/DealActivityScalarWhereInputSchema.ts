...
export const DealActivityScalarWhereInputSchema: z.ZodType<Prisma.DealActivityScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => DealActivityScalarWhereInputSchema),z.lazy(() => DealActivityScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => DealActivityScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => DealActivityScalarWhereInputSchema),z.lazy(() => DealActivityScalarWhereInputSchema).array() ]).optional(),
