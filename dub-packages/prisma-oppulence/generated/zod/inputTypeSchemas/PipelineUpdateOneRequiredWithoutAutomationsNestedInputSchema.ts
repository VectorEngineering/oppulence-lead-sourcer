...
export const PipelineUpdateOneRequiredWithoutAutomationsNestedInputSchema: z.ZodType<Prisma.PipelineUpdateOneRequiredWithoutAutomationsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => PipelineUpdateToOneWithWhereWithoutAutomationsInputSchema),z.lazy(() => PipelineUpdateWithoutAutomationsInputSchema),z.lazy(() => PipelineUncheckedUpdateWithoutAutomationsInputSchema) ]).optional(),
}).strict();
