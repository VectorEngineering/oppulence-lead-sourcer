...
export const LeadPersonalDetailsUpdateOneWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadPersonalDetailsUpdateOneWithoutLeadNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LeadPersonalDetailsUpdateToOneWithWhereWithoutLeadInputSchema),z.lazy(() => LeadPersonalDetailsUpdateWithoutLeadInputSchema),z.lazy(() => LeadPersonalDetailsUncheckedUpdateWithoutLeadInputSchema) ]).optional(),
}).strict();

export default LeadPersonalDetailsUpdateOneWithoutLeadNestedInputSchema;
