...
import { LeadUpdateOneRequiredWithoutLeadProductFitNestedInputSchema } from './LeadUpdateOneRequiredWithoutLeadProductFitNestedInputSchema';
import { LeadProductFitAssessmentUpdateManyWithoutProductFitNestedInputSchema } from './LeadProductFitAssessmentUpdateManyWithoutProductFitNestedInputSchema';

export const LeadProductFitUpdateInputSchema: z.ZodType<Prisma.LeadProductFitUpdateInput> = z.object({
  ...
  integrationCosts: z.union([ z.number(),z.lazy(() => NullableFloatFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  lead: z.lazy(() => LeadUpdateOneRequiredWithoutLeadProductFitNestedInputSchema).optional(),
  assessments: z.lazy(() => LeadProductFitAssessmentUpdateManyWithoutProductFitNestedInputSchema).optional()
}).strict();

export default LeadProductFitUpdateInputSchema;
