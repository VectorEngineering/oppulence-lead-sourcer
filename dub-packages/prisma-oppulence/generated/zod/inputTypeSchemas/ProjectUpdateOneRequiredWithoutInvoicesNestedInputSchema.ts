...
export const ProjectUpdateOneRequiredWithoutInvoicesNestedInputSchema: z.ZodType<Prisma.ProjectUpdateOneRequiredWithoutInvoicesNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProjectCreateWithoutInvoicesInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutInvoicesInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ProjectUpdateToOneWithWhereWithoutInvoicesInputSchema),z.lazy(() => ProjectUpdateWithoutInvoicesInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutInvoicesInputSchema) ]).optional(),
}).strict();
