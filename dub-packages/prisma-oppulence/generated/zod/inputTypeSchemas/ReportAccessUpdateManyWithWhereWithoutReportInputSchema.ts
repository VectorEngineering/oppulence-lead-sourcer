...
export const ReportAccessUpdateManyWithWhereWithoutReportInputSchema: z.ZodType<Prisma.ReportAccessUpdateManyWithWhereWithoutReportInput> = z.object({
  where: z.lazy(() => ReportAccessScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ReportAccessUpdateManyMutationInputSchema),z.lazy(() => ReportAccessUncheckedUpdateManyWithoutReportInputSchema) ]),
}).strict();
