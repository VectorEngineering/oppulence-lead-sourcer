...
export const LeadBudgetExpenseUpdateManyWithoutBudgetNestedInputSchema: z.ZodType<Prisma.LeadBudgetExpenseUpdateManyWithoutBudgetNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LeadBudgetExpenseUpsertWithWhereUniqueWithoutBudgetInputSchema),z.lazy(() => LeadBudgetExpenseUpsertWithWhereUniqueWithoutBudgetInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LeadBudgetExpenseCreateManyBudgetInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => LeadBudgetExpenseWhereUniqueInputSchema),z.lazy(() => LeadBudgetExpenseWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => LeadBudgetExpenseWhereUniqueInputSchema),z.lazy(() => LeadBudgetExpenseWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => LeadBudgetExpenseWhereUniqueInputSchema),z.lazy(() => LeadBudgetExpenseWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadBudgetExpenseUpdateWithWhereUniqueWithoutBudgetInputSchema),z.lazy(() => LeadBudgetExpenseUpdateWithWhereUniqueWithoutBudgetInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadBudgetExpenseUpdateManyWithWhereWithoutBudgetInputSchema),z.lazy(() => LeadBudgetExpenseUpdateManyWithWhereWithoutBudgetInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadBudgetExpenseScalarWhereInputSchema),z.lazy(() => LeadBudgetExpenseScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadBudgetExpenseUpdateManyWithoutBudgetNestedInputSchema;
