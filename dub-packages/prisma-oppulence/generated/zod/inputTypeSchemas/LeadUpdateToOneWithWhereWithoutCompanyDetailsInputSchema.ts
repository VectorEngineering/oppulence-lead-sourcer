...
export const LeadUpdateToOneWithWhereWithoutCompanyDetailsInputSchema: z.ZodType<Prisma.LeadUpdateToOneWithWhereWithoutCompanyDetailsInput> = z.object({
  where: z.lazy(() => LeadWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => LeadUpdateWithoutCompanyDetailsInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutCompanyDetailsInputSchema) ]),
}).strict();
