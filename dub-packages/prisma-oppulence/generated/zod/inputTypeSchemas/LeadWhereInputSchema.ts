...
export const LeadWhereInputSchema: z.ZodType<Prisma.LeadWhereInput> = z.object({
  ...
  companyDetails: z.union([ z.lazy(() => LeadCompanyDetailsNullableRelationFilterSchema),z.lazy(() => LeadCompanyDetailsWhereInputSchema) ]).optional().nullable(),
  personalDetails: z.union([ z.lazy(() => LeadPersonalDetailsNullableRelationFilterSchema),z.lazy(() => LeadPersonalDetailsWhereInputSchema) ]).optional().nullable(),
