...
export const PipelineAutomationUpdateToOneWithWhereWithoutTriggersInputSchema: z.ZodType<Prisma.PipelineAutomationUpdateToOneWithWhereWithoutTriggersInput> = z.object({
  where: z.lazy(() => PipelineAutomationWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => PipelineAutomationUpdateWithoutTriggersInputSchema),z.lazy(() => PipelineAutomationUncheckedUpdateWithoutTriggersInputSchema) ]),
}).strict();
