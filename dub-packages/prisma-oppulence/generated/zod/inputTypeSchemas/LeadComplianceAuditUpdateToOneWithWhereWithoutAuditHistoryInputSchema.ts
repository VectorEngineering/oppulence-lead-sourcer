...
export const LeadComplianceAuditUpdateToOneWithWhereWithoutAuditHistoryInputSchema: z.ZodType<Prisma.LeadComplianceAuditUpdateToOneWithWhereWithoutAuditHistoryInput> = z.object({
  where: z.lazy(() => LeadComplianceAuditWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => LeadComplianceAuditUpdateWithoutAuditHistoryInputSchema),z.lazy(() => LeadComplianceAuditUncheckedUpdateWithoutAuditHistoryInputSchema) ]),
}).strict();
