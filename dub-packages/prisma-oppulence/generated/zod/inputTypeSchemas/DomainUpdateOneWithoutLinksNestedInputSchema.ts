...
export const DomainUpdateOneWithoutLinksNestedInputSchema: z.ZodType<Prisma.DomainUpdateOneWithoutLinksNestedInput> = z.object({
  create: z.union([ z.lazy(() => DomainCreateWithoutLinksInputSchema),z.lazy(() => DomainUncheckedCreateWithoutLinksInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => DomainUpdateToOneWithWhereWithoutLinksInputSchema),z.lazy(() => DomainUpdateWithoutLinksInputSchema),z.lazy(() => DomainUncheckedUpdateWithoutLinksInputSchema) ]).optional(),
}).strict();
