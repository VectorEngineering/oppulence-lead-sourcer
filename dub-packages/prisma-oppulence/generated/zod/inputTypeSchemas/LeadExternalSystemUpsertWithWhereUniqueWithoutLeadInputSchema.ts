...
export const LeadExternalSystemUpsertWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadExternalSystemUpsertWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadExternalSystemWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LeadExternalSystemUpdateWithoutLeadInputSchema),z.lazy(() => LeadExternalSystemUncheckedUpdateWithoutLeadInputSchema) ]),
  create: z.union([ z.lazy(() => LeadExternalSystemCreateWithoutLeadInputSchema),z.lazy(() => LeadExternalSystemUncheckedCreateWithoutLeadInputSchema) ]),
}).strict();
