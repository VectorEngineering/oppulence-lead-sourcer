...
export const DealTaskWhereUniqueInputSchema: z.ZodType<Prisma.DealTaskWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => DealTaskWhereInputSchema),z.lazy(() => DealTaskWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => DealTaskWhereInputSchema).array().optional(),
...
export default DealTaskWhereUniqueInputSchema;
