...
export const LeadUpdateOneRequiredWithoutLeadNurturingNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutLeadNurturingNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LeadUpdateToOneWithWhereWithoutLeadNurturingInputSchema),z.lazy(() => LeadUpdateWithoutLeadNurturingInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutLeadNurturingInputSchema) ]).optional(),
}).strict();
