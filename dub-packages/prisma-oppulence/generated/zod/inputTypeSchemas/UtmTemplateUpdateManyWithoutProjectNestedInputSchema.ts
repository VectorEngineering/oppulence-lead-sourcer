...
export const UtmTemplateUpdateManyWithoutProjectNestedInputSchema: z.ZodType<Prisma.UtmTemplateUpdateManyWithoutProjectNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => UtmTemplateUpsertWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => UtmTemplateUpsertWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => UtmTemplateUpdateWithWhereUniqueWithoutProjectInputSchema),z.lazy(() => UtmTemplateUpdateWithWhereUniqueWithoutProjectInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => UtmTemplateUpdateManyWithWhereWithoutProjectInputSchema),z.lazy(() => UtmTemplateUpdateManyWithWhereWithoutProjectInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => UtmTemplateScalarWhereInputSchema),z.lazy(() => UtmTemplateScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default UtmTemplateUpdateManyWithoutProjectNestedInputSchema;
