...
export const LeadHistoryUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadHistoryUpdateManyWithoutLeadNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LeadHistoryUpsertWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadHistoryUpsertWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LeadHistoryCreateManyLeadInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => LeadHistoryWhereUniqueInputSchema),z.lazy(() => LeadHistoryWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => LeadHistoryWhereUniqueInputSchema),z.lazy(() => LeadHistoryWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => LeadHistoryWhereUniqueInputSchema),z.lazy(() => LeadHistoryWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => LeadHistoryWhereUniqueInputSchema),z.lazy(() => LeadHistoryWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => LeadHistoryUpdateWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadHistoryUpdateWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadHistoryUpdateManyWithWhereWithoutLeadInputSchema),z.lazy(() => LeadHistoryUpdateManyWithWhereWithoutLeadInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadHistoryScalarWhereInputSchema),z.lazy(() => LeadHistoryScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadHistoryUpdateManyWithoutLeadNestedInputSchema;
