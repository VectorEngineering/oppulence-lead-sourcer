...
export const PipelineUpsertWithoutAutomationsInputSchema: z.ZodType<Prisma.PipelineUpsertWithoutAutomationsInput> = z.object({
  update: z.union([ z.lazy(() => PipelineUpdateWithoutAutomationsInputSchema),z.lazy(() => PipelineUncheckedUpdateWithoutAutomationsInputSchema) ]),
