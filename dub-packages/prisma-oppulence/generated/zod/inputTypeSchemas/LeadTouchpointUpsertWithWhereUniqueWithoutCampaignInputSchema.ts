...
export const LeadTouchpointUpsertWithWhereUniqueWithoutCampaignInputSchema: z.ZodType<Prisma.LeadTouchpointUpsertWithWhereUniqueWithoutCampaignInput> = z.object({
  where: z.lazy(() => LeadTouchpointWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LeadTouchpointUpdateWithoutCampaignInputSchema),z.lazy(() => LeadTouchpointUncheckedUpdateWithoutCampaignInputSchema) ]),
