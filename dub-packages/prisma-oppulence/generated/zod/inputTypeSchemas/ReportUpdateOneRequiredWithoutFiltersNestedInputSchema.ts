...
export const ReportUpdateOneRequiredWithoutFiltersNestedInputSchema: z.ZodType<Prisma.ReportUpdateOneRequiredWithoutFiltersNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ReportUpdateToOneWithWhereWithoutFiltersInputSchema),z.lazy(() => ReportUpdateWithoutFiltersInputSchema),z.lazy(() => ReportUncheckedUpdateWithoutFiltersInputSchema) ]).optional(),
}).strict();
