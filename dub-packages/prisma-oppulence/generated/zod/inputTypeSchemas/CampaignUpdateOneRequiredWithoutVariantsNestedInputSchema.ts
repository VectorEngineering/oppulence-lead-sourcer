...
export const CampaignUpdateOneRequiredWithoutVariantsNestedInputSchema: z.ZodType<Prisma.CampaignUpdateOneRequiredWithoutVariantsNestedInput> = z.object({
  create: z.union([ z.lazy(() => CampaignCreateWithoutVariantsInputSchema),z.lazy(() => CampaignUncheckedCreateWithoutVariantsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => CampaignUpdateToOneWithWhereWithoutVariantsInputSchema),z.lazy(() => CampaignUpdateWithoutVariantsInputSchema),z.lazy(() => CampaignUncheckedUpdateWithoutVariantsInputSchema) ]).optional(),
}).strict();
