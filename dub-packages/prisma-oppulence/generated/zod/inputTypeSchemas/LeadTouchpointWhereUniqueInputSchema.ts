...
export const LeadTouchpointWhereUniqueInputSchema: z.ZodType<Prisma.LeadTouchpointWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => LeadTouchpointWhereInputSchema),z.lazy(() => LeadTouchpointWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadTouchpointWhereInputSchema).array().optional(),
