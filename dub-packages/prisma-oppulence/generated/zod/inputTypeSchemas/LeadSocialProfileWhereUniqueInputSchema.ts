...
export const LeadSocialProfileWhereUniqueInputSchema: z.ZodType<Prisma.LeadSocialProfileWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => LeadSocialProfileWhereInputSchema),z.lazy(() => LeadSocialProfileWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadSocialProfileWhereInputSchema).array().optional(),
