...
export const LeadComplianceHistoryUpdateManyWithoutComplianceAuditNestedInputSchema: z.ZodType<Prisma.LeadComplianceHistoryUpdateManyWithoutComplianceAuditNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LeadComplianceHistoryUpsertWithWhereUniqueWithoutComplianceAuditInputSchema),z.lazy(() => LeadComplianceHistoryUpsertWithWhereUniqueWithoutComplianceAuditInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LeadComplianceHistoryCreateManyComplianceAuditInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => LeadComplianceHistoryWhereUniqueInputSchema),z.lazy(() => LeadComplianceHistoryWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => LeadComplianceHistoryWhereUniqueInputSchema),z.lazy(() => LeadComplianceHistoryWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => LeadComplianceHistoryWhereUniqueInputSchema),z.lazy(() => LeadComplianceHistoryWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadComplianceHistoryUpdateWithWhereUniqueWithoutComplianceAuditInputSchema),z.lazy(() => LeadComplianceHistoryUpdateWithWhereUniqueWithoutComplianceAuditInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadComplianceHistoryUpdateManyWithWhereWithoutComplianceAuditInputSchema),z.lazy(() => LeadComplianceHistoryUpdateManyWithWhereWithoutComplianceAuditInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadComplianceHistoryScalarWhereInputSchema),z.lazy(() => LeadComplianceHistoryScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadComplianceHistoryUpdateManyWithoutComplianceAuditNestedInputSchema;
