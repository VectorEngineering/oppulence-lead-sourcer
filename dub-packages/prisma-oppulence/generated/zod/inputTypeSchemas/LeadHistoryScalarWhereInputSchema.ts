...
export const LeadHistoryScalarWhereInputSchema: z.ZodType<Prisma.LeadHistoryScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => LeadHistoryScalarWhereInputSchema),z.lazy(() => LeadHistoryScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadHistoryScalarWhereInputSchema).array().optional(),
