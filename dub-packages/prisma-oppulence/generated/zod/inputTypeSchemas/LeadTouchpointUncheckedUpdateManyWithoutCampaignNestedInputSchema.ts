...
export const LeadTouchpointUncheckedUpdateManyWithoutCampaignNestedInputSchema: z.ZodType<Prisma.LeadTouchpointUncheckedUpdateManyWithoutCampaignNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LeadTouchpointUpsertWithWhereUniqueWithoutCampaignInputSchema),z.lazy(() => LeadTouchpointUpsertWithWhereUniqueWithoutCampaignInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadTouchpointUpdateWithWhereUniqueWithoutCampaignInputSchema),z.lazy(() => LeadTouchpointUpdateWithWhereUniqueWithoutCampaignInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadTouchpointUpdateManyWithWhereWithoutCampaignInputSchema),z.lazy(() => LeadTouchpointUpdateManyWithWhereWithoutCampaignInputSchema).array() ]).optional(),
...
export default LeadTouchpointUncheckedUpdateManyWithoutCampaignNestedInputSchema;
