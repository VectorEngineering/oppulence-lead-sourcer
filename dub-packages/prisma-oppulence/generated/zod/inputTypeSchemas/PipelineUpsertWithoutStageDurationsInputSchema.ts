...
export const PipelineUpsertWithoutStageDurationsInputSchema: z.ZodType<Prisma.PipelineUpsertWithoutStageDurationsInput> = z.object({
  update: z.union([ z.lazy(() => PipelineUpdateWithoutStageDurationsInputSchema),z.lazy(() => PipelineUncheckedUpdateWithoutStageDurationsInputSchema) ]),
  create: z.union([ z.lazy(() => PipelineCreateWithoutStageDurationsInputSchema),z.lazy(() => PipelineUncheckedCreateWithoutStageDurationsInputSchema) ]),
