...
export const DealUpdateOneRequiredWithoutHistoryNestedInputSchema: z.ZodType<Prisma.DealUpdateOneRequiredWithoutHistoryNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => DealUpdateToOneWithWhereWithoutHistoryInputSchema),z.lazy(() => DealUpdateWithoutHistoryInputSchema),z.lazy(() => DealUncheckedUpdateWithoutHistoryInputSchema) ]).optional(),
}).strict();
