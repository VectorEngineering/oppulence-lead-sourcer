...
export const LeadScoreHistoryWhereUniqueInputSchema: z.ZodType<Prisma.LeadScoreHistoryWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => LeadScoreHistoryWhereInputSchema),z.lazy(() => LeadScoreHistoryWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadScoreHistoryWhereInputSchema).array().optional(),
