...
import { LeadBudgetExpenseUpdateManyWithoutBudgetNestedInputSchema } from './LeadBudgetExpenseUpdateManyWithoutBudgetNestedInputSchema';

export const LeadBudgetUpdateWithoutRevisionsInputSchema: z.ZodType<Prisma.LeadBudgetUpdateWithoutRevisionsInput> = z.object({
  ...
  expenses: z.lazy(() => LeadBudgetExpenseUpdateManyWithoutBudgetNestedInputSchema).optional()
}).strict();

export default LeadBudgetUpdateWithoutRevisionsInputSchema;
