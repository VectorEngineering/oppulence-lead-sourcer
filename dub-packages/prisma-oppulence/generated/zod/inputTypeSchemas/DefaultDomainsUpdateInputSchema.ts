...
import { ProjectUpdateOneRequiredWithoutDefaultDomainsNestedInputSchema } from './ProjectUpdateOneRequiredWithoutDefaultDomainsNestedInputSchema';

export const DefaultDomainsUpdateInputSchema: z.ZodType<Prisma.DefaultDomainsUpdateInput> = z.object({
  ...
  project: z.lazy(() => ProjectUpdateOneRequiredWithoutDefaultDomainsNestedInputSchema).optional()
}).strict();

export default DefaultDomainsUpdateInputSchema;
