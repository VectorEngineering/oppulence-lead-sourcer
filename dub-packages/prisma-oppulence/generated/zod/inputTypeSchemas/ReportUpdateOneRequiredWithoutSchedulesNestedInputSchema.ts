...
export const ReportUpdateOneRequiredWithoutSchedulesNestedInputSchema: z.ZodType<Prisma.ReportUpdateOneRequiredWithoutSchedulesNestedInput> = z.object({
  create: z.union([ z.lazy(() => ReportCreateWithoutSchedulesInputSchema),z.lazy(() => ReportUncheckedCreateWithoutSchedulesInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ReportUpdateToOneWithWhereWithoutSchedulesInputSchema),z.lazy(() => ReportUpdateWithoutSchedulesInputSchema),z.lazy(() => ReportUncheckedUpdateWithoutSchedulesInputSchema) ]).optional(),
}).strict();
