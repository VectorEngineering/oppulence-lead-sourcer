...
export const LeadUpdateOneRequiredWithoutTimelinesNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutTimelinesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LeadUpdateToOneWithWhereWithoutTimelinesInputSchema),z.lazy(() => LeadUpdateWithoutTimelinesInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutTimelinesInputSchema) ]).optional(),
}).strict();
