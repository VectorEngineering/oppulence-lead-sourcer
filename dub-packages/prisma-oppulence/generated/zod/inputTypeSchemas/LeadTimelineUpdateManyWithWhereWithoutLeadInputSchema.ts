...
export const LeadTimelineUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadTimelineUpdateManyWithWhereWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadTimelineScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LeadTimelineUpdateManyMutationInputSchema),z.lazy(() => LeadTimelineUncheckedUpdateManyWithoutLeadInputSchema) ]),
}).strict();
