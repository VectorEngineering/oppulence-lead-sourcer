...
export const ProgramInviteUncheckedUpdateManyWithoutProgramNestedInputSchema: z.ZodType<Prisma.ProgramInviteUncheckedUpdateManyWithoutProgramNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => ProgramInviteUpsertWithWhereUniqueWithoutProgramInputSchema),z.lazy(() => ProgramInviteUpsertWithWhereUniqueWithoutProgramInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProgramInviteCreateManyProgramInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ProgramInviteWhereUniqueInputSchema),z.lazy(() => ProgramInviteWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ProgramInviteWhereUniqueInputSchema),z.lazy(() => ProgramInviteWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ProgramInviteWhereUniqueInputSchema),z.lazy(() => ProgramInviteWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => ProgramInviteWhereUniqueInputSchema),z.lazy(() => ProgramInviteWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ProgramInviteUpdateWithWhereUniqueWithoutProgramInputSchema),z.lazy(() => ProgramInviteUpdateWithWhereUniqueWithoutProgramInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProgramInviteUpdateManyWithWhereWithoutProgramInputSchema),z.lazy(() => ProgramInviteUpdateManyWithWhereWithoutProgramInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ProgramInviteScalarWhereInputSchema),z.lazy(() => ProgramInviteScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ProgramInviteUncheckedUpdateManyWithoutProgramNestedInputSchema;
