...
export const ProgramUpdateOneRequiredWithoutInvoicesNestedInputSchema: z.ZodType<Prisma.ProgramUpdateOneRequiredWithoutInvoicesNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => ProgramUpdateToOneWithWhereWithoutInvoicesInputSchema),z.lazy(() => ProgramUpdateWithoutInvoicesInputSchema),z.lazy(() => ProgramUncheckedUpdateWithoutInvoicesInputSchema) ]).optional(),
}).strict();
