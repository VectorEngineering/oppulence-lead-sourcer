...
export const CampaignUncheckedUpdateManyWithoutLeadsNestedInputSchema: z.ZodType<Prisma.CampaignUncheckedUpdateManyWithoutLeadsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => CampaignUpsertWithWhereUniqueWithoutLeadsInputSchema),z.lazy(() => CampaignUpsertWithWhereUniqueWithoutLeadsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => CampaignUpdateWithWhereUniqueWithoutLeadsInputSchema),z.lazy(() => CampaignUpdateWithWhereUniqueWithoutLeadsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => CampaignUpdateManyWithWhereWithoutLeadsInputSchema),z.lazy(() => CampaignUpdateManyWithWhereWithoutLeadsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => CampaignScalarWhereInputSchema),z.lazy(() => CampaignScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default CampaignUncheckedUpdateManyWithoutLeadsNestedInputSchema;
