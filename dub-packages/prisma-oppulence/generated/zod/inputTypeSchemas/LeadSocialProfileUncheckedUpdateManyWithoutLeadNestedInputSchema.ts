...
export const LeadSocialProfileUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadSocialProfileUncheckedUpdateManyWithoutLeadNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LeadSocialProfileUpsertWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadSocialProfileUpsertWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LeadSocialProfileCreateManyLeadInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => LeadSocialProfileWhereUniqueInputSchema),z.lazy(() => LeadSocialProfileWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => LeadSocialProfileWhereUniqueInputSchema),z.lazy(() => LeadSocialProfileWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => LeadSocialProfileWhereUniqueInputSchema),z.lazy(() => LeadSocialProfileWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadSocialProfileUpdateWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadSocialProfileUpdateWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadSocialProfileUpdateManyWithWhereWithoutLeadInputSchema),z.lazy(() => LeadSocialProfileUpdateManyWithWhereWithoutLeadInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadSocialProfileScalarWhereInputSchema),z.lazy(() => LeadSocialProfileScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadSocialProfileUncheckedUpdateManyWithoutLeadNestedInputSchema;
