...
import { UserUpdateOneWithoutLeadTaskNestedInputSchema } from './UserUpdateOneWithoutLeadTaskNestedInputSchema';
import { LeadUpdateOneRequiredWithoutLeadTasksNestedInputSchema } from './LeadUpdateOneRequiredWithoutLeadTasksNestedInputSchema';

export const LeadTaskUpdateInputSchema: z.ZodType<Prisma.LeadTaskUpdateInput> = z.object({
  ...
  assignedTo: z.lazy(() => UserUpdateOneWithoutLeadTaskNestedInputSchema).optional(),
  lead: z.lazy(() => LeadUpdateOneRequiredWithoutLeadTasksNestedInputSchema).optional()
}).strict();

export default LeadTaskUpdateInputSchema;
