...
export const RestrictedTokenUncheckedUpdateManyWithoutUserNestedInputSchema: z.ZodType<Prisma.RestrictedTokenUncheckedUpdateManyWithoutUserNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => RestrictedTokenUpsertWithWhereUniqueWithoutUserInputSchema),z.lazy(() => RestrictedTokenUpsertWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => RestrictedTokenUpdateWithWhereUniqueWithoutUserInputSchema),z.lazy(() => RestrictedTokenUpdateWithWhereUniqueWithoutUserInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => RestrictedTokenUpdateManyWithWhereWithoutUserInputSchema),z.lazy(() => RestrictedTokenUpdateManyWithWhereWithoutUserInputSchema).array() ]).optional(),
...
export default RestrictedTokenUncheckedUpdateManyWithoutUserNestedInputSchema;
