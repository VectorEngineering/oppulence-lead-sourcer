...
export const LeadBudgetUpsertWithoutRevisionsInputSchema: z.ZodType<Prisma.LeadBudgetUpsertWithoutRevisionsInput> = z.object({
  update: z.union([ z.lazy(() => LeadBudgetUpdateWithoutRevisionsInputSchema),z.lazy(() => LeadBudgetUncheckedUpdateWithoutRevisionsInputSchema) ]),
