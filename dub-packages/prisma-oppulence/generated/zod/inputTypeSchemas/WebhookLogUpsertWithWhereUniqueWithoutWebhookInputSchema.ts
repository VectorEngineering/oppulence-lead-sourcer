...
export const WebhookLogUpsertWithWhereUniqueWithoutWebhookInputSchema: z.ZodType<Prisma.WebhookLogUpsertWithWhereUniqueWithoutWebhookInput> = z.object({
  where: z.lazy(() => WebhookLogWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => WebhookLogUpdateWithoutWebhookInputSchema),z.lazy(() => WebhookLogUncheckedUpdateWithoutWebhookInputSchema) ]),
