...
export const DashboardUpdateWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.DashboardUpdateWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => DashboardWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => DashboardUpdateWithoutProjectInputSchema),z.lazy(() => DashboardUncheckedUpdateWithoutProjectInputSchema) ]),
}).strict();
