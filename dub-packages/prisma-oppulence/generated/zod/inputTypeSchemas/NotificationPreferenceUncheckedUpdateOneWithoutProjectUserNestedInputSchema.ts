...
export const NotificationPreferenceUncheckedUpdateOneWithoutProjectUserNestedInputSchema: z.ZodType<Prisma.NotificationPreferenceUncheckedUpdateOneWithoutProjectUserNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => NotificationPreferenceUpdateToOneWithWhereWithoutProjectUserInputSchema),z.lazy(() => NotificationPreferenceUpdateWithoutProjectUserInputSchema),z.lazy(() => NotificationPreferenceUncheckedUpdateWithoutProjectUserInputSchema) ]).optional(),
}).strict();

export default NotificationPreferenceUncheckedUpdateOneWithoutProjectUserNestedInputSchema;
