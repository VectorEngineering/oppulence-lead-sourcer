...
export const ReportUpdateManyWithoutCreatorNestedInputSchema: z.ZodType<Prisma.ReportUpdateManyWithoutCreatorNestedInput> = z.object({
  create: z.union([ z.lazy(() => ReportCreateWithoutCreatorInputSchema),z.lazy(() => ReportCreateWithoutCreatorInputSchema).array(),z.lazy(() => ReportUncheckedCreateWithoutCreatorInputSchema),z.lazy(() => ReportUncheckedCreateWithoutCreatorInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ReportCreateOrConnectWithoutCreatorInputSchema),z.lazy(() => ReportCreateOrConnectWithoutCreatorInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ReportUpsertWithWhereUniqueWithoutCreatorInputSchema),z.lazy(() => ReportUpsertWithWhereUniqueWithoutCreatorInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => ReportUpdateWithWhereUniqueWithoutCreatorInputSchema),z.lazy(() => ReportUpdateWithWhereUniqueWithoutCreatorInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ReportUpdateManyWithWhereWithoutCreatorInputSchema),z.lazy(() => ReportUpdateManyWithWhereWithoutCreatorInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ReportScalarWhereInputSchema),z.lazy(() => ReportScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default ReportUpdateManyWithoutCreatorNestedInputSchema;
