...
export const LeadTaskUncheckedUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadTaskUncheckedUpdateManyWithoutLeadNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadTaskCreateWithoutLeadInputSchema),z.lazy(() => LeadTaskCreateWithoutLeadInputSchema).array(),z.lazy(() => LeadTaskUncheckedCreateWithoutLeadInputSchema),z.lazy(() => LeadTaskUncheckedCreateWithoutLeadInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LeadTaskCreateOrConnectWithoutLeadInputSchema),z.lazy(() => LeadTaskCreateOrConnectWithoutLeadInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LeadTaskUpsertWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadTaskUpsertWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadTaskUpdateWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadTaskUpdateWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadTaskUpdateManyWithWhereWithoutLeadInputSchema),z.lazy(() => LeadTaskUpdateManyWithWhereWithoutLeadInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadTaskScalarWhereInputSchema),z.lazy(() => LeadTaskScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadTaskUncheckedUpdateManyWithoutLeadNestedInputSchema;
