...
export const NotificationPreferenceUpsertWithoutProjectUserInputSchema: z.ZodType<Prisma.NotificationPreferenceUpsertWithoutProjectUserInput> = z.object({
  update: z.union([ z.lazy(() => NotificationPreferenceUpdateWithoutProjectUserInputSchema),z.lazy(() => NotificationPreferenceUncheckedUpdateWithoutProjectUserInputSchema) ]),
  create: z.union([ z.lazy(() => NotificationPreferenceCreateWithoutProjectUserInputSchema),z.lazy(() => NotificationPreferenceUncheckedCreateWithoutProjectUserInputSchema) ]),
