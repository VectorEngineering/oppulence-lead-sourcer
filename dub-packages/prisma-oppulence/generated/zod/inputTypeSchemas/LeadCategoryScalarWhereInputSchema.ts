...
export const LeadCategoryScalarWhereInputSchema: z.ZodType<Prisma.LeadCategoryScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => LeadCategoryScalarWhereInputSchema),z.lazy(() => LeadCategoryScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadCategoryScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LeadCategoryScalarWhereInputSchema),z.lazy(() => LeadCategoryScalarWhereInputSchema).array() ]).optional(),
