...
export const LeadCommentUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadCommentUpdateManyWithWhereWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadCommentScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LeadCommentUpdateManyMutationInputSchema),z.lazy(() => LeadCommentUncheckedUpdateManyWithoutLeadInputSchema) ]),
}).strict();
