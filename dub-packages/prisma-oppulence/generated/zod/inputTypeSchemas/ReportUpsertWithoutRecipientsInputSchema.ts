...
export const ReportUpsertWithoutRecipientsInputSchema: z.ZodType<Prisma.ReportUpsertWithoutRecipientsInput> = z.object({
  update: z.union([ z.lazy(() => ReportUpdateWithoutRecipientsInputSchema),z.lazy(() => ReportUncheckedUpdateWithoutRecipientsInputSchema) ]),
  create: z.union([ z.lazy(() => ReportCreateWithoutRecipientsInputSchema),z.lazy(() => ReportUncheckedCreateWithoutRecipientsInputSchema) ]),
