...
export const LeadMetadataUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadMetadataUpdateManyWithWhereWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadMetadataScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LeadMetadataUpdateManyMutationInputSchema),z.lazy(() => LeadMetadataUncheckedUpdateManyWithoutLeadInputSchema) ]),
}).strict();
