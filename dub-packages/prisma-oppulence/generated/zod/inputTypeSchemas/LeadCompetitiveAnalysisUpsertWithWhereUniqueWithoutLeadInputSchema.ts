...
export const LeadCompetitiveAnalysisUpsertWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadCompetitiveAnalysisUpsertWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadCompetitiveAnalysisWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LeadCompetitiveAnalysisUpdateWithoutLeadInputSchema),z.lazy(() => LeadCompetitiveAnalysisUncheckedUpdateWithoutLeadInputSchema) ]),
  create: z.union([ z.lazy(() => LeadCompetitiveAnalysisCreateWithoutLeadInputSchema),z.lazy(() => LeadCompetitiveAnalysisUncheckedCreateWithoutLeadInputSchema) ]),
}).strict();
