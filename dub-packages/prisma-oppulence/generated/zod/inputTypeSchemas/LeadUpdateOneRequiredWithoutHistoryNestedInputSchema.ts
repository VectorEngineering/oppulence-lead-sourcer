...
export const LeadUpdateOneRequiredWithoutHistoryNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutHistoryNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LeadUpdateToOneWithWhereWithoutHistoryInputSchema),z.lazy(() => LeadUpdateWithoutHistoryInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutHistoryInputSchema) ]).optional(),
}).strict();
