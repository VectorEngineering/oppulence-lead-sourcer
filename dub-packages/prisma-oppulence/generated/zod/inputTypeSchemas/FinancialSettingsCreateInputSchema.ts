...
import { UserCreateNestedOneWithoutFinancialSettingsInputSchema } from './UserCreateNestedOneWithoutFinancialSettingsInputSchema';

export const FinancialSettingsCreateInputSchema: z.ZodType<Prisma.FinancialSettingsCreateInput> = z.object({
  ...
  user: z.lazy(() => UserCreateNestedOneWithoutFinancialSettingsInputSchema)
}).strict();

export default FinancialSettingsCreateInputSchema;
