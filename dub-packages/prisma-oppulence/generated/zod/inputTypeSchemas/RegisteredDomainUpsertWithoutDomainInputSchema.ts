...
export const RegisteredDomainUpsertWithoutDomainInputSchema: z.ZodType<Prisma.RegisteredDomainUpsertWithoutDomainInput> = z.object({
  update: z.union([ z.lazy(() => RegisteredDomainUpdateWithoutDomainInputSchema),z.lazy(() => RegisteredDomainUncheckedUpdateWithoutDomainInputSchema) ]),
  create: z.union([ z.lazy(() => RegisteredDomainCreateWithoutDomainInputSchema),z.lazy(() => RegisteredDomainUncheckedCreateWithoutDomainInputSchema) ]),
