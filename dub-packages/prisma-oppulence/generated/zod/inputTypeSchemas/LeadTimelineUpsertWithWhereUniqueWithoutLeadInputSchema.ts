...
export const LeadTimelineUpsertWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadTimelineUpsertWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadTimelineWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LeadTimelineUpdateWithoutLeadInputSchema),z.lazy(() => LeadTimelineUncheckedUpdateWithoutLeadInputSchema) ]),
  create: z.union([ z.lazy(() => LeadTimelineCreateWithoutLeadInputSchema),z.lazy(() => LeadTimelineUncheckedCreateWithoutLeadInputSchema) ]),
}).strict();
