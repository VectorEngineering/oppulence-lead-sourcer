...
export const PipelineAutomationScalarWhereInputSchema: z.ZodType<Prisma.PipelineAutomationScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => PipelineAutomationScalarWhereInputSchema),z.lazy(() => PipelineAutomationScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => PipelineAutomationScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => PipelineAutomationScalarWhereInputSchema),z.lazy(() => PipelineAutomationScalarWhereInputSchema).array() ]).optional(),
