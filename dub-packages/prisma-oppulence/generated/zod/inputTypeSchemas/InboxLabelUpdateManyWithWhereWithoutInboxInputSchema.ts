...
export const InboxLabelUpdateManyWithWhereWithoutInboxInputSchema: z.ZodType<Prisma.InboxLabelUpdateManyWithWhereWithoutInboxInput> = z.object({
  where: z.lazy(() => InboxLabelScalarWhereInputSchema),
  data: z.union([ z.lazy(() => InboxLabelUpdateManyMutationInputSchema),z.lazy(() => InboxLabelUncheckedUpdateManyWithoutInboxInputSchema) ]),
}).strict();
