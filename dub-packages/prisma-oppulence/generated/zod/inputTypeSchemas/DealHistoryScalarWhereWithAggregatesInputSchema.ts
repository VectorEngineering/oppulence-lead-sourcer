...
export const DealHistoryScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.DealHistoryScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => DealHistoryScalarWhereWithAggregatesInputSchema),z.lazy(() => DealHistoryScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => DealHistoryScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => DealHistoryScalarWhereWithAggregatesInputSchema),z.lazy(() => DealHistoryScalarWhereWithAggregatesInputSchema).array() ]).optional(),
