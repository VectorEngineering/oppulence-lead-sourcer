...
export const LeadSocialProfileUpdateWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadSocialProfileUpdateWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadSocialProfileWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadSocialProfileUpdateWithoutLeadInputSchema),z.lazy(() => LeadSocialProfileUncheckedUpdateWithoutLeadInputSchema) ]),
}).strict();
