...
export const DealTaskUpdateManyWithoutAssignedToNestedInputSchema: z.ZodType<Prisma.DealTaskUpdateManyWithoutAssignedToNestedInput> = z.object({
  create: z.union([ z.lazy(() => DealTaskCreateWithoutAssignedToInputSchema),z.lazy(() => DealTaskCreateWithoutAssignedToInputSchema).array(),z.lazy(() => DealTaskUncheckedCreateWithoutAssignedToInputSchema),z.lazy(() => DealTaskUncheckedCreateWithoutAssignedToInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => DealTaskCreateOrConnectWithoutAssignedToInputSchema),z.lazy(() => DealTaskCreateOrConnectWithoutAssignedToInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => DealTaskUpsertWithWhereUniqueWithoutAssignedToInputSchema),z.lazy(() => DealTaskUpsertWithWhereUniqueWithoutAssignedToInputSchema).array() ]).optional(),
  ...
  disconnect: z.union([ z.lazy(() => DealTaskWhereUniqueInputSchema),z.lazy(() => DealTaskWhereUniqueInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => DealTaskUpdateWithWhereUniqueWithoutAssignedToInputSchema),z.lazy(() => DealTaskUpdateWithWhereUniqueWithoutAssignedToInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => DealTaskUpdateManyWithWhereWithoutAssignedToInputSchema),z.lazy(() => DealTaskUpdateManyWithWhereWithoutAssignedToInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => DealTaskScalarWhereInputSchema),z.lazy(() => DealTaskScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default DealTaskUpdateManyWithoutAssignedToNestedInputSchema;
