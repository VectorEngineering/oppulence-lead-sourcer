...
export const LeadFeedbackScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadFeedbackScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => LeadFeedbackScalarWhereWithAggregatesInputSchema),z.lazy(() => LeadFeedbackScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadFeedbackScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LeadFeedbackScalarWhereWithAggregatesInputSchema),z.lazy(() => LeadFeedbackScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  ...
  followUpAssignee: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  followUpStatus: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  followUpNotes: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  status: z.union([ z.lazy(() => EnumFeedbackStatusWithAggregatesFilterSchema),z.lazy(() => FeedbackStatusSchema) ]).optional(),
  resolution: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
