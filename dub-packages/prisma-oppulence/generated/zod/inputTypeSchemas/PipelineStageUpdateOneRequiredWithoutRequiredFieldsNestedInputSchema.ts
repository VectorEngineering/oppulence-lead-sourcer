...
export const PipelineStageUpdateOneRequiredWithoutRequiredFieldsNestedInputSchema: z.ZodType<Prisma.PipelineStageUpdateOneRequiredWithoutRequiredFieldsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => PipelineStageUpdateToOneWithWhereWithoutRequiredFieldsInputSchema),z.lazy(() => PipelineStageUpdateWithoutRequiredFieldsInputSchema),z.lazy(() => PipelineStageUncheckedUpdateWithoutRequiredFieldsInputSchema) ]).optional(),
}).strict();
