...
export const UtmTemplateUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.UtmTemplateUpsertWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => UtmTemplateWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => UtmTemplateUpdateWithoutProjectInputSchema),z.lazy(() => UtmTemplateUncheckedUpdateWithoutProjectInputSchema) ]),
