...
export const LeadComplianceAuditUpdateWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadComplianceAuditUpdateWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadComplianceAuditWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadComplianceAuditUpdateWithoutLeadInputSchema),z.lazy(() => LeadComplianceAuditUncheckedUpdateWithoutLeadInputSchema) ]),
}).strict();
