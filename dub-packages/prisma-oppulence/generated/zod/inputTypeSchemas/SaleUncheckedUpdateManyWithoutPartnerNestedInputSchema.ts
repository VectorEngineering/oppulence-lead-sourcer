...
export const SaleUncheckedUpdateManyWithoutPartnerNestedInputSchema: z.ZodType<Prisma.SaleUncheckedUpdateManyWithoutPartnerNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => SaleUpsertWithWhereUniqueWithoutPartnerInputSchema),z.lazy(() => SaleUpsertWithWhereUniqueWithoutPartnerInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => SaleUpdateWithWhereUniqueWithoutPartnerInputSchema),z.lazy(() => SaleUpdateWithWhereUniqueWithoutPartnerInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => SaleUpdateManyWithWhereWithoutPartnerInputSchema),z.lazy(() => SaleUpdateManyWithWhereWithoutPartnerInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => SaleScalarWhereInputSchema),z.lazy(() => SaleScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default SaleUncheckedUpdateManyWithoutPartnerNestedInputSchema;
