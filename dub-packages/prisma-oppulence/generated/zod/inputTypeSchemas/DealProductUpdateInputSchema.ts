...
import { DealUpdateOneRequiredWithoutProductsNestedInputSchema } from './DealUpdateOneRequiredWithoutProductsNestedInputSchema';

export const DealProductUpdateInputSchema: z.ZodType<Prisma.DealProductUpdateInput> = z.object({
  ...
  deal: z.lazy(() => DealUpdateOneRequiredWithoutProductsNestedInputSchema).optional()
}).strict();

export default DealProductUpdateInputSchema;
