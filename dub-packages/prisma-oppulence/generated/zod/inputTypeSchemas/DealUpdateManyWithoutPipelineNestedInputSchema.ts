...
export const DealUpdateManyWithoutPipelineNestedInputSchema: z.ZodType<Prisma.DealUpdateManyWithoutPipelineNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => DealUpsertWithWhereUniqueWithoutPipelineInputSchema),z.lazy(() => DealUpsertWithWhereUniqueWithoutPipelineInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => DealUpdateWithWhereUniqueWithoutPipelineInputSchema),z.lazy(() => DealUpdateWithWhereUniqueWithoutPipelineInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => DealUpdateManyWithWhereWithoutPipelineInputSchema),z.lazy(() => DealUpdateManyWithWhereWithoutPipelineInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => DealScalarWhereInputSchema),z.lazy(() => DealScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default DealUpdateManyWithoutPipelineNestedInputSchema;
