...
export const LeadProductFitScalarWhereInputSchema: z.ZodType<Prisma.LeadProductFitScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => LeadProductFitScalarWhereInputSchema),z.lazy(() => LeadProductFitScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadProductFitScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LeadProductFitScalarWhereInputSchema),z.lazy(() => LeadProductFitScalarWhereInputSchema).array() ]).optional(),
