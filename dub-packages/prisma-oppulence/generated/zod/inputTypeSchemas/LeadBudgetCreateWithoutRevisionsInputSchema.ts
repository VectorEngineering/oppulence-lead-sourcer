...
import { LeadCreateNestedOneWithoutLeadBudgetInputSchema } from './LeadCreateNestedOneWithoutLeadBudgetInputSchema';
...
export const LeadBudgetCreateWithoutRevisionsInputSchema: z.ZodType<Prisma.LeadBudgetCreateWithoutRevisionsInput> = z.object({
  ...
  lead: z.lazy(() => LeadCreateNestedOneWithoutLeadBudgetInputSchema),
  expenses: z.lazy(() => LeadBudgetExpenseCreateNestedManyWithoutBudgetInputSchema).optional()
}).strict();

export default LeadBudgetCreateWithoutRevisionsInputSchema;
