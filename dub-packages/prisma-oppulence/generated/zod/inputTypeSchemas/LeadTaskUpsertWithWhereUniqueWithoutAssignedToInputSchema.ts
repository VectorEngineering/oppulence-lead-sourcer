...
export const LeadTaskUpsertWithWhereUniqueWithoutAssignedToInputSchema: z.ZodType<Prisma.LeadTaskUpsertWithWhereUniqueWithoutAssignedToInput> = z.object({
  where: z.lazy(() => LeadTaskWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LeadTaskUpdateWithoutAssignedToInputSchema),z.lazy(() => LeadTaskUncheckedUpdateWithoutAssignedToInputSchema) ]),
  create: z.union([ z.lazy(() => LeadTaskCreateWithoutAssignedToInputSchema),z.lazy(() => LeadTaskUncheckedCreateWithoutAssignedToInputSchema) ]),
}).strict();
