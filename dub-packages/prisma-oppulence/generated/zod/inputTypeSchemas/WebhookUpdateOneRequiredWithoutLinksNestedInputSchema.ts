...
export const WebhookUpdateOneRequiredWithoutLinksNestedInputSchema: z.ZodType<Prisma.WebhookUpdateOneRequiredWithoutLinksNestedInput> = z.object({
  create: z.union([ z.lazy(() => WebhookCreateWithoutLinksInputSchema),z.lazy(() => WebhookUncheckedCreateWithoutLinksInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => WebhookUpdateToOneWithWhereWithoutLinksInputSchema),z.lazy(() => WebhookUpdateWithoutLinksInputSchema),z.lazy(() => WebhookUncheckedUpdateWithoutLinksInputSchema) ]).optional(),
}).strict();
