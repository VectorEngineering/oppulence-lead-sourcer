...
export const LeadUpdateOneRequiredWithoutLeadFeedbackNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutLeadFeedbackNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCreateWithoutLeadFeedbackInputSchema),z.lazy(() => LeadUncheckedCreateWithoutLeadFeedbackInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateToOneWithWhereWithoutLeadFeedbackInputSchema),z.lazy(() => LeadUpdateWithoutLeadFeedbackInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutLeadFeedbackInputSchema) ]).optional(),
}).strict();
