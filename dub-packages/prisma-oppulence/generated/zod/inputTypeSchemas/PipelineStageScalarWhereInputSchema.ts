...
export const PipelineStageScalarWhereInputSchema: z.ZodType<Prisma.PipelineStageScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => PipelineStageScalarWhereInputSchema),z.lazy(() => PipelineStageScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => PipelineStageScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => PipelineStageScalarWhereInputSchema),z.lazy(() => PipelineStageScalarWhereInputSchema).array() ]).optional(),
