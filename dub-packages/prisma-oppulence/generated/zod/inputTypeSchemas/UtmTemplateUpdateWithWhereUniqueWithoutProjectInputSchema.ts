...
export const UtmTemplateUpdateWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.UtmTemplateUpdateWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => UtmTemplateWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => UtmTemplateUpdateWithoutProjectInputSchema),z.lazy(() => UtmTemplateUncheckedUpdateWithoutProjectInputSchema) ]),
}).strict();
