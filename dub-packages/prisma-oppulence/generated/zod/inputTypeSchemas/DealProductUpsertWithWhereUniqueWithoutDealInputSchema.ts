...
export const DealProductUpsertWithWhereUniqueWithoutDealInputSchema: z.ZodType<Prisma.DealProductUpsertWithWhereUniqueWithoutDealInput> = z.object({
  where: z.lazy(() => DealProductWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => DealProductUpdateWithoutDealInputSchema),z.lazy(() => DealProductUncheckedUpdateWithoutDealInputSchema) ]),
