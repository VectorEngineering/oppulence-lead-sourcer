...
export const DealUpsertWithoutCompetitorsInputSchema: z.ZodType<Prisma.DealUpsertWithoutCompetitorsInput> = z.object({
  update: z.union([ z.lazy(() => DealUpdateWithoutCompetitorsInputSchema),z.lazy(() => DealUncheckedUpdateWithoutCompetitorsInputSchema) ]),
  create: z.union([ z.lazy(() => DealCreateWithoutCompetitorsInputSchema),z.lazy(() => DealUncheckedCreateWithoutCompetitorsInputSchema) ]),
