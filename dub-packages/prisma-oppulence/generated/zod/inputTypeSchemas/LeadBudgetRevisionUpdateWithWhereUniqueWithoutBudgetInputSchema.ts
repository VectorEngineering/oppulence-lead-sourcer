...
export const LeadBudgetRevisionUpdateWithWhereUniqueWithoutBudgetInputSchema: z.ZodType<Prisma.LeadBudgetRevisionUpdateWithWhereUniqueWithoutBudgetInput> = z.object({
  where: z.lazy(() => LeadBudgetRevisionWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadBudgetRevisionUpdateWithoutBudgetInputSchema),z.lazy(() => LeadBudgetRevisionUncheckedUpdateWithoutBudgetInputSchema) ]),
}).strict();
