...
export const LeadBudgetExpenseWhereUniqueInputSchema: z.ZodType<Prisma.LeadBudgetExpenseWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => LeadBudgetExpenseWhereInputSchema),z.lazy(() => LeadBudgetExpenseWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadBudgetExpenseWhereInputSchema).array().optional(),
