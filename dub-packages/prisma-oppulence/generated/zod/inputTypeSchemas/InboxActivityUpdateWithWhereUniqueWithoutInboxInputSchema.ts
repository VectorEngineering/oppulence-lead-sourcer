...
export const InboxActivityUpdateWithWhereUniqueWithoutInboxInputSchema: z.ZodType<Prisma.InboxActivityUpdateWithWhereUniqueWithoutInboxInput> = z.object({
  where: z.lazy(() => InboxActivityWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => InboxActivityUpdateWithoutInboxInputSchema),z.lazy(() => InboxActivityUncheckedUpdateWithoutInboxInputSchema) ]),
}).strict();
