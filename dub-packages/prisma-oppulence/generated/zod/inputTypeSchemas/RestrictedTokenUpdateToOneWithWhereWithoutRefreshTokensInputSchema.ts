...
export const RestrictedTokenUpdateToOneWithWhereWithoutRefreshTokensInputSchema: z.ZodType<Prisma.RestrictedTokenUpdateToOneWithWhereWithoutRefreshTokensInput> = z.object({
  where: z.lazy(() => RestrictedTokenWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => RestrictedTokenUpdateWithoutRefreshTokensInputSchema),z.lazy(() => RestrictedTokenUncheckedUpdateWithoutRefreshTokensInputSchema) ]),
}).strict();
