...
export const ContractTemplateUpdateWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.ContractTemplateUpdateWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => ContractTemplateWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ContractTemplateUpdateWithoutProjectInputSchema),z.lazy(() => ContractTemplateUncheckedUpdateWithoutProjectInputSchema) ]),
}).strict();
