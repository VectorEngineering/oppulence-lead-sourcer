...
export const LeadCommentWhereUniqueInputSchema: z.ZodType<Prisma.LeadCommentWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => LeadCommentWhereInputSchema),z.lazy(() => LeadCommentWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadCommentWhereInputSchema).array().optional(),
