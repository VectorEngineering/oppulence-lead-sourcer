...
export const AutomationTriggerUpsertWithWhereUniqueWithoutAutomationInputSchema: z.ZodType<Prisma.AutomationTriggerUpsertWithWhereUniqueWithoutAutomationInput> = z.object({
  where: z.lazy(() => AutomationTriggerWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => AutomationTriggerUpdateWithoutAutomationInputSchema),z.lazy(() => AutomationTriggerUncheckedUpdateWithoutAutomationInputSchema) ]),
