...
export const LeadUpdateToOneWithWhereWithoutLeadSegmentationInputSchema: z.ZodType<Prisma.LeadUpdateToOneWithWhereWithoutLeadSegmentationInput> = z.object({
  where: z.lazy(() => LeadWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => LeadUpdateWithoutLeadSegmentationInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutLeadSegmentationInputSchema) ]),
}).strict();
