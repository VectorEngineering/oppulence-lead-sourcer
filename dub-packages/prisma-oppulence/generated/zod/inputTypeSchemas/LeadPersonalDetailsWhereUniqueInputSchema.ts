...
export const LeadPersonalDetailsWhereUniqueInputSchema: z.ZodType<Prisma.LeadPersonalDetailsWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    leadId: z.string()
  }),
...
.and(z.object({
  ...
  yearsInRole: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  yearsInCompany: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
