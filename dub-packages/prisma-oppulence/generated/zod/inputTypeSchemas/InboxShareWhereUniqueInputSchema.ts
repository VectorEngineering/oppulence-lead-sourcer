...
export const InboxShareWhereUniqueInputSchema: z.ZodType<Prisma.InboxShareWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  ...
  maxAccesses: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  ...
  deviceLimit: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
