...
export const PartnerInviteWhereUniqueInputSchema: z.ZodType<Prisma.PartnerInviteWhereUniqueInput> = z.object({
...
.and(z.object({
  ...
  OR: z.lazy(() => PartnerInviteWhereInputSchema).array().optional(),
