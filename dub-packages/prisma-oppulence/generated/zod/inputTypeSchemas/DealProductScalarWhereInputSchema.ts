...
export const DealProductScalarWhereInputSchema: z.ZodType<Prisma.DealProductScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => DealProductScalarWhereInputSchema),z.lazy(() => DealProductScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => DealProductScalarWhereInputSchema).array().optional(),
