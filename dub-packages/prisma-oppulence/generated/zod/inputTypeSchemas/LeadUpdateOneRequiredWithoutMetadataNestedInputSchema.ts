...
export const LeadUpdateOneRequiredWithoutMetadataNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutMetadataNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCreateWithoutMetadataInputSchema),z.lazy(() => LeadUncheckedCreateWithoutMetadataInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateToOneWithWhereWithoutMetadataInputSchema),z.lazy(() => LeadUpdateWithoutMetadataInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutMetadataInputSchema) ]).optional(),
}).strict();
