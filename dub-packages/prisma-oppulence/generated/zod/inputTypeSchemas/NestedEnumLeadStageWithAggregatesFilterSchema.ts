...
export const NestedEnumLeadStageWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumLeadStageWithAggregatesFilter> = z.object({
  equals: z.lazy(() => LeadStageSchema).optional(),
  in: z.lazy(() => LeadStageSchema).array().optional(),
  notIn: z.lazy(() => LeadStageSchema).array().optional(),
