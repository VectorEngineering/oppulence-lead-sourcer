...
export const ProgramApplicationWhereUniqueInputSchema: z.ZodType<Prisma.ProgramApplicationWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => ProgramApplicationWhereInputSchema),z.lazy(() => ProgramApplicationWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ProgramApplicationWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => ProgramApplicationWhereInputSchema),z.lazy(() => ProgramApplicationWhereInputSchema).array() ]).optional(),
  ...
  enrollment: z.union([ z.lazy(() => ProgramEnrollmentNullableRelationFilterSchema),z.lazy(() => ProgramEnrollmentWhereInputSchema) ]).optional().nullable(),
}).strict());
