...
export const ProjectUpsertWithoutYearInReviewsInputSchema: z.ZodType<Prisma.ProjectUpsertWithoutYearInReviewsInput> = z.object({
  update: z.union([ z.lazy(() => ProjectUpdateWithoutYearInReviewsInputSchema),z.lazy(() => ProjectUncheckedUpdateWithoutYearInReviewsInputSchema) ]),
  create: z.union([ z.lazy(() => ProjectCreateWithoutYearInReviewsInputSchema),z.lazy(() => ProjectUncheckedCreateWithoutYearInReviewsInputSchema) ]),
