...
export const LeadScoreUpdateToOneWithWhereWithoutScoreHistoryInputSchema: z.ZodType<Prisma.LeadScoreUpdateToOneWithWhereWithoutScoreHistoryInput> = z.object({
  where: z.lazy(() => LeadScoreWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => LeadScoreUpdateWithoutScoreHistoryInputSchema),z.lazy(() => LeadScoreUncheckedUpdateWithoutScoreHistoryInputSchema) ]),
}).strict();
