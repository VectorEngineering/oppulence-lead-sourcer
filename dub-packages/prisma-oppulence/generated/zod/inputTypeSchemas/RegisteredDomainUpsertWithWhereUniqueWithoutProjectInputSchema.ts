...
export const RegisteredDomainUpsertWithWhereUniqueWithoutProjectInputSchema: z.ZodType<Prisma.RegisteredDomainUpsertWithWhereUniqueWithoutProjectInput> = z.object({
  where: z.lazy(() => RegisteredDomainWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => RegisteredDomainUpdateWithoutProjectInputSchema),z.lazy(() => RegisteredDomainUncheckedUpdateWithoutProjectInputSchema) ]),
