...
export const LeadCommentUpdateWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadCommentUpdateWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadCommentWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => LeadCommentUpdateWithoutLeadInputSchema),z.lazy(() => LeadCommentUncheckedUpdateWithoutLeadInputSchema) ]),
}).strict();
