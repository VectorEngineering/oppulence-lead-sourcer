...
export const DealCompetitorUpsertWithWhereUniqueWithoutDealInputSchema: z.ZodType<Prisma.DealCompetitorUpsertWithWhereUniqueWithoutDealInput> = z.object({
  where: z.lazy(() => DealCompetitorWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => DealCompetitorUpdateWithoutDealInputSchema),z.lazy(() => DealCompetitorUncheckedUpdateWithoutDealInputSchema) ]),
