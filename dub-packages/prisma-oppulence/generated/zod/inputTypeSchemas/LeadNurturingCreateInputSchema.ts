...
import { LeadCreateNestedOneWithoutLeadNurturingInputSchema } from './LeadCreateNestedOneWithoutLeadNurturingInputSchema';

export const LeadNurturingCreateInputSchema: z.ZodType<Prisma.LeadNurturingCreateInput> = z.object({
  ...
  lead: z.lazy(() => LeadCreateNestedOneWithoutLeadNurturingInputSchema)
}).strict();

export default LeadNurturingCreateInputSchema;
