...
export const LeadUpdateManyWithoutCampaignNestedInputSchema: z.ZodType<Prisma.LeadUpdateManyWithoutCampaignNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCreateWithoutCampaignInputSchema),z.lazy(() => LeadCreateWithoutCampaignInputSchema).array(),z.lazy(() => LeadUncheckedCreateWithoutCampaignInputSchema),z.lazy(() => LeadUncheckedCreateWithoutCampaignInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LeadCreateOrConnectWithoutCampaignInputSchema),z.lazy(() => LeadCreateOrConnectWithoutCampaignInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LeadUpsertWithWhereUniqueWithoutCampaignInputSchema),z.lazy(() => LeadUpsertWithWhereUniqueWithoutCampaignInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateWithWhereUniqueWithoutCampaignInputSchema),z.lazy(() => LeadUpdateWithWhereUniqueWithoutCampaignInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadUpdateManyWithWhereWithoutCampaignInputSchema),z.lazy(() => LeadUpdateManyWithWhereWithoutCampaignInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadScalarWhereInputSchema),z.lazy(() => LeadScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadUpdateManyWithoutCampaignNestedInputSchema;
