...
export const LeadUncheckedUpdateManyWithoutAttachmentsNestedInputSchema: z.ZodType<Prisma.LeadUncheckedUpdateManyWithoutAttachmentsNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LeadUpsertWithWhereUniqueWithoutAttachmentsInputSchema),z.lazy(() => LeadUpsertWithWhereUniqueWithoutAttachmentsInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateWithWhereUniqueWithoutAttachmentsInputSchema),z.lazy(() => LeadUpdateWithWhereUniqueWithoutAttachmentsInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadUpdateManyWithWhereWithoutAttachmentsInputSchema),z.lazy(() => LeadUpdateManyWithWhereWithoutAttachmentsInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadScalarWhereInputSchema),z.lazy(() => LeadScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadUncheckedUpdateManyWithoutAttachmentsNestedInputSchema;
