...
export const AutomationConditionUpdateWithWhereUniqueWithoutAutomationInputSchema: z.ZodType<Prisma.AutomationConditionUpdateWithWhereUniqueWithoutAutomationInput> = z.object({
  where: z.lazy(() => AutomationConditionWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => AutomationConditionUpdateWithoutAutomationInputSchema),z.lazy(() => AutomationConditionUncheckedUpdateWithoutAutomationInputSchema) ]),
}).strict();
