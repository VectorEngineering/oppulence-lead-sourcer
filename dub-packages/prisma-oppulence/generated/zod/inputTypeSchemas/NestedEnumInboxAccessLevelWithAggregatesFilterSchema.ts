...
export const NestedEnumInboxAccessLevelWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumInboxAccessLevelWithAggregatesFilter> = z.object({
  equals: z.lazy(() => InboxAccessLevelSchema).optional(),
  in: z.lazy(() => InboxAccessLevelSchema).array().optional(),
  notIn: z.lazy(() => InboxAccessLevelSchema).array().optional(),
