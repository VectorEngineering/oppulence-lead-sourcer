...
export const LeadTaskUpdateManyWithWhereWithoutLeadInputSchema: z.ZodType<Prisma.LeadTaskUpdateManyWithWhereWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadTaskScalarWhereInputSchema),
  data: z.union([ z.lazy(() => LeadTaskUpdateManyMutationInputSchema),z.lazy(() => LeadTaskUncheckedUpdateManyWithoutLeadInputSchema) ]),
}).strict();
