...
export const LeadUpdateOneRequiredWithoutExternalSystemsNestedInputSchema: z.ZodType<Prisma.LeadUpdateOneRequiredWithoutExternalSystemsNestedInput> = z.object({
  ...
  update: z.union([ z.lazy(() => LeadUpdateToOneWithWhereWithoutExternalSystemsInputSchema),z.lazy(() => LeadUpdateWithoutExternalSystemsInputSchema),z.lazy(() => LeadUncheckedUpdateWithoutExternalSystemsInputSchema) ]).optional(),
}).strict();
