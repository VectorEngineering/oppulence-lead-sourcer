...
export const LeadExternalSystemScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LeadExternalSystemScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => LeadExternalSystemScalarWhereWithAggregatesInputSchema),z.lazy(() => LeadExternalSystemScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => LeadExternalSystemScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => LeadExternalSystemScalarWhereWithAggregatesInputSchema),z.lazy(() => LeadExternalSystemScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  leadId: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  provider: z.union([ z.lazy(() => EnumLeadExternalSystemProviderWithAggregatesFilterSchema),z.lazy(() => LeadExternalSystemProviderSchema) ]).optional(),
