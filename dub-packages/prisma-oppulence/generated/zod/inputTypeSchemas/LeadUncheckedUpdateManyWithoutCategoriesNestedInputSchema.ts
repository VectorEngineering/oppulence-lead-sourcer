...
export const LeadUncheckedUpdateManyWithoutCategoriesNestedInputSchema: z.ZodType<Prisma.LeadUncheckedUpdateManyWithoutCategoriesNestedInput> = z.object({
  create: z.union([ z.lazy(() => LeadCreateWithoutCategoriesInputSchema),z.lazy(() => LeadCreateWithoutCategoriesInputSchema).array(),z.lazy(() => LeadUncheckedCreateWithoutCategoriesInputSchema),z.lazy(() => LeadUncheckedCreateWithoutCategoriesInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => LeadCreateOrConnectWithoutCategoriesInputSchema),z.lazy(() => LeadCreateOrConnectWithoutCategoriesInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => LeadUpsertWithWhereUniqueWithoutCategoriesInputSchema),z.lazy(() => LeadUpsertWithWhereUniqueWithoutCategoriesInputSchema).array() ]).optional(),
  ...
  update: z.union([ z.lazy(() => LeadUpdateWithWhereUniqueWithoutCategoriesInputSchema),z.lazy(() => LeadUpdateWithWhereUniqueWithoutCategoriesInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadUpdateManyWithWhereWithoutCategoriesInputSchema),z.lazy(() => LeadUpdateManyWithWhereWithoutCategoriesInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadScalarWhereInputSchema),z.lazy(() => LeadScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadUncheckedUpdateManyWithoutCategoriesNestedInputSchema;
