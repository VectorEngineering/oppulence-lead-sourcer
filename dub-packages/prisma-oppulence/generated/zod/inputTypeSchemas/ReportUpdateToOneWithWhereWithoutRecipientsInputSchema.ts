...
export const ReportUpdateToOneWithWhereWithoutRecipientsInputSchema: z.ZodType<Prisma.ReportUpdateToOneWithWhereWithoutRecipientsInput> = z.object({
  where: z.lazy(() => ReportWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ReportUpdateWithoutRecipientsInputSchema),z.lazy(() => ReportUncheckedUpdateWithoutRecipientsInputSchema) ]),
}).strict();
