...
export const LeadCompetitorUpsertWithWhereUniqueWithoutLeadInputSchema: z.ZodType<Prisma.LeadCompetitorUpsertWithWhereUniqueWithoutLeadInput> = z.object({
  where: z.lazy(() => LeadCompetitorWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => LeadCompetitorUpdateWithoutLeadInputSchema),z.lazy(() => LeadCompetitorUncheckedUpdateWithoutLeadInputSchema) ]),
