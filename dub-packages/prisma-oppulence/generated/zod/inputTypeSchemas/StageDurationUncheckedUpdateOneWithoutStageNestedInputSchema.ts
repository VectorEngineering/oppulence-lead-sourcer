...
export const StageDurationUncheckedUpdateOneWithoutStageNestedInputSchema: z.ZodType<Prisma.StageDurationUncheckedUpdateOneWithoutStageNestedInput> = z.object({
  create: z.union([ z.lazy(() => StageDurationCreateWithoutStageInputSchema),z.lazy(() => StageDurationUncheckedCreateWithoutStageInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => StageDurationUpdateToOneWithWhereWithoutStageInputSchema),z.lazy(() => StageDurationUpdateWithoutStageInputSchema),z.lazy(() => StageDurationUncheckedUpdateWithoutStageInputSchema) ]).optional(),
}).strict();

export default StageDurationUncheckedUpdateOneWithoutStageNestedInputSchema;
