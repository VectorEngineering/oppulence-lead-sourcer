...
export const PipelineAccessRuleWhereUniqueInputSchema: z.ZodType<Prisma.PipelineAccessRuleWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => PipelineAccessRuleWhereInputSchema),z.lazy(() => PipelineAccessRuleWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => PipelineAccessRuleWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => PipelineAccessRuleWhereInputSchema),z.lazy(() => PipelineAccessRuleWhereInputSchema).array() ]).optional(),
...
export default PipelineAccessRuleWhereUniqueInputSchema;
