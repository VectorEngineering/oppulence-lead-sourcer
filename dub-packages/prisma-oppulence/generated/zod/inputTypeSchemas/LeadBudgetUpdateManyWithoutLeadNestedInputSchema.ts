...
export const LeadBudgetUpdateManyWithoutLeadNestedInputSchema: z.ZodType<Prisma.LeadBudgetUpdateManyWithoutLeadNestedInput> = z.object({
  ...
  upsert: z.union([ z.lazy(() => LeadBudgetUpsertWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadBudgetUpsertWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  createMany: z.lazy(() => LeadBudgetCreateManyLeadInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => LeadBudgetWhereUniqueInputSchema),z.lazy(() => LeadBudgetWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => LeadBudgetWhereUniqueInputSchema),z.lazy(() => LeadBudgetWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => LeadBudgetWhereUniqueInputSchema),z.lazy(() => LeadBudgetWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => LeadBudgetWhereUniqueInputSchema),z.lazy(() => LeadBudgetWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => LeadBudgetUpdateWithWhereUniqueWithoutLeadInputSchema),z.lazy(() => LeadBudgetUpdateWithWhereUniqueWithoutLeadInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => LeadBudgetUpdateManyWithWhereWithoutLeadInputSchema),z.lazy(() => LeadBudgetUpdateManyWithWhereWithoutLeadInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => LeadBudgetScalarWhereInputSchema),z.lazy(() => LeadBudgetScalarWhereInputSchema).array() ]).optional(),
}).strict();

export default LeadBudgetUpdateManyWithoutLeadNestedInputSchema;
