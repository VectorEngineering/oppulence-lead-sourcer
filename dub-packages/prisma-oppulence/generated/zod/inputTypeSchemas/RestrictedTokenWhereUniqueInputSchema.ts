...
export const RestrictedTokenWhereUniqueInputSchema: z.ZodType<Prisma.RestrictedTokenWhereUniqueInput> = z.union([
  z.object({
    id: z.string().cuid(),
    hashedKey: z.string()
  }),
...
.and(z.object({
  ...
  OR: z.lazy(() => RestrictedTokenWhereInputSchema).array().optional(),
