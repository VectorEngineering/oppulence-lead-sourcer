...
export const StageRequiredFieldUpdateWithWhereUniqueWithoutStageInputSchema: z.ZodType<Prisma.StageRequiredFieldUpdateWithWhereUniqueWithoutStageInput> = z.object({
  where: z.lazy(() => StageRequiredFieldWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => StageRequiredFieldUpdateWithoutStageInputSchema),z.lazy(() => StageRequiredFieldUncheckedUpdateWithoutStageInputSchema) ]),
}).strict();
