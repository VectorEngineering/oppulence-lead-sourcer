...
export const PayoutUpsertWithWhereUniqueWithoutInvoiceInputSchema: z.ZodType<Prisma.PayoutUpsertWithWhereUniqueWithoutInvoiceInput> = z.object({
  where: z.lazy(() => PayoutWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => PayoutUpdateWithoutInvoiceInputSchema),z.lazy(() => PayoutUncheckedUpdateWithoutInvoiceInputSchema) ]),
