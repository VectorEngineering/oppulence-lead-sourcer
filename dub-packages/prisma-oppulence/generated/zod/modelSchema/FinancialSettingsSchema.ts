...
export const FinancialSettingsSchema = z.object({
  ...
  minTxnAmount: z.instanceof(Prisma.Decimal, { message: "Field 'minTxnAmount' must be a Decimal. Location: ['Models', 'FinancialSettings']"}).nullish(),
  maxTxnAmount: z.instanceof(Prisma.Decimal, { message: "Field 'maxTxnAmount' must be a Decimal. Location: ['Models', 'FinancialSettings']"}).nullish(),
  notifyLargeTransactions: z.boolean(),
  largeTransactionThreshold: z.instanceof(Prisma.Decimal, { message: "Field 'largeTransactionThreshold' must be a Decimal. Location: ['Models', 'FinancialSettings']"}).nullish(),
  notifyFailedSync: z.boolean(),
  notifyLowBalance: z.boolean(),
  lowBalanceThreshold: z.instanceof(Prisma.Decimal, { message: "Field 'lowBalanceThreshold' must be a Decimal. Location: ['Models', 'FinancialSettings']"}).nullish(),
...
export const FinancialSettingsOptionalDefaultsSchema = FinancialSettingsSchema.merge(z.object({
