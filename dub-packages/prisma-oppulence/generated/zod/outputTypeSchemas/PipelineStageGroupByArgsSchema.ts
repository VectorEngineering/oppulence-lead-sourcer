...
export const PipelineStageGroupByArgsSchema: z.ZodType<Prisma.PipelineStageGroupByArgs> = z.object({
  where: PipelineStageWhereInputSchema.optional(),
  orderBy: z.union([ PipelineStageOrderByWithAggregationInputSchema.array(),PipelineStageOrderByWithAggregationInputSchema ]).optional(),
