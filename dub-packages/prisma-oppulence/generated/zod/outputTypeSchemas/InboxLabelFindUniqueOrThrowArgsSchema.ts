...
export const InboxLabelFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.InboxLabelFindUniqueOrThrowArgs> = z.object({
  select: InboxLabelSelectSchema.optional(),
  include: InboxLabelIncludeSchema.optional(),
  where: InboxLabelWhereUniqueInputSchema,
}).strict() ;

export default InboxLabelFindUniqueOrThrowArgsSchema;
