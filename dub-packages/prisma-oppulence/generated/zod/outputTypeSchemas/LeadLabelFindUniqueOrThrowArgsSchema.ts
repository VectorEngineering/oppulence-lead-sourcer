...
export const LeadLabelFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.LeadLabelFindUniqueOrThrowArgs> = z.object({
  select: LeadLabelSelectSchema.optional(),
  include: LeadLabelIncludeSchema.optional(),
  where: LeadLabelWhereUniqueInputSchema,
}).strict() ;

export default LeadLabelFindUniqueOrThrowArgsSchema;
