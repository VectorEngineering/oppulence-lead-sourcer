...
export const RestrictedTokenCreateArgsSchema: z.ZodType<Prisma.RestrictedTokenCreateArgs> = z.object({
  select: RestrictedTokenSelectSchema.optional(),
  include: RestrictedTokenIncludeSchema.optional(),
  data: z.union([ RestrictedTokenCreateInputSchema,RestrictedTokenUncheckedCreateInputSchema ]),
}).strict() ;

export default RestrictedTokenCreateArgsSchema;
