...
export const LeadDecisionMakerUpdateArgsSchema: z.ZodType<Prisma.LeadDecisionMakerUpdateArgs> = z.object({
  select: LeadDecisionMakerSelectSchema.optional(),
  include: LeadDecisionMakerIncludeSchema.optional(),
  data: z.union([ LeadDecisionMakerUpdateInputSchema,LeadDecisionMakerUncheckedUpdateInputSchema ]),
  where: LeadDecisionMakerWhereUniqueInputSchema,
}).strict() ;

export default LeadDecisionMakerUpdateArgsSchema;
