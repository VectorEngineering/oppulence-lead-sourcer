...
export const FinancialSettingsUpdateArgsSchema: z.ZodType<Prisma.FinancialSettingsUpdateArgs> = z.object({
  select: FinancialSettingsSelectSchema.optional(),
  include: FinancialSettingsIncludeSchema.optional(),
  data: z.union([ FinancialSettingsUpdateInputSchema,FinancialSettingsUncheckedUpdateInputSchema ]),
  where: FinancialSettingsWhereUniqueInputSchema,
}).strict() ;

export default FinancialSettingsUpdateArgsSchema;
