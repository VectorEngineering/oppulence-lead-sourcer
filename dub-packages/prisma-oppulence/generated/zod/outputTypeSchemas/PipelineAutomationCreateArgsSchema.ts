...
export const PipelineAutomationCreateArgsSchema: z.ZodType<Prisma.PipelineAutomationCreateArgs> = z.object({
  select: PipelineAutomationSelectSchema.optional(),
  include: PipelineAutomationIncludeSchema.optional(),
  data: z.union([ PipelineAutomationCreateInputSchema,PipelineAutomationUncheckedCreateInputSchema ]),
}).strict() ;

export default PipelineAutomationCreateArgsSchema;
