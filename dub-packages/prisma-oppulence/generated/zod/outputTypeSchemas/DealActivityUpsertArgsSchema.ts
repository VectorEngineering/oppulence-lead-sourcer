...
import { DealActivityUpdateInputSchema } from '../inputTypeSchemas/DealActivityUpdateInputSchema'
import { DealActivityUncheckedUpdateInputSchema } from '../inputTypeSchemas/DealActivityUncheckedUpdateInputSchema'
...
export const DealActivityUpsertArgsSchema: z.ZodType<Prisma.DealActivityUpsertArgs> = z.object({
  ...
  create: z.union([ DealActivityCreateInputSchema,DealActivityUncheckedCreateInputSchema ]),
  update: z.union([ DealActivityUpdateInputSchema,DealActivityUncheckedUpdateInputSchema ]),
}).strict() ;

export default DealActivityUpsertArgsSchema;
