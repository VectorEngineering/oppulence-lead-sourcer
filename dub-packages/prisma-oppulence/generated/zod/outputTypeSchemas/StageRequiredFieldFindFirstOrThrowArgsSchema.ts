...
export const StageRequiredFieldFindFirstOrThrowArgsSchema: z.ZodType<Prisma.StageRequiredFieldFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ StageRequiredFieldOrderByWithRelationInputSchema.array(),StageRequiredFieldOrderByWithRelationInputSchema ]).optional(),
...
export default StageRequiredFieldFindFirstOrThrowArgsSchema;
