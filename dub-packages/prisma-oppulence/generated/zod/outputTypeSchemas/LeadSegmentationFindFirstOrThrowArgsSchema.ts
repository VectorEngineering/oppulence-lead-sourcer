...
export const LeadSegmentationFindFirstOrThrowArgsSchema: z.ZodType<Prisma.LeadSegmentationFindFirstOrThrowArgs> = z.object({
  ...
  orderBy: z.union([ LeadSegmentationOrderByWithRelationInputSchema.array(),LeadSegmentationOrderByWithRelationInputSchema ]).optional(),
...
export default LeadSegmentationFindFirstOrThrowArgsSchema;
