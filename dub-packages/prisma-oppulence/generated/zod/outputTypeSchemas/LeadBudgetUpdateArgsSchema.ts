...
export const LeadBudgetUpdateArgsSchema: z.ZodType<Prisma.LeadBudgetUpdateArgs> = z.object({
  select: LeadBudgetSelectSchema.optional(),
  include: LeadBudgetIncludeSchema.optional(),
  data: z.union([ LeadBudgetUpdateInputSchema,LeadBudgetUncheckedUpdateInputSchema ]),
  where: LeadBudgetWhereUniqueInputSchema,
}).strict() ;

export default LeadBudgetUpdateArgsSchema;
