...
export const WebhookLogFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.WebhookLogFindUniqueOrThrowArgs> = z.object({
  select: WebhookLogSelectSchema.optional(),
  include: WebhookLogIncludeSchema.optional(),
  where: WebhookLogWhereUniqueInputSchema,
}).strict() ;

export default WebhookLogFindUniqueOrThrowArgsSchema;
