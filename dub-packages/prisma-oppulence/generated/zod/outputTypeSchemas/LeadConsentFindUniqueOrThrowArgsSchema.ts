...
export const LeadConsentSelectSchema: z.ZodType<Prisma.LeadConsentSelect> = z.object({
...
export const LeadConsentFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.LeadConsentFindUniqueOrThrowArgs> = z.object({
  select: LeadConsentSelectSchema.optional(),
  include: LeadConsentIncludeSchema.optional(),
  where: LeadConsentWhereUniqueInputSchema,
}).strict() ;

export default LeadConsentFindUniqueOrThrowArgsSchema;
