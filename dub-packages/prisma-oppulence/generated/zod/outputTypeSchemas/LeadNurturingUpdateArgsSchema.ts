...
export const LeadNurturingUpdateArgsSchema: z.ZodType<Prisma.LeadNurturingUpdateArgs> = z.object({
  select: LeadNurturingSelectSchema.optional(),
  include: LeadNurturingIncludeSchema.optional(),
  data: z.union([ LeadNurturingUpdateInputSchema,LeadNurturingUncheckedUpdateInputSchema ]),
  where: LeadNurturingWhereUniqueInputSchema,
}).strict() ;

export default LeadNurturingUpdateArgsSchema;
