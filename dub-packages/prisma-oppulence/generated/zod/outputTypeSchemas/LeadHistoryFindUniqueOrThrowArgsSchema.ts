...
export const LeadHistoryFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.LeadHistoryFindUniqueOrThrowArgs> = z.object({
  select: LeadHistorySelectSchema.optional(),
  include: LeadHistoryIncludeSchema.optional(),
  where: LeadHistoryWhereUniqueInputSchema,
}).strict() ;

export default LeadHistoryFindUniqueOrThrowArgsSchema;
