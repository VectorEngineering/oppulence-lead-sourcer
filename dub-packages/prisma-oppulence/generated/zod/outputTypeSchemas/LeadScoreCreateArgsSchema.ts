...
export const LeadScoreCreateArgsSchema: z.ZodType<Prisma.LeadScoreCreateArgs> = z.object({
  select: LeadScoreSelectSchema.optional(),
  include: LeadScoreIncludeSchema.optional(),
  data: z.union([ LeadScoreCreateInputSchema,LeadScoreUncheckedCreateInputSchema ]),
}).strict() ;

export default LeadScoreCreateArgsSchema;
