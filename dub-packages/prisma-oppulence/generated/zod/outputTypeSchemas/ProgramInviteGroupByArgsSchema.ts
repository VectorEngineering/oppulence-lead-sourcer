...
export const ProgramInviteGroupByArgsSchema: z.ZodType<Prisma.ProgramInviteGroupByArgs> = z.object({
  where: ProgramInviteWhereInputSchema.optional(),
  orderBy: z.union([ ProgramInviteOrderByWithAggregationInputSchema.array(),ProgramInviteOrderByWithAggregationInputSchema ]).optional(),
