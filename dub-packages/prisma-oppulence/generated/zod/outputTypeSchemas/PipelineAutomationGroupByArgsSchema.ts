...
export const PipelineAutomationGroupByArgsSchema: z.ZodType<Prisma.PipelineAutomationGroupByArgs> = z.object({
  where: PipelineAutomationWhereInputSchema.optional(),
  orderBy: z.union([ PipelineAutomationOrderByWithAggregationInputSchema.array(),PipelineAutomationOrderByWithAggregationInputSchema ]).optional(),
