...
export const InboxUpdateArgsSchema: z.ZodType<Prisma.InboxUpdateArgs> = z.object({
  select: InboxSelectSchema.optional(),
  include: InboxIncludeSchema.optional(),
  data: z.union([ InboxUpdateInputSchema,InboxUncheckedUpdateInputSchema ]),
  where: InboxWhereUniqueInputSchema,
}).strict() ;

export default InboxUpdateArgsSchema;
