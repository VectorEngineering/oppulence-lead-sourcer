...
export const InboxCreateArgsSchema: z.ZodType<Prisma.InboxCreateArgs> = z.object({
  select: InboxSelectSchema.optional(),
  include: InboxIncludeSchema.optional(),
  data: z.union([ InboxCreateInputSchema,InboxUncheckedCreateInputSchema ]),
}).strict() ;

export default InboxCreateArgsSchema;
