...
export const OAuthCodeFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.OAuthCodeFindUniqueOrThrowArgs> = z.object({
  select: OAuthCodeSelectSchema.optional(),
  include: OAuthCodeIncludeSchema.optional(),
  where: OAuthCodeWhereUniqueInputSchema,
}).strict() ;

export default OAuthCodeFindUniqueOrThrowArgsSchema;
