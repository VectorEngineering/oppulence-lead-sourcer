...
export const LeadComplianceAuditCreateArgsSchema: z.ZodType<Prisma.LeadComplianceAuditCreateArgs> = z.object({
  select: LeadComplianceAuditSelectSchema.optional(),
  include: LeadComplianceAuditIncludeSchema.optional(),
  data: z.union([ LeadComplianceAuditCreateInputSchema,LeadComplianceAuditUncheckedCreateInputSchema ]),
}).strict() ;

export default LeadComplianceAuditCreateArgsSchema;
