...
export const LeadScoreFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.LeadScoreFindUniqueOrThrowArgs> = z.object({
  select: LeadScoreSelectSchema.optional(),
  include: LeadScoreIncludeSchema.optional(),
  where: LeadScoreWhereUniqueInputSchema,
}).strict() ;

export default LeadScoreFindUniqueOrThrowArgsSchema;
