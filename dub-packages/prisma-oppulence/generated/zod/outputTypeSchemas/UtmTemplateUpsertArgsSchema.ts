...
import { UtmTemplateCreateInputSchema } from '../inputTypeSchemas/UtmTemplateCreateInputSchema'
import { UtmTemplateUncheckedCreateInputSchema } from '../inputTypeSchemas/UtmTemplateUncheckedCreateInputSchema'
...
export const UtmTemplateSelectSchema: z.ZodType<Prisma.UtmTemplateSelect> = z.object({
...
export const UtmTemplateUpsertArgsSchema: z.ZodType<Prisma.UtmTemplateUpsertArgs> = z.object({
  select: UtmTemplateSelectSchema.optional(),
  include: UtmTemplateIncludeSchema.optional(),
  where: UtmTemplateWhereUniqueInputSchema,
  create: z.union([ UtmTemplateCreateInputSchema,UtmTemplateUncheckedCreateInputSchema ]),
  update: z.union([ UtmTemplateUpdateInputSchema,UtmTemplateUncheckedUpdateInputSchema ]),
}).strict() ;

export default UtmTemplateUpsertArgsSchema;
