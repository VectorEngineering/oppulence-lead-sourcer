...
export const ProgramApplicationGroupByArgsSchema: z.ZodType<Prisma.ProgramApplicationGroupByArgs> = z.object({
  where: ProgramApplicationWhereInputSchema.optional(),
  orderBy: z.union([ ProgramApplicationOrderByWithAggregationInputSchema.array(),ProgramApplicationOrderByWithAggregationInputSchema ]).optional(),
