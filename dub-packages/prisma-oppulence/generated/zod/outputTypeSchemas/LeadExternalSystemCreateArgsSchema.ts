...
export const LeadExternalSystemCreateArgsSchema: z.ZodType<Prisma.LeadExternalSystemCreateArgs> = z.object({
  select: LeadExternalSystemSelectSchema.optional(),
  include: LeadExternalSystemIncludeSchema.optional(),
  data: z.union([ LeadExternalSystemCreateInputSchema,LeadExternalSystemUncheckedCreateInputSchema ]),
}).strict() ;

export default LeadExternalSystemCreateArgsSchema;
