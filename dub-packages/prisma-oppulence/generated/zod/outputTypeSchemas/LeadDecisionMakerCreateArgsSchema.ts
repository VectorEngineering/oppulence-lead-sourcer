...
export const LeadDecisionMakerCreateArgsSchema: z.ZodType<Prisma.LeadDecisionMakerCreateArgs> = z.object({
  select: LeadDecisionMakerSelectSchema.optional(),
  include: LeadDecisionMakerIncludeSchema.optional(),
  data: z.union([ LeadDecisionMakerCreateInputSchema,LeadDecisionMakerUncheckedCreateInputSchema ]),
}).strict() ;

export default LeadDecisionMakerCreateArgsSchema;
