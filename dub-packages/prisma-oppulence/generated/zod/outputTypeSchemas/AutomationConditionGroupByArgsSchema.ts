...
export const AutomationConditionGroupByArgsSchema: z.ZodType<Prisma.AutomationConditionGroupByArgs> = z.object({
  where: AutomationConditionWhereInputSchema.optional(),
  orderBy: z.union([ AutomationConditionOrderByWithAggregationInputSchema.array(),AutomationConditionOrderByWithAggregationInputSchema ]).optional(),
