...
import { ProgramEnrollmentUpdateInputSchema } from '../inputTypeSchemas/ProgramEnrollmentUpdateInputSchema'
import { ProgramEnrollmentUncheckedUpdateInputSchema } from '../inputTypeSchemas/ProgramEnrollmentUncheckedUpdateInputSchema'
...
export const ProgramEnrollmentUpsertArgsSchema: z.ZodType<Prisma.ProgramEnrollmentUpsertArgs> = z.object({
  ...
  create: z.union([ ProgramEnrollmentCreateInputSchema,ProgramEnrollmentUncheckedCreateInputSchema ]),
  update: z.union([ ProgramEnrollmentUpdateInputSchema,ProgramEnrollmentUncheckedUpdateInputSchema ]),
}).strict() ;

export default ProgramEnrollmentUpsertArgsSchema;
