...
export const ExecutionPhaseUpdateArgsSchema: z.ZodType<Prisma.ExecutionPhaseUpdateArgs> = z.object({
  select: ExecutionPhaseSelectSchema.optional(),
  include: ExecutionPhaseIncludeSchema.optional(),
  data: z.union([ ExecutionPhaseUpdateInputSchema,ExecutionPhaseUncheckedUpdateInputSchema ]),
  where: ExecutionPhaseWhereUniqueInputSchema,
}).strict() ;

export default ExecutionPhaseUpdateArgsSchema;
