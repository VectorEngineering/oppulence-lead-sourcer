...
export const ExecutionPhaseFindFirstOrThrowArgsSchema: z.ZodType<Prisma.ExecutionPhaseFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ ExecutionPhaseScalarFieldEnumSchema,ExecutionPhaseScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default ExecutionPhaseFindFirstOrThrowArgsSchema;
