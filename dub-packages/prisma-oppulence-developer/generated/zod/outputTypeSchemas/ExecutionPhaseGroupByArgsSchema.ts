...
export const ExecutionPhaseGroupByArgsSchema: z.ZodType<Prisma.ExecutionPhaseGroupByArgs> = z.object({
  where: ExecutionPhaseWhereInputSchema.optional(),
  orderBy: z.union([ ExecutionPhaseOrderByWithAggregationInputSchema.array(),ExecutionPhaseOrderByWithAggregationInputSchema ]).optional(),
