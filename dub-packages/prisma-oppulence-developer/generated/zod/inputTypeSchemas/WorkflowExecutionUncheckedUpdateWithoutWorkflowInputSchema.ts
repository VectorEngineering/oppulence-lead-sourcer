...
import { ExecutionPhaseUncheckedUpdateManyWithoutExecutionNestedInputSchema } from './ExecutionPhaseUncheckedUpdateManyWithoutExecutionNestedInputSchema';

export const WorkflowExecutionUncheckedUpdateWithoutWorkflowInputSchema: z.ZodType<Prisma.WorkflowExecutionUncheckedUpdateWithoutWorkflowInput> = z.object({
  ...
  phases: z.lazy(() => ExecutionPhaseUncheckedUpdateManyWithoutExecutionNestedInputSchema).optional()
}).strict();

export default WorkflowExecutionUncheckedUpdateWithoutWorkflowInputSchema;
