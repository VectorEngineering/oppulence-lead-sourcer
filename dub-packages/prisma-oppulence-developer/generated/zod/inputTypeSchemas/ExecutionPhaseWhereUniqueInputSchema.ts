...
export const ExecutionPhaseWhereUniqueInputSchema: z.ZodType<Prisma.ExecutionPhaseWhereUniqueInput> = z.object({
  id: z.string().cuid()
})
.and(z.object({
  id: z.string().cuid().optional(),
  AND: z.union([ z.lazy(() => ExecutionPhaseWhereInputSchema),z.lazy(() => ExecutionPhaseWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ExecutionPhaseWhereInputSchema).array().optional(),
  ...
  creditsConsumed: z.union([ z.lazy(() => IntNullableFilterSchema),z.number().int() ]).optional().nullable(),
  workflowExecutionId: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  execution: z.union([ z.lazy(() => WorkflowExecutionRelationFilterSchema),z.lazy(() => WorkflowExecutionWhereInputSchema) ]).optional(),
