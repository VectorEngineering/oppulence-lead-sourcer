...
export const ExecutionPhaseUpdateWithWhereUniqueWithoutExecutionInputSchema: z.ZodType<Prisma.ExecutionPhaseUpdateWithWhereUniqueWithoutExecutionInput> = z.object({
  where: z.lazy(() => ExecutionPhaseWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ExecutionPhaseUpdateWithoutExecutionInputSchema),z.lazy(() => ExecutionPhaseUncheckedUpdateWithoutExecutionInputSchema) ]),
}).strict();
