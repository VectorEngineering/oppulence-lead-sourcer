...
export const ExecutionLogUpsertWithWhereUniqueWithoutExecutionPhaseInputSchema: z.ZodType<Prisma.ExecutionLogUpsertWithWhereUniqueWithoutExecutionPhaseInput> = z.object({
  where: z.lazy(() => ExecutionLogWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ExecutionLogUpdateWithoutExecutionPhaseInputSchema),z.lazy(() => ExecutionLogUncheckedUpdateWithoutExecutionPhaseInputSchema) ]),
  create: z.union([ z.lazy(() => ExecutionLogCreateWithoutExecutionPhaseInputSchema),z.lazy(() => ExecutionLogUncheckedCreateWithoutExecutionPhaseInputSchema) ]),
}).strict();
