...
export const ExecutionPhaseUpsertWithoutLogsInputSchema: z.ZodType<Prisma.ExecutionPhaseUpsertWithoutLogsInput> = z.object({
  update: z.union([ z.lazy(() => ExecutionPhaseUpdateWithoutLogsInputSchema),z.lazy(() => ExecutionPhaseUncheckedUpdateWithoutLogsInputSchema) ]),
  create: z.union([ z.lazy(() => ExecutionPhaseCreateWithoutLogsInputSchema),z.lazy(() => ExecutionPhaseUncheckedCreateWithoutLogsInputSchema) ]),
