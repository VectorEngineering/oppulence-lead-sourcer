...
export const ExecutionPhaseUpdateOneRequiredWithoutLogsNestedInputSchema: z.ZodType<Prisma.ExecutionPhaseUpdateOneRequiredWithoutLogsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ExecutionPhaseCreateWithoutLogsInputSchema),z.lazy(() => ExecutionPhaseUncheckedCreateWithoutLogsInputSchema) ]).optional(),
  ...
  update: z.union([ z.lazy(() => ExecutionPhaseUpdateToOneWithWhereWithoutLogsInputSchema),z.lazy(() => ExecutionPhaseUpdateWithoutLogsInputSchema),z.lazy(() => ExecutionPhaseUncheckedUpdateWithoutLogsInputSchema) ]).optional(),
}).strict();
