...
const expenseSchema = z.object({
  ...
  date: z.string().describe(
    "The transaction date of the expense in ISO 8601 format (YYYY-MM-DD)."
  ),
  time: z.string().optional().describe(
    "The transaction time of the expense (e.g. HH:MM), if available."
  ),
  website: z
    .string()
    .describe(
  ...
  description: z.string().describe(
    "A one-sentence summary of the purchase focusing on the supplier and what was bought. Ignore amounts."
  ),
  merchantAddress: z
    .string()
    .optional()
    .describe("The full address of the merchant, if available."),
  merchantPhone: z
    .string()
    .optional()
    .describe("The merchant's phone number, if available."),
  invoiceNumber: z
    .string()
    .optional()
    .describe("The invoice or receipt number if present."),
  paymentMethod: z
    .string()
    .optional()
    .describe("The payment method used (e.g. credit card, cash), if identifiable."),
  ...
  lineItems: z
    ...
    .optional()
    .describe("An array of line items detailing individual purchased goods or services."),
});
