...
export const LeadEventSchema = z.object({
    ...
    last_funding_date: z.string().nullable(), // ISO Date string
    ...
    stage_duration_days: z.record(z.string(), z.number().int()),
    ...
    expected_close_date: z.string(), // ISO Date string
    actual_close_date: z.string().nullable(), // ISO Date string
