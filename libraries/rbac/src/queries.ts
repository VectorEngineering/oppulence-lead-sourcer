...
function merge<R extends string>(rule: Rule, ...args: Array<PermissionQuery<R> | undefined>): PermissionQuery<R> {
...
export function or<R extends string = string>(...args: Array<PermissionQuery<R> | undefined>): PermissionQuery<R> {
    return merge('or', ...args)
}

export function and<R extends string = string>(...args: Array<PermissionQuery<R> | undefined>): PermissionQuery<R> {
