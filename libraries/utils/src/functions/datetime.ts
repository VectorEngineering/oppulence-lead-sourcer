...
export const formatDate = (datetime: Date | string, options?: Intl.DateTimeFormatOptions) => {
...
export const formatDateTime = (datetime: Date | string, options?: Intl.DateTimeFormatOptions) => {
    if (datetime.toString() === 'Invalid Date') return ''
