    ...
    ...(process.env.NEXT_PUBLIC_IS_DUB
        ? [
              ...
              },
              {
                  ...
                  primary: false,
                  archived: false,
                  placeholder: 'https://github.com/vector-workflow-manager',
              ...
              },
              {
                  ...
                  allowedHostnames: ['amazon.com', 'amazon.co.uk', 'amazon.ca', 'amazon.es', 'amazon.fr'],
              ...
              },
              {
                  ...
                  primary: false,
                  archived: false,
                  placeholder: 'https://docs.google.com/document/d/15-GOZA12SXGEh8lNwU5QI1jBi04TCPgY2-LChTbXVpA',
                  allowedHostnames: [
                      'google.com',
                      'google.co.uk',
                      'google.co.id',
              ...
              },
              {
                  ...
                  description: 'Branded domain for Figma links (portfolios, prototypes, presentations, etc.).',
                  projectId: DUB_WORKSPACE_ID
              },
              {
                  ...
                  description: "Branded domain for lengthening links instead of shortening them (April Fool's Prank).",
                  projectId: DUB_WORKSPACE_ID
              }
          ]
        : [])
