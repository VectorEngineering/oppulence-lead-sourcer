...
function getDefaultCalendarDateTime(value: Date | null | undefined, defaultValue: Date | null | undefined) {
    if (value) {
...
function getDefaultCalendarDate(value: Date | null | undefined, defaultValue: Date | null | undefined) {
    if (value) {
...
function updateCalendarDateFromDate(date: CalendarDate | CalendarDateTime | null | undefined, value: Date, granularity?: Granularity) {
    if (granularity && USES_TIME.has(granularity)) {
...
function getDefaultCalendarDateFromDate(value: Date | null | undefined, defaultValue: Date | null | undefined, granularity?: Granularity) {
    if (value) {
