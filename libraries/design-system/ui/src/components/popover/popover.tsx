...
const Trigger = React.forwardRef<React.ElementRef<typeof Primitives.Trigger>, React.ComponentPropsWithoutRef<typeof Primitives.Trigger>>(
    (props, ref) => {
...
const Anchor = React.forwardRef<React.ElementRef<typeof Primitives.Anchor>, React.ComponentPropsWithoutRef<typeof Primitives.Anchor>>(
    (props, ref) => {
...
const Close = React.forwardRef<React.ElementRef<typeof Primitives.Close>, React.ComponentPropsWithoutRef<typeof Primitives.Close>>(
    (props, ref) => {
...
const Seperator = React.forwardRef<HTMLDivElement, React.ComponentPropsWithoutRef<'div'>>(({ className, ...props }, ref) => {
    return <div ref={ref} className={clx('bg-ui-border-base -mx-1 my-1 h-px', className)} {...props} />
})
