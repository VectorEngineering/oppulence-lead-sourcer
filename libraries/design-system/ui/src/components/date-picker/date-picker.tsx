...
import { CalendarMini, Clock, XMarkMini } from '@playbookmedia/icons'
import { cva } from 'cva'
import * as React from 'react'
import { DateValue, useDatePicker, useInteractOutside, type AriaDatePickerProps as BaseDatePickerProps } from 'react-aria'
        ...
        return (
            <Popover modal={modal} open={state.isOpen} onOpenChange={state.setOpen}>
                <Popover.Anchor asChild>
                    <div
                        ref={ref}
                        className={clx(datePickerStyles(state.isOpen, state.isInvalid, state.value)({ size }), className)}
                        {...groupProps}
                    >
...
function convertProps(
    ...
    setValue: React.Dispatch<React.SetStateAction<CalendarDateTime | CalendarDate | null | undefined>>
