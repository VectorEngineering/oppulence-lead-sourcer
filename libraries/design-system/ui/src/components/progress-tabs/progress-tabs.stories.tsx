            ...
            <Container className='h-full w-full overflow-hidden p-0'>
                <ProgressTabs defaultValue='tab1'>
                    ...
                    <div className='txt-compact-medium text-ui-fg-base border-ui-border-base h-full border-t p-3'>
                        <ProgressTabs.Content value='tab1'>Tab 1 content</ProgressTabs.Content>
                        <ProgressTabs.Content value='tab2'>Tab 2 content</ProgressTabs.Content>
                        <ProgressTabs.Content value='tab3'>Tab 3 content</ProgressTabs.Content>
                    </div>
                </ProgressTabs>
            </Container>
        </div>
