...
interface SwitchProps
    extends Omit<React.ComponentPropsWithoutRef<typeof Primitives.Root>, 'asChild'>,
        VariantProps<typeof switchVariants> {}

/**
 * This component is based on the [Radix UI Switch](https://www.radix-ui.com/primitives/docs/components/switch) primitive.
 */
const Switch = React.forwardRef<React.ElementRef<typeof Primitives.Root>, SwitchProps>(
    (
        {
            className,
            /**
        ...
        <Primitives.Root className={clx(switchVariants({ size }), className)} {...props} ref={ref}>
