...
const Overlay = React.forwardRef<React.ElementRef<typeof Primitives.Overlay>, React.ComponentPropsWithoutRef<typeof Primitives.Overlay>>(
    ({ className, ...props }, ref) => {
        return (
            <Primitives.Overlay
                ref={ref}
...
>(({ className, ...props }, ref) => {
    return <Primitives.Description ref={ref} className={clx('text-ui-fg-subtle txt-compact-medium', className)} {...props} />
})
...
const Header = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
    return <div className={clx('flex flex-col gap-y-1 px-6 pt-6', className)} {...props} />
}
...
const Footer = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
    return <div className={clx('flex items-center justify-end gap-x-2 p-6', className)} {...props} />
}
