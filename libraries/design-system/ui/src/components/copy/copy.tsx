...
import { CheckCircleMiniSolid, CheckCircleSolid, SquareTwoStack, SquareTwoStackMini } from '@playbookmedia/icons'
...
const Copy = React.forwardRef<HTMLButtonElement, CopyProps>(
    (
        ...
        const copyToClipboard = (e: React.MouseEvent<HTMLElement, MouseEvent> | React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
            e.stopPropagation()
        ...
        return (
            <Tooltip content={text} open={done || open} onOpenChange={setOpen}>
                <Component
                    ...
                    type='button'
                    className={clx('h-fit w-fit', className)}
