...
export interface TextProps extends React.ComponentPropsWithoutRef<'p'>, VariantProps<typeof textVariants> {
    asChild?: boolean
    as?: 'p' | 'span' | 'div'
}
...
const Text = React.forwardRef<HTMLParagraphElement, TextProps>(
    (
        ...
        return (
            <Component ref={ref} className={clx(textVariants({ size, weight, family, leading }), className)} {...props}>
                {children}
            </Component>
        )
    }
