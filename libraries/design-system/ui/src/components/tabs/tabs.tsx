...
const TabsList = React.forwardRef<React.ElementRef<typeof TabsPrimitives.List>, React.ComponentPropsWithoutRef<typeof TabsPrimitives.List>>(
    ({ className, ...props }, ref) => <TabsPrimitives.List ref={ref} className={clx('flex items-center gap-2', className)} {...props} />
)
...
>(({ className, ...props }, ref) => <TabsPrimitives.Content ref={ref} className={clx('outline-none', className)} {...props} />)
