...
import { Eye, EyeSlash, MagnifyingGlassMini } from '@playbookmedia/icons'
    ...
    (
        ...
        return (
            <div className='relative'>
                ...
                {isSearch && (
                    <div
                        className={clx('text-ui-fg-muted pointer-events-none absolute bottom-0 left-0 flex items-center justify-center', {
                            'h-8 w-8': size === 'base',
                            'h-7 w-7': size === 'small'
                        })}
                        role='img'
