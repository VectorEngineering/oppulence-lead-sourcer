...
import { CheckCircleSolid, CircleDottedLine, CircleHalfSolid, Plus } from '@playbookmedia/icons'
...
const Item = React.forwardRef<React.ElementRef<typeof Primitves.Item>, React.ComponentPropsWithoutRef<typeof Primitves.Item>>(
    ({ className, ...props }, ref) => {
        return <Primitves.Item ref={ref} className={clx('border-ui-border-base border-b last-of-type:border-b-0', className)} {...props} />
    }
)
...
const Header = React.forwardRef<React.ElementRef<typeof Primitves.Header>, HeaderProps>(
    (
        ...
        return (
            <Primitves.Header
                ref={ref}
                className={clx('h3-core text-ui-fg-base group flex w-full flex-1 items-center gap-4 px-6', className)}
                {...props}
            >
...
const Content = React.forwardRef<React.ElementRef<typeof Primitves.Content>, React.ComponentPropsWithoutRef<typeof Primitves.Content>>(
    ({ className, ...props }, ref) => {
        return (
            <Primitves.Content
                ref={ref}
