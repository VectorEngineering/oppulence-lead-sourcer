    ...
    return (
        <div className='flex items-center justify-center p-8'>
            <Container className='p-0'>
                <ProgressAccordion value={value} onValueChange={setValue} type='multiple' className='w-full'>
                    <ProgressAccordion.Item value='1'>
                        <ProgressAccordion.Header>Trigger 1</ProgressAccordion.Header>
                        <ProgressAccordion.Content>
                            <div className='pb-6'>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. A recusandae officiis aliquam quia, natus saepe
                                obcaecati eligendi non animi fuga culpa, cum unde consequuntur architecto quos reiciendis deleniti eos iste!
                            </div>
                        </ProgressAccordion.Content>
