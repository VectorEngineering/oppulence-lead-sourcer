...
import { Minus } from '@playbookmedia/icons'
...
const Root = React.forwardRef<HTMLTableElement, React.HTMLAttributes<HTMLTableElement>>(({ className, ...props }, ref) => (
    <table ref={ref} className={clx('text-ui-fg-subtle txt-compact-small w-full', className)} {...props} />
))
...
const Cell = React.forwardRef<HTMLTableCellElement, React.HTMLAttributes<HTMLTableCellElement>>(({ className, ...props }, ref) => (
...
const Header = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(({ className, ...props }, ref) => (
    <thead
        ref={ref}
        className={clx('border-ui-border-base txt-compact-small-plus [&_tr:hover]:bg-ui-bg-base border-y', className)}
        {...props}
    />
))
Header.displayName = 'Table.Header'

const HeaderCell = React.forwardRef<HTMLTableCellElement, React.TdHTMLAttributes<HTMLTableCellElement>>(({ className, ...props }, ref) => (
    <th ref={ref} className={clx('txt-compact-small-plus h-12 pr-6 text-left', className)} {...props} />
))
...
const Pagination = React.forwardRef<HTMLDivElement, TablePaginationProps>(
    (
        ...
        return (
            <div
                ref={ref}
                className={clx('text-ui-fg-subtle txt-compact-small-plus flex w-full items-center justify-between px-3 py-4', className)}
                {...props}
            >
