...
const CommandCopy = React.forwardRef<React.ElementRef<typeof Copy>, React.ComponentPropsWithoutRef<typeof Copy>>(
    ({ className, ...props }, ref) => {
        return <Copy {...props} ref={ref} className={clx('!text-ui-contrast-fg-secondary ml-auto', className)} />
    }
)
