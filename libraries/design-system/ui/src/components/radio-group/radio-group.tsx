 ...
 */
const Root = React.forwardRef<React.ElementRef<typeof Primitives.Root>, React.ComponentPropsWithoutRef<typeof Primitives.Root>>(
    ({ className, ...props }, ref) => {
        return <Primitives.Root className={clx('grid gap-2', className)} {...props} ref={ref} />
    }
)
...
>(({ className, ...props }, ref) => {
    return (
        <Primitives.Indicator ref={ref} className={clx('flex items-center justify-center', className)} {...props}>
            <div
                className={clx(
...
const ChoiceBox = React.forwardRef<React.ElementRef<typeof Primitives.Item>, ChoiceBoxProps>(
        ...
        return (
            ...
            >
                ...
                <div className='flex flex-col items-start'>
                    ...
                    <Hint className='txt-compact-medium text-ui-fg-subtle group-disabled:text-ui-fg-disabled text-left' id={descriptionId}>
                        {description}
                    </Hint>
                </div>
            </Primitives.Item>
