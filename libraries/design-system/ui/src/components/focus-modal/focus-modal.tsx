...
import { XMark } from '@playbookmedia/icons'
...
const FocusModalHeader = React.forwardRef<HTMLDivElement, React.ComponentPropsWithoutRef<'div'>>(
    ({ children, className, ...props }, ref) => {
        return (
            <div
                ref={ref}
                className={clx('border-ui-border-base flex items-center justify-between gap-x-4 border-b px-4 py-2', className)}
                {...props}
            >
...
const FocusModalFooter = React.forwardRef<HTMLDivElement, React.ComponentPropsWithoutRef<'div'>>(
    ({ children, className, ...props }, ref) => {
        return (
            <div
                ref={ref}
                className={clx('border-ui-border-base flex items-center justify-end gap-x-2 border-t p-4', className)}
                {...props}
            >
                {children}
            </div>
...
const FocusModalTitle = React.forwardRef<HTMLHeadingElement, React.ComponentPropsWithoutRef<typeof FocusModalPrimitives.Title>>(
    ({ className, ...props }, ref) => {
 ...
 * This component is based on the `div` element and supports all of its props
 */
const FocusModalBody = React.forwardRef<HTMLDivElement, React.ComponentPropsWithoutRef<'div'>>(({ className, ...props }, ref) => {
