...
import { CheckMini, ChevronRightMini, EllipseMiniSolid } from '@playbookmedia/icons'
 ...
 */
const Content = React.forwardRef<React.ElementRef<typeof Primitives.Content>, React.ComponentPropsWithoutRef<typeof Primitives.Content>>(
 ...
 */
const Item = React.forwardRef<React.ElementRef<typeof Primitives.Item>, React.ComponentPropsWithoutRef<typeof Primitives.Item>>(
    ({ className, ...props }, ref) => (
        <Primitives.Item
            ref={ref}
            className={clx(
 ...
 */
const Label = React.forwardRef<React.ElementRef<typeof Primitives.Label>, React.ComponentPropsWithoutRef<typeof Primitives.Label>>(
    ({ className, ...props }, ref) => (
        <Primitives.Label ref={ref} className={clx('text-ui-fg-subtle txt-compact-xsmall-plus', className)} {...props} />
    )
)
...
>(({ className, ...props }, ref) => (
    <Primitives.Separator
        ref={ref}
        className={clx(
            'bg-ui-border-component -mx-1 my-1 h-0.5 border-t border-t-ui-border-menu-top border-b border-b-ui-border-menu-bot',
            className
        )}
        {...props}
    />
...
const Shortcut = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => {
    return <span className={clx('text-ui-fg-subtle txt-compact-small ml-auto tracking-widest', className)} {...props} />
}
