...
interface TooltipProps
    extends Omit<Primitives.TooltipContentProps, 'content' | 'onClick'>,
        Pick<Primitives.TooltipProps, 'open' | 'defaultOpen' | 'onOpenChange' | 'delayDuration'> {
...
const Tooltip = ({
    ...
    return (
        <Primitives.Root open={open} defaultOpen={defaultOpen} onOpenChange={onOpenChange} delayDuration={delayDuration}>
