...
const Google = React.forwardRef<SVGSVGElement, Omit<IconProps, 'color'>>((props, ref) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={15} height={15} fill='none' ref={ref} {...props}>
            ...
            />
            <path fill='#F6B704' d='M3.836 8.794a4.1 4.1 0 0 1 0-2.588L1.6 4.47a6.76 6.76 0 0 0 0 6.06z' />
            <path
                fill='#E54335'
