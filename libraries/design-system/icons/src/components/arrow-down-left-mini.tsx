...
const ArrowDownLeftMini = React.forwardRef<SVGSVGElement, IconProps>(({ color = 'currentColor', ...props }, ref) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={15} height={15} fill='none' ref={ref} {...props}>
            ...
            />
            <path stroke={color} strokeLinecap='round' strokeLinejoin='round' strokeWidth={1.5} d='M5.722 4.389 1.944 8.167l3.778 3.778' />
        </svg>
    )
})
