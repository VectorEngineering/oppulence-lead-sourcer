...
const Typescript = React.forwardRef<SVGSVGElement, Omit<IconProps, 'color'>>((props, ref) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={15} height={15} fill='none' ref={ref} {...props}>
            <path fill='#3178C6' d='M11.25.75h-7.5a3 3 0 0 0-3 3v7.5a3 3 0 0 0 3 3h7.5a3 3 0 0 0 3-3v-7.5a3 3 0 0 0-3-3' />
            <path
                fill='#fff'
                fillRule='evenodd'
