...
const Klarna = React.forwardRef<SVGSVGElement, Omit<IconProps, 'color'>>((props, ref) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={15} height={15} fill='none' ref={ref} {...props}>
            <path fill='#FFB3C7' d='M7.5 14.25a6.75 6.75 0 1 0 0-13.5 6.75 6.75 0 0 0 0 13.5' />
            <path
                fill='#000'
            ...
            />
            <path fill='#000' d='M10.285 8.47a.821.821 0 1 0-.001 1.642.821.821 0 0 0 .001-1.642' />
        </svg>
    )
})
