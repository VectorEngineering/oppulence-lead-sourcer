...
const ReactJs = React.forwardRef<SVGSVGElement, Omit<IconProps, 'color'>>((props, ref) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={15} height={15} fill='none' ref={ref} {...props}>
            <path fill='#61DAFB' d='M11.25.75h-7.5a3 3 0 0 0-3 3v7.5a3 3 0 0 0 3 3h7.5a3 3 0 0 0 3-3v-7.5a3 3 0 0 0-3-3' />
            <path
                stroke='#000'
                strokeWidth={0.75}
            ...
            />
            <path fill='#000' d='M7.5 8.406a.906.906 0 1 0 0-1.812.906.906 0 0 0 0 1.812' />
        </svg>
    )
})
