...
const Facebook = React.forwardRef<SVGSVGElement, Omit<IconProps, 'color'>>((props, ref) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={15} height={15} fill='none' ref={ref} {...props}>
            ...
            />
            <defs>
                <linearGradient id='a' x1={7.5} x2={7.5} y1={13.78} y2={0.748} gradientUnits='userSpaceOnUse'>
