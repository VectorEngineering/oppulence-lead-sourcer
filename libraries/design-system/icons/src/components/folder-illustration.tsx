...
const FolderIllustration = React.forwardRef<SVGSVGElement, IconProps>(({ color = 'currentColor', ...props }, ref) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={15} height={15} fill='none' ref={ref} {...props}>
            ...
            <defs>
                <linearGradient id='a' x1={7.5} x2={7.5} y1={1.498} y2={13.502} gradientUnits='userSpaceOnUse'>
                    <stop />
                    <stop offset={1} stopOpacity={0} />
                </linearGradient>
                <linearGradient id='c' x1={7.5} x2={7.5} y1={4.965} y2={13.501} gradientUnits='userSpaceOnUse'>
                    <stop stopColor='#fff' />
                ...
                >
                    ...
                    <feBlend in2='effect1_innerShadow_6347_11987' result='effect2_innerShadow_6347_11987' />
                </filter>
            </defs>
        </svg>
    )
