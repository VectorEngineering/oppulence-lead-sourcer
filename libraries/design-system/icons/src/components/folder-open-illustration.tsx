...
const FolderOpenIllustration = React.forwardRef<SVGSVGElement, IconProps>(({ color = 'currentColor', ...props }, ref) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={15} height={15} fill='none' ref={ref} {...props}>
            ...
            <defs>
                <linearGradient id='b' x1={7.5} x2={7.5} y1={1.466} y2={13.469} gradientUnits='userSpaceOnUse'>
                    <stop />
                    <stop offset={1} stopOpacity={0} />
                </linearGradient>
                <linearGradient id='d' x1={7.5} x2={7.5} y1={5.734} y2={13.534} gradientUnits='userSpaceOnUse'>
                    <stop stopColor='#fff' />
                ...
                >
                    ...
                    <feBlend in2='effect1_innerShadow_6347_12110' result='effect2_innerShadow_6347_12110' />
                </filter>
            </defs>
        </svg>
    )
