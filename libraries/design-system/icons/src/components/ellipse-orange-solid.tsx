...
const EllipseOrangeSolid = React.forwardRef<SVGSVGElement, IconProps>(({ color = 'currentColor', ...props }, ref) => {
    return (
        <svg xmlns='http://www.w3.org/2000/svg' width={15} height={15} fill='none' ref={ref} {...props}>
            ...
            <defs>
                ...
                <filter id='b' width={14} height={14} x={0.5} y={1.5} colorInterpolationFilters='sRGB' filterUnits='userSpaceOnUse'>
                    ...
                    <feMorphology in='SourceAlpha' operator='dilate' radius={1} result='effect1_dropShadow_2733_2027' />
                    <feOffset />
