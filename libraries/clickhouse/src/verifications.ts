...
const outcome = z.enum(['VALID', 'INSUFFICIENT_PERMISSIONS', 'RATE_LIMITED', 'FORBIDDEN', 'DISABLED', 'EXPIRED', 'USAGE_EXCEEDED', ''])
...
export function insertVerification(ch: Inserter) {
    return ch.insert({
        ...
        schema: z.object({
            ...
            outcome: z.enum(['VALID', 'RATE_LIMITED', 'EXPIRED', 'DISABLED', 'FORBIDDEN', 'USAGE_EXCEEDED', 'INSUFFICIENT_PERMISSIONS']),
