...
export class ClickHouseContainer {
    ...
    static async start(t: TaskContext, opts?: { keepContainer?: boolean }): Promise<ClickHouseContainer> {
        ...
        const dsn = `tcp://${ClickHouseContainer.username}:${ClickHouseContainer.password}@localhost:${container.getMappedPort(9000)}`
